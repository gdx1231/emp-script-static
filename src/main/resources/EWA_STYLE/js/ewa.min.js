...
d[e]);this._Ajax.PostNew(this._Url,EWA.CurUI._PostChangeCallback);this.IsPostChange=!0};this._PostChangeCallback=function(){var d=EWA.CurUI._Ajax;4==d._Http.readyState&&(d.HiddenWaitting(),200==d._Http.status?(d=d._Http.responseText,EWA.F.CheckCallBack(d)&&("OnTreeNodeMore"==EWA.CurUI.PostChangeType?EWA.CurUI.LoadChildrenAfter(d):"OnTreeNodeStatus"==EWA.CurUI.PostChangeType?EWA.CurUI.LoadChildrenStatus(d):eval(d))):alert("ERROR:\r\n"+d._Http.statusText),EWA.CurUI.IsPostChange=!1,EWA.SHOW_ERROR=!0)};
this.LoadChildrenStatus=function(d){var e=new EWA.C.Xml;e.LoadXml(d);var g=e.GetElements("FrameData/Row");if(null!=g){d=[];for(var h={},k=0;k<g.length;k=1+k){var l=this._CreateNodeFromXml(g[k],e);""==l.Key||$[l.ParentKey]||(d.push(l),h[l.Key]=l)}if(0!=d.length&&(e=this.GetNodeById(d[0].ParentKey),null!=e)){h[e.Key]=e;for(k=0;k<d.length;k+=1)h[d[k].ParentKey].AddChild(d[k]);e.GetObject().setAttribute("EWA_TREE_MORE","0");e.IsMoreChildren=!1;for(k=0;k<e.Children.length;k+=1)this.Create(e.Children[k]);
e.NodeShow(!0);this.ShowNode(this.PostChangeKey)}}};this.LoadChildrenAfter=function(d){var e=new EWA.C.Xml;e.LoadXml(d);d=e.GetElements("FrameData/Row");if(null!=d&&0!=d.length){var g=this.GetNodeById(this.PostChangeKey),h={};h[g.Key]=g;for(var k=0;k<d.length;k=1+k){var l=this._CreateNodeFromXml(d[k],e);if("EWA_TREE_ROOT"!=l.Key){if(null==l.ParentKey||""==l.ParentKey)l.ParentKey=g.Key;h[l.Key]=l;var m=l.ParentKey;null!=h[m]&&h[m].AddChild(l)}}if(0<g.Children.length)for(k=0;k<g.Children.length;k=1+
k)this.Create(g.Children[k]);g.NodeShow(!0)}};this._CreateNodeFromXml=function(d,e){var g=new EWA_TreeNodeClass;g.ewa=this;g.Key=e.GetElementAttribute(d,"Key");g.ParentKey=e.GetElementAttribute(d,"ParentKey");g.Text=e.GetElementAttribute(d,"Text");g.IsMoreChildren="1"==e.GetElementAttribute(d,"IsMoreChildren")?!0:!1;g.MenuGroup=e.GetElementAttribute(d,"MenuGroup");for(var h=0;3>h;h+=1)g.AddParas[g.AddParas.length]=e.GetElementAttribute(d,"AddPara"+h);return g};this.Rename=function(d,e,g,h){null==
d&&(d=this._LastFocus);null!=d&&(this._RenameActionCmd=e,this._RenameRegex=g,this._RenameInfo=h,this._RenameNode="TREE_NODE"==d.tagName?d:this.GetNode(d),"EWA_TREE_ROOT"==this._RenameNode.Key?this._RenameNode=null:(d=this._RenameNode.GetObject(),d=d.rows[0].cells[d.rows[0].cells.length-1].childNodes[0],e=GetInnerText(d),d.style.display="none",g=this._GetInput(),d.parentNode.appendChild(g),g.value=e,g.setAttribute("EWA_OLD_VAL",e),g.style.width="300px",g.focus()))};this._GetInput=function(){for(var d=
this.ParentObject.getElementsByTagName("INPUT"),e=d.length-1;0<=e;e--){var g=d[e];if(g.getAttribute("onblur")&&0<g.getAttribute("onblur").indexOf("RenameBlur("))return this._InputDiv=g.parentNode,g}};this.RenameBlur=function(d){for(var e=d.getAttribute("EWA_OLD_VAL"),g=this._RenameNode,h=this.GetNode(g.GetObject().parentNode),k=0;k<h.Children.length;k+=1){var l=h.Children[k];if(l.Key!=g.Key&&l.Text.trim()==d.value.trim()){alert(_EWA_EVENT_MSG.OnTreeNodeNameRepeat);d.focus();return}}h=d.parentNode.childNodes[0];
this._InputDiv.appendChild(d);h.style.display="";if("NEW"==g.RenameType||e!=d.value){h.innerHTML=d.value;e=this._RenameActionCmd;null==e&&(e=new EWA.F.Cmd);if(null==e.EWA_ACTION||""==e.EWA_ACTION.trim())e.EWA_ACTION="NEW"==g.RenameType?"OnTreeNodeNew":"OnTreeNodeRename";"NEW"==g.RenameType&&(""==e.EWA_AFTER_EVENT&&(e.EWA_AFTER_EVENT='EWA.F.FOS["'+this._Id+'"].NewNodeAfter;'),h=this.GetNode(g.GetObject().parentNode),e.EWA_TREE_PARENT_KEY=h.Key);e.EWA_TREE_TEXT=d.value;e.EWA_TREE_KEY=g.Key;this._PostChange(e);
this._RenameActionCmd=null}};this.RenameKeyDown=function(d,e){d=d.keyCode?d.keyCode:d.which;13==d&&this.RenameBlur(e);27==d&&(d=e.getAttribute("EWA_OLD_VAL"),e.value=d,this.RenameBlur(e))};this.Delete=function(d,e){var g=this.GetNode(this._LastFocus);null!=g&&"EWA_TREE_ROOT"!=g.Key&&window.confirm(_EWA_EVENT_MSG.OnTreeNodeDelete)&&(!d&&(0<g.Children.length||g.IsMoreChildren)?(g.NodeShow(!0),alert(_EWA_EVENT_MSG.OnTreeNodeDeleteHaveChildren)):(d=e,null==d&&(d=new EWA.F.Cmd,d.EWA_ACTION="OnTreeNodeDelete"),
""==d.EWA_AFTER_EVENT&&(d.EWA_AFTER_EVENT='EWA.F.FOS["'+this._Id+'"].DeleteAfter();'),d.EWA_TREE_KEY=g.Key,this._PostChange(d)))};this.DeleteAfter=function(){var d=this.GetNode(this._LastFocus).GetObject(),e=d.parentNode;e.removeChild(d);d=this.GetNode(e);0==d.Children.length?this.GetNode(d.GetObject().parentNode).ChildLast.Key==d.Key?d.NodeCrossEnd(!0):d.NodeCross(!0):d.ChildLast.NodeCrossEnd();this._LastFocus=null};this.NewNode=function(d,e,g,h){null!=this._LastFocus&&(this._NewNodeTemp={TEXT:d,
CMD:e,REGEX:g,INFO:h},this.GetNode(this._LastFocus).NodeShow(!0),this.IsPostChange?this._NewNodeTimer=window.setInterval(function(){EWA.CurUI.IsPostChange||(window.clearInterval(EWA.CurUI._NewNodeTimer),EWA.CurUI._NewNode())},100):this._NewNode())};this._NewNode=function(){var d=this._NewNodeTemp.TEXT,e=this._NewNodeTemp.CMD,g=this._NewNodeTemp.REGEX,h=this._NewNodeTemp.INFO;this._NewNodeTemp=null;var k=new EWA_TreeNodeClass;k.ewa=this;this._CurNewNode+=1;k.Key="NEW_NODE_"+this._Id+"__"+this._CurNewNode;
k.RenameType="NEW";var l=_EWA_EVENT_MSG.OnTreeNodeNew+this._CurNewNode;null!=d&&0<d.trim().length&&(l=d.trim());k.Text=l;d=this.GetNode(this._LastFocus);0<d.Children.length&&d.Children[d.Children.length-1].NodeCross();d.AddChild(k);this.Create(k);d.NodeShow(!0);this.Rename(k,e,g,h)};this.NewNodeAfter=function(d,e,g){var h=this.GetNodeById("NEW_NODE_"+this._Id+"__"+this._CurNewNode);h.SetKey(d);h.SetAddParameters(null==e?"":e);h.SetMenuGroup(null==g?"":g);d=this.TestIcon(h);h.SetBookIcon(d)};this.GetNodeById=
function(d){d=$("#EWA_TREE_"+this._Id+' .ewa-tree-node[id="'+d+'"]');return 0==d.length?null:this.GetNode(d[0])};this.GetFocusNode=function(){return this.GetNode(this._LastFocus)};this.GetNode=function(d){if(null==d||null==d.tagName)return null;var e=d;for(d=0;("TABLE"!=e.tagName||"1"!=e.getAttribute("EWA_T"))&&"EWA_TREE_ROOT"!=e.id;)if(e=e.parentNode,d++,33<d||"BODY"==e.tagName)return null;d=new EWA_TreeNodeClass;d.ewa=this;d.Key=e.id;d.MenuGroup=e.getAttribute("EWA_MG");d.Object=e;var g=e.rows[0].cells[2];
d.Text=GetInnerText(g);for(var h=0;3>h;h+=1)d.AddParas[h]=g.childNodes[0].getAttribute("EWA_P"+h);h=e.getAttribute("EWA_TREE_MORE");d.IsMoreChildren="1"==h?!0:!1;if(1<e.rows.length){e=e.rows[1].cells[e.rows[1].cells.length-1];for(h=0;h<e.childNodes.length;h=1+h)g=e.childNodes[h],3!=g.nodeType&&"TABLE"==g.tagName&&"1"==g.getAttribute("EWA_T")&&d.Children.push(this.GetNode(g));0<d.Children.length&&(d.ChildLast=d.Children[d.Children.length-1])}return d};this.Click=function(d,e){if(!this.IsPostChange&&
(EWA.CurUI=this,d=d.srcElement?d.srcElement:d.target,"INPUT"!=d.tagName))if("DIV"==d.tagName&&(d=d.parentNode),"TD"==d.tagName&&0==d.className.indexOf("TD00")){var g=this.GetNode(d);g.NodeShow()}else{for(;("SPAN"!=d.tagName||null==d.getAttribute("EWA_CMD"))&&"1"!=d.getAttribute("EWA_TREE_TOP");)if(d=d.parentNode,"BODY"==d.tagName)return;g=this.GetNode(d);if("SPAN"==d.tagName&&(null!=d.getAttribute("EWA_CMD")||"1"==d.getAttribute("EWA_TREE_TOP"))){null!=this._LastFocus&&(this.GetNode(this._LastFocus).Mark(!1),
this._LastFocus=null);"1"!=d.getAttribute("EWA_TREE_TOP")&&g.Mark(!0);this._LastFocus=d;if(e)return d;0>this.Url.toUpperCase().indexOf("EWA_TREE_SKIP_GET_STATUS")&&EWA.F.ST.SaveStatus(g.Key,"TREE");this._RunCmd(g);this.MoveNode(g.GetObject())}}};this._RunCmd=function(d){var e=this.GetNode(d.GetObject().parentNode);if(this.link)this.link(d.Key,d);else{console.warn('\u5efa\u8bae\u91c7\u7528\u5b9a\u4e49 EWA.F.FOS["xx"].link = function(nodeKey, node){}');e='link("'+d.Key+'","'+e.Key+'","'+d.Text.replace(/\n/mig,
"\\n").replace(/\r/mig,"\\r").replace(/"/mig,"&quot;")+'"';for(var g=0;g<d.AddParas.length;g+=1)e=null==d.AddParas[g]?e+",null":e+(',"'+d.AddParas[g]+'"');EWA.C.Utils.RunCmd(e+");")}};this.ShowMenu=function(d){EWA.CurUI=this;var e=this.Click(d,!0);null!=this.Menu&&null!=e&&(e=this.GetNode(e),this.Menu.ShowByMouse(d,e.MenuGroup))};this.TestIcon=function(d){if(null==this.Icons)return"TD01A";for(var e in this.Icons){var g=this.Icons[e],h=null;switch(g.TEST.toUpperCase()){case "KEY":h=d.Key;break;case "PARENTKEY":h=
d.Parent.Key;break;case "TEXT":h=d.Text;break;case "P0":h=d.AddParas[0];break;case "P1":h=d.AddParas[1];break;case "P2":h=d.AddParas[2];break;case "MG":h=d.MenuGroup}if(null!=h&&eval("/"+g.FILTER+"/ig").test(h))return g.NAME+"A"}return"TD01A"};this.Create=function(d,e){if(null!=d)if(null==d.Parent)this._CreateFirst(d);else{var g=this._HtmlTemplate.replace("[ID]",'id="'+d.Key+'"');g=g.replace("[TEMP_NODE_ADD_FIELDS]",this.AddCols||"");for(var h="",k=0;k<d.AddParas.length;k+=1)null!=d.AddParas[k]&&
void 0!=d.AddParas[k]&&(h+="EWA_P"+k+'="'+d.AddParas[k]+'" ');g=g.replace("[TMP_ADD_PARAS]",h);g=g.replace("[EWA_MENU_GROUP]",d.MenuGroup);h=this.TestIcon(d);g=g.replace("[B]",h);g=g.replace("[C]",d.Text);g=d.IsMoreChildren?g.replace("[EWA_MORE_CHILDREN]","EWA_TREE_MORE='1'"):g.replace("[EWA_MORE_CHILDREN]","");0<d.Children.length||d.IsMoreChildren?(g=g.replace("[A]","TD00A"),g=d!=d.Parent.ChildLast?g.replace("[A1]","TD10B"):g.replace("[A1]","TD10A")):g=d==d.Parent.ChildLast?g.replace("[A]","TD00D"):
g.replace("[A]","TD00C");h=d.Parent.GetObject();1==h.rows.length&&(k=h.insertRow(-1),k.insertCell(-1),k.insertCell(-1),k.cells[1].colSpan=2);k=this.GetNodeLvl(d.Parent);g=g.replace("[LVL]",k+1);this._TempNode.innerHTML=g;g=this._TempNode.childNodes[0];h.rows[1].cells[h.rows[1].cells.length-1].appendChild(g);h.parentNode.childNodes[h.parentNode.childNodes.length-1]!=h&&(h.rows[1].cells[0].className="TD10B");d.Parent.NodeShow(!0);e&&e(g,this);for(k=0;k<d.Children.length;k+=1)this.Create(d.Children[k],
e)}};this.GetNodeLvl=function(d){var e=d;if(d.Object.getAttribute("tree_lvl"))return 1*d.Object.getAttribute("tree_lvl");for(var g=0;100>g;g++)if(e=this.GetParentNode(e),null==e)return d.Object.setAttribute("tree_lvl",g+1),g+1};this._CreateFirst=function(d,e){var g=this._HtmlTemplate1.replace("[ID]","id='"+d.Key+"'");g=g.replace("[B]",d.Text);this.ParentObject.innerHTML=g;for(g=0;g<d.Children.length;g+=1)this.Create(d.Children[g],e)};this.Init=function(d){var e=new EWA.C.Xml;e.LoadXml(d);this.Resources=
new EWA_FrameResoures;this.Resources.Init(e);-1!=this.Url.toUpperCase().indexOf("EWA_TREE_INIT_KEY")||0<this.Url.toUpperCase().indexOf("EWA_TREE_SKIP_GET_STATUS")||EWA.F.ST.GetStatus("TREE",this)};this.LoadStatus=function(){EWA.SHOW_ERROR=!1;this.ShowNode(_EWA_STATUS_VALUE)};this.ShowNode=function(d){if(null!=d&&""!=d&&"EWA_TREE_ROOT"!=d){var e=this.GetNodeById(d);null==e?(e=new EWA.F.Cmd,e.EWA_ACTION="OnTreeNodeStatus",e.EWA_AJAX="XML",e.EWA_TREE_KEY=d,e.EWA_TREE_STATUS="1",this._PostChange(e)):
(this._StatusNode=e,this.ShowNodeA())}};this.ShowNodeA=function(){var d=this._StatusNode;this._StatusNode=null;for(var e=d.GetObject().parentNode,g=this.GetNode(e);"EWA_TREE_ROOT"!=g.Key;)g.NodeShow(!0),g=this.GetNode(g.GetObject().parentNode);d.Mark(!0);this._LastFocus=d.GetObject();this._RunCmd(d);window.setTimeout(function(){e.focus()},0)};this.getUrlClass=function(){var d=new EWA_UrlClass;d.SetUrl(this.Url);return d};this.Reload=function(){}}

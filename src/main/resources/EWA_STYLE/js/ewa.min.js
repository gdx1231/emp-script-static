...
function(a){var b=new FileReader,c=this;b.onloadend=function(){var d=null,e={};$(c.target).find("img").each(function(){e[this.src]=!0});c.target.ownerDocument.execCommand("InsertImage",!1,this.result);$(c.target).find("img").each(function(){null!=d||e[this.src]||(d=this)});if(d){var g=c.tmpId(d);c.images.push({id:g,src:d.src,mode:"base64"});c.process()}else console.log("not img")};b.readAsDataURL(a.getAsFile())};this.processAsHtml=function(){var a=this.target,b=this;$(a).find("img").each(function(){if(!this.getAttribute("_tmp_id")){var c=
b.tmpId(this);this.src&&0!=this.src.indexOf(location.origin)&&b.images.push({id:c,src:this.src,mode:0==this.src.indexOf("data:image")?"base64":"normal"})}});this.processRemoveComments();$(a).find("*").each(function(){var c=$(this).css("background-image");c&&(c=c.replace("url(","").replace(")",""))&&c.startsWith("http://")&&b.images.push({id:EWA_MiscPasteTool.tmpId(this),src:c,mode:"background"});$(this).attr({onclick:null,onload:null,onkeydown:null,onkeyup:null,onerror:null,onmousedown:null,onmouseout:null,
...
var b=("r_"+Math.random()).replace(".","");a.setAttribute("_tmp_id",b);$(a).css("max-width","100%");return b};this.process=function(){if(0!=this.images.length){var a={d:JSON.stringify(this.images)};this.images=[];var b=this;$JP(this.handleUrl,a,function(c){if(c.rst)for(var d=0;d<c.rsts.length;d++){var e=c.rsts[d],g=e.id,h=e.local;"background"==e.mode?$(b.target).find('[_tmp_id="'+g+'"]').css("background-image","url("+h+")"):$(b.target).find('img[_tmp_id="'+g+'"]').attr("src",h)}else $Tip("\u5904\u7406\u9519\u8bef");
b.handleUrlAfterEvent&&b.handleUrlAfterEvent(c)})}};this.bind=function(a,b,c){if(b){this.handleUrl=b;this.images=[];this.target=a;var d=this;$(document).ready(function(){$(a).bind("paste",function(e){d.paste(e)})});this.handleUrlAfterEvent=c?c:null}else alert("\u8bf7\u5b9a\u4e49\u63d0\u4ea4\u5730\u5740")}}
...
var d=a.parentNode.getElementsByTagName("input")[1].value;b.innerHTML=a.parentNode.getElementsByTagName("input")[0].value}else"select"==a.tagName.toLowerCase()?(c=a.id,b.innerHTML=a.options[a.selectedIndex].text):(c=a.value.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/\n/ig,"<br>"),b.innerHTML=c,c=a.id),d=a.value;b=a.getAttribute("action_name");if(""==b||null==b)b="OnListFrameUpdateCell";var e=a.getAttribute("action_confirm");e=null==e?"":e;var g=a.getAttribute("action_tip");null==g&&(g="");
var h=a.getAttribute("action_js"),k=[];k[0]={Name:"EWA_FIELD_ID",Value:c};k[1]={Name:"EWA_FIELD_VAL",Value:d};k[2]={Name:"EWA_ACTION_RELOAD",Value:"0"};k[3]={Name:a.id,Value:a.value};c=this.ItemList.GetValue(a.id,"DataItem","DataType");k[4]={Name:"EWA_DATA_TYPE",Value:c};k[5]={Name:"EWA_FIELD_VAL_OLD",Value:a.getAttribute("old")};this.EditEvent={FROM:a,OLD_VAL:a.getAttribute("old"),NEW_VAL:a.value};this.DoAction(a,b,e,g,k,h)}else a.focus()};this.RewriteInfo=function(a,b,c,d){$X("EWA_LF_"+this._Id);

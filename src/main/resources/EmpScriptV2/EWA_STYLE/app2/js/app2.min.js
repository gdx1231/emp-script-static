...
console.log(b),console.log(f)}else d[e]=f}return d},log:function(){var b={},a;for(a in arguments){var c=arguments[a];try{var d=JSON.stringify(c)}catch(e){d=e}b["log"+a]=d}$JP2("console.jsp",b,function(){})},getBodySize:function(){let b=!1,a=document.documentElement.clientWidth,c=document.documentElement.clientHeight;if(screen.orientation){if(0===screen.orientation.angle||180===screen.orientation.angle)b=!0;return{width:a,height:c,orientation:b?"v":"h"}}if(this.IS_IN_IPHONE||this.IS_IN_IPAD){if(180===
window.orientation||0===window.orientation)b=!0}else b=180===window.orientation||0===window.orientation?!1:!0;return b?{width:a<c?a:c,height:a<c?c:a,orientation:"v"}:{height:a>c?c:a,width:a>c?a:c,orientation:"h"}},changeBodyHeight:function(b,a,c){b||(a=this.getBodySize(),b=a.width,a=a.height);EWA_App.DEBUG&&console.log("changeBodyHeight",b,a,c);$("body").css("height",a).css("width",b);$("section").css("width",b+"px").attr("aw",b);b>a?$("body").addClass("landscape"):$("body").removeClass("landscape")},
start:function(b){if(b)if(__SECTIONS[b]){this.FirstId=b;var a=this;window.addEventListener("orientationchange",function(e){setTimeout(function(){EWA_App.DEBUG&&console.log("orientation:"+window.orientation);var f=a.getBodySize();var g=f.height;(f=f.width)&&g&&EWA_App.changeBodyHeight(f,g,"\u5ef6\u65f61")},501)});this._clientHeight=document.documentElement.clientHeight;window.setInterval(function(){let e=a.getBodySize().height;a._clientHeight!=e&&(a._clientHeight=e,console.log("\u9ad8\u5ea6\u53d8\u5316\u4e86\uff1a"+
e),EWA_App.changeBodyHeight())},1E3);EWA_App.changeBodyHeight();EWA_App.State.init("home");EWA_App.State._is_replace=!0;b="";var c=window.location.href.split("#"),d=c[0];this.ENTRY_URL=d;1<c.length&&(b=c[1],b==this.FirstId&&(b=null));EWA_App.Section.createIScroll($("section#"+this.FirstId)[0],__SECTIONS[this.FirstId]);EWA_App.State.state(__SECTIONS[this.FirstId].Title,d+"#"+this.FirstId);b&&(EWA_App.DEBUG&&console.log("other_id",b),EWA_App.State.state("",d+"#"+b));EWA_App.startAfter&&EWA_App.startAfter()}else alert(" fristId\u300a\u7b2c\u4e00\u4e2a\u9875\u9762id\u300b\u5bf9\u5e94\u914d\u7f6e\u9879\u4e0d\u5b58\u5728__SECTIONS."+
b);else $Tip("\u8bf7\u5b9a\u4e49 fristId\u300a\u7b2c\u4e00\u4e2a\u9875\u9762id\u300b")},SplitEwa:function(b,a,c){b=EWA.F.FOS[b];var d=b.Url,e=new EWA_UrlClass;e.SetUrl(d);e.AddParameter("xmlname",a);e.AddParameter("itemname",c);b.Url=e.GetUrl()},back:function(b){if(b){var a=$(b).attr("t")||0,c=(new Date).getTime();if(300>c-a)return;$(b).attr("t",c)}var d;EWA_App.SECTION_SHOW&&(d=__SECTIONS[EWA_App.SECTION_SHOW.id]);d&&d.backBeforeEvent&&d.backBeforeEvent();this.backAction=!0;window.history.back();
d&&d.backAfterEvent&&d.backAfterEvent()}};

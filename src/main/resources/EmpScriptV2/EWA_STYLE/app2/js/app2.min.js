var EWA_App={IS_STOP_TOUCH_MOVE:!0,EWA_ROOT:"ewa.jsp",CFGS:null,CFGS_CURRENT:null,IS_IN_WEIXIN:/micromessenger/ig.test(navigator.userAgent),IS_IN_WEIXIN_MINI:/miniprogram/ig.test(navigator.userAgent),IS_IN_ANDROID:/android/ig.test(navigator.userAgent),IS_IN_IPHONE:/iphone/ig.test(navigator.userAgent),IS_IN_IPAD:/ipad/ig.test(navigator.userAgent),initCfgs:function(b){var a={},c;for(c in b){var d=b[c],e=d.ID;d=this.convertCfg(d);a[e]=d}this.CFGS={INIT:a};__SECTIONS=this.CFGS_CURRENT=a},attatchCfgs:function(b,
a){var c={},d;for(d in a){var e=a[d],f=e.ID;e=this.convertCfg(e);c[f]=e;this.CFGS_CURRENT[f]=e}this.CFGS[b]=c;__SECTIONS=this.CFGS_CURRENT},changeCfgs:function(b){b||="INIT";this.CFGS[b]?__SECTIONS=this.CFGS_CURRENT=this.CFGS[b]:alert(b+"\u7684\u914d\u7f6e\u4fe1\u606f\u4e0d\u5b58\u5728")},convertCfg:function(b){var a={IScroll:1,PageFooter:1,PageHeader:1,Refresh:1,ButtonOnFooter:1,EWA:1,IScrollMore:1},c={Installed:1,Losted:1,RefreshAfter:1,ShowCompleted:1},d={},e;for(e in b){var f=b[e];null!=f&&"string"==
typeof f&&(f=f.trim());if(f)if(a[e])d[e]="Y"==f?!0:!1;else if(c[e])try{eval("window.______js="+f),d[e]=window.______js,delete window.______js}catch(g){console.log(g),console.log(b),console.log(f)}else d[e]=f}return d},log:function(){var b={},a;for(a in arguments){var c=arguments[a];try{var d=JSON.stringify(c)}catch(e){d=e}b["log"+a]=d}$JP2("console.jsp",b,function(){})},getBodySize:function(){let b=!1,a=document.documentElement.clientWidth,c=document.documentElement.clientHeight;if(screen.orientation){if(0===
screen.orientation.angle||180===screen.orientation.angle)b=!0;return{width:a,height:c,orientation:b?"v":"h"}}if(this.IS_IN_IPHONE||this.IS_IN_IPAD){if(180===window.orientation||0===window.orientation)b=!0}else b=180===window.orientation||0===window.orientation?!1:!0;return b?{width:a<c?a:c,height:a<c?c:a,orientation:"v"}:{height:a>c?c:a,width:a>c?a:c,orientation:"h"}},changeBodyHeight:function(b,a,c){b||(a=this.getBodySize(),b=a.width,a=a.height);EWA_App.DEBUG&&console.log("changeBodyHeight",b,a,
c);$("body").css("height",a).css("width",b);$("section").css("width",b+"px").attr("aw",b);b>a?$("body").addClass("landscape"):$("body").removeClass("landscape")},start:function(b){if(b)if(__SECTIONS[b]){this.FirstId=b;var a=this;window.addEventListener("orientationchange",function(e){setTimeout(function(){EWA_App.DEBUG&&console.log("orientation:"+window.orientation);var f=a.getBodySize();var g=f.height;(f=f.width)&&g&&EWA_App.changeBodyHeight(f,g,"\u5ef6\u65f61")},501)});this._clientHeight=document.documentElement.clientHeight;
window.setInterval(function(){let e=a.getBodySize().height;a._clientHeight!=e&&(a._clientHeight=e,console.log("\u9ad8\u5ea6\u53d8\u5316\u4e86\uff1a"+e),EWA_App.changeBodyHeight())},1E3);EWA_App.changeBodyHeight();EWA_App.State.init("home");EWA_App.State._is_replace=!0;b="";var c=window.location.href.split("#"),d=c[0];this.ENTRY_URL=d;1<c.length&&(b=c[1],b==this.FirstId&&(b=null));EWA_App.Section.createIScroll($("section#"+this.FirstId)[0],__SECTIONS[this.FirstId]);EWA_App.State.state(__SECTIONS[this.FirstId].Title,
d+"#"+this.FirstId);b&&(EWA_App.DEBUG&&console.log("other_id",b),EWA_App.State.state("",d+"#"+b));EWA_App.startAfter&&EWA_App.startAfter()}else alert(" fristId\u300a\u7b2c\u4e00\u4e2a\u9875\u9762id\u300b\u5bf9\u5e94\u914d\u7f6e\u9879\u4e0d\u5b58\u5728__SECTIONS."+b);else $Tip("\u8bf7\u5b9a\u4e49 fristId\u300a\u7b2c\u4e00\u4e2a\u9875\u9762id\u300b")},SplitEwa:function(b,a,c){b=EWA.F.FOS[b];var d=b.Url,e=new EWA_UrlClass;e.SetUrl(d);e.AddParameter("xmlname",a);e.AddParameter("itemname",c);b.Url=e.GetUrl()},
back:function(b){if(b){var a=$(b).attr("t")||0,c=(new Date).getTime();if(300>c-a)return;$(b).attr("t",c)}var d;EWA_App.SECTION_SHOW&&(d=__SECTIONS[EWA_App.SECTION_SHOW.id]);d&&d.backBeforeEvent&&d.backBeforeEvent();this.backAction=!0;window.history.back();d&&d.backAfterEvent&&d.backAfterEvent()}};
...
"disabled"));e.append(k)})},footerButtonRelate:function(b){var a=b.attr("last_t")||0,c=(new Date).getTime();500>c-a||(b.setAttribute("last_t",c),a=$(b).attr("rid"),c=$X(a),null==c?console.log("\u4e0d\u80fd\u627e\u5230 ref_obj id="+a):(c.onclick(),$(b).parent().find("input").each(function(){var d=$(this).attr("rid"),e=$X(d);null==e?console.log("\u4e0d\u80fd\u627e\u5230 ref_obj id="+d):(this.value=e.value,"none"==e.style.display||e.disabled?this.setAttribute("disabled","disabled"):this.removeAttribute("disabled"))})))},
bindAEvents:function(b){var a=this;$(b||EWA_App.SECTION_SHOW).find("a").each(function(){a.bindAEvent(this)})},bindAEvent:function(b){b=$(b);if(!b.attr("ckjs")){var a=this,c=b.attr("href");!c||0>c.indexOf("#")||(b[0].addEventListener("click",function(d){a.handleAClick(this,d);return!1},!1),b.attr("ckjs","g"))}},handleAClick:function(b,a){a&&(a.stopPropagation(),a.preventDefault());a=(new Date).getTime();var c=$(b).attr("t");$(b).attr("t",a);if(!(c&&144>a-c)){var d=b.href;if(!(null==d||0>d.indexOf("#"))){a=
EWA_App.Section.getParas(d);if(a.section_id&&EWA_App.State.prevShow==$("section[id="+a.section_id+"]")[0])return!1;var e=b.innerText.trim();$(b).addClass("act");d=EWA_App.ENTRY_URL+"#"+d.split("#")[1];EWA_App.DEBUG&&console.log(d);var f=(new EWA_UrlClass(d)).GetParameter("EWA_APP_SECTION_REPLACE");EWA_App.DEBUG&&console.log(f);EWA_App.handleAClickBefore?EWA_App.handleAClickBefore(a,d,e,function(){EWA_App.State.state(e,d,!1,f)}):setTimeout(function(){EWA_App.State.state(e,d,!1,f)},10);setTimeout(function(){$(b).removeClass("act")},
500)}}},showLargeAddButton:function(b,a){var c=$(EWA_App.SECTION_SHOW),d=c.find(".ewa-grid-frame"),e=c.find(".ewa-lf-frame");if(0<d.length){if(0<d.find(".ewa_grid_li").length)return;d=d.parent()}else if(0<e.length){if(0<e.find(".ewa-lf-data-row").length)return;d=e.parent()}else return;var f=$('<a class="ewa-app-large-add-btn"></a>');b||="enus"==EWA.LANG?"Publish your work and let more people know about you":"\u53d1\u8868\u60a8\u7684\u4f5c\u54c1\uff0c\u8ba9\u66f4\u591a\u7684\u4eba\u4e86\u89e3\u60a8\u3002";
f.text(b);d.html("").append(f);if(a)f[0].onclick=function(){a(this)};else{var g=this;setTimeout(function(){var h=c.find(".ewa-app-btn-add a").attr("href");f.attr("href",h);g.bindAEvent(f[0])},444)}},showBtnAdd:function(b,a){b=$(b).find(".ewa-app-btn-add");b.html("<a></a>");b.show();a&&(b.find("a").attr("href",a),this.bindAEvent(b.find("a")[0]));return b},hideBtnAdd:function(b){b=$(b).find(".ewa-app-btn-add");b.hide();return b},swapPage:function(b,a,c){var d=$(b).attr("id"),e=$(a).attr("id"),f=__SECTIONS[e],
g=__SECTIONS[d];if(d==e){if(f.ShowCompleted)try{f.ShowCompleted(a,b)}catch(m){console.log(f.ShowCompleted,m)}this.hideCoverDiv()}else{EWA_App.DEBUG&&console.log("swapPage",b,a,c);if(f.ShowPlusButton){d=(new EWA_UrlClass).GetParas();var h=f.ShowPlusButton;d&&(h=h+"&"+d);this.showBtnAdd(a,h+("&EWA_APP_FROM_SECTION_ID="+e))}else{var k=null;if(0==e.indexOf("ewa")||"Y"==f.SHOW_LF_ADD)d=$("section#"+e+" .ewa_lf_func"),d.find("input[type=button]").each(function(){var m=$(this).attr("res");m&&0<m.indexOf("butAdd")&&
(k=$(this).attr("onclick"))}),k||=d.find(".ewa_lf_func_dact[ewa_click]:eq(0)").attr("ewa_click");EWA_App.DEBUG&&(console.log("\u6dfb\u52a0\u6309\u94ae"),console.log(k));k?this.showBtnAdd(a).find("a").attr("onclick",k):this.hideBtnAdd(a)}g&&(g.Losted&&g.Losted(b),!g.Refresh&&g.myScroll&&(g.myScroll.___x=g.myScroll.x,g.myScroll.___y=g.myScroll.y));$(a).find("footer a.ft-item").each(function(){$(this).removeClass("ft-item-cur");$(this).attr("href").split("?")[0]=="#"+e&&$(this).addClass("ft-item-cur")});
c&&EWA_App.IS_IN_WEIXIN&&(d=f._title_old||f.Title,document.title=d,this.setWeiXinTitle(d));if(f&&"direct"==f.swap)EWA_App.DEBUG&&console.log(f.swap),$(b).hide(),$(a).css("display","flex"),$(a).css("-webkit-transform","translate3d(0,0,0)"),f.swap="",this.showCompleted(b,c);else{var l=EWA_App.Ani.getCss(c?g.swap:f.swap);c?$(a).css(l.INIT_BACK):$(a).css(l.INIT);$(a).css("display","flex");!f.Refresh&&f.myScroll&&f.myScroll.___y&&(EWA_App.DEBUG&&console.log(f.myScroll.___x,f.myScroll.___y),f.myScroll.scrollTo(f.myScroll.___x,
f.myScroll.___y,0));var p=this;setTimeout(function(){c?($(b).css(l.BACK_HIDE),$(a).css(l.BACK_SHOW),EWA_App.DEBUG&&console.log(b,a),EWA_App.DEBUG&&console.log(l.BACK_HIDE,l.BACK_SHOW)):($(b).css(l.HIDE),$(a).css(l.SHOW));setTimeout(function(){"pop"!=f.swap&&($(b).css({"-webkit-transform":"","-webkit-transition":""}),$(b).hide());if(f.ShowCompleted)try{f.ShowCompleted(a,b)}catch(r){console.log(f.ShowCompleted,r)}if(f.InitScrollToElement){var m=$(f.InitScrollToElement);0==m.length?EWA_App.DEBUG&&console.log("showCfg.InitScrollToElement none"):
f.myScroll.scrollToElement(m[0],f.InitScrollToElementTimer||0);f.InitScrollToElementTimer=null;f.InitScrollToElement=null}p.showCompleted(b,c)},500)},1)}}},showCompleted:function(b,a){this.hideCoverDiv();b=$(b).attr("id");var c=__SECTIONS[b];if(c){var d=!1;a?c.Refresh&&(d=!0):c.RefreshBackAction&&(d=!0);d&&(EWA_App.DEBUG&&console.log("showCompleted ("+b+") -> clear content!"),c.myScroll&&(c.myScroll.destroy(),delete c.myScroll,c.myScroll=null),$("section#"+b).remove())}},moveSplitToFooter:function(){var b=
$(EWA_App.SECTION_SHOW),a=b.find("footer");if(0!=a.length&&!__SECTIONS[b.attr("id")].IScrollMore){var c=b.find(".ewa-lf-frame").attr("id");if(c&&EWA.F.FOS[c.replace("EWA_LF_","")]){c=a.attr("rid");c||(c=EWA_Utils.tempId("_rid_"),a.attr("rid",c));var d=b.find(".content .ewa-lf-frame-split");0<d.length&&d.attr("rid1")!=c&&(d.attr("rid1",c),a.html("").append(d),a=d.find("td:eq(0) b:last()").text())&&(a="<span class='records'> ("+a+")</span>",b.find("header h1 .records").remove(),b.find("header h1").append(a))}}}};

...
console.log(b),console.log(f)}else d[e]=f}return d},log:function(){var b={},a;for(a in arguments){var c=arguments[a];try{var d=JSON.stringify(c)}catch(e){d=e}b["log"+a]=d}$JP2("console.jsp",b,function(){})},getBodySize:function(){let b=!1;if(screen.orientation){if(0===screen.orientation.angle||180===screen.orientation.angle)b=!0;return{width:screen.availWidth,height:screen.availHeight,orientation:b?"v":"h"}}if(this.IS_IN_IPHONE||this.IS_IN_IPAD){if(180===window.orientation||0===window.orientation)b=
!0}else b=180===window.orientation||0===window.orientation?!1:!0;let a=screen.availWidth,c=screen.availHeight;return b?{width:a<c?a:c,height:a<c?c:a,orientation:"v"}:{height:a>c?c:a,width:a>c?a:c,orientation:"h"}},changeBodyHeight:function(b,a,c){b||(a=this.getBodySize(),b=a.width,a=a.height);EWA_App.DEBUG&&console.log("changeBodyHeight",b,a,c);$("body").css("height",a).css("width",b);$("section").css("width",b+"px").attr("aw",b);b>a?$("body").addClass("landscape"):$("body").removeClass("landscape")},

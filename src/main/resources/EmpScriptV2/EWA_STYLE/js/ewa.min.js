...
function _$J_SELECT(a,b,c,d,e,g,h,k){function l(v,u){var y=v[c],w=b.options[b.options.length]=new Option(y,v[d]);if(u){for(var x=[],A=0;A<u;A++)x.push("");x.push(y);x.join("\u3000")}for(var B in v)v[B]&&w.setAttribute("para_"+B.toLowerCase(),v[B]);w.setAttribute("json",JSON.stringify(v));return w}b.options.length=0;e&&(b.options[0]=new Option("",""),e instanceof Array&&(b.options[0].text=e[0],b.options[0].value=e[1]));if(k){var m=function(v,u){if((v=n[v])&&v._children&&0!=v._children.length)for(var y,
w=0;w<v._children.length;w++)y=v._children[w],l(y,u),m(y[d],u+1)},n={___ROOT___:[]};e={___ROOT___:{}};for(var p,t,r,q=0;q<a.length;q++){r=a[q];p=r[k];t=r[d];if(null===p||""===p||"0"===p)p="___ROOT___";n[p]||(n[p]=[]);n[p].push(r);e[t]=r;e[p]&&(e[p]._children||(e[p]._children=[]),e[p]._children.push(r))}m("___ROOT___",0)}else for(q=0;q<a.length;q++)r=a[q],l(r);g&&(b.value=g);$(b).trigger("change");h&&h(b)}
...
"";b=b.document.getElementsByClassName("but")[0];b.style.pointerEvents="";b.style.filter=""}else if("TEXTAREA"==this.tagName){var c=$(this).parent();b=c.find("iframe")[0].contentWindow;b.document.body.contentEditable=!0;b.document.body.style.backgroundColor="";c.find(".ewa-editor").removeAttr("ewadisabled")}})};this.convertFilterCheckbox=function(a,b,c,d,e,g){function h(u){var y=$("<nobr></nobr>");p.append(y);p.append(" ");var w=$(u).parent();u=$(u).attr("id")+"_"+t;w.attr("id",u);y.append(w.children());
y.attr("ref_id",u)}function k(u){u=$(u).parent();var y=u.attr("ref_id");y&&($("#"+y).append(u.children()),u.remove())}var l={},m=this.getObj(".ewa-row-"+a),n=this.getObj(".ewa-row-"+b),p=$("<div class='ewa-filter-checked'></div>");m.find("#"+a).prepend(p).addClass("ewa-filter-chks");var t=this._Id;c||(c="PY");m.find("input[type=checkbox]").each(function(){var u=JSON.parse($(this).attr("json"))[c];u&&(u=u.toUpperCase().trim().substring(0,1),l[u]||(l[u]=[]),l[u].push(this.id),this.checked&&h(this),
...
$(a).attr("recycle",1).addClass("ewa-lf-func-recycle-yes"));this.Url=b;this.Goto(1)};this.BindButton=function(a,b){$("#EWA_LF_"+this._Id+' tr[ewa_key] [id="'+a+'"]').each(function(){$(this).attr("onclick","$(this).parent().parent().find('[id=\""+b+"\"]')[0].click()");$(this).addClass("ewa-map-button")})};this.Merge=function(a,b,c,d){$("#EWA_LF_"+this._Id+" tr[ewa_key]").each(function(){var e=$(this).find('[id="'+a+'"]');e.parent().hide();var g=$(this).find('[id="'+b+'"]').parentsUntil("tr").last();
c||(c="<br>");0<=c.indexOf("<")?g.append(c):g.append("<span class='ewa-mearge-str'>"+c+"</span>");g.append(e);d&&d(g,this)});$("#EWA_LF_"+this._Id+' tr[ewa_tag="HEADER"] [id="'+a+'"]').parent().hide()};this.Mearge=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 Merge");this.Merge(a,b,c)};this.MergeExp=function(a,b,c,d){if(b){var e=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),g=[],h=b,k={};for(b=0;b<e.length;b++){var l=e[b];g.push(l);var m=l.replace("@@","");h=h.replace(l,"<span class='ewa-lf-mearge ewa-lf-mearge-"+
m+"' mid=\""+m+'"></span>');m!=a&&$("#EWA_LF_"+this._Id+' tr[ewa_tag="HEADER"] [id="'+m+'"]').parent().hide();k[m]=$("#EWA_LF_"+this._Id+' tr[ewa_tag="HEADER"] [id="'+m+'"]').html()}$("#EWA_LF_"+this._Id+" tr[ewa_key]").each(function(){var n=document.createElement("div");n.style.display="none";n.innerHTML=h;document.body.appendChild(n);if(0==$(this).find('[id="'+a+'"]').length)console.log("not find "+a);else{var p=$(this).find('[id="'+a+'"]').parent(),t;for(t in g){var r=g[t].replace("@@",""),q=$(this).find('[id="'+
r+'"]');if(0!=q.length){r!=a&&q.parent().hide();var v=$(n).find('span[mid="'+r+'"]');c&&(v.append("<span class='ewa-lf-mearge-memo'></span>"),v.find(".ewa-lf-mearge-memo").html(k[r]));v.append(q)}}for(;0<n.childNodes.length;)p.append(n.childNodes[0]);$(n).remove();d&&d(p,this)}})}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MeargeExp=function(a,b,c,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 MereExp");this.MergeExp(a,b,c,d)};this.SubBottoms=function(a){this.SubBottomsArray=
a.split(",");this._SubBottoms()};this._SubBottoms=function(){var a=this.AddRow([]);$(a).find("td").addClass("ewa-lf-sub-td");var b=0,c;for(c in this.SubBottomsArray){var d=this.SubBottomsArray[c],e=0;$("#EWA_LF_"+this._Id+" .ewa-col-"+d).each(function(){var g=GetInnerText(this).replace(/,/ig,"");isNaN(g)||(e+=1*g,0<g.indexOf(".")&&(b=2))});$(a).find("td[id=ADD_ROW_"+d+"]").html("<nobr class='ewa-lf-sub'>"+e.fm(b)+"</nobr>")}};this.ChangeRowStyle=function(a,b,c){for(var d=$X("EWA_LF_"+this._Id),e=
...
a)}catch(b){console.log(b,this.MOutEvent)}this._CurTr=null}};this.MDownEnableCheck=function(a,b){return!0};this.MDown=function(a,b){if(this.IsTrSelect&&(b=null==b?event:b,this.MDownEnableCheck(a))){if(b){var c=b.srcElement?b.srcElement:b.target;if(c&&("A"==c.tagName||"INPUT"==c.tagName||"SELECT"==c.tagName||"BUTTON"==c.tagName||"TEXTAREA"==c.tagName||0<=c.className.indexOf("EWA_LF_EDIT")||0<=c.className.indexOf("ewa-lf-edit")||0<=c.className.indexOf("ewa-lf-search-text-click")||0<=c.parentNode.className.indexOf("ewa-lf-search-text-click")||
0<=c.parentNode.parentNode.className.indexOf("ewa-lf-search-text-click")))return}var d=(new Date).getTime(),e=$(a).attr("mdown_time_last");if(!(null!=e&&500>d-e)){$(a).attr("mdown_time_last",d);d=null;if(!this.IsNotMDownAutoChecked){var g=a.getElementsByTagName("input");if("INPUT"!=c.tagName&&0<g.length)for(c=0;c<g.length;c++){if("RADIO"==g[c].type.toUpperCase()){d=g[c];d.click();break}if("CHECKBOX"==g[c].type.toUpperCase()&&0>g[c].parentNode.className.indexOf("ewa-switch")){d=g[c];d.click();break}}}if("1"==
a.getAttribute("__ewa_lf_mdown"))this._TrSelectMulti&&(d&&"CHECKBOX"==d.type.toUpperCase()&&(d.checked=!1),this._MSetBg(a,""),a.removeAttribute("__ewa_lf_mdown"),$(a).removeClass("ewa-lf-mdown"));else{d&&(d.checked=!0);this._MSetBg(a,"down");a.setAttribute("__ewa_lf_mdown",1);$(a).addClass("ewa-lf-mdown");if(!this._TrSelectMulti&&(d=a.parentNode)&&d.rows)for(c=0;c<d.rows.length;c++)e=d.rows[c],"1"==e.getAttribute("__ewa_lf_mdown")&&e!=a&&(e.removeAttribute("__ewa_lf_mdown"),$(e).removeClass("ewa-lf-mdown"),
this._MSetBg(e,""));if(this.IsReShow)for(c=0;c<g.length;c++)"BUTTON"==g[c].type.toUpperCase()&&(d=g[c],"true"==d.getAttribute("disabled")||1==d.getAttribute("disabled")||"true"==d.parentNode.getAttribute("disabled")||1==d.parentNode.getAttribute("disabled")?(this._ReshowButs[d.value].disabled=!0,this._ReshowButs[d.value].style.display="none"):(this._ReshowButs[d.value].disabled=!1,this._ReshowButs[d.value].style.display=""))}if(this._IsAddPreRow){if(g=a.getAttribute("ewa_key"),this.AddPreRowCheck(a,
g,b)){d=a.parentNode.rows[a.rowIndex+1];if(null==d||1!=d.getAttribute("add_pre_row"))d=a.parentNode.parentNode,c=d.rows[0].cells.length,d=d.insertRow(a.rowIndex+1),d.setAttribute("add_pre_row",1),e=d.insertCell(-1),e.innerHTML="",e.colSpan=c,e.className="",d.style.display="none",e.id=("EWA_LF_NR_"+this._Id+"_"+Math.random()).replace(".","G"),$(d).addClass("ewa-lf-add-pre-row");this.prevTr&&(this.AddPreRowCloseBeforeEvent&&this.AddPreRowCloseBeforeEvent(this._Id,a,g,this.prevTr,b),this.prevTr.style.display=
"none",this.prevTr.cells[0].innerHTML="",this.AddPreRowCloseEvent&&this.AddPreRowCloseEvent(this._Id,a,g,this.prevTr,b));this.prevTr==d?this.prevTr=null:(this.prevTr=d,this.prevTr.style.display="",this.MDownEvent(this._Id,a,g,this.prevTr,b))}}else this.MDownEvent(a,b)}}};this.AddPreRow=function(a){this._IsAddPreRow||(this.MDownEvent=a);this._IsAddPreRow=!0};this.AddPreRowCheck=function(a,b,c){return!0};this.AddPreRowCloseBeforeEvent=function(a,b,c,d,e){};this.AddPreRowCloseEvent=function(a,b,c,d,
e){};this._MSetBg=function(a,b){var c="EWA_TD_M";"down"==b?c="ewa_grid_down":"over"==b&&(c="ewa_grid_mover");for(b=0;b<a.cells.length;b++)$(a.cells[b]).removeClass("ewa_grid_mover ewa_grid_down EWA_TD_M").addClass(c)};this._ReShowSearchQuick=function(){var a=this,b=EWA_ListFrameClass.prototype.RESOURCES.search_text_items,c,d,e;for(e in b){var g=b[e];"eq"==g.Id&&(c=g);"lk"==g.Id&&(d=g)}for(e in this._SearchJson){var h=this._SearchJson[e];h.isSearchQuick&&(b=$("#EWA_LF_"+this.Id+' .ewa-lf-data-row [id="'+
e+'"]'),b.bind("click",function(k){k.stopPropagation();k=$(this).attr("search_tag");var l=$(this).text(),m=l,n=$("#EWA_SEARCH_ITEM_"+a.Id+' .ewa-lf-search-item-ctl [name="'+this.id.toUpperCase()+'"]');if("number"==k||"date"==k)n=n.parentsUntil(".ewa-lf-search-item").last().find("input");var p=n.parentsUntil(".ewa-lf-search-item").last().find("a");if("date"==k)l=l.split(" ")[0],m=l+" 23:59:59";else if("fix"==k){var t=null;n.find("option").each(function(){this.text==l&&(t=this.value)});l=null===t?"":
t}n.val()==l?("text"==k&&d&&0<p.length&&(p.attr("tag",d.Id),p.html("enus"==EWA.LANG?d.TxtEn:d.Txt)),n.val("")):("text"==k&&c&&0<p.length&&(p.attr("tag",c.Id),p.html("enus"==EWA.LANG?c.TxtEn:c.Txt)),n.val(l),"date"==k&&(n[1].value=m))}),b.each(function(){$(this).text()&&$(this).addClass("ewa-lf-search-text-click").attr("search_tag",h.T)}))}};this.ReShowWithNoButtons=function(){var a=$X("EWA_LF_"+this._Id),b=[],c;for(c in this.ItemList.Items){var d=this.ItemList.Items[c],e=this._GetSubValue("Tag","Tag",
d);if(null!=e&&"button"==e.trim().toLowerCase())for(e=0;e<a.rows[0].cells.length;e++)if(a.rows[0].cells[e].childNodes[0].id.toUpperCase()==c){b.push(e);d.setAttribute("but_show","1");break}}this.ShowHiddenColumns(b,!1)};this.ReShowButtonsInDailogTitle=function(){EWA.OW.Load();if(EWA.OW.Dia){var a=$(EWA.OW.Dia._Dialog.GetFrameTitle()),b=$($X("EWA_RESHOW_"+this._Id)).find("td.ewa_lf_func:eq(0)"),c=this;b.find(".ewa_lf_func_dact").each(function(){this.id=EWA_Utils.tempId("gDx_"+c._Id+"_")});a.html(b.html());
a.find(".ewa_lf_func_dact").each(function(){this.onclick=function(){b.find('div[id="'+this.id+'"]').click()}});b.parent().hide();$(EWA.OW.Dia._Dialog.GetFrame()).addClass("ewa-lf-btns-in-title")}};this.ReShow=function(a){this.IsReShow=!0;a=document.createElement("table");a.id="EWA_RESHOW_"+this._Id;a.cellSpacing="0";a.cellPadding="0";var b=!(0<this.Url.toUpperCase().indexOf("EWA_AJAX=INSTALL")||0<this.Url.toUpperCase().indexOf("EWA_CALL_METHOD=INNER_CALL")||0<this.Url.toUpperCase().indexOf(".JSP"));
b?EWA.UI.Utils.SetStyle(a,"width:100%;height:100%;"):EWA.UI.Utils.SetStyle(a,"width:100%");var c=a.insertRow(-1),d=c.insertCell(-1),e=a.insertRow(-1).insertCell(-1);e.className="ewa_lf_func";e.innerHTML='<div style="display:none"></div><div></div>';var g=a.insertRow(-1).insertCell(-1);g.vAlign="top";EWA.UI.Utils.SetStyle(g,"width:100%;");css="";g.innerHTML='<div id="_G_'+this._Id+'" style="'+css+'"></div>';var h=$X("EWA_LF_"+this._Id),k=h.parentNode.parentNode.parentNode;g.childNodes[0].appendChild(h.parentNode);
var l="_G_"+this._Id;this.NewDivId=l;b&&(window.setTimeout(function(){$X("__EWA_DEBUG")&&g.childNodes[0].appendChild($X("__EWA_DEBUG"));var z=$X(l);z.getElementsByTagName("table");var C=EWA.UI.Utils.GetDocSize(window),D=z.parentNode.parentNode.previousSibling.offsetHeight;z.style.top=D+"px";z.style.height=C.H-D+"px"},100),addEvent(window,"resize",function(){var z=$X(l),C=EWA.UI.Utils.GetDocSize(window),D=z.parentNode.parentNode.previousSibling.offsetHeight;z.style.top=D+"px";z.style.height=C.H-D+
"px"}));for(;0<k.childNodes.length;)e.childNodes[0].appendChild(k.childNodes[0]);var m=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",e.childNodes[1]);m.className="ewa_lf_func_caption";b=m;var n=[],p=!1,t=GetInnerText(e);t=t.trim();this._ReshowButs={};for(var r in this.ItemList.Items){m=this.ItemList.Items[r];var q=this._GetSubValue("Tag","Tag",m);if(null!=q&&("button"==q.trim().toLowerCase()||"butflow"==q.trim().toLowerCase()))for(q=0;q<h.rows[0].cells.length;q++)if(h.rows[0].cells[q].childNodes[0].id.toUpperCase()==
r){n.push(q);p=!0;q=this._GetSubValue("DescriptionSet","Info",m);var v=this._GetSubValue("DescriptionSet","Memo",m),u=this._GetSubValue("EventSet","EventName",m),y="";null!=u&&"ewa_click"==u.toLowerCase().trim()&&(y=this._GetSubValue("EventSet","EventValue",m));t=t.replace(q,"");m=this._ReShowButton(q,v,null);this._ReshowButs[q]=m;m.setAttribute("f_id",this._Id);e.childNodes[1].appendChild(m);""==y?m.onclick=function(){var z=this.getAttribute("f_id");z=EWA.F.FOS[z].SelectCheckedRows();if(null==z||
0==z.length)EWA.UI.Msg.Alert(_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM"],_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM_TITLE"]);else{z=z[0].getElementsByTagName("input");for(var C=0;C<z.length;C++){var D=z[C];if("button"==D.type&&D.value==this.childNodes[0].innerHTML){D.click();break}}}}:(m.setAttribute("ewa_click",y),m.onclick=function(){eval(this.getAttribute("ewa_click"))});break}}p&&this._ReShowSplit(e.childNodes[1]);n=e.getElementsByTagName("input");h={};for(q=0;q<n.length;q++){var w=n[q];w.style.display="none";
if(null==w.id||""==w.id)w.id=("_tmp_"+Math.random()).replace(".","_");if("button"==w.type){if(m=this._ReShowButton(w.value,w.title,w.id),p=w.nextSibling){var x="";3==p.nodeType&&(x=p.nodeValue.trimEx());"|"==x&&this._ReShowSplit(e.childNodes[1])}}else(p=w.nextSibling)&&(x=3==p.nodeType?p.nodeValue.replace("|",""):p.innerHTML),m=this._ReShowButton(x.trimEx(),w.title,w.id),m.id=("_tmp_"+Math.random()).replace(".","_"),h[w.name]||(h[w.name]=[]),h[w.name].push(m.id);e.childNodes[1].appendChild(m)}t=t.replace(/ /ig,
"").replace(/\|/ig,"").trimEx();""!=t?0<=t.indexOf("if")?c.style.display="none":d.innerHTML=t.replace(/ /,""):c.style.display="none";k.appendChild(a);for(r in h)for(x=h[r],q=0;q<x.length;q++)w=$X(x[q]),w.setAttribute("_r_ids",x.join(",")),w.onclick=function(){var z=this.getAttribute("_ewa_event_id");$X(z).click();z=this.getAttribute("_r_ids").split(",");for(var C=0;C<z.length;C++)w.id!=z[C]&&($X(z[C]).style.fontWeight="",$X(z[C]).style.color="");this.style.fontWeight="bold";this.style.color="blue"};
b.innerHTML='<b>[<i class="fa fa-star-o"></i>&nbsp;'+this.Description+"]</b>";if(0<this.Url.toUpperCase().indexOf("EWA_BTNS_IN_TITLE"))var A=this,B=0,E=setInterval(function(){B++;1E3<B&&window.clearInterval(E);EWA.OW.Load();EWA.OW.Dia&&(window.clearInterval(E),A.ReShowButtonsInDailogTitle())},10)};this._ReShowSplit=function(a){EWA.UI.Utils.CreateObject(window,"div","",a).className="ewa_lf_func_split"};this._ReShowButton=function(a,b,c){var d=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",
document.body);d.innerHTML="<nobr>"+a+"</nobr>";null!=c&&(d.setAttribute("_ewa_event_id",c),d.onclick=function(){var e=this.getAttribute("_ewa_event_id");$X(e).click()});EWA.B.IE&&(d.onselectstart=function(){return!1});d.className="ewa_lf_func_dact";d.title=b;return d};this.CheckValid=function(a){var b=a.tagName.toLowerCase();if("span"==b||"img"==b||"div"==b)return!0;b=this.ItemList.GetObjectValue(a);return this.ItemList.CheckValid(a,b)};this.ShowEdit=function(a){a.parentNode.style.width=a.clientWidth+
"px";a.style.display="none";__show_obj__=a.nextSibling;__show_obj__.style.display="";var b=__show_obj__.childNodes[0];3==b.nodeType&&(b=__show_obj__.childNodes[1]);b.setAttribute("old",b.value);"SELECT"!=b.tagName||b.getAttribute("func")||(b.setAttribute("func",1),b.onchange=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)});null==b.getAttribute("__ewa_fid__")&&(b.setAttribute("__ewa_fid__",this._Id),b.onblur=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)},
b.onkeydown=function(c){c=null==c?window.event:c;var d=c.target?c.target:c.srcElement;13==c.keyCode&&"INPUT"==d.tagName&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this);27==c.keyCode&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditReset(this)});setTimeout(function(){b.focus()},10)};this.EditReset=function(a){a.parentNode.style.display="none";var b=a.parentNode.previousSibling;b.style.display="";b.innerHTML=a.getAttribute("old");"select"==a.tagName.toLowerCase()?b.innerHTML=a.options[a.selectedIndex].text:
a.value=a.getAttribute("old").replace(/</ig,"&lt;").replace(/>/ig,"&gt;")};this.EditAfter=function(a){if(this.CheckValid(a))if(a.getAttribute("old")==a.value)this.EditReset(a);else{a.parentNode.style.display="none";var b=a.parentNode.previousSibling;b.style.display="";if("droplist"==a.getAttribute("ewa_class")){var c=$(a.parentNode.getElementsByTagName("input")[1]).attr("name");var d=a.parentNode.getElementsByTagName("input")[1].value;b.innerHTML=a.parentNode.getElementsByTagName("input")[0].value}else"select"==
a.tagName.toLowerCase()?(c=$(a).attr("name"),b.innerHTML=a.options[a.selectedIndex].text):(c=a.value.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/\n/ig,"<br>"),b.innerHTML=c,c=$(a).attr("name")),d=a.value;b=a.getAttribute("action_name");if(""==b||null==b)b="OnListFrameUpdateCell";var e=a.getAttribute("action_confirm");e=null==e?"":e;var g=a.getAttribute("action_tip");null==g&&(g="");var h=a.getAttribute("action_js"),k=this.ItemList.GetValue(c,"DataItem","DataType");c=[{Name:"EWA_FIELD_ID",
Value:c},{Name:"EWA_FIELD_VAL",Value:d},{Name:"EWA_ACTION_RELOAD",Value:"0"},{Name:c,Value:d},{Name:"EWA_DATA_TYPE",Value:k},{Name:"EWA_FIELD_VAL_OLD",Value:a.getAttribute("old")}];this.EditEvent={FROM:a,OLD_VAL:a.getAttribute("old"),NEW_VAL:a.value};this.DoAction(a,b,e,g,c,h)}else a.focus()};this.RewriteInfo=function(a,b,c,d){$X("EWA_LF_"+this._Id);null==this._INFO&&(this._INFO={},this._INFO.INFO=a,this._INFO.ID_NAME=b,this._INFO.INFO_NAME=c,this._INFO.INFO_MEMO=d);if(null!=this._INFO.INFO)for(a=
0;a<this._INFO.INFO.length;a++)if(b=this._INFO.INFO[a],c=b[this._INFO.ID_NAME],$X(c))if(null==b[this._INFO.INFO_NAME]||""==b[this._INFO.INFO_NAME].trim())for(b="TD"==$X(c).parentNode.tagName?$X(c).parentNode:$X(c).parentNode.parentNode,c=0;c<b.parentNode.cells.length;c++)b.parentNode.cells[c]==b&&this.ShowHiddenColumn(c,!1);else $X(c).innerHTML=b[this._INFO.INFO_NAME]};this.ShowHiddenColumn=function(a,b){var c=$X("EWA_LF_"+this._Id),d="";if(null==b||0==b||"none"==b)d="none";for(b=0;b<c.rows.length;b++)c.rows[b].cells.length==
...
"Id")[a];c="enus"==EWA.LANG?c.TxtEn:c.Txt;b.find("a").attr("tag",a).html(c);var d=b.find("input");"blk"==a||"nblk"==a?d.val(c).prop("disabled",!0):d.prop("disabled")&&b.find("input").val("").prop("disabled",!1)};this._GetInitSearchMap=function(){var a=new EWA_UrlClass(this.Url),b={},c=a.GetParameter("ewa_search");if(!c)return b;this.Url=a.RemoveParameter("ewa_search");c=c.unURL();a=c.split(",");for(var d in a){var e=a[d],g=e.indexOf("["),h=e.indexOf("]");0>g||h<g||(c=e.substring(0,g).trim(),0!=c.length&&
(g=e.substring(g+1,h).trim().toLowerCase(),0!=g.length&&(e=e.substring(h+1).trim(),""!=e&&(b[c.toUpperCase()]||(b[c.toUpperCase()]={name:c,tag:g}),c=b[c.toUpperCase()],"lt"==g||"lte"==g?c.para2=e.unURL():c.para1=e.unURL()))))}return b};this.SearchFilterDate=function(a){var b=$(this._MENU_DATE_RANGE.SHOW_BY_OBJECT).parentsUntil(".ewa-lf-search-item").last(),c=b.find("input")[0];b=b.find("input")[1];if("Clear"==a)$(c).val(""),$(b).val("");else{var d=EWA_Utils.Date(),e="",g="";"Today"==a?g=e=d.GetDateString():
"Week"==a?(a=d.GetBenWeek(),e=a[0],g=a[1]):"Today-Weekend"==a?(a=d.GetBenWeek(),e=a[d.GetDateString()],g=a[1]):"Month"==a?(a=d.GetBenMonth(),e=a[0],g=a[1]):"Today-EOM"==a?(a=d.GetBenMonth(),e=a[d.GetDateString()],g=a[1]):"Quarter"==a?(a=d.GetBenQ(),e=a[0],g=a[1]):"Today-EOQ"==a?(a=d.GetBenQ(),e=a[d.GetDateString()],g=a[1]):"Year"==a?(a=d.GetBenYear(),e=a[0],g=a[1]):"Today-EOY"==a&&(a=d.GetBenYear(),e=a[d.GetDateString()],g=a[1]);a=EWA_Utils.Date(e).FormatDate();d=EWA_Utils.Date(g).FormatDate();d+=
" 23:59:59";$(c).val(a);$(b).val(d)}};this._SearchCreateDateRange=function(){var a="_MENU_DATE_RANGE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",c=JSON.parse(JSON.stringify(this.RESOURCES.search_date_items)),d="EWA.F.FOS[&quot;"+this._Id+"&quot;].SearchFilterDate",e;for(e in c){var g=c[e];g.Txt=g[b];g.Cmd=d+"(&quot;"+g.Id+"&quot;)"}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_DATE_RANGE";this._MENU_DATE_RANGE=new EWA_UI_MenuClass(b);this._MENU_DATE_RANGE.Create(c);
$(this._MENU_DATE_RANGE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+a);return b};this._SearchCreateTextType=function(){var a="_MENU_TEXT_TYPE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",c=JSON.parse(JSON.stringify(this.RESOURCES.search_text_items)),d="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextTypeIt",e;for(e in c){var g=c[e];g.Txt=g[b];g.Cmd=d+"(&quot;"+g.Id+"&quot;)";g.Group=g.Id}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_TEXT_TYPE";this._MENU_TEXT_TYPE=
new EWA_UI_MenuClass(b);this._MENU_TEXT_TYPE.Create(c);$(this._MENU_TEXT_TYPE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+a);this._MENU_TEXT_TYPE.clickBeforeEvent=function(h,k){$(this.Dialog.GetFrame()).find(".search-text-tag").remove();$(k).find("td:eq(0)").html('<b class="fa fa-check search-text-tag"></b>')};return b};this._SearchCreateItm=function(){var a="EWA_SEARCH_ITEM_"+this.Id,b=[],c=[],d=[],e={},g;for(g in this._SearchJson)this._SearchJson[g].ORI_NAME=g,e[g.toUpperCase()]=this._SearchJson[g];
this._SearchJson=e;var h="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextType(this)",k="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchDateType(this)",l=$J2MAP(this.RESOURCES.search_text_items,"Id");e=this._GetInitSearchMap();var m=!1,n=!1;for(g in this.ItemList.Items)if(null!=this._SearchJson[g]){var p=[],t=this._SearchJson[g],r=t.T,q=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[g]);p.push("<table class='ewa-lf-search-item ewa-ref-"+g+" ewa-lf-search-type-"+r+" "+("fix"==r?
"ewa-lf-search-fix-m"+(t.M||"0"):"")+"' cellspacing=0 cellpadding=0>");p.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");p.push(q);var v=q="",u="lk";e[g.toUpperCase()]&&(v=e[g.toUpperCase()],u=v.tag,q=v.para1,v=v.para2);var y="";"text"==r?(n=l[u]||l.lk,y="enus"==EWA.LANG?n.TxtEn:n.Txt,p.push("<a class='ewa-lf-search-type' tag='"+u+"' href='javascript:void(0)' onclick='"+h+"'>"),p.push(y),p.push("</a>"),n=!0):"date"==r&&(p.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+
k+"'></a>"),m=!0);p.push("</b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==r?"blk"==u||"nblk"==u?(t=this._SearchSingle(g,y),t=t.replace("<input","<input disabled "),p.push(t)):p.push(this._SearchSingle(g,q)):"date"==r?p.push(this._SearchDate(g,q,v)):"number"==r?p.push(this._SearchNumber(g,q,v)):"fix"==r&&(t="<div >"+this._SearchFix(g,t,"span",q)+"</div>",p.push(t));p.push("</td></tr></table>");"fix"==r?c.push(p.join("")):d.push(p.join(""))}if(0!=d.length+c.length){b.push('<table class="ewa-lf-search-main" id="'+
a+'" cellspacing="0" cellpadding="0" style="width:100%">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");0<d.length&&b.push(" "+d.join("")+" ");if(0<c.length)for(d=0;d<c.length;d++)b.push(" "+c[d]+" ");b.push("</td></tr></table>");var w=document.createElement("div");this._SEARCH_BOX=w;w.className="ewa-lf-search";w.innerHTML=b.join("");b=$X("EWA_LF_"+this.Id).parentNode;b.parentNode.insertBefore(w,b);a="EWA_SEARCH_ITEM_"+this.Id;var x=this;m&&this._SearchCreateDateRange();n&&this._SearchCreateTextType();
x._SEARCH_ITEM_EXP=this.SearchGetExp(w);"{}"!=JSON.stringify(e)&&(x._SearchExp=x._SEARCH_ITEM_EXP);$(w).find("input[type=text]").on("compositionstart",function(){x._is_search_composition=!0}).on("compositionend",function(){x._is_search_composition=!1});this._TIMER_SEARCH=window.setInterval(function(){if(!x._is_search_composition){try{if(!$X(a)){window.clearInterval(x._TIMER_SEARCH);return}}catch(B){window.clearInterval(x._TIMER_SEARCH);return}var A=x.SearchGetExp(w);A!=x._SEARCH_ITEM_EXP&&(x._SEARCH_ITEM_EXP=
A,x.DoSearch($X(a)))}},700)}};this._SearchSingle=function(a,b){var c=[];c.push('<input t="text" type="text" autocomplete="off" class="EWA_INPUT" maxlength="40" name="');c.push(a.toInputValue());c.push('"');null!=b&&(c.push(' value="'),a=b.toInputValue(),c.push(a),c.push('" '));c.push(" />");return c.join("")};this._SearchDate=function(a,b,c){var d=[];d.push("<table border=0 cellpadding=0 cellspacing=0>");d.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');
...
for(d=0;d<b.length;d++)r=b[d],a=r.WF_UNIT_TO,q=r.WF_UNIT_FROM,q=n.Units[q],a=n.Units[a],p=new EWAC_WfCnn,p.Create(q,a),n.Cnns[p.Id]=p,r.IsHaveLogic&&!r.IsLogicOk&&(p.IsStop=!0);for(var y in n.Units)d=n.Units[y],null==u&&0==d.CnnsToLength&&(u=d);if(null==u)h="enus"==EWA.LANG?"No startup node was found, process definition error":"\u672a\u53d1\u73b0\u542f\u52a8\u8282\u70b9,\u6d41\u7a0b\u5b9a\u4e49\u9519\u8bef",alert(h);else{0==c.length&&(n.CurUnit=u);var w=[];y={};for(d=0;d<c.length;d++)b=c[d],n=b.SYS_STA_TAG,
q=m[n],null!=q&&(r=b.ADM_NAME,"enus"==EWA.LANG&&b.ADM_NAME_EN&&(r=b.ADM_NAME_EN),q.Log(r,b.SYS_STA_CDATE,b.SYS_STA_MEMO),y[n]||(y[n]=1,w.push({ID:n,DES:q.GetDes()})),n=b.SYS_STA_TAG+"G"+b.SYS_STA_VAL,EWAC_WfUtil.WF.Cnns[n]&&(EWAC_WfUtil.WF.Cnns[n].Disp(3,"blue"),q==u&&(q.ADM_ID=b.ADM_ID),d==c.length-1&&(n=m[b.SYS_STA_VAL],n.WF_UNIT_ADM_LST=b.ROLE_IDS,n.WF_UNIT_ADM=b.ROLE_TYPE,EWAC_WfUtil.WF.CurUnit=n)));null!=l&&0<l.length&&m[l]&&(EWAC_WfUtil.WF.CurUnit=m[l]);EWAC_WfUtil.WF.CurUnit.LogCur(e);l=!1;
q=EWAC_WfUtil.WF.CurUnit;c=[];if(u==q)l=!0;else if("WF_ADM_ADM"==q.WF_UNIT_ADM)if(u=","+q.WF_UNIT_ADM_LST+",",0<=u.indexOf(","+g+","))l=!0;else for(d in g=$J2MAP1(top.org,"ADM_ID"),h=q.WF_UNIT_ADM_LST.split(","),h){k=g[h[d]];for(var x in k)c.push(k[x].ADM_NAME)}else if("WF_ADM_DEPT"==q.WF_UNIT_ADM)if(u=","+q.WF_UNIT_ADM_LST+",",0<=u.indexOf(","+h+","))l=!0;else for(d in g=$J2MAP1(top.org,"DEP_ID"),h=q.WF_UNIT_ADM_LST.split(","),h)for(x in k=g[h[d]],k)c.push(k[x].ADM_NAME);else if("WF_ADM_POST"==q.WF_UNIT_ADM)if(u=
","+q.WF_UNIT_ADM_LST+",",0<=u.indexOf(","+k+","))l=!0;else for(d in g=$J2MAP1(top.org,"POS_ID"),h=q.WF_UNIT_ADM_LST.split(","),h)for(x in k=g[h[d]],k)c.push(k[x].ADM_NAME);else if("WF_ADM_START"==q.WF_UNIT_ADM){if(u==q||g==u.ADM_ID)l=!0}else"WF_ADM_MANAGER"==q.WF_UNIT_ADM&&(x=u.ADM_ID,top||top.ORG||(h="enus"==EWA.LANG?"No organization":"\u6ca1\u6709\u7ec4\u7ec7\u673a\u6784",alert(h),l=!1),l=top.ORG.GetMaster(x).Id==g?!0:!1);e&&window.parent&&window.parent.$X(e)&&(x=window.parent.$X(e).parentNode.parentNode.parentNode,
l?0<w.length&&(g=x.rows[x.rows.length-1].cells[0],h=window.parent.document.createElement("input"),h.type="button",h.value="enus"==EWA.LANG?"Back":"\u6253\u56de",h.onclick=function(){var A=window.parent.$X(e);A.options.length=1;for(var B=0;B<w.length;B++){var E=w[B];A.options[A.length]=new Option(E.DES,E.ID);this.style.display="none"}A.parentNode.parentNode.cells[0].innerHTML="enus"==EWA.LANG?'<div style="color:red">Back steps</div>':'<div style="color:red">\u8fd4\u56de\u6b65\u9aa4</div>'},g.insertBefore(h,
g.getElementsByTagName("input")[1])):(0==c.length?(h="enus"==EWA.LANG?"Only view":"\u60a8\u53ea\u80fd\u67e5\u770b",window.parent.$X(e).parentNode.innerHTML="<b>"+h+"</b>"):(h="enus"==EWA.LANG?"Waitting":"\u7b49\u5f85",g="enus"==EWA.LANG?"or":"\u6216",window.parent.$X(e).parentNode.innerHTML="<b>"+h+':<span style="color:blue">'+c.join("</span> "+g+' <span style="color:blue">')+"</span></b>"),window.parent.$X("butOk").style.display="none"),showControls(x,_EWA_WF.WF_SHOW))}}

...
null==h&&(h="");var k=a.getAttribute("action_js"),l=this.ItemList.GetValue(d,"DataItem","DataType");d=[{Name:"EWA_FIELD_ID",Value:d},{Name:"EWA_FIELD_VAL",Value:e},{Name:"EWA_ACTION_RELOAD",Value:"0"},{Name:d,Value:e},{Name:"EWA_DATA_TYPE",Value:l},{Name:"EWA_FIELD_VAL_OLD",Value:a.getAttribute("old")}];this.EditEvent={FROM:a,OLD_VAL:a.getAttribute("old"),NEW_VAL:a.value};this.DoAction(a,b,g,h,d,k)}else a.focus()};this.RewriteInfo=function(a,b,d,e){$X("EWA_LF_"+this._Id);null==this._INFO&&(this._INFO=
{},this._INFO.INFO=a,this._INFO.ID_NAME=b,this._INFO.INFO_NAME=d,this._INFO.INFO_MEMO=e);if(null!=this._INFO.INFO)for(a=0;a<this._INFO.INFO.length;a++)if(b=this._INFO.INFO[a],d=b[this._INFO.ID_NAME],$X(d))if(null==b[this._INFO.INFO_NAME]||""==b[this._INFO.INFO_NAME].trim())for(b="TD"==$X(d).parentNode.tagName?$X(d).parentNode:$X(d).parentNode.parentNode,d=0;d<b.parentNode.cells.length;d++)b.parentNode.cells[d]==b&&this.ShowHiddenColumn(d,!1);else $X(d).innerHTML=b[this._INFO.INFO_NAME]};this.ShowHiddenColumn=
function(a,b){var d=$X("EWA_LF_"+this._Id),e="";if(null==b||0==b||"none"==b)e="none";for(b=0;b<d.rows.length;b++)d.rows[b].cells.length==d.rows[0].cells.length&&(d.rows[b].cells[a].style.display=e)};this.ShowHiddenColumns=function(a,b){var d=$X("EWA_LF_"+this._Id),e="";if(null==b||0==b||"none"==b)e="none";b=d.rows[0].cells.length;for(var g=0;g<d.rows.length;g++){var h=d.rows[g];if(h.cells.length==b)for(var k=0;k<a.length;k++)h.cells[a[k]].style.display=e}};this.GroupShowHidden=function(a){var b=$(a).attr("t"),
d=(new Date).getTime();if(!(b&&333>d-b)){$(a).attr("t",d);b=a.parentNode.parentNode;d=b.getAttribute("ewa_group");""==d?(d="none",a.childNodes[0].innerHTML=" + "):(d="",a.childNodes[0].innerHTML=" - ");b.setAttribute("ewa_group",d);for(var e=b.parentNode.parentNode,g=0,h=b.rowIndex+1;h<e.rows.length;h++){b=e.rows[h];if("group"==b.getAttribute("ewa_tag"))break;b.getAttribute("add_pre_row")?"none"==d?("none"!=b.style.display&&b.setAttribute("ewa_group_show_old",b.style.display),b.style.display="none"):
b.hasAttribute("ewa_group_show_old")&&(b.style.display=b.getAttribute("ewa_group_show_old"),b.removeAttribute("ewa_group_show_old")):(b.style.display=d,g++)}a.childNodes[a.childNodes.length-1].innerHTML=" ("+g+")"}};this.Sort=function(a){var b=this._last_sort_timer||0,d=this._Sort||"",e=(new Date).getTime();d==a&&500>e-b||(this._last_sort_timer=e,this._Sort=a,this.Goto(1))};this.SearchClear=function(a){a=a.parentNode.parentNode.parentNode.parentNode;for(var b=0;b<a.rows.length;b+=1)for(var d=a.rows[b].getElementsByTagName("input"),
e=0;e<d.length;e++){var g=d[e];if("text"==g.type)g.value="";else if("radio"==g.type||"checkbox"==g.type)g.checked=!1}};this.SearchGetExpInit=function(){var a=$("#_G_"+this._Id),b=[];$(a).find(".ewa-lf-search-item").each(function(){var d=$(this).find("input");if(0==d.length&&(d=$(this).find("select"),0==d.length))return;var e=d[0],g=$(e).attr("t");if(1==d.length){var h=e.value;if(""!=e.value.trim())for("text"==g&&(d=$(e.parentNode.parentNode).find("a").attr("tag"))&&(g=d),e=e.name.split(","),d=0;d<
e.length;d++)b.push(e[d]+"["+g+"]"+h)}else if(("date"==g||"number"==g)&&2==d.length){if(h=e.value,g=d[1].value,""!=g||""!=h)b.push(e.name+"[gte]"+h),g&&b.push(e.name+"[lte]"+g)}else if("fix"==g&&"INPUT"==e.tagName){var k=[""];$(this).find("input").each(function(){this.checked&&k.push(this.value)});1!=k.length&&b.push(e.name+"[or]"+k.join(";"))}});return b.join(",")};this.SearchGetExp=function(a){var b=[];$(a).find(".ewa-lf-search-item").each(function(){var d=$(this).find("input");if(0==d.length&&
(d=$(this).find("select"),0==d.length))return;var e=d[0],g=$(e).attr("t");if(1==d.length){var h=e.value;""!=e.value.trim()&&("text"==g&&(d=$(e.parentNode.parentNode).find("a").attr("tag"))&&(g=d),b.push("@!@"+e.name+"~!~"+g+"~!~"+h))}else if(("date"==g||"number"==g)&&2==d.length)h=e.value,d=d[1].value,""==d&&""==h||b.push("@!@"+e.name+"~!~"+g+"~!~"+h+"~!~"+d);else if("fix"==g&&"INPUT"==e.tagName){var k=[""];$(this).find("input").each(function(){this.checked&&k.push(this.value)});1!=k.length&&b.push("@!@"+
e.name+"~!~"+g+k.join("~!~"))}});return b.join("")};this.DoSearch=function(a){var b=!1;a.id=="EWA_SEARCH_ITEM_"+this.Id?a=$X("EWA_SEARCH_ITEM_"+this.Id).childNodes[0]:(a=a.parentNode.parentNode.parentNode.parentNode,b=!0);this._SearchExp=this.SearchGetExp(a);b&&(this._SearchHtml=a.parentNode.innerHTML,this._SearchDialog.Show(!1));this.Goto(1)};this.Search=function(a){null==this._SearchHtml?(this._SearchCreate(),this._SearchDialog=new EWA.UI.Dialog.OpenWindow("about:blank","aa",400,100,!0,null,null,
...
this._MENU_TEXT_TYPE=new EWA_UI_MenuClass(b);this._MENU_TEXT_TYPE.Create(d);$(this._MENU_TEXT_TYPE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+a);this._MENU_TEXT_TYPE.clickBeforeEvent=function(k,l){$(this.Dialog.GetFrame()).find(".search-text-tag").remove();$(l).find("td:eq(0)").html('<b class="fa fa-check search-text-tag"></b>')};return b};this._SearchCreateItm=function(){var a="EWA_SEARCH_ITEM_"+this.Id,b=[],d=[],e=[],g={},h;for(h in this._SearchJson)this._SearchJson[h].ORI_NAME=h,g[h.toUpperCase()]=
this._SearchJson[h];this._SearchJson=g;var k="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextType(this)",l="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchDateType(this)",m=$J2MAP(this.RESOURCES.search_text_items,"Id");g=this._GetInitSearchMap();var n=!1,p=!1;for(h in this.ItemList.Items)if(null!=this._SearchJson[h]){var q=[],u=this._SearchJson[h],t=u.T,r=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[h]);q.push("<table class='ewa-lf-search-item ewa-ref-"+h+" ewa-lf-search-type-"+
t+" "+("fix"==t?"ewa-lf-search-fix-m"+(u.M||"0"):"")+"' cellspacing=0 cellpadding=0>");q.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");q.push(r);var w=r="",v="lk";g[h.toUpperCase()]&&(w=g[h.toUpperCase()],v=w.tag,r=w.para1,w=w.para2);var y="";"text"==t?(p=m[v]||m.lk,y="enus"==EWA.LANG?p.TxtEn:p.Txt,q.push("<a class='ewa-lf-search-type' tag='"+v+"' href='javascript:void(0)' onclick='"+k+"'>"),q.push(y),q.push("</a>"),p=!0):"date"==t&&(q.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+
l+"'></a>"),n=!0);q.push("</b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==t?"blk"==v||"nblk"==v?(u=this._SearchSingle(h,y),u=u.replace("<input","<input disabled "),q.push(u)):q.push(this._SearchSingle(h,r)):"date"==t?q.push(this._SearchDate(h,r,w)):"number"==t?q.push(this._SearchNumber(h,r,w)):"fix"==t&&(u="<div >"+this._SearchFix(h,u,"span",r)+"</div>",q.push(u));q.push("</td></tr></table>");"fix"==t?d.push(q.join("")):e.push(q.join(""))}if(0!=e.length+d.length){b.push('<table class="ewa-lf-search-main" id="'+
a+'" cellspacing="0" cellpadding="0" style="width:100%">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");0<e.length&&b.push(" "+e.join("")+" ");if(0<d.length)for(e=0;e<d.length;e++)b.push(" "+d[e]+" ");b.push("</td></tr></table>");var x=document.createElement("div");this._SEARCH_BOX=x;x.className="ewa-lf-search";x.innerHTML=b.join("");b=$X("EWA_LF_"+this.Id).parentNode;b.parentNode.insertBefore(x,b);a="EWA_SEARCH_ITEM_"+this.Id;var z=this;n&&this._SearchCreateDateRange();p&&this._SearchCreateTextType();
z._SEARCH_ITEM_EXP=this.SearchGetExp(x);"{}"!=JSON.stringify(g)&&(z._SearchExp=z._SEARCH_ITEM_EXP);$(x).find("input[type=text]").on("compositionstart",function(){z._is_search_composition=!0}).on("compositionend",function(){z._is_search_composition=!1});this._TIMER_SEARCH=window.setInterval(function(){if(!z._is_search_composition){try{if(!$X(a)){window.clearInterval(z._TIMER_SEARCH);return}}catch(C){window.clearInterval(z._TIMER_SEARCH);return}var A=z.SearchGetExp(x);A!=z._SEARCH_ITEM_EXP&&(z._SEARCH_ITEM_EXP=
A,z.DoSearch($X(a)))}},700)}};this._SearchSingle=function(a,b){var d=[];d.push('<input t="text" type="text" autocomplete="off" class="EWA_INPUT" maxlength="40" name="');d.push(a.toInputValue());d.push('"');null!=b&&(d.push(' value="'),a=b.toInputValue(),d.push(a),d.push('" '));d.push(" />");return d.join("")};this._SearchDate=function(a,b,d){var e=[];e.push("<table border=0 cellpadding=0 cellspacing=0>");e.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');
e.push(a);e.push('"');b&&(b=b.toInputValue(),e.push(' value="'),e.push(b),e.push('"'));e.push(' /></td><td><span class="ewa-lf-search-split"> - </span></td>');e.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');e.push(a);e.push('1"');d&&(b=d.toInputValue(),e.push(' value="'),e.push(b),e.push('"'));e.push("/></td></tr></table>");return e.join("")};this._SearchNumber=function(a,b,d){var e=[];e.push('<input type="text" t="number" size="10" name="');
e.push(a);e.push('"');b&&(b*=1,e.push(' value="'),e.push(b),e.push('"'));e.push(' /><span class="ewa-lf-search-split"> - </span>');e.push('<input type="text" t="number" size="10" name="');e.push(a);e.push('1"');d&&(b=1*d,e.push(' value="'),e.push(b),e.push('"'));e.push("/>");return e.join("")};this._SearchFix=function(a,b,d,e){var g=[],h="radio";if("1"==b.M)h="checkbox";else if("2"==b.M)return this._SearchFix1(a,b,d,e);d="<"+d+"><nobr><input t='fix' [@CHK] id='@ID' value=\"@V\" type='"+h+"' name='"+
a+"' /><label for='@ID'>@T</label></nobr></"+d+"> ";h={};if(e){e=e.split(";");for(var k in e)h[e[k].trim().toUpperCase()]=1}for(k=0;k<b.D.length;k++){var l=b.D[k];e=l[0];l=l[1];var m=this.Id+"_"+a+"_SearchFix_"+k,n=d.replace("@ID",m);n=n.replace("@ID",m);n=n.replace("@V",e);n=h[e.toUpperCase().trim()]?n.replace("[@CHK]","checked"):n.replace("[@CHK]","");n=n.replace("@T",l);g.push(n)}return g.join("")};this._SearchFix1=function(a,b,d,e){d=[];d.push("<select t='fix' name='"+a+"'><option></option>");
for(var g=0;g<b.D.length;g++){var h=b.D[g],k="<option @CKD t='fix' id='@ID' value=\"@V\">@T</option> ".replace("@ID",this.Id+"_"+a+"_SearchFix_"+g);k=k.replace("@V",h[0]);k=k.replace("@T",h[1]);k=e&&h[0]==e?k.replace("@CKD","selected"):k.replace("@CKD","");d.push(k)}d.push("</select>");return d.join("")};this._SearchCreate=function(){var a=[];a.push("<div><table border=0 style='margin:0px;' class=EWA_TABLE cellspacing=1>");for(var b in this.ItemList.Items)if(null!=this._SearchJson[b]){var d=this._SearchJson[b],
e=d.T,g=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[b]);a.push("<tr><td class=EWA_TD_L width=140><nobr>"+g+"<nobr></td><td width=350 class=EWA_TD_M>");"text"==e?a.push(this._SearchSingle(b)):"date"==e?a.push(this._SearchDate(b)):"number"==e?a.push(this._SearchNumber(b)):"fix"==e&&a.push(this._SearchFix(b,d,"div"));a.push("</td></tr>")}a.push("<tr><td class=EWA_TD_B colspan=2 align=right><input onclick='EWA.F.FOS[\""+this._Id+"\"].SearchClear(this);' type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLEAR"]+
"'> <input type=submit value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.SEARCH"]+"' onclick='EWA.F.FOS[\""+this._Id+"\"].DoSearch(this);'> <input type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLOSE"]+"' onclick='EWA.F.FOS[\""+this.Id+"\"]._SearchDialog.Show(false);'></td></tr>");a.push("</table></div>");this._SearchHtml=a.join("")};this.SearchMark=function(){for(var a=this._SearchExp.split("@!@"),b=$X("EWA_LF_"+this._Id),d=0;d<a.length;d+=1){var e=a[d].split("~!~");if(!(3>e.length))for(var g=2;g<
e.length;g++){var h=e[g];if(""!=h){if("fix"==e[1]){var k=e[2];$("table#EWA_SEARCH_ITEM_"+this.Id+' [name="'+e[0]+'"]').find("option").each(function(){this.value==k&&(h=this.text)})}for(var l=[],m=0;m<h.length;m++){var n=h[m];"a"<=n&&"z">=n||"A"<=n&&"Z">=n||"0"<=n&&"9">=n?l.push(n):l.push("\\"+n)}h=l.join("");h=eval("/("+h+")/ig");l=e[0].split(",");for(var p in l){m=l[p];this._SearchJson[m]&&(m=this._SearchJson[m].ORI_NAME);m=$(b).find(".ewa-lf-data-row .ewa-col-"+m).not("[ewa-search-marked=yes]");
m.attr("ewa-search-marked","yes");try{m.find("*").each(function(){0==this.children.length&&(this.innerHTML=this.innerHTML.replace(h,"<font color=red><b>$1</b></font>"))})}catch(q){console.log(q)}}}}}};this.DblClick=function(a){this._IsDblClick=a;for(var b=$X("EWA_LF_"+this._Id),d=1;d<b.rows.length;d++)b.rows[d].ondblclick=function(){var e=this.getElementsByTagName("input");e.length>a&&0==e[a].disabled&&e[a].click()}};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.Init(this.Xml);
this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);if((a=$X("EWA_LF_"+this._Id))&&"table"==a.tagName&&!(1>=a.rows.length)){a=a.rows[1].getElementsByTagName("input");for(var b=0;b<a.length;b++)if("RADIO"==a[b].type.toUpperCase()){this._TrSelectMulti=!1;break}}};this.SetPageParameters=function(a,b,d,e,g){this._PageCurrent=a;this._PageSize=d;this._PageCount=b;this._RecordCount=e;this._Sort=g};this.SetPageParametersName=function(a,b,d,e,g){this._PageCurrentName=a;this._PageSizeName=d;
this._PageCountName=b;this._RecordCountName=e;this._SortName=g};this.CheckedAll=function(){var a=document.getElementById("EWA_LF_"+this._Id);if(!(1>=a.rows.length)){for(var b=0;b<a.rows.length;b+=1){var d=a.rows[b].getElementsByTagName("input");0!=d.length&&(d[0].checked=this._IsCheckedAll)}this._IsCheckedAll=this._IsCheckedAll?!1:!0;this.CheckedAllAfter&&this.CheckedAllAfter(a)}};this.SelectChecked=function(){var a=$X("EWA_LF_"+this._Id);if(!a||1>a.rows.length)return"";var b=[],d=$F(a,"input","type",
"radio,checkbox");if(0<d.length)for(var e=0;e<d.length;e++)d[e].checked&&b.push(d[e].value);else for(e=0;e<a.rows.length;e++)d=a.rows[e],1==d.getAttribute("__ewa_lf_mdown")&&b.push(d.getAttribute("EWA_KEY"));return b.join(",")};this.SelectCheckedInputs=function(){var a=[],b=$X("EWA_LF_"+this._Id);if(1>b.rows.length)return a;b=b.getElementsByTagName("input");a=[];for(var d=0;d<b.length;d++)("CHECKBOX"==b[d].type.toUpperCase()||"RADIO"==b[d].type.toUpperCase())&&b[d].checked&&a.push(b[d]);return a};
this.SelectCheckedRows=function(){for(var a=[],b=$X("EWA_LF_"+this._Id),d=0;d<b.rows.length;d++){var e=b.rows[d],g=e.getElementsByTagName("input");0!=g.length&&g[0].checked&&-1==g[0].parentNode.className.indexOf("ewa-switch")&&a.push(e)}if(0==a.length)for(d=0;d<b.rows.length;d++)e=b.rows[d],1==e.getAttribute("__ewa_lf_mdown")&&a.push(e);return a};this.Reload=function(a){this.StopAjaxAfterReload?this.StopAjaxAfterReload=!1:this.Goto(this._PageCurrent,a)};this.refreshPage=function(a,b){this.replaceRowsData(null,
null,a,b)};this.replaceRowsData=function(a,b,d,e){var g=this.getUrlClass();g.AddParameter("EWA_AJAX","LF_RELOAD");g.AddParameter("EWA_IS_SPLIT_PAGE","no");g.AddParameter("EWA_IS_HIDDEN_CAPTION","yes");g=g.GetUrl();a&&(g+="&"+a);var h=a?new EWA_AjaxClass:this.CreateAjax(),k=this;h.PostNew(g,function(){if(4==h._Http.readyState){h.HiddenWaitting();var l=h._Http.responseText;200!=h._Http.status?(console.error(l),alert("ERROR:\r\n"+h._Http.statusText)):EWA.F.CheckCallBack(l)?k.replaceRowsWithDataHtml(l,
b,d,e):console.error(l)}})};this.replaceRowsWithDataHtml=function(a,b,d,e){var g=$("<div></div>");g.html(a);var h=[],k=$("#EWA_LF_"+this._Id);g.find(".ewa-lf-data-row").each(function(){var l='tr[ewa_key="'+$(this).attr("ewa_key")+'"]',m=k.find(l);if(0==m.length)console.warn(l+" not found");else{l=$(this).attr("ewa_row_sign");var n=m.attr("ewa_row_sign"),p=!0;(l||n)&&n===l&&(p=!1);if(p){m.attr("ewa_row_sign",l);l=m.clone()[0];for(n=0;n<this.cells.length;n++){p=m[0].cells[n];var q=this.cells[n];p.removeAttribute("ewa-merged");
p.removeAttribute("ewa-search-marked");b?b(q,p):p.innerHTML=q.innerHTML}h.push({before:l,current:m[0]})}}});g.remove();this.SearchMark();this.IsReShow&&this.ReShowWithNoButtons();this._ReShowSearchQuick();null!=this._IsDblClick&&this.DblClick(c._IsDblClick);this.SubBottomsArray&&this._SubBottoms();this.ReloadAfter&&this.ReloadAfter(d);this.ReloadAfterApp&&this.ReloadAfterApp(d);e&&e(h)};this.DoAction=function(a,b,d,e,g,h){EWA.F.CID=this._Id;if(b){if(a&&$(a).parent().hasClass("scroll-delete")){var k=
$(a).attr("do-action-time")||0,l=(new Date).getTime();if(1E3>l-k)return;$(a).attr("do-action-time",l)}this.lastAction=b;this._Ajax=new EWA_AjaxClass;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.AddParameter("EWA_ACTION_TIP",e);null!=h&&0<h.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",h),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD",
"0")):this.StopAjaxAfterReload=!1;if(a&&a.getAttribute&&"yes"==a.getAttribute("box_menu_item")){if(this._Ajax.AddParameter("___CALL__FROM__","box"),a=a.parentNode)a=a.getAttribute("json_ref"),a=JSON.parse(a),a.EWA_KEY&&this._Ajax.AddParameter("EWA_ACTION_KEY",a.EWA_KEY)}else(a=this.GetRowKey(a))&&this._Ajax.AddParameter("EWA_ACTION_KEY",a);a=this.SelectChecked();this._Ajax.AddParameter("IDS_SPLIT",a);if(null!=g&&0<g.length)for(a=0;a<g.length;a+=1)this._Ajax.AddParameter(g[a].Name,g[a].Value);g=new EWA.C.Url;
g.SetUrl(this.Url);var m=g.RemoveParameter("EWA_ACTION"),n=this;d?((g=_EWA_INFO_MSG[d])||(g=d),$Confirm(g,"Confirm",function(){n._Ajax.PostNew(m,function(){n._CallBackJs()})})):this._Ajax.PostNew(m,function(){n._CallBackJs()})}};this.NewPageSize=function(a){this._PageSize!=a&&(this._PageSize=a,this.Goto(1))};this.Goto=function(a,b){EWA.F.CID=this._Id;this._PageCurrent=a;this._Ajax=this.CreateAjax();a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.RemoveParameter("EWA_AJAX");
var d=this;this._Ajax.PostNew(a.GetUrl(),function(){d._CallBack(b)});this.REPLACE_HISTORY_STATE&&this.replaceHistoryState()};this.createReplaceHistoryStateUrl=function(){var a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.AddParameter(this._PageCurrentName,this._PageCurrent);this._PageSize&&a.AddParameter(this._PageSizeName,this._PageSize);null!=this._Sort&&a.AddParameter(this._SortName,this._Sort);var b=this.SearchGetExpInit();b&&a.AddParameter("EWA_SEARCH",b);if(null!=
this.GotoParas&&0<this.GotoParas.length)for(b=0;b<this.GotoParas.length;b+=1)a.AddParameter(this.GotoParas[b].Name,this.GotoParas[b].Value);a.RemoveParameter("EWA_AJAX");return a};this.replaceHistoryState=function(){var a=this.createReplaceHistoryStateUrl();window.history.replaceState("",null,a.GetUrl())};this.CreateAjax=function(){var a=new EWA.C.Ajax;a.LoadingType="image";a.AddParameter(this._PageCurrentName,this._PageCurrent);this._PageSize&&a.AddParameter(this._PageSizeName,this._PageSize);null!=
...
a?'<input type=text class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,true);" readonly !!>':"STRING"==a||"NUMBER"==a?"<input type=text class=EWA_INPUT !!>":null};this.AddedValues=function(a,b,d,e,g){for(var h=0;h<a.length;h++){var k=a[h],l=$X(k[b]+"_"+k[d]);if(!l)break;var m=l.tagName.toUpperCase();"INPUT"==m||"SELECT"==m||"TEXTAREA"==m?l.value=k[e]:l.innerHTML=k[e];g&&(this.GetRow(l).getElementsByTagName("input")[0].checked=!0)}};this.AddRow=function(a){for(var b=$X("EWA_LF_"+this._Id),d=b.insertRow(-1),
e=0;e<b.rows[0].cells.length;e++){var g=d.insertCell(-1),h=b.rows[0].cells[e];g.className="EWA_TD_M";null!=a[e]&&(g.innerHTML=a[e]);g.style.display=h.style.display;g.id="ADD_ROW_"+h.childNodes[0].id}return d};this.Calc=function(a,b,d,e){for(var g=$X("EWA_LF_"+this._Id),h={},k=0;k<a.length;k++)h[a[k]]=0;for(k=b;k<d;k++)for(a=g.rows[k],b=0;b<a.cells.length;b++)if(null!=h[b]){var l=a.cells[b],m=l.getElementsByTagName("input");0<m.length?h[b]+=1*m[0].value:(l=GetInnerText(l),""==l&&(l=0),h[b]+=1*l)}d=
g.rows[e];for(k=0;k<d.cells.length;k++)null!=h[k]&&(l=Math.round(100*h[k])/100,e=GetInnerText(d.cells[k]),l!=1*e&&(this.IsCalcChanged=!0),d.cells[k].innerHTML=l.fm())};this.mergeHeaders=function(a,b,d){var e=$($X("EWA_LF_"+this._Id)),g=e.find('tr[ewa_tag="HEADER"]');if(0!=g.length&&(a=g.find('nobr[id="'+a+'"]').parent(),0!=a.length)){var h=e.find("tr[ewa_mearge]");0==h.length&&(h=$(e[0].insertRow(1)),h.attr("ewa_mearge","gdx"));e=-1;for(var k=0;k<g[0].cells.length;k++){var l=g[0].cells[k];l==a[0]&&
(e=k,l.colSpan=d);if(-1==e)"1"!=$(l).attr("ewa_tdmearged")&&(l.rowSpan=2);else if(e+d==k)e=-1,l.rowSpan=2;else{l.rowSpan=1;var m=h[0].insertCell(-1);m.innerHTML=l.innerHTML;m.className=l.className;m.style.cssText=l.style.cssText;l.style.display="none";$(l).attr("ewa_tdmearged",1)}l==a[0]&&(l.innerHTML=b,l.style.display="",l.style.width="")}}};this.MeargeHeader=function(a,b,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 mergeHeaders");this.mergeHeaders(a,b,d)};this.getUrlClass=function(){var a=

...
(g.NodeShow(!0),alert(_EWA_EVENT_MSG.OnTreeNodeDeleteHaveChildren)):(d=e,null==d&&(d=new EWA.F.Cmd,d.EWA_ACTION="OnTreeNodeDelete"),""==d.EWA_AFTER_EVENT&&(d.EWA_AFTER_EVENT='EWA.F.FOS["'+this._Id+'"].DeleteAfter();'),d.EWA_TREE_KEY=g.Key,this._PostChange(d)))};this.DeleteNoConfirmById=function(d){d=this.GetNodeById(d);null!=d&&"EWA_TREE_ROOT"!=d.Key&&(this._LastFocus=d,this.DeleteAfter())};this.DeleteAfter=function(){var d=this.GetNode(this._LastFocus).GetObject(),e=d.parentNode;e.removeChild(d);
d=this.GetNode(e);0==d.Children.length?this.GetNode(d.GetObject().parentNode).ChildLast.Key==d.Key?d.NodeCrossEnd(!0):d.NodeCross(!0):d.ChildLast.NodeCrossEnd();this._LastFocus=null};this.NewNode=function(d,e,g,h){null!=this._LastFocus&&(this._NewNodeTemp={TEXT:d,CMD:e,REGEX:g,INFO:h},this.GetNode(this._LastFocus).NodeShow(!0),this.IsPostChange?this._NewNodeTimer=window.setInterval(function(){EWA.CurUI.IsPostChange||(window.clearInterval(EWA.CurUI._NewNodeTimer),EWA.CurUI._NewNode())},100):this._NewNode())};
this._NewNode=function(){var d=this._NewNodeTemp.TEXT,e=this._NewNodeTemp.CMD,g=this._NewNodeTemp.REGEX,h=this._NewNodeTemp.INFO;this._NewNodeTemp=null;var k=new EWA_TreeNodeClass;k.ewa=this;this._CurNewNode+=1;k.Key="NEW_NODE_"+this._Id+"__"+this._CurNewNode;k.RenameType="NEW";var l=_EWA_EVENT_MSG.OnTreeNodeNew+this._CurNewNode;null!=d&&0<d.trim().length&&(l=d.trim());k.Text=l;d=this.GetNode(this._LastFocus);0<d.Children.length&&d.Children[d.Children.length-1].NodeCross();d.AddChild(k);this.Create(k);
d.NodeShow(!0);this.Rename(k,e,g,h)};this.NewNodeAfter=function(d,e,g){var h=this.GetNodeById("NEW_NODE_"+this._Id+"__"+this._CurNewNode);h.SetKey(d);h.SetAddParameters(null==e?"":e);h.SetMenuGroup(null==g?"":g);d=this.TestIcon(h);h.SetBookIcon(d)};this.GetNodeById=function(d){d=$("#EWA_TREE_"+this._Id+' .ewa-tree-node[id="'+d+'"]');return 0==d.length?null:this.GetNode(d[0])};this.GetFocusNode=function(){return this.GetNode(this._LastFocus)};this.GetNode=function(d){if(null==d||null==d.tagName)return null;
var e=d;for(d=0;("TABLE"!=e.tagName||"1"!=e.getAttribute("EWA_T"))&&"EWA_TREE_ROOT"!=e.id;)if(e=e.parentNode,d++,33<d||"BODY"==e.tagName)return null;d=new EWA_TreeNodeClass;d.ewa=this;d.Key=e.id;d.MenuGroup=e.getAttribute("EWA_MG");d.Object=e;var g=e.rows[0].cells[2];d.Text=GetInnerText(g);for(var h=0;3>h;h+=1)d.AddParas[h]=g.childNodes[0].getAttribute("EWA_P"+h);h=e.getAttribute("EWA_TREE_MORE");d.IsMoreChildren="1"==h?!0:!1;if(1<e.rows.length){e=e.rows[1].cells[e.rows[1].cells.length-1];for(h=0;h<
e.childNodes.length;h=1+h)g=e.childNodes[h],3!=g.nodeType&&"TABLE"==g.tagName&&"1"==g.getAttribute("EWA_T")&&d.Children.push(this.GetNode(g));0<d.Children.length&&(d.ChildLast=d.Children[d.Children.length-1])}return d};this.Click=function(d,e){if(!this.IsPostChange&&(EWA.CurUI=this,d=d.srcElement?d.srcElement:d.target,"INPUT"!=d.tagName))if("DIV"==d.tagName&&(d=d.parentNode),"TD"==d.tagName&&0==d.className.indexOf("TD00")){var g=this.GetNode(d);g.NodeShow()}else{for(;("SPAN"!=d.tagName||null==d.getAttribute("EWA_CMD"))&&
"1"!=d.getAttribute("EWA_TREE_TOP");)if(d=d.parentNode,"BODY"==d.tagName)return;g=this.GetNode(d);if("SPAN"==d.tagName&&(null!=d.getAttribute("EWA_CMD")||"1"==d.getAttribute("EWA_TREE_TOP"))){null!=this._LastFocus&&(this.GetNode(this._LastFocus).Mark(!1),this._LastFocus=null);"1"!=d.getAttribute("EWA_TREE_TOP")&&g.Mark(!0);this._LastFocus=d;if(e)return d;0>this.Url.toUpperCase().indexOf("EWA_TREE_SKIP_GET_STATUS")&&EWA.F.ST.SaveStatus(g.Key,"TREE");this._RunCmd(g);this.MoveNode(g.GetObject())}}};
this._RunCmd=function(d){var e=this.GetNode(d.GetObject().parentNode);if(this.link)this.link(d.Key,d);else{console.warn('\u5efa\u8bae\u91c7\u7528\u5b9a\u4e49 EWA.F.FOS["xx"].link = function(nodeKey, node){}');e='link("'+d.Key+'","'+e.Key+'","'+d.Text.replace(/\n/mig,"\\n").replace(/\r/mig,"\\r").replace(/"/mig,"&quot;")+'"';for(var g=0;g<d.AddParas.length;g+=1)e=null==d.AddParas[g]?e+",null":e+(',"'+d.AddParas[g]+'"');EWA.C.Utils.RunCmd(e+");")}};this.ShowMenu=function(d){EWA.CurUI=this;var e=this.Click(d,
!0);null!=this.Menu&&null!=e&&(e=this.GetNode(e),this.Menu.ShowByMouse(d,e.MenuGroup))};this.TestIcon=function(d){if(null==this.Icons)return"TD01A";for(var e in this.Icons){var g=this.Icons[e],h=null;switch(g.TEST.toUpperCase()){case "KEY":h=d.Key;break;case "PARENTKEY":h=d.Parent.Key;break;case "TEXT":h=d.Text;break;case "P0":h=d.AddParas[0];break;case "P1":h=d.AddParas[1];break;case "P2":h=d.AddParas[2];break;case "MG":h=d.MenuGroup}if(null!=h&&eval("/"+g.FILTER+"/ig").test(h))return g.NAME+"A"}return"TD01A"};
this.Create=function(d,e){if(null!=d)if(null==d.Parent)this._CreateFirst(d);else{var g=this._HtmlTemplate.replace("[ID]",'id="'+d.Key+'"');g=g.replace("[TEMP_NODE_ADD_FIELDS]",this.AddCols||"");for(var h="",k=0;k<d.AddParas.length;k+=1)null!=d.AddParas[k]&&void 0!=d.AddParas[k]&&(h+="EWA_P"+k+'="'+d.AddParas[k].replace(/"/ig,"&quot;").replace(/</ig,"&lt;").replace(/</ig,"&gt;")+'" ');g=g.replace("[TMP_ADD_PARAS]",h);g=g.replace("[EWA_MENU_GROUP]",d.MenuGroup);h=this.TestIcon(d);g=g.replace("[B]",
...
"undefined"==typeof link&&(link=EWA_Treelink);EWA.F.T={CUR:null,C:EWA_TreeClass,Node:EWA_TreeNodeClass};

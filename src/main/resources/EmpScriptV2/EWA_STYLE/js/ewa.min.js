...
EWA_Utils.ShowPic=function(a){a=a.src;if(!(0<a.indexOf("pic_no.jpg"))){if(0<a.indexOf("$resized/")){var b=a.indexOf("$resized/");a=a.substring(0,b)}else a=a.replace("_SMAILL.","."),a=a.replace("small","a");window.open(a)}};EWA_Utils.ShowBgPic=function(a){if(a=$(a).css("background-image"))if(a=a.slice(4,a.length-1)){if(a.startsWith('"')||a.startsWith("'"))a=a.slice(1,a.length-1);0<a.indexOf("pic_no.jpg")||(a=a.replace("_SMAILL.",".").split("$resized")[0],a=a.replace("small","a"),window.open(a))}};
EWA_Utils.RunCmd=function(a,b){"string"==typeof a?(b=a,EWA.LastMenuMsg=""):(b=a.getAttribute("EWA_CMD"),EWA.LastMenuMsg=GetInnerText(a).trimEx());null!=b&&0<b.trim().length&&eval(b)};EWA_Utils.ReloadValidCodeImage=function(){for(var a=document.getElementsByTagName("IMG"),b=0;b<a.length;b+=1){var c=a[b];0<c.src.indexOf("/cgi-bin/_co_/")&&(c.src=c.src)}alert(_EWA_EVENT_MSG.ValidCodeError)};
...
EWA_Utils.LazyBackgroundLoad=function(a,b){var c=b||("CSS1Compat"==document.compatMode?document.documentElement.clientHeight+document.documentElement.scrollTop:document.body.clientHeight+document.body.scrollTop)+50;(a||$(".EWA_GRID_BG_IMG[is_lazy_load=true]")).each(function(){var d=$(this);if(d.offset().top<c){d.removeAttr("is_lazy_load");var e=d.attr("ori_src");d.css("background-image",'url("'+e+'")')}})};
...
function _$J_SELECT(a,b,c,d,e,g,h,k){function l(v,u){var w=v[c],x=b.options[b.options.length]=new Option(w,v[d]);if(u){for(var y=[],A=0;A<u;A++)y.push("");y.push(w);y.join("\u3000")}for(var B in v)v[B]&&x.setAttribute("para_"+B.toLowerCase(),v[B]);x.setAttribute("json",JSON.stringify(v));return x}b.options.length=0;e&&(b.options[0]=new Option("",""),e instanceof Array&&(b.options[0].text=e[0],b.options[0].value=e[1]));if(k){var m=function(v,u){if((v=n[v])&&v._children&&0!=v._children.length)for(var w,
x=0;x<v._children.length;x++)w=v._children[x],l(w,u),m(w[d],u+1)},n={___ROOT___:[]};e={___ROOT___:{}};for(var p,t,q,r=0;r<a.length;r++){q=a[r];p=q[k];t=q[d];if(null===p||""===p||"0"===p)p="___ROOT___";n[p]||(n[p]=[]);n[p].push(q);e[t]=q;e[p]&&(e[p]._children||(e[p]._children=[]),e[p]._children.push(q))}m("___ROOT___",0)}else for(r=0;r<a.length;r++)q=a[r],l(q);g&&(b.value=g);$(b).trigger("change");h&&h(b)}
...
e+=g;var p=[];if("number"===typeof m.length&&!m.propertyIsEnumerable("length")){var t=m.length;for(l=0;l<t;l+=1)p[l]=c(l,m)||"null";var q=0===p.length?"[]":e?"[\n"+e+p.join(",\n"+e)+"\n"+n+"]":"["+p.join(",")+"]";e=n;return q}if("object"===typeof k)for(t=k.length,l=0;l<t;l+=1){var r=k[l];"string"===typeof r&&(q=c(r,m,k))&&p.push(b(r)+(e?": ":":")+q)}else for(r in m)(q=c(r,m,k))&&p.push(b(r)+(e?": ":":")+q);q=0===p.length?"{}":e?"{\n"+e+p.join(",\n"+e)+"\n"+n+"}":"{"+p.join(",")+"}";e=n;return q}}
...
"number"===typeof m.length)k=m;else throw Error("JSON.stringify");else k=function(t,q){if(Object.hasOwnProperty.call(this,t))return q};return c("",{"":l})},parse:function(l,m){function n(p,t){var q,r=p[t];if(r&&"object"===typeof r)for(q in r)if(Object.hasOwnProperty.call(r,q)){var v=n(r,q);void 0!==v?r[q]=v:delete r[q]}return m.call(p,t,r)}if(/^[\],:{}\s]*$/.test(l.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,
...
a.childNodes.length;b+=1)EWA$UI$COMMON.Dispose(a.childNodes[b])}},Drop:function(a){EWA$UI$COMMON.Dispose(a);a.parentNode.removeChild(a)},AniExpand:function(a,b,c,d,e){if(null==d||0>=d)d=10;var g=0,h=b/(1*d),k=c/(1*d),l=a.clientWidth+b,m=a.clientHeight+c,n=window.setInterval(function(){var p=EWA$UI$COMMON.GetObjSize(a);if(g<d-1){var t=p.H+k,q=p.W+h;t>m&&(t=m);q>l&&(q=l);EWA$UI$COMMON.SetSize(a,q,t)}else EWA$UI$COMMON.SetSize(a,l,m);q=EWA$UI$COMMON.GetObjSize(a);t=q.W-p.W;q=q.H-p.H;p=EWA$UI$COMMON.GetPosition(a);
p.Y=p.Y-a.clientHeight-1*a.style.borderTopWidth.replace("px","")-1*a.style.borderBottomWidth.replace("px","");"LEFT_TOP"!=e&&("LEFT_BOTTOM"==e?(q=p.Y-q,t=p.X,EWA$UI$COMMON.MoveTo(a,t,q)):"RIGHT_TOP"==e?(q=p.Y,t=p.X-t,EWA$UI$COMMON.MoveTo(a,t,q)):"RIGHT_BOTTOM"==e?(q=p.Y-q,t=p.X-t,EWA$UI$COMMON.MoveTo(a,t,q)):(q=1*p.Y-q/2,t=1*p.X-t/2,EWA$UI$COMMON.MoveTo(a,t,q),EWA._TmpAniObj=a));g++;g>=d&&(window.clearInterval(n),EWA.UI.Utils.AniExpandCompleateFunction&&(EWA.UI.Utils.AniExpandCompleateFunction(),
...
e.innerHTML='<div class="ewa_lmenu_bar" des="rq1"></div><div  des="rq2"></div>';e.childNodes[1].style.paddingLeft="5px";h.appendChild(e);d[g].style.height="100%";e.childNodes[0].appendChild(d[g]);0==g?$(e).addClass("ewa-lmenu-show"):e.childNodes[1].style.display="none"}for(b=c.childNodes;0<c.childNodes.length;)d=b[0],g=d.getAttribute("EWA_MF_PID"),e=document.createElement("div"),e.innerHTML='<div class="ewa_lmenu_bar1"></div><div style="padding-left:4px;display:none"></div>',g=$X(g).parentNode.parentNode,
$(g).addClass("ewa-lmenu-children"),g.childNodes[1].appendChild(e),e.childNodes[0].appendChild(d)};this._CreateDialog=function(){var b=new EWA_UI_DialogClass;b.Create();b.SetHtml("<table class='ewa_menu_down' border=0 width=100 cellspacing=0 cellpadding=0 onmousemove='window."+this.ClassName+".IsOut=false;' onmouseout='window."+this.ClassName+".IsOut=true; window.setTimeout(function(){var a=window."+this.ClassName+";a.AutoHidden();},1410);' onselectstart='return false' style='cursor:pointer;-moz-user-select:none;' ><tr><td></td></tr></table>");
...
4," ",80);a.setAttribute("tag","txt");c.editor?c.editor.setValue(b):(__VAL__=b,__TYPE__="html",c.aa())};this.execute=function(a){var b=$("#"+this.BoxId+" iframe:eq(0)")[0].contentWindow,c=$("#"+this.BoxId+" iframe:eq(1)")[0].contentWindow,d=b.document,e=a.getAttribute("cmd");if(0==a.id.indexOf("st_"))"CreateLink"==e?d.execCommand(e,!0,null):d.execCommand(e,!1,null);else if(0==a.id.indexOf("fn_"))this[e](a);else if("eraser"==e)this.executeEraser();else if("CODE_TXT"==e){var g=a.getAttribute("tag"),
h=$("#"+this.BoxId+" iframe:eq(0)");d=$("#"+this.BoxId+" iframe:eq(1)");if(g)h.show(),d.hide(),a.setAttribute("tag",""),b.document.body.innerHTML=c.getText();else if(h.hide(),d.show(),d.attr("src0")){b=d.attr("src0");d.attr("src",b);d.removeAttr("src0");var k=this;this._WAIT_CODE_LOAD_COMPLETE=setInterval(function(){"complete"==c.document.readyState&&(window.clearInterval(k._WAIT_CODE_LOAD_COMPLETE),k._WAIT_CODE_LOAD_COMPLETE=null,k.showCode(a))},100)}else this.showCode(a)}else"IMG"==a.id?insertImg(window):
...
EWA.UI.Ext.IdCard2=function(a){var b=[1,31,28,31,30,31,30,31,31,30,31,30,31],c=$(a).attr("sfz_id");c=$($X(c)).show();var d=a.value,e=c.find("div");e.html("");for(var g=!0,h=[],k=[],l=[],m=[],n=0;n<d.length;n++){var p=d.substring(n,n+1),t="";6>n?h.push(p):6<=n&&10>n?k.push(p):10<=n&&12>n?l.push(p):12<=n&&14>n&&m.push(p);17>n?isNaN(p)&&(t="red",g=!1):"x"!=p&&"X"!=p&&isNaN(p)&&(t="red",g=!1);e[n]&&(e[n].innerHTML="<span style='font-size:16px;color:"+t+"'>"+p+"</span>")}h=k.join("");k=[];if(isNaN(h))g=
...
g?(c.find("i").html("<font color=green>\u6b63\u786e</font>"),b={YEAR:h,MONTH:l,DAY:m,SEX:1*$(e[16]).text()%2},$(a).attr("sfz_json",JSON.stringify(b))):c.find("i").html("<font color=red>"+k.join(", ")+"\u9519\u8bef</font>")};"undefined"==typeof EWA&&(EWA={});
...
"/"!=EWA.CP?c.value.replace(EWA.CP,""):c.value,d=d.replace("//","/");else if("INPUT"==b&&c.getAttribute("val_ref")){a=c.getAttribute("val_ref");try{d=eval("(function(){var a="+a+";return a;})()")}catch(g){console.log(a),console.log(g),d=""}}else d="INPUT"!=b||"checkbox"!=c.type&&"radio"!=c.type?c.value:c.checked?c.value:"";return d}}function EWA_FrameResourceDescription(){this.Memo=this.Info=this.Lang=null}
...
function EWA_FrameClass(){this._Ajax=this.Xml=null;this.ItemList=new EWA_FrameCommonItems;this.Resources={};this.ReloadAfter=this._Id=this._ValidExObj=this._ValidExFail=this._ValidExOk=this.Url=null;this.isShowPostWaitting=!0;this.getObj=function(a){var b=$("#EWA_FRAME_"+this._Id);return a?b.find(a):b};this.switchButtonAction=function(a,b){if(b){var c=this.getUrlClass(),d={};d.ewa_switch_name=a.name;d.ewa_action=b;d.ewa_ajax="json";d.ewa_switch=a.checked?"on":"off";b=a.parentNode;var e=b.getAttributeNames(),
g;for(g in e){var h=e[g],k=b.getAttribute(h);0!=h.indexOf("on")&&"name"!=h&&"id"!=h&&"class"!=h&&(d[h]=k)}var l=this;c=c.GetUrl();$JP(c,d,function(m){l.extSwitchCallBack&&l.extSwitchCallBack(a,m)})}};this.setDisable=function(){var a=this.getObj();a.find("input,textarea,select,label").each(function(){this.disabled||"hidden"==this.type||(this.disabled=!0,this.setAttribute("ewadisabled",1))});a.find(".EWA_DHTML").each(function(){if("DIV"==this.tagName)var b=$(this).find("iframe")[0].contentWindow,c=
setInterval(function(){if("complete"==b.document.readyState){window.clearInterval(c);b.frames[0].document.body.contentEditable=!1;b.frames[0].document.body.style.backgroundColor="#eee";var e=b.document.getElementsByClassName("but")[0];e.style.pointerEvents="none";e.style.filter="grayscale(1) opacity(0.8)"}},300);else if("TEXTAREA"==this.tagName){var d=$(this).parent();c=setInterval(function(){var e=d.find("iframe");0<e.length&&(e=e[0].contentWindow)&&"complete"==e.document.readyState&&(window.clearInterval(c),
e.document.body.contentEditable=!1,e.document.body.style.backgroundColor="#eee",d.find(".ewa-editor").attr("ewadisabled",1))},300)}})};this.setEnable=function(){var a=this.getObj();a.find("input,textarea,select,label").each(function(){this.disabled&&this.getAttribute("ewadisabled")&&(this.disabled=!1,this.removeAttribute("ewadisabled"))});a.find(".EWA_DHTML").each(function(){if("DIV"==this.tagName){var b=$(this).find("iframe")[0].contentWindow;b.frames[0].document.body.contentEditable=!0;b.frames[0].document.body.style.backgroundColor=
"";b=b.document.getElementsByClassName("but")[0];b.style.pointerEvents="";b.style.filter=""}else if("TEXTAREA"==this.tagName){var c=$(this).parent();b=c.find("iframe")[0].contentWindow;b.document.body.contentEditable=!0;b.document.body.style.backgroundColor="";c.find(".ewa-editor").removeAttr("ewadisabled")}})};this.convertFilterCheckbox=function(a,b,c,d,e,g){function h(u){var w=$("<nobr></nobr>");p.append(w);p.append(" ");var x=$(u).parent();u=$(u).attr("id")+"_"+t;x.attr("id",u);w.append(x.children());
w.attr("ref_id",u)}function k(u){u=$(u).parent();var w=u.attr("ref_id");w&&($("#"+w).append(u.children()),u.remove())}var l={},m=this.getObj(".ewa-row-"+a),n=this.getObj(".ewa-row-"+b),p=$("<div class='ewa-filter-checked'></div>");m.find("#"+a).prepend(p).addClass("ewa-filter-chks");var t=this._Id;c||(c="PY");m.find("input[type=checkbox]").each(function(){var u=JSON.parse($(this).attr("json"))[c];u&&(u=u.toUpperCase().trim().substring(0,1),l[u]||(l[u]=[]),l[u].push(this.id),this.checked&&h(this),
$(this).on("change",function(){this.checked?h(this):k(this)}))});a="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");b=["<a class='ewa-filter-char ewa-filter-char-all' code=''>ALL</a>"];for(var q in a){var r=a[q],v=l[r];v&&b.push("<a class='ewa-filter-char' code='"+r+"'>"+r+"<span class='ewa-filter-char-num'>("+v.length+")</span></a>")}n.find(".EWA_TD_M").html(b.join(" "));d&&(m.find(".EWA_TD_L").hide(),m.find(".EWA_TD_M").attr("colspan",2));n.find("a.ewa-filter-char").on("click",function(){var u=$(this).attr("code");
m.find("input[type=checkbox]").each(function(){u?this.checked?p.append($(this).parent()):($(this).parent().attr("ref_id")&&k(this),$(this).parent().hide()):$(this).parent().show()});if(u){for(var w=l[u],x=0;x<w.length;x++)m.find("#"+w[x]).parent().show();g&&g(this,m,n)}});e&&e(m,n)};this.createFilterCheckbox=function(a,b,c,d,e,g,h){var k=this;$J(d,function(l){k.createFilterCheckboxByData(a,b,c,l,e,g,h)})};this.createFilterCheckboxByData=function(a,b,c,d,e,g,h){var k={},l=l?"[]":c.split(",");c={};
for(var m in l)c[l[m]]=1;l=[];var n=[],p=a.id;for(m in d){var t=d[m],q=t[e];q&&(q=q.replace(/</ig,"&lt;"));var r=t[g];r&&(r=r.replace(/</ig,"&lt;"));var v=t[h],u=c[q],w=[];w.push("<nobr class='ewa-filter-chk' style='float:left;margin-right:4px'>");w.push('<input class="ewa-filter-chkbox" type="checkbox" ');u&&w.push(" checked ");t=p+"_"+m;w.push(' value="'+q+'" id="'+t+'" name="'+p+'"><label ');w.push(' for="'+t+'">'+r+"</label></nobr>");u?n.push(w.join("")):l.push(w.join(""));b&&(q=v?v.substring(0,
1).toUpperCase():"",k[q]||(k[q]=[]),k[q].push(t))}a.innerHTML=n.join(" ")+" "+l.join(" ");if(b){d=['<a href="javascript:void(0)">ALL</a>'];for(m="A".charCodeAt();m<="Z".charCodeAt();m++)e=String.fromCharCode(m),k[e]&&d.push('<a href="javascript:void(0)">'+e+"</a>");b.innerHTML=d.join(" ");$(b).find("a").each(function(){var x=$(this).text();"ALL"!=x&&$(this).attr("ids",k[x].join(","));$(this).on("click",function(){if("ALL"==$(this).text())$(a).find("nobr.ewa-filter-chk").show();else{var y=$(this).attr("ids").split(","),
A={},B;for(B in y)A[y[B]]=1;$(a).find("input.ewa-filter-chkbox").each(function(){this.checked||A[this.id]?$(this).parent().show():$(this).parent().hide()})}})})}};this.hiddenNoContentRow=function(){var a=$("#EWA_FRAME_"+this._Id);a.find(".EWA_TD_M").each(function(){if(""==$(this).text()&&0==$(this).find("img,a,input[type=text],input[type=button],textarea").length){$(this).parent().hide();var b=$(this).find("*:eq(0)").attr("id");b&&a.find(".ewa-row-"+b).hide().attr("hiddennocontentrow",1)}})};this.itemReload=
function(a,b,c){if(a){var d=new EWA_UrlClass(this.Url);d.AddParameter("EWA_AJAX","SELECT_RELOAD");d.AddParameter("EWA_RELOAD_ID",a);d=d.GetUrl();$J(d,function(e){if(e.RST){var g=e.ITEM.LST,h=$X(a);h.options.length=0;for(var k in g){var l=g[k];l=new Option(l.T,l.V);h.options[h.options.length]=l}b&&(h.value=b);if(c)try{c(e,h)}catch(m){console.log(m)}}else $Tip(e.ERR)})}};this._checkSelectOptionsChange=function(){if(this._SelectFilters){var a=this;this.isSelectFilter&&setTimeout(function(){a._checkSelectOptionsChange()},
311);for(var b in this._SelectFilters){var c=this._SelectFilters[b];this.getObj("#"+c.id).html()!=c.html&&a._selectOptionsChangeed(c)}setTimeout(function(){a._checkSelectOptionsChange()},311)}};this._selectOptionsChangeed=function(a){console.log("changed");var b=this.getObj("select#"+a.id),c="initSelectFilter"+this._Id+"-"+a.id+"-filter",d="initSelectFilter"+this._Id+"-"+a.id+"-filter2",e=this._initSelectFilterCreateCode(a.codeJsonFrom,b);this.getObj("#"+c).html(e);this.getObj("#"+d).html("");a.html=
b.html()};this._initSelectFilterCreateCode=function(a,b){var c=["<option value=''>ALL</option>"];if(a){var d={},e=[];b.find("option").each(function(){if(""!=this.value){var k;this.hasAttribute("para_"+a)?k=this.getAttribute("para_"+a):this.getAttribute("json")&&(k=JSON.parse(this.getAttribute("json"))[a]);k&&!d[k]&&(d[k]=!0,e.push(k))}});var g=e.sort(),h;for(h in g)b=g[h],b=b.replace(/>/ig,"&lt;").replace(/"/,"&quot;"),c.push('<option value="'+b+'">'+b+"</option>")}else for(h="A".charCodeAt();h<=
"Z".charCodeAt();h++)b=String.fromCharCode(h),c.push('<option value="'+b+'">'+b+"</option>");return c.join("")};this.initSelectFilter=function(a,b,c,d){if(!this["INIT_SELECT_FILTER"+a]){this["INIT_SELECT_FILTER"+a]=!0;var e=$("#EWA_FRAME_"+this._Id+" select#"+a),g=e.parent(),h="initSelectFilter"+this._Id+"-"+a+"-filter",k="initSelectFilter"+this._Id+"-"+a+"-filter2",l="initSelectFilter"+this._Id+"-"+a+"-filter-table";$X(l)&&(g.append(e),$($X(l)).remove());g.addClass("ewa-select-filter");h=["<table id='"+
l+"' cellpadding=0 cellspacing=0 width=100%><tr><td class='ewa-select-filter-char'><select class='EWA_SELECT' style='margin-right:4px' id='"+h+"' onchange='EWA.F.FOS[\""+this._Id+'"]._chCode(this,"'+b+'","'+c+"\")'>"];l=this._initSelectFilterCreateCode(d,e);h.push(l);h.push("</select><select id='"+k+"' style='display:none'></select></td><td class='ewa-select-filter-target'></td></tr></table>");g.prepend(h.join(""));g.find(".ewa-select-filter-target").append(e);this._SelectFilters||(this._SelectFilters=
{});g={};g.html=e.html();g.id=a;g.filterType=b;g.filterFrom=c;g.codeJsonFrom=d;this._SelectFilters[g.id]=g}};this._chCode=function(a,b,c){this.isSelectFilter=!0;var d=$(a).next(),e=$(a).parent().parent().find(".ewa-select-filter-target select");0==d[0].options.length&&d.html(e.html());if(""==a.value)e.html(d.html());else{for(var g=["<option></option>"],h=1;h<d[0].options.length;h++){var k=d[0].options[h];this._chCodeFilter(k,b,c,a.value)&&g.push(GetOuterHTML(k))}e.html(g.join(""));this._SelectFilters[e[0].id].html=
e.html();this.isSelectFilter=!1}};this._chCodeFilter=function(a,b,c,d){"json"==b?(a=JSON.parse(a.getAttribute("json"))[c],"ADM_LID"==c&&(c=a.split("."),a=c[c.length-1])):a="text"==b?a.text:a.value;return a?a.substring(0,d.length).toUpperCase()==d.toUpperCase()?!0:!1:!1};this.setUnMust=function(a){(a=this.ItemList.Items[a])&&a.getElementsByTagName("IsMustInput")[0].getElementsByTagName("Set")[0].setAttribute("IsMustInput",0)};this.setMust=function(a){(a=this.ItemList.Items[a])&&a.getElementsByTagName("IsMustInput")[0].getElementsByTagName("Set")[0].setAttribute("IsMustInput",
1)};this.RedrawCreateSpans=function(){for(var a=$("#EWA_FRAME_"+this._Id+" tr"),b=0;b<a.length;b++){var c=a[b];if("none"!=c.style.display)for(var d=0,e=!1,g=c.cells.length-1;0<=g;g--){var h=c.cells[g];"none"==h.style.display?e?d++:(d=1,e=!0):e&&(h.colSpan=d+1,e=!1)}}EWA_FrameShowAlert=EWA_FrameShowAlert1;EWA_FrameRemoveAlert=EWA_FrameRemoveAlert1;$("#EWA_FRAME_"+this._Id+" .ewa_d1").each(function(){this.title=this.innerHTML});for(var k in this.ItemList.Items)a=this.GetItemDescription(k).Memo,null!=
a&&0<a.trim().length&&($("#"+k).attr("placeHolder",a),$("#"+k).attr("title",a));this.RedrawChangWidth()};this.GetItemDescription=function(a){return this.ItemList.GetDescription(a)};this.ShowPlaceHolder=function(a){$("#EWA_FRAME_"+this._Id).addClass("ewa-frame-cols-"+a);for(var b in this.ItemList.Items){var c=this.ItemList.GetValue(b,"Name","Name");if(c=this.GetObject(c)){c=$(c);var d=this.GetItemDescription(b),e=d.Memo,g=d.Info;d=null;1==a?(d=g,null!=e&&0<e.trim().length&&e!=d&&("smsValid"==c.attr("ewa_tag")?
d=e:(e="<div class='ewa-item-memo'>"+e+"</div>",c.parentsUntil("tr").last().append(e))),c.hasClass("ewa-switch")&&c.prepend("<div class='ewa-switch-info'>"+d+"</div>")):2==a&&null!=e&&0<e.trim().length&&(d=e);d&&("hidden"==c[0].type?c.prev().attr("placeholder",d):"SELECT"==c[0].tagName?0<c[0].options.length&&""==c[0].options[0].value&&(c[0].options[0].text="-- "+d+" --",c[0].options[0].value=""):(c.attr("placeHolder",d),c.attr("title",d)))}}};this.RedrawChangWidth=function(){var a=$("#EWA_FRAME_"+
this._Id),b=a.width(),c=a.find(".ewa_msg_box")[0].colSpan/2;$("#EWA_FRAME_"+this._Id+">tbody>tr[class*='ewa-row-']:not('.ewa-row-msg-box')").each(function(){var e=$(this).find("td.ewa_redraw_info:visible").length,g=(b-90*e)/c;$(this).find("td.ewa_redraw_ctl:visible").each(function(){var h=this.colSpan||1;$(this).css("width",g*h)})});var d=this;addEvent(window,"size",function(){d.RedrawChangWidth()})};this.Mearge=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff1a\u8bf7\u7528 Merge");this.Merge(a,
b,c)};this.Merge=function(a,b,c){if(a||b){var d=$("#EWA_FRAME_"+this._Id),e=d.find("#"+a),g=d.find("#"+b);if(0==e.length)console.log("Mearge:"+a+"\u4e0d\u5b58\u5728");else if(0==g.length)console.log("Mearge:"+b+"\u4e0d\u5b58\u5728");else{var h=!1,k=d.find(".ewa-row-"+b+" .EWA_TD_M"),l=null;0==k.length&&(h=!0,k=d.find(".ewa-row-"+b+" .EWA_TD_1"),l=d.find(".ewa-row-"+b+" .EWA_TD"),1==l.length&&(h=!0),b=l.html(),l.html("<table cellpadding=0 cellspacing=0 width=100%><tr><td style='width:50%'></td><td style='display:none'></td><td style='width:50%'></td></tr></table>"),
l.find("td:eq(0)").html(b));if(0==k.length)alert("target parent not exists");else{var m="border-box"==e.css("box-sizing")?0:1*e.css("padding-left").replace("px","")+1*e.css("padding-right").replace("px",""),n="border-box"==e.css("box-sizing")?0:1*g.css("padding-left").replace("px","")+1*g.css("padding-right").replace("px","");d.find(".ewa-row-"+a).hide();null==c&&(c=" - ");var p=k.width(),t=e[0].tagName,q=g[0].tagName;e.parent().hasClass("ewa-select-filter-target")&&(e=d.find(".ewa-row-"+a+" .EWA_TD_M table:eq(0)"),
t="SELECT_WITH_FILTER");var r=0;b=null;c&&(k.append('<span class="mearge-span">'+c+"</span>"),h&&l.find("table:eq(0) td:eq(1)").html('<span class="mearge-span">'+c+"</span>").show(),b=k.find(".mearge-span"),r=b.width()+1+1*b.css("padding-left").replace("px","")+1*b.css("padding-right").replace("px","")+1*b.css("margin-left").replace("px","")+1*b.css("margin-right").replace("px",""));t==q?(c=(p-r)/2-m-2,e.css("width",c),g.css("width",c),h&&l.find("table:eq(0) td:eq(2), table:eq(0) td:eq(0)").css("width",
c)):"SELECT"==t?(e.css("width",100),g.css("width",p-r-m-n-2-2-e.width())):"SELECT_WITH_FILTER"==t?(e.css("width",200),g.css("width",p-r-m-n-2-2-e.width())):"SELECT"==q&&(g.css("width",100),e.css("width",p-r-m-n-2-2-e.width()));g.css("float","left");b&&b.css("float","left");e.css("float","right");k.append(e);k.addClass("ewa-frame-merge");h&&(a=d.find(".ewa-row-"+a+" .EWA_TD").html(),l.find("table:eq(0) td:eq(2)").html(a))}}}};this.MergeExp=function(a,b,c,d){if(b){var e=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),
...
null);try{a.ReloadAfter&&a.ReloadAfter(b)}catch(c){alert(b)}}}else alert("ERROR:\r\n"+b._Http.statusText)};this.RewriteInfo=function(a,b,c,d){for(a=0;a<info.length;a++){var e=info[a],g=e[b];if($X(g)){var h="TD"==$X(g).parentNode.tagName?$X(g).parentNode:$X(g).parentNode.parentNode;"IMG_UPLOAD"==$X(g).getAttribute("ewa_tag")&&(h=$X(g).parentNode.parentNode.parentNode.parentNode.parentNode.parentNode);g=h.parentNode;null==e[c]||""==e[c].trim()?g.style.display="none":3==g.cells.length?(g.cells[2].innerHTML=
e[d],g.cells[0].innerHTML=e[c]):1==g.cells.length&&(g=g.previousSibling,3==g.nodeType&&(g=g.previousSibling),g.cells[1].innerHTML=e[d],g.cells[0].innerHTML=e[c])}}};this._HiddenMemo=function(a,b){var c=a.parentNode.parentNode;b=!1;"none"==c.style.display&&(b=!0);c.style.display="none";c.id="tr_"+a.id;c=c.previousSibling;3==c.nodeType&&(c=c.previousSibling);c.style.display="none";a="<span id=tab_"+a.id+' class="ewa_merge_tab" onclick="EWA.F.FOS[\''+this._Id+"'].ShowMemo(this.id);\">"+c.cells[0].innerHTML+
"</span>";return b?"":a};this.ShowMemo=function(a){for(var b=$X(this._Id+"__ewa_meger").getElementsByTagName("SPAN"),c=0;c<b.length;c++){var d=b[c].id.replace("tab_","tr_");"ewa_merge_tab1"==b[c].className&&(b[c].className="ewa_merge_tab",$X(d).style.display="none");b[c].id==a&&(b[c].className="ewa_merge_tab1",$X(d).style.display="")}};this.MergeMemo=function(){var a=$X("EWA_FRAME_"+this._Id).getElementsByTagName("textarea");if(0!=a.length&&"1"!=a[0].getAttribute("ewa_merge")){for(var b=[],c=0;c<
a.length;c++){var d=this._HiddenMemo(a[c]);d="<nobr>"+d.replace("\u2022 ","").trim()+"</nobr>";b.push(d)}a=a[0];c=a.parentNode.parentNode;d=c.previousSibling;3==d.nodeType&&(d=d.previousSibling);d.id=this._Id+"__ewa_meger";d.cells[0].colSpan=3;d.cells[0].innerHTML=b.join("");d.cells[0].style.width="100%";d.cells[0].style.height="25px";d.style.display="";c.style.display="";$X("tab_"+a.id).className="ewa_merge_tab1";null!=window._EWA_DialogWnd&&EWA.UI.Dialog._SetTitle(window._EWA_DialogWnd)}};this.DoValidEx=
function(a,b,c,d,e,g){""!=a.value&&(this._ValidExOk=this.Resources[e],this._ValidExFail=this.Resources[g],this._ValidExObj=a,"action"==b.toLowerCase().trim()?this._DoValidExAction(a,d,this.Resources[e].GetInfo(),this.Resources[g].GetInfo()):eval(c)?(EWA_FrameShowAlert(a,this._ValidExOk.GetInfo()),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,this._ValidExFail.GetInfo()),a.setAttribute("EWA_VALID_EX",this._ValidExFail.GetInfo())))};this._DoValidExAction=function(a,b,c,d){if(null!=a&&!$(a).is(":hidden"))if(null==
b||""==b.trim())alert("action not value");else{var e=a.id+","+a.value;if(this.DoValidExAction_RETS&&null!=this.DoValidExAction_RETS[e])0==this.DoValidExAction_RETS[e]?(EWA_FrameRemoveAlert(a,c),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,d),a.setAttribute("EWA_VALID_EX",d));else{var g=new EWA.C.Ajax;g.LoadingType="image";g.AddParameter("EWA_AJAX","HAVE_DATA");g.AddParameter("EWA_ACTION",b);g.AddParameter("EWA_ID",this._Id);g.AddParameter("EWA_NO_CONTENT","1");g.AddParameter(a.id,a.value);
this.DoValidExAction_RETS||(this.DoValidExAction_RETS={});var h=this;g.PostNew(this.Url,function(){if(4==g._Http.readyState){g.HiddenWaitting();if(200==g._Http.status){var k=g._Http.responseText;if(EWA.F.CheckCallBack(k))try{var l=parseInt(k.trim());h.DoValidExAction_RETS[e]=l;0==l?(EWA_FrameRemoveAlert(a,c),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,d),a.setAttribute("EWA_VALID_EX",d))}catch(m){alert(m+","+k)}}else alert("ERROR:\r\n"+g._Http.statusText);g=null}})}}};this.ValidCodeError=
function(a){$(".ewa-valid-code-img").each(function(){this.click()});a||($Tip(_EWA_EVENT_MSG.ValidCodeError),$(".ewa-valid-code-img").parent().parent().find("input").focus().select())};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.F=this;this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);"enus"==EWA.LANG&&$(".ewa-ipt-droplist").attr("placeholder","Input character selection");this._InitTranslations();this._GetDropListValue();
this._InitMustInputs();this._InitEncyptions()};this._InitMustInputs=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name");0<$(c).find('IsMustInput Set[IsMustInput="1"]').length&&(c="#"+d,a.find(".ewa-row-"+d).addClass("ewa-row-must"),d=a.find(c),d.addClass("ewa-row-item-must"),0<d.length&&d.attr("type")&&"hidden"==d.attr("type").toLowerCase()&&d.prev().addClass("ewa-row-item-must"))}};this._InitEncyptions=
function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name");c=$(c).find("DispEnc Set");if(0!=c.length&&(d=a.find("#"+d),0!=d.length&&c.attr("EncType"))){if("INPUT"==d[0].tagName||"TEXTAREA"==d[0].tagName){if(!d.val())continue;d.prop("disabled",!0);d.attr("ewa_encyrption","yes")}var e=$("<div class='ewa-enc-cover' style='position:absolute;left:0;top:0;width:100%;height:100%;'><div></div></div>");d.parent().append(e);
d.parent().css("position","relative");if(c=c.attr("EncShowUrl")){e.find("div").html("\u70b9\u51fb\u67e5\u770b").css({position:"absolute",height:30,"line-height":"30px",top:"50%","margin-top":"-15px",right:10,"text-align":"right"});c=new EWA_UrlClass(c);e=new EWA_UrlClass(this.Url);for(var g in e._Paras)if(!c.GetParameter(g)){var h=e._Paras[g];null!=h&&(h=h.unURL());c.AddParameter(g,h)}c.AddParameter("EWA_ENCY_FROM_ID",d.attr("id"));c=c.GetUrl();d.parent().attr("enc_url",c).attr("fid",d.attr("id"));
d.parent().on("click",function(){if(!$(this).attr("enc_ok")){var k=$(this).attr("t")||100,l=(new Date).getTime();if(!(400>l-k)){$(this).attr("t",l);k=$(this).attr("enc_url");var m=$(this).find("#"+$(this).attr("fid"));$J(k,function(n){n.RST?(m.prop("disabled",!1),m.removeAttr("ewa_encyrption"),m.val(n.VALUE),$(m).parent().find(".ewa-enc-cover").remove(),$(m).parent().attr("enc_ok","1")):(n.ERR||n.MSG)&&$Tip(n.ERR||n.MSG)})}}})}}}};this._InitTranslations=function(){var a="EWA.F.FOS[&quot;"+this._Id+
"&quot;]._Trans(this)",b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name"),e=$(c).find("DataItem Set[Translation]");if(c=e.attr("Translation")){e=e.attr("TransTarget");var g="en2zh"==c?" \u82f1\u8bd1\u4e2d":" \u4e2d\u8bd1\u82f1";"enus"==EWA.LANG&&(g="en2zh"==c?" En-Zh":" Zh-En");c=$('<a class="ewa-but-trans" href="javascript:void(0)" onclick="'+a+'" _transf="'+d+'" _transp="'+c+'" _transt="'+e+'">'+g+"</a>");e=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+
d+" .EWA_TD_L");0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+d+" .EWA_TD"));0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" #"+d).parent().prev().find(".ewa_d1"));0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" #"+d).parent(),e.css("position","relative"),c.addClass("ewa-but-trans-float"));e.append(c)}}};this._Trans=function(a){if(a){var b=$(a).attr("_transf"),c=$(a).attr("_transp");a=$(a).attr("_transt");b=$("#EWA_FRAME_"+this._Id+" #"+b);a=$("#EWA_FRAME_"+this._Id+" #"+a);if(0==b.length||0==a.length)console.log("trans ex:",
b,a);else{var d=b[0].tagName.toLowerCase();if(b="input"==d||"textarea"==d||"hidden"==d?b.val():b.text()){var e=new EWA_TransClass;"en2zh"==c?e.transToCn(b,a[0]):e.transToEn(b,a[0]);$Tip("enus"==EWA.LANG?"Translating...":"\u7ffb\u8bd1\u4e2d...",function(){return!e.IsRun})}}}};this._bindCompostion=function(a,b){if(!EWA.B.IE){var c=this;c._droplist_||(c._droplist_={});c._droplist_[b.id]={_is_composition:!1};$(a).on("compositionstart",function(){c._droplist_[b.id]._is_composition=!0}).on("compositionend",
function(){c._droplist_[b.id]._is_composition=!1;EWA.F.I.DropList(this)}).removeAttr("oninput").removeAttr("onkeyup").on("input",function(){c._droplist_[b.id]._is_composition||EWA.F.I.DropList(this)})}};this._GetDropListValue=function(){var a=this.getObj();if(0!=a.length){a=a[0];var b=a.getElementsByTagName("input");this._droplist_={};for(var c=0;c<b.length;c++){var d=b[c];if("droplist"==d.getAttribute("ewa_class")){var e=d.nextSibling;"INPUT"==e.tagName.toUpperCase()&&"HIDDEN"==e.type.toUpperCase()&&
(this._GetDropListValue1(d,e),this._bindCompostion(d,e))}}a=a.getElementsByTagName("select");for(c=0;c<a.length;c++)if(d=a[c],b=d.getAttribute("_ListFilterType"))e=d.getAttribute("_ListFilterField"),this.initSelectFilter(d.id,b,e);this._SelectFilters&&this._checkSelectOptionsChange()}};this._GetDropListValue1=function(a,b){if(""==b.value)b.setAttribute("setvalue",1);else{var c=b.getAttribute("DlsShow");if(null==c||""==c)b.setAttribute("canopen",0),a.value=b.value,b.setAttribute("canopen",1);else{var d=
new EWA_AjaxClass,e=b.getAttribute("xmlName"),g=b.getAttribute("itemName"),h=b.getAttribute("paraName"),k=b.getAttribute("DlsAction");d=new EWA.C.Ajax;var l=b.value;var m=this.EWA_CGI?this.EWA_CGI:window.EWA_CGI?window.EWA_CGI:EWA.CP+"/EWA_STYLE/cgi-bin/";var n=-1==m.indexOf("?")?"?":"&";m=(m+(n+"XMLNAME="+e+"&ITEMNAME="+g+"&EWA_AJAX=JSON")).replace("//","/");m=m.replace("//","/");m=m.replace("//","/");d.AddParameter(h,l);null!=k&&0<k.trim().length&&(d.AddParameter("EWA_ACTION",k),d.AddParameter(b.id,
b.value));d.PostNew(m,function(){if(d.IsRunEnd()){var p=d.GetRst(),t="__json"+Math.random();try{eval('window["'+t+'"]='+p)}catch(u){b.setAttribute("canopen",0);a.value=u;b.setAttribute("canopen",1);return}p=window[t];if(0!=p.length){t=p[0];var q=[];p={};for(var r in t)q.push(t[r]),p["@"+r.toUpperCase()]=t[r],t[r]&&b.setAttribute("para_"+r.toLowerCase(),t[r]);if(null==c||""==c)p=q.join("/");else{r=c.match(/@[a-zA-Z0-9\-\._:]*\b/ig);for(t=0;t<r.length;t++){q=r[t];var v=p[q.toUpperCase()];c=c.replace(q,
v)}p=c}b.setAttribute("canopen",0);a.value=p;b.id=null==b.id||""==b.id?Math.random():b.id;"yes"==b.getAttribute("isdlseventload")&&(EWA.F.FOS[b.id]=new EWA_FrameItemClass,EWA.F.FOS[b.id].DropList(a),EWA.F.FOS[b.id].CallAfterEvent());b.setAttribute("canopen",1);b.setAttribute("setvalue",1)}}})}}};this.DoPostEx=function(){EWA.F.F.CUR=this;if(this.CheckValidAll(document.forms[0])){this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST",
"1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");for(var a=document.getElementsByTagName("input"),b=0;b<a.length;b+=1){var c=a[b],d=""==c.name?c.id:c.name;null!=d&&""!=d&&this._Ajax.AddParameter(d,c.value)}a=document.getElementsByTagName("select");for(b=0;b<a.length;b+=1)c=a[b],d=""==c.name?c.id:c.name,null!=d&&""!=d&&this._Ajax.AddParameter(d,c.value);a=document.getElementsByTagName("textarea");for(b=0;b<a.length;b+=1)c=a[b],d=""==c.name?c.id:c.name,null!=d&&""!=d&&this._Ajax.AddParameter(d,c.value);
this._Ajax.PostNew(this.Url,EWA.F.F.CUR._CallBack)}};this.CreateAjax=function(a,b){EWA.F.F.CUR=this;null==a&&(a=$("#f_"+this._Id)[0]);if(!b&&!this.CheckValidAll(a))return null;b=new EWA.C.Ajax;for(var c in this.ItemList.Items){var d=this.ItemList.GetItemValue(this.ItemList.Items[c],"Name","Name"),e=this.GetObject(d,a);if(null!=e&&!$(e).attr("ewa_encyrption")){var g=e.getAttribute("ewa_tag");if("signature"==g){var h="N";var k=this.tablets[c];for(var l=0;l<k.lines.length;l++)if(k.lines[l]){h="Y";break}k=
"Y"==h?this._GetObjectValue(e):"";b.AddParameter(d+"_CHANGED",h)}else k=this._GetObjectValue(e);null!=k&&b.AddParameter(d,k);"DIV"==e.tagName.toUpperCase()&&"1"==e.getAttribute("EWA_DHTML")&&(h=$X("UP_IMG_"+d).value,b.AddParameter(d+"_imgs_split",h));if("swffile"==g||"IMG_UPLOAD"==g)if(d=e.getAttribute("UP_PARAS"),null!=d&&0<d.length)for(d=d.split(","),g=0;g<d.length;g++){var m=d[g];b.AddParameter(m,e.getAttribute(m))}else b.AddParameter("UP_URL",e.value);else"markdown"==g&&(e=e.parentNode.getElementsByTagName("textarea"),
1<e.length&&b.AddParameter(e[1].id,e[1].value))}}if(this.PostAddData)for(m in this.PostAddData)b.AddParameter(m,this.PostAddData[m]);return b};this.CreatePostData=function(){var a=$("#f_"+this._Id)[0],b={},c;for(c in this.ItemList.Items){var d=this.ItemList.GetItemValue(this.ItemList.Items[c],"Name","Name"),e=this.GetObject(d,a);if(null!=e){var g=this._GetObjectValue(e);null!=g&&(b[d]=g);"DIV"==e.tagName.toUpperCase()&&"1"==e.getAttribute("EWA_DHTML")&&(g=$X("UP_IMG_"+d).value,b[d+"_imgs_split"]=
g);d=e.getAttribute("ewa_tag");if("swffile"==d||"IMG_UPLOAD"==d)if(g=e.getAttribute("UP_PARAS"),null!=g&&0<g.length){g=g.split(",");for(var h=0;h<g.length;h++){var k=g[h];b[k]=e.getAttribute(k)}}else b.UP_URL=e.value;"markdown"==d&&(e=e.parentNode.getElementsByTagName("textarea"),1<e.length&&(b[e[1].id]=e[1].value))}}return b};this.DoPostBefore=function(){return!0};this.isDoPostBeforeTimer=function(){return null!=this._checkStatusFristResult};this._uploadingFileCheck=function(a){a=window["h5u_"+this._Id+
"$"+a.id];if(!a.haveFile())return!1;if("ok"==a.UPLOAD_STATUS)return a.removeWaitBox(),this.uploadProcess=!1;if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;if("error"==a.UPLOAD_STATUS||"abort"==a.UPLOAD_STATUS)return this._stopPost=!0,this._stopPostError="enus"==EWA.LANG?"Upload file error or aborted":"\u4e0a\u4f20\u6587\u4ef6\u9519\u8bef\u6216\u88ab\u4e2d\u6b62",console.log(this._stopPostError),!1;if("start"==a.UPLOAD_STATUS||"checking"==a.UPLOAD_STATUS)return!0;a.submitUploads();
if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;$X(a.WAIT_ID)||a.createWaitBox();return this.uploadProcess=!0};this.DoPost=function(a,b,c){if(!c){c=this.DoPostBefore();if(c instanceof Array){var d=this;this._checkStatusInc=0;this._checkStatusFristResult=c;this._checkStatusTimer=window.setInterval(function(){var l=0==d._checkStatusInc?d._checkStatusFristResult:d.DoPostBefore();d._checkStatusInc++;null!=l[0]&&(window.clearInterval(d._checkStatusTimer),d._checkStatusTimer=
null,d._checkStatusInc=null,d._checkStatusFristResult=null,0==l[0]?l[2]?$Confirm(l[1],l[1],function(){l[0]=l[1]=null;d.DoPost(a,b,!0)},function(){}):$Tip(l[1]):(l[0]=l[1]=null,d.DoPost(a,b,!0)))},232);return}if(!c)return}var e=$(a).find("input[ewa_tag=ht5upload]");if(!(0<e.length)||this.uploadProcess||this.CheckValidAll(a)){var g=0;d=this;for(c=0;c<e.length>0;c++){var h=e[c];this._uploadingFileCheck(h)&&g++}if(0<g)setTimeout(function(){d.DoPost(a,b)},700);else if(e=$(a).find("input[ewa_tag=ht5takephoto]"),
!(0<e.length)||this.uploadProcess||this.CheckValidAll(a)){for(c=0;c<e.length>0;c++){h=e[c];g=!1;h=window["h5takephoto_"+this._Id+"$"+h.id];if("ok"!=h.UPLOAD_STATUS){if(!$X(h.H5_UPLOAD.WAIT_ID)){try{h.submitUpload()}catch(l){console.log("ht5takephotos - ht5.submitUpload: "+l);$Tip("\u60a8\u6ca1\u6709\u83b7\u53d6\u7167\u7247");return}h.H5_UPLOAD.createWaitBox();this.uploadProcess=!0}g||(d=this,setTimeout(function(){d.DoPost(a,b)},700),g=!0);return}h.H5_UPLOAD.removeWaitBox()}if(this._stopPostError)EWA.UI.Msg.ShowError(this._stopPostError,
"");else if(c=this.CreateAjax(a),null!=c){null==b&&(b=this.Url);if(""==b||null==b)b=window.location.href;this._Ajax=c;this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.LoadingType="image";this.DoPostStart&&this.DoPostStart(this._Ajax);c=new EWA_UrlClass(b);for(var k in this._Ajax._Parameters)c.RemoveParameter(k);b=c.GetUrl();this._Ajax.PostNew(b,EWA.F.F.CUR._CallBack);this.isShowPostWaitting||this._Ajax.HiddenWaitting();
$("#EWA_FRAME_"+this._Id+" input[type=submit]").attr("disabled","disabled")}}}};this._CallBack=function(){var a=EWA.F.F.CUR._Ajax;if(a.IsRunEnd())if($("#EWA_FRAME_"+EWA.F.F.CUR._Id+" input[type=submit]").attr("disabled",null),EWA.F.F.CUR.DoPostEnd&&EWA.F.F.CUR.DoPostEnd(a,a._Http.status,a._Http.responseText,a._Http.statusText),200==a._Http.status){if(a=a._Http.responseText,EWA.F.CheckCallBack(a)){EWA.F.F.CUR.ValidCodeError(!0);try{EWA.F.F.CUR.ReloadAfter&&EWA.F.F.CUR.ReloadAfter(a),eval(a)}catch(b){alert(a)}}}else alert("ERROR:\r\n"+
a._Http.statusText)};this.Reload=function(){};this.Reload1=function(){console.log("Reload1 \u8fd9\u4e2a\u5e72\u561b\u7528\uff1f\u8c01\u5728\u8c03\u7528\uff1f")};this.ReloadFrame=function(a){var b=$("#EWA_FRAME_"+this._Id);if(0!=b.length){var c=b.parentsUntil("#EWA_FRAME_MAIN").last().parent();if(0!=c.length){b=EWA_Utils.tempId("ewa_frame_relaod");c.attr("id",b);var d=new EWA_UrlClass(this.Url);d.AddParameter("ewa_ajax","install");d=d.GetUrl();$Install(d,b,function(){a&&a(c,this)})}}};this.CheckValidAll=
function(a){var b=!0,c=null,d;for(d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],"Name","Name");e=this.GetObject(e,a);null!=e&&((b&=this.CheckValid(e))||null!=c||(c=e))}null!=c&&c.focus();return b};this.H5Type=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name");d=a.find('[id="'+d+'"]');if(0!=d.length){var e=this.ItemList.GetItemValue(c,"Tag","Tag"),g=this.ItemList.GetItemValue(c,
"DataItem","Valid");this.ItemList.GetItemValue(c,"DataItem","Format");c=this.ItemList.GetItemValue(c,"IsMustInput","IsMustInput");"Email"==g&&d.attr("type","email");"valid"==e&&d.attr("type","tel");1==c&&d.attr("required","required")}}};this.GetObject=function(a,b){b||(b=$("FORM#f_"+this._Id));a=$(b).find('[id="'+a+'"]');return 0<a.length?a[0]:null};this.CheckValid=function(a,b){if("SPAN"==a.tagName||"IMG"==a.tagName)return!0;if(a&&b&&"DIV"==a.tagName&&"REPT"==a.getAttribute("tag")){b=b.target.tagName;
if("LABEL"==b||"INPUT"==b){var c=this;setTimeout(function(){c._GetObjectValue(a);c.ItemList.CheckValid(a,d)},10)}return!0}var d=this._GetObjectValue(a);return this.ItemList.CheckValid(a,d)};this._GetObjectValue=function(a){return this.ItemList.GetObjectValue(a)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}var __EWA_ALTER_MSG=null;
...
window[n].GetHtml();window.onmousedown=null;n=d.attr("oldv");p==n?($(d).attr("style",""),l.hide()):(n={key:$(a).attr("ref"),val:p},$JP(m.POST_URL||window.location.href,n,function(t){$(d).attr("style","");l.hide();t.RST?(""==p&&(p="............."),b.html(p),$TipTL("\u4fdd\u5b58\u5b8c\u6bd5"),b.append('<i style="margin-left:5px" class="fa fa-edit"></i>')):$Tip(t.ERR)}))}}};this.checkInHtmlEditor=function(a){a=$(event.target).parents();for(var b=0;b<a.length;b++){var c=$(a[b]);if(c.hasClass("ewa-editor")||
...
a).cells[0]).text();var k=this.createRefCaption(a,g,d,e);c.focus();if(!c.attr("evtblur")){c.attr("evtblur","is_setted");var l=this;addEvent(c[0],"keydown",function(m){m=m.keyCode;13==m&&"TEXTAREA"!=c[0].tagName?this.blur():27==m&&(this.value=$(this).attr("oldv"),this.blur())});addEvent(c[0],"blur",function(){var m=$(this.parentNode.parentNode.cells[0]),n=m.css("background-color"),p=$(this).attr("onmousedown");if(p){var t=p.indexOf(".CheckValid");p=p.substring(0,t);if(eval(p).CheckValid(this))$(this).css("background",
"");else{this.focus();$(this).css("background","pink");return}}p=this.id;t=this.value;"droplist"==$(this).attr("ewa_class")&&(t=$(this).next().val(),p=$(this).next().attr("id"));p={key:p,val:t};if("rgb(255, 255, 224)"==n)$Tip(m.html()),k.hide(),this.focus();else if(this.value==$(this).attr("oldv"))$(this).attr("style",""),k.hide();else{var q=this;$JP(l.POST_URL||window.location.href,p,function(r){$(q).attr("style","");k.hide();r.RST?(r="SELECT"==q.tagName?q.options[q.selectedIndex].text:q.value,"TEXTAREA"==
q.tagName?""==r?b.html("............."):(r=r.replace(/</ig,"&lt;").replace(/>/ig,"&gt;"),r="<div>"+r.split("\n").join("</div><div>")+"</div>",b.html(r)):(""==r&&(r="............."),b.text(r)),b.append('<i style="margin-left:5px" class="fa fa-edit"></i>'),$TipTL("\u4fdd\u5b58\u5b8c\u6bd5")):$Tip(r.ERR)})}})}}}
...
!1;this.CheckedAllAfter=this.ReloadAfter=null;this.REPLACE_HISTORY_STATE=this.IsNotMDownAutoChecked=!1;this.composeSearchTexts=function(){var a=[],b=[],c=$("#EWA_RESHOW_"+this._Id+" .ewa-lf-search-type-text");if(0==c.length)return null;c.each(function(g){var h=$(this).find(".ewa-lf-search-item-title").text();h=h.replace(":","").replace("\uff1a","").replace("\u5305\u542b","").replace("Like","").trim();var k=$(this).find("input[type=text]").attr("name");a.push(h);b.push(k);0<g&&$(this).hide()});var d=
$(c[0]);d.addClass("ewa-app-lf-search-compose");d.find("input[type=text]").attr("name",b.join(",")).attr("placeholder",a.join(", "));var e=d.find("a").clone();d.find(".ewa-lf-search-item-title b").text("enus"==EWA.LANG?"Search":"\u7efc\u5408\u641c\u7d22").append(e);return c};this.switchButtonAction=function(a,b){if(b){var c=this.getUrlClass();c.AddParameter("ewa_switch_name",a.name);c.AddParameter("ewa_action",b);c.AddParameter("ewa_ajax","json");c.AddParameter("ewa_switch",a.checked?"on":"off");
c.AddParameter("ewa_action_key",$(a).parentsUntil("tbody").last().attr("ewa_key"));var d=a.parentNode,e=d.getAttributeNames();b={};for(var g in e){var h=e[g],k=d.getAttribute(h);0!=h.indexOf("on")&&"name"!=h&&"id"!=h&&"class"!=h&&(b[h]=k)}var l=this;c=c.GetUrl();$JP(c,b,function(m){l.extSwitchCallBack&&l.extSwitchCallBack(a,m)})}};this.replaceRowsData=function(a,b){var c=this.getUrlClass();c.AddParameter("EWA_AJAX","LF_RELOAD");c.AddParameter("EWA_IS_SPLIT_PAGE","no");c.AddParameter("EWA_IS_HIDDEN_CAPTION",
"yes");c=c.GetUrl();a&&(c+="&"+a);var d=$("#EWA_LF_"+this._Id);$J2(c,function(e){$(e).find("tr.ewa-lf-data-row").each(function(){var g=$(this).attr("ewa_key"),h=d.find('tr[ewa_key="'+g+'"]');$(this).find("td").each(function(){var k=$(this).children(0).attr("name");k&&(k=h.find(".ewa-col-"+k),0!=k.length&&(b?b(this,k[0]):k.html($(this).html())))})})})};this.ShowRecycle=function(){var a=$X("EWA_LF_"+this._Id);if(null!=a&&(a=$(a).parentsUntil("table").last().find(".ewa_lf_func_caption"),0!=a.length)){var b=
...
$(a).attr("recycle",1).addClass("ewa-lf-func-recycle-yes"));this.Url=b;this.Goto(1)};this.BindButton=function(a,b){$("#EWA_LF_"+this._Id+' tr[ewa_key] [id="'+a+'"]').each(function(){$(this).attr("onclick","$(this).parent().parent().find('[id=\""+b+"\"]')[0].click()");$(this).addClass("ewa-map-button")})};this.Merge=function(a,b,c,d,e){var g=$("#EWA_LF_"+this._Id);g.find("tr[ewa_key]").each(function(){var h=$(this).find('[id="'+a+'"]');h.parent().hide();var k=$(this).find('[id="'+b+'"]').parentsUntil("tr").last();
null==c&&(c="<br>");0<=c.indexOf("<")?k.append(c):k.append("<span class='ewa-mearge-str'>"+c+"</span>");k.append(h);d&&d(k,this)});e&&(e="<span class='ewa-lf-merge-header-split'></span>"+g.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(),g.find('tr[ewa_tag="HEADER"] [id="'+b+'"]').append(e));g.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').parent().hide();g.find("td#ADD_ROW_"+a).hide()};this.Mearge=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 Merge");this.Merge(a,b,c)};this.MergeExp=
function(a,b,c,d,e){if(b){var g=$("#EWA_LF_"+this._Id),h=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),k=[],l=b,m={};b=[];for(var n=0;n<h.length;n++){var p=h[n];k.push(p);var t=p.replace("@@","");l=l.replace(p,"<span class='ewa-lf-mearge ewa-lf-mearge-"+t+"' mid=\""+t+'"></span>');t!=a&&(g.find('tr[ewa_tag="HEADER"] [id="'+t+'"]').parent().hide(),g.find("td#ADD_ROW_"+t).hide());p=g.find('tr[ewa_tag="HEADER"] [id="'+t+'"]').html();m[t]=p;b.push(p)}e&&(e=b.join("<span class='ewa-lf-merge-header-split'></span>"),
g.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(e));g.find("tr[ewa_key]").each(function(){var q=document.createElement("div");q.style.display="none";q.innerHTML=l;document.body.appendChild(q);if(0==$(this).find('[id="'+a+'"]').length)console.log("not find "+a);else{var r=$(this).find('[id="'+a+'"]').parent(),v;for(v in k){var u=k[v].replace("@@",""),w=$(this).find('[id="'+u+'"]');if(0!=w.length){u!=a&&w.parent().hide();var x=$(q).find('span[mid="'+u+'"]');c&&(x.append("<span class='ewa-lf-mearge-memo'></span>"),
x.find(".ewa-lf-mearge-memo").html(m[u]));x.append(w)}}for(;0<q.childNodes.length;)r.append(q.childNodes[0]);$(q).remove();d&&d(r,this)}})}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MeargeExp=function(a,b,c,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 MereExp");this.MergeExp(a,b,c,d)};this.SubBottoms=function(a){this.SubBottomsArray=a.split(",");this._SubBottoms()};this._SubBottoms=function(){var a=this.AddRow([]);$(a).find("td").addClass("ewa-lf-sub-td");var b=0,c;
for(c in this.SubBottomsArray){var d=this.SubBottomsArray[c],e=0;$("#EWA_LF_"+this._Id+" .ewa-col-"+d).each(function(){var g=GetInnerText(this).replace(/,/ig,"");isNaN(g)||(e+=1*g,0<g.indexOf(".")&&(b=2))});$(a).find("td[id=ADD_ROW_"+d+"]").html("<nobr class='ewa-lf-sub'>"+e.fm(b)+"</nobr>")}};this.ChangeRowStyle=function(a,b,c){for(var d=$X("EWA_LF_"+this._Id),e=1;e<d.rows.length;e++){var g=d.rows[e];if(!(0==g.cells.length||g.cells.length<=a)){var h=g.cells[a].childNodes[0].getAttribute(b);if(null!=
h&&c[h])for(var k=0;k<g.cells.length;k++)g.cells[k].style.cssText=g.cells[k].style.cssText+";"+c[h]}}if(null==this.ReloadAfter){var l=this;this.ReloadAfter=function(){l.ChangeRowStyle(a,b,c)}}};this.MDownEvent=function(a,b){};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.Workflow=function(a,b,c,d,e,g){EWA.F.CID=this._Id;this._Ajax=this.CreateAjax();this._Ajax.AddParameter("EWA_AJAX","WORKFLOW");this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_WF_NAME",
b);null!=c?(a=this.GetRowKey(c),this._Ajax.AddParameter("EWA_ACTION_KEY",a),"true"==c.getAttribute("ewa_wf_control")?this._Ajax.AddParameter("EWA_WF_CTRL",1):this._Ajax.AddParameter("EWA_WF_CTRL",0)):this._Ajax.AddParameter("EWA_WF_CTRL",1);null!=d&&this._Ajax.AddParameter("EWA_ACTION_KEY",d);e&&this._Ajax.AddParameter("EWA_WF_UOK",e);g&&this._Ajax.AddParameter("EWA_WF_UMSG",g);var h=this;this._Ajax.PostNew(this.Url,function(){h._CallBackJs()})};this.GetRowKey=function(a){a=this.GetRow(a);return null!=
a?a.getAttribute("EWA_KEY"):null};this.GetRow=function(a){if(null==a||null==a.tagName||""==a.tagName)return null;var b=0;for(a=a.parentNode;"TR"!=a.tagName||null==a.getAttribute("EWA_KEY");){a=a.parentNode;if("BODY"==a.tagName){a=null;break}b++;if(100<b){alert("\u5faa\u73af100\u6b21\uff0c\u672a\u53d1\u73b0TR");break}}return a};this.RecordModify=function(a,b,c){var d=this.SelectChecked();if(0==d.length)EWA.UI.Msg.Alter("\u8bf7\u5148\u9009\u62e9","\u4fee\u6539");else{var e="EWA_MTYPE=M";null!=c&&0<
c.trim().length&&(e+="&"+c);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,e+d)}};this.RecordNew=function(a,b,c){var d="EWA_MTYPE=N";null!=c&&0<c.trim().length&&(d+="&"+c);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,d)};this.SelectSingle=function(){this.IsTrSelect=!0;this._TrSelectMulti=!1};this.SelectMulti=function(){this._TrSelectMulti=this.IsTrSelect=!0};this.MOver=function(a,b){if(this.IsTrSelect&&this._CurTr!=a&&(null!=this._CurTr&&("1"!=this._CurTr.getAttribute("__ewa_lf_mdown")?this._MSetBg(this._CurTr,
""):this._MSetBg(this._CurTr,"down")),"1"!=a.getAttribute("__ewa_lf_mdown")?this._MSetBg(a,"over"):this._MSetBg(a,"down"),this._CurTr=a,this.MOverEvent))try{this.MOverEvent(a,b)}catch(c){console.log(c,this.MOverEvent)}};this.MOut=function(a){if(this.IsTrSelect&&null!=this._CurTr&&"1"!=this._CurTr.getAttribute("__ewa_lf_mdown")){this._MSetBg(this._CurTr,"out");if(this.MOutEvent)try{this.MOutEvent(this._CurTr,a)}catch(b){console.log(b,this.MOutEvent)}this._CurTr=null}};this.MDownEnableCheck=function(a,
b){return!0};this.checkMDownEnable=function(a,b){if(!b)return!0;b=b.srcElement?b.srcElement:b.target;return!b||"TD"==b.tagName&&b.parentNode==a?!0:"A"==b.tagName||"A"==b.parentNode.tagName||"INPUT"==b.tagName||"SELECT"==b.tagName||"BUTTON"==b.tagName||"TEXTAREA"==b.tagName||0<=b.className.indexOf("EWA_LF_EDIT")||0<=b.className.indexOf("ewa-lf-edit")||0<=b.className.indexOf("ewa-lf-search-text-click")||0<=b.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=b.parentNode.parentNode.className.indexOf("ewa-lf-search-text-click")||
0<=b.className.indexOf("ewa-mdown-stop")?!1:!0};this.mDownAutoCheck=function(a,b,c){for(var d,e=0;e<b.length&&!(0<=b[e].parentNode.className.indexOf("ewa-switch"));e++){if("RADIO"==b[e].type.toUpperCase())return d=b[e],d.click(),d;if("CHECKBOX"==b[e].type.toUpperCase()){d=b[e];d.click();if(!this._TrSelectMulti){var g=$(b[e]).attr("id")||$(b[e]).attr("name");0==$(c).find(b[e]).length&&$(a).siblings(".ewa-lf-data-row").find("input[name='"+g+"']:checked").prop("checked",!1);d.checked=!0}return d}}return null};
this.MDown=function(a,b){if(this.IsTrSelect){var c=(new Date).getTime(),d=$(a).attr("mdown_time_last");if(!(null!=d&&500>c-d)&&($(a).attr("mdown_time_last",c),b=null==b?window.event:b,this.MDownEnableCheck(a)&&this.checkMDownEnable(a,b))){d=b.srcElement?b.srcElement:b.target;var e=null;c=a.getElementsByTagName("input");this.IsNotMDownAutoChecked||(e=this.mDownAutoCheck(a,c,d));if("1"==a.getAttribute("__ewa_lf_mdown"))this._TrSelectMulti&&(e&&"CHECKBOX"==e.type.toUpperCase()&&(e.checked=!1),this._MSetBg(a,
""),a.removeAttribute("__ewa_lf_mdown"),$(a).removeClass("ewa-lf-mdown"));else{e&&(e.checked=!0);this._MSetBg(a,"down");a.setAttribute("__ewa_lf_mdown",1);$(a).addClass("ewa-lf-mdown");if(!this._TrSelectMulti&&(e=a.parentNode)&&e.rows)for(d=0;d<e.rows.length;d++){var g=e.rows[d];"1"==g.getAttribute("__ewa_lf_mdown")&&g!=a&&(g.removeAttribute("__ewa_lf_mdown"),$(g).removeClass("ewa-lf-mdown"),this._MSetBg(g,""))}if(this.IsReShow)for(d=0;d<c.length;d++)"BUTTON"==c[d].type.toUpperCase()&&(e=c[d],"true"==
e.getAttribute("disabled")||1==e.getAttribute("disabled")||"true"==e.parentNode.getAttribute("disabled")||1==e.parentNode.getAttribute("disabled")?(this._ReshowButs[e.value].disabled=!0,this._ReshowButs[e.value].style.display="none"):(this._ReshowButs[e.value].disabled=!1,this._ReshowButs[e.value].style.display=""))}if(this._IsAddPreRow){if(c=a.getAttribute("ewa_key"),this.AddPreRowCheck(a,c,b)){e=a.parentNode.rows[a.rowIndex+1];if(null==e||1!=e.getAttribute("add_pre_row"))e=a.parentNode.parentNode,
d=e.rows[0].cells.length,e=e.insertRow(a.rowIndex+1),e.setAttribute("add_pre_row",1),g=e.insertCell(-1),g.innerHTML="",g.colSpan=d,g.className="",e.style.display="none",g.id=("EWA_LF_NR_"+this._Id+"_"+Math.random()).replace(".","G"),$(e).addClass("ewa-lf-add-pre-row");this.prevTr&&(this.AddPreRowCloseBeforeEvent&&this.AddPreRowCloseBeforeEvent(this._Id,a,c,this.prevTr,b),this.prevTr.style.display="none",this.prevTr.cells[0].innerHTML="",this.AddPreRowCloseEvent&&this.AddPreRowCloseEvent(this._Id,
a,c,this.prevTr,b));this.prevTr==e?this.prevTr=null:(this.prevTr=e,this.prevTr.style.display="",this.MDownEvent(this._Id,a,c,this.prevTr,b))}}else this.MDownEvent(a,b)}}};this.AddPreRow=function(a){this._IsAddPreRow||(this.MDownEvent=a);this._IsAddPreRow=!0};this.AddPreRowCheck=function(a,b,c){return!0};this.AddPreRowCloseBeforeEvent=function(a,b,c,d,e){};this.AddPreRowCloseEvent=function(a,b,c,d,e){};this._MSetBg=function(a,b){var c="EWA_TD_M";"down"==b?c="ewa_grid_down":"over"==b&&(c="ewa_grid_mover");
for(b=0;b<a.cells.length;b++)$(a.cells[b]).removeClass("ewa_grid_mover ewa_grid_down EWA_TD_M").addClass(c)};this._ReShowSearchQuick=function(){var a=this,b=EWA_ListFrameClass.prototype.RESOURCES.search_text_items,c,d,e;for(e in b){var g=b[e];"eq"==g.Id&&(c=g);"lk"==g.Id&&(d=g)}for(e in this._SearchJson){var h=this._SearchJson[e];h.isSearchQuick&&(b=$("#EWA_LF_"+this.Id+' .ewa-lf-data-row [id="'+e+'"]'),b.bind("click",function(k){k.stopPropagation();k=$(this).attr("search_tag");var l=$(this).text(),
m=l,n=$("#EWA_SEARCH_ITEM_"+a.Id+' .ewa-lf-search-item-ctl [name="'+this.id.toUpperCase()+'"]');if("number"==k||"date"==k)n=n.parentsUntil(".ewa-lf-search-item").last().find("input");var p=n.parentsUntil(".ewa-lf-search-item").last().find("a");if("date"==k)l=l.split(" ")[0],m=l+" 23:59:59";else if("fix"==k){var t=null;n.find("option").each(function(){this.text==l&&(t=this.value)});l=null===t?"":t}n.val()==l?("text"==k&&d&&0<p.length&&(p.attr("tag",d.Id),p.html("enus"==EWA.LANG?d.TxtEn:d.Txt)),n.val("")):
("text"==k&&c&&0<p.length&&(p.attr("tag",c.Id),p.html("enus"==EWA.LANG?c.TxtEn:c.Txt)),n.val(l),"date"==k&&(n[1].value=m))}),b.each(function(){$(this).text()&&$(this).addClass("ewa-lf-search-text-click").attr("search_tag",h.T)}))}};this.ReShowWithNoButtons=function(){var a=$X("EWA_LF_"+this._Id),b=[],c;for(c in this.ItemList.Items){var d=this.ItemList.Items[c],e=this._GetSubValue("Tag","Tag",d);if(null!=e&&"button"==e.trim().toLowerCase())for(e=0;e<a.rows[0].cells.length;e++)if(a.rows[0].cells[e].childNodes[0].id.toUpperCase()==
...
this.ReShow=function(a){this.IsReShow=!0;a=document.createElement("table");a.id="EWA_RESHOW_"+this._Id;a.cellSpacing="0";a.cellPadding="0";var b=!(0<this.Url.toUpperCase().indexOf("EWA_AJAX=INSTALL")||0<this.Url.toUpperCase().indexOf("EWA_CALL_METHOD=INNER_CALL")||0<this.Url.toUpperCase().indexOf(".JSP"));b?EWA.UI.Utils.SetStyle(a,"width:100%;height:100%;"):EWA.UI.Utils.SetStyle(a,"width:100%");var c=a.insertRow(-1),d=c.insertCell(-1),e=a.insertRow(-1).insertCell(-1);e.className="ewa_lf_func";e.innerHTML=
'<div style="display:none"></div><div></div>';var g=a.insertRow(-1).insertCell(-1);g.vAlign="top";EWA.UI.Utils.SetStyle(g,"width:100%;");css="";g.innerHTML='<div id="_G_'+this._Id+'" style="'+css+'"></div>';var h=$X("EWA_LF_"+this._Id),k=h.parentNode.parentNode.parentNode;g.childNodes[0].appendChild(h.parentNode);var l="_G_"+this._Id;this.NewDivId=l;b&&(window.setTimeout(function(){$X("__EWA_DEBUG")&&g.childNodes[0].appendChild($X("__EWA_DEBUG"));var z=$X(l);z.getElementsByTagName("table");var C=
EWA.UI.Utils.GetDocSize(window),D=z.parentNode.parentNode.previousSibling.offsetHeight;z.style.top=D+"px";z.style.height=C.H-D+"px"},100),addEvent(window,"resize",function(){var z=$X(l),C=EWA.UI.Utils.GetDocSize(window),D=z.parentNode.parentNode.previousSibling.offsetHeight;z.style.top=D+"px";z.style.height=C.H-D+"px"}));for(;0<k.childNodes.length;)e.childNodes[0].appendChild(k.childNodes[0]);var m=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",e.childNodes[1]);m.className="ewa_lf_func_caption";
b=m;var n=!1;h=GetInnerText(e);h=h.trim();this._ReshowButs={};for(var p in this.ItemList.Items){m=this.ItemList.Items[p];var t=this._GetSubValue("Tag","Tag",m);if(null!=t&&("button"==t.trim().toLowerCase()||"butflow"==t.trim().toLowerCase())){t=this._GetSubValue("Name","Name",m);n=!0;var q=this._GetSubValue("DescriptionSet","Info",m),r=this._GetSubValue("DescriptionSet","Memo",m),v=this._GetSubValue("EventSet","EventName",m),u="";null!=v&&"ewa_click"==v.toLowerCase().trim()&&(u=this._GetSubValue("EventSet",
"EventValue",m));h=h.replace(q,"");m=this._ReShowButton(q,r,null);this._ReshowButs[q]=m;m.setAttribute("f_id",this._Id);m.setAttribute("t_id",t);e.childNodes[1].appendChild(m);""==u?m.setAttribute("onclick","EWA.F.FOS['"+this._Id+"'].reShowButtonClick(this)"):m.setAttribute("onclick",u)}}n&&this._ReShowSplit(e.childNodes[1]);q=e.getElementsByTagName("input");n={};for(t=0;t<q.length;t++){var w=q[t];w.style.display="none";if(null==w.id||""==w.id)w.id=("_tmp_"+Math.random()).replace(".","_");if("button"==
w.type){if(m=this._ReShowButton(w.value,w.title,w.id),u=w.nextSibling){var x="";3==u.nodeType&&(x=u.nodeValue.trimEx());"|"==x&&this._ReShowSplit(e.childNodes[1])}}else(u=w.nextSibling)&&(x=3==u.nodeType?u.nodeValue.replace("|",""):u.innerHTML),m=this._ReShowButton(x.trimEx(),w.title,w.id),m.id=("_tmp_"+Math.random()).replace(".","_"),n[w.name]||(n[w.name]=[]),n[w.name].push(m.id);e.childNodes[1].appendChild(m)}h=h.replace(/ /ig,"").replace(/\|/ig,"").trimEx();""!=h?0<=h.indexOf("if")?c.style.display=
"none":d.innerHTML=h.replace(/ /,""):c.style.display="none";k.appendChild(a);for(p in n)for(x=n[p],t=0;t<x.length;t++)w=$X(x[t]),w.setAttribute("_r_ids",x.join(",")),w.onclick=function(){var z=this.getAttribute("_ewa_event_id");$X(z).click();z=this.getAttribute("_r_ids").split(",");for(var C=0;C<z.length;C++)w.id!=z[C]&&($X(z[C]).style.fontWeight="",$X(z[C]).style.color="");this.style.fontWeight="bold";this.style.color="blue"};b.innerHTML='<b><i class="fa fa-star-o">&nbsp;</i>'+this.Description+"</b>";
if(0<this.Url.toUpperCase().indexOf("EWA_BTNS_IN_TITLE"))var y=this,A=0,B=setInterval(function(){A++;1E3<A&&window.clearInterval(B);EWA.OW.Load();EWA.OW.Dia&&(window.clearInterval(B),y.ReShowButtonsInDailogTitle())},10)};this.reShowButtonClick=function(a){a=a.getAttribute("t_id");var b=this.SelectCheckedRows();if(null==b||0==b.length)EWA.UI.Msg.Alert(_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM"],_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM_TITLE"]);else{b=b[0].getElementsByTagName("input");for(var c=0;c<b.length;c++){var d=
...
function(){var a="EWA_SEARCH_ITEM_"+this.Id,b=[],c=[],d=[],e={},g;for(g in this._SearchJson)this._SearchJson[g].ORI_NAME=g,e[g.toUpperCase()]=this._SearchJson[g];this._SearchJson=e;var h="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextType(this)",k="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchDateType(this)",l=$J2MAP(this.RESOURCES.search_text_items,"Id");e=this._GetInitSearchMap();var m=!1,n=!1;for(g in this.ItemList.Items)if(null!=this._SearchJson[g]){var p=[],t=this._SearchJson[g],q=t.T,
r=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[g]);p.push("<table class='ewa-lf-search-item ewa-ref-"+g+" ewa-lf-search-type-"+q+" "+("fix"==q?"ewa-lf-search-fix-m"+(t.M||"0"):"")+"' cellspacing=0 cellpadding=0>");p.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");p.push(r);var v=r="",u="lk";e[g.toUpperCase()]&&(v=e[g.toUpperCase()],u=v.tag,r=v.para1,v=v.para2);var w="";"text"==q?(n=l[u]||l.lk,w="enus"==EWA.LANG?n.TxtEn:n.Txt,p.push("<a class='ewa-lf-search-type' tag='"+
u+"' href='javascript:void(0)' onclick='"+h+"'>"),p.push(w),p.push("</a>"),n=!0):"date"==q&&(p.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+k+"'></a>"),m=!0);p.push("</b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==q?"blk"==u||"nblk"==u?(t=this._SearchSingle(g,w),t=t.replace("<input","<input disabled "),p.push(t)):p.push(this._SearchSingle(g,r)):"date"==q?p.push(this._SearchDate(g,r,v)):"number"==q?p.push(this._SearchNumber(g,r,v)):"fix"==q&&(t="<div >"+
this._SearchFix(g,t,"span",r)+"</div>",p.push(t));p.push("</td></tr></table>");"fix"==q?c.push(p.join("")):d.push(p.join(""))}if(0!=d.length+c.length){b.push('<table class="ewa-lf-search-main" id="'+a+'" cellspacing="0" cellpadding="0" style="width:100%">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");0<d.length&&b.push(" "+d.join("")+" ");if(0<c.length)for(d=0;d<c.length;d++)b.push(" "+c[d]+" ");b.push("</td></tr></table>");var x=document.createElement("div");this._SEARCH_BOX=x;x.className=
"ewa-lf-search";x.innerHTML=b.join("");b=$X("EWA_LF_"+this.Id).parentNode;b.parentNode.insertBefore(x,b);a="EWA_SEARCH_ITEM_"+this.Id;var y=this;m&&this._SearchCreateDateRange();n&&this._SearchCreateTextType();y._SEARCH_ITEM_EXP=this.SearchGetExp(x);"{}"!=JSON.stringify(e)&&(y._SearchExp=y._SEARCH_ITEM_EXP);$(x).find("input[type=text]").on("compositionstart",function(){y._is_search_composition=!0}).on("compositionend",function(){y._is_search_composition=!1});this._TIMER_SEARCH=window.setInterval(function(){if(!y._is_search_composition){try{if(!$X(a)){window.clearInterval(y._TIMER_SEARCH);
return}}catch(B){window.clearInterval(y._TIMER_SEARCH);return}var A=y.SearchGetExp(x);A!=y._SEARCH_ITEM_EXP&&(y._SEARCH_ITEM_EXP=A,y.DoSearch($X(a)))}},700)}};this._SearchSingle=function(a,b){var c=[];c.push('<input t="text" type="text" autocomplete="off" class="EWA_INPUT" maxlength="40" name="');c.push(a.toInputValue());c.push('"');null!=b&&(c.push(' value="'),a=b.toInputValue(),c.push(a),c.push('" '));c.push(" />");return c.join("")};this._SearchDate=function(a,b,c){var d=[];d.push("<table border=0 cellpadding=0 cellspacing=0>");
d.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');d.push(a);d.push('"');b&&(b=b.toInputValue(),d.push(' value="'),d.push(b),d.push('"'));d.push(' /></td><td><span class="ewa-lf-search-split"> - </span></td>');d.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');d.push(a);d.push('1"');c&&(b=c.toInputValue(),d.push(' value="'),
d.push(b),d.push('"'));d.push("/></td></tr></table>");return d.join("")};this._SearchNumber=function(a,b,c){var d=[];d.push('<input type="text" t="number" size="10" name="');d.push(a);d.push('"');b&&(b*=1,d.push(' value="'),d.push(b),d.push('"'));d.push(' /><span class="ewa-lf-search-split"> - </span>');d.push('<input type="text" t="number" size="10" name="');d.push(a);d.push('1"');c&&(b=1*c,d.push(' value="'),d.push(b),d.push('"'));d.push("/>");return d.join("")};this._SearchFix=function(a,b,c,d){var e=
[],g="radio";if("1"==b.M)g="checkbox";else if("2"==b.M)return this._SearchFix1(a,b,c,d);c="<"+c+"><nobr><input t='fix' [@CHK] id='@ID' value=\"@V\" type='"+g+"' name='"+a+"' /><label for='@ID'>@T</label></nobr></"+c+"> ";g={};if(d){d=d.split(";");for(var h in d)g[d[h].trim().toUpperCase()]=1}for(h=0;h<b.D.length;h++){var k=b.D[h];d=k[0];k=k[1];var l=this.Id+"_"+a+"_SearchFix_"+h,m=c.replace("@ID",l);m=m.replace("@ID",l);m=m.replace("@V",d);m=g[d.toUpperCase().trim()]?m.replace("[@CHK]","checked"):
m.replace("[@CHK]","");m=m.replace("@T",k);e.push(m)}return e.join("")};this._SearchFix1=function(a,b,c,d){c=[];c.push("<select t='fix' name='"+a+"'><option></option>");for(var e=0;e<b.D.length;e++){var g=b.D[e],h="<option @CKD t='fix' id='@ID' value=\"@V\">@T</option> ".replace("@ID",this.Id+"_"+a+"_SearchFix_"+e);h=h.replace("@V",g[0]);h=h.replace("@T",g[1]);h=d&&g[0]==d?h.replace("@CKD","selected"):h.replace("@CKD","");c.push(h)}c.push("</select>");return c.join("")};this._SearchCreate=function(){var a=
[];a.push("<div><table border=0 style='margin:0px;' class=EWA_TABLE cellspacing=1>");for(var b in this.ItemList.Items)if(null!=this._SearchJson[b]){var c=this._SearchJson[b],d=c.T,e=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[b]);a.push("<tr><td class=EWA_TD_L width=140><nobr>"+e+"<nobr></td><td width=350 class=EWA_TD_M>");"text"==d?a.push(this._SearchSingle(b)):"date"==d?a.push(this._SearchDate(b)):"number"==d?a.push(this._SearchNumber(b)):"fix"==d&&a.push(this._SearchFix(b,c,"div"));
a.push("</td></tr>")}a.push("<tr><td class=EWA_TD_B colspan=2 align=right><input onclick='EWA.F.FOS[\""+this._Id+"\"].SearchClear(this);' type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLEAR"]+"'> <input type=submit value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.SEARCH"]+"' onclick='EWA.F.FOS[\""+this._Id+"\"].DoSearch(this);'> <input type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLOSE"]+"' onclick='EWA.F.FOS[\""+this.Id+"\"]._SearchDialog.Show(false);'></td></tr>");a.push("</table></div>");
this._SearchHtml=a.join("")};this.SearchMark=function(){for(var a=this._SearchExp.split("@!@"),b=$X("EWA_LF_"+this._Id),c=0;c<a.length;c+=1){var d=a[c].split("~!~");if(!(3>d.length))for(var e=2;e<d.length;e++){var g=d[e];if(""!=g){if("fix"==d[1]){var h=d[2];$("table#EWA_SEARCH_ITEM_"+this.Id+' [name="'+d[0]+'"]').find("option").each(function(){this.value==h&&(g=this.text)})}for(var k=[],l=0;l<g.length;l++){var m=g[l];"a"<=m&&"z">=m||"A"<=m&&"Z">=m||"0"<=m&&"9">=m?k.push(m):k.push("\\"+m)}g=k.join("");
g=eval("/("+g+")/ig");k=d[0].split(",");for(var n in k){l=k[n];this._SearchJson[l]&&(l=this._SearchJson[l].ORI_NAME);try{$(b).find(".ewa-lf-data-row .ewa-col-"+l+">*").each(function(){0==this.children.length&&(this.innerHTML=this.innerHTML.replace(g,"<font color=red><b>$1</b></font>"))})}catch(p){console.log(p)}}}}}};this.DblClick=function(a){this._IsDblClick=a;for(var b=$X("EWA_LF_"+this._Id),c=1;c<b.rows.length;c++)b.rows[c].ondblclick=function(){var d=this.getElementsByTagName("input");d.length>
a&&0==d[a].disabled&&d[a].click()}};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);if((a=$X("EWA_LF_"+this._Id))&&"table"==a.tagName&&!(1>=a.rows.length)){a=a.rows[1].getElementsByTagName("input");for(var b=0;b<a.length;b++)if("RADIO"==a[b].type.toUpperCase()){this._TrSelectMulti=!1;break}}};this.SetPageParameters=function(a,b,c,d,e){this._PageCurrent=a;this._PageSize=c;this._PageCount=
b;this._RecordCount=d;this._Sort=e};this.SetPageParametersName=function(a,b,c,d,e){this._PageCurrentName=a;this._PageSizeName=c;this._PageCountName=b;this._RecordCountName=d;this._SortName=e};this.CheckedAll=function(){var a=document.getElementById("EWA_LF_"+this._Id);if(!(1>=a.rows.length)){for(var b=0;b<a.rows.length;b+=1){var c=a.rows[b].getElementsByTagName("input");0!=c.length&&(c[0].checked=this._IsCheckedAll)}this._IsCheckedAll=this._IsCheckedAll?!1:!0;this.CheckedAllAfter&&this.CheckedAllAfter(a)}};
this.SelectChecked=function(){var a=$X("EWA_LF_"+this._Id);if(!a||1>a.rows.length)return"";var b=[],c=$F(a,"input","type","radio,checkbox");if(0<c.length)for(var d=0;d<c.length;d++)c[d].checked&&b.push(c[d].value);else for(d=0;d<a.rows.length;d++)c=a.rows[d],1==c.getAttribute("__ewa_lf_mdown")&&b.push(c.getAttribute("EWA_KEY"));return b.join(",")};this.SelectCheckedInputs=function(){var a=[],b=$X("EWA_LF_"+this._Id);if(1>b.rows.length)return a;b=b.getElementsByTagName("input");a=[];for(var c=0;c<
b.length;c++)("CHECKBOX"==b[c].type.toUpperCase()||"RADIO"==b[c].type.toUpperCase())&&b[c].checked&&a.push(b[c]);return a};this.SelectCheckedRows=function(){for(var a=[],b=$X("EWA_LF_"+this._Id),c=0;c<b.rows.length;c++){var d=b.rows[c],e=d.getElementsByTagName("input");0!=e.length&&e[0].checked&&-1==e[0].parentNode.className.indexOf("ewa-switch")&&a.push(d)}if(0==a.length)for(c=0;c<b.rows.length;c++)d=b.rows[c],1==d.getAttribute("__ewa_lf_mdown")&&a.push(d);return a};this.Reload=function(a){this.StopAjaxAfterReload?
this.StopAjaxAfterReload=!1:this.Goto(this._PageCurrent,a)};this.DoAction=function(a,b,c,d,e,g){EWA.F.CID=this._Id;if(b){if(a&&$(a).parent().hasClass("scroll-delete")){var h=$(a).attr("do-action-time")||0,k=(new Date).getTime();if(1E3>k-h)return;$(a).attr("do-action-time",k)}this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");
this._Ajax.AddParameter("EWA_ACTION_TIP",d);null!=g&&0<g.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",g),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=!1;if(a&&a.getAttribute&&"yes"==a.getAttribute("box_menu_item")){if(this._Ajax.AddParameter("___CALL__FROM__","box"),a=a.parentNode)a=a.getAttribute("json_ref"),a=JSON.parse(a),a.EWA_KEY&&this._Ajax.AddParameter("EWA_ACTION_KEY",a.EWA_KEY)}else(a=this.GetRowKey(a))&&this._Ajax.AddParameter("EWA_ACTION_KEY",
a);a=this.SelectChecked();this._Ajax.AddParameter("IDS_SPLIT",a);if(null!=e&&0<e.length)for(a=0;a<e.length;a+=1)this._Ajax.AddParameter(e[a].Name,e[a].Value);e=new EWA.C.Url;e.SetUrl(this.Url);var l=e.RemoveParameter("EWA_ACTION"),m=this;c?((e=_EWA_INFO_MSG[c])||(e=c),$Confirm(e,"Confirm",function(){m._Ajax.PostNew(l,function(){m._CallBackJs()})})):this._Ajax.PostNew(l,function(){m._CallBackJs()})}};this.NewPageSize=function(a){this._PageSize!=a&&(this._PageSize=a,this.Goto(1))};this.Goto=function(a,
b){EWA.F.CID=this._Id;this._PageCurrent=a;this._Ajax=this.CreateAjax();a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.RemoveParameter("EWA_AJAX");var c=this;this._Ajax.PostNew(a.GetUrl(),function(){c._CallBack(b)});this.REPLACE_HISTORY_STATE&&this.replaceHistoryState()};this.createReplaceHistoryStateUrl=function(){var a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.AddParameter(this._PageCurrentName,this._PageCurrent);this._PageSize&&a.AddParameter(this._PageSizeName,
this._PageSize);null!=this._Sort&&a.AddParameter(this._SortName,this._Sort);var b=this.SearchGetExpInit();b&&a.AddParameter("EWA_SEARCH",b);if(null!=this.GotoParas&&0<this.GotoParas.length)for(b=0;b<this.GotoParas.length;b+=1)a.AddParameter(this.GotoParas[b].Name,this.GotoParas[b].Value);a.RemoveParameter("EWA_AJAX");return a};this.replaceHistoryState=function(){var a=this.createReplaceHistoryStateUrl();window.history.replaceState("",null,a.GetUrl())};this.CreateAjax=function(){var a=new EWA.C.Ajax;
a.LoadingType="image";a.AddParameter(this._PageCurrentName,this._PageCurrent);this._PageSize&&a.AddParameter(this._PageSizeName,this._PageSize);null!=this._Sort&&a.AddParameter(this._SortName,this._Sort);null!=this._SearchExp&&""!=this._SearchExp&&a.AddParameter("EWA_LF_SEARCH",this._SearchExp);a.AddParameter("EWA_AJAX","LF_RELOAD");if(null!=this.GotoParas&&0<this.GotoParas.length)for(var b=0;b<this.GotoParas.length;b+=1)a.AddParameter(this.GotoParas[b].Name,this.GotoParas[b].Value);return a};this.DownlodData=
function(a,b){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";null!=this._Sort&&this._Ajax.AddParameter(this._SortName,this._Sort);null!=this._SearchExp&&""!=this._SearchExp&&this._Ajax.AddParameter("EWA_LF_SEARCH",this._SearchExp);this._Ajax.AddParameter("EWA_AJAX","DOWN_DATA");this._Ajax.AddParameter("EWA_AJAX_DOWN_TYPE",a);b&&this._Ajax.AddParameter("EWA_ACTION",b);if(null!=this.GotoParas&&0<this.GotoParas.length)for(a=0;a<this.GotoParas.length;a+=1)this._Ajax.AddParameter(this.GotoParas[a].Name,
this.GotoParas[a].Value);this._AjaxType="DOWN_DATA";a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);var c=this;this._Ajax.PostNew(a.GetUrl(),function(){c._CallBack()})};this.Get=function(a){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";var b=this;this._Ajax.Get(a,function(){b._CallBack()})};this.Post=function(a,b){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";var c=this;this._Ajax.Post(a,b,function(){c._CallBackJs()})};
this._CallBack=function(a){var b=this._Ajax;if(4==b._Http.readyState){b.HiddenWaitting();if(top.EWA&&top.EWA.MQE){var c=new EWA_MqeClass;c.Data=b.GetRst();c.FromId=EWA.F.CID;c.Type="POST";top.EWA.MQE.AddMqe(c)}200==b._Http.status?(b=b._Http.responseText,EWA.F.CheckCallBack(b)&&("DOWN_DATA"==this._AjaxType?(this._AjaxType=null,"DENY"==b.trim()?alert(_EWA_INFO_MSG["EWA.LF.DOWN_DATA.DENY"]):window.location.href=b.trim()):(c=$X("EWA_LF_"+this._Id).parentNode,$(c).replaceWith(b),this.SearchMark(),this.IsReShow&&
this.ReShowWithNoButtons(),this._ReShowSearchQuick(),null!=this._IsDblClick&&this.DblClick(this._IsDblClick),this._IsAddPreRow&&this.AddPreRow(),this.SubBottomsArray&&this._SubBottoms(),this.ReloadAfter&&this.ReloadAfter(a),this.ReloadAfterApp&&this.ReloadAfterApp(a)))):alert("ERROR:\r\n"+b._Http.statusText);this.RewriteInfo()}};this._CallBackJs=function(){var a=this._Ajax;if(4==a._Http.readyState){if(top.EWA&&top.EWA.MQE){var b=new EWA_MqeClass;b.Data=a.GetRst();b.FromId=EWA.F.CID;b.Type="POST";
top.EWA.MQE.AddMqe(b)}a.HiddenWaitting();200==a._Http.status?(a=a._Http.responseText,EWA.F.CheckCallBack(a)&&eval(a)):alert("ERROR:\r\n"+a._Http.statusText);this.EditAfterEvent&&this.EditAfterEvent()}};this.EditAfterEvent=function(){};this._GetItem=function(a){for(var b=this.ItemList,c=0;c<b.length;c+=1){var d=b[c],e=this._GetSubItem("Name",d);if(this.Xml.GetElementAttribute(e,"Name")==a)return d}};this._GetSubItem=function(a,b){b=this.Xml.GetElements(a+"/Set",b);if(null==b||0==b.length)return null;
if("DescriptionSet"==a)for(a=0;a<b.length;a+=1){var c=b[a].getAttribute("Lang");if(null!=c&&c.trim().toUpperCase()==EWA.LANG.trim().toUpperCase())return b[a]}return b[0]};this._GetSubValue=function(a,b,c){a=this._GetSubItem(a,c);return null==a?null:this.Xml.GetElementAttribute(a,b)};this.AddColumns=function(a,b,c,d,e,g,h,k){var l=$X("EWA_LF_"+this._Id);null==k&&(k=l.rows[0].cells.length);for(var m=0;m<a.length;m++)for(var n=a[m],p=k+m,t=0;t<l.rows.length;t++){var q=l.rows[t].insertCell(p);if(0==t)q.className=
"EWA_TD_H",q.innerHTML='<nobr cellIdx="'+p+'" id="'+n[b]+'">'+n[c]+"</nobr>",q.title=n[d],q.width=100;else{var r=l.rows[t].getAttribute("EWA_KEY");q.className="EWA_TD_M";r=r+"_"+n[b];var v=this._GetAddControl(n[g]);null==v&&(v=e);var u=h.replace("[ID]",n[b]);v=0<=v.indexOf("<select")?v.replace("!!",u.replace("onblur=","onchange=")):v.replace("!!",u);q.innerHTML=v;q.childNodes[0].id=r}}};this._GetAddControl=function(a){if(null==a)return null;a=a.toUpperCase().trim();return"SELECT"==a?"<select !!></select>":
"DATE"==a?'<input type=text class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,false);" readonly !!>':"TIME"==a?'<input type=text class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,true);" readonly !!>':"STRING"==a||"NUMBER"==a?"<input type=text class=EWA_INPUT !!>":null};this.AddedValues=function(a,b,c,d,e){for(var g=0;g<a.length;g++){var h=a[g],k=$X(h[b]+"_"+h[c]);if(!k)break;var l=k.tagName.toUpperCase();"INPUT"==l||"SELECT"==l||"TEXTAREA"==l?k.value=h[d]:k.innerHTML=h[d];e&&(this.GetRow(k).getElementsByTagName("input")[0].checked=
!0)}};this.AddRow=function(a){for(var b=$X("EWA_LF_"+this._Id),c=b.insertRow(-1),d=0;d<b.rows[0].cells.length;d++){var e=c.insertCell(-1),g=b.rows[0].cells[d];e.className="EWA_TD_M";null!=a[d]&&(e.innerHTML=a[d]);e.style.display=g.style.display;e.id="ADD_ROW_"+g.childNodes[0].id}return c};this.Calc=function(a,b,c,d){for(var e=$X("EWA_LF_"+this._Id),g={},h=0;h<a.length;h++)g[a[h]]=0;for(h=b;h<c;h++)for(a=e.rows[h],b=0;b<a.cells.length;b++)if(null!=g[b]){var k=a.cells[b],l=k.getElementsByTagName("input");
0<l.length?g[b]+=1*l[0].value:(k=GetInnerText(k),""==k&&(k=0),g[b]+=1*k)}c=e.rows[d];for(h=0;h<c.cells.length;h++)null!=g[h]&&(k=Math.round(100*g[h])/100,d=GetInnerText(c.cells[h]),k!=1*d&&(this.IsCalcChanged=!0),c.cells[h].innerHTML=k.fm())};this.mergeHeaders=function(a,b,c){var d=$($X("EWA_LF_"+this._Id)),e=d.find('tr[ewa_tag="HEADER"]');if(0!=e.length&&(a=e.find('nobr[id="'+a+'"]').parent(),0!=a.length)){var g=d.find("tr[ewa_mearge]");0==g.length&&(g=$(d[0].insertRow(1)),g.attr("ewa_mearge","gdx"));
d=-1;for(var h=0;h<e[0].cells.length;h++){var k=e[0].cells[h];k==a[0]&&(d=h,k.colSpan=c);if(-1==d)"1"!=$(k).attr("ewa_tdmearged")&&(k.rowSpan=2);else if(d+c==h)d=-1,k.rowSpan=2;else{k.rowSpan=1;var l=g[0].insertCell(-1);l.innerHTML=k.innerHTML;l.className=k.className;l.style.cssText=k.style.cssText;k.style.display="none";$(k).attr("ewa_tdmearged",1)}k==a[0]&&(k.innerHTML=b,k.style.display="",k.style.width="")}}};this.MeargeHeader=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 mergeHeaders");
...
g.focus()))};this._GetInput=function(){for(var d=this.ParentObject.getElementsByTagName("INPUT"),e=d.length-1;0<=e;e--){var g=d[e];if(g.getAttribute("onblur")&&0<g.getAttribute("onblur").indexOf("RenameBlur("))return this._InputDiv=g.parentNode,g}};this.RenameBlur=function(d){for(var e=d.getAttribute("EWA_OLD_VAL"),g=this._RenameNode,h=this.GetNode(g.GetObject().parentNode),k=0;k<h.Children.length;k+=1){var l=h.Children[k];if(l.Key!=g.Key&&l.Text.trim()==d.value.trim()){alert(_EWA_EVENT_MSG.OnTreeNodeNameRepeat);
d.focus();return}}h=d.parentNode.childNodes[0];this._InputDiv.appendChild(d);h.style.display="";if("NEW"==g.RenameType||e!=d.value){h.innerHTML=d.value;e=this._RenameActionCmd;null==e&&(e=new EWA.F.Cmd);if(null==e.EWA_ACTION||""==e.EWA_ACTION.trim())e.EWA_ACTION="NEW"==g.RenameType?"OnTreeNodeNew":"OnTreeNodeRename";"NEW"==g.RenameType&&(""==e.EWA_AFTER_EVENT&&(e.EWA_AFTER_EVENT='EWA.F.FOS["'+this._Id+'"].NewNodeAfter;'),h=this.GetNode(g.GetObject().parentNode),e.EWA_TREE_PARENT_KEY=h.Key);e.EWA_TREE_TEXT=
d.value;e.EWA_TREE_KEY=g.Key;this._PostChange(e);this._RenameActionCmd=null}};this.RenameKeyDown=function(d,e){d=d.keyCode?d.keyCode:d.which;13==d&&this.RenameBlur(e);27==d&&(d=e.getAttribute("EWA_OLD_VAL"),e.value=d,this.RenameBlur(e))};this.Delete=function(d,e){var g=this.GetNode(this._LastFocus);null!=g&&"EWA_TREE_ROOT"!=g.Key&&window.confirm(_EWA_EVENT_MSG.OnTreeNodeDelete)&&(!d&&(0<g.Children.length||g.IsMoreChildren)?(g.NodeShow(!0),alert(_EWA_EVENT_MSG.OnTreeNodeDeleteHaveChildren)):(d=e,null==
d&&(d=new EWA.F.Cmd,d.EWA_ACTION="OnTreeNodeDelete"),""==d.EWA_AFTER_EVENT&&(d.EWA_AFTER_EVENT='EWA.F.FOS["'+this._Id+'"].DeleteAfter();'),d.EWA_TREE_KEY=g.Key,this._PostChange(d)))};this.DeleteAfter=function(){var d=this.GetNode(this._LastFocus).GetObject(),e=d.parentNode;e.removeChild(d);d=this.GetNode(e);0==d.Children.length?this.GetNode(d.GetObject().parentNode).ChildLast.Key==d.Key?d.NodeCrossEnd(!0):d.NodeCross(!0):d.ChildLast.NodeCrossEnd();this._LastFocus=null};this.NewNode=function(d,e,g,
h){null!=this._LastFocus&&(this._NewNodeTemp={TEXT:d,CMD:e,REGEX:g,INFO:h},this.GetNode(this._LastFocus).NodeShow(!0),this.IsPostChange?this._NewNodeTimer=window.setInterval(function(){EWA.CurUI.IsPostChange||(window.clearInterval(EWA.CurUI._NewNodeTimer),EWA.CurUI._NewNode())},100):this._NewNode())};this._NewNode=function(){var d=this._NewNodeTemp.TEXT,e=this._NewNodeTemp.CMD,g=this._NewNodeTemp.REGEX,h=this._NewNodeTemp.INFO;this._NewNodeTemp=null;var k=new EWA_TreeNodeClass;k.ewa=this;this._CurNewNode+=
1;k.Key="NEW_NODE_"+this._Id+"__"+this._CurNewNode;k.RenameType="NEW";var l=_EWA_EVENT_MSG.OnTreeNodeNew+this._CurNewNode;null!=d&&0<d.trim().length&&(l=d.trim());k.Text=l;d=this.GetNode(this._LastFocus);0<d.Children.length&&d.Children[d.Children.length-1].NodeCross();d.AddChild(k);this.Create(k);d.NodeShow(!0);this.Rename(k,e,g,h)};this.NewNodeAfter=function(d,e,g){var h=this.GetNodeById("NEW_NODE_"+this._Id+"__"+this._CurNewNode);h.SetKey(d);h.SetAddParameters(null==e?"":e);h.SetMenuGroup(null==
g?"":g);d=this.TestIcon(h);h.SetBookIcon(d)};this.GetNodeById=function(d){d=$("#EWA_TREE_"+this._Id+' .ewa-tree-node[id="'+d+'"]');return 0==d.length?null:this.GetNode(d[0])};this.GetFocusNode=function(){return this.GetNode(this._LastFocus)};this.GetNode=function(d){if(null==d||null==d.tagName)return null;var e=d;for(d=0;("TABLE"!=e.tagName||"1"!=e.getAttribute("EWA_T"))&&"EWA_TREE_ROOT"!=e.id;)if(e=e.parentNode,d++,33<d||"BODY"==e.tagName)return null;d=new EWA_TreeNodeClass;d.ewa=this;d.Key=e.id;
d.MenuGroup=e.getAttribute("EWA_MG");d.Object=e;var g=e.rows[0].cells[2];d.Text=GetInnerText(g);for(var h=0;3>h;h+=1)d.AddParas[h]=g.childNodes[0].getAttribute("EWA_P"+h);h=e.getAttribute("EWA_TREE_MORE");d.IsMoreChildren="1"==h?!0:!1;if(1<e.rows.length){e=e.rows[1].cells[e.rows[1].cells.length-1];for(h=0;h<e.childNodes.length;h=1+h)g=e.childNodes[h],3!=g.nodeType&&"TABLE"==g.tagName&&"1"==g.getAttribute("EWA_T")&&d.Children.push(this.GetNode(g));0<d.Children.length&&(d.ChildLast=d.Children[d.Children.length-
1])}return d};this.Click=function(d,e){if(!this.IsPostChange&&(EWA.CurUI=this,d=d.srcElement?d.srcElement:d.target,"INPUT"!=d.tagName))if("DIV"==d.tagName&&(d=d.parentNode),"TD"==d.tagName&&0==d.className.indexOf("TD00")){var g=this.GetNode(d);g.NodeShow()}else{for(;("SPAN"!=d.tagName||null==d.getAttribute("EWA_CMD"))&&"1"!=d.getAttribute("EWA_TREE_TOP");)if(d=d.parentNode,"BODY"==d.tagName)return;g=this.GetNode(d);if("SPAN"==d.tagName&&(null!=d.getAttribute("EWA_CMD")||"1"==d.getAttribute("EWA_TREE_TOP"))){null!=
this._LastFocus&&(this.GetNode(this._LastFocus).Mark(!1),this._LastFocus=null);"1"!=d.getAttribute("EWA_TREE_TOP")&&g.Mark(!0);this._LastFocus=d;if(e)return d;0>this.Url.toUpperCase().indexOf("EWA_TREE_SKIP_GET_STATUS")&&EWA.F.ST.SaveStatus(g.Key,"TREE");this._RunCmd(g);this.MoveNode(g.GetObject())}}};this._RunCmd=function(d){var e=this.GetNode(d.GetObject().parentNode);if(this.link)this.link(d.Key,d);else{console.warn('\u5efa\u8bae\u91c7\u7528\u5b9a\u4e49 EWA.F.FOS["xx"].link = function(nodeKey, node){}');
...
function EWA_Html5UploadClass(){this.uploadIframes=[];this.files=[];this.UPLOAD_STATUS=this.POST_REF=this.POST_NAME=this.POST_ITEMNAME=this.POST_XMLNAME="";this.WAIT_ID=EWA_Utils.tempId("ht5upload_wait_");this.changeUpExts=function(a){$("#"+this.INPUT_FILE_ID).attr("accept",a)};this.changeUpSizeLimit=function(a){this.UpLimit=a};this.haveFile=function(){for(var a=0;a<this.files.length;a++)if(""!=this.files[a].value)return!0;return!1};this.getValue=function(){if(0==this.uploadIframes.length&&0==this.files.length)return"";
for(var a=[],b=0;b<this.uploadIframes.length;b++){var c=this.uploadIframes[b];if("string"==typeof c){c=JSON.parse(c);for(var d in c)a.push(c[d])}}return JSON.stringify(a)};this.fileIco=function(a,b){a=EWA.UI.Ext.FileExt(a.name);$X(b).onerror=function(){};$X(b).src=EWA.UI.Ext.FileIco(a)};this.showPreview=function(a,b){if(10<a.files.length)"enus"==EWA.LANG?EWA.UI.Msg.ShowError("Upload up to 10 files at a time","limts"):EWA.UI.Msg.ShowError("\u4e00\u6b21\u6700\u591a\u4e0a\u4f2010\u4e2a\u6587\u4ef6",
"\u6587\u4ef6\u6570\u91cf\u9650\u5236"),a.value="";else{this.UpLimit||(this.UpLimit="10M");b=(this.UpLimit+"").toLocaleLowerCase().replace(/,/ig,"").replace(/ /ig,"");if(b.endsWith("m")){b=b.substring(0,b.length-1);if(isNaN(b)){alert("Invalid sizeLimit parameter:"+this.sizeLimit);return}var c=1048576*b}else if(b.endsWith("k")){b=b.substring(0,b.length-1);if(isNaN(b)){alert("Invalid sizeLimit parameter:"+this.sizeLimit);return}c=1024*b}else{if(isNaN(b)){alert("Invalid sizeLimit parameter:"+this.sizeLimit);
return}c=1*b}var d=[];if(0<c)for(b=0;b<a.files.length;b++){var e=a.files[b];if(e.size>c){var g=EWA.UI.Ext.getFileLen(e.size,2);d.push(e.name.replace(/</ig,"%lt;").replace(/>/ig,"%gt;")+" ["+g+"]")}}if(0<d.length)a.value="","enus"==EWA.LANG?(d.push("Exceed "+this.UpLimit+" limit"),EWA.UI.Msg.ShowError(d.join("<br>"),"Exceed "+this.UpLimit+" limit")):(d.push("\u8d85\u8fc7"+this.UpLimit+"\u5927\u5c0f\u9650\u5236"),EWA.UI.Msg.ShowError(d.join("<br>"),"\u8d85\u8fc7"+this.UpLimit+"\u5927\u5c0f\u9650\u5236"));
else{c=a.parentNode;d=c.outerHTML;c.style.display="none";a.setAttribute("ok",1);gFileReaders={};for(b=0;b<a.files.length;b++)e=a.files[b],this.showPreview1(c,e),this.files.push(e);"yes"==this.UpMulti&&$(c).before(d)}}};this.addOther=function(a){for(var b=$X(this.POST_NAME).parentNode.getElementsByTagName("input")[1].parentNode,c=0;c<a.length;c++)this.showPreview1(b,a[c]);this.uploadIframes.push(JSON.stringify(a))};this.createPreviewBox=function(a){var b=a||$("#EWA_FRAME_"+this.SYS_FRAME_UNID+" input#"+
this.POST_NAME).parent().find(".ewa_app_upload_form")[0],c="_upload_"+Math.random();c=c.replace(".","G");a=document.createElement("img");a.id=c;c=document.createElement("table");c.cellPadding=0;c.cellSpacing=0;c.className="ewa_app_upload_form1";b.parentNode.appendChild(c);b=c.insertRow(-1).insertCell(-1);b.align="center";b.appendChild(a);b.className="img";b.vAlign="middle";c.insertRow(-1).insertCell(-1).className="name";var d=this;a.onerror=function(e){console.log(e);d.fileIco({name:this.src},this.id)};
return c};this.showPreviewExists=function(){var a=$("#EWA_FRAME_"+this.SYS_FRAME_UNID+" input#"+this.POST_NAME).val();if(""!=a){try{EWA.F.FOS[this.SYS_FRAME_UNID].setUnMust(this.POST_NAME)}catch(b){}this.showPreviewUrl(a)}};this.showPreviewUrl=function(a){var b=this.createPreviewBox(),c=$(b).find("td")[1],d=a.split("/");d=d[d.length-1];c.innerHTML="<div title='"+d+"'>"+d+"</div>";$(b).find("img")[0].src=a;return b};this.showPreview1=function(a,b){var c=this.createPreviewBox(a),d=$(c).find("td")[1],
e=$(c).find("img")[0];a=e.id;b.ref=a;d.innerHTML="<div>"+b.name+"</div><div id='"+a+"_process1' class='ewa-app-upload-process1'></div><div id='"+a+"_process' class='ewa-app-upload-process'>0%</div>";d.className="name";$(c).attr("file_name",b.name);$(c).attr("file_type",b.type);$(c).attr("file_size",b.size);if(b.type&&0==b.type.indexOf("image/")){e.src=(EWA.RV_STATIC_PATH||"/EmpScriptV2")+"/EWA_STYLE/images/loading2.gif";c=new FileReader;gFileReaders[a]=c;var g=this;c.onloadend=function(h){for(var k in gFileReaders)gFileReaders[k]==
h.target&&($X(k).src=h.target.result,g.showPreviewAfter&&g.showPreviewAfter($X(k),b))};c.readAsDataURL(b)}else this.fileIco(b,a),this.showPreviewAfter&&this.showPreviewAfter($X(a),b)};this.submitUploads=function(a){if(window.FormData){this.uploadIframes=[];var b=this;this.UPLOAD_STATUS="start";this.action=EWA.CP+"/EWA_STYLE/cgi-bin/_up_/?xmlname="+this.POST_XMLNAME+"&ITEMNAME="+this.POST_ITEMNAME+"&NAME="+this.POST_NAME+"&EWA_UP_TYPE=SWFUPLOAD&EWA_UP_REF="+this.POST_REF;try{$("input[type=file][ok=1]").each(function(){var c=
this.id.split("_1_2_3_4_5_")[1];if(b.POST_NAME==c)for(c=0;c<this.files.length;c++){var d=this.files[c];d.isDeleted?console.log(d):b.uploadIframes.push({file:d})}})}catch(c){alert(c)}0<this.uploadIframes.length?($("#f_"+this.SYS_FRAME_UNID).find(".ewa-app-upload-process,.ewa-app-upload-process1").show(),b.UPLOAD_STATUS="checking",this.asyncUpload()):this.UPLOAD_STATUS="nofile"}else this.submitUploads_old(a)};this.asyncUpload=function(){var a=this,b=null,c;for(c in this.uploadIframes){var d=this.uploadIframes[c];
if("string"!=typeof d){b=d;break}}null!=b?(b.submitting||(b.submitting=!0,this.submitUpload(b)),setTimeout(function(){a.asyncUpload()},111)):this.uploadsCompleted&&this.uploadsCompleted(this.uploadIframes)};this.createFormData=function(){var a=new FormData,b=new EWA_UrlClass;b.SetUrl(EWA.F.FOS[this.SYS_FRAME_UNID].Url);for(var c in b._Paras)0!=c.toUpperCase().indexOf("EWA")&&a.append(c,b._Paras[c]);if(b=$X("f_"+this.SYS_FRAME_UNID))for(c=0;c<b.length;c++){var d=b[c],e=d.name||d.id;"file"!=d.type&&
"button"!=d.type&&"submit"!=d.type&&("radio"!=d.type&&"checkbox"!=d.type||d.checked)&&"ht5upload"!=$(d).attr("ewa_tag")&&a.append(e,d.value)}return a};this.submitUpload=function(a){var b=a.file,c=this.createFormData();c.append(this.POST_NAME,b,b.name);var d=$('img[id="'+b.ref+'"]');this.createNewSizes(d[0],c);var e=this,g=$('div[id="'+b.ref+'_process"]');g.show().html("0%");var h=$('div[id="'+b.ref+'_process1"]');h.css("width",0).show();b=new XMLHttpRequest;b.upload.addEventListener("progress",function(k){k.lengthComputable?
...
b.animate(q,"fast","swing",function(){b[0].style.cssText="";var r=1*b.attr("st");document.body.scrollTop=r;1==$("#crm_left_box").attr("show")&&$("#crm_left_box").show();b.css("display",b.attr("dsp"));0<d.length&&"DES_plugin"!=a?d[0].click():(r=$X(a.replace("DES_","")),r.style.width=r.parentNode.clientWidth-10+"px",r.style.height=q.height-30+"px",c.find('div[id="EWA_FRAME_MAIN"]').css("height",q.height-150))});else{b.attr("full","1");b.attr("st",document.body.scrollTop);b.attr("dsp",b.css("display"));
var g=document.documentElement.clientHeight;e=document.documentElement.clientWidth-10;var h=g-20,k=document.documentElement.clientWidth-30,l=g-20-20-15;g=b.offset();var m=b.position(),n=g.left-m.left,p=b.width(),t=b.height();var q={width:p,height:t,"margin-left":n,left:m.left,top:m.top};b.attr("ori",JSON.stringify(q));b.css({"margin-left":"0px",top:g.top,left:g.left,position:"absolute",display:"",overflow:"auto"});b.animate({width:e,height:h,left:10,top:0},"fast","swing",function(){c.css("width",
...
var EWAC_WfOrg=function(){this.Depts={};this.Posts={};this.Users={};this.GetMaster=function(a){var b=this.Users[a];if(null==b)alert(("enus"==EWA.LANG?"NONE of ":"\u6ca1\u6709\u554a")+a);else{a=b.Dept;for(var c in a.Users){b=a.Users[c];for(var d in b.Posts)if(b.Posts[d].IsMaster)return b}alert("enus"==EWA.LANG?"\tNo manager":"\u6ca1\u6709\u7ba1\u7406\u8005")}};this.IsMaster=function(a){var b=this.GetMaster(a);return null==b?!1:b.Id==a};this.InitDepts=function(a,b,c,d,e,g){for(var h=0;h<a.length;h++){var k=
a[h];if(null==this.Depts[k[b]]){var l={};l.Id=k[b];l.Name=k[c];l.Lvl=k[d];l.Ord=k[e];l.Pid=k[g];l.Posts={};l.Users={};l.Children={};this.Depts[l.Id]=l}}for(var m in this.Depts)k=this.Depts[m],this.Depts[k.Pid]?(a=this.Depts[k.Pid],k.Parent=a,a.Children[k.Id]=k):null==this.DeptRoot&&(this.DeptRoot=k)};this.InitPosts=function(a,b,c,d,e){for(var g=0;g<a.length;g++){var h=a[g],k=h[b];if(null==this.Posts[k]){var l={};l.Id=k;l.Name=h[c];l.DeptId=h[e];h=h[d];h=null==h?"":h.trim().toLowerCase();l.IsMaster=
...
function loadWfShow(a,b,c,d,e,g,h,k,l,m){_EWA_WF&&_EWA_WF.EN&&(_EWA_WF.EN1=$J2MAP(_EWA_WF.EN,"WF_UNIT_ID"));d=document.createElement("div");d.style.position="absolute";d.style.zIndex=123;d.innerHTML="ver: "+_EWA_WF.WF_DLV_VER;document.body.appendChild(d);var n=EWAC_WfUtil.WF,p=1000012,t=1000011;for(d=0;d<a.length;d++){var q=a[d],r=q.WF_UNIT_X,v=q.WF_UNIT_Y;null!=r&&1*r<p&&(p=1*r);null!=v&&1*v<t&&(t=1*v)}1000012==p&&(p=0);1000011==t&&(t=0);p-=10;t-=10;m={};var u;for(d=0;d<a.length;d++)q=a[d],n.Ids[d]=
q.WF_UNIT_ID,r=n.CreateUnit(),m[q.WF_UNIT_ID]=r,v=q.WF_UNIT_NAME,"enus"==EWA.LANG&&_EWA_WF.EN1&&_EWA_WF.EN1[q.WF_UNIT_ID]&&_EWA_WF.EN1[q.WF_UNIT_ID].WF_UNIT_NAME_EN&&(v=_EWA_WF.EN1[q.WF_UNIT_ID].WF_UNIT_NAME_EN),r.ChangeDes(v),r.ChangeType(q.WF_UNIT_TYPE),r.WF_UNIT_ADM=q.WF_UNIT_ADM,r.WF_UNIT_ADM_LST=q.WF_UNIT_ADM_LST,r=q.WF_UNIT_X,v=q.WF_UNIT_Y,q=$X(q.WF_UNIT_ID),null!=r&&(q.style.left=r-p+"px"),null!=v&&(q.style.top=v-t+"px");a={};for(d=0;d<b.length;d++)q=b[d],r=q.WF_UNIT_FROM,a[r]||(a[r]=[]),a[r].push(q);
for(d=0;d<b.length;d++)q=b[d],a=q.WF_UNIT_TO,r=q.WF_UNIT_FROM,r=n.Units[r],a=n.Units[a],p=new EWAC_WfCnn,p.Create(r,a),n.Cnns[p.Id]=p,q.IsHaveLogic&&!q.IsLogicOk&&(p.IsStop=!0);for(var w in n.Units)d=n.Units[w],null==u&&0==d.CnnsToLength&&(u=d);if(null==u)h="enus"==EWA.LANG?"No startup node was found, process definition error":"\u672a\u53d1\u73b0\u542f\u52a8\u8282\u70b9,\u6d41\u7a0b\u5b9a\u4e49\u9519\u8bef",alert(h);else{0==c.length&&(n.CurUnit=u);var x=[];w={};for(d=0;d<c.length;d++)b=c[d],n=b.SYS_STA_TAG,
r=m[n],null!=r&&(q=b.ADM_NAME,"enus"==EWA.LANG&&b.ADM_NAME_EN&&(q=b.ADM_NAME_EN),r.Log(q,b.SYS_STA_CDATE,b.SYS_STA_MEMO),w[n]||(w[n]=1,x.push({ID:n,DES:r.GetDes()})),n=b.SYS_STA_TAG+"G"+b.SYS_STA_VAL,EWAC_WfUtil.WF.Cnns[n]&&(EWAC_WfUtil.WF.Cnns[n].Disp(3,"blue"),r==u&&(r.ADM_ID=b.ADM_ID),d==c.length-1&&(n=m[b.SYS_STA_VAL],n.WF_UNIT_ADM_LST=b.ROLE_IDS,n.WF_UNIT_ADM=b.ROLE_TYPE,EWAC_WfUtil.WF.CurUnit=n)));null!=l&&0<l.length&&m[l]&&(EWAC_WfUtil.WF.CurUnit=m[l]);EWAC_WfUtil.WF.CurUnit.LogCur(e);l=!1;
r=EWAC_WfUtil.WF.CurUnit;c=[];if(u==r)l=!0;else if("WF_ADM_ADM"==r.WF_UNIT_ADM)if(u=","+r.WF_UNIT_ADM_LST+",",0<=u.indexOf(","+g+","))l=!0;else for(d in g=$J2MAP1(top.org,"ADM_ID"),h=r.WF_UNIT_ADM_LST.split(","),h){k=g[h[d]];for(var y in k)c.push(k[y].ADM_NAME)}else if("WF_ADM_DEPT"==r.WF_UNIT_ADM)if(u=","+r.WF_UNIT_ADM_LST+",",0<=u.indexOf(","+h+","))l=!0;else for(d in g=$J2MAP1(top.org,"DEP_ID"),h=r.WF_UNIT_ADM_LST.split(","),h)for(y in k=g[h[d]],k)c.push(k[y].ADM_NAME);else if("WF_ADM_POST"==r.WF_UNIT_ADM)if(u=
","+r.WF_UNIT_ADM_LST+",",0<=u.indexOf(","+k+","))l=!0;else for(d in g=$J2MAP1(top.org,"POS_ID"),h=r.WF_UNIT_ADM_LST.split(","),h)for(y in k=g[h[d]],k)c.push(k[y].ADM_NAME);else if("WF_ADM_START"==r.WF_UNIT_ADM){if(u==r||g==u.ADM_ID)l=!0}else"WF_ADM_MANAGER"==r.WF_UNIT_ADM&&(y=u.ADM_ID,top||top.ORG||(h="enus"==EWA.LANG?"No organization":"\u6ca1\u6709\u7ec4\u7ec7\u673a\u6784",alert(h),l=!1),l=top.ORG.GetMaster(y).Id==g?!0:!1);e&&window.parent&&window.parent.$X(e)&&(y=window.parent.$X(e).parentNode.parentNode.parentNode,
l?0<x.length&&(g=y.rows[y.rows.length-1].cells[0],h=window.parent.document.createElement("input"),h.type="button",h.value="enus"==EWA.LANG?"Back":"\u6253\u56de",h.onclick=function(){var A=window.parent.$X(e);A.options.length=1;for(var B=0;B<x.length;B++){var z=x[B];A.options[A.length]=new Option(z.DES,z.ID);this.style.display="none"}A.parentNode.parentNode.cells[0].innerHTML="enus"==EWA.LANG?'<div style="color:red">Back steps</div>':'<div style="color:red">\u8fd4\u56de\u6b65\u9aa4</div>'},g.insertBefore(h,
g.getElementsByTagName("input")[1])):(0==c.length?(h="enus"==EWA.LANG?"Only view":"\u60a8\u53ea\u80fd\u67e5\u770b",window.parent.$X(e).parentNode.innerHTML="<b>"+h+"</b>"):(h="enus"==EWA.LANG?"Waitting":"\u7b49\u5f85",g="enus"==EWA.LANG?"or":"\u6216",window.parent.$X(e).parentNode.innerHTML="<b>"+h+':<span style="color:blue">'+c.join("</span> "+g+' <span style="color:blue">')+"</span></b>"),window.parent.$X("butOk").style.display="none"),showControls(y,_EWA_WF.WF_SHOW))}}
...
e[0];var g=e.parentNode.rows[0];for(c=e.cells.length-1;1<=c;c--)if(!(0<e.cells[c].getElementsByTagName("input")||0<e.cells[c].getElementsByTagName("img")||0<e.cells[c].getElementsByTagName("a"))&&(b=GetInnerText(g.cells[c]),d=GetInnerText(e.cells[c]),null!=b&&""!=b.trim()&&null!=d&&""!=d.trim()&&(b=b.replace("?","").trim(),b.trim()!=d.trim()))){var h=a.insertRow(0),k=h.insertCell(-1);k.className="EWA_TD_L";var l=h.insertCell(-1);l.className="EWA_TD_M";k.innerHTML='<span style="color:111"><i>'+b+"</i></span>";
l.innerHTML=d}}}}else window.setTimeout(loadParentInfo,300)}
...
this.lastWR=null);"TD"==b&&1==d.childNodes.length?(g=this.createEle("w:p"),d.appendChild(g)):"TABLE"==b&&null==d.nextSibling&&"w:tc"==d.parentNode.tagName&&(g=this.createEle("w:p"),d.parentNode.appendChild(g))}};this.walkerTxt=function(a){if(""!=a.nodeValue.trimEx()){var b=this.createText(a),c=this.getDock();if("w:p"!=c.tagName){var d=this.createP(a.parentNode);a=this.createSpan(a.parentNode);d.appendChild(a);a.appendChild(b);c.appendChild(d);this.docks.push(d)}else this.lastWR||(a=this.createSpan(a.parentNode),
...
for(var c=[],d=0;d<a.length;d++){var e=this.createEle(a[d].trim());c.push(e);b.appendChild(e)}return c};this.createText=function(a){if(""!=a.nodeValue.trim()){var b=this.createEle("w:t");EWA.B.IE?b.text=a.nodeValue:b.textContent=a.nodeValue;return b}};this.createHr=function(){var a=this.createElesLvl("w:pict,v:rect");a[0].setAttribute("w14:anchorId",this.getParaId());this.setAtts(a[1],{style:"width:.05pt;height:1pt","o:hralign":"center","o:hrstd":"t","o:hrnoshade":"t","o:hr":"t",fillcolor:"black [3213]",
stroked:"f"});return a[0]};this.createLi=function(a){var b=this.createEles("w:numPr,w:ilvl,w:numId");"OL"==a.parentNode.tagName?(a==a.parentNode.getElementsByTagName("li")[0]&&this.liNum++,b[1].setAttribute("w:val",0),b[2].setAttribute("w:val",this.liNum)):(b[1].setAttribute("w:val",0),b[2].setAttribute("w:val",22));a=this.createEle("w:spacing");a.setAttribute("w:line",270);a.setAttribute("w:lineRule","atLeast");var c=this.getDock();c.getElementsByTagName("w:pPr")[0].appendChild(b[0]);c.getElementsByTagName("w:pPr")[0].appendChild(a)};
this.createSpan=function(a){var b=this.createEle("w:r");a=$(a);var c=this.createEle("w:rPr");this.lastWR=c;b.appendChild(c);if(""!=a.css("color")){var d=this.createEle("w:color"),e=this.rgb1(a.css("color"));d.setAttribute("w:val",e);c.appendChild(d)}if(""!=a.css("font-family")){a.css("font-family").replace(/'/ig,"").split(",");d=this.createEle("w:rFonts");var g=/[\u4E00-\u9FA5]|[\uFE30-\uFFA0]/gi.test(a.text())?this.defaultFontChinese:this.defaultFontEnglish;this.setAtts(d,{"w:ascii":g,"w:eastAsia":g,
"w:hAnsi":g,"w:hint":"eastAsia","w:cs":this.defaultFontEnglish});c.appendChild(d)}""!=a.css("font-size")&&(d=a.css("font-size"),g=this.fontSize(d),null!=g&&(d=this.createEle("w:sz"),d.setAttribute("w:val",2*g),c.appendChild(d),e=this.createEle("w:szCs"),e.setAttribute("w:val",2*g),c.appendChild(e)));d=a.css("font-weight");if("B"==a.tagName||""!=d&&"normal"!=d&&"400"!=d)d=this.createEle("w:b"),c.appendChild(d);"I"==a.tagName&&(d=this.createEle("w:i"),c.appendChild(d));return b};this.createBr=function(a){a=
this.createEle("w:r");var b=this.createEle("w:br");a.appendChild(b);return a};this.createTable=function(a){var b=this.createEle("w:tbl"),c=this.createEle("w:tblPr"),d=this.createEle("w:tblStyle");d.setAttribute("w:val","a4");c.appendChild(d);d=this.createWidth(a,"tblW");c.appendChild(d);a.setAttribute("ww",d.getAttribute("w:w"));b.appendChild(c);return b};this.createTbody=function(){return this.createEle("w:tblGrid")};this.createTr=function(a){var b=this.createElesLvl("w:tr,w:trPr");this.setAtts(b[0],
{"w:rsidR":"003D2D54","w14:textId":"77777777","w14:paraId":this.getParaId()});a=this.createHeight(a,"trHeight");b[1].appendChild(a);return b[0]};this.paraId=0;this.getParaId=function(){var a="0000"+this.paraId;a=a.substring(a.length-4);this.paraId++;return"F0C0"+a};this.createTd=function(a){thisTr=a.parentNode;var b=thisTr.parentNode.parentNode,c=a.getAttribute("vmerge"),d=0;if(null!=c&&""!=c){var e=this.createEle("w:tc"),g=this.createEle("w:tcPr"),h=this.createEle("w:vMerge");g.appendChild(h);e.appendChild(g);
this.getDock().appendChild(e);d=this.createEle("w:p");e.appendChild(d);e=c.split(",");e=b.rows[e[0]].cells[e[1]];g.appendChild(this.createTdBorders(e));d=1*e.getAttribute("wwtd")}e=this.createEle("w:tc");g=this.createEle("w:tcPr");e.appendChild(g);if(1<a.rowSpan)for(h=this.createEle("w:vMerge"),h.setAttribute("w:val","restart"),g.appendChild(h),h=0;h<a.rowSpan-1;h++)(c=b.rows[h+1+thisTr.rowIndex])&&(c=c.cells[a.cellIndex])&&c.setAttribute("vmerge",thisTr.rowIndex+","+a.cellIndex);1<a.colSpan&&(b=
this.createEle("w:gridSpan"),b.setAttribute("w:val",a.colSpan),g.appendChild(b));g.appendChild(this.createTdBorders(a));h=this.createWidth(a,"tcW");c=a.parentNode;b=c.getAttribute("wwtr");if(null==b||""==b)b=c.parentNode.parentNode,b=b.getAttribute("ww");var k=h.getAttribute("w:w");a!=a.parentNode.cells[a.parentNode.cells.length-1]?(a.setAttribute("wwtd",k),c.setAttribute("wwtr",1*b-1*k-d)):(h.setAttribute("w:w",0),h.setAttribute("w:type","auto"));g.appendChild(h);a=$(a).css("vertical-align");"middle"==
a?(a=this.createEle("w:vAlign"),a.setAttribute("w:val","center"),g.appendChild(a)):"bottom"==a&&(a=this.createEle("w:vAlign"),a.setAttribute("w:val","bottom"),g.appendChild(a));return e};this.createWidth=function(a,b){b=this.createEle("w:"+b);a=15*$(a).width();b.setAttribute("w:w",a);b.setAttribute("w:type","dxa");return b};this.createHeight=function(a,b){b=this.createEle("w:"+b);a=15*$(a).height();b.setAttribute("w:val",a);return b};this.createTdBorders=function(a){for(var b=this.createEle("w:tcBorders"),
c=0;c<this.EWA_DocTmp.borders.length;c++){var d=this.createBorder(a,this.EWA_DocTmp.borders[c]);b.appendChild(d)}return b};this.createBorder=function(a,b){var c=$(a).css("border-"+b+"-width"),d=this.createEle("w:"+b);"0px"==c?d.setAttribute("w:val","nil"):(d.setAttribute("w:val","single"),a=$(a).css("border-"+b+"-color"),a=this.rgb1(a),d.setAttribute("w:color",a),d.setAttribute("w:sz",6));return d};this.createPVanish=function(){return this.createElesLvl("w:p,w:pPr,w:rPr,w:vanish")};this.createP=function(a){var b=
this.createEle("w:p"),c=this.createEle("w:pPr");b.appendChild(c);c=this.createElesSameLvl("w:pStyle,w:jc",c);var d=c[1],e=$(a).css("text-align");e=null==e?"":e;0<=e.indexOf("center")?d.setAttribute("w:val","center"):0<=e.indexOf("right")?d.setAttribute("w:val","right"):d.setAttribute("w:val","left");d=c[0];d.setAttribute("w:val","a");0==a.tagName.indexOf("H")&&d.setAttribute("w:val",a.tagName.replace("H",""));this.createElesLvl("w:rFonts",c[2])[0].setAttribute("w:hint","eastAsia");this.lastWR=null;
this.setAtts(b,{"w:rsidR":"003D2D54","w14:textId":"77777777","w14:paraId":this.getParaId(),"w:rsidRDefault":"0057281A"});return b};this.createPic=function(a){var b=$(a),c=a.src;this.pics.push(a.src);a=c.lastIndexOf("/");c=c.substring(a+1);a=this.px2emu(b.width());b=this.px2emu(b.height());var d=this.createElesLvl("w:r,w:rPr,w:noProof")[0],e=this.createElesLvl("w:drawing,wp:inline,wp:extent");d.appendChild(e[0]);wExtent=e[2];this.setAtts(wExtent,{cx:a,cy:b});e=e[1];this.setAtts(e,{distT:"0",distB:"0",
distL:"0",distR:"0"});var g=this.createElesSameLvl("wp:effectExtent,wp:docPr,wp:cNvGraphicFramePr",e);this.setAtts(g[0],{l:"0",t:"0",r:"0",b:"0"});this.setAtts(g[1],{id:"0",name:c});var h=this.createEleNs("a:graphicFrameLocks","http://schemas.openxmlformats.org/drawingml/2006/main");g[2].appendChild(h);this.setAtts(h,{noChangeAspect:1});g=this.createEleNs("a:graphic","http://schemas.openxmlformats.org/drawingml/2006/main");h=this.createEle("a:graphicData");h.setAttribute("uri","http://schemas.openxmlformats.org/drawingml/2006/picture");
var k=this.createEleNs("pic:pic","http://schemas.openxmlformats.org/drawingml/2006/picture");g.appendChild(h);h.appendChild(k);e.appendChild(g);e=this.createElesSameLvl("pic:nvPicPr,pic:blipFill,pic:spPr",k);this.setAtts(e[1],{rotWithShape:"1"});this.setAtts(e[2],{bwMode:"auto"});g=this.createElesSameLvl("pic:cNvPr,pic:cNvPicPr",e[0]);this.setAtts(g[0],{id:"0",name:c});g=this.createElesSameLvl("a:blip,a:srcRect,a:stretch",e[1]);this.setAtts(g[0],{"r:embed":"pic"+(this.pics.length-1)});this.setAtts(g[1],
{l:"0",t:"0",r:"0",b:"0"});c=this.createEles("a:extLst,a:ext");g[0].appendChild(c[0]);c[1].setAttribute("uri","{28A0092B-C50C-407E-A947-70E740481C1C}");g=this.createEleNs("a14:useLocalDpi","http://schemas.microsoft.com/office/drawing/2010/main");g.setAttribute("val",0);c[1].appendChild(g);c=this.createElesSameLvl("a:xfrm,a:prstGeom,a:ln,a:extLst",e[2]);this.setAtts(c[1],{prst:"rect"});e=this.createElesSameLvl("a:off,a:ext",c[0]);this.setAtts(e[0],{x:0,y:0});this.setAtts(e[1],{cx:a,cy:b});this.createElesSameLvl("a:avLst",
c[1]);this.createElesSameLvl("a:noFill",c[2]);return d};this.createEleNs=function(a,b){return this.doc.XmlDoc.createElementNS(b,a)};this.setAtts=function(a,b){for(var c in b)a.setAttribute(c,b[c])};this.fontSize=function(a){0<a.indexOf("px")&&(a=this.EWA_DocTmp.f[a],a=null==a?"9pt":a);return a.replace("pt","")};this.rgb1=function(a){a=a.replace("rgb(","").replace(")","").split(",");return this.rgb(1*a[0],1*a[1],1*a[2]).toUpperCase()};this.rgb=function(a,b,c){a=a.toString(16);b=b.toString(16);c=c.toString(16);
return(2>a.length?"0":"")+a+(2>b.length?"0":"")+b+(2>c.length?"0":"")+c};this.init=function(){this.doc=new EWA_XmlClass;this.doc.LoadXml(this.EWA_DocTmp.document);EWA.B.IE?this.docks.push(this.doc.XmlDoc.getElementsByTagName("w:body")[0]):this.docks.push(this.doc.XmlDoc.childNodes[0].childNodes[0])};this.getDock=function(){return this.docks[this.docks.length-1]};this.idx=0;this.docksPop=function(a){for(;1!=this.docks.length&&this.docks.pop()!=a;);};this.getDockTable=function(){for(var a=this.docks.length-
...
a.replace("rgb(","").replace(")","").split(",");return this.rgb(1*a[0],1*a[1],1*a[2]).toUpperCase()};this.rgb=function(a,b,c){a=a.toString(16);b=b.toString(16);c=c.toString(16);return(2>a.length?"0":"")+a+(2>b.length?"0":"")+b+(2>c.length?"0":"")+c};this.init=function(){this.doc=new EWA_XmlClass;this.doc.LoadXml(this.EWA_DocTmp.document);var a=this.doc.XmlDoc.getElementsByTagName("text");0==a.length&&(a=this.doc.XmlDoc.getElementsByTagName("office:text"));this.docks.push(a[0])};this.getDock=function(){return this.docks[this.docks.length-

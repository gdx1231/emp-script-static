...
function EWA_TanslatorCalss(){this.SKIP_EXISTS=!0;this.transAll=function(a,b,c,d){var e=this;this.idx_ok=this.idx=0;null==a?alert("enus"==EWA.LANG?"Object objs_ch cannot be empty":"\u5bf9\u8c61objs_ch\u4e0d\u80fd\u4e3a\u7a7a"):(this._objs_ch=a,this._objs_en=b,this._transCompleteCallback=d,this._transCompleteItemCallBack=c,this.start_trans("en"),$Tip("enus"==EWA.LANG?"Translate started":"\u7ffb\u8bd1\u5f00\u59cb",function(){return e.check_complete()}))};this.transAllToCn=function(a,b,c,d){this.idx_ok=
this.idx=0;null==a?alert("enus"==EWA.LANG?"Object objs_ch cannot be empty":"\u5bf9\u8c61objs_ch\u4e0d\u80fd\u4e3a\u7a7a"):(this._objs_ch=a,this._objs_en=b,this._transCompleteCallback=d,this._transCompleteItemCallBack=c,this.start_trans("cn"))};this.start_trans=function(a){if(this.idx<=this._objs_ch.length-1){var b=this.idx;this.idx++;var c=this._objs_ch[b];if(this.get_text(c)){b=this._objs_en?this._objs_en[b]:null;var d=this.get_text(b);if(this.SKIP_EXISTS&&d)this.idx_ok++,this.start_trans(a);else{this.trans_item(c,
b,a);var e=this;setTimeout(function(){e.start_trans(a)},123)}}else this.idx_ok++,this.start_trans(a)}};this.trans_item=function(a,b,c){var d=this;null==this.trans&&(this.trans=new EWA_TransClass,this.trans.transAfter=function(e,g){d.idx_ok++;d.call_item_callback(g,e)});"cn"==c?this.trans.TransToCn(this.get_text(a),b):this.trans.TransToEn(this.get_text(a),b)};this.get_text=function(a){if(null==!a||void 0==a)return null;if("string"==typeof a)var b=a;else{var c=a.tagName;null==c&&(c="");c=c.toUpperCase();
"SELECT"==c||"INPUT"==c||"TEXTAREA"==c?b=a.value:""!=c?b=a.innerHTML:(console.log("trans_err"),console.log(a))}return b||""};this.call_item_callback=function(a,b){this._transCompleteItemCallBack&&this._transCompleteItemCallBack(a,b)};this.check_complete=function(){return this._objs_ch.length==this.idx_ok?($Tip("enus"==EWA.LANG?"Translate completed":"\u7ffb\u8bd1\u5b8c\u6210"),this._transCompleteCallback&&this._transCompleteCallback(),!0):!1}}
...
this.Merge(a,b,c)};this.Merge=function(a,b,c,d){this.merges(b,[b,a],c,d)};this.merges=function(a,b,c,d){if(a&&b&&0!=b.length){"string"==typeof b&&(b=b.split(","));var e=[];e.push("<table class='ewa-merge-table' cellpadding=0 cellpadding=0><tr>");for(var g=0;g<b.length;g++){var h=(b[g]+"").trim();e.push("<td class='ewa-merge-td "+(0===g?"ewa-merge-td-first ":"")+"\n\t\t\t\t"+(g===b.length-1?"ewa-merge-td-last ":"")+"\n\t\t\t'>@@"+h+"</td>")}e.push("</tr></table>");this.MergeExp(a,e.join(""),c,d)}};
this.MergeExp=function(a,b,c,d){if(b){var e=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),g=[],h=b;b={};for(var k=this.getObj(),l=0;l<e.length;l++){var m=e[l];g.push(m);var n=m.replace("@@",""),p=k.find(".ewa-row-"+n),r="<span class='ewa-row-merge "+(p.hasClass("ewa-row-must")?"ewa-row-must":"")+" ewa-row-merge-"+n+"' mid=\""+n+'"></span>';h=h.replace(m,r);n!=a&&p.hide().addClass("ewa-row-merge-hide").attr("hiddennocontentrow",1);b[n]=this.GetItemDescription(n).Info}e=document.createElement("div");e.style.display=
"none";e.innerHTML=h;document.body.appendChild(e);m=k.find('[id="'+a+'"]');if(0==m.length)console.log("not find "+a);else{a=m.parent();for(var q in g)if(m=g[q].replace("@@",""),h=k.find('[id="'+m+'"]'),0==h.length)console.log("not found [id="+m+"]");else if(l=$(e).find('span[mid="'+m+'"]'),"placeholder"==c?h.attr("placeholder",b[m]):c&&(l.append("<span class='ewa-row-merge-memo'></span>"),l.find(".ewa-row-merge-memo").text(b[m])),m=k.find(".ewa-row-"+m+" .EWA_TD_M"),0==m.length)l.append(h);else for(;0<
m[0].childNodes.length;)l.append(m[0].childNodes[0]);for(;0<e.childNodes.length;)a.append(e.childNodes[0]);$(e).remove();d&&d(a)}}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MergeItems=function(){for(var a in this.MeargeMap){var b=this.MeargeMap[a],c=$X("_ewa_tr$"+a);if(c){for(var d=c.cells.length,e=$(c.cells[0]);1<c.cells.length;)e.append(c.cells[1].innerHTML),c.removeChild(c.cells[1]);c.cells[0].colSpan=d;c=[];for(d=0;d<b.length;d++){for(var g=$X("_ewa_tr$"+b[d]),h=["<nobr>"],k=
0;k<g.cells.length;k++)h.push(g.cells[k].innerHTML);h.push("</nobr>");c.push(h.join(" "));g.parentNode.removeChild(g)}e.append(c.join(" "))}}};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.DoAction=function(a,b,c,d,e,g){EWA.F.CID=this._Id;if(null!=b&&""!=b.trim()){if(null!=c&&0<c.trim().length)if(a=_EWA_INFO_MSG[c],null!=a&&""!=a){if(!window.confirm(a))return}else if(!window.confirm(c))return;this.DoPostBefore();this._Ajax=this.CreateAjax(null,!0);this._Ajax.LoadingType=
"image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.AddParameter("EWA_ACTION_TIP",d);null!=g&&0<g.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",g),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=!1;if(null!=e&&0<e.length)for(b=0;b<e.length;b+=1)this._Ajax.AddParameter(e[b].Name,e[b].Value);e=new EWA.C.Url;
e.SetUrl(this.Url);e=e.RemoveParameter("EWA_ACTION");this._Ajax.PostNew(e,EWA.F.FOS[EWA.F.CID]._CallBackJs)}};this.GuideShowCreate=function(a){this._GroupInfos=a;var b=$X("EWA_FRAME_"+this._Id);a=a.length-1;b.setAttribute("EWA_GUIDE_IDX","0");b.setAttribute("EWA_GUIDE_IDX_MAX",a);b.rows[b.rows.length-1].style.display="none";100<b.clientHeight&&(b.parentNode.style.height=b.clientHeight+"px");a=document.createElement("input");a.id="ewa_but_"+Math.random();a.type="button";a.value="enus"==EWA.LANG?"Back":
"\u4e0a\u4e00\u6b65";a.style.display="none";a.onclick=function(){var h=b.getAttribute("EWA_GUIDE_IDX");if(0==1*h)$Tip("\u5230\u5934\u4e86");else{var k=b.id.replace("EWA_FRAME_","");EWA.F.FOS[k].GuidePrevBefore&&EWA.F.FOS[k].GuidePrevBefore(h,this,b);EWA.F.FOS[k].GuideShow(1*h-1);EWA.F.FOS[k].GuidePrevAfter&&EWA.F.FOS[k].GuidePrevAfter(h,this,b)}};var c=document.createElement("input");c.id="ewa_but_"+Math.random();c.type="submit";c.value="enus"==EWA.LANG?"Next":"\u4e0b\u4e00\u6b65";c.onclick=function(){var h=
b.getAttribute("EWA_GUIDE_IDX"),k=b.id.replace("EWA_FRAME_","");EWA.F.FOS[k].GuideShowCheck(h)&&(EWA.F.FOS[k].GuideNextBefore&&EWA.F.FOS[k].GuideNextBefore(h,this,b),"ok"==this.getAttribute("ewa_guide_method")?$F(b,"input","type","submit")[0].click():EWA.F.FOS[k].GuideShow(1*h+1),EWA.F.FOS[k].GuideNextAfter&&EWA.F.FOS[k].GuideNextAfter(h,this,b))};var d=b.parentNode.parentNode.parentNode.parentNode.parentNode,e=d.insertRow(-1).insertCell(-1);e.appendChild(a);e.appendChild(c);e.className="EWA_FRAME_GROUP_BUTTONS";
tdTitle=d.insertRow(0).insertCell(-1);d="ewa_title_"+Math.random();e=[];for(var g=0;g<this._GroupInfos.length;g++)e.push('<div style="float:left" id="ewa_'+this._Id+"_"+g+'">'+(g+1)+". "+this._GroupInfos[g].DES+"</div>");tdTitle.innerHTML="<div style='text-align:left'>"+e.join(" <div style='float:left;color:#aaa'>&nbsp;&gt;&nbsp;</div> ")+"</div><div id='"+d+"'></div>";tdTitle.className="EWA_FRAME_GROUP_TITLE";b.setAttribute("EWA_GUIDE_ID_PREV",a.id);b.setAttribute("EWA_GUIDE_ID_NEXT",c.id);b.setAttribute("EWA_GUIDE_ID_TITLE",
d);this.GuideShowTitle(0);a=document.createElement("div");100<b.clientHeight&&(a.style.width=b.clientWidth+"px",a.style.height=b.clientHeight+20+"px",a.style.overflow="auto");b.parentNode.appendChild(a);a.appendChild(b);b.parentNode.className="EWA_GROUP_GUIDE"};this.GuideShowTitle=function(a){for(var b=$X("EWA_FRAME_"+this._Id).getAttribute("EWA_GUIDE_IDX_MAX"),c=0;c<=b;c++){var d="ewa_"+this._Id+"_"+c;c==a?($X(d).style.color="blue",$X(d).style.borderBottom="2px solid green"):($X(d).style.color="green",
$X(d).style.borderBottom="2px")}};this.GuideShowCheck=function(a){var b=!0,c=null,d;for(d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],"Name","Name");e=this.getObj("#"+e);if(0!=e.length){e=e[0];var g=this._GetTr(e);null!=g&&g.getAttribute("groupindex")==a&&((b&=this.CheckValid(e))||null!=c||(c=e))}}null!=c&&c.focus();return b};this._GetTr=function(a){for(var b=0;100>b;){b++;a=a.parentNode;try{if("TR"==a.tagName.toUpperCase()&&null!=a.getAttribute("id")&&0==a.getAttribute("id").indexOf("_ewa_tr$"))return a}catch(c){break}}return null};
this.GuideShow=function(a){this.GuideShowTitle(a);var b=$X("EWA_FRAME_"+this._Id);if(b.getAttribute("EWA_GUIDE_IDX")!=a){var c=b.getAttribute("EWA_GUIDE_IDX_MAX"),d=b.getAttribute("EWA_GUIDE_ID_PREV"),e=b.getAttribute("EWA_GUIDE_ID_NEXT");a==c?($X(e).value="enus"==EWA.LANG?"Confirm":"\u786e\u5b9a",$X(e).setAttribute("ewa_guide_method","ok")):($X(e).value="enus"==EWA.LANG?"Next":"\u4e0b\u4e00\u6b65",$X(e).setAttribute("ewa_guide_method",""));0==a?$X(d).style.display="none":$X(d).style.display="";b.setAttribute("EWA_GUIDE_IDX",
a);this._ShowHidenGroup(b,a)}};this._ShowHidenGroup=function(a,b){for(var c=0;c<a.rows.length-1;c++){var d=a.rows[c];if(null!=d.getAttribute("groupIndex")&&""!=d.getAttribute("groupIndex")){var e=1*d.getAttribute("groupIndex");d.style.display=b==e?"":"none"}}};this.GroupShow=function(a,b){if(!(0<a.className.indexOf("1"))){this.GroupShowBefore&&this.GroupShowBefore(a,b);for(var c=$X("EWA_FRAME_"+this._Id),d=a.parentNode.parentNode,e=0;e<c.rows.length;e++){var g=c.rows[e];if(g!=d&&!(1==g.cells.length&&
g.cells[0].className&&0<=g.cells[0].className.indexOf("EWA_TD_B"))&&"1"!=g.getAttribute("hiddennocontentrow")){var h=0;null!=g.getAttribute("groupIndex")&&""!=g.getAttribute("groupIndex")&&(h=1*g.getAttribute("groupIndex"));g.style.display=b==h?"":"none"}}c=d.getElementsByTagName("div");for(e=0;e<c.length;e++)d=c[e],d.className=d==a?d.className+"1":d.className.replace("1","");this.GroupShowAfter&&this.GroupShowAfter(a,b)}};this.DoActionJSON=function(a,b,c,d){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;
...
b=a._Ajax;if(4==b._Http.readyState)if(b.HiddenWaitting(),200==b._Http.status){if(b=b._Http.responseText,EWA.F.CheckCallBack(b)){eval(b);a._AjaxJsonAfter&&(a._AjaxJsonAfter(),a._AjaxJsonAfter=null);try{a.ReloadAfter&&a.ReloadAfter(b)}catch(c){alert(b)}}}else alert("ERROR:\r\n"+b._Http.statusText)};this.RewriteInfo=function(a,b,c,d,e){var g=$("this.getObj()_"+this._Id),h=[];b=b||"id";c=c||"info";d=d||"memo";for(var k=0;k<a.length;k++){var l=a[k],m=g.find("#"+l[b]);0!=m.length&&(m=m.parentsUntil("tr[show_msg]").last().parent(),
null==l[c]||""==l[c].trim()?(m.hide(),e&&e(m[0],l,k)):3==m[0].cells.length?(h.push(m[0]),m[0].cells[2].innerHTML=l[d],m[0].cells[0].innerHTML=l[c],e&&e(m[0],l,k)):2==m[0].cells.length?(h.push(m[0]),m[0].cells[0].innerHTML=l[c],e&&e(m[0],l,k)):1==m[0].cells.length&&(m=m.prev(),1<m[0].cells.length&&(m[0].cells[1].innerHTML=l[d]),h.push(m[0]),m[0].cells[0].innerHTML=l[c],e&&e(m[0],l,k)))}return h};this._HiddenMemo=function(a,b){var c=a.parentNode.parentNode;b=!1;"none"==c.style.display&&(b=!0);c.style.display=
"none";c.id="tr_"+a.id;c=c.previousSibling;3==c.nodeType&&(c=c.previousSibling);c.style.display="none";a="<span id=tab_"+a.id+' class="ewa_merge_tab" onclick="EWA.F.FOS[\''+this._Id+"'].ShowMemo(this.id);\">"+c.cells[0].innerHTML+"</span>";return b?"":a};this.ShowMemo=function(a){for(var b=$X(this._Id+"__ewa_meger").getElementsByTagName("SPAN"),c=0;c<b.length;c++){var d=b[c].id.replace("tab_","tr_");"ewa_merge_tab1"==b[c].className&&(b[c].className="ewa_merge_tab",$X(d).style.display="none");b[c].id==
a&&(b[c].className="ewa_merge_tab1",$X(d).style.display="")}};this.MergeMemo=function(){var a=$X("EWA_FRAME_"+this._Id).getElementsByTagName("textarea");if(0!=a.length&&"1"!=a[0].getAttribute("ewa_merge")){for(var b=[],c=0;c<a.length;c++){var d=this._HiddenMemo(a[c]);d="<nobr>"+d.replace("\u2022 ","").trim()+"</nobr>";b.push(d)}a=a[0];c=a.parentNode.parentNode;d=c.previousSibling;3==d.nodeType&&(d=d.previousSibling);d.id=this._Id+"__ewa_meger";d.cells[0].colSpan=3;d.cells[0].innerHTML=b.join("");
d.cells[0].style.width="100%";d.cells[0].style.height="25px";d.style.display="";c.style.display="";$X("tab_"+a.id).className="ewa_merge_tab1";null!=window._EWA_DialogWnd&&EWA.UI.Dialog._SetTitle(window._EWA_DialogWnd)}};this.DoValidEx=function(a,b,c,d,e,g){""!=a.value&&(this._ValidExOk=this.Resources[e],this._ValidExFail=this.Resources[g],this._ValidExObj=a,"action"==b.toLowerCase().trim()?this._DoValidExAction(a,d,this.Resources[e].GetInfo(),this.Resources[g].GetInfo()):(0<=c.indexOf("&quot;")&&
(c=c.replace(/&quot;/ig,'"')),eval(c)?(EWA_FrameShowAlert(a,this._ValidExOk.GetInfo()),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,this._ValidExFail.GetInfo()),a.setAttribute("EWA_VALID_EX",this._ValidExFail.GetInfo()))))};this._DoValidExAction=function(a,b,c,d){if(null!=a&&!$(a).is(":hidden"))if(null==b||""==b.trim())alert("action not value");else{var e=a.id+","+a.value;if(this.DoValidExAction_RETS&&null!=this.DoValidExAction_RETS[e])0==this.DoValidExAction_RETS[e]?(EWA_FrameRemoveAlert(a,
c),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,d),a.setAttribute("EWA_VALID_EX",d));else{var g=new EWA.C.Ajax;g.LoadingType="image";g.AddParameter("EWA_AJAX","HAVE_DATA");g.AddParameter("EWA_ACTION",b);g.AddParameter("EWA_ID",this._Id);g.AddParameter("EWA_NO_CONTENT","1");g.AddParameter(a.id,a.value);this.DoValidExAction_RETS||(this.DoValidExAction_RETS={});var h=this;g.PostNew(this.Url,function(){if(4==g._Http.readyState){g.HiddenWaitting();if(200==g._Http.status){var k=g._Http.responseText;
if(EWA.F.CheckCallBack(k))try{var l=parseInt(k.trim());h.DoValidExAction_RETS[e]=l;0==l?(EWA_FrameRemoveAlert(a,c),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,d),a.setAttribute("EWA_VALID_EX",d))}catch(m){alert(m+","+k)}}else alert("ERROR:\r\n"+g._Http.statusText);g=null}})}}};this.ValidCodeError=function(a){var b=this._t_ValidCodeError||0,c=(new Date).getTime();1E3>c-b?a||(a=_EWA_EVENT_MSG.ValidCodeError,$Tip(a),$(".ewa-valid-code-img").parent().parent().find("input").focus().select()):
(this._t_ValidCodeError=c,$(".ewa-valid-code-img").each(function(){this.click()}),a||(a=_EWA_EVENT_MSG.ValidCodeError,$Tip(a),$(".ewa-valid-code-img").parent().parent().find("input").focus().select()))};this.checkIdempotenceError=function(){$Tip(_EWA_EVENT_MSG.IdempotanceError)};this.checkValidSildePuzzleError=function(){$Tip(_EWA_EVENT_MSG.ValidSildePuzzleError)};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.F=this;this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;
this.Resources.Init(this.Xml);"enus"==EWA.LANG&&$(".ewa-ipt-droplist").attr("placeholder","Input character selection");this._InitTranslations();this._GetDropListValue();this._InitMustInputs();this._InitEncyptions();this._InitTriggerValids()};this._InitTriggerValids=function(){var a=this.getObj(),b="EWA.F.FOS['"+this._Id+"'].callTriggerValid(this)";this.triggerValids={};for(var c in this.ItemList.Items){var d=this.ItemList.Items[c],e=this.ItemList.GetItemValue(d,"Name","Name"),g=$(d).find("DataItem Set[TriggerValid]").attr("TriggerValid");
if(g){this.triggerValids[e]=null;var h=a.find("#"+e);0===h.length&&contine;h.attr("ewa_trigger_valid",g);d=$(d).find("Tag Set").attr("Tag");if("submit"==d)break;if("smsValid"==d){h=a.find(".ewa-row-"+e+" .ewa-sms-valid-code-button");d=h.attr("id");d||(d=EWA_Utils.tempId(),h.attr("id",d));var k=$("<a style='position:absolute;left:0;top:0;right:0;bottom:0'></a>");k.attr("ewa_trigger_valid",g);k.attr("ewa_trigger_valid_rid",e);k.attr("ewa_trigger_valid_click_id",d);h.parent().css("position","relative").append(k);
h=k}(e=h.attr("onclick"))&&h.attr("_onclick",e);h.attr("onclick",b)}}};this.callTriggerValidBefore=function(a){return!0};this.callTriggerValid=function(a){if(this.callTriggerValidBefore(a)){var b=this.getObj(),c=$(a),d=c.attr("id");d||(d=c.attr("ewa_trigger_valid_rid"));var e=this.getUrlClass(),g=c.attr("ewa_trigger_valid");e.AddParameter("ewa_ajax",g);e.AddParameter("ewa_trigger_valid_name",d);e.AddParameter("ewa_trigger_valid_mode","create");e.AddParameter("ewa_trigger_valid_width",document.documentElement.clientWidth);
var h=this,k=EWA_Utils.tempId();$J(e.GetUrl(),function(l){if(l.RST){c.attr("_trigger_valid_id",k);var m=top.$DialogHtml("<div id='"+k+"'></div>","enus"==EWA.LANG?"Silde puzzle":"\u62fc\u56fe\u9a8c\u8bc1",l.bigImgWidth+20,200,!1);$(m.getContent()).css("overflow","hidden");l.ewa_trigger_valid_name=d;l.ewa_trigger_valid=g;l.ewa_url=e.GetUrl();EWA.UI.SlidePuzzle(l,top.$("#"+k),function(n){console.log("2. puzzle cb true");var p=!1;c.attr("_onclick")&&(c.attr("onclick",$(a).attr("_onclick")),p=!0);setTimeout(function(){$(m.getMain()).animate({opacity:0},
500)},500);setTimeout(function(){var r=c.attr("type");h.triggerValids[d]=n.VALID;var q=$(a).attr("ewa_trigger_valid_click_id");q?(c.remove(),console.log(q+".click"),b.find("#"+q).click()):p?(console.log("3. puzzle click"),c.click()):"submit"==r&&console.log("3. puzzle submit");m.Close()},1E3)});setTimeout(function(){m.AutoSize()},100)}else alert(l.ERR)})}};this._InitMustInputs=function(){var a=this.getObj(),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,
"Name","Name");0<$(c).find('IsMustInput Set[IsMustInput="1"]').length&&(c="#"+d,a.find(".ewa-row-"+d).addClass("ewa-row-must"),d=a.find(c),d.addClass("ewa-row-item-must"),0<d.length&&d.attr("type")&&"hidden"==d.attr("type").toLowerCase()&&d.prev().addClass("ewa-row-item-must"))}};this._InitEncyptions=function(){var a=this.getObj(),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name");c=$(c).find("DispEnc Set");if(0!=c.length&&(d=a.find("#"+d),0!=
d.length&&c.attr("EncType"))){if("INPUT"==d[0].tagName||"TEXTAREA"==d[0].tagName){if(!d.val())continue;d.prop("disabled",!0);d.attr("ewa_encyrption","yes")}var e=$("<div class='ewa-enc-cover' style='position:absolute;left:0;top:0;width:100%;height:100%;'><div></div></div>");d.parent().append(e);d.parent().css("position","relative");if(c=c.attr("EncShowUrl")){e.find("div").html("\u70b9\u51fb\u67e5\u770b").css({position:"absolute",height:30,"line-height":"30px",top:"50%","margin-top":"-15px",right:10,
"text-align":"right"});c=new EWA_UrlClass(c);e=new EWA_UrlClass(this.Url);for(var g in e._Paras)if(!c.GetParameter(g)){var h=e._Paras[g];null!=h&&(h=h.unURL());c.AddParameter(g,h)}c.AddParameter("EWA_ENCY_FROM_ID",d.attr("id"));c=c.GetUrl();d.parent().attr("enc_url",c).attr("fid",d.attr("id"));d.parent().on("click",function(){if(!$(this).attr("enc_ok")){var k=$(this).attr("t")||100,l=(new Date).getTime();if(!(400>l-k)){$(this).attr("t",l);k=$(this).attr("enc_url");var m=$(this).find("#"+$(this).attr("fid"));
$J(k,function(n){n.RST?(m.prop("disabled",!1),m.removeAttr("ewa_encyrption"),m.val(n.VALUE),$(m).parent().find(".ewa-enc-cover").remove(),$(m).parent().attr("enc_ok","1")):(n.ERR||n.MSG)&&$Tip(n.ERR||n.MSG)})}}})}}}};this._InitTranslations=function(){var a="EWA.F.FOS[&quot;"+this._Id+"&quot;]._Trans(this)",b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name"),e=$(c).find("DataItem Set[Translation]");if(c=e.attr("Translation")){e=e.attr("TransTarget");
var g="en2zh"==c?" \u82f1\u8bd1\u4e2d":" \u4e2d\u8bd1\u82f1";"enus"==EWA.LANG&&(g="en2zh"==c?" En-Zh":" Zh-En");c=$('<a class="ewa-but-trans" href="javascript:void(0)" onclick="'+a+'" _transf="'+d+'" _transp="'+c+'" _transt="'+e+'">'+g+"</a>");e=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+d+" .EWA_TD_L");0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+d+" .EWA_TD"));0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" #"+d).parent().prev().find(".ewa_d1"));0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" #"+d).parent(),
e.css("position","relative"),c.addClass("ewa-but-trans-float"));e.append(c)}}};this._Trans=function(a){if(a){var b=$(a).attr("_transf"),c=$(a).attr("_transp");a=$(a).attr("_transt");b=$("#EWA_FRAME_"+this._Id+" #"+b);a=$("#EWA_FRAME_"+this._Id+" #"+a);if(0==b.length||0==a.length)console.log("trans ex:",b,a);else{var d=b[0].tagName.toLowerCase();if(b="input"==d||"textarea"==d||"hidden"==d?b.val():b.text()){var e=new EWA_TransClass;"en2zh"==c?e.transToCn(b,a[0]):e.transToEn(b,a[0]);$Tip("enus"==EWA.LANG?
"Translating...":"\u7ffb\u8bd1\u4e2d...",function(){return!e.IsRun})}}}};this._bindCompostion=function(a,b){if(!EWA.B.IE){var c=this;c._droplist_||(c._droplist_={});c._droplist_[b.id]={_is_composition:!1};$(a).on("compositionstart",function(){c._droplist_[b.id]._is_composition=!0}).on("compositionend",function(){c._droplist_[b.id]._is_composition=!1;EWA.F.I.DropList(this)}).removeAttr("oninput").removeAttr("onkeyup").on("input",function(){c._droplist_[b.id]._is_composition||EWA.F.I.DropList(this)})}};
this._GetDropListValue=function(){var a=this.getObj();if(0!=a.length){a=a[0];var b=a.getElementsByTagName("input");this._droplist_={};for(var c=0;c<b.length;c++){var d=b[c];if("droplist"==d.getAttribute("ewa_class")){var e=d.nextSibling;"INPUT"==e.tagName.toUpperCase()&&"HIDDEN"==e.type.toUpperCase()&&(this._GetDropListValue1(d,e),this._bindCompostion(d,e))}}a=a.getElementsByTagName("select");for(c=0;c<a.length;c++)if(d=a[c],b=d.getAttribute("_ListFilterType"))e=d.getAttribute("_ListFilterField"),
this.initSelectFilter(d.id,b,e);this._SelectFilters&&this._checkSelectOptionsChange()}};this.refreshDropList=function(a,b){var c=this.getObj('input[id="'+a+'"]');if(0==c.length)console.warn("Can not found id="+a);else{var d=c.prev();0==d.length?console.warn("Can not found  id="+a+" prev"):"droplist"==d.attr("ewa_class")?(c.val(b),this._GetDropListValue1(d[0],c[0])):console.warn("Not droplist id="+a+" prev")}};this._GetDropListValue1=function(a,b){if(""==b.value)b.setAttribute("setvalue",1);else{var c=
b.getAttribute("DlsShow");if(null==c||""==c)b.setAttribute("canopen",0),a.value=obj1.value,b.setAttribute("canopen",1);else{var d=b.getAttribute("xmlName"),e=b.getAttribute("itemName"),g=b.getAttribute("paraName"),h=b.getAttribute("DlsAction"),k=b.value;var l=this.EWA_CGI?this.EWA_CGI:window.EWA_CGI?window.EWA_CGI:EWA.CP+"/EWA_STYLE/cgi-bin/";var m=-1==l.indexOf("?")?"?":"&";l=(l+(m+"XMLNAME="+d+"&ITEMNAME="+e+"&EWA_AJAX=JSON")).replace("//","/");l=l.replace("//","/");l=l.replace("//","/");d={};d[g]=
k;null!=h&&0<h.trim().length&&(d.EWA_ACTION=h,d[b.id]=b.value);$JP(l,d,function(n){if(0!=n.length){var p=n[0],r=[];n={};for(var q in p)r.push(p[q]),n["@"+q.toUpperCase()]=p[q],p[q]&&b.setAttribute("para_"+q.toLowerCase(),p[q]);if(null==c||""==c)n=r.join("/");else{q=c.match(/@[a-zA-Z0-9\-\._:]*\b/ig);for(p=0;p<q.length;p++){r=q[p];var t=n[r.toUpperCase()];c=c.replace(r,t)}n=c}b.setAttribute("canopen",0);a.value=n;b.id=null==b.id||""==b.id?Math.random():b.id;"yes"==b.getAttribute("isdlseventload")&&
(EWA.F.FOS[b.id]=new EWA_FrameItemClass,EWA.F.FOS[b.id].DropList(a),EWA.F.FOS[b.id].CallAfterEvent());b.setAttribute("canopen",1);b.setAttribute("setvalue",1)}})}}};this.DoPostEx=function(){EWA.F.F.CUR=this;if(this.CheckValidAll(document.forms[0])){this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");for(var a=document.getElementsByTagName("input"),b=0;b<a.length;b+=1){var c=
a[b],d=""==c.name?c.id:c.name;null!=d&&""!=d&&this._Ajax.AddParameter(d,c.value)}a=document.getElementsByTagName("select");for(b=0;b<a.length;b+=1)c=a[b],d=""==c.name?c.id:c.name,null!=d&&""!=d&&this._Ajax.AddParameter(d,c.value);a=document.getElementsByTagName("textarea");for(b=0;b<a.length;b+=1)c=a[b],d=""==c.name?c.id:c.name,null!=d&&""!=d&&this._Ajax.AddParameter(d,c.value);this._Ajax.PostNew(this.Url,EWA.F.F.CUR._CallBack)}};this.createAjax=this.CreateAjax=function(a,b){EWA.F.F.CUR=this;null==
a&&(a=$("#f_"+this._Id)[0]);if(!b&&!this.CheckValidAll(a))return null;a=new EWA.C.Ajax;b=this.CreatePostData();for(var c in b)a.AddParameter(c,b[c]);return a};this.createPostData=this.CreatePostData=function(a){a=a||$("#f_"+this._Id)[0];var b={},c;for(c in this.ItemList.Items){var d=this.ItemList.GetItemValue(this.ItemList.Items[c],"Name","Name"),e=this.GetObject(d,a);if(null!=e&&!$(e).attr("ewa_encyrption")){var g=e.getAttribute("ewa_tag");if("signature"==g){var h="N";var k=this.tablets[c];for(var l=
0;l<k.lines.length;l++)if(k.lines[l]){h="Y";break}k="Y"==h?this._GetObjectValue(e):"";b[d+"_CHANGED"]=h}else k=this._GetObjectValue(e);null!=k&&(b[d]=k);"DIV"==e.tagName.toUpperCase()&&"1"==e.getAttribute("EWA_DHTML")&&(h=$X("UP_IMG_"+d).value,b[d+"_imgs_split"]=h);if("swffile"==g||"IMG_UPLOAD"==g)if(d=e.getAttribute("UP_PARAS"),null!=d&&0<d.length)for(d=d.split(","),g=0;g<d.length;g++){var m=d[g];b[m]=e.getAttribute(m)}else b.UP_URL=e.value;else"markdown"==g&&(e=e.parentNode.getElementsByTagName("textarea"),
1<e.length&&(b[e[1].id]=e[1].value))}}if(this.PostAddData)for(m in this.PostAddData)b[m]=this.PostAddData[m];if(this.triggerValids)for(var n in this.triggerValids)b[n+"_TRIGGER_VALID_RESULT"]=this.triggerValids[n];return b};this.DoPostBefore=function(){return!0};this.isDoPostBeforeTimer=function(){return null!=this._checkStatusFristResult};this._uploadingFileCheck=function(a){a=window["h5u_"+this._Id+"$"+a.id];if(!a.haveFile())return!1;if("ok"==a.UPLOAD_STATUS)return a.removeWaitBox(),this.uploadProcess=
!1;if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;if("error"==a.UPLOAD_STATUS||"abort"==a.UPLOAD_STATUS)return this._stopPost=!0,this._stopPostError="enus"==EWA.LANG?"Upload file error or aborted":"\u4e0a\u4f20\u6587\u4ef6\u9519\u8bef\u6216\u88ab\u4e2d\u6b62",console.log(this._stopPostError),!1;if("start"==a.UPLOAD_STATUS||"checking"==a.UPLOAD_STATUS)return!0;a.submitUploads();if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;$X(a.WAIT_ID)||
a.createWaitBox();return this.uploadProcess=!0};this._checkTriggerValids=function(){if(!this.triggerValids)return!0;var a=this.getObj();for(b in this.triggerValids)if(!this.triggerValids[b]){a=a.find("#"+b);if(0<a.length&&"submit"==a[0].type){var b=a.attr("_trigger_valid_inc")?1*a.attr("_trigger_valid_inc"):0;if(0==b)this.callTriggerValid(a);else{var c=a.attr("_trigger_valid_id");if(!c)return!1;if(0==top.$("#"+c).length)return this._cancelPostWait=!0,a.removeAttr("_trigger_valid_inc"),a.removeAttr("_trigger_valid_id"),
console.log("\u7a97\u53e3\u4e0d\u89c1\u4e86\uff0c\u53d6\u6d88\u63d0\u4ea4\u7b49\u5f85"),!1}b++;a.attr("_trigger_valid_inc",b)}return!1}return!0};this.DoPost=function(a,b,c){if(this.posting)return!1;if(this._cancelPostWait)return console.log("\u53d6\u6d88\u63d0\u4ea4"),this._cancelPostWait=null,!1;var d=this;if(!c){var e=this.DoPostBefore();if(e instanceof Array){d=this;this._checkStatusInc=0;this._checkStatusFristResult=e;this._checkStatusTimer=window.setInterval(function(){var p=0==d._checkStatusInc?
d._checkStatusFristResult:d.DoPostBefore();d._checkStatusInc++;var r=p[0];if(null!==r&&void 0!==r){window.clearInterval(d._checkStatusTimer);d._checkStatusTimer=null;d._checkStatusInc=null;d._checkStatusFristResult=null;var q=p[1];p=p[2];r&&!p?d.DoPost(a,b,!0):r&&p?$Confirm(q,q,function(){d.DoPost(a,b,!0)},function(){}):q&&$Tip(q)}},232);return}if(!e)return}var g=$(a).find("input[ewa_tag=ht5upload]");if(!(0<g.length)||this.uploadProcess||this.CheckValidAll(a)){var h=0;for(e=0;e<g.length>0;e++){var k=
g[e];this._uploadingFileCheck(k)&&h++}if(0<h)setTimeout(function(){d.DoPost(a,b)},700);else{g=$(a).find("input[ewa_tag=ht5takephoto]");if(0<g.length&&!this.uploadProcess&&!this.CheckValidAll(a))return!1;for(e=0;e<g.length>0;e++){k=g[e];h=!1;k=window["h5takephoto_"+this._Id+"$"+k.id];if("ok"!=k.UPLOAD_STATUS){if(!$X(k.H5_UPLOAD.WAIT_ID)){try{k.submitUpload()}catch(p){console.log("ht5takephotos - ht5.submitUpload: "+p);$Tip("\u60a8\u6ca1\u6709\u83b7\u53d6\u7167\u7247");return}k.H5_UPLOAD.createWaitBox();
this.uploadProcess=!0}h||(d=this,setTimeout(function(){d.DoPost(a,b)},700),h=!0);return}k.H5_UPLOAD.removeWaitBox()}if(this._stopPostError)return EWA.UI.Msg.ShowError(this._stopPostError,""),!1;e=this.CreateAjax(a);if(null==e)return!1;if(this._checkTriggerValids()){null==b&&(b=this.Url);if(""==b||null==b)b=window.location.href;this._Ajax=e;this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.LoadingType="image";this.DoPostStart&&
this.DoPostStart(this._Ajax);e=new EWA_UrlClass(b);for(var l in this._Ajax._Parameters)e.RemoveParameter(l);b=e.GetUrl();this.posting=!0;var m=this;if(this.triggerValids)for(var n in this.triggerValids)this.triggerValids[n]=null,this.getObj("#"+n).removeAttr("_trigger_valid").removeAttr("_trigger_valid_inc");this._Ajax.PostNew(b,function(){m._CallBack()});this.isShowPostWaitting||this._Ajax.HiddenWaitting();this.getObj("input[type=submit]").attr("disabled","disabled");return!0}setTimeout(function(){d.DoPost(a,
b,c)},500)}}};this._CallBack=function(){var a=this._Ajax;if(a.IsRunEnd())if(this.getObj("input[type=submit]").attr("disabled",null),this.posting=!1,this.DoPostEnd&&this.DoPostEnd(a,a._Http.status,a._Http.responseText,a._Http.statusText),200==a._Http.status){if(a=a._Http.responseText,EWA.F.CheckCallBack(a)){this.ValidCodeError(!0);var b=null;this.doPostAfter?b=this.doPostAfter:this.ReloadAfter&&(console.warn("\u8bf7\u7528\uff1adoPostAfter"),b=this.ReloadAfter);try{b&&b(a)||eval(a)}catch(c){console.log(a),
console.error(c),alert(a)}}}else alert("ERROR:\r\n"+a._Http.statusText)};this.Reload=function(){};this.Reload1=function(){console.log("Reload1 \u8fd9\u4e2a\u5e72\u561b\u7528\uff1f\u8c01\u5728\u8c03\u7528\uff1f")};this.ReloadFrame=function(a){var b=$("#f_"+this._Id);if(0!=b.length){var c=new EWA_UrlClass(this.Url),d=null,e=this._last_reload_frame_id;e?d=$("#"+this._last_reload_frame_id):(e=EWA_Utils.tempId("ewa_frame_relaod"),d=b.parentsUntil("#EWA_FRAME_MAIN").last().parent(),"EWA_FRAME_MAIN"!=d[0].id&&
(d=$("<div class='ewa-reload-frame'></div>"),d.insertBefore(b),d.append(b)),this._last_reload_frame_id=e,d.attr("id",e));c=new EWA_UrlClass(this.Url);c.AddParameter("ewa_ajax","install");b=c.GetUrl();$Install(b,e,function(){a&&a(d,this)})}};this.CheckValidAll=function(a){var b=!0,c=null,d;for(d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],"Name","Name");e=this.GetObject(e,a);null!=e&&((b&=this.CheckValid(e))||null!=c||(c=e))}null!=c&&c.focus();return b};this.H5Type=
function(){for(var a in this.ItemList.Items){var b=this.ItemList.Items[a],c=this.ItemList.GetItemValue(b,"Name","Name");c=this.getObj('[id="'+c+'"]');if(0!=c.length){var d=this.ItemList.GetItemValue(b,"Tag","Tag"),e=this.ItemList.GetItemValue(b,"DataItem","Valid");this.ItemList.GetItemValue(b,"DataItem","Format");b=this.ItemList.GetItemValue(b,"IsMustInput","IsMustInput");"Email"==e&&c.attr("type","email");"valid"==d&&c.attr("type","tel");1==b&&c.attr("required","required")}}};this.GetObject=function(a,
b){b||(b=$("FORM#f_"+this._Id));a=$(b).find('[id="'+a+'"]');return 0<a.length?a[0]:null};this.CheckValid=function(a,b){if("SPAN"==a.tagName||"IMG"==a.tagName)return!0;if(a&&b&&"DIV"==a.tagName&&"REPT"==a.getAttribute("tag")){b=b.target.tagName;if("LABEL"==b||"INPUT"==b){var c=this;setTimeout(function(){c._GetObjectValue(a);c.ItemList.CheckValid(a,d)},10)}return!0}var d=this._GetObjectValue(a);return this.ItemList.CheckValid(a,d)};this._GetObjectValue=function(a){return this.ItemList.GetObjectValue(a)};
this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}var __EWA_ALTER_MSG=null;
...
this.Merge=function(a,b,c,d,e){var g=$("#EWA_LF_"+this._Id);null==c?c="":-1==c.indexOf("<")&&(c="<span class='ewa-merge-str ewa-mearge-str'>"+c+"</span>");g.find("tr[ewa_key],tr.ewa-lf-sub-tr").each(function(){var h=$(this).find('[id="'+b+'"]').parentsUntil("tr").last();if("yes"!=h.attr("ewa-merged")){h.attr("ewa-merged","yes");var k=$(this).find('[id="'+a+'"]');k.parentsUntil("tr").last().hide().addClass("ewa-row-merge-hide");h.append(c);h.append(k);d&&d(h,this)}});e&&(e="<span class='ewa-lf-merge-header-split'></span>"+
g.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(),g.find('tr[ewa_tag="HEADER"] [id="'+b+'"]').append(e));g.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').parent().hide();g.find("td#ADD_ROW_"+a).hide()};this.Mearge=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 Merge");this.Merge(a,b,c)};this.MergeExp=function(a,b,c,d,e){if(b){var g=$("#EWA_LF_"+this._Id),h=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),k=[],l=b,m={};b=[];for(var n=0;n<h.length;n++){var p=h[n];k.push(p);var r=p.replace("@@",
"");l=l.replace(p,"<span class='ewa-lf-merge ewa-lf-merge-"+r+" ewa-lf-mearge ewa-lf-mearge-"+r+"' mid=\""+r+'"></span>');r!=a&&(g.find('tr[ewa_tag="HEADER"] [id="'+r+'"]').parent().hide(),g.find("td#ADD_ROW_"+r).hide());p=g.find('tr[ewa_tag="HEADER"] [id="'+r+'"]').html();m[r]=p;b.push(p)}e&&(e=b.join("<span class='ewa-lf-merge-header-split'></span>"),g.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(e));g.find("tr[ewa_key],tr.ewa-lf-sub-tr").each(function(){if(0==$(this).find('[id="'+a+'"]').length)console.log("not find "+
a);else{var q=$(this).hasClass("ewa-lf-sub-tr")?$(this).find('[id="ADD_ROW_'+a+'"]'):$(this).find(".ewa-col-"+a);if("yes"!=q.attr("ewa-merged")){var t=$('<div style="display:none"></div>');t.html(l);for(var v in k){var u=k[v].replace("@@",""),x=$(this).find('[id="'+u+'"]');if(0!=x.length){u!=a&&x.parent().hide().addClass("ewa-row-merge-hide");var w=t.find('span[mid="'+u+'"]');c&&(w.append("<span class='ewa-lf-mearge-memo'></span>"),w.find(".ewa-lf-mearge-memo").html(m[u]));w.append(x)}}for(;0<t[0].childNodes.length;)q.append(t[0].childNodes[0]);
$(t).remove();d&&d(q,this);q.attr("ewa-merged","yes")}}})}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MeargeExp=function(a,b,c,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 MereExp");this.MergeExp(a,b,c,d)};this.SubBottoms=function(a){this.SubBottomsArray=a.split(",");this._SubBottoms()};this.reCalcBottoms=function(){this._SubBottoms()};this._SubBottoms=function(){var a=$("#EWA_LF_"+this._Id).find(".ewa-lf-sub-tr");0==a.length?(a=$(this.AddRow([])),a.addClass("ewa-lf-sub-tr"),
a.find("td").addClass("ewa-lf-sub-td")):a.find("td").text("");var b={},c;for(c in this.SubBottomsArray){b={total:void 0,fm_length:void 0};var d=this.SubBottomsArray[c];b.total=0;var e="#EWA_LF_"+this._Id+' .ewa-lf-data-row [name="'+d+'"]';b.fm_length=0;$(e).each(function(g){return function(){var h=this.hasAttribute("value")?this.value:this.hasAttribute("title")?this.title:this.innerText;null!=h&&0!==h.length&&(h=h.replace(/,/ig,""),isNaN(h)||(g.total+=1*h,0<h.indexOf(".")&&(g.fm_length=2)))}}(b));
b="<span id='"+d+"' name='"+d+"' class='ewa-lf-sub'>"+b.total.fm(b.fm_length)+"</span>";a.find("td[id=ADD_ROW_"+d+"]").html(b)}};this.ChangeRowStyle=function(a,b,c){for(var d=$X("EWA_LF_"+this._Id),e=1;e<d.rows.length;e++){var g=d.rows[e];if(!(0==g.cells.length||g.cells.length<=a)){var h=g.cells[a].childNodes[0].getAttribute(b);if(null!=h&&c[h])for(var k=0;k<g.cells.length;k++)g.cells[k].style.cssText=g.cells[k].style.cssText+";"+c[h]}}if(null==this.ReloadAfter){var l=this;this.ReloadAfter=function(){l.ChangeRowStyle(a,
b,c)}}};this.MDownEvent=function(a,b){};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.Workflow=function(a,b,c,d,e,g){EWA.F.CID=this._Id;this._Ajax=this.CreateAjax();this._Ajax.AddParameter("EWA_AJAX","WORKFLOW");this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_WF_NAME",b);null!=c?(a=this.GetRowKey(c),this._Ajax.AddParameter("EWA_ACTION_KEY",a),"true"==c.getAttribute("ewa_wf_control")?this._Ajax.AddParameter("EWA_WF_CTRL",1):this._Ajax.AddParameter("EWA_WF_CTRL",
0)):this._Ajax.AddParameter("EWA_WF_CTRL",1);null!=d&&this._Ajax.AddParameter("EWA_ACTION_KEY",d);e&&this._Ajax.AddParameter("EWA_WF_UOK",e);g&&this._Ajax.AddParameter("EWA_WF_UMSG",g);var h=this;this._Ajax.PostNew(this.Url,function(){h._CallBackJs()})};this.GetRowKey=function(a){a=this.GetRow(a);return null!=a?a.getAttribute("EWA_KEY"):null};this.GetRow=function(a){if(null==a||null==a.tagName||""==a.tagName)return null;var b=0;for(a=a.parentNode;"TR"!=a.tagName||null==a.getAttribute("EWA_KEY");){a=
a.parentNode;if("BODY"==a.tagName){a=null;break}b++;if(100<b){alert("\u5faa\u73af100\u6b21\uff0c\u672a\u53d1\u73b0TR");break}}return a};this.RecordModify=function(a,b,c){var d=this.SelectChecked();if(0==d.length)EWA.UI.Msg.Alter("\u8bf7\u5148\u9009\u62e9","\u4fee\u6539");else{var e="EWA_MTYPE=M";null!=c&&0<c.trim().length&&(e+="&"+c);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,e+d)}};this.RecordNew=function(a,b,c){var d="EWA_MTYPE=N";null!=c&&0<c.trim().length&&(d+="&"+c);EWA.UI.Dialog.OpenReloadClose(this._Id,

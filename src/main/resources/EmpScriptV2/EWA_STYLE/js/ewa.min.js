...
this._Id+" input[type=submit]").attr("disabled","disabled");return!0}setTimeout(function(){e.DoPost(a,b,d)},500)}}};this._CallBack=function(){var a=this._Ajax;if(a.IsRunEnd())if($("#EWA_FRAME_"+this._Id+" input[type=submit]").attr("disabled",null),this.posting=!1,this.DoPostEnd&&this.DoPostEnd(a,a._Http.status,a._Http.responseText,a._Http.statusText),200==a._Http.status){if(a=a._Http.responseText,EWA.F.CheckCallBack(a)){this.ValidCodeError(!0);try{this.doPostAfter?this.doPostAfter(a):this.ReloadAfter&&
(console.log("\u8bf7\u7528\uff1adoPostAfter"),this.ReloadAfter(a)),eval(a)}catch(b){console.log(a),console.error(b),alert(a)}}}else alert("ERROR:\r\n"+a._Http.statusText)};this.Reload=function(){};this.Reload1=function(){console.log("Reload1 \u8fd9\u4e2a\u5e72\u561b\u7528\uff1f\u8c01\u5728\u8c03\u7528\uff1f")};this.ReloadFrame=function(a){var b=$("#f_"+this._Id);if(0!=b.length){var d=new EWA_UrlClass(this.Url),e=null,g=this._last_reload_frame_id;g?e=$("#"+this._last_reload_frame_id):(g=EWA_Utils.tempId("ewa_frame_relaod"),
e=b.parentsUntil("#EWA_FRAME_MAIN").last().parent(),"EWA_FRAME_MAIN"!=e[0].id&&(e=$("<div class='ewa-reload-frame'></div>"),e.insertBefore(b),e.append(b)),this._last_reload_frame_id=g,e.attr("id",g));d=new EWA_UrlClass(this.Url);d.AddParameter("ewa_ajax","install");b=d.GetUrl();$Install(b,g,function(){a&&a(e,this)})}};this.CheckValidAll=function(a){var b=!0,d=null,e;for(e in this.ItemList.Items){var g=this.ItemList.GetItemValue(this.ItemList.Items[e],"Name","Name");g=this.GetObject(g,a);null!=g&&

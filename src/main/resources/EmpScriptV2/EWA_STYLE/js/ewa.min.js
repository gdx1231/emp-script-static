...
null==h&&(h="");var k=a.getAttribute("action_js"),l=this.ItemList.GetValue(d,"DataItem","DataType");d=[{Name:"EWA_FIELD_ID",Value:d},{Name:"EWA_FIELD_VAL",Value:e},{Name:"EWA_ACTION_RELOAD",Value:"0"},{Name:d,Value:e},{Name:"EWA_DATA_TYPE",Value:l},{Name:"EWA_FIELD_VAL_OLD",Value:a.getAttribute("old")}];this.EditEvent={FROM:a,OLD_VAL:a.getAttribute("old"),NEW_VAL:a.value};this.DoAction(a,b,g,h,d,k)}else a.focus()};this.RewriteInfo=function(a,b,d,e){var g=$("#EWA_LF_"+this._Id);a&&(this._INFO={},this._INFO.INFO=
a,this._INFO.ID_NAME=b||"id",this._INFO.INFO_NAME=d||"info",this._INFO.MEMO_NAME=e||"memo");if(this._INFO.INFO)for(a=0;a<this._INFO.INFO.length;a++){var h=this._INFO.INFO[a];d=g.find('[id="'+h[this._INFO.ID_NAME]+'"]:eq(0)');if(0!==d.length)if(b=d.parentsUntil("tr").last(),e=h[this._INFO.INFO_NAME],h=h[this._INFO.MEMO_NAME],null==e||""==e.trim())for(d=b.parent()[0],e=0;e<d.cells.length;e++){if(d.cells[e]==b[0]){this.ShowHiddenColumn(e,!1);break}}else 0==d.children().length?d.text(e):d.children()[0].innerText=
e,h&&d.attr("title",h)}};this.ShowHiddenColumn=function(a,b){var d=$X("EWA_LF_"+this._Id),e="";if(null==b||0==b||"none"==b)e="none";for(b=0;b<d.rows.length;b++)d.rows[b].cells.length==d.rows[0].cells.length&&(d.rows[b].cells[a].style.display=e)};this.ShowHiddenColumns=function(a,b){var d=$X("EWA_LF_"+this._Id),e="";if(null==b||0==b||"none"==b)e="none";b=d.rows[0].cells.length;for(var g=0;g<d.rows.length;g++){var h=d.rows[g];if(h.cells.length==b)for(var k=0;k<a.length;k++)h.cells[a[k]].style.display=

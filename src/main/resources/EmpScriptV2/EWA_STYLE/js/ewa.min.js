...
function _$J_SELECT(a,b,d,e,g,h,k,l){function m(v,x){if(!x)return"not defined textName";if(x instanceof Function)return x[v];if(-1==x.indexOf("@@"))return v[x];for(var y=x.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),z=0;z<y.length;z++){var A=y[z],B=A.replace("@@","");x=x.replace(A,v[B]||"")}return x}function n(v,x){var y=m(v,d),z=b.options[b.options.length]=new Option(y,v[e]);if(x){for(var A=[],B=0;B<x;B++)A.push("");A.push(y);A.join("\u3000")}for(var D in v)v[D]&&z.setAttribute("para_"+D.toLowerCase(),v[D]);
z.setAttribute("json",JSON.stringify(v));return z}b.options.length=0;g&&(b.options[0]=new Option("",""),g instanceof Array&&(b.options[0].text=g[0],b.options[0].value=g[1]));if(l){var p=function(v,x){if((v=q[v])&&v._children&&0!=v._children.length)for(var y,z=0;z<v._children.length;z++)y=v._children[z],n(y,x),p(y[e],x+1)},q={___ROOT___:[]};g={___ROOT___:{}};for(var r,t,u,w=0;w<a.length;w++){u=a[w];r=u[l];t=u[e];if(null===r||""===r||"0"===r)r="___ROOT___";q[r]||(q[r]=[]);q[r].push(u);g[t]=u;g[r]&&
(g[r]._children||(g[r]._children=[]),g[r]._children.push(u))}p("___ROOT___",0)}else for(w=0;w<a.length;w++)u=a[w],n(u);h&&(b.value=h);$(b).trigger("change");k&&k(b)}$Install=function(a,b,d,e){a.GetUrl?a=a.GetUrl():a.getUrl?a=a.getUrl():a.href&&(a=a.href);var g=new EWA_UrlClass;g.SetUrl(a);g.GetParameter("EWA_AJAX")||g.AddParameter("EWA_AJAX","INSTALL");(new EWA_AjaxClass).Install(g.GetUrl(),"",b,d,e)};
...
g+=h;var q=[];if("number"===typeof n.length&&!n.propertyIsEnumerable("length")){var r=n.length;for(m=0;m<r;m+=1)q[m]=d(m,n)||"null";var t=0===q.length?"[]":g?"[\n"+g+q.join(",\n"+g)+"\n"+p+"]":"["+q.join(",")+"]";g=p;return t}if("object"===typeof l)for(r=l.length,m=0;m<r;m+=1){var u=l[m];"string"===typeof u&&(t=d(u,n,l))&&q.push(b(u)+(g?": ":":")+t)}else for(u in n)(t=d(u,n,l))&&q.push(b(u)+(g?": ":":")+t);t=0===q.length?"{}":g?"{\n"+g+q.join(",\n"+g)+"\n"+p+"}":"{"+q.join(",")+"}";g=p;return t}}
...
"number"===typeof n.length)l=n;else throw Error("JSON.stringify");else l=function(r,t){if(Object.hasOwnProperty.call(this,r))return t};return d("",{"":m})},parse:function(m,n){function p(q,r){var t,u=q[r];if(u&&"object"===typeof u)for(t in u)if(Object.hasOwnProperty.call(u,t)){var w=p(u,t);void 0!==w?u[t]=w:delete u[t]}return n.call(q,r,u)}if(/^[\],:{}\s]*$/.test(m.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,
...
a.childNodes.length;b+=1)EWA$UI$COMMON.Dispose(a.childNodes[b])}},Drop:function(a){EWA$UI$COMMON.Dispose(a);a.parentNode.removeChild(a)},AniExpand:function(a,b,d,e,g){if(null==e||0>=e)e=10;var h=0,k=b/(1*e),l=d/(1*e),m=a.clientWidth+b,n=a.clientHeight+d,p=window.setInterval(function(){var q=EWA$UI$COMMON.GetObjSize(a);if(h<e-1){var r=q.H+l,t=q.W+k;r>n&&(r=n);t>m&&(t=m);EWA$UI$COMMON.SetSize(a,t,r)}else EWA$UI$COMMON.SetSize(a,m,n);t=EWA$UI$COMMON.GetObjSize(a);r=t.W-q.W;t=t.H-q.H;q=EWA$UI$COMMON.GetPosition(a);
q.Y=q.Y-a.clientHeight-1*a.style.borderTopWidth.replace("px","")-1*a.style.borderBottomWidth.replace("px","");"LEFT_TOP"!=g&&("LEFT_BOTTOM"==g?(t=q.Y-t,r=q.X,EWA$UI$COMMON.MoveTo(a,r,t)):"RIGHT_TOP"==g?(t=q.Y,r=q.X-r,EWA$UI$COMMON.MoveTo(a,r,t)):"RIGHT_BOTTOM"==g?(t=q.Y-t,r=q.X-r,EWA$UI$COMMON.MoveTo(a,r,t)):(t=1*q.Y-t/2,r=1*q.X-r/2,EWA$UI$COMMON.MoveTo(a,r,t),EWA._TmpAniObj=a));h++;h>=e&&(window.clearInterval(p),EWA.UI.Utils.AniExpandCompleateFunction&&(EWA.UI.Utils.AniExpandCompleateFunction(),
...
$X(b).innerHTML="";$X(b).className="ewa-metro-menu";$X(b).appendChild(m);$($X(b)).append('<div class="pop_title" style="display: none;"><div>-</div><p></p></div>');$($X(b)).css("background","transparent").css("border",0);m.align="center";var n=0,p=[];for(k=0;k<g;k++){var q=b+"_htr_"+k;l=m.insertRow(-1);l.id=q;var r=l.insertCell(-1);r.colSpan=e;l.style.display="none";r.id=q+"a";r=m.insertRow(-1);for(var t=0;t<e;t++){l=a[n];n++;var u=this.add_menu_item(r,l,h,n,d,q);l&&(u.id="M_"+l.id);u&&l&&(null==
...
EWA.UI.Ext.IdCard2=function(a){var b=[1,31,28,31,30,31,30,31,31,30,31,30,31],d=$(a).attr("sfz_id");d=$($X(d)).show();var e=a.value,g=d.find("div");g.html("");for(var h=!0,k=[],l=[],m=[],n=[],p=0;p<e.length;p++){var q=e.substring(p,p+1),r="";6>p?k.push(q):6<=p&&10>p?l.push(q):10<=p&&12>p?m.push(q):12<=p&&14>p&&n.push(q);17>p?isNaN(q)&&(r="red",h=!1):"x"!=q&&"X"!=q&&isNaN(q)&&(r="red",h=!1);g[p]&&(g[p].innerHTML="<span style='font-size:16px;color:"+r+"'>"+q+"</span>")}k=l.join("");l=[];if(isNaN(k))h=
...
(function(){function a(){var l=$(".ewa-slider-puzzle-box"),m=$(".ewa-slider-puzzle-swiper"),n=$(".ewa-slider-puzzle-verify"),p=$(".ewa-slider-puzzle-text"),q=k?"touchmove":"mousemove",r=k?"touchend":"mouseup";m.bind(k?"touchstart":"mousedown",function(t){t.stopPropagation();n.css({display:"block"});var u=(k?t.touches[0]:t).clientX-$(this).offset().left;$(this).offset();p.css("opacity","0");l.unbind(q);l.unbind(r);console.log(l[0]);l.bind(q,function(w){var v=k?w.touches[0]:w,x=$(".ewa-slider-puzzle-handle");
w=$(".ewa-slider-puzzle-swiper");var y=$(".ewa-slider-puzzle-verify");v=v.clientX-u-$(x).offset().left;x=$(x).width()+29;0>v?v=0:v>x&&(v=x);w.css("left",v);y.css("left",v+10)});l.bind(r,function(w){l.unbind(q);l.unbind(r);w=new EWA_UrlClass(h.ewa_url);console.log(n.position());console.log(n.offset());w.AddParameter("left",n.position().left);w.AddParameter("top",n.position().top);w.AddParameter("left1",n.offset().left);w.AddParameter("top1",n.offset().top);w.AddParameter("ewa_trigger_valid_mode","check");
w.AddParameter("ewa_trigger_valid_name",h.ewa_trigger_valid_name);w.AddParameter("ewa_ajax",h.ewa_trigger_valid);$J(w.GetUrl(),function(v){console.log(v);v.RST?(l.addClass("ewa-slider-puzzle-successful"),e&&e(v)):(l.addClass("ewa-slider-puzzle-fail"),setTimeout(function(){l.removeClass("ewa-slider-puzzle-fail");m.css("left","0px");n.css("left","10px");p.css("opacity","1");g&&g(v);v.newConfig&&(v.newConfig.ewa_trigger_valid_name=h.ewa_trigger_valid_name,v.newConfig.ewa_trigger_valid=h.ewa_trigger_valid,
v.newConfig.ewa_url=h.ewa_url,h=v.newConfig,b(h))},500))})})})}function b(l){var m=$(".ewa-slider-puzzle-imgbox"),n=$(".ewa-slider-puzzle-imgbox img");m.css("width",l.imgBigWidth).css("height",l.imgBigHeight);n.length?n.attr("src",l.imgBig):m.prepend("<img src='"+l.imgBig+"' />");$(".ewa-slider-puzzle-verify").css("background-image","url('"+l.imgSmall+"')").css("top",l.imgTop).css("width",l.imgSmallWidth).css("height",l.imgSmallHeight)}var d=[];d.push('<div class="ewa-slider-puzzle-box">');d.push('<div class="ewa-slider-puzzle-imgbox">');
d.push('<div class="ewa-slider-puzzle-verify"></div>');d.push('<div class="ewa-slider-puzzle-refresh"></div>');d.push("</div>");d.push('<div class="ewa-slider-puzzle-handle">');d.push('<span class="ewa-slider-puzzle-swiper"></span>');d.push('<span class="ewa-slider-puzzle-text"></span>');d.push("</div>");d.push("</div>");var e,g,h,k=/iphone|android|ipad/ig.test(navigator.userAgent)||window.EWA_App;EWA.UI.SlidePuzzle=function(l,m,n,p){h=l;e=n;g=p;$(m||"body").append(d.join(""));m=$(".ewa-slider-puzzle-refresh");
$(".ewa-slider-puzzle-box").css("width",l.imgBigWidth);b(l);m.click(function(q){q.stopPropagation();q=new EWA_UrlClass(h.ewa_url);q.AddParameter("ewa_trigger_valid_mode","refresh");q.AddParameter("ewa_trigger_valid_name",h.ewa_trigger_valid_name);q.AddParameter("ewa_ajax",h.ewa_trigger_valid);q.AddParameter("ewa_trigger_valid_width",document.documentElement.clientWidth);$J(q,function(r){r.RST?(r.ewa_trigger_valid_name=h.ewa_trigger_valid_name,r.ewa_trigger_valid=h.ewa_trigger_valid,r.ewa_url=h.ewa_url,
h=r,b(h)):alert(r.ERR)})});a()}})();"undefined"==typeof EWA&&(EWA={});
...
this.convertFilterCheckbox=function(a,b,d,e,g,h){function k(v){var x=$("<nobr></nobr>");q.append(x);q.append(" ");var y=$(v).parent();v=$(v).attr("id")+"_"+r;y.attr("id",v);x.append(y.children());x.attr("ref_id",v)}function l(v){v=$(v).parent();var x=v.attr("ref_id");x&&($("#"+x).append(v.children()),v.remove())}var m={},n=this.getObj(".ewa-row-"+a),p=this.getObj(".ewa-row-"+b),q=$("<div class='ewa-filter-checked'></div>");n.find("#"+a).prepend(q).addClass("ewa-filter-chks");var r=this._Id;d||(d=
"PY");n.find("input[type=checkbox]").each(function(){var v=JSON.parse($(this).attr("json"))[d];v&&(v=v.toUpperCase().trim().substring(0,1),m[v]||(m[v]=[]),m[v].push(this.id),this.checked&&k(this),$(this).on("change",function(){this.checked?k(this):l(this)}))});a="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");b=["<a class='ewa-filter-char ewa-filter-char-all' code=''>ALL</a>"];for(var t in a){var u=a[t],w=m[u];w&&b.push("<a class='ewa-filter-char' code='"+u+"'>"+u+"<span class='ewa-filter-char-num'>("+w.length+
")</span></a>")}p.find(".EWA_TD_M").html(b.join(" "));e&&(n.find(".EWA_TD_L").hide(),n.find(".EWA_TD_M").attr("colspan",2));p.find("a.ewa-filter-char").on("click",function(){var v=$(this).attr("code");n.find("input[type=checkbox]").each(function(){v?this.checked?q.append($(this).parent()):($(this).parent().attr("ref_id")&&l(this),$(this).parent().hide()):$(this).parent().show()});if(v){for(var x=m[v],y=0;y<x.length;y++)n.find("#"+x[y]).parent().show();h&&h(this,n,p)}});g&&g(n,p)};this.createFilterCheckbox=
function(a,b,d,e,g,h,k){var l=this;$J(e,function(m){l.createFilterCheckboxByData(a,b,d,m,g,h,k)})};this.createFilterCheckboxByData=function(a,b,d,e,g,h,k){var l={},m=m?"[]":d.split(",");d={};for(var n in m)d[m[n]]=1;m=[];var p=[],q=a.id;for(n in e){var r=e[n],t=r[g];t&&(t=t.replace(/</ig,"&lt;"));var u=r[h];u&&(u=u.replace(/</ig,"&lt;"));var w=r[k],v=d[t],x=[];x.push("<nobr class='ewa-filter-chk' style='float:left;margin-right:4px'>");x.push('<input class="ewa-filter-chkbox" type="checkbox" ');v&&
x.push(" checked ");r=q+"_"+n;x.push(' value="'+t+'" id="'+r+'" name="'+q+'"><label ');x.push(' for="'+r+'">'+u+"</label></nobr>");v?p.push(x.join("")):m.push(x.join(""));b&&(t=w?w.substring(0,1).toUpperCase():"",l[t]||(l[t]=[]),l[t].push(r))}a.innerHTML=p.join(" ")+" "+m.join(" ");if(b){e=['<a href="javascript:void(0)">ALL</a>'];for(n="A".charCodeAt();n<="Z".charCodeAt();n++)g=String.fromCharCode(n),l[g]&&e.push('<a href="javascript:void(0)">'+g+"</a>");b.innerHTML=e.join(" ");$(b).find("a").each(function(){var y=
$(this).text();"ALL"!=y&&$(this).attr("ids",l[y].join(","));$(this).on("click",function(){if("ALL"==$(this).text())$(a).find("nobr.ewa-filter-chk").show();else{var z=$(this).attr("ids").split(","),A={},B;for(B in z)A[z[B]]=1;$(a).find("input.ewa-filter-chkbox").each(function(){this.checked||A[this.id]?$(this).parent().show():$(this).parent().hide()})}})})}};this.hiddenNoContentRow=function(){var a=$("#EWA_FRAME_"+this._Id);a.find(".EWA_TD_M").each(function(){if(""==$(this).text()&&0==$(this).find("img,a,input[type=text],input[type=button],textarea").length){$(this).parent().hide();
...
m.ITEM.LST;h.options.length=0;var p=[],q;for(q in n){var r=n[q];if(!r.V||!k[r.V]){var t=new Option(r.T,r.V);r.json&&$(t).attr("json",r.json);h.options[h.options.length]=t;p.push(t);r._used=!0}}for(q in n)r=n[q],r._used||(t=new Option(r.T,r.V),r.json&&$(t).attr("json",r.json),h.options[h.options.length]=t);if(b)h.value=b;else for(var u in p)if(p[u].value){h.value=p[u].value;break}if(d)try{d(m,h)}catch(w){console.log(w)}}else $Tip(m.ERR)})}};this._checkSelectOptionsChange=function(){if(this._SelectFilters){var a=
...
if(d=this.GetObject(d)){d=$(d);var e=this.GetItemDescription(b),g=e.Memo;e=e.Info;var h=null;1==a?(h=e,null!=g&&0<g.trim().length&&g!=h&&(h="smsValid"==d.attr("ewa_tag")?g:h+(", "+g)),d.hasClass("ewa-switch")&&d.prepend("<div class='ewa-switch-info'>"+h+"</div>")):2==a&&null!=g&&0<g.trim().length&&(h=g);h&&("hidden"==d[0].type?d.prev().attr("placeholder",h):"SELECT"==d[0].tagName?0<d[0].options.length&&""==d[0].options[0].value&&(d[0].options[0].text="-- "+h+" --",d[0].options[0].value=""):(d.attr("placeHolder",
h),d.attr("title",h)))}}};this.RedrawChangWidth=function(){var a=$("#EWA_FRAME_"+this._Id),b=a.width(),d=a.find(".ewa_msg_box")[0].colSpan/2;$("#EWA_FRAME_"+this._Id+">tbody>tr[class*='ewa-row-']:not('.ewa-row-msg-box')").each(function(){var g=$(this).find("td.ewa_redraw_info:visible").length,h=(b-90*g)/d;$(this).find("td.ewa_redraw_ctl:visible").each(function(){var k=this.colSpan||1;$(this).css("width",h*k)})});var e=this;addEvent(window,"size",function(){e.RedrawChangWidth()})};this.Mearge=function(a,
b,d){console.log("\u62fc\u5199\u9519\u8bef\uff1a\u8bf7\u7528 Merge");this.Merge(a,b,d)};this.Merge=function(a,b,d){if(a||b){var e=$("#EWA_FRAME_"+this._Id),g=e.find("#"+a),h=e.find("#"+b);if(0==g.length)console.log("Mearge:"+a+"\u4e0d\u5b58\u5728");else if(0==h.length)console.log("Mearge:"+b+"\u4e0d\u5b58\u5728");else{var k=!1,l=e.find(".ewa-row-"+b+" .EWA_TD_M"),m=null;0==l.length&&(k=!0,l=e.find(".ewa-row-"+b+" .EWA_TD_1"),m=e.find(".ewa-row-"+b+" .EWA_TD"),1==m.length&&(k=!0),b=m.html(),m.html("<table cellpadding=0 cellspacing=0 width=100%><tr><td style='width:50%'></td><td style='display:none'></td><td style='width:50%'></td></tr></table>"),
m.find("td:eq(0)").html(b));if(0==l.length)alert("target parent not exists");else{var n="border-box"==g.css("box-sizing")?0:1*g.css("padding-left").replace("px","")+1*g.css("padding-right").replace("px",""),p="border-box"==g.css("box-sizing")?0:1*h.css("padding-left").replace("px","")+1*h.css("padding-right").replace("px","");e.find(".ewa-row-"+a).hide();null==d&&(d=" - ");var q=l.width(),r=g[0].tagName,t=h[0].tagName;g.parent().hasClass("ewa-select-filter-target")&&(g=e.find(".ewa-row-"+a+" .EWA_TD_M table:eq(0)"),
r="SELECT_WITH_FILTER");var u=0;b=null;d&&(l.append('<span class="mearge-span">'+d+"</span>"),k&&m.find("table:eq(0) td:eq(1)").html('<span class="mearge-span">'+d+"</span>").show(),b=l.find(".mearge-span"),u=b.width()+1+1*b.css("padding-left").replace("px","")+1*b.css("padding-right").replace("px","")+1*b.css("margin-left").replace("px","")+1*b.css("margin-right").replace("px",""));r==t?(d=(q-u)/2-n-2,g.css("width",d),h.css("width",d),k&&m.find("table:eq(0) td:eq(2), table:eq(0) td:eq(0)").css("width",
d)):"SELECT"==r?(g.css("width",100),h.css("width",q-u-n-p-2-2-g.width())):"SELECT_WITH_FILTER"==r?(g.css("width",200),h.css("width",q-u-n-p-2-2-g.width())):"SELECT"==t&&(h.css("width",100),g.css("width",q-u-n-p-2-2-g.width()));h.css("float","left");b&&b.css("float","left");g.css("float","right");l.append(g);l.addClass("ewa-frame-merge");k&&(a=e.find(".ewa-row-"+a+" .EWA_TD").html(),m.find("table:eq(0) td:eq(2)").html(a))}}}};this.MergeExp=function(a,b,d,e){if(b){var g=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),
...
console.log(e);if("submit"==e)break;if("smsValid"==e){k=a.find(".ewa-row-"+g+" .ewa-sms-valid-code-button");e=k.attr("id");e||(e=EWA_Utils.tempId(),k.attr("id",e));var l=$("<a style='position:absolute;left:0;top:0;right:0;bottom:0'></a>");l.attr("ewa_trigger_valid",h);l.attr("ewa_trigger_valid_rid",g);l.attr("ewa_trigger_valid_click_id",e);k.parent().css("position","relative").append(l);k=l}(g=k.attr("onclick"))&&k.attr("_onclick",g);k.attr("onclick",b)}}};this.callTriggerValidBefore=function(a){return!0};
this.callTriggerValid=function(a){if(this.callTriggerValidBefore(a)){var b=$("#EWA_FRAME_"+this._Id),d=$(a).attr("id");d||(d=$(a).attr("ewa_trigger_valid_rid"));var e=this.getUrlClass(),g=$(a).attr("ewa_trigger_valid");e.AddParameter("ewa_ajax",g);e.AddParameter("ewa_trigger_valid_name",d);e.AddParameter("ewa_trigger_valid_mode","create");e.AddParameter("ewa_trigger_valid_width",document.documentElement.clientWidth);var h=this,k=EWA_Utils.tempId();$(a).attr("_trigger_valid_id",k);$J(e.GetUrl(),function(l){if(l.RST){var m=
$DialogHtml("<div id='"+k+"'></div>","enus"==EWA.LANG?"Silde puzzle":"\u62fc\u56fe\u9a8c\u8bc1",l.bigImgWidth+20,200,!1);l.ewa_trigger_valid_name=d;l.ewa_trigger_valid=g;l.ewa_url=e.GetUrl();EWA.UI.SlidePuzzle(l,$("#"+k),function(n){$(a).removeAttr("onclick");var p=!1;$(a).attr("_onclick")&&($(a).attr("onclick",$(a).attr("_onclick")),p=!0);setTimeout(function(){$(m.getMain()).animate({opacity:0},500)},500);setTimeout(function(){h.triggerValids[d]=n.VALID;var q=$(a).attr("ewa_trigger_valid_click_id");
q?($(a).remove(),b.find("#"+q).click()):p&&a.click();m.Close()},1E3)});setTimeout(function(){m.AutoSize()},100)}else alert(l.ERR)})}};this._InitMustInputs=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name");0<$(d).find('IsMustInput Set[IsMustInput="1"]').length&&(d="#"+e,a.find(".ewa-row-"+e).addClass("ewa-row-must"),e=a.find(d),e.addClass("ewa-row-item-must"),0<e.length&&e.attr("type")&&"hidden"==e.attr("type").toLowerCase()&&
e.prev().addClass("ewa-row-item-must"))}};this._InitEncyptions=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name");d=$(d).find("DispEnc Set");if(0!=d.length&&(e=a.find("#"+e),0!=e.length&&d.attr("EncType"))){if("INPUT"==e[0].tagName||"TEXTAREA"==e[0].tagName){if(!e.val())continue;e.prop("disabled",!0);e.attr("ewa_encyrption","yes")}var g=$("<div class='ewa-enc-cover' style='position:absolute;left:0;top:0;width:100%;height:100%;'><div></div></div>");
e.parent().append(g);e.parent().css("position","relative");if(d=d.attr("EncShowUrl")){g.find("div").html("\u70b9\u51fb\u67e5\u770b").css({position:"absolute",height:30,"line-height":"30px",top:"50%","margin-top":"-15px",right:10,"text-align":"right"});d=new EWA_UrlClass(d);g=new EWA_UrlClass(this.Url);for(var h in g._Paras)if(!d.GetParameter(h)){var k=g._Paras[h];null!=k&&(k=k.unURL());d.AddParameter(h,k)}d.AddParameter("EWA_ENCY_FROM_ID",e.attr("id"));d=d.GetUrl();e.parent().attr("enc_url",d).attr("fid",
...
!0}).on("compositionend",function(){d._droplist_[b.id]._is_composition=!1;EWA.F.I.DropList(this)}).removeAttr("oninput").removeAttr("onkeyup").on("input",function(){d._droplist_[b.id]._is_composition||EWA.F.I.DropList(this)})}};this._GetDropListValue=function(){var a=this.getObj();if(0!=a.length){a=a[0];var b=a.getElementsByTagName("input");this._droplist_={};for(var d=0;d<b.length;d++){var e=b[d];if("droplist"==e.getAttribute("ewa_class")){var g=e.nextSibling;"INPUT"==g.tagName.toUpperCase()&&"HIDDEN"==
g.type.toUpperCase()&&(this._GetDropListValue1(e,g),this._bindCompostion(e,g))}}a=a.getElementsByTagName("select");for(d=0;d<a.length;d++)if(e=a[d],b=e.getAttribute("_ListFilterType"))g=e.getAttribute("_ListFilterField"),this.initSelectFilter(e.id,b,g);this._SelectFilters&&this._checkSelectOptionsChange()}};this.refreshDropList=function(a,b){var d=this.getObj('input[id="'+a+'"]');if(0==d.length)console.warn("Can not found id="+a);else{var e=d.prev();0==e.length?console.warn("Can not found  id="+a+
" prev"):"droplist"==e.attr("ewa_class")?(d.val(b),this._GetDropListValue1(e[0],d[0])):console.warn("Not droplist id="+a+" prev")}};this._GetDropListValue1=function(a,b){if(""==b.value)b.setAttribute("setvalue",1);else{var d=b.getAttribute("DlsShow");if(null==d||""==d)b.setAttribute("canopen",0),a.value=obj1.value,b.setAttribute("canopen",1);else{var e=b.getAttribute("xmlName"),g=b.getAttribute("itemName"),h=b.getAttribute("paraName"),k=b.getAttribute("DlsAction"),l=b.value;var m=this.EWA_CGI?this.EWA_CGI:
window.EWA_CGI?window.EWA_CGI:EWA.CP+"/EWA_STYLE/cgi-bin/";var n=-1==m.indexOf("?")?"?":"&";m=(m+(n+"XMLNAME="+e+"&ITEMNAME="+g+"&EWA_AJAX=JSON")).replace("//","/");m=m.replace("//","/");m=m.replace("//","/");e={};e[h]=l;null!=k&&0<k.trim().length&&(e.EWA_ACTION=k,e[b.id]=b.value);$JP(m,e,function(p){if(0!=p.length){var q=p[0],r=[];p={};for(var t in q)r.push(q[t]),p["@"+t.toUpperCase()]=q[t],q[t]&&b.setAttribute("para_"+t.toLowerCase(),q[t]);if(null==d||""==d)p=r.join("/");else{t=d.match(/@[a-zA-Z0-9\-\._:]*\b/ig);
for(q=0;q<t.length;q++){r=t[q];var u=p[r.toUpperCase()];d=d.replace(r,u)}p=d}b.setAttribute("canopen",0);a.value=p;b.id=null==b.id||""==b.id?Math.random():b.id;"yes"==b.getAttribute("isdlseventload")&&(EWA.F.FOS[b.id]=new EWA_FrameItemClass,EWA.F.FOS[b.id].DropList(a),EWA.F.FOS[b.id].CallAfterEvent());b.setAttribute("canopen",1);b.setAttribute("setvalue",1)}})}}};this.DoPostEx=function(){EWA.F.F.CUR=this;if(this.CheckValidAll(document.forms[0])){this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";
this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");for(var a=document.getElementsByTagName("input"),b=0;b<a.length;b+=1){var d=a[b],e=""==d.name?d.id:d.name;null!=e&&""!=e&&this._Ajax.AddParameter(e,d.value)}a=document.getElementsByTagName("select");for(b=0;b<a.length;b+=1)d=a[b],e=""==d.name?d.id:d.name,null!=e&&""!=e&&this._Ajax.AddParameter(e,d.value);a=document.getElementsByTagName("textarea");for(b=0;b<a.length;b+=1)d=
a[b],e=""==d.name?d.id:d.name,null!=e&&""!=e&&this._Ajax.AddParameter(e,d.value);this._Ajax.PostNew(this.Url,EWA.F.F.CUR._CallBack)}};this.createAjax=this.CreateAjax=function(a,b){EWA.F.F.CUR=this;null==a&&(a=$("#f_"+this._Id)[0]);if(!b&&!this.CheckValidAll(a))return null;a=new EWA.C.Ajax;b=this.CreatePostData();for(var d in b)a.AddParameter(d,b[d]);return a};this.createPostData=this.CreatePostData=function(a){a=a||$("#f_"+this._Id)[0];var b={},d;for(d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],
"Name","Name"),g=this.GetObject(e,a);if(null!=g&&!$(g).attr("ewa_encyrption")){var h=g.getAttribute("ewa_tag");if("signature"==h){var k="N";var l=this.tablets[d];for(var m=0;m<l.lines.length;m++)if(l.lines[m]){k="Y";break}l="Y"==k?this._GetObjectValue(g):"";b[e+"_CHANGED"]=k}else l=this._GetObjectValue(g);null!=l&&(b[e]=l);"DIV"==g.tagName.toUpperCase()&&"1"==g.getAttribute("EWA_DHTML")&&(k=$X("UP_IMG_"+e).value,b[e+"_imgs_split"]=k);if("swffile"==h||"IMG_UPLOAD"==h)if(e=g.getAttribute("UP_PARAS"),
null!=e&&0<e.length)for(e=e.split(","),h=0;h<e.length;h++){var n=e[h];b[n]=g.getAttribute(n)}else b.UP_URL=g.value;else"markdown"==h&&(g=g.parentNode.getElementsByTagName("textarea"),1<g.length&&(b[g[1].id]=g[1].value))}}if(this.PostAddData)for(n in this.PostAddData)b[n]=this.PostAddData[n];if(this.triggerValids)for(var p in this.triggerValids)b[p+"_TRIGGER_VALID_RESULT"]=this.triggerValids[p];return b};this.DoPostBefore=function(){return!0};this.isDoPostBeforeTimer=function(){return null!=this._checkStatusFristResult};
...
a.UPLOAD_STATUS||"checking"==a.UPLOAD_STATUS)return!0;a.submitUploads();if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;$X(a.WAIT_ID)||a.createWaitBox();return this.uploadProcess=!0};this._checkTriggerValids=function(){if(!this.triggerValids)return!0;var a=$("#EWA_FRAME_"+this._Id);for(b in this.triggerValids)if(!this.triggerValids[b]){a=a.find("#"+b);if(0<a.length&&"submit"==a[0].type){var b=a.attr("_trigger_valid_inc")?1*a.attr("_trigger_valid_inc"):0;if(0==b)this.callTriggerValid(a);
else{var d=a.attr("_trigger_valid_id");if(0==$("#"+d).length)return this._cancelPostWait=!0,a.removeAttr("_trigger_valid_inc"),a.removeAttr("_trigger_valid_id"),!1}b++;a.attr("_trigger_valid_inc",b)}return!1}return!0};this.DoPost=function(a,b,d){if(this.posting)return!1;if(this._cancelPostWait)return console.log("\u53d6\u6d88\u63d0\u4ea4"),this._cancelPostWait=null,!1;var e=this;if(!d){var g=this.DoPostBefore();if(g instanceof Array){e=this;this._checkStatusInc=0;this._checkStatusFristResult=g;this._checkStatusTimer=
window.setInterval(function(){var p=0==e._checkStatusInc?e._checkStatusFristResult:e.DoPostBefore();e._checkStatusInc++;var q=p[0];if(null!==q&&void 0!==q){window.clearInterval(e._checkStatusTimer);e._checkStatusTimer=null;e._checkStatusInc=null;e._checkStatusFristResult=null;var r=p[1];p=p[2];q&&!p?e.DoPost(a,b,!0):q&&p?$Confirm(r,r,function(){e.DoPost(a,b,!0)},function(){}):r&&$Tip(r)}},232);return}if(!g)return}var h=$(a).find("input[ewa_tag=ht5upload]");if(!(0<h.length)||this.uploadProcess||this.CheckValidAll(a)){var k=
0;for(g=0;g<h.length>0;g++){var l=h[g];this._uploadingFileCheck(l)&&k++}if(0<k)setTimeout(function(){e.DoPost(a,b)},700);else{h=$(a).find("input[ewa_tag=ht5takephoto]");if(0<h.length&&!this.uploadProcess&&!this.CheckValidAll(a))return!1;for(g=0;g<h.length>0;g++){l=h[g];k=!1;l=window["h5takephoto_"+this._Id+"$"+l.id];if("ok"!=l.UPLOAD_STATUS){if(!$X(l.H5_UPLOAD.WAIT_ID)){try{l.submitUpload()}catch(p){console.log("ht5takephotos - ht5.submitUpload: "+p);$Tip("\u60a8\u6ca1\u6709\u83b7\u53d6\u7167\u7247");
return}l.H5_UPLOAD.createWaitBox();this.uploadProcess=!0}k||(e=this,setTimeout(function(){e.DoPost(a,b)},700),k=!0);return}l.H5_UPLOAD.removeWaitBox()}if(this._stopPostError)return EWA.UI.Msg.ShowError(this._stopPostError,""),!1;g=this.CreateAjax(a);if(null==g)return!1;if(this._checkTriggerValids()){null==b&&(b=this.Url);if(""==b||null==b)b=window.location.href;this._Ajax=g;this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");
this._Ajax.LoadingType="image";this.DoPostStart&&this.DoPostStart(this._Ajax);g=new EWA_UrlClass(b);for(var m in this._Ajax._Parameters)g.RemoveParameter(m);b=g.GetUrl();this.posting=!0;var n=this;this._Ajax.PostNew(b,function(){n._CallBack()});this.isShowPostWaitting||this._Ajax.HiddenWaitting();$("#EWA_FRAME_"+this._Id+" input[type=submit]").attr("disabled","disabled");return!0}setTimeout(function(){e.DoPost(a,b,d)},500)}}};this._CallBack=function(){var a=this._Ajax;if(a.IsRunEnd())if($("#EWA_FRAME_"+
this._Id+" input[type=submit]").attr("disabled",null),this.posting=!1,this.DoPostEnd&&this.DoPostEnd(a,a._Http.status,a._Http.responseText,a._Http.statusText),200==a._Http.status){if(a=a._Http.responseText,EWA.F.CheckCallBack(a)){this.ValidCodeError(!0);try{this.doPostAfter?this.doPostAfter(a):this.ReloadAfter&&(console.log("\u8bf7\u7528\uff1adoPostAfter"),this.ReloadAfter(a)),eval(a)}catch(b){console.log(a),console.error(b),alert(a)}}}else alert("ERROR:\r\n"+a._Http.statusText)};this.Reload=function(){};
this.Reload1=function(){console.log("Reload1 \u8fd9\u4e2a\u5e72\u561b\u7528\uff1f\u8c01\u5728\u8c03\u7528\uff1f")};this.ReloadFrame=function(a){var b=$("#EWA_FRAME_"+this._Id);if(0!=b.length){var d=b.parentsUntil("#EWA_FRAME_MAIN").last().parent();if(0!=d.length){b=EWA_Utils.tempId("ewa_frame_relaod");d.attr("id",b);var e=new EWA_UrlClass(this.Url);e.AddParameter("ewa_ajax","install");e=e.GetUrl();$Install(e,b,function(){a&&a(d,this)})}}};this.CheckValidAll=function(a){var b=!0,d=null,e;for(e in this.ItemList.Items){var g=
this.ItemList.GetItemValue(this.ItemList.Items[e],"Name","Name");g=this.GetObject(g,a);null!=g&&((b&=this.CheckValid(g))||null!=d||(d=g))}null!=d&&d.focus();return b};this.H5Type=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name");e=a.find('[id="'+e+'"]');if(0!=e.length){var g=this.ItemList.GetItemValue(d,"Tag","Tag"),h=this.ItemList.GetItemValue(d,"DataItem","Valid");this.ItemList.GetItemValue(d,"DataItem",
"Format");d=this.ItemList.GetItemValue(d,"IsMustInput","IsMustInput");"Email"==h&&e.attr("type","email");"valid"==g&&e.attr("type","tel");1==d&&e.attr("required","required")}}};this.GetObject=function(a,b){b||(b=$("FORM#f_"+this._Id));a=$(b).find('[id="'+a+'"]');return 0<a.length?a[0]:null};this.CheckValid=function(a,b){if("SPAN"==a.tagName||"IMG"==a.tagName)return!0;if(a&&b&&"DIV"==a.tagName&&"REPT"==a.getAttribute("tag")){b=b.target.tagName;if("LABEL"==b||"INPUT"==b){var d=this;setTimeout(function(){d._GetObjectValue(a);
d.ItemList.CheckValid(a,e)},10)}return!0}var e=this._GetObjectValue(a);return this.ItemList.CheckValid(a,e)};this._GetObjectValue=function(a){return this.ItemList.GetObjectValue(a)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}var __EWA_ALTER_MSG=null;
...
window[p].GetHtml();window.onmousedown=null;p=e.attr("oldv");q==p?($(e).attr("style",""),m.hide()):(p={key:$(a).attr("ref"),val:q},$JP(n.POST_URL||window.location.href,p,function(r){$(e).attr("style","");m.hide();r.RST?(""==q&&(q="............."),b.html(q),$TipTL("\u4fdd\u5b58\u5b8c\u6bd5"),b.append('<i style="margin-left:5px" class="fa fa-edit"></i>')):$Tip(r.ERR)}))}}};this.checkInHtmlEditor=function(a){a=$(event.target).parents();for(var b=0;b<a.length;b++){var d=$(a[b]);if(d.hasClass("ewa-editor")||
...
a).cells[0]).text();var l=this.createRefCaption(a,h,e,g);d.focus();if(!d.attr("evtblur")){d.attr("evtblur","is_setted");var m=this;addEvent(d[0],"keydown",function(n){n=n.keyCode;13==n&&"TEXTAREA"!=d[0].tagName?this.blur():27==n&&(this.value=$(this).attr("oldv"),this.blur())});addEvent(d[0],"blur",function(){var n=$(this.parentNode.parentNode.cells[0]),p=n.css("background-color"),q=$(this).attr("onmousedown");if(q){var r=q.indexOf(".CheckValid");q=q.substring(0,r);if(eval(q).CheckValid(this))$(this).css("background",
"");else{this.focus();$(this).css("background","pink");return}}q=this.id;r=this.value;"droplist"==$(this).attr("ewa_class")&&(r=$(this).next().val(),q=$(this).next().attr("id"));q={key:q,val:r};if("rgb(255, 255, 224)"==p)$Tip(n.html()),l.hide(),this.focus();else if(this.value==$(this).attr("oldv"))$(this).attr("style",""),l.hide();else{var t=this;$JP(m.POST_URL||window.location.href,q,function(u){$(t).attr("style","");l.hide();u.RST?(u="SELECT"==t.tagName?t.options[t.selectedIndex].text:t.value,"TEXTAREA"==
t.tagName?""==u?b.html("............."):(u=u.replace(/</ig,"&lt;").replace(/>/ig,"&gt;"),u="<div>"+u.split("\n").join("</div><div>")+"</div>",b.html(u)):(""==u&&(u="............."),b.text(u)),b.append('<i style="margin-left:5px" class="fa fa-edit"></i>'),$TipTL("\u4fdd\u5b58\u5b8c\u6bd5")):$Tip(u.ERR)})}})}}}
...
a+'"]').html(),h.find('tr[ewa_tag="HEADER"] [id="'+b+'"]').append(g));h.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').parent().hide();h.find("td#ADD_ROW_"+a).hide()};this.Mearge=function(a,b,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 Merge");this.Merge(a,b,d)};this.MergeExp=function(a,b,d,e,g){if(b){var h=$("#EWA_LF_"+this._Id),k=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),l=[],m=b,n={};b=[];for(var p=0;p<k.length;p++){var q=k[p];l.push(q);var r=q.replace("@@","");m=m.replace(q,"<span class='ewa-lf-merge ewa-lf-merge-"+
r+" ewa-lf-mearge ewa-lf-mearge-"+r+"' mid=\""+r+'"></span>');r!=a&&(h.find('tr[ewa_tag="HEADER"] [id="'+r+'"]').parent().hide(),h.find("td#ADD_ROW_"+r).hide());q=h.find('tr[ewa_tag="HEADER"] [id="'+r+'"]').html();n[r]=q;b.push(q)}g&&(g=b.join("<span class='ewa-lf-merge-header-split'></span>"),h.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(g));h.find("tr[ewa_key],tr.ewa-lf-sub-tr").each(function(){if(0==$(this).find('[id="'+a+'"]').length)console.log("not find "+a);else{var t=$(this).hasClass("ewa-lf-sub-tr")?
$(this).find('[id="ADD_ROW_'+a+'"]'):$(this).find(".ewa-col-"+a);if("yes"!=t.attr("ewa-merged")){var u=$('<div style="display:none"></div>');u.html(m);for(var w in l){var v=l[w].replace("@@",""),x=$(this).find('[id="'+v+'"]');if(0!=x.length){v!=a&&x.parent().hide();var y=u.find('span[mid="'+v+'"]');d&&(y.append("<span class='ewa-lf-mearge-memo'></span>"),y.find(".ewa-lf-mearge-memo").html(n[v]));y.append(x)}}for(;0<u[0].childNodes.length;)t.append(u[0].childNodes[0]);$(u).remove();e&&e(t,this);t.attr("ewa-merged",
...
a.find("td").text("");var b={},d;for(d in this.SubBottomsArray){var e=this.SubBottomsArray[d];b.$jscomp$loop$prop$total$37=0;var g="#EWA_LF_"+this._Id+' .ewa-lf-data-row [name="'+e+'"]';b.$jscomp$loop$prop$fm_length$38=0;$(g).each(function(h){return function(){var k=this.hasAttribute("value")?this.value:this.hasAttribute("title")?this.title:this.innerText;null!=k&&0!==k.length&&(k=k.replace(/,/ig,""),isNaN(k)||(h.$jscomp$loop$prop$total$37+=1*k,0<k.indexOf(".")&&(h.$jscomp$loop$prop$fm_length$38=
2)))}}(b));g="<span id='"+e+"' name='"+e+"' class='ewa-lf-sub'>"+b.$jscomp$loop$prop$total$37.fm(b.$jscomp$loop$prop$fm_length$38)+"</span>";a.find("td[id=ADD_ROW_"+e+"]").html(g);b={$jscomp$loop$prop$total$37:b.$jscomp$loop$prop$total$37,$jscomp$loop$prop$fm_length$38:b.$jscomp$loop$prop$fm_length$38}}};this.ChangeRowStyle=function(a,b,d){for(var e=$X("EWA_LF_"+this._Id),g=1;g<e.rows.length;g++){var h=e.rows[g];if(!(0==h.cells.length||h.cells.length<=a)){var k=h.cells[a].childNodes[0].getAttribute(b);
if(null!=k&&d[k])for(var l=0;l<h.cells.length;l++)h.cells[l].style.cssText=h.cells[l].style.cssText+";"+d[k]}}if(null==this.ReloadAfter){var m=this;this.ReloadAfter=function(){m.ChangeRowStyle(a,b,d)}}};this.MDownEvent=function(a,b){};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.Workflow=function(a,b,d,e,g,h){EWA.F.CID=this._Id;this._Ajax=this.CreateAjax();this._Ajax.AddParameter("EWA_AJAX","WORKFLOW");this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_WF_NAME",
b);null!=d?(a=this.GetRowKey(d),this._Ajax.AddParameter("EWA_ACTION_KEY",a),"true"==d.getAttribute("ewa_wf_control")?this._Ajax.AddParameter("EWA_WF_CTRL",1):this._Ajax.AddParameter("EWA_WF_CTRL",0)):this._Ajax.AddParameter("EWA_WF_CTRL",1);null!=e&&this._Ajax.AddParameter("EWA_ACTION_KEY",e);g&&this._Ajax.AddParameter("EWA_WF_UOK",g);h&&this._Ajax.AddParameter("EWA_WF_UMSG",h);var k=this;this._Ajax.PostNew(this.Url,function(){k._CallBackJs()})};this.GetRowKey=function(a){a=this.GetRow(a);return null!=
a?a.getAttribute("EWA_KEY"):null};this.GetRow=function(a){if(null==a||null==a.tagName||""==a.tagName)return null;var b=0;for(a=a.parentNode;"TR"!=a.tagName||null==a.getAttribute("EWA_KEY");){a=a.parentNode;if("BODY"==a.tagName){a=null;break}b++;if(100<b){alert("\u5faa\u73af100\u6b21\uff0c\u672a\u53d1\u73b0TR");break}}return a};this.RecordModify=function(a,b,d){var e=this.SelectChecked();if(0==e.length)EWA.UI.Msg.Alter("\u8bf7\u5148\u9009\u62e9","\u4fee\u6539");else{var g="EWA_MTYPE=M";null!=d&&0<
d.trim().length&&(g+="&"+d);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,g+e)}};this.RecordNew=function(a,b,d){var e="EWA_MTYPE=N";null!=d&&0<d.trim().length&&(e+="&"+d);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,e)};this.SelectSingle=function(){this.IsTrSelect=!0;this._TrSelectMulti=!1};this.SelectMulti=function(){this._TrSelectMulti=this.IsTrSelect=!0};this.MOver=function(a,b){if(this.IsTrSelect&&this._CurTr!=a&&(null!=this._CurTr&&("1"!=this._CurTr.getAttribute("__ewa_lf_mdown")?this._MSetBg(this._CurTr,
...
0<=b.className.indexOf("ewa-mdown-stop")?!1:!0};this.mDownAutoCheck=function(a,b,d){for(var e,g=0;g<b.length&&!(0<=b[g].parentNode.className.indexOf("ewa-switch"));g++){if("RADIO"==b[g].type.toUpperCase())return e=b[g],e.click(),e;if("CHECKBOX"==b[g].type.toUpperCase()){e=b[g];e.click();if(!this._TrSelectMulti){var h=$(b[g]).attr("id")||$(b[g]).attr("name");0==$(d).find(b[g]).length&&$(a).siblings(".ewa-lf-data-row").find("input[name='"+h+"']:checked").prop("checked",!1);e.checked=!0}return e}}return null};
this.MDown=function(a,b){if(this.IsTrSelect){var d=(new Date).getTime(),e=$(a).attr("mdown_time_last");if(!(null!=e&&500>d-e)&&($(a).attr("mdown_time_last",d),b=null==b?window.event:b,this.MDownEnableCheck(a)&&this.checkMDownEnable(a,b))){e=b.srcElement?b.srcElement:b.target;var g=null;d=a.getElementsByTagName("input");this.IsNotMDownAutoChecked||(g=this.mDownAutoCheck(a,d,e));if("1"==a.getAttribute("__ewa_lf_mdown"))this._TrSelectMulti&&(g&&"CHECKBOX"==g.type.toUpperCase()&&(g.checked=!1),this._MSetBg(a,
""),a.removeAttribute("__ewa_lf_mdown"),$(a).removeClass("ewa-lf-mdown"));else{g&&(g.checked=!0);this._MSetBg(a,"down");a.setAttribute("__ewa_lf_mdown",1);$(a).addClass("ewa-lf-mdown");if(!this._TrSelectMulti&&(g=a.parentNode)&&g.rows)for(e=0;e<g.rows.length;e++){var h=g.rows[e];"1"==h.getAttribute("__ewa_lf_mdown")&&h!=a&&(h.removeAttribute("__ewa_lf_mdown"),$(h).removeClass("ewa-lf-mdown"),this._MSetBg(h,""))}if(this.IsReShow)for(e=0;e<d.length;e++)"BUTTON"==d[e].type.toUpperCase()&&(g=d[e],"true"==
g.getAttribute("disabled")||1==g.getAttribute("disabled")||"true"==g.parentNode.getAttribute("disabled")||1==g.parentNode.getAttribute("disabled")?(this._ReshowButs[g.value].disabled=!0,this._ReshowButs[g.value].style.display="none"):(this._ReshowButs[g.value].disabled=!1,this._ReshowButs[g.value].style.display=""))}if(this._IsAddPreRow){if(d=a.getAttribute("ewa_key"),this.AddPreRowCheck(a,d,b)){g=a.parentNode.rows[a.rowIndex+1];if(null==g||1!=g.getAttribute("add_pre_row"))g=a.parentNode.parentNode,
e=g.rows[0].cells.length,g=g.insertRow(a.rowIndex+1),g.setAttribute("add_pre_row",1),h=g.insertCell(-1),h.colSpan=e,h.className="ewa-lf-add-pre-cell",g.style.display="none",h.id=EWA_Utils.tempId("EWA_LF_NR_"+this._Id),$(g).addClass("ewa-lf-add-pre-row");this.prevTr&&(this.AddPreRowCloseBeforeEvent&&this.AddPreRowCloseBeforeEvent(this._Id,a,d,this.prevTr,b),this.prevTr.style.display="none",this.prevTr.cells[0].innerHTML="",this.AddPreRowCloseEvent&&this.AddPreRowCloseEvent(this._Id,a,d,this.prevTr,
...
this._ReShowSearchQuick=function(){var a=this,b=EWA_ListFrameClass.prototype.RESOURCES.search_text_items,d,e,g;for(g in b){var h=b[g];"eq"==h.Id&&(d=h);"lk"==h.Id&&(e=h)}for(g in this._SearchJson){var k=this._SearchJson[g];k.isSearchQuick&&(b=$("#EWA_LF_"+this.Id+' .ewa-lf-data-row [id="'+g+'"]'),b.bind("click",function(l){l.stopPropagation();l=$(this).attr("search_tag");var m=$(this).text(),n=m,p=$("#EWA_SEARCH_ITEM_"+a.Id+' .ewa-lf-search-item-ctl [name="'+this.id.toUpperCase()+'"]');if("number"==
l||"date"==l)p=p.parentsUntil(".ewa-lf-search-item").last().find("input");var q=p.parentsUntil(".ewa-lf-search-item").last().find("a");if("date"==l)m=m.split(" ")[0],n=m+" 23:59:59";else if("fix"==l){var r=null;p.find("option").each(function(){this.text==m&&(r=this.value)});m=null===r?"":r}p.val()==m?("text"==l&&e&&0<q.length&&(q.attr("tag",e.Id),q.html("enus"==EWA.LANG?e.TxtEn:e.Txt)),p.val("")):("text"==l&&d&&0<q.length&&(q.attr("tag",d.Id),q.html("enus"==EWA.LANG?d.TxtEn:d.Txt)),p.val(m),"date"==
l&&(p[1].value=n))}),b.each(function(){$(this).text()&&$(this).addClass("ewa-lf-search-text-click").attr("search_tag",k.T)}))}};this.ReShowWithNoButtons=function(){var a=$X("EWA_LF_"+this._Id),b=[],d;for(d in this.ItemList.Items){var e=this.ItemList.Items[d],g=this._GetSubValue("Tag","Tag",e);if(null!=g&&"button"==g.trim().toLowerCase())for(g=0;g<a.rows[0].cells.length;g++)if(a.rows[0].cells[g].childNodes[0].id.toUpperCase()==d){b.push(g);e.setAttribute("but_show","1");break}}this.ShowHiddenColumns(b,
...
function(a){this.IsReShow=!0;var b="_G_"+this._Id;this.NewDivId=b;a=[];a.push("<table class='ewa-lf-reshow' id='EWA_RESHOW_"+this._Id+"'>");a.push("<tr style='display:none'><td style='padding:0'></td></tr>");a.push("<tr><td class='ewa_lf_func' style='padding:0'>");a.push("<div style='display:none'></div>");a.push("<div><div style='cursor:pointer' class='ewa_lf_func_caption'></div></div>");a.push("</td></tr>");a.push("<tr><td style='width:100%;padding:0;vertical-align:top'>");a.push("<div id='"+b+
"' style=''></div>");a.push("</td></tr>");a.push("</table>");var d=$(a.join("")),e=!(0<this.Url.toUpperCase().indexOf("EWA_AJAX=INSTALL")||0<this.Url.toUpperCase().indexOf("EWA_CALL_METHOD=INNER_CALL")||0<this.Url.toUpperCase().indexOf(".JSP"));e?EWA.UI.Utils.SetStyle(d[0],"width:100%;height:100%;border-spacing:0"):EWA.UI.Utils.SetStyle(d[0],"width:100%;border-spacing:0");css="";var g=$X("EWA_LF_"+this._Id);a=g.parentNode.parentNode;var h=g.parentNode;d.find("td:eq(2)>div").append(h);h=d[0];var k=
d.find("tr:eq(0)")[0],l=d.find("td:eq(0)")[0],m=d.find("td:eq(1)")[0],n=d.find("td:eq(2)")[0];e&&(window.setTimeout(function(){$X("__EWA_DEBUG")&&n.childNodes[0].appendChild($X("__EWA_DEBUG"));var C=$X(b);C.getElementsByTagName("table");var E=EWA.UI.Utils.GetDocSize(window),F=C.parentNode.parentNode.previousSibling.offsetHeight;C.style.top=F+"px";C.style.height=E.H-F+"px"},100),addEvent(window,"resize",function(){var C=$X(b),E=EWA.UI.Utils.GetDocSize(window),F=C.parentNode.parentNode.previousSibling.offsetHeight;
C.style.top=F+"px";C.style.height=E.H-F+"px"}));for(;0<a.childNodes.length;)m.childNodes[0].appendChild(a.childNodes[0]);d=d.find(".ewa_lf_func_caption")[0];var p=!1;e=GetInnerText(m);e=e.trim();this._ReshowButs={};g=$(g.rows[0]);for(var q in this.ItemList.Items){var r=this.ItemList.Items[q],t=this._GetSubValue("Tag","Tag",r);if(t&&("button"==t.toLowerCase()||"butflow"==t.toLowerCase())&&(t=this._GetSubValue("Name","Name",r),0!==g.find(".ewa-col-"+t).length)){p=!0;var u=this._GetSubValue("DescriptionSet",
"Info",r),w=this._GetSubValue("DescriptionSet","Memo",r),v=this._GetSubValue("EventSet","EventName",r),x="";null!=v&&"ewa_click"==v.toLowerCase().trim()&&(x=this._GetSubValue("EventSet","EventValue",r));e=e.replace(u,"");r=this._ReShowButton(u,w,null);this._ReshowButs[u]=r;r.setAttribute("f_id",this._Id);r.setAttribute("t_id",t);m.childNodes[1].appendChild(r);""==x?r.setAttribute("onclick","EWA.F.FOS['"+this._Id+"'].reShowButtonClick(this)"):r.setAttribute("onclick",x)}}p&&this._ReShowSplit(m.childNodes[1]);
t=m.getElementsByTagName("input");p={};for(g=0;g<t.length;g++){var y=t[g];y.style.display="none";if(null==y.id||""==y.id)y.id=("_tmp_"+Math.random()).replace(".","_");if("button"==y.type){if(r=this._ReShowButton(y.value,y.title,y.id),u=y.nextSibling){var z="";3==u.nodeType&&(z=u.nodeValue.trimEx());"|"==z&&this._ReShowSplit(m.childNodes[1])}}else(u=y.nextSibling)&&(z=3==u.nodeType?u.nodeValue.replace("|",""):u.innerHTML),r=this._ReShowButton(z.trimEx(),y.title,y.id),r.id=("_tmp_"+Math.random()).replace(".",
"_"),p[y.name]||(p[y.name]=[]),p[y.name].push(r.id);m.childNodes[1].appendChild(r)}e=e.replace(/ /ig,"").replace(/\|/ig,"").trimEx();""!=e?0<=e.indexOf("if")?k.style.display="none":l.innerHTML=e.replace(/ /,""):k.style.display="none";a.appendChild(h);for(q in p)for(z=p[q],g=0;g<z.length;g++)y=$X(z[g]),y.setAttribute("_r_ids",z.join(",")),y.onclick=function(){var C=this.getAttribute("_ewa_event_id");$X(C).click();C=this.getAttribute("_r_ids").split(",");for(var E=0;E<C.length;E++)y.id!=C[E]&&($X(C[E]).style.fontWeight=
"",$X(C[E]).style.color="");this.style.fontWeight="bold";this.style.color="blue"};d.innerHTML='<b><i class="fa fa-star-o">&nbsp;</i>'+this.Description+"</b>";if(0<this.Url.toUpperCase().indexOf("EWA_BTNS_IN_TITLE"))var A=this,B=0,D=setInterval(function(){B++;1E3<B&&window.clearInterval(D);EWA.OW.Load();EWA.OW.Dia&&(window.clearInterval(D),A.ReShowButtonsInDailogTitle())},10)};this.reShowButtonClick=function(a){a=a.getAttribute("t_id");var b=this.SelectCheckedRows();if(null==b||0==b.length)EWA.UI.Msg.Alert(_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM"],
_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM_TITLE"]);else{b=b[0].getElementsByTagName("input");for(var d=0;d<b.length;d++){var e=b[d];if(e.name===a){e.click();break}}}};this._ReShowSplit=function(a){EWA.UI.Utils.CreateObject(window,"div","",a).className="ewa_lf_func_split"};this._ReShowButton=function(a,b,d){var e=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",document.body);e.innerHTML="<nobr>"+a+"</nobr>";null!=d&&(e.setAttribute("_ewa_event_id",d),e.onclick=function(){var g=this.getAttribute("_ewa_event_id");
$X(g).click()});EWA.B.IE&&(e.onselectstart=function(){return!1});e.className="ewa_lf_func_dact";e.title=b;return e};this.CheckValid=function(a){var b=a.tagName.toLowerCase();if("input"!=b&&"textarea"!=b&&"select"!=b||"button"==a.type||"submit"==a.type||"image"==a.type)return!0;b=this.ItemList.GetObjectValue(a);return this.ItemList.CheckValid(a,b)};this.ShowEdit=function(a){a.parentNode.style.width=a.clientWidth+"px";a.style.display="none";__show_obj__=a.nextSibling;__show_obj__.style.display="";var b=
__show_obj__.childNodes[0];3==b.nodeType&&(b=__show_obj__.childNodes[1]);b.setAttribute("old",b.value);"SELECT"!=b.tagName||b.getAttribute("func")||(b.setAttribute("func",1),b.onchange=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)});null==b.getAttribute("__ewa_fid__")&&(b.setAttribute("__ewa_fid__",this._Id),b.onblur=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)},b.onkeydown=function(d){d=null==d?window.event:d;var e=d.target?d.target:d.srcElement;
13==d.keyCode&&"INPUT"==e.tagName&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this);27==d.keyCode&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditReset(this)});setTimeout(function(){b.focus()},10)};this.EditReset=function(a){a.parentNode.style.display="none";var b=a.parentNode.previousSibling;b.style.display="";b.innerHTML=a.getAttribute("old");"select"==a.tagName.toLowerCase()?b.innerHTML=a.options[a.selectedIndex].text:a.value=a.getAttribute("old").replace(/</ig,"&lt;").replace(/>/ig,
"&gt;")};this.EditAfter=function(a){if(this.CheckValid(a))if(a.getAttribute("old")==a.value)this.EditReset(a);else{a.parentNode.style.display="none";var b=a.parentNode.previousSibling;b.style.display="";if("droplist"==a.getAttribute("ewa_class")){var d=$(a.parentNode.getElementsByTagName("input")[1]).attr("name");var e=a.parentNode.getElementsByTagName("input")[1].value;b.innerHTML=a.parentNode.getElementsByTagName("input")[0].value}else"select"==a.tagName.toLowerCase()?(d=$(a).attr("name"),b.innerHTML=
a.options[a.selectedIndex].text):(d=a.value.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/\n/ig,"<br>"),b.innerHTML=d,d=$(a).attr("name")),e=a.value;b=a.getAttribute("action_name");if(""==b||null==b)b="OnListFrameUpdateCell";var g=a.getAttribute("action_confirm");g=null==g?"":g;var h=a.getAttribute("action_tip");null==h&&(h="");var k=a.getAttribute("action_js"),l=this.ItemList.GetValue(d,"DataItem","DataType");d=[{Name:"EWA_FIELD_ID",Value:d},{Name:"EWA_FIELD_VAL",Value:e},{Name:"EWA_ACTION_RELOAD",
Value:"0"},{Name:d,Value:e},{Name:"EWA_DATA_TYPE",Value:l},{Name:"EWA_FIELD_VAL_OLD",Value:a.getAttribute("old")}];this.EditEvent={FROM:a,OLD_VAL:a.getAttribute("old"),NEW_VAL:a.value};this.DoAction(a,b,g,h,d,k)}else a.focus()};this.RewriteInfo=function(a,b,d,e,g){var h=$("#EWA_LF_"+this._Id),k=[];if(a)this._INFO={},this._INFO.INFO=a,this._INFO.ID_NAME=b||"id",this._INFO.INFO_NAME=d||"info",this._INFO.MEMO_NAME=e||"memo";else if(!this._INFO||!this._INFO.INFO)return;for(a=0;a<this._INFO.INFO.length;a++)if(b=
this._INFO.INFO[a],d=h.find('[id="'+b[this._INFO.ID_NAME]+'"]:eq(0)'),0!==d.length){e=d.parentsUntil("tr").last();var l=b[this._INFO.INFO_NAME],m=b[this._INFO.MEMO_NAME];if(null==l||""==l.trim())for(l=e.parent()[0],m=0;m<l.cells.length;m++){if(l.cells[m]==e[0]){this.ShowHiddenColumn(m,!1);break}}else 0==d.children().length?d.text(l):d.children()[0].innerText=l,m&&d.attr("title",m);k.push(d[0]);g&&g(d[0],b,a)}return k};this.ShowHiddenColumn=function(a,b){var d=$X("EWA_LF_"+this._Id),e="";if(null==
b||0==b||"none"==b)e="none";for(b=0;b<d.rows.length;b++)d.rows[b].cells.length==d.rows[0].cells.length&&(d.rows[b].cells[a].style.display=e)};this.ShowHiddenColumns=function(a,b){var d=$X("EWA_LF_"+this._Id),e="";if(null==b||0==b||"none"==b)e="none";b=d.rows[0].cells.length;for(var g=0;g<d.rows.length;g++){var h=d.rows[g];if(h.cells.length==b)for(var k=0;k<a.length;k++)h.cells[a[k]].style.display=e}};this.GroupShowHidden=function(a){var b=$(a).attr("t"),d=(new Date).getTime();if(!(b&&333>d-b)){$(a).attr("t",
d);b=a.parentNode.parentNode;d=b.getAttribute("ewa_group");""==d?(d="none",a.childNodes[0].innerHTML=" + "):(d="",a.childNodes[0].innerHTML=" - ");b.setAttribute("ewa_group",d);for(var e=b.parentNode.parentNode,g=0,h=b.rowIndex+1;h<e.rows.length;h++){b=e.rows[h];if("group"==b.getAttribute("ewa_tag"))break;b.getAttribute("add_pre_row")?"none"==d?("none"!=b.style.display&&b.setAttribute("ewa_group_show_old",b.style.display),b.style.display="none"):b.hasAttribute("ewa_group_show_old")&&(b.style.display=
b.getAttribute("ewa_group_show_old"),b.removeAttribute("ewa_group_show_old")):(b.style.display=d,g++)}a.childNodes[a.childNodes.length-1].innerHTML=" ("+g+")"}};this.Sort=function(a){var b=this._last_sort_timer||0,d=this._Sort||"",e=(new Date).getTime();d==a&&500>e-b||(this._last_sort_timer=e,this._Sort=a,this.Goto(1))};this.SearchClear=function(a){a=a.parentNode.parentNode.parentNode.parentNode;for(var b=0;b<a.rows.length;b+=1)for(var d=a.rows[b].getElementsByTagName("input"),e=0;e<d.length;e++){var g=
d[e];if("text"==g.type)g.value="";else if("radio"==g.type||"checkbox"==g.type)g.checked=!1}};this.SearchGetExpInit=function(){var a=$("#_G_"+this._Id),b=[];$(a).find(".ewa-lf-search-item").each(function(){var d=$(this).find("input");if(0==d.length&&(d=$(this).find("select"),0==d.length))return;var e=d[0],g=$(e).attr("t");if(1==d.length){var h=e.value;if(""!=e.value.trim())for("text"==g&&(d=$(e.parentNode.parentNode).find("a").attr("tag"))&&(g=d),e=e.name.split(","),d=0;d<e.length;d++)b.push(e[d]+
"["+g+"]"+h)}else if(("date"==g||"number"==g)&&2==d.length){if(h=e.value,g=d[1].value,""!=g||""!=h)b.push(e.name+"[gte]"+h),g&&b.push(e.name+"[lte]"+g)}else if("fix"==g&&"INPUT"==e.tagName){var k=[""];$(this).find("input").each(function(){this.checked&&k.push(this.value)});1!=k.length&&b.push(e.name+"[or]"+k.join(";"))}});return b.join(",")};this.SearchGetExp=function(a){var b=[];$(a).find(".ewa-lf-search-item").each(function(){var d=$(this).find("input");if(0==d.length&&(d=$(this).find("select"),
0==d.length))return;var e=d[0],g=$(e).attr("t");if(1==d.length){var h=e.value;""!=e.value.trim()&&("text"==g&&(d=$(e.parentNode.parentNode).find("a").attr("tag"))&&(g=d),b.push("@!@"+e.name+"~!~"+g+"~!~"+h))}else if(("date"==g||"number"==g)&&2==d.length)h=e.value,d=d[1].value,""==d&&""==h||b.push("@!@"+e.name+"~!~"+g+"~!~"+h+"~!~"+d);else if("fix"==g&&"INPUT"==e.tagName){var k=[""];$(this).find("input").each(function(){this.checked&&k.push(this.value)});1!=k.length&&b.push("@!@"+e.name+"~!~"+g+k.join("~!~"))}});
...
0>h||k<h||(d=g.substring(0,h).trim(),0!=d.length&&(h=g.substring(h+1,k).trim().toLowerCase(),0!=h.length&&(g=g.substring(k+1).trim(),""!=g&&(b[d.toUpperCase()]||(b[d.toUpperCase()]={name:d,tag:h}),d=b[d.toUpperCase()],"lt"==h||"lte"==h?d.para2=g.unURL().replace(/\+/ig," "):d.para1=g.unURL().replace(/\+/ig," ")))))}return b};this.SearchFilterDate=function(a){var b=$(this._MENU_DATE_RANGE.SHOW_BY_OBJECT).parentsUntil(".ewa-lf-search-item").last(),d=b.find("input")[0];b=b.find("input")[1];if("Clear"==
a)$(d).val(""),$(b).val("");else{var e=EWA_Utils.Date(),g="",h="";"Today"==a?h=g=e.GetDateString():"Week"==a?(a=e.GetBenWeek(),g=a[0],h=a[1]):"Today-Weekend"==a?(a=e.GetBenWeek(),g=a[e.GetDateString()],h=a[1]):"Month"==a?(a=e.GetBenMonth(),g=a[0],h=a[1]):"Today-EOM"==a?(a=e.GetBenMonth(),g=a[e.GetDateString()],h=a[1]):"Quarter"==a?(a=e.GetBenQ(),g=a[0],h=a[1]):"Today-EOQ"==a?(a=e.GetBenQ(),g=a[e.GetDateString()],h=a[1]):"Year"==a?(a=e.GetBenYear(),g=a[0],h=a[1]):"Today-EOY"==a&&(a=e.GetBenYear(),
g=a[e.GetDateString()],h=a[1]);a=EWA_Utils.Date(g).FormatDate();e=EWA_Utils.Date(h).FormatDate();e+=" 23:59:59";$(d).val(a);$(b).val(e)}};this._SearchCreateDateRange=function(){var a="_MENU_DATE_RANGE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",d=JSON.parse(JSON.stringify(this.RESOURCES.search_date_items)),e="EWA.F.FOS[&quot;"+this._Id+"&quot;].SearchFilterDate",g;for(g in d){var h=d[g];h.Txt=h[b];h.Cmd=e+"(&quot;"+h.Id+"&quot;)"}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_DATE_RANGE";
this._MENU_DATE_RANGE=new EWA_UI_MenuClass(b);this._MENU_DATE_RANGE.Create(d);$(this._MENU_DATE_RANGE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+a);return b};this._SearchCreateTextType=function(){var a="_MENU_TEXT_TYPE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",d=JSON.parse(JSON.stringify(this.RESOURCES.search_text_items)),e="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextTypeIt",g;for(g in d){var h=d[g];h.Txt=h[b];h.Cmd=e+"(&quot;"+h.Id+"&quot;)";h.Group=
h.Id}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_TEXT_TYPE";this._MENU_TEXT_TYPE=new EWA_UI_MenuClass(b);this._MENU_TEXT_TYPE.Create(d);$(this._MENU_TEXT_TYPE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+a);this._MENU_TEXT_TYPE.clickBeforeEvent=function(k,l){$(this.Dialog.GetFrame()).find(".search-text-tag").remove();$(l).find("td:eq(0)").html('<b class="fa fa-check search-text-tag"></b>')};return b};this._SearchCreateItm=function(){var a="EWA_SEARCH_ITEM_"+this.Id,b=[],d=[],e=[],g={},h;for(h in this._SearchJson)this._SearchJson[h].ORI_NAME=
h,g[h.toUpperCase()]=this._SearchJson[h];this._SearchJson=g;var k="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextType(this)",l="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchDateType(this)",m=$J2MAP(this.RESOURCES.search_text_items,"Id");g=this._GetInitSearchMap();var n=!1,p=!1;for(h in this.ItemList.Items)if(null!=this._SearchJson[h]){var q=[],r=this._SearchJson[h],t=r.T,u=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[h]);q.push("<table class='ewa-lf-search-item ewa-ref-"+
h+" ewa-lf-search-type-"+t+" "+("fix"==t?"ewa-lf-search-fix-m"+(r.M||"0"):"")+"' cellspacing=0 cellpadding=0>");q.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");q.push(u);var w=u="",v="lk";g[h.toUpperCase()]&&(w=g[h.toUpperCase()],v=w.tag,u=w.para1,w=w.para2);var x="";"text"==t?(p=m[v]||m.lk,x="enus"==EWA.LANG?p.TxtEn:p.Txt,q.push("<a class='ewa-lf-search-type' tag='"+v+"' href='javascript:void(0)' onclick='"+k+"'>"),q.push(x),q.push("</a>"),p=!0):"date"==t&&
(q.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+l+"'></a>"),n=!0);q.push("</b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==t?"blk"==v||"nblk"==v?(r=this._SearchSingle(h,x),r=r.replace("<input","<input disabled "),q.push(r)):q.push(this._SearchSingle(h,u)):"date"==t?q.push(this._SearchDate(h,u,w)):"number"==t?q.push(this._SearchNumber(h,u,w)):"fix"==t&&(r="<div >"+this._SearchFix(h,r,"span",u)+"</div>",q.push(r));q.push("</td></tr></table>");"fix"==t&&
this._IsSearchGroup?d.push(q.join("")):e.push(q.join(""))}if(0!=e.length+d.length){b.push('<table class="ewa-lf-search-main" id="'+a+'" cellspacing="0" cellpadding="0">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");0<e.length&&b.push(" "+e.join("")+" ");for(e=0;e<d.length;e++)b.push(" "+d[e]+" ");b.push("</td></tr></table>");var y=document.createElement("div");this._SEARCH_BOX=y;y.className="ewa-lf-search";y.innerHTML=b.join("");b=$X("EWA_LF_"+this.Id).parentNode;b.parentNode.insertBefore(y,
b);a="EWA_SEARCH_ITEM_"+this.Id;var z=this;n&&this._SearchCreateDateRange();p&&this._SearchCreateTextType();z._SEARCH_ITEM_EXP=this.SearchGetExp(y);"{}"!=JSON.stringify(g)&&(z._SearchExp=z._SEARCH_ITEM_EXP);$(y).find("input[type=text]").on("compositionstart",function(){z._is_search_composition=!0}).on("compositionend",function(){z._is_search_composition=!1});this._TIMER_SEARCH=window.setInterval(function(){if(!z._is_search_composition){try{if(!$X(a)){window.clearInterval(z._TIMER_SEARCH);return}}catch(B){window.clearInterval(z._TIMER_SEARCH);
return}var A=z.SearchGetExp(y);A!=z._SEARCH_ITEM_EXP&&(z._SEARCH_ITEM_EXP=A,z.DoSearch($X(a)))}},700)}};this._SearchSingle=function(a,b){var d=[];d.push('<input t="text" type="text" autocomplete="off" class="EWA_INPUT" maxlength="40" name="');d.push(a.toInputValue());d.push('"');null!=b&&(d.push(' value="'),a=b.toInputValue(),d.push(a),d.push('" '));d.push(" />");return d.join("")};this._SearchDate=function(a,b,d){var e=[];e.push("<table border=0 cellpadding=0 cellspacing=0>");e.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');
...
"'> <input type=submit value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.SEARCH"]+"' onclick='EWA.F.FOS[\""+this._Id+"\"].DoSearch(this);'> <input type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLOSE"]+"' onclick='EWA.F.FOS[\""+this.Id+"\"]._SearchDialog.Show(false);'></td></tr>");a.push("</table></div>");this._SearchHtml=a.join("")};this.createRegExp=function(a){if(!a)return null;a=String(a).trim();if(0===a.length)return null;for(var b=[],d=0;d<a.length;d++){var e=a[d];"a"<=e&&"z">=e||"A"<=e&&"Z">=
e||"0"<=e&&"9">=e?b.push(e):b.push("\\"+e)}try{return new RegExp("("+b.join("")+")")}catch(g){return console.warn("new RegExp",a,g),null}};this.SearchMark=function(){for(var a=this._SearchExp.split("@!@"),b=$X("EWA_LF_"+this._Id),d=0;d<a.length;d+=1){var e=a[d].split("~!~");if(!(3>e.length))for(var g={},h=2;h<e.length;g={$jscomp$loop$prop$regExp$40:g.$jscomp$loop$prop$regExp$40},h++){var k=e[h];if(""!=k){if("fix"==e[1]){var l=e[2];$("table#EWA_SEARCH_ITEM_"+this.Id+' [name="'+e[0]+'"]').find("option").each(function(){this.value==
l&&(k=this.text)})}g.$jscomp$loop$prop$regExp$40=this.createRegExp(k);var m=e[0].split(","),n;for(n in m){var p=m[n];this._SearchJson[p]&&(p=this._SearchJson[p].ORI_NAME);p=$(b).find(".ewa-lf-data-row .ewa-col-"+p).not("[ewa-search-marked=yes]");p.attr("ewa-search-marked","yes");try{p.find("*").each(function(q){return function(){0==this.children.length&&(this.innerHTML=this.innerHTML.replace(q.$jscomp$loop$prop$regExp$40,"<font color=red><b>$1</b></font>"))}}(g))}catch(q){console.log(q)}}}}}};this.DblClick=
function(a){this._IsDblClick=a;for(var b=$X("EWA_LF_"+this._Id),d=1;d<b.rows.length;d++)b.rows[d].ondblclick=function(){var e=this.getElementsByTagName("input");e.length>a&&0==e[a].disabled&&e[a].click()}};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);if((a=$X("EWA_LF_"+this._Id))&&"table"==a.tagName&&!(1>=a.rows.length)){a=a.rows[1].getElementsByTagName("input");for(var b=0;b<a.length;b++)if("RADIO"==
a[b].type.toUpperCase()){this._TrSelectMulti=!1;break}}};this.SetPageParameters=function(a,b,d,e,g){this._PageCurrent=a;this._PageSize=d;this._PageCount=b;this._RecordCount=e;this._Sort=g};this.SetPageParametersName=function(a,b,d,e,g){this._PageCurrentName=a;this._PageSizeName=d;this._PageCountName=b;this._RecordCountName=e;this._SortName=g};this.CheckedAll=function(){var a=document.getElementById("EWA_LF_"+this._Id);if(!(1>=a.rows.length)){for(var b=0;b<a.rows.length;b+=1){var d=a.rows[b].getElementsByTagName("input");
0!=d.length&&(d[0].checked=this._IsCheckedAll)}this._IsCheckedAll=this._IsCheckedAll?!1:!0;this.CheckedAllAfter&&this.CheckedAllAfter(a)}};this.SelectChecked=function(){var a=$X("EWA_LF_"+this._Id);if(!a||1>a.rows.length)return"";var b=[],d=$F(a,"input","type","radio,checkbox");if(0<d.length)for(var e=0;e<d.length;e++)d[e].checked&&b.push(d[e].value);else for(e=0;e<a.rows.length;e++)d=a.rows[e],1==d.getAttribute("__ewa_lf_mdown")&&b.push(d.getAttribute("EWA_KEY"));return b.join(",")};this.SelectCheckedInputs=
function(){var a=[],b=$X("EWA_LF_"+this._Id);if(1>b.rows.length)return a;b=b.getElementsByTagName("input");a=[];for(var d=0;d<b.length;d++)("CHECKBOX"==b[d].type.toUpperCase()||"RADIO"==b[d].type.toUpperCase())&&b[d].checked&&a.push(b[d]);return a};this.SelectCheckedRows=function(){for(var a=[],b=$X("EWA_LF_"+this._Id),d=0;d<b.rows.length;d++){var e=b.rows[d],g=e.getElementsByTagName("input");0!=g.length&&g[0].checked&&-1==g[0].parentNode.className.indexOf("ewa-switch")&&a.push(e)}if(0==a.length)for(d=
0;d<b.rows.length;d++)e=b.rows[d],1==e.getAttribute("__ewa_lf_mdown")&&a.push(e);return a};this.Reload=function(a){this.StopAjaxAfterReload?this.StopAjaxAfterReload=!1:this.Goto(this._PageCurrent,a)};this.refreshPage=function(a,b){this.replaceRowsData(null,null,a,b)};this.replaceRowsData=function(a,b,d,e){var g=this.getUrlClass();g.AddParameter("EWA_AJAX","LF_RELOAD");g.AddParameter("EWA_IS_SPLIT_PAGE","no");g.AddParameter("EWA_IS_HIDDEN_CAPTION","yes");g=g.GetUrl();a&&(g+="&"+a);var h=a?new EWA_AjaxClass:
this.CreateAjax(),k=this;h.PostNew(g,function(){if(4==h._Http.readyState){h.HiddenWaitting();var l=h._Http.responseText;200!=h._Http.status?(console.error(l),alert("ERROR:\r\n"+h._Http.statusText)):EWA.F.CheckCallBack(l)?k.replaceRowsWithDataHtml(l,b,d,e):console.error(l)}})};this.replaceRowsWithDataHtml=function(a,b,d,e){var g=$("<div></div>");g.html(a);var h=[],k=$("#EWA_LF_"+this._Id);g.find(".ewa-lf-data-row").each(function(){var l='tr[ewa_key="'+$(this).attr("ewa_key")+'"]',m=k.find(l);if(0==
m.length)console.warn(l+" not found");else{l=$(this).attr("ewa_row_sign");var n=m.attr("ewa_row_sign"),p=!0;(l||n)&&n===l&&(p=!1);if(p){m.attr("ewa_row_sign",l);l=m.clone()[0];for(n=0;n<this.cells.length;n++){p=m[0].cells[n];var q=this.cells[n];p.removeAttribute("ewa-merged");p.removeAttribute("ewa-search-marked");b?b(q,p):p.innerHTML=q.innerHTML}h.push({before:l,current:m[0]})}}});g.remove();this.SearchMark();this.IsReShow&&this.ReShowWithNoButtons();this._ReShowSearchQuick();null!=this._IsDblClick&&
...
b.animate(t,"fast","swing",function(){b[0].style.cssText="";var u=1*b.attr("st");document.body.scrollTop=u;1==$("#crm_left_box").attr("show")&&$("#crm_left_box").show();b.css("display",b.attr("dsp"));0<e.length&&"DES_plugin"!=a?e[0].click():(u=$X(a.replace("DES_","")),u.style.width=u.parentNode.clientWidth-10+"px",u.style.height=t.height-30+"px",d.find('div[id="EWA_FRAME_MAIN"]').css("height",t.height-150))});else{b.attr("full","1");b.attr("st",document.body.scrollTop);b.attr("dsp",b.css("display"));
var h=document.documentElement.clientHeight;g=document.documentElement.clientWidth-10;var k=h-20,l=document.documentElement.clientWidth-30,m=h-20-20-15;h=b.offset();var n=b.position(),p=h.left-n.left,q=b.width(),r=b.height();var t={width:q,height:r,"margin-left":p,left:n.left,top:n.top};b.attr("ori",JSON.stringify(t));b.css({"margin-left":"0px",top:h.top,left:h.left,position:"absolute",display:"",overflow:"auto"});b.animate({width:g,height:k,left:10,top:0},"fast","swing",function(){d.css("width",
...
(function(a,b){"object"===typeof module&&"object"===typeof module.exports?module.exports=b():b(a)})("undefined"!==typeof window?window:this,function(a){function b(m){for(var n=[{number:0,scale:1,items:[]}],p=null,q=0;q<m.length;q++){var r=m[q],t=g[r],u=e[r];n[n.length-1].items.push([r,t,u]);if(t)0==q&&t.first?n[n.length-1].number=10:t.stop?(n[n.length-1].scale=t.value||1,n.push({number:0,scale:1,items:[]}),scale=1,p=null):(q==m.length-1&&(console.log(t),n[n.length-1].number.scale=t.value),p=t);else{if(null==
u)throw"\u975e\u6570\u5b57\u6216\u5355\u4f4d\uff1a"+r;r=q==m.length-1?null:m[q+1];var w=q==m.length-1?null:g[r];w&&w.stop&&(w=null);r=n[n.length-1].number;var v=n[n.length-1].items;t=v[v.length-2];v=v[v.length-3];null==w?null==p?(p=!1,t&&0===t[2]?v&&null!=v[1]&&(p=!0):t&&t[1]&&10===t[1].value&&(p=!0),u=p?r+u:10*r+u):u=t&&t[1]&&10===t[1].value&&(null==v||0===v[2]||null!=v[1])?r+u+10:r+u:u=r+u*w.value;n[n.length-1].number=u;p=null}}return n}function d(m){if(!m)return m;if(!isNaN(m.toString()))return 1*
m.toString();var n=m.replace(/\uff0c|,| |\u5143|\u5706/ig,"").replace(/\u70b9|\u3002/ig,".").split(".");if(2<n.length)throw"\u975e\u6570\u5b57\u8868\u8fbe\u5f0f\uff1a"+m;var p=n[0].split("");m=(2==n.length?n[1]:"").split("");n=!1;var q=p[0];h[q]?(n=!0,p=p.splice(1)):k[q]&&(n=!1,p=p.splice(1));q=p[p.length-1];l[q]?p=p.splice(0,p.length-1):1<m.length&&(q=m[m.length-1],l[q]&&(m=m.splice(0,m.length-1)));q=p;for(var r=p=0,t=q.length-1;0<=t;t-=2){var u=q[t];var w=e[q[t-1]];u=w?"\u89d2"==u?1*("0."+w):"\u5206"==
u?1*("0.0"+w):"\u5398"==u?1*("0.00"+w):"\u6beb"==u?1*("0.000"+w):-1:-1;if(-1===u)break;else p+=u,r++}q=q.splice(0,q.length-2*r);q=b(q);r=0;t=1;for(u=q.length-1;0<=u;u--){w=q[u];var v=w.number;t*=w.scale;r+=v*t}p=r+p;if(0<m.length){q=1;r=0;for(t=m.length-1;0<=t;t--){u=g[m[t]];if(!u)break;q*=u.value;r++}m=1==q?m:m.splice(0,m.length-r);r=b(m);t=0;u=1;for(w=r.length-1;0<=w;w--){v=r[w];var x=v.number;u*=v.scale;t+=x*u}m=[1*("0."+t),q,m.length]}else m=0;return 0==m?p*(n?-1:1):((p+m[0])*m[1]).toFixed(0>
...
function loadWfShow(a,b,d,e,g,h,k,l,m,n){_EWA_WF&&_EWA_WF.EN&&(_EWA_WF.EN1=$J2MAP(_EWA_WF.EN,"WF_UNIT_ID"));e=document.createElement("div");e.style.position="absolute";e.style.zIndex=123;e.innerHTML="ver: "+_EWA_WF.WF_DLV_VER;document.body.appendChild(e);var p=EWAC_WfUtil.WF,q=1000012,r=1000011;for(e=0;e<a.length;e++){var t=a[e],u=t.WF_UNIT_X,w=t.WF_UNIT_Y;null!=u&&1*u<q&&(q=1*u);null!=w&&1*w<r&&(r=1*w)}1000012==q&&(q=0);1000011==r&&(r=0);q-=10;r-=10;n={};var v;for(e=0;e<a.length;e++)t=a[e],p.Ids[e]=
t.WF_UNIT_ID,u=p.CreateUnit(),n[t.WF_UNIT_ID]=u,w=t.WF_UNIT_NAME,"enus"==EWA.LANG&&_EWA_WF.EN1&&_EWA_WF.EN1[t.WF_UNIT_ID]&&_EWA_WF.EN1[t.WF_UNIT_ID].WF_UNIT_NAME_EN&&(w=_EWA_WF.EN1[t.WF_UNIT_ID].WF_UNIT_NAME_EN),u.ChangeDes(w),u.ChangeType(t.WF_UNIT_TYPE),u.WF_UNIT_ADM=t.WF_UNIT_ADM,u.WF_UNIT_ADM_LST=t.WF_UNIT_ADM_LST,u=t.WF_UNIT_X,w=t.WF_UNIT_Y,t=$X(t.WF_UNIT_ID),null!=u&&(t.style.left=u-q+"px"),null!=w&&(t.style.top=w-r+"px");a={};for(e=0;e<b.length;e++)t=b[e],u=t.WF_UNIT_FROM,a[u]||(a[u]=[]),a[u].push(t);
for(e=0;e<b.length;e++)t=b[e],a=t.WF_UNIT_TO,u=t.WF_UNIT_FROM,u=p.Units[u],a=p.Units[a],q=new EWAC_WfCnn,q.Create(u,a),p.Cnns[q.Id]=q,t.IsHaveLogic&&!t.IsLogicOk&&(q.IsStop=!0);for(var x in p.Units)e=p.Units[x],null==v&&0==e.CnnsToLength&&(v=e);if(null==v)e="enus"==EWA.LANG?"No startup node was found, process definition error":"\u672a\u53d1\u73b0\u542f\u52a8\u8282\u70b9,\u6d41\u7a0b\u5b9a\u4e49\u9519\u8bef",alert(e);else{0==d.length&&(p.CurUnit=v);var y=[];x={};for(e=0;e<d.length;e++)b=d[e],p=b.SYS_STA_TAG,
u=n[p],null!=u&&(t=b.ADM_NAME,"enus"==EWA.LANG&&b.ADM_NAME_EN&&(t=b.ADM_NAME_EN),u.Log(t,b.SYS_STA_CDATE,b.SYS_STA_MEMO),x[p]||(x[p]=1,y.push({ID:p,DES:u.GetDes()})),p=b.SYS_STA_TAG+"G"+b.SYS_STA_VAL,EWAC_WfUtil.WF.Cnns[p]&&(EWAC_WfUtil.WF.Cnns[p].Disp(3,"blue"),u==v&&(u.ADM_ID=b.ADM_ID),e==d.length-1&&(u=n[b.SYS_STA_VAL],u.WF_UNIT_ADM_LST=b.ROLE_IDS,u.WF_UNIT_ADM=b.ROLE_TYPE,EWAC_WfUtil.WF.CurUnit=u)));null!=m&&0<m.length&&n[m]&&(EWAC_WfUtil.WF.CurUnit=n[m]);EWAC_WfUtil.WF.CurUnit.LogCur(g);m=!1;
...
h?!0:!1);g&&window.parent&&window.parent.$X(g)&&(z=window.parent.$X(g).parentNode.parentNode.parentNode,m?0<y.length&&(e=z.rows[z.rows.length-1].cells[0],h=window.parent.document.createElement("input"),h.type="button",h.value="enus"==EWA.LANG?"Back":"\u6253\u56de",h.onclick=function(){var A=window.parent.$X(g);A.options.length=1;for(var B=0;B<y.length;B++){var D=y[B];A.options[A.length]=new Option(D.DES,D.ID);this.style.display="none"}A.parentNode.parentNode.cells[0].innerHTML="enus"==EWA.LANG?'<div style="color:red">Back steps</div>':

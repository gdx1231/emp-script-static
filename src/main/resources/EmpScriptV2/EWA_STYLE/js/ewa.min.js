...
alert("enus"==EWA.LANG?"Object objs_ch cannot be empty":"\u5bf9\u8c61objs_ch\u4e0d\u80fd\u4e3a\u7a7a"):(this._objs_ch=a,this._objs_en=b,this._transCompleteCallback=d,this._transCompleteItemCallBack=c,this.start_trans("cn"))};this.start_trans=function(a){if(this.idx<=this._objs_ch.length-1){var b=this.idx;this.idx++;const e=this._objs_ch[b];if(this.get_text(e)){b=this._objs_en?this._objs_en[b]:null;var c=this.get_text(b);if(this.SKIP_EXISTS&&c)this.idx_ok++,this.start_trans(a);else{this.trans_item(e,
b,a);var d=this;setTimeout(function(){d.start_trans(a)},123)}}else this.idx_ok++,this.start_trans(a)}};this.trans_item=function(a,b,c){let d=this;this.trans==null&&(this.trans=new EWA_TransClass,this.trans.transAfter=function(e,g){d.idx_ok++;d.call_item_callback(g,e)});c=="cn"?this.trans.TransToCn(this.get_text(a),b):this.trans.TransToEn(this.get_text(a),b)};this.get_text=function(a){if(!a==null||a==void 0)return null;if(typeof a=="string")var b=a;else{var c=a.tagName;c==null&&(c="");c=c.toUpperCase();
c=="SELECT"||c=="INPUT"||c=="TEXTAREA"?b=a.value:c!=""?b=a.innerHTML:(console.log("trans_err"),console.log(a))}return b||""};this.call_item_callback=function(a,b){this._transCompleteItemCallBack&&this._transCompleteItemCallBack(a,b)};this.check_complete=function(){return this._objs_ch.length==this.idx_ok?($Tip("enus"==EWA.LANG?"Translate completed":"\u7ffb\u8bd1\u5b8c\u6210"),this._transCompleteCallback&&this._transCompleteCallback(),!0):!1}}

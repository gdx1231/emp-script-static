...
u;(u=q==m.length-1?null:g[m[q+1]])&&u.stop&&(u=null);var t=n[n.length-1].number;n[n.length-1].number=null==u?null==p?10*t+r:t+r:t+r*u.value;p=null}}return n}function d(m){if(!m)return m;if(!isNaN(m.toString()))return 1*m.toString();var n=m.replace(/\uff0c|,| |\u5143|\u5706/ig,"").replace(/\u70b9|\u3002/ig,".").split(".");if(2<n.length)throw"\u975e\u6570\u5b57\u8868\u8fbe\u5f0f\uff1a"+m;var p=n[0].split("");m=(2==n.length?n[1]:"").split("");n=!1;var q=p[0];h[q]?(n=!0,p=p.splice(1)):k[q]&&(n=!1,p=p.splice(1));
q=p[p.length-1];l[q]?p=p.splice(0,p.length-1):1<m.length&&(q=m[m.length-1],l[q]&&(m=m.splice(0,m.length-1)));for(var u=q=0,r=p.length-1;0<=r;r-=2){var t=p[r];var w=e[p[r-1]];t=w?"\u89d2"==t?1*("0."+w):"\u5206"==t?1*("0.0"+w):"\u5398"==t?1*("0.00"+w):"\u6beb"==t?1*("0.000"+w):-1:-1;if(-1===t)break;else q+=t,u++}p={sum:q,inc:u,strs:p.splice(0,p.length-2*u)};console.log(p);q=p.strs;q=b(q);u=0;r=1;for(t=q.length-1;0<=t;t--){w=q[t];var v=w.number;r*=w.scale;u+=v*r}p=u+p.sum;if(0<m.length){q=1;u=0;for(r=
m.length-1;0<=r;r--){t=g[m[r]];if(!t)break;q*=t.value;u++}m=1==q?m:m.splice(0,m.length-u);u=b(m);r=0;t=1;for(w=u.length-1;0<=w;w--){v=u[w];var y=v.number;t*=v.scale;r+=y*t}m=[1*("0."+r),q,m.length]}else m=0;return 0==m?p*(n?-1:1):((p+m[0])*m[1]).toFixed(0>m[2]?0:m[2])*(n?-1:1)}var e={"\u96f6":0,0:0,"\uff10":0,o:0,O:0,"\u4e00":1,"\u58f9":1,1:1,"\uff11":1,"\u4e8c":2,"\u8d30":2,2:2,"\uff12":2,"\u4e24":2,"\u4fe9":2,"\u4e09":3,"\u53c1":3,3:3,"\uff13":3,"\u56db":4,"\u8086":4,4:4,"\uff14":4,"\u4e94":5,"\u4f0d":5,
5:5,"\uff15":5,"\u516d":6,"\u9646":6,6:6,"\uff16":6,"\u4e03":7,"\u67d2":7,7:7,"\uff17":7,"\u516b":8,"\u634c":8,8:8,"\uff18":8,"\u4e5d":9,"\u7396":9,9:9,"\uff19":9},g={"\u5341":{value:10,first:!0},"\u62fe":{value:10,first:!0},"\u4ec0":{value:10,first:!0},"\u767e":{value:100},"\u4f70":{value:100},"\u964c":{value:100},"\u5343":{value:1E3},"\u9621":{value:1E3},"\u4edf":{value:1E3},k:{value:1E3,stop:!0},K:{value:1E3,stop:!0},"\u4e07":{value:1E4,stop:!0},"\u842c":{value:1E4,stop:!0},M:{value:1E6,stop:!0},
m:{value:1E6,stop:!0},"\u4ebf":{value:1E8,stop:!0},b:{value:1E9,stop:!0},B:{value:1E9,stop:!0}},h={"-":!0,"\u8d1f":!0,"\uff0d":!0},k={"+":!0,"\u6b63":!0},l={"\u6574":!0};if(window&&window.EWA&&window.EWA_Utils)window.EWA_Utils.chineseToNumber=d;else if(a)a.chineseToNumber=d;else return d});

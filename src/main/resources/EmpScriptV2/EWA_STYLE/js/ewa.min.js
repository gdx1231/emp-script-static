...
"div","",a).className="ewa_lf_func_split"};this._ReShowButton=function(a,b,d){var e=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",document.body);e.innerHTML="<nobr>"+a+"</nobr>";null!=d&&(e.setAttribute("_ewa_event_id",d),e.onclick=function(){var g=this.getAttribute("_ewa_event_id");$X(g).click()});EWA.B.IE&&(e.onselectstart=function(){return!1});e.className="ewa_lf_func_dact";e.title=b;return e};this.CheckValid=function(a){var b=a.tagName.toLowerCase();if("input"!=b&&"textarea"!=b&&"select"!=

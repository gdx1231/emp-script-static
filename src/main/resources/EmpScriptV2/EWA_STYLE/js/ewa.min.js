...
b.style.display=""}};this._CreateWaittingText=function(){var b=document.createElement("DIV");b.id=this._WaittingId;b.innerHTML="Waiting...";document.body.appendChild(b);b.className="ewa-wait-txt"};this._CreateWaittingImg=function(){var b=document.createElement("TABLE");b.id=this._WaittingId;var c=b.insertRow(-1).insertCell(-1);c.align="center";c.innerHTML="<img src='"+this._getLoaddingImg()+"'>";document.body.appendChild(b);b.className="ewa-wait-img"};this.HiddenWaitting=function(){var b=document.getElementById(this._WaittingId);
null!=b&&(b.style.display="none")};this._InitHttp=function(){this._Http=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");if(null==window._EWA_AJAX_LIST||200<window._EWA_AJAX_LIST.length)window._EWA_AJAX_LIST=[];window._EWA_AJAX_LIST.push(this)};this.Get=function(b,c){null==b?console.log("ajax url not null"):(b.GetUrl?b=b.GetUrl():b.getUrl?b=b.getUrl():b.href&&(b=b.href),0<=b.indexOf("|")&&(b=b.replace(/\|/ig,"%7c")),this._Http.onreadystatechange=c,b.endsWith(".txt")||
b.endsWith(".TXT")||(b=0<b.indexOf("?")?b+"&___R="+Math.random():b+"?___R="+Math.random()),b=b.replace("&&","&"),b=b.replace("?&","?"),0==EWA.B.IE?(this._Http.open("GET",b,!this._IsAsync),this._Http.send(null)):(this._Http.open("GET",b,!this._IsAsync),this._Http.send()),this._IsAsync||this._ShowWaitting())};this.Post=function(b,c,d){null==b?console.log("ajax url not null"):(b.GetUrl?b=b.GetUrl():b.getUrl?b=b.getUrl():b.href&&(b=b.href),0<=b.indexOf("|")&&(b=b.replace(/\|/ig,"%7c")),this._ShowWaitting(),
null!=d&&(this._Http.onreadystatechange=d),b=b.replace("&&","&"),b=b.replace("?&","?"),this._Http.open("POST",b,!this._IsAsync),this._Http.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),this._Http.send(c),this._IsAsync||this._ShowWaitting())};this.PostNew=function(b,c){var d=[],e;for(e in this._Parameters){var g=this._Parameters[e];null!=g&&d.push(e+"="+g)}this.Post(b,d.join("&"),c)};this.GetReturnValue=function(){return this._Http.responseText};this.AddParameter=function(b,
c,d){this._Parameters[b]=d?c:encodeURIComponent(c)};this._InitHttp();this._getLoaddingImg=function(){return(EWA.RV_STATIC_PATH||"/EmpScriptV2")+"/EWA_STYLE/images/loading4.gif"};this.Install=function(b,c,d,e,g){var h=this,k="string"==typeof d?document.getElementById(d):d;if(null==k)alert("Object ["+d+"] not found");else{var l=$(k),m=null;g||(m=l.css("position"),"static"==m&&l.css("position","relative"),l.append("<div class='ewa-ajax-install-waitting'></div>"));this.Post(b,c,function(){if(h.IsRunEnd()){"static"==
m&&l.css("position",m);var n=h.GetRst();if(h.IsError())$(k)[0].innerHTML=n;else{$(k)[0].innerHTML=n;try{EWA.C.Utils.JsRegisters(n)}catch(p){console.log(p)}}null!=e&&e(b,c,d,n)}});this.HiddenWaitting()}};this.IsRunEnd=function(){if(4!=this._Http.readyState)return!1;this.HiddenWaitting();this._RunEndTime||(this._RunEndTime=(new Date).getTime());window.setTimeout(function(){for(var b=window._EWA_AJAX_LIST.length-1;0<=b;b--){var c=window._EWA_AJAX_LIST[b];if(null!=c&&1231<c.GetEndPastTime()){try{c.Dispose()}catch(d){}window._EWA_AJAX_LIST[b]=
...
function _$J_HandleRst(a,b,c,d){if(a.IsRunEnd())if(a.IsError())window.EWA_AjaxErr?window.EWA_AjaxErr(a.GetRst()):console.error(a.GetRst());else{a=a.GetRst();if(d)try{a=JSON.parse(a)}catch(l){console.error("_$J_HandleRst-JSON"+l);return}if(null==b)alert("\u5bf9\u8c61\u6ca1\u6709\u53d1\u73b0");else if(b instanceof Function||"function"==typeof b)b(a,c);else if("string"==typeof b)$X(b);else if("SELECT"==b.tagName)if(d)if(2>c.length)alert("\u53c2\u6570\u4e0d\u8db3\uff0c\u9700\u8981textName,valueName\u7684\u5b9a\u4e49");
...
function _$J_SELECT(a,b,c,d,e,g,h,k){function l(u,x){if(!x)return"not defined textName";if(x instanceof Function)return x[u];if(-1==x.indexOf("@@"))return u[x];for(var w=x.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),y=0;y<w.length;y++){var z=w[y],A=z.replace("@@","");x=x.replace(z,u[A]||"")}return x}function m(u,x){var w=l(u,c),y=b.options[b.options.length]=new Option(w,u[d]);if(x){for(var z=[],A=0;A<x;A++)z.push("");z.push(w);z.join("\u3000")}for(var C in u)u[C]&&y.setAttribute("para_"+C.toLowerCase(),u[C]);
y.setAttribute("json",JSON.stringify(u));return y}b.options.length=0;e&&(b.options[0]=new Option("",""),e instanceof Array&&(b.options[0].text=e[0],b.options[0].value=e[1]));if(k){var n=function(u,x){if((u=p[u])&&u._children&&0!=u._children.length)for(var w,y=0;y<u._children.length;y++)w=u._children[y],m(w,x),n(w[d],x+1)},p={___ROOT___:[]};e={___ROOT___:{}};for(var r,q,t,v=0;v<a.length;v++){t=a[v];r=t[k];q=t[d];if(null===r||""===r||"0"===r)r="___ROOT___";p[r]||(p[r]=[]);p[r].push(t);e[q]=t;e[r]&&
(e[r]._children||(e[r]._children=[]),e[r]._children.push(t))}n("___ROOT___",0)}else for(v=0;v<a.length;v++)t=a[v],m(t);g&&(b.value=g);$(b).trigger("change");h&&h(b)}$Install=function(a,b,c,d){a.GetUrl?a=a.GetUrl():a.getUrl?a=a.getUrl():a.href&&(a=a.href);var e=new EWA_UrlClass;e.SetUrl(a);e.GetParameter("EWA_AJAX")||e.AddParameter("EWA_AJAX","INSTALL");(new EWA_AjaxClass).Install(e.GetUrl(),"",b,c,d)};
...
function EWA_JSONClass(){this._Escapeable=/["\\\x00-\x1f\x7f-\x9f]/g;this._Meta={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};this.ToJSONDate=function(a){return null==a?"null":a.getUTCFullYear()+"-"+f(a.getUTCMonth()+1)+"-"+f(a.getUTCDate())+"T"+f(a.getUTCHours())+":"+f(a.getUTCMinutes())+":"+f(a.getUTCSeconds())+"Z"};this.ToJSONString=function(a){return'"'+(this._Escapeable.test(a)?a.replace(escapeable,function(b){var c=meta[b];if("string"===typeof c)return c;c=b.charCodeAt();
...
JSON=window.JSON||function(){function a(l){return 10>l?"0"+l:l}function b(l){return d.test(l)?'"'+l.replace(d,function(m){var n=h[m];if("string"===typeof n)return n;n=m.charCodeAt();return"\\u00"+Math.floor(n/16).toString(16)+(n%16).toString(16)})+'"':'"'+l+'"'}function c(l,m){var n=e;(m=m[l])&&"object"===typeof m&&"function"===typeof m.toJSON&&(m=m.toJSON(l));switch(typeof m){case "string":return b(m);case "number":return isFinite(m)?String(m):"null";case "boolean":case "null":return String(m);case "object":if(!m)return"null";
e+=g;var p=[];if("number"===typeof m.length&&!m.propertyIsEnumerable("length")){var r=m.length;for(l=0;l<r;l+=1)p[l]=c(l,m)||"null";var q=0===p.length?"[]":e?"[\n"+e+p.join(",\n"+e)+"\n"+n+"]":"["+p.join(",")+"]";e=n;return q}if("object"===typeof k)for(r=k.length,l=0;l<r;l+=1){var t=k[l];"string"===typeof t&&(q=c(t,m,k))&&p.push(b(t)+(e?": ":":")+q)}else for(t in m)(q=c(t,m,k))&&p.push(b(t)+(e?": ":":")+q);q=0===p.length?"{}":e?"{\n"+e+p.join(",\n"+e)+"\n"+n+"}":"{"+p.join(",")+"}";e=n;return q}}
Date.prototype.toJSON=function(){return this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z"};var d=/["\\\x00-\x1f\x7f-\x9f]/g,e,g,h={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},k;return{stringify:function(l,m,n){var p;g=e="";if(n)if("number"===typeof n)for(p=0;p<n;p+=1)g+=" ";else"string"===typeof n&&(g=n);if(m)if("function"===typeof m||"object"===typeof m&&
"number"===typeof m.length)k=m;else throw Error("JSON.stringify");else k=function(r,q){if(Object.hasOwnProperty.call(this,r))return q};return c("",{"":l})},parse:function(l,m){function n(p,r){var q,t=p[r];if(t&&"object"===typeof t)for(q in t)if(Object.hasOwnProperty.call(t,q)){var v=n(t,q);void 0!==v?t[q]=v:delete t[q]}return m.call(p,r,t)}if(/^[\],:{}\s]*$/.test(l.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,
"")))return l=eval("("+l+")"),"function"===typeof m?n({"":l},""):l;throw new SyntaxError("JSON.parse");},quote:b}}();EWA.JSON=JSON;
...
"-12-31"]};this.GetBenMonth=function(){var b=this.GetYear(),c=this.GetMonth(),d=this._Days[c-1];2==c&&(0==(b-1992)%4&&0!=(b-1900)%100||0==(b-2E3)%400)&&(d=29);10>c&&(c="0"+c);10>d&&(d="0"+d);return[b+"-"+c+"-01",b+"-"+c+"-"+d]};this.GetBenWeek=function(b){var c=this._Date.getDay(),d=this.GetDay();b?(b=c,c=6-c):(b=c-1,c=7-c);var e=this.Clone();e.setDate(d-b);b=this.Clone();b.setDate(d+c);return[this.GetDateString(e),this.GetDateString(b)]};this.GetBenQ=function(){var b=this.GetMonth();if(3>=b){var c=
1;b=3}else 6>=b?(c=4,b=6):9>=b?(c=7,b=9):(c=10,b=12);var d=this.GetYear();c=this.CreateDate(d,c,1);b=this.CreateDate(d,b,this._Days[b-1]);return[this.GetDateString(c),this.GetDateString(b)]};this.GetDateString=function(b){return this.FormatDateTime(null,b)};this.GetDateTimeString=function(b){return this.FormatDate(null,b)};this.Clone=function(){return this.CreateDate(this.GetYear(),this.GetMonth(),this.GetDay())};this.AddDays=function(b){var c=this._Date.getDate();this._Date.setDate(c+1*b);return this.GetDateString()};
this.AddDaysFt=function(b,c){var d=this._Date.getDate();this._Date.setDate(d+1*b);return this.FormatDate(c)};this.CreateDate=function(b,c,d,e,g,h){var k=new Date;null==e&&(e=0);null==g&&(g=0);null==h&&(h=0);k.setDate(1);k.setFullYear(b);k.setMonth(c-1);k.setDate(d);k.setHours(e);k.setMinutes(g);k.setSeconds(h);k.setMilliseconds(0);return k};this.SetDate=function(b,c,d,e,g,h){this._Date=null==c?EWA_Utils.Date(b)._Date:this.CreateDate(b,c,d,e,g,h)};this.GetWeekName=function(){return _EWA_G_SETTINGS.WEEKS.split(",")[this._Date.getDay()]};
this.FormatDate=function(b,c){!b&&_EWA_G_SETTINGS&&_EWA_G_SETTINGS.DATE&&(b=_EWA_G_SETTINGS.DATE);b||(b="yyyy-MM-dd");var d=c||this._Date,e=c=d.getMonth()+1,g=d.getDate();10>e&&(e="0"+c);10>g&&(g="0"+g);d=d.getFullYear();var h,k="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ");"MM/dd/yyyy"==b?h=e+"/"+g+"/"+d:"dd/MM/yyyy"==b?h=g+"/"+e+"/"+d:"yyyy-MM-dd"==b?h=d+"-"+e+"-"+g:"MM/dd"==b?h=e+"/"+g+"/"+d:"dd/MM"==b?h=g+"/"+e+"/"+d:"MM-dd"==b?h=e+"-"+g:"MMM dd"==b?h=k[c-1]+" "+g:"dd-MMM"==b?h=
g+"-"+k[c-1]:"ddMMM"==b?h=g+k[c-1]:"MMMdd"==b?h=k[c-1]+g:"MM\u6708dd\u65e5"==b?h=c+g+"\u65e5":"yyyyMMdd"==b&&(h=d+""+e+g);return h};this.FormatDateTime=function(b,c){return this.FormatDate(b,c)+" "+this.GetTimeStr(c)};this.GetTimeStr=function(b){var c=b||this._Date;b=c.getHours();var d=c.getMinutes();c=c.getSeconds();return(10>b?"0":"")+b+":"+(10>d?"0":"")+d+":"+(10>c?"0":"")+c};this.GetDateDiff=function(b){var c=this._Date;b=b?b instanceof Date?b:b instanceof EWA_DateClass?b._Date:EWA_Utils.Date(b)._Date:
...
function EWA_UrlClass(a){this._URL="";this._Paras={};this._Root="";this.SetUrl=function(b){this._URL=b=null==b?window.location.href:b.href?b.href:b.toString();this._Paras={};this._Root=b.split("?")[0];if(!(0>b.indexOf("?"))){b=b.split("?")[1].split("&");for(var c=0;c<b.length;c++){var d=b[c].split("=");2==d.length?this._Paras[d[0].toUpperCase()]=d[1]:this._Paras[d[0].toUpperCase()]=""}}};this.RemoveEwa=function(){for(var b in this._Paras){var c=b.toLowerCase();if("xmlname"==c||"itemname"==c||0==c.indexOf("ewa_"))this._Paras[b]=
null}return this.GetUrl()};this.GetParameter=function(b){return this._Paras[b.toUpperCase().trim()]};this.GetParas=function(b){var c=[],d;for(d in this._Paras){var e=this._Paras[d];b&&(d=d.toLowerCase());d&&null!=e&&c.push(d+"="+e)}return c.join("&")};this.SetRoot=function(b){this._Root=b};this.GetUrl=function(b){b=this.GetParas(b);var c="";0<b.length&&(c=0<=this._Root.indexOf("?")?"&":"?");return this._Root+c+b};this.AddParameter=function(b,c,d){b=b.toUpperCase().trim();this._Paras[b]=d?c:encodeURIComponent(c);
...
c,this.start_trans("cn"))};this.start_trans=function(a){if(this.idx<=this._objs_ch.length-1){var b=this._objs_ch[this.idx],c=null;if(this._objs_en&&(c=this._objs_en[this.idx],this.SKIP_EXISTS&&this.get_text(c))){this.idx++;this.start_trans(a);return}this.idx++;this.trans_item(b,c,a);var d=this;setTimeout(function(){d.start_trans(a)},123)}};this.trans_item=function(a,b,c){var d=this;null==this.trans&&(this.trans=new EWA_TransClass,this.trans.transAfter=function(e,g){d.idx_ok++;d.call_item_callback(g,
e);d.check_complete()});"cn"==c?this.trans.TransToCn(this.get_text(a),b):this.trans.TransToEn(this.get_text(a),b)};this.get_text=function(a){if("string"==typeof a)var b=a;else{var c=a.tagName;null==c&&(c="");c=c.toUpperCase();"SELECT"==c||"INPUT"==c||"TEXTAREA"==c?b=a.value:""!=c?b=a.innerHTML:(console.log("trans_err"),console.log(a))}return b||""};this.call_item_callback=function(a,b){this._transCompleteItemCallBack&&this._transCompleteItemCallBack(a,b)};this.check_complete=function(){return this._objs_ch.length==
...
Function)b(a);else{"string"==typeof b&&(b=document.getElementById(b));var c=b.tagName;null==c&&(c="");c=c.toUpperCase();if("SELECT"==c||"INPUT"==c||"TEXTAREA"==c){b.value=a;b.setAttribute("ewa_trans_end","ok");if(null!=b.onblur)b.onblur();"TEXTAREA"==c&&window.autosize&&autosize.update&&autosize.update(b)}else"DIV"==c||"SPAN"==c?"DIV"==c&&$(b).attr("EWA_DHTML")?($(b).find("iframe")[0].contentWindow.frames[0].document.body.innerHTML=a,$(b).find("input[type=hidden]")[0].value=a):(b.setAttribute("ewa_trans_end",
...
0,this.debug&&console.debug("tryClearCbs\uff1a\u8d85\u8fc7200\uff0c\u5f3a\u5236\u6e05\u7a7a");else{for(var b in this.cbs)if(null!=this.cbs[b])return;this.debug&&console.debug("tryClearCbs\uff1a\u6e05\u7a7a"+this.cbs_length);this.cbs={};this.cbs_length=0}};this.onMessage=function(b){try{var c=JSON.parse(b.data);if(c.ID&&this.cbs[c.ID]){var d=this.cbs[c.ID];if(d){this.debug&&(console.debug("\u6267\u884c\u56de\u8c03\u65b9\u6cd5"),console.debug(c.ID,d));try{d(c,b)}catch(e){console.log(b),console.log(d),
console.log(e)}this.cbs[c.ID]=null;10<this.cbs_length&&this.tryClearCbs()}}else if(c.BROADCAST_ID&&this.handleBroadMsgs[c.BROADCAST_ID]&&(d=this.handleBroadMsgs[c.BROADCAST_ID])){this.debug&&(console.debug("\u6267\u884c\u5e7f\u64ad\u6d88\u606f\u56de\u8c03\u7684\u65b9\u6cd5"),console.debug(d));try{d(c,b)}catch(e){console.log(b),console.log(d),console.log(e)}}}catch(e){console.log(b),console.log(e)}};this.onOpen=function(b,c){var d=this;d.connected=!0;if(c)c();else for(var e in d.handleOnReconnected){b=
...
a.childNodes.length;b+=1)EWA$UI$COMMON.Dispose(a.childNodes[b])}},Drop:function(a){EWA$UI$COMMON.Dispose(a);a.parentNode.removeChild(a)},AniExpand:function(a,b,c,d,e){if(null==d||0>=d)d=10;var g=0,h=b/(1*d),k=c/(1*d),l=a.clientWidth+b,m=a.clientHeight+c,n=window.setInterval(function(){var p=EWA$UI$COMMON.GetObjSize(a);if(g<d-1){var r=p.H+k,q=p.W+h;r>m&&(r=m);q>l&&(q=l);EWA$UI$COMMON.SetSize(a,q,r)}else EWA$UI$COMMON.SetSize(a,l,m);q=EWA$UI$COMMON.GetObjSize(a);r=q.W-p.W;q=q.H-p.H;p=EWA$UI$COMMON.GetPosition(a);
p.Y=p.Y-a.clientHeight-1*a.style.borderTopWidth.replace("px","")-1*a.style.borderBottomWidth.replace("px","");"LEFT_TOP"!=e&&("LEFT_BOTTOM"==e?(q=p.Y-q,r=p.X,EWA$UI$COMMON.MoveTo(a,r,q)):"RIGHT_TOP"==e?(q=p.Y,r=p.X-r,EWA$UI$COMMON.MoveTo(a,r,q)):"RIGHT_BOTTOM"==e?(q=p.Y-q,r=p.X-r,EWA$UI$COMMON.MoveTo(a,r,q)):(q=1*p.Y-q/2,r=1*p.X-r/2,EWA$UI$COMMON.MoveTo(a,r,q),EWA._TmpAniObj=a));g++;g>=d&&(window.clearInterval(n),EWA.UI.Utils.AniExpandCompleateFunction&&(EWA.UI.Utils.AniExpandCompleateFunction(),
EWA.UI.Utils.AniExpandCompleateFunction=null))},12)},AniExpandTo:function(a,b,c,d,e){if(null==d||0>=d)d=10;var g=EWA$UI$COMMON.GetObjSize(a);this.AniExpand(a,b-g.W,c-g.H,d,e)},SetSize:function(a,b,c){a.style.width=b+"px";a.style.height=c+"px"},MoveTo:function(a,b,c){a.style.left=b+"px";a.style.top=c+"px"},MoveCenter:function(a){var b=this._GetOwnerWindow(a),c=this.GetObjSize(a);b=this.GetDocSize(b);this.MoveTo(a,(b.W-c.W)/2,(b.H-c.H)/2)},GetObjSize:function(a){return{H:a.clientHeight,W:a.clientWidth}},
...
EWA_COMMON_MV_OBJECT,c=b.B;if("1"==c.getAttribute("_EWA_MOUSE_DOWN")){a=this._GetEventXY(a);var d=1*c.getAttribute("_EWA_MOUSE_X"),e=1*c.getAttribute("_EWA_MOUSE_Y"),g=a.X-d,h=a.Y-e;if(!(Math.abs(g)<this.MoveStep&&Math.abs(h)<this.MoveStep)){e=b.L;d=1*$(c).css("left").replace("px","")+g;var k=1*$(c).css("top").replace("px","")+h;if("MOVE"==b.T)null==e?(0>d&&(d=0),0>k&&(k=0)):(g=c.offsetWidth,h=c.offsetHeight,d<e.Left?d=e.Left:d+g>e.Right&&(d=e.Right-g),g=e.Right-(d+g),k<e.Top?k=e.Top:k+h>e.Bottom&&
(k=e.Bottom-h),e=e.Bottom-(k+h),c.setAttribute("ewa_mv_left",d.fm(0)),c.setAttribute("ewa_mv_top",k.fm(0)),c.setAttribute("ewa_mv_bottom",e.fm(0)),c.setAttribute("ewa_mv_right",g.fm(0))),this.IsMoveX&&b.MOVE_X&&(c.style.left=d+"px"),this.IsMoveY&&b.MOVE_Y&&(c.style.top=k+"px");else{var l=1*c.style.width.replace("px","")+g,m=1*c.style.height.replace("px","")+h;10>l&&(l=10);10>m&&(m=10);if(null!=e)if(null!=b.M){var n=1*b.M.Width/b.M.Height;if(1==n){c.style.width.replace("px","");a=Math.sqrt(g*g+h*h);
if(0<h||0>g)a*=-1;a={left:$(c).position().left-a/4,top:$(c).position().top-a/4,width:$(c).width()+a/2,height:$(c).height()+a/2};if(a.height+a.top>e.Bottom||a.top<e.Top||a.left+a.width>e.Right||a.left<e.Left||50>a.width)return;$(c).css(a);b.JSM&&b.JSM(b.B,b.A);return}g=l/m;g>n?m=l/n:g<n&&(l=m*n);d+l>e.Right&&(l=e.Right-d,m=l/n);k+m>e.Bottom&&(m=e.Bottom-k,l=m*n)}else d+l>e.Right&&(l=e.Right-d),k+m>e.Bottom&&(m=e.Bottom-k);this.IsMoveX&&(c.style.width=l+"px");this.IsMoveY&&(c.style.height=m+"px")}c.setAttribute("_EWA_MOUSE_X",
...
function EWA_UI_MenuClass(a){this.ClassName=a;this.MenuShowType="";this.Dialog=null;this.Dialogs=[];this.clickedItem=this._ItemsDiv=this._LastObj=null;this.Click=function(b,c){this.clickBeforeEvent&&this.clickBeforeEvent(b,c);"LEFT"!=this.MenuShowType&&(null!=this._LastObj&&(this._LastObj.className=this._LastObj.className.replace("_mv1","")),this._LastObj=null,"undefined"!=typeof b.stopPropagation?b.stopPropagation():b.cancelBubble=!0,this._HiddenDialogs());EWA.C.Utils.RunCmd(c);this.clickAfterEvent&&
this.clickAfterEvent(b,c)};this.OnClick=function(b,c){this.clickedItem=c;if("LEFT"==this.MenuShowType){var d=c.parentNode.parentNode,e=c.parentNode,g=c.parentNode.parentNode.childNodes[1];if(null==g)return;0==g.childNodes.length?(this._LastCkObj&&(this._LastCkObj.style.backgroundColor=""),e.style.backgroundColor="#ccc",this._LastCkObj=e):("none"==g.style.display?(g.style.display="",$(d).addClass("ewa-lmenu-show")):($(d).removeClass("ewa-lmenu-show"),g.style.display="none"),window.event?b.cancelBubble=
!0:b.stopPropagation())}else if(""==c.getAttribute("EWA_MF_PID")&&(this._HiddenDialogs(),0>=this.Dialogs.length&&this.Dialogs.push(this._CreateDialog()),0<this._ShowPullDownMenu(c,this.Dialogs[0]))){this.ShowByObject(c,this.Dialogs[0],0);return}this.Click(b,c)};this._CalcLevel=function(b){for(var c=0;""!=b.getAttribute("EWA_MF_PID");)if(c+=1,b=document.getElementById(b.getAttribute("EWA_MF_PID")),null==b)return null;return c};this._ShowPullDownMenu=function(b,c){for(var d=$X(c.FrameContent).childNodes[0].rows[0].cells[0];0<
d.childNodes.length;)this._ItemsDiv.appendChild(d.childNodes[0]);for(var e=[],g=0;g<this._ItemsDiv.childNodes.length;g++){var h=this._ItemsDiv.childNodes[g];0<h.innerHTML.toUpperCase().indexOf("<HR")||(h.style.paddingRight="10px");h.getAttribute("EWA_MF_PID")==b.id&&e.push(h)}b=e.length;for(g=0;g<e.length;g++){d.appendChild(e[g]);if(this._CheckChildren(e[g].id)){h=e[g].childNodes[0].rows[0].cells[2];if(null==h.getAttribute("gdx")||""==h.getAttribute("gdx"))h.innerHTML+=" +",h.setAttribute("gdx","gdx");
e[g].setAttribute("EWA_MF_CHILD","1")}else e[g].setAttribute("EWA_MF_CHILD","0");e[g]=null}e.length=0;$X(c.FrameContent).childNodes[0].style.height="auto";return b};this._CheckChildren=function(b){for(var c=0;c<this._ItemsDiv.childNodes.length;c++)if(this._ItemsDiv.childNodes[c].getAttribute("EWA_MF_PID")==b)return!0;return!1};this.InstallMenus=function(b,c,d){if("METRO"==d){var e=[],g={};$(".ewa_menu_m").each(function(){var m=$(this),n={};n.id=m.attr("id");n.pid=m.attr("EWA_MF_PID");n.url=m.attr("EWA_CMD");
n.icon=m.find(".ewa_menu_m0").attr("class");n.title=m.text().trim();n.icon&&(n.icon=n.icon.replace("ewa_menu_m0","").trim());""==n.pid?(n.pid="0",n.subs=[],g[n.id]=n,e.push(n)):g[n.pid].subs.push(n)});EWA_UI_Metro.menus=e;EWA_UI_Metro.add_menus(e,"EWA_FRAME_MAIN","item",null,null,!0)}else{this.MenuShowType=d;d=$X(b);var h=$X(c);if(null==h)alert("MenuShow defined error ("+c+")");else{this._ItemsDiv=d;c=[];h.innerHTML="<table onselectstart='return false' style='cursor:pointer;-moz-user-select:none;' border=0 cellspacing=0 cellpadding=0></table>";
h=h.childNodes[0];for(var k=0;k<d.childNodes.length;k++){var l=d.childNodes[k];"DIV"==l.tagName&&""==l.getAttribute("EWA_MF_PID")&&c.push(l)}if(""==this.MenuShowType||"TOP"==this.MenuShowType)for(h.insertRow(-1),k=0;k<c.length;k++)h.rows[0].insertCell(-1).appendChild(c[k]);else h.style.width="100%",this._InstallMenusLeft(h,d,c,b);c.length=0;c=null}}};this._InstallMenusLeft=function(b,c,d,e){$(b).addClass("ewa-lmenu");for(var g=0;g<d.length;g++){var h=b.insertRow(-1).insertCell(-1);e=document.createElement("div");
e.innerHTML='<div class="ewa_lmenu_bar" des="rq1"></div><div  des="rq2"></div>';e.childNodes[1].style.paddingLeft="5px";h.appendChild(e);d[g].style.height="100%";e.childNodes[0].appendChild(d[g]);0==g?$(e).addClass("ewa-lmenu-show"):e.childNodes[1].style.display="none"}for(b=c.childNodes;0<c.childNodes.length;)d=b[0],g=d.getAttribute("EWA_MF_PID"),e=document.createElement("div"),e.innerHTML='<div class="ewa_lmenu_bar1"></div><div style="padding-left:4px;display:none"></div>',$X(g)?(g=$X(g).parentNode.parentNode,
...
for(var d=0;d<b.length;d+=1){var e=b[d];c.push("<div class='ewa_menu_m' EWA_MG=\""+e.Group+"\" style='cursor:pointer' EWA_CMD=\""+e.Cmd+"\" onclick='"+this.ClassName+".Click(event,this);' onmouseover='"+this.ClassName+".MouseOver(this);'><table boder=0 width=100% cellpadding=0 cellspacing=0>");0<=e.Txt.toUpperCase().indexOf("<HR")?c.push("<tr><td colspan=2 style='white-space:nowrap'>"+e.Txt+"</td></tr></table></div>"):(c.push("<tr><td class='ewa_menu_m0'>"),e=b[d].Img,null!=e&&0>e.indexOf("index=0,size=0")&&
0<e.trim().length&&(0<=e.indexOf("fa")?c.push('<i class="'+e+'"></i>'):c.push('<img src="'+b[d].Img+'">')),c.push("</td><td class='ewa_menu_m1' style='white-space:nowrap'>"+b[d].Txt+"</td></tr></table></div>"))}c.push("</div>");this.Dialog.SetHtml(c.join(""))}};this.HiddenMemu=function(){this.Dialog.Show(!1);EWA.UI.CurMenu=null};this.ShowByObject=function(b,c,d){var e=EWA.UI.Utils.GetPosition(b);this.SHOW_BY_OBJECT=b;c=c||this.Dialog;null==d||0==d?c.Move(e.X,e.Y):c.Move(e.X+b.offsetWidth-5,e.Y-b.offsetHeight+
4);c.Show(!0);$(c.GetFrame()).find(".ewa_menu_box").attr("open_time",(new Date).getTime());c.ResizeByContent()};this.ShowByMouse=function(b,c){if(this.Dialog){var d=0,e=$X(this.Dialog.FrameContent).childNodes[0];if(null==c)d=e.childNodes.length;else for(var g=0;g<e.childNodes.length;g++)e.childNodes[g].getAttribute("EWA_MG")==c||null==c||""==c?(e.childNodes[g].style.display="",d++):e.childNodes[g].style.display="none";0<d?(c=b.x?b.x:b.pageX,b=b.y?b.y:b.pageY,b+=document.documentElement.scrollTop||
...
k.all||1==k.all)&&n.push(t.innerHTML)}}!this._is_load_main_menu&&this.menuLoadInRight&&(parent.$("#RIGHT").html(n.join("")),parent.$("#RIGHT .item").each(function(){$(this).append($(this).attr("_title"));$(this).attr("onmouseout",null);$(this).attr("onmouseover",null);$(this).attr("onclick","EWA_UI_Metro.right_show_menu_sub(this,event)")}));this._is_load_main_menu=!0},add_menu_item:function(a,b,c,d,e,g){if(c||b){var h=a.insertCell(-1);h.innerHTML="<div class='"+e+"'><i id='memu_item_"+d+"'></i></div>"}if(b)return a=
$(h).find("i"),c=a.parent(),b.icon&&0<b.icon.trim().length?0==b.icon.indexOf("fa")?a.attr("class",b.icon):(c.append("<table width=100% height=100%><tr><td align=center><img style='max-width:90%;max-height:90%' src='"+b.icon+"' /></td></tr></table>"),a.hide()):b.img&&(c.append("<table width=100% height=100%><tr><td align=center><img  src='"+b.img+"' /></td></tr></table>"),a.hide()),c.attr("_title",b.title),c.attr("onmouseover","EWA_UI_Metro.show_title(this)"),c.attr("onmouseout","$('.pop_title').hide()"),
c.attr("hid",g),b.url?(c.attr("u",b.url),c.attr("onclick","EWA_UI_Metro.item_click(this,event)")):b.subs&&(c.attr("subs",JSON.stringify(b.subs)),c.attr("onclick","EWA_UI_Metro.show_menu_sub(this,event)")),h.id="M_"+b.id,h},show_menu_sub:function(a){var b=$(a),c=b.attr("class"),d=b.attr("hid");window.last_open&&window.last_open!=a&&window.last_open.click();if(1==b.attr("is_open"))b.attr("is_open","0"),$X(d).style.display="none",window.last_open=null,b.attr("class",c.split(" ")[0]);else{b.attr("is_open",
...
b.childNodes[0];return b};this._CreateImgHtml=function(b,c,d){return"<img src='"+((null==EWA.RV_STATIC_PATH?EWA.CP:EWA.RV_STATIC_PATH)+"/EWA_STYLE/images/tip/"+b)+"' width="+c+" height="+d+">"};this._SetBackgound=function(b,c){b.style.backgroundImage="url('"+((null==EWA.RV_STATIC_PATH?EWA.CP:EWA.RV_STATIC_PATH)+"/EWA_STYLE/images/tip/"+c)+"')";b.style.backgroundRepeat="repeat-x"};this._InitTableImgForground=function(b){b.className="ewa-tip-for";b.rows[2].cells[1].onmouseover=function(){window.clearInterval(__EMP_TIP_TIMER_SHOW);
...
b.rows[3].cells[0].className="ewa-tip-bl";b.rows[3].cells[1].className="ewa-tip-bm";b.rows[3].cells[2].className="ewa-tip-br"};this._InitTableImgBackground=function(b){};this._InitTable=function(){var b=this.ParentWindow.document.createElement("table"),c=b.insertRow(-1);c.insertCell(-1);for(var d=0;3>d;d++){c=b.insertRow(-1);for(var e=0;3>e;e++)c.insertCell(-1).style.fontSize=1==d&&1==e?"12px":"1px"}c=b.insertRow(-1);c.insertCell(-1);b.border=0;b.cellSpacing=0;b.cellPadding=0;b.style.fontSize="1px";
b.rows[0].cells[0].colSpan=3;b.rows[4].cells[0].colSpan=3;return b};this.ShowTip=function(b,c,d){window.clearInterval(__EMP_TIP_TIMER_SHOW);__EMP_TIP_TIMER_SHOW=null;this.TipFrame.style.display="";this._ForTable.rows[2].cells[1].innerHTML=b;b=this._ForTable.offsetWidth;this._ForTable.style.width=this._ForTable.rows[2].cells[1].offsetWidth+12+"px";var e=c-b/4+14;0>e?e=12:null!=this._ShowDocument&&b+e>this._ShowDocument.body.offsetWidth&&(e=this._ShowDocument.body.offsetWidth-b-2);this.TipFrame.style.left=
e+"px";this.TipFrame.style.top=d+3+"px";e=c-e;c=e+3;var g="/EWA_STYLE/images/tip/image048.gif";d="/EWA_STYLE/images/tip/image013.png";e<b/2&&0<e-32&&(g="/EWA_STYLE/images/tip/image050.gif",d="/EWA_STYLE/images/tip/image015.png",e-=32,0>e&&(e=4),c=e-3);b=document.all?6:9;var h=null==EWA.RV_STATIC_PATH?EWA.CP:EWA.RV_STATIC_PATH;this._ForTable.rows[0].cells[0].innerHTML="<img src='"+h+g+"' width=32 height=21 style='position: relative; left: "+e+"px; top: "+b+"px'>";e="<img src='"+h+d+"' width=37 height=21 style='position: relative; left: "+
c+"px; top: "+b+"px'>";document.all&&(e="<div style=\"filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+(h+d)+"', sizingMethod='scale'); position: relative; left: "+c+"px; top: "+b+'px; width:37px; height:21px"></DIv>');this._BakTable.rows[0].cells[0].innerHTML=e;this.TipFrame.style.display=""};this.HiddenTip=function(){__EMP_TIP_CLASS=this;null!=__EMP_TIP_TIMER_SHOW&&window.clearInterval(__EMP_TIP_TIMER_SHOW);__EMP_TIP_TIMER_SHOW=window.setInterval(EMP_TIP_HIDE,500)};this.GetObjectLocation=
...
c.cellSpacing=0;for(var d=c.cellPadding=0;2>d;d++)for(var e=c.insertRow(-1),g=0;2>g;g++)e.insertCell(-1).innerHTML="&nbsp;";document.body.appendChild(c);this.LinkObj=c};this.Link=function(){null==this.LinkObj&&this._CreateLinkObj();this.LinkObj.rows[0].cells[0].style.border="";this.LinkObj.rows[0].cells[1].style.border="";this.LinkObj.rows[1].cells[0].style.border="";this.LinkObj.rows[1].cells[1].style.border="";var c=this.getSize(this.LinkObj1),d=this.getSize(this.LinkObj2);if(c.X+c.W<d.X){var e=
...
b,c,d,e,"RELOAD_PARENT",g,h)},OpenReloadClear:function(a,b,c,d,e,g,h){EWA.UI.Dialog.OpenFrame(a,b,c,d,e,"RELOAD_PARENT,CLEAR_SELF",g,h)},OpenFrame:function(a,b,c,d,e,g,h,k){null==g&&(g="");__Dialog[a]||(__Dialog[a]={});__Dialog[a].AfterMsg=null==h?"":h;if("yes"==k&&EWA.F&&EWA.F.FOS[a]&&EWA.F.FOS[a].Url){k=new EWA_UrlClass(EWA.F.FOS[a].Url);k.RemoveEwa();e=new EWA_UrlClass("a1?"+e);for(var l in e._Paras)h=e.GetParameter(l),k.AddParameter(l,h);e=k.GetParas()}g="EWA_P_BEHAVIOR="+g+"&EWA_PARENT_FRAME="+
a;a=EWA.UI.Dialog.GetUrl(b,c,e?e+"&"+g:g);EWA.UI.Dialog.OpenWindow(a,b+"-"+c,100,50,d)},OpenWindow:function(a,b,c,d,e,g,h,k){var l=void 0===k?!0:k;var m=e?window:EWA.UI.Dialog._GetTopWindow();e=a;null!=e&&"about:blank"!=e&&(e=0<a.indexOf("?")?e+("&_r="+Math.random()):e+("?_r="+Math.random()));e=e.replace(/\|/ig,"%7c");a="_EWA_UI_DIALOG_"+b;EWA.UI.Dialog.WND[a]=null;EWA.UI.Dialog.WND[a]=new EWA.UI.Dialog.C(m,l);l=EWA.UI.Dialog.WND[a];l.Id=a;l.DisposeOnClose=k;l.Create(c,d,b);null!=e&&l.SetUrl(e);null!=
g&&l.SetCallBack(g);null!=h&&l.SetReturnBack(h);__Dialog.TimerInc=0;l._TimerHandle=window.setInterval(EWA.UI.Dialog._DialogMointer,155);l._IncNoIe=0;EWA.UI.Dialog.WNDCUR=l;return EWA.UI.Dialog.WND[a]},GetUrl:function(a,b,c){return EWA.CP+"/EWA_STYLE/cgi-bin/?XMLNAME="+a.toURL()+"&ITEMNAME="+b.toURL()+"&"+c}};
...
this.Id]=this;this.SetContent(d,e,h);return this};this.SetSize=function(a,b){var c=$("#"+this.Id+"_content");a||(a=document.documentElement.clientWidth,a=410<a?400:300<a?a-10:300);b=b?b:200;c.css("width",a);c.css("height",b);0<$("#"+this.Id+"_title span").length&&(title_height=$("#"+this.Id+"_title").height())};this.SetTitle=function(a){a&&$("#"+this.Id+"_title span").html(a)};this.getTitleContainer=function(){var a=$("#"+this.Id+"_title");return 0==a.length?null:a[0]};this.SetContent=function(a,
...
$DialogInstall=function(a,b,c,d,e,g){var h=EWA_Utils.tempId("dialogInstall"),k=$DialogHtml("<div id='"+h+"'></div>","",c,d,e);$Install(a,h,function(){var l=!(c&&d);if(e||b)l&&k.AutoSize(),g&&g(k,p);else{var m=k.getContent(),n=$(m).find(".EWA_TABLE");if(0!=n.length&&n[0].id){var p=n[0].id;n=p.replace("EWA_FRAME_","").replace("EWA_LF_","");if(EWA&&EWA.F&&EWA.F.FOS&&EWA.F.FOS[n])if(n=EWA.F.FOS[n].Title,p.startsWith("EWA_LF_"))var r=0,q=setInterval(function(){r++;if(90<r)window.clearInterval(q),l&&k.AutoSize(),
g&&g(k,p);else{var t=$(m).find(".ewa_lf_func");if(0!=t.length){window.clearInterval(q);var v=k.getTitleContainer();if(v){t.css({"background-color":"transparent",display:"block","float":"left","font-size":"14px"});var u=t.find(".ewa_lf_func_caption");u.css("color","#08c");u.text(u.text().replace("[","").replace("]","").trim());$(v).find("span:eq(0)").remove();$(v).append(t).css("border-bottom","1px solid #eee")}l&&k.AutoSize();g&&g(k,p)}}},10);else n&&k.SetTitle(n),l&&k.AutoSize(),g&&g(k,p);else l&&
k.AutoSize(),g&&g(k,p)}else l&&k.AutoSize(),g&&g(k,p)}});return k};
function EWA_UI_CalendarYearClass(){this.Create=function(a,b,c,d,e){console.log(b,c,d);this.classId=("CY"+Math.random()).replace(".","");EWA.UI.CalendarYear=EWA.UI.CalendarYear||{};EWA.UI.CalendarYear[this.classId]=this;$($X(a)).append('<div class="ewa-ui-calendar-year" id="'+this.classId+'"></div>');a=$("#"+this.classId);var g=new EWA_CalendarClass,h=new Date;b&&c&&(h=new Date(b,c-1,1));b=c=h.getMonth();e||(b=3*Math.round(c/3-.5));e=h.getFullYear();if(!d||0>=d)d=12;for(h=1;h<=d;h++){if("enus"==EWA.LANG){var k=
b+1+"/"+e;g.SetDate("dd/MM/yyyy"==_EWA_G_SETTINGS.DATE?"01/"+(b+1)+"/"+e:b+1+"/01/"+e)}else k=e+"-"+(b+1),g.SetDate(k+"-01");c=g.CreateCalendar();var l=this.classId+"_"+e+"_"+b;c.id=l;c.setAttribute("yearmonth",e+(10>b?"0":"")+b);a.append(c);$(c.rows[3]).remove();$(c.rows[0].cells[1]).remove();k="<a href='javascript:EWA.UI.CalendarYear."+this.classId+'.chooeseMonth("'+l+"\",event)'>"+k+"</a>";$(c.rows[0].cells[0]).html(k);$(c).find("th").attr("onclick","EWA.UI.CalendarYear."+this.classId+".chooeseWeek('"+
l+"',this, event)");b++;12==b&&(b=0,e++);$(c).find("th:eq(0)").addClass("rq-sun");$(c).find("th:eq(6)").addClass("rq-sat")}a.append('<div style="clear:both"></div>');a.find(".ewa-ui-days td").attr("onclick","EWA.UI.CalendarYear."+this.classId+".Click(this,event)");_EWA_CALENDAR_ITEM=g};this.chooeseWeek=function(a,b,c){var d=b.cellIndex;a=$("#"+a).find(".ewa-ui-days")[0];for(var e=$(b).attr("chooese"),g=[],h=1;h<a.rows.length;h++){var k=a.rows[h].cells[d];0!=k.childNodes.length&&(e?$(k).removeClass("ewa-ui-calendar-year-chooese").attr("chooese",
null):$(k).addClass("ewa-ui-calendar-year-chooese").attr("chooese",1),g.push($(k).find("div:eq(0)").attr("title")))}e?$(b).attr("chooese",null):$(b).attr("chooese",1);this.ClickEvent&&this.ClickEvent(g,!e,c)};this.chooeseMonth=function(a,b){var c=$("#"+a),d=c.attr("all1"),e=[];d?(c.attr("all1",null),$("#"+a+" .ewa-ui-days .ewa-ui-calendar-year-chooese").each(function(){$(this).removeClass("ewa-ui-calendar-year-chooese").attr("chooese",null);e.push($(this).find("div:eq(0)").attr("title"))}),c.find("th").attr("chooese",
...
{};EWA.UI.CalendarYear[this.classId]=this;$($X(a)).append('<div class="ewa-ui-calendar-year" id="'+this.classId+'"></div>');a=$("#"+this.classId);var k=new Date;b&&c&&(k=new Date(b,c-1,1));b=c=k.getMonth();e||(b=3*Math.round(c/3-.5));e=k.getFullYear();if(!d||0>=d)d=12;k=new EWA_CalendarClass;for(c=1;c<=d;c++){var l=b+1;if("enus"==EWA.LANG){var m=l+"/"+e;k.SetDate("dd/MM/yyyy"==_EWA_G_SETTINGS.DATE?"01/"+l+"/"+e:l+"/01/"+e)}else m=e+"-"+(b+1),k.SetDate(m+"-01");var n=k.CreateCalendar(),p=e+(10>l?"0":
"")+l;l=this.classId+"_"+p;n.id=l;n.setAttribute("yearmonth",p);a.append(n);$(n.rows[3]).remove();$(n.rows[0].cells[1]).remove();m="<a href='javascript:EWA.UI.CalendarYear."+this.classId+'.chooeseMonth("'+l+"\",event)'>"+m+"</a>";$(n.rows[0].cells[0]).html(m);$(n).find("th").attr("onclick","EWA.UI.CalendarYear."+this.classId+".chooeseWeek('"+l+"',this, event)");b++;12==b&&(b=0,e++);$(n).find("th:eq(0)").addClass("rq-sun");$(n).find("th:eq(6)").addClass("rq-sat")}a.append('<div style="clear:both"></div>');
a.find(".ewa-ui-days td").attr("onclick","EWA.UI.CalendarYear."+this.classId+".Click(this,event)");_EWA_CALENDAR_ITEM=k;g&&this.denysBefore(g);h&&this.denysAfter(h)};this.getChooeseName=function(){return this.CUR_GROUP_NAME?this.CUR_GROUP_NAME:"chooese"};this.addOrRemoveMark=function(a,b,c){var d=this.getChooeseName(),e=$(a);b?(e.find("."+d).remove(),e.attr(d,null),this.unMarkEvent&&this.unMarkEvent(a,c)):0==e.find("."+d).length&&(e.append("<nobr class='ewa-ui-calendar-year-item "+d+"'></nobr>"),
e.attr(d,1),this.markEvent&&this.markEvent(a,c));e.attr("_last_item_count_")&&e.removeClass(e.attr("_last_item_count_"));a=e.find(".ewa-ui-calendar-year-item").length;0<a?(e.addClass("ewa-ui-calendar-year-chooese"),a=100>a?"N"+a:"NP",e.addClass("N "+a).attr("_last_item_count_",a)):e.removeClass("ewa-ui-calendar-year-chooese").removeClass("N")};this.chooeseWeek=function(a,b,c){for(var d=$("#"+a).find(".ewa-ui-days")[0],e=this.getChooeseName(),g=[],h=b.cellIndex,k=!0,l=!1,m=1;m<d.rows.length;m++){var n=
d.rows[m].cells[h];if(0!=n.childNodes.length&&($(n).attr("deny")||(l=!0),$(n).attr(e)||(k=!1),l&&!k))break}if(!l)$Tip("\u6ca1\u6709\u53ef\u9009\u7684\u65e5\u671f");else if(!this.ClickBeforeEvent||this.ClickBeforeEvent(a,b,c,"WEEK")){for(m=1;m<d.rows.length;m++)n=d.rows[m].cells[h],0==n.childNodes.length||$(n).attr("deny")||(a=$(n).find("div:eq(0)").attr("title"),g.push(a),this.addOrRemoveMark(n,k,a));k?$(b).attr(e,null):$(b).attr(e,1);this.ClickEvent&&this.ClickEvent(g,!k,c)}};this.chooeseMonth=function(a,
b){for(var c=$("#"+a+" .ewa-ui-days")[0],d=this.getChooeseName(),e=!0,g=!1,h=1;h<c.rows.length;h++){for(var k=c.rows[h],l=0;l<k.cells.length;l++){var m=k.cells[l];0!=m.childNodes.length&&(g||$(m).attr("deny")||(g=!0),$(m).attr(d)||(e=!1))}if(!e&&g)break}if(!g)$Tip("\u6ca1\u6709\u53ef\u9009\u7684\u65e5\u671f");else if(!this.ClickBeforeEvent||this.ClickBeforeEvent(a,null,b,"MONTH")){a=[];for(h=1;h<c.rows.length;h++)for(k=c.rows[h],l=0;l<k.cells.length;l++)m=k.cells[l],0==m.childNodes.length||$(m).attr("deny")||
(d=$(m).find("div:eq(0)").attr("title"),a.push(d),this.addOrRemoveMark(m,e,d));this.ClickEvent&&this.ClickEvent(a,!e,b)}};this.SetChooeses=function(a,b,c,d){this._RQ_MAP=null;var e=$("#"+this.classId);e.find(".ewa-ui-days td");for(var g in a){var h=a[g],k=h[b];if(k){c&&this.setGroupName(h[c]);k=k.split(" ")[0];var l=this.findTdByRq(k);l&&0<l.length?(this.addOrRemoveMark(l,!1,k),d&&d(l[0],k,h)):console.log("\u65e0\u6548\u7684\u65e5\u671f"+k)}}this._RQ_MAP=null;e.find(".ewa-ui-date").each(function(){$(this).find(".ewa-ui-calendar-year-chooese").length==
$(this).find("td div[title]").length&&($(this).attr("all1","yes"),$(this).find("th").attr("chooese","yes"))})};this.findTdByRq=function(a){if(!a)return null;if(!this._RQ_MAP)this._RQ_MAP={};else if(this._RQ_MAP[a])return this._RQ_MAP[a];var b=a.replace(/-/ig,""),c=b.substring(0,6);c=$("#"+this.classId+" table[yearmonth='"+c+"']");if(0==c.length)return this._RQ_MAP[a]=null;this._RQ_MAP[a]=c.find("div[date='"+b+"']").parent();return this._RQ_MAP[a]};this.GetChooeses=function(a){var b=[];(a?$(a):$("#"+
...
a=this._CurDate.getDate(),this._DaysTable&&this._DaysTable.setAttribute("EMP_CURRENT_DAY",a))};this._CreateTime=function(){var a=this._CurDate,b=this.CreateWindow.document.createElement("div"),c=this.CreateWindow.document.createElement("select"),d=this.CreateWindow.document.createElement("select"),e=this.CreateWindow.document.createElement("span");"enus"==EWA.LANG.toLowerCase()?e.innerHTML="Time ":e.innerHTML="\u65f6\u95f4 ";var g=this.CreateWindow.document.createElement("span");g.innerHTML=":";for(var h=
0;24>h;h++){var k=10>h?"0"+h:h+"";c.options[c.options.length]=new Option(k,k)}c.value=(100+a.getHours()+"").substring(1);b.appendChild(e);b.appendChild(c);b.appendChild(g);b.appendChild(d);c=this.CreateWindow.document.createElement("span");c.innerHTML="&nbsp;";e=this.CreateWindow.document.createElement("span");e.style.cursor="pointer";e.style.color="blue";e.setAttribute("IS_ALL",0);e.onclick=function(){d.options.length=0;if(1==this.getAttribute("IS_ALL")){for(var l=0;12>l;l++){var m=(100+5*l+"").substring(1);
d.options[d.options.length]=new Option(m,m)}l=a.getMinutes();l=0==l%5?l:5*parseInt(l/5);d.value=(100+l+"").substring(1);this.setAttribute("IS_ALL",0);this.innerHTML="\u5168\u90e8"}else{for(l=0;60>l;l++)m=(100+l+"").substring(1),d.options[d.options.length]=new Option(m,m);l=a.getMinutes();d.value=(100+l+"").substring(1);this.setAttribute("IS_ALL",1);this.innerHTML="\u6bcf5\u5206\u949f"}};b.appendChild(c);b.appendChild(e);return b};this.CreateTime=function(){var a=[];a.push("<table border=0 class='ewa-ui-date-picker' style='border:1px solid #aaa' bgcolor='#E1E1E1' onselectstart='return false'>");
...
function EWA_UI_MsgClass(a,b){this._IsSelfWindow=b;this._Dialog=null;this._Msg=a;this._Buttons=[];this._Caption=null;this._Icon="MSG_ICON";this.SetIcon=function(c){this._Icon=c};this.SetCaption=function(c){this._Caption=c};this.AddButton=function(c,d){this._Buttons.push({Text:c,Event:d})};this.AddButtons=function(c){if(null!=c)for(var d=0;d<c.length;d++)this._Buttons.push(c[d])};this._Init=function(){this._Dialog=__Dialog.OpenWindow("about:blank",Math.random(),500,200,this._IsSelfWindow);this._Dialog._FromMsgClass=
this;this._Dialog.SetHtml(this._CreateHtml());this._Dialog.SetCaption(this._Caption);var c=this._Dialog._Dialog.GetFrameContent().getElementsByTagName("table")[0],d=this._Dialog._Dialog.GetFrame();d.style.width=c.clientWidth+"px";d.style.height=c.clientHeight+"px"};this._CreateHtml=function(){var c=[];c.push("<table border=0 class='MSG_INFO'>");c.push("<tr><td rowspan=2 style='width:130px;' align='center'>");c.push("<div class='"+this._Icon+"'>&nbsp;</div></td>");c.push("<td class='MSG_TEXT'>");c.push(this._Msg);
c.push("</td></tr>");c.push("<tr><td class='MSG_BUTS'>");var d=this._CloseWindowJs();if(0<this._Buttons.length){c.push("<hr><table><tr>");for(var e=0;e<this._Buttons.length;e++){var g=this._Buttons[e];c.push("<td>");var h="<button _ewa_msg_default='"+(g.Default?1:0)+"'  type='button' _ewa_dialog_='"+this._Dialog.Id+"' ";h=g.Event&&"function"==typeof g.Event?h+(" onclick=\"_EWA_UI_WINDOW_LIST[this.getAttribute('_ewa_dialog_')]._FromMsgClass.fire("+e+')">'+g.Text+"</button>"):h+(' onclick="'+(g.Event?
g.Event+";"+d:d)+'">'+g.Text+"</button>");c.push(h);c.push("</td>")}c.push("</tr></table>")}c.push("</td></tr></table>");return c.join("")};this.fire=function(c){if((c=this._Buttons[c])&&c.Event)try{c.Event(this)}catch(d){console.log(d)}this.Hidden()};this._CloseWindowJs=function(){return"var a=this.getAttribute('_ewa_dialog_'); _EWA_UI_WINDOW_LIST[a].CloseWindow();"};this.Show=function(c,d){null==this._Dialog&&this._Init();if(c)if(c=this._Dialog._ParentWindow.document.getElementsByTagName("button"),
d){var e=[];for(d=0;d<c.length;d++){var g=$(c[d]);g.attr("_ewa_dialog_")==this._Dialog.Id&&(g.prop("disabled",!0),e.push(g))}setTimeout(function(){for(var h in e)e[h].prop("disabled",!1)},435)}else for(this._Dialog.ResizeByContent(),this._Dialog.MoveCenter(),d=0;d<c.length;d++)if(1==c[d].getAttribute("_ewa_msg_default")&&c[d].getAttribute("_ewa_dialog_")==this._Dialog.Id){c[d].focus();break}};this.Hidden=function(){this.Show(!1);this._Dialog.CloseWindow()}}
EWA.UI.Msg={IS_IN_APP:!1,C:EWA_UI_MsgClass,Show:function(a,b,c,d){if(0<a.indexOf("(")&&a.trim().endsWith(")"))try{a=eval(a)}catch(e){console.log(a)}a=new EWA_UI_MsgClass(a);a.SetCaption(c);a.AddButtons(b);a.SetIcon(d);a.Show(!0,EWA.UI.Msg.IS_IN_APP);return a},ShowInfo:function(a,b,c){__EWA_MSG__=EWA.UI.Msg.Show(a,b,c,"MSG_ICON");$(__EWA_MSG__._Dialog._Dialog.GetFrame()).addClass("ewa-msg-info");return __EWA_MSG__},ShowError:function(a,b){var c=[];c[0]={Text:_EWA_INFO_MSG["BUT.OK"],Event:null,Default:!0};
...
a;var g=setInterval(function(){d()&&(window.clearInterval(g),$(e).animate({opacity:0},200,function(){$(e).remove()}))},300)}else{b.innerHTML=a;if(!d||isNaN(d))d=1500;setTimeout(function(){$(e).animate({opacity:0},200,function(){$(e).remove()})},d)}},Tip:function(a,b){var c={width:300,height:80,padding:10,"background-color":"rgba(10,20,30,0.7)",position:"fixed",top:"50%",left:"50%","margin-left":-150,"margin-top":-60,"border-radius":10,"z-index":window._EWA_UI_DIALOG_COVERINDEX?window._EWA_UI_DIALOG_COVERINDEX+
...
"font-size":12,"line-height":1.5},b)}};$Mark=function(a,b){var c=1E3*b||3E3,d="<div class='ewa-mark' style='transition-duration:"+(b||3)+"s;'></div>";$(a).each(function(){var e=$(d),g=$(this).offset();g={left:g.left+2,top:g.top-2,width:$(this).outerWidth(),height:$(this).outerHeight()};e.css(g);$("body").append(e);setTimeout(function(){e.css("opacity",0)},10);setTimeout(function(){e.remove()},c+10)})};$Confirm=EWA.UI.Msg.Confirm;$Tip=EWA.UI.Msg.Tip;$TipBR=EWA.UI.Msg.TipBR;$TipBL=EWA.UI.Msg.TipBL;
...
this.CSS.center.replace("[BGCOLOR]",g);g=this.CSS.rightarrow.replace("[BGCOLOR]",g);var k=this.CSS.centertd.replace("[COLOR]",a.color||this.COLOR);d.push("<div style='"+e+"'>");d.push("<div style='"+this.CSS.leftarrow+"'></div>");d.push("</div>");d.push("<table border=0 cellpadding=0 cellspacing=0  style='"+h+"'><tr><td style='"+k+"'>");"function"==typeof this.FIELD_TEXT?(a=this.FIELD_TEXT(a,b,c),d.push(a)):d.push(a[this.FIELD_TEXT]);d.push("</td></tr></table>");d.push("<div style='"+this.CSS.rightbox+
...
a.innerHTML,c=$(a).height(),d={border:"1px solid #ccc",position:"relative",width:$(a).width(),height:c,overflow:"hidden"};"1"==a.getAttribute("EWA_DHTML")&&(d.width="100%");c=document.createElement("table");c.id=this.BoxId;$(c).css(d).addClass("ewa-editor").attr("cellpadding",0).attr("cellspacing",0);d=c.insertRow(-1).insertCell(-1);d.className="ewa-editor-buts";var e=c.insertRow(-1).insertCell(-1);$(e).css("position","static").css("opacity",1).addClass("ewa-ui-dialog-cover");var g=[],h=EWA_UI_HtmlEditorConfig.defaultConf,
k;for(k in h){0<k&&g.push("<span class='ewa-editor-but-spt '>|</span>");for(var l in h[k]){var m=this._CreateButton(EWA_UI_HtmlEditorConfig.buts[h[k][l]]);g.push(m)}}d.innerHTML=g.join("");a.parentNode.insertBefore(c,a);a.style.display="none";this._CreateIframe(e,b,a);a="<input onchange='"+this.Id+".executeImages(this)' multiple accept='image/jpeg,image/png,image/bmp' type=file  style='width:30px;height:30px;position:absolute;top:4px;left:0px;opacity:0.0'>";$("#"+this.BoxId).find("a[id=fn_Img]").append(a);
a="<input onchange='"+this.Id+".executeWord(this)' accept='doc,docx,odt' type=file  style='width:30px;height:30px;position:absolute;top:4px;left:0px;opacity:0.0'>";$("#"+this.BoxId).find("a[id=fn_Word2Html]").append(a);this.executeAfterEvent("init","ok");if(window.__Cal)for(k in __Cal)0==k.indexOf("EDITOR_Pop_")&&delete window.__Cal[k]};this._CreateIframe=function(a,b,c){a.innerHTML="<iframe id='"+this.Id+"cntent' frameborder=0 width=100% height=100%></iframe><iframe id='"+this.Id+"code' src0='"+
(EWA.RV_STATIC_PATH||"/EmpScriptV2")+"/EWA_STYLE/editor/CodeMirror/index.html' style='display: none; width: 100%; height: 100%' frameborder=0></iframe>";var d=this;setTimeout(function(){var e=$("#"+d.BoxId+" iframe:eq(0)"),g=e[0].contentWindow,h=g.document;h.body.style.minHeight=e.height()+"px";840>e.width()&&(h.body.style.boxSizing="border-box",h.body.style.width="100%");e=h.createElement("style");e.textContent=EWA_UI_HtmlEditorConfig.css;h.getElementsByTagName("head")[0].appendChild(e);e=EWA.CP+
(EWA.CP.endsWith("/")?"":"/")+"EWA_STYLE/cgi-bin/_re_/index.jsp?method=HtmlImages";EWA_UI_HtmlEditorConfig.OPT_ImageResizes&&(e+="&ImageReiszes="+EWA_UI_HtmlEditorConfig.OPT_ImageResizes.toURL());d.pasteClass.bind(g.document.body,e,function(k){d.executeAfterEvent("HtmlImages",k)});h.contentEditable=!0;h.designMode="on";h.body.innerHTML=b;$(h.body).css(EWA_UI_HtmlEditorConfig.css);EWA_UI_HtmlEditorConfig.OPT_PopImgProperties&&(h.onmousedown=function(k){k=k||event;k=k.target||k.srcElement;"IMG"==k.tagName&&
d.PopImgProperties(k)});$(h.body).bind("cut",function(){setTimeout(function(){d.executeAfterEvent("cut")},10)});$(h.body).bind("keyup",function(){d.executeAfterEvent("keyup")});$(h.body).bind("paste",function(){setTimeout(function(){d.executeAfterEvent("paste")},10)});$(h.body).bind("undo",function(){d.executeAfterEvent("undo")});$(h.body).bind("redo",function(){d.executeAfterEvent("redo")})},411)};this.PopImgProperties=function(a){var b=["<table style='background:rgba(0,0,0,0.77);color:#f1f1f1;' border=0 width=300 height=140>"];
...
4," ",80);a.setAttribute("tag","txt");c.editor?c.editor.setValue(b):c.initEditor(b,"html")};this.execute=function(a){var b=$("#"+this.BoxId+" iframe:eq(0)")[0].contentWindow,c=$("#"+this.BoxId+" iframe:eq(1)")[0].contentWindow,d=b.document,e=a.getAttribute("cmd");if(0==a.id.indexOf("st_"))"CreateLink"==e?d.execCommand(e,!0,null):d.execCommand(e,!1,null);else if(0==a.id.indexOf("fn_"))this[e](a);else if("eraser"==e)this.executeEraser();else if("CODE_TXT"==e){var g=a.getAttribute("tag"),h=$("#"+this.BoxId+
" iframe:eq(0)");d=$("#"+this.BoxId+" iframe:eq(1)");if(g)h.show(),d.hide(),a.setAttribute("tag",""),b.document.body.innerHTML=c.getText();else if(h.hide(),d.show(),d.attr("src0")){b=d.attr("src0");d.attr("src",b);d.removeAttr("src0");var k=this;this._WAIT_CODE_LOAD_COMPLETE=setInterval(function(){"complete"==c.document.readyState&&(window.clearInterval(k._WAIT_CODE_LOAD_COMPLETE),k._WAIT_CODE_LOAD_COMPLETE=null,k.showCode(a))},100)}else this.showCode(a)}else"IMG"==a.id?insertImg(window):("CreateLink"==
...
$(a).find("script").remove();$(a).find("style").remove();$(a).find("link").remove();$(a).find("meta").remove();$(a).find("title").remove();$(a).find("colgroup").remove();$(a).find("*").each(function(){for(var b={},c=0;c<this.attributes.length;c++){var d=this.attributes[c].name;"src"!=d&&(b[d]=null)}$(this).attr(b)});this.OBJ_REPLACE.value=a.innerHTML=a.innerHTML.replace(/\x3c!--[\w\W\r\n]*?--\x3e/gim,"")};this.executeAfterEvent=function(a,b){var c=$("#"+this.BoxId+" iframe:eq(0)")[0].contentWindow.document.body;
if("init"!=a||"ok"!=b)this.OBJ_REPLACE.value=c.innerHTML;this.userAfterEvent&&this.userAfterEvent(a,b,c)};this.userAfterEvent=function(a,b,c){}}
...
function(a){var b=new FileReader,c=this,d={};$(c.target).find("img").each(function(){d[this]=!0});b.onloadend=function(){var e=null;$(c.target).find("img").each(function(){null!=e||d[this]||(e=this)});e||c.target.ownerDocument.execCommand("InsertImage",!1,this.result);$(c.target).find("img").each(function(){null!=e||d[this]||(e=this)});if(e){var g=c.tmpId(e);c.images.push({id:g,src:e.src,mode:"base64"});c.process()}else console.log("not img")};b.readAsDataURL(a.getAsFile())};this.processAsHtml=function(){var a=
this.target,b=this;$(a).find("img").each(function(){if(!this.getAttribute("_tmp_id")){var c=b.tmpId(this);this.src&&0!=this.src.indexOf(location.origin)&&b.images.push({id:c,src:this.src,mode:0==this.src.indexOf("data:image")?"base64":"normal"})}});this.processRemoveComments();$(a).find("*").each(function(){var c=$(this).css("background-image");c&&(c=c.replace("url(","").replace(")",""))&&c.startsWith("http://")&&b.images.push({id:EWA_MiscPasteTool.tmpId(this),src:c,mode:"background"});$(this).attr({onclick:null,
onload:null,onkeydown:null,onkeyup:null,onerror:null,onmousedown:null,onmouseout:null,onmouseover:null,onkeypress:null,onblur:null,onscroll:null})})};this.processRemoveComments=function(a){null==a&&(a=this.target);var b=[],c;for(c in a.childNodes){var d=a.childNodes[c];8==d.nodeType||"SCRIPT"==d.tagName||"LINK"==d.tagName||"STYLE"==d.tagName||"IFRAME"==d.tagName?b.push(d):"SPAN"==d.tagName&&(GetInnerText(d)||b.push(d))}for(c in b)a.removeChild(b[c]);for(c in a.childNodes)d=a.childNodes[c],1==d.nodeType&&
d.childNodes&&this.processRemoveComments(d)};this.tmpId=function(a){if(a.getAttribute("_tmp_id"))return a.getAttribute("_tmp_id");var b=("r_"+Math.random()).replace(".","");a.setAttribute("_tmp_id",b);$(a).css("max-width","100%");return b};this.process=function(){if(0!=this.images.length){var a={d:JSON.stringify(this.images)};this.images=[];var b=this;$JP(this.handleUrl,a,function(c){if(c.rst)for(var d=0;d<c.rsts.length;d++){var e=c.rsts[d],g=e.id,h=e.local;"background"==e.mode?$(b.target).find('[_tmp_id="'+
...
this;b.ontouchstart=function(g){1==g.targetTouches.length?e.t_start=g:2==g.targetTouches.length&&(e.t_start1=g,e.dist_base=0);e.is_move=!1;g.preventDefault();g.stopPropagation()};b.ontouchmove=function(g){if(2==g.targetTouches.length){e.t_start1a=g;var h=g.targetTouches[0].pageX-e.t_start1.pageX,k=g.targetTouches[0].pageY-e.t_start1.pageY,l=g.targetTouches[1].pageX-e.t_start1.pageX,m=g.targetTouches[1].pageY-e.t_start1.pageY;k=Math.sqrt((h-l)*(h-l)+(k-m)*(k-m));0==e.dist_base?e.dist_base=k:(k/=e.dist_base,
h=$(g.target).attr("rold"),k*=h?1*h:1,1>=k&&(k=1),5<k&&(k=5),$(g.target).css("transform","scale("+k+")").attr("r",k),1==k&&$(g.target).css("margin-left",0).css("margin-top",0))}else if(1==g.targetTouches.length){k=$(g.target).attr("r");if(null==k||1==k)return;h=g.pageX-e.t_start.pageX;k=g.pageY-e.t_start.pageY;m=1*$(g.target).css("margin-left").replace("px","");l=1*$(g.target).css("margin-top").replace("px","");h=m+h;k=l+k;$(g.target).css("margin-left",h).css("margin-top",k);e.t_start=g;e.is_move=
!0}g.preventDefault();g.stopPropagation()};b.ontouchend=function(g){g.preventDefault();g.stopPropagation();if(e.t_start){var h=g.pageX-e.t_start.pageX,k=g.timeStamp-e.t_start.timeStamp;-50>h&&244>k?(h=e.prevIdx,h++,h==e.total&&(h=0),e.changePhoto(h)):50<h&&244>k?(h=e.prevIdx,h--,0>h&&(h=e.total-1),e.changePhoto(h)):10>Math.abs(h)&&150>k&&!e.is_move&&e.click_page()}console.log(e.t_start1);e.t_start1&&(h=$(g.target).attr("r"),console.log(h),$(g.target).attr("rold",h));e.t_start=null;e.t_start1=null}}}
...
var a=this.objSplit[0],b=this;this.mv1.AddMoveObjectY(a,a,function(c){b.objCover.hide();b.objSplit.css("z-index",1)},document.body,function(c,d){c=1*$(c).css("top").replace("px","");b.ChangeLocation(c);window.localStorage[b.LOC_ID]=c},function(){b.objCover.show()})};this.CreateMoveH5=function(){this.mv1=this._GetMoveInstance();var a=this.objSplit[0],b=this;this.mv1.AddMoveObjectX(a,a,function(c){b.objCover.hide();b.objSplit.css("z-index",1)},document.body,function(c,d){c=1*$(c).css("left").replace("px",
"");b.ChangeLocation(c);window.localStorage[b.LOC_ID]=c},function(){b.objCover.show()})};this.ChangeLocation=function(a){"H5"==this.FrameType?(this.objOne.css("width",a),this.objTwo.css("left",a+1),this.objSplit.css("left",a)):(this.objOne.css("height",a),this.objTwo.css("top",a+1),this.objSplit.css("top",a))}}
...
EWA_UI_NavBarClass=function(){this.tabsCfg=this.parent=this.id=null;this.lastIdx=0};EWA_UI_NavBarClass.prototype.show=function(a){var b=1*a;b!==this.lastIdx&&(this.lastIdx=b,a=$(this.parent).find(".ewa-tab-box"),$(this.parent).find(".ewa-tab-tab").each(function(){1*$(this).attr("idx")===b?$(this).removeClass("EWA_GROUP_CNT_TOP").addClass("EWA_GROUP_CNT_TOP1"):$(this).removeClass("EWA_GROUP_CNT_TOP1").addClass("EWA_GROUP_CNT_TOP")}),a.hide(),$(a[b]).show())};
EWA_UI_NavBarClass.prototype.getBox=function(a){a=$(this.parent).find(".ewa-tab-box:eq("+a+")");return 0==a.length?null:a[0]};EWA_UI_NavBarClass.prototype.setContent=function(a,b,c){var d=this.getBox(a);d.html(b);c&&c(d,a,b)};EWA_UI_NavBarClass.prototype.install=function(a,b,c){var d=this.getBox(a);$Install(b,d,function(e,g,h){c&&c(d,a,b,e,g,h)})};EWA_UI_NavBarClass.prototype.createInstallCfg=function(a,b,c,d){return{text:a,url:b,cb:c,show:d}};
EWA_UI_NavBarClass.prototype.createContentCfg=function(a,b,c,d){return{text:a,content:b,cb:c,show:d}};EWA_UI_NavBarClass.prototype.demo=function(){document.body.innerHTML="";this.init("demo",document.body,[{text:"\u6807\u7b7e\u4e00"},{text:"\u6807\u7b7e\u4e8c"},{text:"<b>\u6807\u7b7e\u4e09</b>",show:!0}])};
EWA_UI_NavBarClass.prototype.init=function(a,b,c){this.id=a;this.parent=b;this.tabsCfg=c;var d=[],e=[],g;for(g in c){var h='<div idx="'+g+'" class="ewa-tab-tab '+(0<g?"EWA_GROUP_CNT_TOP":"EWA_GROUP_CNT_TOP1")+'" id="tab_'+a+"_"+g+"\">\n<a style='display:block'>"+c[g].text+"</a></div>";e.push('<div idx="'+g+"\" class='ewa-tab-box' id=\"box_"+a+"_"+g+'" style="display: '+(0<g?"none":"block")+'"></div>');d.push(h)}d=d.join("");e=e.join("");a=$('<div class="ewa-tab" id="'+a+'">\n\t<div class="ewa-tab-headers" id="headers_'+
a+'">'+d+'<div style=\'clear:both\'></div></div>\n\t<div class="ewa-tab-boxes" id="boxes_'+a+'">'+e+"</div>\n</div>");var k=this;a.find("a").on("click",function(){var m=1*$(this).parent().attr("idx");k.show(m)});$(b).append(a);for(var l in c)b=c[l],b.url?k.install(l,b.url,b.cb):b.content&&k.setContent(l,b.content,b.cb),b.show&&(console.log(b),this.show(l))};
var EWA_Behavior={RELOAD_PARENTA:function(a){var b=window.parent;try{b.EWA.F.FOS[a]&&b.EWA.F.FOS[a].Reload?b.EWA.F.FOS[a].Reload():b.location=b.location.href}catch(c){b.location=b.location.href}},RELOAD_PARENT:function(a){var b=EWA_Behavior.getParentWindow();if(b){var c=EWA_Behavior.getParentFrame(a);try{c?c.Reload(window.location.href):(console.warn("not found parent frame:"+a),_EWA_DialogWnd.CloseWindow(),b.location=b.location.href)}catch(d){console.log(d),b.location=b.location.href}}},getParentWindow:function(){return null==
...
EWA.UI.Ext.getFileIcon=function(a){this.initExtsMap();null==a&&(a="");a=a.toLowerCase();0>a.indexOf(".")&&(a="."+a);return this.mapIcon[a]?this.mapIcon[a]:this.mapIcon.def};EWA.UI.Ext.FileExt=function(a){if(null==a)return"";a=a.toLowerCase();var b=a.lastIndexOf("."),c="";0<b&&(c=a.substring(b));return c};
...
EWA.UI.Ext.IdCard2=function(a){var b=[1,31,28,31,30,31,30,31,31,30,31,30,31],c=$(a).attr("sfz_id");c=$($X(c)).show();var d=a.value,e=c.find("div");e.html("");for(var g=!0,h=[],k=[],l=[],m=[],n=0;n<d.length;n++){var p=d.substring(n,n+1),r="";6>n?h.push(p):6<=n&&10>n?k.push(p):10<=n&&12>n?l.push(p):12<=n&&14>n&&m.push(p);17>n?isNaN(p)&&(r="red",g=!1):"x"!=p&&"X"!=p&&isNaN(p)&&(r="red",g=!1);e[n]&&(e[n].innerHTML="<span style='font-size:16px;color:"+r+"'>"+p+"</span>")}h=k.join("");k=[];if(isNaN(h))g=
!1,k.push("\u5e74:"+h);else{if(1900>h||2100<h){g=!1;for(n=6;10>n;n++)$(e[n]).find("span").css("color","red");k.push("\u5e74:"+h)}b[2]=0==(h-1996)%4?29:28}l=l.join("");ismonth1=!0;if(isNaN(l))g=ismonth1=!1,k.push("\u6708:"+l);else if(1>l||12<l){ismonth1=g=!1;for(n=10;12>n;n++)$(e[n]).find("span").css("color","red");k.push("\u6708:"+l)}m=m.join("");if(isNaN(m))g=!1;else if(ismonth1&&(1>m||m>b[1*l])){g=!1;for(n=12;14>n;n++)$(e[n]).find("span").css("color","red");k.push("\u65e5:"+m)}d.length==e.length&&
g?(c.find("i").html("<font color=green>\u6b63\u786e</font>"),b={YEAR:h,MONTH:l,DAY:m,SEX:1*$(e[16]).text()%2},$(a).attr("sfz_json",JSON.stringify(b))):c.find("i").html("<font color=red>"+k.join(", ")+"\u9519\u8bef</font>")};
(function(){function a(){var l=k.$(".ewa-slider-puzzle-box"),m=k.$(".ewa-slider-puzzle-swiper"),n=k.$(".ewa-slider-puzzle-verify"),p=k.$(".ewa-slider-puzzle-text"),r=h?"touchmove":"mousemove",q=h?"touchend":"mouseup";m.bind(h?"touchstart":"mousedown",function(t){t.stopPropagation();n.css({display:"block"});var v=(h?t.touches[0]:t).clientX-$(this).offset().left;$(this).offset();p.css("opacity","0");l.unbind(r);l.unbind(q);l.bind(r,function(u){var x=h?u.touches[0]:u,w=k.$(".ewa-slider-puzzle-handle");
u=k.$(".ewa-slider-puzzle-swiper");var y=k.$(".ewa-slider-puzzle-verify");x=x.clientX-v-$(w).offset().left;w=$(w).width()+29;0>x?x=0:x>w&&(x=w);u.css("left",x);y.css("left",x+10)});l.bind(q,function(u){l.unbind(r);l.unbind(q);u=new EWA_UrlClass(g.ewa_url);var x={};x.left=n.position().left;x.top=n.position().top;x.left1=n.offset().left;x.top1=n.offset().top;x.ewa_trigger_valid_mode="check";x.ewa_trigger_valid_name=g.ewa_trigger_valid_name;x.ewa_ajax=g.ewa_trigger_valid;console.log("0. Puzzle post check");
$JP(u.GetUrl(),x,function(w){w.RST?(console.log("1. puzzle valid ok"),l.addClass("ewa-slider-puzzle-successful"),d&&d(w)):(l.addClass("ewa-slider-puzzle-fail"),setTimeout(function(){l.removeClass("ewa-slider-puzzle-fail");m.css("left","0px");n.css("left","10px");p.css("opacity","1");e&&e(w);w.newConfig&&(w.newConfig.ewa_trigger_valid_name=g.ewa_trigger_valid_name,w.newConfig.ewa_trigger_valid=g.ewa_trigger_valid,w.newConfig.ewa_url=g.ewa_url,g=w.newConfig,b(g))},500))})})})}function b(l){var m=k.$(".ewa-slider-puzzle-imgbox"),
...
"undefined"==typeof EWA&&(EWA={});
EWA.F={FOS:{},GetFOSOne:function(){for(var a in EWA.F.FOS)return EWA.F.FOS[a]},getSubEwas:function(a){var b=[];$(a).find(".EWA_TABLE").each(function(){var c=$(this).attr("id");c&&(c=c.replace("EWA_FRAME_","").replace("EWA_LF_",""),(c=EWA.F.FOS[c])&&b.push(c))});return b},U:{WND:null},Cmd:function(){this.EWA_ACTION=null;this.EWA_NO_CONTENT=this.EWA_AJAX="1";this.EWA_TREE_TEXT=this.EWA_TREE_PARENT_KEY=this.EWA_TREE_KEY=null;this.EWA_AFTER_EVENT=""},Install:function(a,b,c,d,e){b=(window.EWA_CGI?window.EWA_CGI:
EWA.CP+"/EWA_STYLE/cgi-bin/")+"?xmlName="+b+"&itemName="+c+"&EWA_FRAMESET_NO=1&EWA_AJAX=INSTALL&"+d;(new EWA.C.Ajax).Install(b,"_r=1",a,e)},InstallHtml:function(a,b,c){var d=$X(a);if(null==d)alert("Object ["+a+"] not found");else{d.innerHTML=b;try{EWA.C.Utils.JsRegisters(rst)}catch(e){console.log(e)}if(null!=c)try{c(a)}catch(e){console.log(e)}}},replaceXmlName:function(a,b){a=a.unURL().replace(/\|/ig,"/").split("/");for(var c=[],d=0;d<a.length-1;d++){var e=a[d];""!==e&&c.push(e)}c.push(b);return c.join("/")}};
EWA.F.POP={AJAX:null,PostBehavior:function(a,b,c){var d=EWA.F.FOS[a];if(null==d)alert("Object EWA.F.FOS."+a+" not exists!");else if(d=null==d.Url?d._Url:d.Url,null==d)alert("Object EWA.F.FOS."+a+".Url not exists!");else{a="EWA_AJAX=1&EWA_NO_CONTENT=1&EWA_ACTION="+c;if(null!=b)for(c=0;c<b.length;c+=1){var e=b[c].Name,g=b[c].Value;null!=e&&""!=e&&null!=g&&""!=g&&(g=encodeURIComponent(g),a=a+"&"+e+"="+g)}EWA.F.POP.AJAX=new EWA.C.Ajax;EWA.F.POP.AJAX.LoadingType="image";EWA.F.POP.AJAX.Post(d,a,EWA.F.POP.CallBack)}},
...
a.isStop=!0;b.HiddenWaitting();a.ret=200==b._Http.status?b._Http.responseText:"ERROR:\r\n"+b._Http.statusText;a.ReplaceObject();return!0},Install:function(a,b){this.replaceId=b;this.CLASS_NAME="EWA.F.Ajax.Install";this.ajax=new EWA.C.Ajax;this.ret=null;this.isStop=!0;this.id=EWA.F.Ajax._GetId(this);this.ajax.Get(a,function(){});this.isStop=!1;EWA.F.Ajax._StartMonitor();this.ReplaceObject=function(){$X(this.replaceId).innerHTML=this.ret;this.AddScripts()};this.AddScripts=function(){var c=this.ret.match(/<script(.|\n|\r)*?>(.|\n|\r)*?<\/script(.|\n|\r)*?>/ig);
if(null!=c)for(var d=document.getElementsByTagName("head")[0]||document.documentElement,e=0;e<c.length;e++){var g=c[e];g=g.replace(/<script(.|\n|\r)*?>/ig,"").replace(/<\/script(.|\n|\r)*?>/ig,"").trim();if(0!=g.length)try{var h=document.createElement("script");h.type="text/javascript";EWA.B.IE?h.text=g:h.appendChild(document.createTextNode(g));d.insertBefore(h,d.firstChild);d.removeChild(h)}catch(k){}}}}};
...
function EWA_FrameInstallClass(a,b,c,d){this.Xml=new EWA.C.Xml;this.XmlName=b;this.ItemName=c;this.Parameters=d;this.Install=function(e){null==e&&(e=this.GetUrl());this.Xml.LoadXmlFile(e);var g=this.Xml.GetElement("FrameData"),h=this.Xml.GetElementAttribute(g,"Type"),k=this.Xml.GetElementAttribute(g,"ClassName");g=this.Xml.GetElement("Css",g);g=this.Xml.GetElementText(g);document.write(g);"TREE"==h.toUpperCase()&&(e=new EWA.F.T.C(a,k,e),eval(k+"=c"),EWA.F.FOS[k]=e,e.CreateByXml(this.Xml))};this.GetUrl=
function(){var e=EWA.CP+"/EWA_STYLE/cgi-bin/?XMLNAME=";e+=this.XmlName.toURL()+"&ITEMNAME="+this.ItemName.toURL();e+="&EWA_AJAX=XML";null!=this.Parameters&&(e+="&"+this.Parameters.GetString());return e}}
...
d.toUpperCase(),g=a[c];this.Items[e]=g;var h=this.GetItemValue(g,"DataItem","Valid");h&&"MOBILE"==h.toUpperCase()?EWA.UI.Ext.Mobile($X(e)):h&&"IDCARD"==h.toUpperCase()&&EWA.UI.Ext.IdCard($X(e));b&&this.disableOnModify(g,d)}};this.disableOnModify=function(a,b){(a=this.GetItemValue(a,"DataItem","DisableOnModify"))&&"YES"==a.toUpperCase()&&(b=$X(b))&&(b.setAttribute("disabled","disabled"),b.getAttribute("DlsShow")&&$(b).prev().attr("disabled","disabled"))};this.GetItem=function(a){a=a.toUpperCase().trim();
return this.Items[a]};this.GetItemValue=function(a,b,c){if(null==a)return null;a=this._ClassXml.GetElement(b+"/Set",a);return null==a?null:a.getAttribute(c)};this.GetDescription=function(a){a=$(this.GetItem(a)).find("DescriptionSet Set[Lang="+EWA.LANG+"]");return{Info:a.attr("Info"),Memo:a.attr("Memo")}};this.GetValue=function(a,b,c){a=this.GetItem(a);return this.GetItemValue(a,b,c)};this.CheckValid=function(a,b){if("SPAN"==a.tagName||"IMG"==a.tagName)return!0;var c=this.GetItem(a.id),d=[],e=this._CheckMustInput(a,
b,c);e&&d.push(e);if(null==b||""==b){if(0==d.length)return EWA_FrameRemoveAlert(a),!0;EWA_FrameShowAlert(a,d.join(", "));return!1}(e=this._CheckMaxMinLength(a,b,c))&&d.push(e);(e=this._CheckDataValid(a,b,c))&&d.push(e);(e=this._CheckDataType(a,b,c))&&d.push(e);(e=this._CheckMaxMinValue(a,b,c))&&d.push(e);(e=this._CheckPassword(a,b,c))&&d.push(e);(e=this._CheckExtent(a,b,c))&&d.push(e);if(0==d.length)return EWA_FrameRemoveAlert(a),!0;EWA_FrameShowAlert(a,d.join(", "));return!1};this._CheckExtent=function(a,
b,c){b=null;a=a.getAttribute("EWA_VALID_EX");a=null==a?"":a;0<a.length&&(b=a);return b};this._CheckDataType=function(a,b,c){if(null==b||""==b.trim())return null;c=null;this.isNumber(a)&&(a=b.replace(/,/ig,""),isNaN(a)&&(c=_EWA_INFO_MSG["EWA.SYS.INVALID_NUMBER_FORMAT"]));return c};this._CheckPassword=function(a,b,c){if("input"!=a.tagName.toLowerCase()||"password"!=a.type.toLowerCase())return null;c=$("#USR_PWD").parentsUntil("form").last().find("input[type=password]");b=null;for(var d=a.id,e=0;e<c.length;e+=
1)if("password"==c[e].type&&c[e]!=a&&c[e].id==d+"1"){b=c[e];break}c=null;null!=b&&(b.value!=a.value?(isok=!1,c=_EWA_INFO_MSG["EWA.F.PASSWORD"]):EWA_FrameRemoveAlert(b));return c};this._CheckMustInput=function(a,b,c){return"1"!=this.GetItemValue(c,"IsMustInput","IsMustInput")||null!=b&&0<b.length||"hidden"==a.type&&"ht5upload"==$(a).attr("ewa_tag")&&0<$(a).parent().find(".ewa_app_upload_form1:visible").length?null:b=(b=_EWA_JS_ALERT.IsMustInput)?b.replace("{Name}",a.id):"*"};this._CheckMaxMinLength=
...
"DataItem","Valid");if(null==a||""==a.trim())return"";if(0<b.length)return a=_EWA_VALIDS[a.toUpperCase().trim()],null==a?"":a.REGEX.test(b)?"":a.MSG};this._CheckMaxMinValue=function(a,b,c){a=this.GetItemValue(c,"MaxMinValue","MaxValue");c=this.GetItemValue(c,"MaxMinValue","MinValue");var d=null==a||""==a.trim()?null:1*a,e=null==c||""==c.trim()?null:1*c,g=!0;null!=d&&(g=1*b<=d?!0:!1);null!=e&&(g=1*b>=e?g&1:!1);if(g)return"";errorInfo=_EWA_JS_ALERT.MaxMinValue||this._EWA_JS_ALERT_DEFAULT.MaxMinValue;
errorInfo=errorInfo.replace("{MaxValue}",a);return errorInfo=errorInfo.replace("{MinValue}",c)};this.isNumber=function(a){if(!a)return null;a=(a=this.GetItem(a.id))?this.GetItemValue(a,"DataItem","DataType"):"";a=null==a?"":a.toUpperCase();return"NUMBER"==a||"INT"==a||"BIGINT"==a};this.isTrim=function(a){if(!a)return null;if($(a).attr("ewa_trim"))return!0;var b=this.GetItem(a.id);b=(b=b?this.GetItemValue(b,"DataItem","Trim"):"")?b.toUpperCase():"YES";if(b="YES"==b)$(a).attr("ewa_trim","yes").on("blur",
function(){this.value=this.value.trim()});return b};this.getFormat=function(a){return a?(a=this.GetItem(a.id))?this.GetItemValue(a,"DataItem","Format"):"":""};this.GetObjectValue=function(a){var b=a.tagName.toUpperCase(),c=a,d="";if("DIV"==b&&$(a).hasClass("ewa-switch"))return a.getElementsByTagName("input")[0].checked?"on":"off";if("DIV"==b&&"REPT"==a.getAttribute("TAG")){a=a.getElementsByTagName("input");for(var e=0;e<a.length;e+=1)a[e].checked&&(0<d.length&&(d+=","),d+=a[e].value);return d}if("DIV"==
b&&"1"==a.getAttribute("EWA_DHTML"))return d=a.getElementsByTagName("iframe")[0].contentWindow,b=d.document.getElementsByTagName("textarea"),d=0<b.length&&"none"!=b[0].style.display?b[0].value:d.frames[0].document.body.innerHTML,null!=location.search&&0>location.search.toUpperCase().indexOf("EWA_DHTML_HOST")&&(e="http:\\/\\/"+eval("document.location.host")),e=eval("/"+e+"/ig"),d=d.replace(e,""),a=a.getElementsByTagName("input")[0],a.value=d,a.value;if("SELECT"==b)return d="",0<=c.options.selectedIndex&&
(d=c.options[c.options.selectedIndex].value),d;if("TEXTAREA"==b&&"none"==c.style.display)return a.value;if("INPUT"==b&&"IMG_UPLOAD"==c.getAttribute("ewa_tag"))return d="/"!=EWA.CP?c.value.replace(EWA.CP,""):c.value,d=d.replace("//","/");if("INPUT"==b&&c.getAttribute("val_ref")){a=c.getAttribute("val_ref");try{d=eval("(function(){var a="+a+";return a;})()")}catch(g){console.log(a),console.log(g),d=""}return d}if("INPUT"==b&&("checkbox"==c.type||"radio"==c.type))return d=c.checked?c.value:"";(d=c.value)&&
this.isTrim(a)&&(e=d.trim(),e!==d&&(d=e));if("INPUT"!==b||!this.isNumber(a))return d;if(""!==d&&"-"!==d&&"."!==d){if(isNaN(d)&&(d=d.replace(/,/ig,""),isNaN(d)))try{d=EWA_Utils.chineseToNumber(d)+"",a.value=d}catch(g){return d}e=this.getFormat(a);if("LeastMoney"==e||"Money"==e)e=d.split("."),a.value=1==e.length?(1*d).fm(0):(1*d).fm(e[1].length)+(0==e[1].length?".":"");return d}}}function EWA_FrameResourceDescription(){this.Memo=this.Info=this.Lang=null}
...
0<e.indexOf(".Resources[")))){var g="";try{g=eval(e)}catch(h){g=h.message}"INPUT"==c[d].tagName?c[d].value=g:c[d].innerHTML=g}}a.length=0}}
...
return a?b.find(a):b};this.switchButtonAction=function(a,b){if(b){var c=this.getUrlClass(),d={};d.ewa_switch_name=a.name;d.ewa_action=b;d.ewa_ajax="json";d.ewa_switch=a.checked?"on":"off";b=a.parentNode;var e=b.getAttributeNames(),g;for(g in e){var h=e[g],k=b.getAttribute(h);0!=h.indexOf("on")&&"name"!=h&&"id"!=h&&"class"!=h&&(d[h]=k)}var l=this;c=c.GetUrl();$JP(c,d,function(m){l.extSwitchCallBack&&l.extSwitchCallBack(a,m)})}};this.setDisable=function(){var a=this.getObj();a.find("input,textarea,select,label").each(function(){this.disabled||
"hidden"==this.type||(this.disabled=!0,this.setAttribute("ewadisabled",1))});a.find(".EWA_DHTML").each(function(){if("DIV"==this.tagName)var b=$(this).find("iframe")[0].contentWindow,c=setInterval(function(){if("complete"==b.document.readyState){window.clearInterval(c);b.frames[0].document.body.contentEditable=!1;b.frames[0].document.body.style.backgroundColor="#eee";var e=b.document.getElementsByClassName("but")[0];e.style.pointerEvents="none";e.style.filter="grayscale(1) opacity(0.8)"}},300);else if("TEXTAREA"==
this.tagName){var d=$(this).parent();c=setInterval(function(){var e=d.find("iframe");0<e.length&&(e=e[0].contentWindow)&&"complete"==e.document.readyState&&(window.clearInterval(c),e.document.body.contentEditable=!1,e.document.body.style.backgroundColor="#eee",d.find(".ewa-editor").attr("ewadisabled",1))},300)}})};this.setEnable=function(){var a=this.getObj();a.find("input,textarea,select,label").each(function(){this.disabled&&this.getAttribute("ewadisabled")&&(this.disabled=!1,this.removeAttribute("ewadisabled"))});
a.find(".EWA_DHTML").each(function(){if("DIV"==this.tagName){var b=$(this).find("iframe")[0].contentWindow;b.frames[0].document.body.contentEditable=!0;b.frames[0].document.body.style.backgroundColor="";b=b.document.getElementsByClassName("but")[0];b.style.pointerEvents="";b.style.filter=""}else if("TEXTAREA"==this.tagName){var c=$(this).parent();b=c.find("iframe")[0].contentWindow;b.document.body.contentEditable=!0;b.document.body.style.backgroundColor="";c.find(".ewa-editor").removeAttr("ewadisabled")}})};
this.convertFilterCheckbox=function(a,b,c,d,e,g){function h(u){var x=$("<nobr></nobr>");p.append(x);p.append(" ");var w=$(u).parent();u=$(u).attr("id")+"_"+r;w.attr("id",u);x.append(w.children());x.attr("ref_id",u)}function k(u){u=$(u).parent();var x=u.attr("ref_id");x&&($("#"+x).append(u.children()),u.remove())}var l={},m=this.getObj(".ewa-row-"+a),n=this.getObj(".ewa-row-"+b),p=$("<div class='ewa-filter-checked'></div>");m.find("#"+a).prepend(p).addClass("ewa-filter-chks");var r=this._Id;c||(c=
...
")</span></a>")}n.find(".EWA_TD_M").html(b.join(" "));d&&(m.find(".EWA_TD_L").hide(),m.find(".EWA_TD_M").attr("colspan",2));n.find("a.ewa-filter-char").on("click",function(){var u=$(this).attr("code");m.find("input[type=checkbox]").each(function(){u?this.checked?p.append($(this).parent()):($(this).parent().attr("ref_id")&&k(this),$(this).parent().hide()):$(this).parent().show()});if(u){for(var x=l[u],w=0;w<x.length;w++)m.find("#"+x[w]).parent().show();g&&g(this,m,n)}});e&&e(m,n)};this.createFilterCheckbox=
function(a,b,c,d,e,g,h){var k=this;$J(d,function(l){k.createFilterCheckboxByData(a,b,c,l,e,g,h)})};this.createFilterCheckboxByData=function(a,b,c,d,e,g,h){var k={},l=l?"[]":c.split(",");c={};for(var m in l)c[l[m]]=1;l=[];var n=[],p=a.id;for(m in d){var r=d[m],q=r[e];q&&(q=q.replace(/</ig,"&lt;"));var t=r[g];t&&(t=t.replace(/</ig,"&lt;"));var v=r[h],u=c[q],x=[];x.push("<nobr class='ewa-filter-chk' style='float:left;margin-right:4px'>");x.push('<input class="ewa-filter-chkbox" type="checkbox" ');u&&
x.push(" checked ");r=p+"_"+m;x.push(' value="'+q+'" id="'+r+'" name="'+p+'"><label ');x.push(' for="'+r+'">'+t+"</label></nobr>");u?n.push(x.join("")):l.push(x.join(""));b&&(q=v?v.substring(0,1).toUpperCase():"",k[q]||(k[q]=[]),k[q].push(r))}a.innerHTML=n.join(" ")+" "+l.join(" ");if(b){d=['<a href="javascript:void(0)">ALL</a>'];for(m="A".charCodeAt();m<="Z".charCodeAt();m++)e=String.fromCharCode(m),k[e]&&d.push('<a href="javascript:void(0)">'+e+"</a>");b.innerHTML=d.join(" ");$(b).find("a").each(function(){var w=
$(this).text();"ALL"!=w&&$(this).attr("ids",k[w].join(","));$(this).on("click",function(){if("ALL"==$(this).text())$(a).find("nobr.ewa-filter-chk").show();else{var y=$(this).attr("ids").split(","),z={},A;for(A in y)z[y[A]]=1;$(a).find("input.ewa-filter-chkbox").each(function(){this.checked||z[this.id]?$(this).parent().show():$(this).parent().hide()})}})})}};this.hiddenNoContentRow=function(){var a=$("#EWA_FRAME_"+this._Id);a.find(".EWA_TD_M").each(function(){if(""==$(this).text()&&0==$(this).find("img,a,input[type=text],input[type=button],textarea").length){$(this).parent().hide();
var b=$(this).find("*:eq(0)").attr("id");b&&a.find(".ewa-row-"+b).hide().attr("hiddennocontentrow",1)}})};this.itemReload=function(a,b,c){if(a){var d=new EWA_UrlClass(this.Url);d.AddParameter("EWA_AJAX","SELECT_RELOAD");d.AddParameter("EWA_RELOAD_ID",a);this.getObj("input,select").each(function(){this.name!=a&&100>this.value.length&&d.AddParameter(this.name,this.value)});for(var e=d.GetUrl(),g=this.getObj("#"+a)[0],h={},k=0;k<g.options.length;k++)h[g.options[k].value]=1;$J(e,function(l){if(l.RST){var m=
l.ITEM.LST;g.options.length=0;var n=[],p;for(p in m){var r=m[p];if(!r.V||!h[r.V]){var q=new Option(r.T,r.V);r.json&&$(q).attr("json",r.json);g.options[g.options.length]=q;n.push(q);r._used=!0}}for(p in m)r=m[p],r._used||(q=new Option(r.T,r.V),r.json&&$(q).attr("json",r.json),g.options[g.options.length]=q);if(b)g.value=b;else for(var t in n)if(n[t].value){g.value=n[t].value;break}if(c)try{c(l,g)}catch(v){console.log(v)}}else $Tip(l.ERR)})}};this._checkSelectOptionsChange=function(){if(this._SelectFilters){var a=
this;this.isSelectFilter&&setTimeout(function(){a._checkSelectOptionsChange()},311);for(var b in this._SelectFilters){var c=this._SelectFilters[b];this.getObj("#"+c.id).html()!=c.html&&a._selectOptionsChangeed(c)}setTimeout(function(){a._checkSelectOptionsChange()},311)}};this._selectOptionsChangeed=function(a){var b=this.getObj("select#"+a.id),c="initSelectFilter"+this._Id+"-"+a.id+"-filter",d="initSelectFilter"+this._Id+"-"+a.id+"-filter2",e=this._initSelectFilterCreateCode(a.codeJsonFrom||a.filterFrom,
b);this.getObj("#"+c).html(e);this.getObj("#"+d).html("");a.html=b.html()};this._initSelectFilterCreateCode=function(a,b){var c=["<option value=''>-ALL-</option>"];if(a){var d={},e=[];b.find("option").each(function(){if(""!=this.value){var k;this.hasAttribute("para_"+a)?k=this.getAttribute("para_"+a):this.getAttribute("json")&&(k=JSON.parse(this.getAttribute("json"))[a]);k&&(d[k]?d[k]+=1:(d[k]=1,e.push(k)))}});var g=e.sort(),h;for(h in g)b=g[h],b=b.replace(/>/ig,"&lt;").replace(/"/,"&quot;"),c.push('<option value="'+
b+'">'+b+" ["+d[b]+"]</option>")}else for(h="A".charCodeAt();h<="Z".charCodeAt();h++)b=String.fromCharCode(h),c.push('<option value="'+b+'">'+b+"</option>");return c.join("")};this.initSelectFilter=function(a,b,c,d){if(!this["INIT_SELECT_FILTER"+a]){this["INIT_SELECT_FILTER"+a]=!0;var e=$("#EWA_FRAME_"+this._Id+" select#"+a),g=e.parent(),h="initSelectFilter"+this._Id+"-"+a+"-filter",k="initSelectFilter"+this._Id+"-"+a+"-filter2",l="initSelectFilter"+this._Id+"-"+a+"-filter-table";$X(l)&&(g.append(e),
$($X(l)).remove());g.addClass("ewa-select-filter");h=["<table id='"+l+"' cellpadding=0 cellspacing=0 width=100%><tr><td class='ewa-select-filter-char'><select class='EWA_SELECT' style='margin-right:4px' id='"+h+"' onchange='EWA.F.FOS[\""+this._Id+'"]._chCode(this,"'+b+'","'+c+"\")'>"];l=this._initSelectFilterCreateCode(d||c,e);h.push(l);h.push("</select><select id='"+k+"' style='display:none'></select></td><td class='ewa-select-filter-target'></td></tr></table>");g.prepend(h.join(""));g.find(".ewa-select-filter-target").append(e);
this._SelectFilters||(this._SelectFilters={});g={};g.html=e.html();g.id=a;g.filterType=b;g.filterFrom=c;g.codeJsonFrom=d;this._SelectFilters[g.id]=g}};this._chCode=function(a,b,c){this.isSelectFilter=!0;var d=$(a).next(),e=$(a).parent().parent().find(".ewa-select-filter-target select");0==d[0].options.length&&d.html(e.html());if(""==a.value)e.html(d.html());else{for(var g=["<option></option>"],h=1;h<d[0].options.length;h++){var k=d[0].options[h];this._chCodeFilter(k,b,c,a.value)&&g.push(GetOuterHTML(k))}e.html(g.join(""));
this._SelectFilters[e[0].id].html=e.html();this.isSelectFilter=!1}};this._chCodeFilter=function(a,b,c,d){"json"==b?(a=JSON.parse(a.getAttribute("json"))[c],"ADM_LID"==c&&(c=a.split("."),a=c[c.length-1])):a="text"==b?a.text:a.value;return a?a.substring(0,d.length).toUpperCase()==d.toUpperCase()?!0:!1:!1};this.setUnMust=function(a){(a=this.ItemList.Items[a.toUpperCase()])&&a.getElementsByTagName("IsMustInput")[0].getElementsByTagName("Set")[0].setAttribute("IsMustInput",0)};this.setMust=function(a){(a=
this.ItemList.Items[a.toUpperCase()])&&a.getElementsByTagName("IsMustInput")[0].getElementsByTagName("Set")[0].setAttribute("IsMustInput",1)};this.RedrawCreateSpans=function(){for(var a=$("#EWA_FRAME_"+this._Id+" tr"),b=0;b<a.length;b++){var c=a[b];if("none"!=c.style.display)for(var d=0,e=!1,g=c.cells.length-1;0<=g;g--){var h=c.cells[g];"none"==h.style.display?e?d++:(d=1,e=!0):e&&(h.colSpan=d+1,e=!1)}}EWA_FrameShowAlert=EWA_FrameShowAlert1;EWA_FrameRemoveAlert=EWA_FrameRemoveAlert1;$("#EWA_FRAME_"+
this._Id+" .ewa_d1").each(function(){this.title=this.innerHTML});for(var k in this.ItemList.Items)a=this.GetItemDescription(k).Memo,null!=a&&0<a.trim().length&&($("#"+k).attr("placeHolder",a),$("#"+k).attr("title",a));this.RedrawChangWidth()};this.GetItemDescription=function(a){return this.ItemList.GetDescription(a)};this.ShowPlaceHolder=function(a){$("#EWA_FRAME_"+this._Id).addClass("ewa-frame-cols-"+a);for(var b in this.ItemList.Items){var c=this.ItemList.GetValue(b,"Name","Name");if(c=this.GetObject(c)){c=
$(c);var d=this.GetItemDescription(b),e=d.Memo;d=d.Info;var g=null;1==a?(g=d,null!=e&&0<e.trim().length&&e!=g&&(g="smsValid"==c.attr("ewa_tag")?e:g+(", "+e)),c.hasClass("ewa-switch")&&c.prepend("<div class='ewa-switch-info'>"+g+"</div>")):2==a&&null!=e&&0<e.trim().length&&(g=e);g&&("hidden"==c[0].type?c.prev().attr("placeholder",g):"SELECT"==c[0].tagName?0<c[0].options.length&&""==c[0].options[0].value&&(c[0].options[0].text="-- "+g+" --",c[0].options[0].value=""):(c.attr("placeHolder",g),c.attr("title",
g)))}}};this.RedrawChangWidth=function(){var a=$("#EWA_FRAME_"+this._Id),b=a.width(),c=a.find(".ewa_msg_box")[0].colSpan/2;$("#EWA_FRAME_"+this._Id+">tbody>tr[class*='ewa-row-']:not('.ewa-row-msg-box')").each(function(){var e=$(this).find("td.ewa_redraw_info:visible").length,g=(b-90*e)/c;$(this).find("td.ewa_redraw_ctl:visible").each(function(){var h=this.colSpan||1;$(this).css("width",g*h)})});var d=this;addEvent(window,"size",function(){d.RedrawChangWidth()})};this.Mearge=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff1a\u8bf7\u7528 Merge");
this.Merge(a,b,c)};this.Merge=function(a,b,c){if(a||b){var d=$("#EWA_FRAME_"+this._Id),e=d.find("#"+a),g=d.find("#"+b);if(0==e.length)console.log("Mearge:"+a+"\u4e0d\u5b58\u5728");else if(0==g.length)console.log("Mearge:"+b+"\u4e0d\u5b58\u5728");else{var h=!1,k=d.find(".ewa-row-"+b+" .EWA_TD_M"),l=null;0==k.length&&(h=!0,k=d.find(".ewa-row-"+b+" .EWA_TD_1"),l=d.find(".ewa-row-"+b+" .EWA_TD"),1==l.length&&(h=!0),b=l.html(),l.html("<table cellpadding=0 cellspacing=0 width=100%><tr><td style='width:50%'></td><td style='display:none'></td><td style='width:50%'></td></tr></table>"),
l.find("td:eq(0)").html(b));if(0==k.length)alert("target parent not exists");else{var m="border-box"==e.css("box-sizing")?0:1*e.css("padding-left").replace("px","")+1*e.css("padding-right").replace("px",""),n="border-box"==e.css("box-sizing")?0:1*g.css("padding-left").replace("px","")+1*g.css("padding-right").replace("px","");d.find(".ewa-row-"+a).hide();null==c&&(c=" - ");var p=k.width(),r=e[0].tagName,q=g[0].tagName;e.parent().hasClass("ewa-select-filter-target")&&(e=d.find(".ewa-row-"+a+" .EWA_TD_M table:eq(0)"),
r="SELECT_WITH_FILTER");var t=0;b=null;c&&(k.append('<span class="mearge-span">'+c+"</span>"),h&&l.find("table:eq(0) td:eq(1)").html('<span class="mearge-span">'+c+"</span>").show(),b=k.find(".mearge-span"),t=b.width()+1+1*b.css("padding-left").replace("px","")+1*b.css("padding-right").replace("px","")+1*b.css("margin-left").replace("px","")+1*b.css("margin-right").replace("px",""));r==q?(c=(p-t)/2-m-2,e.css("width",c),g.css("width",c),h&&l.find("table:eq(0) td:eq(2), table:eq(0) td:eq(0)").css("width",
c)):"SELECT"==r?(e.css("width",100),g.css("width",p-t-m-n-2-2-e.width())):"SELECT_WITH_FILTER"==r?(e.css("width",200),g.css("width",p-t-m-n-2-2-e.width())):"SELECT"==q&&(g.css("width",100),e.css("width",p-t-m-n-2-2-e.width()));g.css("float","left");b&&b.css("float","left");e.css("float","right");k.append(e);k.addClass("ewa-frame-merge");h&&(a=d.find(".ewa-row-"+a+" .EWA_TD").html(),l.find("table:eq(0) td:eq(2)").html(a))}}}};this.MergeExp=function(a,b,c,d){if(b){var e=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),
g=[],h=b;b={};for(var k=$("#EWA_FRAME_"+this._Id),l=0;l<e.length;l++){var m=e[l];g.push(m);var n=m.replace("@@","");h=h.replace(m,"<span class='ewa-row-merge ewa-row-merge-"+n+"' mid=\""+m+'"></span>');n!=a&&k.find(".ewa-row-"+n).hide();b[n]=this.GetItemDescription(n).Info}e=document.createElement("div");e.style.display="none";e.innerHTML=h;document.body.appendChild(e);m=k.find('[id="'+a+'"]');if(0==m.length)console.log("not find "+a);else{a=m.parent();for(var p in g)l=g[p],m=l.replace("@@",""),h=
k.find('[id="'+m+'"]'),0==h.length?console.log("not found [id="+m+"]"):(l=$(e).find('span[mid="'+l+'"]'),"placeholder"==c?h.attr("placeholder",b[m]):c&&(l.append("<span class='ewa-row-merge-memo'></span>"),l.find(".ewa-row-merge-memo").text(b[m])),l.append(h));for(;0<e.childNodes.length;)a.append(e.childNodes[0]);$(e).remove();d&&d(a)}}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MergeItems=function(){for(var a in this.MeargeMap){var b=this.MeargeMap[a],c=$X("_ewa_tr$"+a);if(c){for(var d=
c.cells.length,e=$(c.cells[0]);1<c.cells.length;)e.append(c.cells[1].innerHTML),c.removeChild(c.cells[1]);c.cells[0].colSpan=d;c=[];for(d=0;d<b.length;d++){for(var g=$X("_ewa_tr$"+b[d]),h=["<nobr>"],k=0;k<g.cells.length;k++)h.push(g.cells[k].innerHTML);h.push("</nobr>");c.push(h.join(" "));g.parentNode.removeChild(g)}e.append(c.join(" "))}}};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.DoAction=function(a,b,c,d,e,g){EWA.F.CID=this._Id;if(null!=b&&""!=
b.trim()){if(null!=c&&0<c.trim().length)if(a=_EWA_INFO_MSG[c],null!=a&&""!=a){if(!window.confirm(a))return}else if(!window.confirm(c))return;this.DoPostBefore();this._Ajax=this.CreateAjax(null,!0);this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.AddParameter("EWA_ACTION_TIP",d);null!=g&&0<g.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",
g),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=!1;if(null!=e&&0<e.length)for(b=0;b<e.length;b+=1)this._Ajax.AddParameter(e[b].Name,e[b].Value);e=new EWA.C.Url;e.SetUrl(this.Url);e=e.RemoveParameter("EWA_ACTION");this._Ajax.PostNew(e,EWA.F.FOS[EWA.F.CID]._CallBackJs)}};this.GuideShowCreate=function(a){this._GroupInfos=a;var b=$X("EWA_FRAME_"+this._Id);a=a.length-1;b.setAttribute("EWA_GUIDE_IDX","0");b.setAttribute("EWA_GUIDE_IDX_MAX",a);b.rows[b.rows.length-
1].style.display="none";100<b.clientHeight&&(b.parentNode.style.height=b.clientHeight+"px");a=document.createElement("input");a.id="ewa_but_"+Math.random();a.type="button";a.value="enus"==EWA.LANG?"Back":"\u4e0a\u4e00\u6b65";a.style.display="none";a.onclick=function(){var h=b.getAttribute("EWA_GUIDE_IDX");if(0==1*h)$Tip("\u5230\u5934\u4e86");else{var k=b.id.replace("EWA_FRAME_","");EWA.F.FOS[k].GuidePrevBefore&&EWA.F.FOS[k].GuidePrevBefore(h,this,b);EWA.F.FOS[k].GuideShow(1*h-1);EWA.F.FOS[k].GuidePrevAfter&&
EWA.F.FOS[k].GuidePrevAfter(h,this,b)}};var c=document.createElement("input");c.id="ewa_but_"+Math.random();c.type="submit";c.value="enus"==EWA.LANG?"Next":"\u4e0b\u4e00\u6b65";c.onclick=function(){var h=b.getAttribute("EWA_GUIDE_IDX"),k=b.id.replace("EWA_FRAME_","");EWA.F.FOS[k].GuideShowCheck(h)&&(EWA.F.FOS[k].GuideNextBefore&&EWA.F.FOS[k].GuideNextBefore(h,this,b),"ok"==this.getAttribute("ewa_guide_method")?$F(b,"input","type","submit")[0].click():EWA.F.FOS[k].GuideShow(1*h+1),EWA.F.FOS[k].GuideNextAfter&&
EWA.F.FOS[k].GuideNextAfter(h,this,b))};var d=b.parentNode.parentNode.parentNode.parentNode.parentNode,e=d.insertRow(-1).insertCell(-1);e.appendChild(a);e.appendChild(c);e.className="EWA_FRAME_GROUP_BUTTONS";tdTitle=d.insertRow(0).insertCell(-1);d="ewa_title_"+Math.random();e=[];for(var g=0;g<this._GroupInfos.length;g++)e.push('<div style="float:left" id="ewa_'+this._Id+"_"+g+'">'+(g+1)+". "+this._GroupInfos[g].DES+"</div>");tdTitle.innerHTML="<div style='text-align:left'>"+e.join(" <div style='float:left;color:#aaa'>&nbsp;&gt;&nbsp;</div> ")+
"</div><div id='"+d+"'></div>";tdTitle.className="EWA_FRAME_GROUP_TITLE";b.setAttribute("EWA_GUIDE_ID_PREV",a.id);b.setAttribute("EWA_GUIDE_ID_NEXT",c.id);b.setAttribute("EWA_GUIDE_ID_TITLE",d);this.GuideShowTitle(0);a=document.createElement("div");100<b.clientHeight&&(a.style.width=b.clientWidth+"px",a.style.height=b.clientHeight+20+"px",a.style.overflow="auto");b.parentNode.appendChild(a);a.appendChild(b);b.parentNode.className="EWA_GROUP_GUIDE"};this.GuideShowTitle=function(a){for(var b=$X("EWA_FRAME_"+
this._Id).getAttribute("EWA_GUIDE_IDX_MAX"),c=0;c<=b;c++){var d="ewa_"+this._Id+"_"+c;c==a?($X(d).style.color="blue",$X(d).style.borderBottom="2px solid green"):($X(d).style.color="green",$X(d).style.borderBottom="2px")}};this.GuideShowCheck=function(a){var b=!0,c=null,d;for(d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],"Name","Name");e=this.getObj("#"+e);if(0!=e.length){e=e[0];var g=this._GetTr(e);null!=g&&g.getAttribute("groupindex")==a&&((b&=this.CheckValid(e))||
null!=c||(c=e))}}null!=c&&c.focus();return b};this._GetTr=function(a){for(var b=0;100>b;){b++;a=a.parentNode;try{if("TR"==a.tagName.toUpperCase()&&null!=a.getAttribute("id")&&0==a.getAttribute("id").indexOf("_ewa_tr$"))return a}catch(c){break}}return null};this.GuideShow=function(a){this.GuideShowTitle(a);var b=$X("EWA_FRAME_"+this._Id);if(b.getAttribute("EWA_GUIDE_IDX")!=a){var c=b.getAttribute("EWA_GUIDE_IDX_MAX"),d=b.getAttribute("EWA_GUIDE_ID_PREV"),e=b.getAttribute("EWA_GUIDE_ID_NEXT");a==c?
($X(e).value="enus"==EWA.LANG?"Confirm":"\u786e\u5b9a",$X(e).setAttribute("ewa_guide_method","ok")):($X(e).value="enus"==EWA.LANG?"Next":"\u4e0b\u4e00\u6b65",$X(e).setAttribute("ewa_guide_method",""));0==a?$X(d).style.display="none":$X(d).style.display="";b.setAttribute("EWA_GUIDE_IDX",a);this._ShowHidenGroup(b,a)}};this._ShowHidenGroup=function(a,b){for(var c=0;c<a.rows.length-1;c++){var d=a.rows[c];if(null!=d.getAttribute("groupIndex")&&""!=d.getAttribute("groupIndex")){var e=1*d.getAttribute("groupIndex");
d.style.display=b==e?"":"none"}}};this.GroupShow=function(a,b){if(!(0<a.className.indexOf("1"))){this.GroupShowBefore&&this.GroupShowBefore(a,b);for(var c=$X("EWA_FRAME_"+this._Id),d=a.parentNode.parentNode,e=0;e<c.rows.length;e++){var g=c.rows[e];if(g!=d&&!(1==g.cells.length&&g.cells[0].className&&0<=g.cells[0].className.indexOf("EWA_TD_B"))&&"1"!=g.getAttribute("hiddennocontentrow")){var h=0;null!=g.getAttribute("groupIndex")&&""!=g.getAttribute("groupIndex")&&(h=1*g.getAttribute("groupIndex"));
g.style.display=b==h?"":"none"}}c=d.getElementsByTagName("div");for(e=0;e<c.length;e++)d=c[e],d.className=d==a?d.className+"1":d.className.replace("1","");this.GroupShowAfter&&this.GroupShowAfter(a,b)}};this.DoActionJSON=function(a,b,c,d){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","JSON");this._Ajax.AddParameter("EWA_ACTION",a);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_JSON_NAME",b);this._AjaxJsonAfter=
null!=d?d:null;if(null!=c&&0<c.length)for(a=0;a<c.length;a+=1)this._Ajax.AddParameter(c[a].Name,c[a].Value);c=new EWA.C.Url;c.SetUrl(this.Url);c=c.RemoveParameter("EWA_ACTION");this._Ajax.PostNew(c,EWA.F.FOS[EWA.F.CID]._CallBackJs)};this._CallBackJs=function(){var a=EWA.F.FOS[EWA.F.CID],b=a._Ajax;if(4==b._Http.readyState)if(b.HiddenWaitting(),200==b._Http.status){if(b=b._Http.responseText,EWA.F.CheckCallBack(b)){eval(b);a._AjaxJsonAfter&&(a._AjaxJsonAfter(),a._AjaxJsonAfter=null);try{a.ReloadAfter&&
a.ReloadAfter(b)}catch(c){alert(b)}}}else alert("ERROR:\r\n"+b._Http.statusText)};this.RewriteInfo=function(a,b,c,d,e){var g=$("#EWA_FRAME_"+this._Id),h=[];b=b||"id";c=c||"info";d=d||"memo";for(var k=0;k<a.length;k++){var l=a[k],m=g.find("#"+l[b]);0!=m.length&&(m=m.parentsUntil("tr[show_msg]").last().parent(),null==l[c]||""==l[c].trim()?(m.hide(),e&&e(m[0],l,k)):3==m[0].cells.length?(h.push(m[0]),m[0].cells[2].innerHTML=l[d],m[0].cells[0].innerHTML=l[c],e&&e(m[0],l,k)):2==m[0].cells.length?(h.push(m[0]),
m[0].cells[0].innerHTML=l[c],e&&e(m[0],l,k)):1==m[0].cells.length&&(m=m.prev(),1<m[0].cells.length&&(m[0].cells[1].innerHTML=l[d]),h.push(m[0]),m[0].cells[0].innerHTML=l[c],e&&e(m[0],l,k)))}return h};this._HiddenMemo=function(a,b){var c=a.parentNode.parentNode;b=!1;"none"==c.style.display&&(b=!0);c.style.display="none";c.id="tr_"+a.id;c=c.previousSibling;3==c.nodeType&&(c=c.previousSibling);c.style.display="none";a="<span id=tab_"+a.id+' class="ewa_merge_tab" onclick="EWA.F.FOS[\''+this._Id+"'].ShowMemo(this.id);\">"+
c.cells[0].innerHTML+"</span>";return b?"":a};this.ShowMemo=function(a){for(var b=$X(this._Id+"__ewa_meger").getElementsByTagName("SPAN"),c=0;c<b.length;c++){var d=b[c].id.replace("tab_","tr_");"ewa_merge_tab1"==b[c].className&&(b[c].className="ewa_merge_tab",$X(d).style.display="none");b[c].id==a&&(b[c].className="ewa_merge_tab1",$X(d).style.display="")}};this.MergeMemo=function(){var a=$X("EWA_FRAME_"+this._Id).getElementsByTagName("textarea");if(0!=a.length&&"1"!=a[0].getAttribute("ewa_merge")){for(var b=
[],c=0;c<a.length;c++){var d=this._HiddenMemo(a[c]);d="<nobr>"+d.replace("\u2022 ","").trim()+"</nobr>";b.push(d)}a=a[0];c=a.parentNode.parentNode;d=c.previousSibling;3==d.nodeType&&(d=d.previousSibling);d.id=this._Id+"__ewa_meger";d.cells[0].colSpan=3;d.cells[0].innerHTML=b.join("");d.cells[0].style.width="100%";d.cells[0].style.height="25px";d.style.display="";c.style.display="";$X("tab_"+a.id).className="ewa_merge_tab1";null!=window._EWA_DialogWnd&&EWA.UI.Dialog._SetTitle(window._EWA_DialogWnd)}};
this.DoValidEx=function(a,b,c,d,e,g){""!=a.value&&(this._ValidExOk=this.Resources[e],this._ValidExFail=this.Resources[g],this._ValidExObj=a,"action"==b.toLowerCase().trim()?this._DoValidExAction(a,d,this.Resources[e].GetInfo(),this.Resources[g].GetInfo()):(0<=c.indexOf("&quot;")&&(c=c.replace(/&quot;/ig,'"')),eval(c)?(EWA_FrameShowAlert(a,this._ValidExOk.GetInfo()),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,this._ValidExFail.GetInfo()),a.setAttribute("EWA_VALID_EX",this._ValidExFail.GetInfo()))))};
this._DoValidExAction=function(a,b,c,d){if(null!=a&&!$(a).is(":hidden"))if(null==b||""==b.trim())alert("action not value");else{var e=a.id+","+a.value;if(this.DoValidExAction_RETS&&null!=this.DoValidExAction_RETS[e])0==this.DoValidExAction_RETS[e]?(EWA_FrameRemoveAlert(a,c),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,d),a.setAttribute("EWA_VALID_EX",d));else{var g=new EWA.C.Ajax;g.LoadingType="image";g.AddParameter("EWA_AJAX","HAVE_DATA");g.AddParameter("EWA_ACTION",b);g.AddParameter("EWA_ID",
this._Id);g.AddParameter("EWA_NO_CONTENT","1");g.AddParameter(a.id,a.value);this.DoValidExAction_RETS||(this.DoValidExAction_RETS={});var h=this;g.PostNew(this.Url,function(){if(4==g._Http.readyState){g.HiddenWaitting();if(200==g._Http.status){var k=g._Http.responseText;if(EWA.F.CheckCallBack(k))try{var l=parseInt(k.trim());h.DoValidExAction_RETS[e]=l;0==l?(EWA_FrameRemoveAlert(a,c),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,d),a.setAttribute("EWA_VALID_EX",d))}catch(m){alert(m+","+
k)}}else alert("ERROR:\r\n"+g._Http.statusText);g=null}})}}};this.ValidCodeError=function(a){var b=this._t_ValidCodeError||0,c=(new Date).getTime();1E3>c-b?a||(a=_EWA_EVENT_MSG.ValidCodeError,$Tip(a),$(".ewa-valid-code-img").parent().parent().find("input").focus().select()):(this._t_ValidCodeError=c,$(".ewa-valid-code-img").each(function(){this.click()}),a||(a=_EWA_EVENT_MSG.ValidCodeError,$Tip(a),$(".ewa-valid-code-img").parent().parent().find("input").focus().select()))};this.checkIdempotenceError=
function(){$Tip(_EWA_EVENT_MSG.IdempotanceError)};this.checkValidSildePuzzleError=function(){$Tip(_EWA_EVENT_MSG.ValidSildePuzzleError)};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.F=this;this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);"enus"==EWA.LANG&&$(".ewa-ipt-droplist").attr("placeholder","Input character selection");this._InitTranslations();this._GetDropListValue();this._InitMustInputs();this._InitEncyptions();
this._InitTriggerValids()};this._InitTriggerValids=function(){var a=$("#EWA_FRAME_"+this._Id),b="EWA.F.FOS['"+this._Id+"'].callTriggerValid(this)";this.triggerValids={};for(var c in this.ItemList.Items){var d=this.ItemList.Items[c],e=this.ItemList.GetItemValue(d,"Name","Name"),g=$(d).find("DataItem Set[TriggerValid]").attr("TriggerValid");if(g){this.triggerValids[e]=null;var h=a.find("#"+e);0===h.length&&contine;h.attr("ewa_trigger_valid",g);d=$(d).find("Tag Set").attr("Tag");if("submit"==d)break;
if("smsValid"==d){h=a.find(".ewa-row-"+e+" .ewa-sms-valid-code-button");d=h.attr("id");d||(d=EWA_Utils.tempId(),h.attr("id",d));var k=$("<a style='position:absolute;left:0;top:0;right:0;bottom:0'></a>");k.attr("ewa_trigger_valid",g);k.attr("ewa_trigger_valid_rid",e);k.attr("ewa_trigger_valid_click_id",d);h.parent().css("position","relative").append(k);h=k}(e=h.attr("onclick"))&&h.attr("_onclick",e);h.attr("onclick",b)}}};this.callTriggerValidBefore=function(a){return!0};this.callTriggerValid=function(a){if(this.callTriggerValidBefore(a)){var b=
$("#EWA_FRAME_"+this._Id),c=$(a),d=c.attr("id");d||(d=c.attr("ewa_trigger_valid_rid"));var e=this.getUrlClass(),g=c.attr("ewa_trigger_valid");e.AddParameter("ewa_ajax",g);e.AddParameter("ewa_trigger_valid_name",d);e.AddParameter("ewa_trigger_valid_mode","create");e.AddParameter("ewa_trigger_valid_width",document.documentElement.clientWidth);var h=this,k=EWA_Utils.tempId();$J(e.GetUrl(),function(l){if(l.RST){c.attr("_trigger_valid_id",k);var m=top.$DialogHtml("<div id='"+k+"'></div>","enus"==EWA.LANG?
"Silde puzzle":"\u62fc\u56fe\u9a8c\u8bc1",l.bigImgWidth+20,200,!1);l.ewa_trigger_valid_name=d;l.ewa_trigger_valid=g;l.ewa_url=e.GetUrl();EWA.UI.SlidePuzzle(l,top.$("#"+k),function(n){console.log("2. puzzle cb true");var p=!1;c.attr("_onclick")&&(c.attr("onclick",$(a).attr("_onclick")),p=!0);setTimeout(function(){$(m.getMain()).animate({opacity:0},500)},500);setTimeout(function(){var r=c.attr("type");h.triggerValids[d]=n.VALID;var q=$(a).attr("ewa_trigger_valid_click_id");q?(c.remove(),console.log(q+
".click"),b.find("#"+q).click()):p?(console.log("3. puzzle click"),c.click()):"submit"==r&&console.log("3. puzzle submit");m.Close()},1E3)});setTimeout(function(){m.AutoSize()},100)}else alert(l.ERR)})}};this._InitMustInputs=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name");0<$(c).find('IsMustInput Set[IsMustInput="1"]').length&&(c="#"+d,a.find(".ewa-row-"+d).addClass("ewa-row-must"),d=a.find(c),d.addClass("ewa-row-item-must"),
0<d.length&&d.attr("type")&&"hidden"==d.attr("type").toLowerCase()&&d.prev().addClass("ewa-row-item-must"))}};this._InitEncyptions=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name");c=$(c).find("DispEnc Set");if(0!=c.length&&(d=a.find("#"+d),0!=d.length&&c.attr("EncType"))){if("INPUT"==d[0].tagName||"TEXTAREA"==d[0].tagName){if(!d.val())continue;d.prop("disabled",!0);d.attr("ewa_encyrption","yes")}var e=
$("<div class='ewa-enc-cover' style='position:absolute;left:0;top:0;width:100%;height:100%;'><div></div></div>");d.parent().append(e);d.parent().css("position","relative");if(c=c.attr("EncShowUrl")){e.find("div").html("\u70b9\u51fb\u67e5\u770b").css({position:"absolute",height:30,"line-height":"30px",top:"50%","margin-top":"-15px",right:10,"text-align":"right"});c=new EWA_UrlClass(c);e=new EWA_UrlClass(this.Url);for(var g in e._Paras)if(!c.GetParameter(g)){var h=e._Paras[g];null!=h&&(h=h.unURL());
c.AddParameter(g,h)}c.AddParameter("EWA_ENCY_FROM_ID",d.attr("id"));c=c.GetUrl();d.parent().attr("enc_url",c).attr("fid",d.attr("id"));d.parent().on("click",function(){if(!$(this).attr("enc_ok")){var k=$(this).attr("t")||100,l=(new Date).getTime();if(!(400>l-k)){$(this).attr("t",l);k=$(this).attr("enc_url");var m=$(this).find("#"+$(this).attr("fid"));$J(k,function(n){n.RST?(m.prop("disabled",!1),m.removeAttr("ewa_encyrption"),m.val(n.VALUE),$(m).parent().find(".ewa-enc-cover").remove(),$(m).parent().attr("enc_ok",
"1")):(n.ERR||n.MSG)&&$Tip(n.ERR||n.MSG)})}}})}}}};this._InitTranslations=function(){var a="EWA.F.FOS[&quot;"+this._Id+"&quot;]._Trans(this)",b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name"),e=$(c).find("DataItem Set[Translation]");if(c=e.attr("Translation")){e=e.attr("TransTarget");var g="en2zh"==c?" \u82f1\u8bd1\u4e2d":" \u4e2d\u8bd1\u82f1";"enus"==EWA.LANG&&(g="en2zh"==c?" En-Zh":" Zh-En");c=$('<a class="ewa-but-trans" href="javascript:void(0)" onclick="'+
a+'" _transf="'+d+'" _transp="'+c+'" _transt="'+e+'">'+g+"</a>");e=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+d+" .EWA_TD_L");0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+d+" .EWA_TD"));0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" #"+d).parent().prev().find(".ewa_d1"));0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" #"+d).parent(),e.css("position","relative"),c.addClass("ewa-but-trans-float"));e.append(c)}}};this._Trans=function(a){if(a){var b=$(a).attr("_transf"),c=$(a).attr("_transp");a=$(a).attr("_transt");
b=$("#EWA_FRAME_"+this._Id+" #"+b);a=$("#EWA_FRAME_"+this._Id+" #"+a);if(0==b.length||0==a.length)console.log("trans ex:",b,a);else{var d=b[0].tagName.toLowerCase();if(b="input"==d||"textarea"==d||"hidden"==d?b.val():b.text()){var e=new EWA_TransClass;"en2zh"==c?e.transToCn(b,a[0]):e.transToEn(b,a[0]);$Tip("enus"==EWA.LANG?"Translating...":"\u7ffb\u8bd1\u4e2d...",function(){return!e.IsRun})}}}};this._bindCompostion=function(a,b){if(!EWA.B.IE){var c=this;c._droplist_||(c._droplist_={});c._droplist_[b.id]=
{_is_composition:!1};$(a).on("compositionstart",function(){c._droplist_[b.id]._is_composition=!0}).on("compositionend",function(){c._droplist_[b.id]._is_composition=!1;EWA.F.I.DropList(this)}).removeAttr("oninput").removeAttr("onkeyup").on("input",function(){c._droplist_[b.id]._is_composition||EWA.F.I.DropList(this)})}};this._GetDropListValue=function(){var a=this.getObj();if(0!=a.length){a=a[0];var b=a.getElementsByTagName("input");this._droplist_={};for(var c=0;c<b.length;c++){var d=b[c];if("droplist"==
d.getAttribute("ewa_class")){var e=d.nextSibling;"INPUT"==e.tagName.toUpperCase()&&"HIDDEN"==e.type.toUpperCase()&&(this._GetDropListValue1(d,e),this._bindCompostion(d,e))}}a=a.getElementsByTagName("select");for(c=0;c<a.length;c++)if(d=a[c],b=d.getAttribute("_ListFilterType"))e=d.getAttribute("_ListFilterField"),this.initSelectFilter(d.id,b,e);this._SelectFilters&&this._checkSelectOptionsChange()}};this.refreshDropList=function(a,b){var c=this.getObj('input[id="'+a+'"]');if(0==c.length)console.warn("Can not found id="+
a);else{var d=c.prev();0==d.length?console.warn("Can not found  id="+a+" prev"):"droplist"==d.attr("ewa_class")?(c.val(b),this._GetDropListValue1(d[0],c[0])):console.warn("Not droplist id="+a+" prev")}};this._GetDropListValue1=function(a,b){if(""==b.value)b.setAttribute("setvalue",1);else{var c=b.getAttribute("DlsShow");if(null==c||""==c)b.setAttribute("canopen",0),a.value=obj1.value,b.setAttribute("canopen",1);else{var d=b.getAttribute("xmlName"),e=b.getAttribute("itemName"),g=b.getAttribute("paraName"),
h=b.getAttribute("DlsAction"),k=b.value;var l=this.EWA_CGI?this.EWA_CGI:window.EWA_CGI?window.EWA_CGI:EWA.CP+"/EWA_STYLE/cgi-bin/";var m=-1==l.indexOf("?")?"?":"&";l=(l+(m+"XMLNAME="+d+"&ITEMNAME="+e+"&EWA_AJAX=JSON")).replace("//","/");l=l.replace("//","/");l=l.replace("//","/");d={};d[g]=k;null!=h&&0<h.trim().length&&(d.EWA_ACTION=h,d[b.id]=b.value);$JP(l,d,function(n){if(0!=n.length){var p=n[0],r=[];n={};for(var q in p)r.push(p[q]),n["@"+q.toUpperCase()]=p[q],p[q]&&b.setAttribute("para_"+q.toLowerCase(),
p[q]);if(null==c||""==c)n=r.join("/");else{q=c.match(/@[a-zA-Z0-9\-\._:]*\b/ig);for(p=0;p<q.length;p++){r=q[p];var t=n[r.toUpperCase()];c=c.replace(r,t)}n=c}b.setAttribute("canopen",0);a.value=n;b.id=null==b.id||""==b.id?Math.random():b.id;"yes"==b.getAttribute("isdlseventload")&&(EWA.F.FOS[b.id]=new EWA_FrameItemClass,EWA.F.FOS[b.id].DropList(a),EWA.F.FOS[b.id].CallAfterEvent());b.setAttribute("canopen",1);b.setAttribute("setvalue",1)}})}}};this.DoPostEx=function(){EWA.F.F.CUR=this;if(this.CheckValidAll(document.forms[0])){this._Ajax=
...
for(b=0;b<a.length;b+=1)c=a[b],d=""==c.name?c.id:c.name,null!=d&&""!=d&&this._Ajax.AddParameter(d,c.value);this._Ajax.PostNew(this.Url,EWA.F.F.CUR._CallBack)}};this.createAjax=this.CreateAjax=function(a,b){EWA.F.F.CUR=this;null==a&&(a=$("#f_"+this._Id)[0]);if(!b&&!this.CheckValidAll(a))return null;a=new EWA.C.Ajax;b=this.CreatePostData();for(var c in b)a.AddParameter(c,b[c]);return a};this.createPostData=this.CreatePostData=function(a){a=a||$("#f_"+this._Id)[0];var b={},c;for(c in this.ItemList.Items){var d=
this.ItemList.GetItemValue(this.ItemList.Items[c],"Name","Name"),e=this.GetObject(d,a);if(null!=e&&!$(e).attr("ewa_encyrption")){var g=e.getAttribute("ewa_tag");if("signature"==g){var h="N";var k=this.tablets[c];for(var l=0;l<k.lines.length;l++)if(k.lines[l]){h="Y";break}k="Y"==h?this._GetObjectValue(e):"";b[d+"_CHANGED"]=h}else k=this._GetObjectValue(e);null!=k&&(b[d]=k);"DIV"==e.tagName.toUpperCase()&&"1"==e.getAttribute("EWA_DHTML")&&(h=$X("UP_IMG_"+d).value,b[d+"_imgs_split"]=h);if("swffile"==
g||"IMG_UPLOAD"==g)if(d=e.getAttribute("UP_PARAS"),null!=d&&0<d.length)for(d=d.split(","),g=0;g<d.length;g++){var m=d[g];b[m]=e.getAttribute(m)}else b.UP_URL=e.value;else"markdown"==g&&(e=e.parentNode.getElementsByTagName("textarea"),1<e.length&&(b[e[1].id]=e[1].value))}}if(this.PostAddData)for(m in this.PostAddData)b[m]=this.PostAddData[m];if(this.triggerValids)for(var n in this.triggerValids)b[n+"_TRIGGER_VALID_RESULT"]=this.triggerValids[n];return b};this.DoPostBefore=function(){return!0};this.isDoPostBeforeTimer=
function(){return null!=this._checkStatusFristResult};this._uploadingFileCheck=function(a){a=window["h5u_"+this._Id+"$"+a.id];if(!a.haveFile())return!1;if("ok"==a.UPLOAD_STATUS)return a.removeWaitBox(),this.uploadProcess=!1;if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;if("error"==a.UPLOAD_STATUS||"abort"==a.UPLOAD_STATUS)return this._stopPost=!0,this._stopPostError="enus"==EWA.LANG?"Upload file error or aborted":"\u4e0a\u4f20\u6587\u4ef6\u9519\u8bef\u6216\u88ab\u4e2d\u6b62",
console.log(this._stopPostError),!1;if("start"==a.UPLOAD_STATUS||"checking"==a.UPLOAD_STATUS)return!0;a.submitUploads();if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;$X(a.WAIT_ID)||a.createWaitBox();return this.uploadProcess=!0};this._checkTriggerValids=function(){if(!this.triggerValids)return!0;var a=$("#EWA_FRAME_"+this._Id);for(b in this.triggerValids)if(!this.triggerValids[b]){a=a.find("#"+b);if(0<a.length&&"submit"==a[0].type){var b=a.attr("_trigger_valid_inc")?
1*a.attr("_trigger_valid_inc"):0;if(0==b)this.callTriggerValid(a);else{var c=a.attr("_trigger_valid_id");if(!c)return!1;if(0==top.$("#"+c).length)return this._cancelPostWait=!0,a.removeAttr("_trigger_valid_inc"),a.removeAttr("_trigger_valid_id"),console.log("\u7a97\u53e3\u4e0d\u89c1\u4e86\uff0c\u53d6\u6d88\u63d0\u4ea4\u7b49\u5f85"),!1}b++;a.attr("_trigger_valid_inc",b)}return!1}return!0};this.DoPost=function(a,b,c){if(this.posting)return!1;if(this._cancelPostWait)return console.log("\u53d6\u6d88\u63d0\u4ea4"),
this._cancelPostWait=null,!1;var d=this;if(!c){var e=this.DoPostBefore();if(e instanceof Array){d=this;this._checkStatusInc=0;this._checkStatusFristResult=e;this._checkStatusTimer=window.setInterval(function(){var n=0==d._checkStatusInc?d._checkStatusFristResult:d.DoPostBefore();d._checkStatusInc++;var p=n[0];if(null!==p&&void 0!==p){window.clearInterval(d._checkStatusTimer);d._checkStatusTimer=null;d._checkStatusInc=null;d._checkStatusFristResult=null;var r=n[1];n=n[2];p&&!n?d.DoPost(a,b,!0):p&&
n?$Confirm(r,r,function(){d.DoPost(a,b,!0)},function(){}):r&&$Tip(r)}},232);return}if(!e)return}var g=$(a).find("input[ewa_tag=ht5upload]");if(!(0<g.length)||this.uploadProcess||this.CheckValidAll(a)){var h=0;for(e=0;e<g.length>0;e++){var k=g[e];this._uploadingFileCheck(k)&&h++}if(0<h)setTimeout(function(){d.DoPost(a,b)},700);else{g=$(a).find("input[ewa_tag=ht5takephoto]");if(0<g.length&&!this.uploadProcess&&!this.CheckValidAll(a))return!1;for(e=0;e<g.length>0;e++){k=g[e];h=!1;k=window["h5takephoto_"+
this._Id+"$"+k.id];if("ok"!=k.UPLOAD_STATUS){if(!$X(k.H5_UPLOAD.WAIT_ID)){try{k.submitUpload()}catch(n){console.log("ht5takephotos - ht5.submitUpload: "+n);$Tip("\u60a8\u6ca1\u6709\u83b7\u53d6\u7167\u7247");return}k.H5_UPLOAD.createWaitBox();this.uploadProcess=!0}h||(d=this,setTimeout(function(){d.DoPost(a,b)},700),h=!0);return}k.H5_UPLOAD.removeWaitBox()}if(this._stopPostError)return EWA.UI.Msg.ShowError(this._stopPostError,""),!1;e=this.CreateAjax(a);if(null==e)return!1;if(this._checkTriggerValids()){null==
b&&(b=this.Url);if(""==b||null==b)b=window.location.href;this._Ajax=e;this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.LoadingType="image";this.DoPostStart&&this.DoPostStart(this._Ajax);e=new EWA_UrlClass(b);for(var l in this._Ajax._Parameters)e.RemoveParameter(l);b=e.GetUrl();this.posting=!0;var m=this;this._Ajax.PostNew(b,function(){m._CallBack()});this.isShowPostWaitting||this._Ajax.HiddenWaitting();$("#EWA_FRAME_"+
this._Id+" input[type=submit]").attr("disabled","disabled");return!0}setTimeout(function(){d.DoPost(a,b,c)},500)}}};this._CallBack=function(){var a=this._Ajax;if(a.IsRunEnd())if($("#EWA_FRAME_"+this._Id+" input[type=submit]").attr("disabled",null),this.posting=!1,this.DoPostEnd&&this.DoPostEnd(a,a._Http.status,a._Http.responseText,a._Http.statusText),200==a._Http.status){if(a=a._Http.responseText,EWA.F.CheckCallBack(a)){this.ValidCodeError(!0);var b=null;this.doPostAfter?b=this.doPostAfter:this.ReloadAfter&&
(console.warn("\u8bf7\u7528\uff1adoPostAfter"),b=this.ReloadAfter);try{b&&b(a)||eval(a)}catch(c){console.log(a),console.error(c),alert(a)}}}else alert("ERROR:\r\n"+a._Http.statusText)};this.Reload=function(){};this.Reload1=function(){console.log("Reload1 \u8fd9\u4e2a\u5e72\u561b\u7528\uff1f\u8c01\u5728\u8c03\u7528\uff1f")};this.ReloadFrame=function(a){var b=$("#f_"+this._Id);if(0!=b.length){var c=new EWA_UrlClass(this.Url),d=null,e=this._last_reload_frame_id;e?d=$("#"+this._last_reload_frame_id):
(e=EWA_Utils.tempId("ewa_frame_relaod"),d=b.parentsUntil("#EWA_FRAME_MAIN").last().parent(),"EWA_FRAME_MAIN"!=d[0].id&&(d=$("<div class='ewa-reload-frame'></div>"),d.insertBefore(b),d.append(b)),this._last_reload_frame_id=e,d.attr("id",e));c=new EWA_UrlClass(this.Url);c.AddParameter("ewa_ajax","install");b=c.GetUrl();$Install(b,e,function(){a&&a(d,this)})}};this.CheckValidAll=function(a){var b=!0,c=null,d;for(d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],"Name",
"Name");e=this.GetObject(e,a);null!=e&&((b&=this.CheckValid(e))||null!=c||(c=e))}null!=c&&c.focus();return b};this.H5Type=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name");d=a.find('[id="'+d+'"]');if(0!=d.length){var e=this.ItemList.GetItemValue(c,"Tag","Tag"),g=this.ItemList.GetItemValue(c,"DataItem","Valid");this.ItemList.GetItemValue(c,"DataItem","Format");c=this.ItemList.GetItemValue(c,"IsMustInput",
"IsMustInput");"Email"==g&&d.attr("type","email");"valid"==e&&d.attr("type","tel");1==c&&d.attr("required","required")}}};this.GetObject=function(a,b){b||(b=$("FORM#f_"+this._Id));a=$(b).find('[id="'+a+'"]');return 0<a.length?a[0]:null};this.CheckValid=function(a,b){if("SPAN"==a.tagName||"IMG"==a.tagName)return!0;if(a&&b&&"DIV"==a.tagName&&"REPT"==a.getAttribute("tag")){b=b.target.tagName;if("LABEL"==b||"INPUT"==b){var c=this;setTimeout(function(){c._GetObjectValue(a);c.ItemList.CheckValid(a,d)},
10)}return!0}var d=this._GetObjectValue(a);return this.ItemList.CheckValid(a,d)};this._GetObjectValue=function(a){return this.ItemList.GetObjectValue(a)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}var __EWA_ALTER_MSG=null;
function EWA_FrameShowAlert(a,b){if(1!=a.getAttribute("show_alert")){a.setAttribute("show_alert",1);var c=a;do if(c=c.parentNode,"BODY"==c.tagName){c=null;break}while("TR"!=c.tagName||1!=c.getAttribute("SHOW_MSG"));if(!c){var d=$(a);d.attr("ori_bc",d.css("background-color"));d.css("background-color","pink");"SELECT"!=a.tagName&&a.focus();d=$(a).parentsUntil("tbody").last();d.prev().hasClass("ewa-row-"+a.id)&&(c=d.prev()[0])}if(c)if(1==c.cells.length||"1"==c.parentNode.parentNode.getAttribute("error_show_type")){d=
$(c);var e=d.next();e.attr("error")||(e=c.parentNode.insertRow(c.rowIndex+1),e.setAttribute("error",1),e.setAttribute("rid",a.id),a=e.insertCell(-1),a.colSpan=c.cells.length,a.className="ewa-tip-error",e=$(e),a.innerHTML='<div class="ewa-tip-error-info"></div>');d.find("td").addClass("ewa-tip-error");e.find(".ewa-tip-error-info").html(b)}else 3==c.cells.length?(c.style.backgroundColor="lightyellow",null==a.getAttribute("ori_msg")&&(a.setAttribute("ori_msg",c.cells[2].innerHTML),a.setAttribute("ori_st",
c.cells[2].style.borderLeft)),c.cells[2].innerHTML=a.getAttribute("ORI_MSG")+"(<font color=red>"+b+"</font>)",c.cells[2].style.borderLeft="2px solid red"):($(c).find("td").css("background-color","lightyellow"),"SELECT"!=a.tagName&&a.focus(),1==c.cells.length?(c=$(c).prev(),c.attr("id")&&0<c.attr("id").indexOf(a.id)?(null==a.getAttribute("ori_msg")&&a.setAttribute("ori_msg",c[0].cells[0].innerHTML),c[0].cells[0].innerHTML=a.getAttribute("ori_msg")+"(<font color=red>"+b+"</font>)"):(alert("\u8bf7\u8f93\u5165\uff1a"+
b),a.focus())):(null==a.getAttribute("ori_msg")&&a.setAttribute("ori_msg",c.cells[0].innerHTML),c.cells[0].innerHTML=a.getAttribute("ori_msg")+"(<font color=red>"+b+"</font>)"))}}
function EWA_FrameRemoveAlert(a){__EWA_ALTER_MSG&&(__EWA_ALTER_MSG.style.display="none");if(1==a.getAttribute("show_alert")){a.setAttribute("show_alert",0);var b=a;do if(b=b.parentNode,"BODY"==b.tagName){b=null;break}while("TR"!=b.tagName||1!=b.getAttribute("SHOW_MSG"));if(!b){var c=$(a);c.css("background-color",c.attr("ori_bc"));c=$(a).parentsUntil("tbody").last();c.prev().prev().hasClass("ewa-row-"+a.id)&&(b=c.prev().prev()[0])}b&&(b.style.backgroundColor="",1==b.cells.length||"1"==b.parentNode.parentNode.getAttribute("error_show_type")?
(a=$(b),a.find("td").removeClass("ewa-tip-error"),a=a.next(),a.attr("error")&&a.remove()):3==b.cells.length?(b.cells[2].innerHTML=a.getAttribute("ori_msg"),b.cells[2].style.borderLeft=a.getAttribute("ori_st")):1==b.cells.length?(b=$(b).prev(),b.attr("id")&&0<b.attr("id").indexOf(a.id)&&(b[0].cells[0].innerHTML=a.getAttribute("ori_msg"))):($(b).find("td").css("background-color",""),b.cells[0].innerHTML=a.getAttribute("ori_msg")))}}
...
_EWA_FRAME_ITEM.SetContent(l)}});this.SetContent(this._Items[c.value])}else this._SelectedValue=null};this.MouseOver=function(a){a=a?a:window.event;a=a.srcElement?a.srcElement:a.target;if("TD"==a.tagName){a=a.parentNode;if(null!=this._LastMoveTr)for(var b=0;b<this._LastMoveTr.cells.length;b+=1)this._LastMoveTr.cells[b].style.backgroundColor="";if("HEADER"==a.getAttribute("EWA_TAG"))this._LastMoveTr=null;else{for(b=0;b<a.cells.length;b+=1)a.cells[b].style.backgroundColor="#cccccc";this._LastMoveTr=
...
window.location.href,a,function(c){c.RST?$TipTL("\u4fdd\u5b58\u5b8c\u6bd5"):$Tip(c.ERR)})};this.showGpsMap=function(a,b){var c=a.attr("ref_map");if(c){var d=b.parent().parent().next().find(".ewa-map-small");if(0==d.length){var e=this;setTimeout(function(){e.showGpsMap(a,b)},100)}else 0==c.indexOf(".")||0==c.indexOf("#")?$(c).append(d.css("height","100%")):$("#"+c).append(d.css("height","100%"))}};this.mapRefItem=function(a,b){var c=$(a),d=c.attr("ref");d=b.find('[id="'+d+'"]');var e=!1,g=this,h="",
k="EWA.F.FOS['"+this._Id+"']";if("hidden"==d[0].type){if(!d.attr("setvalue")){setTimeout(function(){g.mapRefItem(a,b)},100);return}d=d.prev();h=d.val();c.attr("onclick",k+".modifyRef(this)").css("cursor","pointer")}else if("addressMap"==d.attr("ewa_tag"))h=d.val(),c.attr("onclick",k+".modifyRef(this)").css("cursor","pointer"),this.showGpsMap(c,d);else{if("REPT"==d.attr("tag")){c=$(a);c.offset();c.offset();c.outerWidth();c.append(d);d.find("input[type=checkbox]").attr("onclick",k+".checkbox(this)");
...
c.hasClass("ewa-editor-pop")||c.hasClass("ewa-dialog"))return!0}return!1};this.modifyRef=function(a){var b=$(a);a=b.attr("ref");var c=$("#EWA_FRAME_"+this.EWA._Id).find('[id="'+a+'"]');"hidden"==c[0].type&&(c=$(c).prev());var d=b.offset().left,e=b.offset().top,g=b.outerWidth(),h=b.outerHeight();"TEXTAREA"==c[0].tagName&&(h+=30);g={position:"absolute",left:d,top:e,width:g,height:h,font:b.css("font"),border:"2px solid antiquewhite",outline:"none"};c.css(g);g=c.val();c.attr("oldv",g);g=$($X("_ewa_tr$"+
...
"");else{this.focus();$(this).css("background","pink");return}}p=this.id;r=this.value;"droplist"==$(this).attr("ewa_class")&&(r=$(this).next().val(),p=$(this).next().attr("id"));p={key:p,val:r};if("rgb(255, 255, 224)"==n)$Tip(m.html()),k.hide(),this.focus();else if(this.value==$(this).attr("oldv"))$(this).attr("style",""),k.hide();else{var q=this;$JP(l.POST_URL||window.location.href,p,function(t){$(q).attr("style","");k.hide();t.RST?(t="SELECT"==q.tagName?q.options[q.selectedIndex].text:q.value,"TEXTAREA"==
q.tagName?""==t?b.html("............."):(t=t.replace(/</ig,"&lt;").replace(/>/ig,"&gt;"),t="<div>"+t.split("\n").join("</div><div>")+"</div>",b.html(t)):(""==t&&(t="............."),b.text(t)),b.append('<i style="margin-left:5px" class="fa fa-edit"></i>'),$TipTL("\u4fdd\u5b58\u5b8c\u6bd5")):$Tip(t.ERR)})}})}}}
...
!1;this.CheckedAllAfter=this.ReloadAfter=null;this.REPLACE_HISTORY_STATE=this.IsNotMDownAutoChecked=!1;this._IsSearchGroup=!0;this.composeSearchTexts=function(){var a=[],b=[],c=$("#EWA_RESHOW_"+this._Id+" .ewa-lf-search-type-text");if(0==c.length)return null;c.each(function(g){var h=$(this).find(".ewa-lf-search-item-title").text();h=h.replace(":","").replace("\uff1a","").replace("\u5305\u542b","").replace("Like","").trim();var k=$(this).find("input[type=text]").attr("name");a.push(h);b.push(k);0<
g&&$(this).hide()});var d=$(c[0]);d.addClass("ewa-app-lf-search-compose");d.find("input[type=text]").attr("name",b.join(",")).attr("placeholder",a.join(", "));var e=d.find("a").clone();d.find(".ewa-lf-search-item-title b").text("enus"==EWA.LANG?"Search":"\u7efc\u5408\u641c\u7d22").append(e);return c};this.switchButtonAction=function(a,b){if(b){var c=this.getUrlClass();c.AddParameter("ewa_switch_name",a.name);c.AddParameter("ewa_action",b);c.AddParameter("ewa_ajax","json");c.AddParameter("ewa_switch",
a.checked?"on":"off");c.AddParameter("ewa_action_key",$(a).parentsUntil("tbody").last().attr("ewa_key"));var d=a.parentNode,e=d.getAttributeNames();b={};for(var g in e){var h=e[g],k=d.getAttribute(h);0!=h.indexOf("on")&&"name"!=h&&"id"!=h&&"class"!=h&&(b[h]=k)}var l=this;c=c.GetUrl();$JP(c,b,function(m){l.extSwitchCallBack&&l.extSwitchCallBack(a,m)})}};this.ShowRecycle=function(){var a=$X("EWA_LF_"+this._Id);if(null!=a&&(a=$(a).parentsUntil("table").last().find(".ewa_lf_func_caption"),0!=a.length)){var b=
"\u56de\u6536\u7ad9";window._EWA_INFO_MSG&&window._EWA_INFO_MSG.RECYCLE&&(b=window._EWA_INFO_MSG.RECYCLE);b="<div class='ewa_lf_func_dact ewa-lf-func-recycle' onclick='EWA.F.FOS[\""+this._Id+"\"].ShowRecycle1(this)' ><b class='fa fa-recycle'></b>"+b+"</div>";a.parent().append(b)}};this.ShowRecycle1=function(a){var b=new EWA_UrlClass(this.Url);$(a).attr("recycle")?(b=b.RemoveParameter("ewa_recycle"),$(a).attr("recycle",null).removeClass("ewa-lf-func-recycle-yes")):(b=b.AddParameter("ewa_recycle","1"),
$(a).attr("recycle",1).addClass("ewa-lf-func-recycle-yes"));this.Url=b;this.Goto(1)};this.BindButton=function(a,b){$("#EWA_LF_"+this._Id+' tr[ewa_key] [id="'+a+'"]').each(function(){$(this).attr("onclick","$(this).parent().parent().find('[id=\""+b+"\"]')[0].click()");$(this).addClass("ewa-map-button")})};this.Merges=function(a){if(null==a||0==a.length)console.log("cfg.from, cfg.to, cfg.str, cfg.func, cfg.header");else for(var b=0;b<a.length;b++){var c=a[b];this.Merge(c.from,c.to,c.str,c.func,c.header)}};
this.Merge=function(a,b,c,d,e){var g=$("#EWA_LF_"+this._Id);null==c?c="":-1==c.indexOf("<")&&(c="<span class='ewa-merge-str ewa-mearge-str'>"+c+"</span>");g.find("tr[ewa_key],tr.ewa-lf-sub-tr").each(function(){var h=$(this).find('[id="'+b+'"]').parentsUntil("tr").last();if("yes"!=h.attr("ewa-merged")){h.attr("ewa-merged","yes");var k=$(this).find('[id="'+a+'"]');k.parentsUntil("tr").last().hide();h.append(c);h.append(k);d&&d(h,this)}});e&&(e="<span class='ewa-lf-merge-header-split'></span>"+g.find('tr[ewa_tag="HEADER"] [id="'+
a+'"]').html(),g.find('tr[ewa_tag="HEADER"] [id="'+b+'"]').append(e));g.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').parent().hide();g.find("td#ADD_ROW_"+a).hide()};this.Mearge=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 Merge");this.Merge(a,b,c)};this.MergeExp=function(a,b,c,d,e){if(b){var g=$("#EWA_LF_"+this._Id),h=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),k=[],l=b,m={};b=[];for(var n=0;n<h.length;n++){var p=h[n];k.push(p);var r=p.replace("@@","");l=l.replace(p,"<span class='ewa-lf-merge ewa-lf-merge-"+
r+" ewa-lf-mearge ewa-lf-mearge-"+r+"' mid=\""+r+'"></span>');r!=a&&(g.find('tr[ewa_tag="HEADER"] [id="'+r+'"]').parent().hide(),g.find("td#ADD_ROW_"+r).hide());p=g.find('tr[ewa_tag="HEADER"] [id="'+r+'"]').html();m[r]=p;b.push(p)}e&&(e=b.join("<span class='ewa-lf-merge-header-split'></span>"),g.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(e));g.find("tr[ewa_key],tr.ewa-lf-sub-tr").each(function(){if(0==$(this).find('[id="'+a+'"]').length)console.log("not find "+a);else{var q=$(this).hasClass("ewa-lf-sub-tr")?
$(this).find('[id="ADD_ROW_'+a+'"]'):$(this).find(".ewa-col-"+a);if("yes"!=q.attr("ewa-merged")){var t=$('<div style="display:none"></div>');t.html(l);for(var v in k){var u=k[v].replace("@@",""),x=$(this).find('[id="'+u+'"]');if(0!=x.length){u!=a&&x.parent().hide();var w=t.find('span[mid="'+u+'"]');c&&(w.append("<span class='ewa-lf-mearge-memo'></span>"),w.find(".ewa-lf-mearge-memo").html(m[u]));w.append(x)}}for(;0<t[0].childNodes.length;)q.append(t[0].childNodes[0]);$(t).remove();d&&d(q,this);q.attr("ewa-merged",
"yes")}}})}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MeargeExp=function(a,b,c,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 MereExp");this.MergeExp(a,b,c,d)};this.SubBottoms=function(a){this.SubBottomsArray=a.split(",");this._SubBottoms()};this.reCalcBottoms=function(){this._SubBottoms()};this._SubBottoms=function(){var a=$("#EWA_LF_"+this._Id).find(".ewa-lf-sub-tr");0==a.length?(a=$(this.AddRow([])),a.addClass("ewa-lf-sub-tr"),a.find("td").addClass("ewa-lf-sub-td")):
a.find("td").text("");var b={},c;for(c in this.SubBottomsArray){b={total:void 0,fm_length:void 0};var d=this.SubBottomsArray[c];b.total=0;var e="#EWA_LF_"+this._Id+' .ewa-lf-data-row [name="'+d+'"]';b.fm_length=0;$(e).each(function(g){return function(){var h=this.hasAttribute("value")?this.value:this.hasAttribute("title")?this.title:this.innerText;null!=h&&0!==h.length&&(h=h.replace(/,/ig,""),isNaN(h)||(g.total+=1*h,0<h.indexOf(".")&&(g.fm_length=2)))}}(b));b="<span id='"+d+"' name='"+d+"' class='ewa-lf-sub'>"+
b.total.fm(b.fm_length)+"</span>";a.find("td[id=ADD_ROW_"+d+"]").html(b)}};this.ChangeRowStyle=function(a,b,c){for(var d=$X("EWA_LF_"+this._Id),e=1;e<d.rows.length;e++){var g=d.rows[e];if(!(0==g.cells.length||g.cells.length<=a)){var h=g.cells[a].childNodes[0].getAttribute(b);if(null!=h&&c[h])for(var k=0;k<g.cells.length;k++)g.cells[k].style.cssText=g.cells[k].style.cssText+";"+c[h]}}if(null==this.ReloadAfter){var l=this;this.ReloadAfter=function(){l.ChangeRowStyle(a,b,c)}}};this.MDownEvent=function(a,
b){};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.Workflow=function(a,b,c,d,e,g){EWA.F.CID=this._Id;this._Ajax=this.CreateAjax();this._Ajax.AddParameter("EWA_AJAX","WORKFLOW");this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_WF_NAME",b);null!=c?(a=this.GetRowKey(c),this._Ajax.AddParameter("EWA_ACTION_KEY",a),"true"==c.getAttribute("ewa_wf_control")?this._Ajax.AddParameter("EWA_WF_CTRL",1):this._Ajax.AddParameter("EWA_WF_CTRL",0)):
this._Ajax.AddParameter("EWA_WF_CTRL",1);null!=d&&this._Ajax.AddParameter("EWA_ACTION_KEY",d);e&&this._Ajax.AddParameter("EWA_WF_UOK",e);g&&this._Ajax.AddParameter("EWA_WF_UMSG",g);var h=this;this._Ajax.PostNew(this.Url,function(){h._CallBackJs()})};this.GetRowKey=function(a){a=this.GetRow(a);return null!=a?a.getAttribute("EWA_KEY"):null};this.GetRow=function(a){if(null==a||null==a.tagName||""==a.tagName)return null;var b=0;for(a=a.parentNode;"TR"!=a.tagName||null==a.getAttribute("EWA_KEY");){a=a.parentNode;
if("BODY"==a.tagName){a=null;break}b++;if(100<b){alert("\u5faa\u73af100\u6b21\uff0c\u672a\u53d1\u73b0TR");break}}return a};this.RecordModify=function(a,b,c){var d=this.SelectChecked();if(0==d.length)EWA.UI.Msg.Alter("\u8bf7\u5148\u9009\u62e9","\u4fee\u6539");else{var e="EWA_MTYPE=M";null!=c&&0<c.trim().length&&(e+="&"+c);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,e+d)}};this.RecordNew=function(a,b,c){var d="EWA_MTYPE=N";null!=c&&0<c.trim().length&&(d+="&"+c);EWA.UI.Dialog.OpenReloadClose(this._Id,
a,b,!1,d)};this.SelectSingle=function(){this.IsTrSelect=!0;this._TrSelectMulti=!1};this.SelectMulti=function(){this._TrSelectMulti=this.IsTrSelect=!0};this.MOver=function(a,b){if(this.IsTrSelect&&this._CurTr!=a&&(null!=this._CurTr&&("1"!=this._CurTr.getAttribute("__ewa_lf_mdown")?this._MSetBg(this._CurTr,""):this._MSetBg(this._CurTr,"down")),"1"!=a.getAttribute("__ewa_lf_mdown")?this._MSetBg(a,"over"):this._MSetBg(a,"down"),this._CurTr=a,this.MOverEvent))try{this.MOverEvent(a,b)}catch(c){console.log(c,
this.MOverEvent)}};this.MOut=function(a){if(this.IsTrSelect&&null!=this._CurTr&&"1"!=this._CurTr.getAttribute("__ewa_lf_mdown")){this._MSetBg(this._CurTr,"out");if(this.MOutEvent)try{this.MOutEvent(this._CurTr,a)}catch(b){console.log(b,this.MOutEvent)}this._CurTr=null}};this.MDownEnableCheck=function(a,b){return!0};this.checkMDownEnable=function(a,b){if(!b)return!0;b=b.srcElement?b.srcElement:b.target;return!b||"TD"==b.tagName&&b.parentNode==a?!0:"A"==b.tagName||"A"==b.parentNode.tagName||"INPUT"==
b.tagName||"SELECT"==b.tagName||"BUTTON"==b.tagName||"TEXTAREA"==b.tagName||0<=b.className.indexOf("EWA_LF_EDIT")||0<=b.className.indexOf("ewa-lf-edit")||0<=b.className.indexOf("ewa-lf-search-text-click")||0<=b.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=b.parentNode.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=b.className.indexOf("ewa-mdown-stop")?!1:!0};this.mDownAutoCheck=function(a,b,c){for(var d,e=0;e<b.length&&!(0<=b[e].parentNode.className.indexOf("ewa-switch"));e++){if("RADIO"==
b[e].type.toUpperCase())return d=b[e],d.click(),d;if("CHECKBOX"==b[e].type.toUpperCase()){d=b[e];d.click();if(!this._TrSelectMulti){var g=$(b[e]).attr("id")||$(b[e]).attr("name");0==$(c).find(b[e]).length&&$(a).siblings(".ewa-lf-data-row").find("input[name='"+g+"']:checked").prop("checked",!1);d.checked=!0}return d}}return null};this.newRowOneTd=function(a){if(null==a)return null;a=$(a)[0];var b=a.parentNode.rows[a.rowIndex+1];if(null!=b&&"1"==b.getAttribute("add_pre_row"))return b;b=a.parentNode.parentNode;
var c=b.rows[0].cells.length;b=b.insertRow(a.rowIndex+1);b.setAttribute("add_pre_row",1);a=b.insertCell(-1);a.colSpan=c;a.className="ewa-lf-add-pre-cell";b.style.display="none";a.id=EWA_Utils.tempId("EWA_LF_NR_"+this._Id);$(b).addClass("ewa-lf-add-pre-row");return b};this.MDown=function(a,b){if(this.IsTrSelect){var c=(new Date).getTime(),d=$(a).attr("mdown_time_last");if(!(null!=d&&500>c-d)&&($(a).attr("mdown_time_last",c),b=null==b?window.event:b,this.MDownEnableCheck(a)&&this.checkMDownEnable(a,
b))){d=b.srcElement?b.srcElement:b.target;var e=null;c=a.getElementsByTagName("input");this.IsNotMDownAutoChecked||(e=this.mDownAutoCheck(a,c,d));if("1"==a.getAttribute("__ewa_lf_mdown"))this._TrSelectMulti&&(e&&"CHECKBOX"==e.type.toUpperCase()&&(e.checked=!1),this._MSetBg(a,""),a.removeAttribute("__ewa_lf_mdown"),$(a).removeClass("ewa-lf-mdown"));else{e&&(e.checked=!0);this._MSetBg(a,"down");a.setAttribute("__ewa_lf_mdown",1);$(a).addClass("ewa-lf-mdown");if(!this._TrSelectMulti&&(e=a.parentNode)&&
e.rows)for(d=0;d<e.rows.length;d++){var g=e.rows[d];"1"==g.getAttribute("__ewa_lf_mdown")&&g!=a&&(g.removeAttribute("__ewa_lf_mdown"),$(g).removeClass("ewa-lf-mdown"),this._MSetBg(g,""))}if(this.IsReShow)for(d=0;d<c.length;d++)"BUTTON"==c[d].type.toUpperCase()&&(e=c[d],"true"==e.getAttribute("disabled")||1==e.getAttribute("disabled")||"true"==e.parentNode.getAttribute("disabled")||1==e.parentNode.getAttribute("disabled")?(this._ReshowButs[e.value].disabled=!0,this._ReshowButs[e.value].style.display=
"none"):(this._ReshowButs[e.value].disabled=!1,this._ReshowButs[e.value].style.display=""))}this._IsAddPreRow?(c=a.getAttribute("ewa_key"),this.AddPreRowCheck(a,c,b)&&(d=this.newRowOneTd(a),this.prevTr&&(this.AddPreRowCloseBeforeEvent&&this.AddPreRowCloseBeforeEvent(this._Id,a,c,this.prevTr,b),this.prevTr.style.display="none",this.prevTr.cells[0].innerHTML="",this.AddPreRowCloseEvent&&this.AddPreRowCloseEvent(this._Id,a,c,this.prevTr,b)),this.prevTr==d?this.prevTr=null:(this.prevTr=d,this.prevTr.style.display=
"",this.MDownEvent(this._Id,a,c,this.prevTr,b)))):this.MDownEvent(a,b)}}};this.AddPreRow=function(a){this._IsAddPreRow||(this.MDownEvent=a);this._IsAddPreRow=!0};this.AddPreRowCheck=function(a,b,c){return!0};this.AddPreRowCloseBeforeEvent=function(a,b,c,d,e){};this.AddPreRowCloseEvent=function(a,b,c,d,e){};this._MSetBg=function(a,b){var c="";"down"==b?c="ewa_grid_down":"over"==b&&(c="ewa_grid_mover");$(a).children("td").removeClass("ewa_grid_mover ewa_grid_down").addClass(c)};this._ReShowSearchQuick=
function(){var a=this,b=EWA_ListFrameClass.prototype.RESOURCES.search_text_items,c,d,e;for(e in b){var g=b[e];"eq"==g.Id&&(c=g);"lk"==g.Id&&(d=g)}for(e in this._SearchJson){var h=this._SearchJson[e];h.isSearchQuick&&(b=$("#EWA_LF_"+this.Id+' .ewa-lf-data-row [id="'+e+'"]'),b.bind("click",function(k){k.stopPropagation();k=$(this).attr("search_tag");var l=$(this).text(),m=l,n=$("#EWA_SEARCH_ITEM_"+a.Id+' .ewa-lf-search-item-ctl [name="'+this.id.toUpperCase()+'"]');if("number"==k||"date"==k)n=n.parentsUntil(".ewa-lf-search-item").last().find("input");
var p=n.parentsUntil(".ewa-lf-search-item").last().find("a");if("date"==k)l=l.split(" ")[0],m=l+" 23:59:59";else if("fix"==k){var r=null;n.find("option").each(function(){this.text==l&&(r=this.value)});l=null===r?"":r}n.val()==l?("text"==k&&d&&0<p.length&&(p.attr("tag",d.Id),p.html("enus"==EWA.LANG?d.TxtEn:d.Txt)),n.val("")):("text"==k&&c&&0<p.length&&(p.attr("tag",c.Id),p.html("enus"==EWA.LANG?c.TxtEn:c.Txt)),n.val(l),"date"==k&&(n[1].value=m))}),b.each(function(){$(this).text()&&$(this).addClass("ewa-lf-search-text-click").attr("search_tag",
h.T)}))}};this.ReShowWithNoButtons=function(){var a=$X("EWA_LF_"+this._Id),b=[],c;for(c in this.ItemList.Items){var d=this.ItemList.Items[c],e=this._GetSubValue("Tag","Tag",d);if(null!=e&&"button"==e.trim().toLowerCase())for(e=0;e<a.rows[0].cells.length;e++)if(a.rows[0].cells[e].childNodes[0].id.toUpperCase()==c){b.push(e);d.setAttribute("but_show","1");break}}this.ShowHiddenColumns(b,!1)};this.ReShowButtonsInDailogTitle=function(){EWA.OW.Load();if(EWA.OW.Dia){var a=$(EWA.OW.Dia._Dialog.GetFrameTitle()),
...
this._Id+"'>");a.push("<tr style='display:none'><td style='padding:0'></td></tr>");a.push("<tr><td class='ewa_lf_func' style='padding:0'>");a.push("<div style='display:none'></div>");a.push("<div><div style='cursor:pointer' class='ewa_lf_func_caption'></div></div>");a.push("</td></tr>");a.push("<tr><td style='width:100%;padding:0;vertical-align:top'>");a.push("<div id='"+b+"' style=''></div>");a.push("</td></tr>");a.push("</table>");var c=$(a.join("")),d=!(0<this.Url.toUpperCase().indexOf("EWA_AJAX=INSTALL")||
0<this.Url.toUpperCase().indexOf("EWA_CALL_METHOD=INNER_CALL")||0<this.Url.toUpperCase().indexOf(".JSP"));d?EWA.UI.Utils.SetStyle(c[0],"width:100%;height:100%;border-spacing:0"):EWA.UI.Utils.SetStyle(c[0],"width:100%;border-spacing:0");css="";var e=$X("EWA_LF_"+this._Id);a=e.parentNode.parentNode;var g=e.parentNode;c.find("td:eq(2)>div").append(g);g=c[0];var h=c.find("tr:eq(0)")[0],k=c.find("td:eq(0)")[0],l=c.find("td:eq(1)")[0],m=c.find("td:eq(2)")[0];d&&(window.setTimeout(function(){$X("__EWA_DEBUG")&&
m.childNodes[0].appendChild($X("__EWA_DEBUG"));var B=$X(b);B.getElementsByTagName("table");var D=EWA.UI.Utils.GetDocSize(window),E=B.parentNode.parentNode.previousSibling.offsetHeight;B.style.top=E+"px";B.style.height=D.H-E+"px"},100),addEvent(window,"resize",function(){var B=$X(b),D=EWA.UI.Utils.GetDocSize(window),E=B.parentNode.parentNode.previousSibling.offsetHeight;B.style.top=E+"px";B.style.height=D.H-E+"px"}));for(;0<a.childNodes.length;)l.childNodes[0].appendChild(a.childNodes[0]);c=c.find(".ewa_lf_func_caption")[0];
var n=!1;d=GetInnerText(l);d=d.trim();this._ReshowButs={};e=$(e.rows[0]);for(var p in this.ItemList.Items){var r=this.ItemList.Items[p],q=this._GetSubValue("Tag","Tag",r);if(q&&("button"==q.toLowerCase()||"butflow"==q.toLowerCase())&&(q=this._GetSubValue("Name","Name",r),0!==e.find(".ewa-col-"+q).length)){n=!0;var t=this._GetSubValue("DescriptionSet","Info",r),v=this._GetSubValue("DescriptionSet","Memo",r),u=this._GetSubValue("EventSet","EventName",r),x="";null!=u&&"ewa_click"==u.toLowerCase().trim()&&
(x=this._GetSubValue("EventSet","EventValue",r));d=d.replace(t,"");r=this._ReShowButton(t,v,null);this._ReshowButs[t]=r;r.setAttribute("f_id",this._Id);r.setAttribute("t_id",q);l.childNodes[1].appendChild(r);""==x?r.setAttribute("onclick","EWA.F.FOS['"+this._Id+"'].reShowButtonClick(this)"):r.setAttribute("onclick",x)}}n&&this._ReShowSplit(l.childNodes[1]);q=l.getElementsByTagName("input");n={};for(e=0;e<q.length;e++){var w=q[e];w.style.display="none";if(null==w.id||""==w.id)w.id=("_tmp_"+Math.random()).replace(".",
"_");if("button"==w.type){if(r=this._ReShowButton(w.value,w.title,w.id),t=w.nextSibling){var y="";3==t.nodeType&&(y=t.nodeValue.trimEx());"|"==y&&this._ReShowSplit(l.childNodes[1])}}else(t=w.nextSibling)&&(y=3==t.nodeType?t.nodeValue.replace("|",""):t.innerHTML),r=this._ReShowButton(y.trimEx(),w.title,w.id),r.id=("_tmp_"+Math.random()).replace(".","_"),n[w.name]||(n[w.name]=[]),n[w.name].push(r.id);l.childNodes[1].appendChild(r)}d=d.replace(/ /ig,"").replace(/\|/ig,"").trimEx();""!=d?0<=d.indexOf("if")?
h.style.display="none":k.innerHTML=d.replace(/ /,""):h.style.display="none";a.appendChild(g);for(p in n)for(y=n[p],e=0;e<y.length;e++)w=$X(y[e]),w.setAttribute("_r_ids",y.join(",")),w.onclick=function(){var B=this.getAttribute("_ewa_event_id");$X(B).click();B=this.getAttribute("_r_ids").split(",");for(var D=0;D<B.length;D++)w.id!=B[D]&&($X(B[D]).style.fontWeight="",$X(B[D]).style.color="");this.style.fontWeight="bold";this.style.color="blue"};c.innerHTML='<b><i class="fa fa-star-o">&nbsp;</i>'+this.Description+
"</b>";if(0<this.Url.toUpperCase().indexOf("EWA_BTNS_IN_TITLE"))var z=this,A=0,C=setInterval(function(){A++;1E3<A&&window.clearInterval(C);EWA.OW.Load();EWA.OW.Dia&&(window.clearInterval(C),z.ReShowButtonsInDailogTitle())},10)};this.reShowButtonClick=function(a){a=a.getAttribute("t_id");var b=this.SelectCheckedRows();if(null==b||0==b.length)EWA.UI.Msg.Alert(_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM"],_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM_TITLE"]);else{b=b[0].getElementsByTagName("input");for(var c=0;c<b.length;c++){var d=
b[c];if(d.name===a){d.click();break}}}};this._ReShowSplit=function(a){EWA.UI.Utils.CreateObject(window,"div","",a).className="ewa_lf_func_split"};this._ReShowButton=function(a,b,c){var d=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",document.body);d.innerHTML="<nobr>"+a+"</nobr>";null!=c&&(d.setAttribute("_ewa_event_id",c),d.onclick=function(){var e=this.getAttribute("_ewa_event_id");$X(e).click()});EWA.B.IE&&(d.onselectstart=function(){return!1});d.className="ewa_lf_func_dact";d.title=
b;return d};this.CheckValid=function(a){var b=a.tagName.toLowerCase();if("input"!=b&&"textarea"!=b&&"select"!=b||"button"==a.type||"submit"==a.type||"image"==a.type)return!0;b=this.ItemList.GetObjectValue(a);return this.ItemList.CheckValid(a,b)};this.ShowEdit=function(a){a.parentNode.style.width=a.clientWidth+"px";a.style.display="none";__show_obj__=a.nextSibling;__show_obj__.style.display="";var b=__show_obj__.childNodes[0];3==b.nodeType&&(b=__show_obj__.childNodes[1]);b.setAttribute("old",b.value);
"SELECT"!=b.tagName||b.getAttribute("func")||(b.setAttribute("func",1),b.onchange=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)});null==b.getAttribute("__ewa_fid__")&&(b.setAttribute("__ewa_fid__",this._Id),b.onblur=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)},b.onkeydown=function(c){c=null==c?window.event:c;var d=c.target?c.target:c.srcElement;13==c.keyCode&&"INPUT"==d.tagName&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this);27==c.keyCode&&
...
else{a.parentNode.style.display="none";var b=a.parentNode.previousSibling;b.style.display="";if("droplist"==a.getAttribute("ewa_class")){var c=$(a.parentNode.getElementsByTagName("input")[1]).attr("name");var d=a.parentNode.getElementsByTagName("input")[1].value;b.innerHTML=a.parentNode.getElementsByTagName("input")[0].value}else"select"==a.tagName.toLowerCase()?(c=$(a).attr("name"),b.innerHTML=a.options[a.selectedIndex].text):(c=a.value.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/\n/ig,
"<br>"),b.innerHTML=c,c=$(a).attr("name")),d=a.value;b=a.getAttribute("action_name");if(""==b||null==b)b="OnListFrameUpdateCell";var e=a.getAttribute("action_confirm");e=null==e?"":e;var g=a.getAttribute("action_tip");null==g&&(g="");var h=a.getAttribute("action_js"),k=this.ItemList.GetValue(c,"DataItem","DataType");c=[{Name:"EWA_FIELD_ID",Value:c},{Name:"EWA_FIELD_VAL",Value:d},{Name:"EWA_ACTION_RELOAD",Value:"0"},{Name:c,Value:d},{Name:"EWA_DATA_TYPE",Value:k},{Name:"EWA_FIELD_VAL_OLD",Value:a.getAttribute("old")}];
this.EditEvent={FROM:a,OLD_VAL:a.getAttribute("old"),NEW_VAL:a.value};this.DoAction(a,b,e,g,c,h)}else a.focus()};this.RewriteInfo=function(a,b,c,d,e){var g=$("#EWA_LF_"+this._Id),h=[];if(a)this._INFO={},this._INFO.INFO=a,this._INFO.ID_NAME=b||"id",this._INFO.INFO_NAME=c||"info",this._INFO.MEMO_NAME=d||"memo";else if(!this._INFO||!this._INFO.INFO)return;for(a=0;a<this._INFO.INFO.length;a++)if(b=this._INFO.INFO[a],c=g.find('[id="'+b[this._INFO.ID_NAME]+'"]:eq(0)'),0!==c.length){d=c.parentsUntil("tr").last();
var k=b[this._INFO.INFO_NAME],l=b[this._INFO.MEMO_NAME];if(null==k||""==k.trim())for(k=d.parent()[0],l=0;l<k.cells.length;l++){if(k.cells[l]==d[0]){this.ShowHiddenColumn(l,!1);break}}else 0==c.children().length?c.text(k):c.children()[0].innerText=k,l&&c.attr("title",l);h.push(c[0]);e&&e(c[0],b,a)}return h};this.ShowHiddenColumn=function(a,b){var c=$X("EWA_LF_"+this._Id),d="";if(null==b||0==b||"none"==b)d="none";for(b=0;b<c.rows.length;b++)c.rows[b].cells.length==c.rows[0].cells.length&&(c.rows[b].cells[a].style.display=
d)};this.ShowHiddenColumns=function(a,b){var c=$X("EWA_LF_"+this._Id),d="";if(null==b||0==b||"none"==b)d="none";b=c.rows[0].cells.length;for(var e=0;e<c.rows.length;e++){var g=c.rows[e];if(g.cells.length==b)for(var h=0;h<a.length;h++)g.cells[a[h]].style.display=d}};this.GroupShowHidden=function(a){var b=$(a).attr("t"),c=(new Date).getTime();if(!(b&&333>c-b)){$(a).attr("t",c);b=a.parentNode.parentNode;c=b.getAttribute("ewa_group");""==c?(c="none",a.childNodes[0].innerHTML=" + "):(c="",a.childNodes[0].innerHTML=
" - ");b.setAttribute("ewa_group",c);for(var d=b.parentNode.parentNode,e=0,g=b.rowIndex+1;g<d.rows.length;g++){b=d.rows[g];if("group"==b.getAttribute("ewa_tag"))break;b.getAttribute("add_pre_row")?"none"==c?("none"!=b.style.display&&b.setAttribute("ewa_group_show_old",b.style.display),b.style.display="none"):b.hasAttribute("ewa_group_show_old")&&(b.style.display=b.getAttribute("ewa_group_show_old"),b.removeAttribute("ewa_group_show_old")):(b.style.display=c,e++)}a.childNodes[a.childNodes.length-1].innerHTML=
" ("+e+")"}};this.Sort=function(a){var b=this._last_sort_timer||0,c=this._Sort||"",d=(new Date).getTime();c==a&&500>d-b||(this._last_sort_timer=d,this._Sort=a,this.Goto(1))};this.SearchClear=function(a){a=a.parentNode.parentNode.parentNode.parentNode;for(var b=0;b<a.rows.length;b+=1)for(var c=a.rows[b].getElementsByTagName("input"),d=0;d<c.length;d++){var e=c[d];if("text"==e.type)e.value="";else if("radio"==e.type||"checkbox"==e.type)e.checked=!1}};this.SearchGetExpInit=function(){var a=$("#_G_"+
this._Id),b=[];$(a).find(".ewa-lf-search-item").each(function(){var c=$(this).find("input");if(0==c.length&&(c=$(this).find("select"),0==c.length))return;var d=c[0],e=$(d).attr("t");if(1==c.length){var g=d.value;if(""!=d.value.trim())for("text"==e&&(c=$(d.parentNode.parentNode).find("a").attr("tag"))&&(e=c),d=d.name.split(","),c=0;c<d.length;c++)b.push(d[c]+"["+e+"]"+g)}else if(("date"==e||"number"==e)&&2==c.length){if(g=d.value,e=c[1].value,""!=e||""!=g)b.push(d.name+"[gte]"+g),e&&b.push(d.name+
"[lte]"+e)}else if("fix"==e&&"INPUT"==d.tagName){var h=[""];$(this).find("input").each(function(){this.checked&&h.push(this.value)});1!=h.length&&b.push(d.name+"[or]"+h.join(";"))}});return b.join(",")};this.SearchGetExp=function(a){var b=[];$(a).find(".ewa-lf-search-item").each(function(){var c=$(this).find("input");if(0==c.length&&(c=$(this).find("select"),0==c.length))return;var d=c[0],e=$(d).attr("t");if(1==c.length){var g=d.value;""!=d.value.trim()&&("text"==e&&(c=$(d.parentNode.parentNode).find("a").attr("tag"))&&
(e=c),b.push("@!@"+d.name+"~!~"+e+"~!~"+g))}else if(("date"==e||"number"==e)&&2==c.length)g=d.value,c=c[1].value,""==c&&""==g||b.push("@!@"+d.name+"~!~"+e+"~!~"+g+"~!~"+c);else if("fix"==e&&"INPUT"==d.tagName){var h=[""];$(this).find("input").each(function(){this.checked&&h.push(this.value)});1!=h.length&&b.push("@!@"+d.name+"~!~"+e+h.join("~!~"))}});return b.join("")};this.DoSearch=function(a){var b=!1;a.id=="EWA_SEARCH_ITEM_"+this.Id?a=$X("EWA_SEARCH_ITEM_"+this.Id).childNodes[0]:(a=a.parentNode.parentNode.parentNode.parentNode,
...
this._SearchDialog.MoveCenter()):(this._SearchDialog._Dialog.AutoSize=!1,this._SearchDialog.Show(!0))};this.ShowSearch=function(a,b){var c="EWA_SEARCH_ITEM_"+this.Id;b&&(this._IsSearchGroup=!1);$X(c)||(this._SearchCreateItm(),a&&this.composeSearchTexts(),this._ReShowSearchQuick())};this.ChangeSearchTextType=function(a){this._MENU_DATE_RANGE&&this._MENU_DATE_RANGE.HiddenMemu();this._MENU_TEXT_TYPE.ShowByObject(a,null,0);var b=$(this._MENU_TEXT_TYPE.Dialog.GetFrame());b.find(".search-text-tag").remove();
b.find('div[ewa_mg="'+$(a).attr("tag")+'"] td:eq(0)').html('<b class="fa fa-check search-text-tag"></b>')};this.ChangeSearchDateType=function(a){this._MENU_TEXT_TYPE&&this._MENU_TEXT_TYPE.HiddenMemu();this._MENU_DATE_RANGE.ShowByObject(a,null,0)};this.ChangeSearchTextTypeIt=function(a){var b=$(this._MENU_TEXT_TYPE.SHOW_BY_OBJECT).parentsUntil(".ewa-lf-search-item").last(),c=$J2MAP(this.RESOURCES.search_text_items,"Id")[a];c="enus"==EWA.LANG?c.TxtEn:c.Txt;b.find("a").attr("tag",a).html(c);var d=b.find("input");
"blk"==a||"nblk"==a?d.val(c).prop("disabled",!0):d.prop("disabled")&&b.find("input").val("").prop("disabled",!1)};this._GetInitSearchMap=function(){var a=new EWA_UrlClass(this.Url),b={},c=a.GetParameter("ewa_search");if(!c)return b;this.Url=a.RemoveParameter("ewa_search");c=c.unURL();a=c.split(",");for(var d in a){var e=a[d],g=e.indexOf("["),h=e.indexOf("]");0>g||h<g||(c=e.substring(0,g).trim(),0!=c.length&&(g=e.substring(g+1,h).trim().toLowerCase(),0!=g.length&&(e=e.substring(h+1).trim(),""!=e&&
(b[c.toUpperCase()]||(b[c.toUpperCase()]={name:c,tag:g}),c=b[c.toUpperCase()],"lt"==g||"lte"==g?c.para2=e.unURL().replace(/\+/ig," "):c.para1=e.unURL().replace(/\+/ig," ")))))}return b};this.SearchFilterDate=function(a){var b=$(this._MENU_DATE_RANGE.SHOW_BY_OBJECT).parentsUntil(".ewa-lf-search-item").last(),c=b.find("input")[0];b=b.find("input")[1];if("Clear"==a)$(c).val(""),$(b).val("");else{var d=EWA_Utils.Date(),e="",g="";"Today"==a?g=e=d.GetDateString():"Week"==a?(a=d.GetBenWeek(),e=a[0],g=a[1]):
"Today-Weekend"==a?(a=d.GetBenWeek(),e=a[d.GetDateString()],g=a[1]):"Month"==a?(a=d.GetBenMonth(),e=a[0],g=a[1]):"Today-EOM"==a?(a=d.GetBenMonth(),e=a[d.GetDateString()],g=a[1]):"Quarter"==a?(a=d.GetBenQ(),e=a[0],g=a[1]):"Today-EOQ"==a?(a=d.GetBenQ(),e=a[d.GetDateString()],g=a[1]):"Year"==a?(a=d.GetBenYear(),e=a[0],g=a[1]):"Today-EOY"==a&&(a=d.GetBenYear(),e=a[d.GetDateString()],g=a[1]);a=EWA_Utils.Date(e).FormatDate();d=EWA_Utils.Date(g).FormatDate();d+=" 23:59:59";$(c).val(a);$(b).val(d)}};this._SearchCreateDateRange=
function(){var a="_MENU_DATE_RANGE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",c=JSON.parse(JSON.stringify(this.RESOURCES.search_date_items)),d="EWA.F.FOS[&quot;"+this._Id+"&quot;].SearchFilterDate",e;for(e in c){var g=c[e];g.Txt=g[b];g.Cmd=d+"(&quot;"+g.Id+"&quot;)"}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_DATE_RANGE";this._MENU_DATE_RANGE=new EWA_UI_MenuClass(b);this._MENU_DATE_RANGE.Create(c);$(this._MENU_DATE_RANGE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+
a);return b};this._SearchCreateTextType=function(){var a="_MENU_TEXT_TYPE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",c=JSON.parse(JSON.stringify(this.RESOURCES.search_text_items)),d="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextTypeIt",e;for(e in c){var g=c[e];g.Txt=g[b];g.Cmd=d+"(&quot;"+g.Id+"&quot;)";g.Group=g.Id}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_TEXT_TYPE";this._MENU_TEXT_TYPE=new EWA_UI_MenuClass(b);this._MENU_TEXT_TYPE.Create(c);$(this._MENU_TEXT_TYPE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+
a);this._MENU_TEXT_TYPE.clickBeforeEvent=function(h,k){$(this.Dialog.GetFrame()).find(".search-text-tag").remove();$(k).find("td:eq(0)").html('<b class="fa fa-check search-text-tag"></b>')};return b};this._SearchCreateItm=function(){var a="EWA_SEARCH_ITEM_"+this.Id,b=[],c=[],d=[],e={},g;for(g in this._SearchJson)this._SearchJson[g].ORI_NAME=g,e[g.toUpperCase()]=this._SearchJson[g];this._SearchJson=e;var h="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextType(this)",k="EWA.F.FOS[&quot;"+this._Id+
"&quot;].ChangeSearchDateType(this)",l=$J2MAP(this.RESOURCES.search_text_items,"Id");e=this._GetInitSearchMap();var m=!1,n=!1;for(g in this.ItemList.Items)if(null!=this._SearchJson[g]){var p=[],r=this._SearchJson[g],q=r.T,t=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[g]);p.push("<table class='ewa-lf-search-item ewa-ref-"+g+" ewa-lf-search-type-"+q+" "+("fix"==q?"ewa-lf-search-fix-m"+(r.M||"0"):"")+"' cellspacing=0 cellpadding=0>");p.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");
p.push(t);var v=t="",u="lk";e[g.toUpperCase()]&&(v=e[g.toUpperCase()],u=v.tag,t=v.para1,v=v.para2);var x="";"text"==q?(n=l[u]||l.lk,x="enus"==EWA.LANG?n.TxtEn:n.Txt,p.push("<a class='ewa-lf-search-type' tag='"+u+"' href='javascript:void(0)' onclick='"+h+"'>"),p.push(x),p.push("</a>"),n=!0):"date"==q&&(p.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+k+"'></a>"),m=!0);p.push("</b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==q?"blk"==u||"nblk"==u?(r=this._SearchSingle(g,
x),r=r.replace("<input","<input disabled "),p.push(r)):p.push(this._SearchSingle(g,t)):"date"==q?p.push(this._SearchDate(g,t,v)):"number"==q?p.push(this._SearchNumber(g,t,v)):"fix"==q&&(r="<div >"+this._SearchFix(g,r,"span",t)+"</div>",p.push(r));p.push("</td></tr></table>");"fix"==q&&this._IsSearchGroup?c.push(p.join("")):d.push(p.join(""))}if(0!=d.length+c.length){b.push('<table class="ewa-lf-search-main" id="'+a+'" cellspacing="0" cellpadding="0">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");
0<d.length&&b.push(" "+d.join("")+" ");for(d=0;d<c.length;d++)b.push(" "+c[d]+" ");b.push("</td></tr></table>");var w=document.createElement("div");this._SEARCH_BOX=w;w.className="ewa-lf-search";w.innerHTML=b.join("");b=$X("EWA_LF_"+this.Id).parentNode;b.parentNode.insertBefore(w,b);a="EWA_SEARCH_ITEM_"+this.Id;var y=this;m&&this._SearchCreateDateRange();n&&this._SearchCreateTextType();y._SEARCH_ITEM_EXP=this.SearchGetExp(w);"{}"!=JSON.stringify(e)&&(y._SearchExp=y._SEARCH_ITEM_EXP);$(w).find("input[type=text]").on("compositionstart",
function(){y._is_search_composition=!0}).on("compositionend",function(){y._is_search_composition=!1});this._TIMER_SEARCH=window.setInterval(function(){if(!y._is_search_composition){try{if(!$X(a)){window.clearInterval(y._TIMER_SEARCH);return}}catch(A){window.clearInterval(y._TIMER_SEARCH);return}var z=y.SearchGetExp(w);z!=y._SEARCH_ITEM_EXP&&(y._SEARCH_ITEM_EXP=z,y.DoSearch($X(a)))}},700)}};this._SearchSingle=function(a,b){var c=[];c.push('<input t="text" type="text" autocomplete="off" class="EWA_INPUT" maxlength="40" name="');
c.push(a.toInputValue());c.push('"');null!=b&&(c.push(' value="'),a=b.toInputValue(),c.push(a),c.push('" '));c.push(" />");return c.join("")};this._SearchDate=function(a,b,c){var d=[];d.push("<table border=0 cellpadding=0 cellspacing=0>");d.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');d.push(a);d.push('"');b&&(b=b.toInputValue(),d.push(' value="'),d.push(b),d.push('"'));d.push(' /></td><td><span class="ewa-lf-search-split"> - </span></td>');
d.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');d.push(a);d.push('1"');c&&(b=c.toInputValue(),d.push(' value="'),d.push(b),d.push('"'));d.push("/></td></tr></table>");return d.join("")};this._SearchNumber=function(a,b,c){var d=[];d.push('<input type="text" t="number" size="10" name="');d.push(a);d.push('"');b&&(b*=1,d.push(' value="'),d.push(b),d.push('"'));d.push(' /><span class="ewa-lf-search-split"> - </span>');
d.push('<input type="text" t="number" size="10" name="');d.push(a);d.push('1"');c&&(b=1*c,d.push(' value="'),d.push(b),d.push('"'));d.push("/>");return d.join("")};this._SearchFix=function(a,b,c,d){var e=[],g="radio";if("1"==b.M)g="checkbox";else if("2"==b.M)return this._SearchFix1(a,b,c,d);c="<"+c+"><nobr><input t='fix' [@CHK] id='@ID' value=\"@V\" type='"+g+"' name='"+a+"' /><label for='@ID'>@T</label></nobr></"+c+"> ";g={};if(d){d=d.split(";");for(var h in d)g[d[h].trim().toUpperCase()]=1}for(h=
0;h<b.D.length;h++){var k=b.D[h];d=k[0];k=k[1];var l=this.Id+"_"+a+"_SearchFix_"+h,m=c.replace("@ID",l);m=m.replace("@ID",l);m=m.replace("@V",d);m=g[d.toUpperCase().trim()]?m.replace("[@CHK]","checked"):m.replace("[@CHK]","");m=m.replace("@T",k);e.push(m)}return e.join("")};this._SearchFix1=function(a,b,c,d){c=[];c.push("<select t='fix' name='"+a+"'><option></option>");for(var e=0;e<b.D.length;e++){var g=b.D[e],h="<option @CKD t='fix' id='@ID' value=\"@V\">@T</option> ".replace("@ID",this.Id+"_"+
a+"_SearchFix_"+e);h=h.replace("@V",g[0]);h=h.replace("@T",g[1]);h=d&&g[0]==d?h.replace("@CKD","selected"):h.replace("@CKD","");c.push(h)}c.push("</select>");return c.join("")};this._SearchCreate=function(){var a=[];a.push("<div><table border=0 style='margin:0px;' class=EWA_TABLE cellspacing=1>");for(var b in this.ItemList.Items)if(null!=this._SearchJson[b]){var c=this._SearchJson[b],d=c.T,e=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[b]);a.push("<tr><td class=EWA_TD_L width=140><nobr>"+
e+"<nobr></td><td width=350 class=EWA_TD_M>");"text"==d?a.push(this._SearchSingle(b)):"date"==d?a.push(this._SearchDate(b)):"number"==d?a.push(this._SearchNumber(b)):"fix"==d&&a.push(this._SearchFix(b,c,"div"));a.push("</td></tr>")}a.push("<tr><td class=EWA_TD_B colspan=2 align=right><input onclick='EWA.F.FOS[\""+this._Id+"\"].SearchClear(this);' type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLEAR"]+"'> <input type=submit value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.SEARCH"]+"' onclick='EWA.F.FOS[\""+
this._Id+"\"].DoSearch(this);'> <input type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLOSE"]+"' onclick='EWA.F.FOS[\""+this.Id+"\"]._SearchDialog.Show(false);'></td></tr>");a.push("</table></div>");this._SearchHtml=a.join("")};this.createRegExp=function(a){if(!a)return null;a=String(a).trim();if(0===a.length)return null;for(var b=[],c=0;c<a.length;c++){var d=a[c];"a"<=d&&"z">=d||"A"<=d&&"Z">=d||"0"<=d&&"9">=d?b.push(d):b.push("\\"+d)}try{return new RegExp("("+b.join("")+")")}catch(e){return console.warn("new RegExp",
a,e),null}};this.SearchMark=function(){for(var a=this._SearchExp.split("@!@"),b=$X("EWA_LF_"+this._Id),c=0;c<a.length;c+=1){var d=a[c].split("~!~");if(!(3>d.length))for(var e=2,g={};e<d.length;g={regExp:void 0},e++){var h=d[e];if(""!=h){if("fix"==d[1]){var k=d[2];$("table#EWA_SEARCH_ITEM_"+this.Id+' [name="'+d[0]+'"]').find("option").each(function(){this.value==k&&(h=this.text)})}g.regExp=this.createRegExp(h);var l=d[0].split(","),m;for(m in l){var n=l[m];this._SearchJson[n]&&(n=this._SearchJson[n].ORI_NAME);
n=$(b).find(".ewa-lf-data-row .ewa-col-"+n).not("[ewa-search-marked=yes]");n.attr("ewa-search-marked","yes");try{n.find("*").each(function(p){return function(){0==this.children.length&&(this.innerHTML=this.innerHTML.replace(p.regExp,"<font color=red><b>$1</b></font>"))}}(g))}catch(p){console.log(p)}}}}}};this.DblClick=function(a){this._IsDblClick=a;for(var b=$X("EWA_LF_"+this._Id),c=1;c<b.rows.length;c++)b.rows[c].ondblclick=function(){var d=this.getElementsByTagName("input");d.length>a&&0==d[a].disabled&&
...
function(){var a=$X("EWA_LF_"+this._Id);if(!a||1>a.rows.length)return"";var b=[],c=[];$("#EWA_LF_"+this._Id+">tbody>tr").find("input[type='radio'],input[type='checkbox']").each(function(){-1==this.parentNode.className.indexOf("ewa-switch")&&c.push(this)});if(0<c.length)for(var d=0;d<c.length;d++)c[d].checked&&b.push(c[d].value);else for(d=0;d<a.rows.length;d++){var e=a.rows[d];1==e.getAttribute("__ewa_lf_mdown")&&b.push(e.getAttribute("EWA_KEY"))}return b.join(",")};this.SelectCheckedInputs=function(){var a=
[],b=$X("EWA_LF_"+this._Id);if(1>b.rows.length)return a;b=b.getElementsByTagName("input");a=[];for(var c=0;c<b.length;c++)("CHECKBOX"==b[c].type.toUpperCase()||"RADIO"==b[c].type.toUpperCase())&&b[c].checked&&a.push(b[c]);return a};this.SelectCheckedRows=function(){for(var a=[],b=$X("EWA_LF_"+this._Id),c=0;c<b.rows.length;c++){var d=b.rows[c],e=d.getElementsByTagName("input");0!=e.length&&e[0].checked&&-1==e[0].parentNode.className.indexOf("ewa-switch")&&a.push(d)}if(0==a.length)for(c=0;c<b.rows.length;c++)d=
b.rows[c],1==d.getAttribute("__ewa_lf_mdown")&&a.push(d);return a};this.Reload=function(a){this.StopAjaxAfterReload?this.StopAjaxAfterReload=!1:this.Goto(this._PageCurrent,a)};this.refreshPage=function(a,b){this.replaceRowsData(null,null,a,b)};this.replaceRowsData=function(a,b,c,d){var e=this.getUrlClass();e.AddParameter("EWA_AJAX","LF_RELOAD");e.AddParameter("EWA_IS_SPLIT_PAGE","no");e.AddParameter("EWA_IS_HIDDEN_CAPTION","yes");e=e.GetUrl();a&&(e+="&"+a);var g=a?new EWA_AjaxClass:this.CreateAjax(),
h=this;g.PostNew(e,function(){if(4==g._Http.readyState){g.HiddenWaitting();var k=g._Http.responseText;200!=g._Http.status?(console.error(k),alert("ERROR:\r\n"+g._Http.statusText)):EWA.F.CheckCallBack(k)?h.replaceRowsWithDataHtml(k,b,c,d):console.error(k)}})};this.replaceRowsWithDataHtml=function(a,b,c,d){var e=$("<div></div>");e.html(a);var g=[],h=$("#EWA_LF_"+this._Id);e.find(".ewa-lf-data-row").each(function(){var k='tr[ewa_key="'+$(this).attr("ewa_key")+'"]',l=h.find(k);if(0==l.length)console.warn(k+
" not found");else{k=$(this).attr("ewa_row_sign");var m=l.attr("ewa_row_sign"),n=!0;(k||m)&&m===k&&(n=!1);if(n){l.attr("ewa_row_sign",k);k=l.clone()[0];for(m=0;m<this.cells.length;m++){n=l[0].cells[m];var p=this.cells[m];n.removeAttribute("ewa-merged");n.removeAttribute("ewa-search-marked");b?b(p,n):n.innerHTML=p.innerHTML}g.push({before:k,current:l[0]})}}});e.remove();this.SearchMark();this.IsReShow&&this.ReShowWithNoButtons();this._ReShowSearchQuick();null!=this._IsDblClick&&this.DblClick(this._IsDblClick);
this.SubBottomsArray&&this._SubBottoms();this.ReloadAfter&&this.ReloadAfter(c);this.ReloadAfterApp&&this.ReloadAfterApp(c);d&&d(g)};this.DoAction=function(a,b,c,d,e,g){EWA.F.CID=this._Id;if(b){if(a&&$(a).parent().hasClass("scroll-delete")){var h=$(a).attr("do-action-time")||0,k=(new Date).getTime();if(1E3>k-h)return;$(a).attr("do-action-time",k)}this.lastAction=b;this._Ajax=new EWA_AjaxClass;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",
b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.AddParameter("EWA_ACTION_TIP",d);null!=g&&0<g.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",g),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=!1;if(a&&a.getAttribute&&"yes"==a.getAttribute("box_menu_item")){if(this._Ajax.AddParameter("___CALL__FROM__","box"),a=a.parentNode)a=a.getAttribute("json_ref"),a=JSON.parse(a),a.EWA_KEY&&this._Ajax.AddParameter("EWA_ACTION_KEY",
a.EWA_KEY)}else(a=this.GetRowKey(a))&&this._Ajax.AddParameter("EWA_ACTION_KEY",a);a=this.SelectChecked();this._Ajax.AddParameter("IDS_SPLIT",a);if(null!=e&&0<e.length)for(a=0;a<e.length;a+=1)this._Ajax.AddParameter(e[a].Name,e[a].Value);e=new EWA.C.Url;e.SetUrl(this.Url);var l=e.RemoveParameter("EWA_ACTION"),m=this;c?((e=_EWA_INFO_MSG[c])||(e=c),$Confirm(e,"Confirm",function(){m._Ajax.PostNew(l,function(){m._CallBackJs()})})):this._Ajax.PostNew(l,function(){m._CallBackJs()})}};this.NewPageSize=function(a){this._PageSize!=
a&&(this._PageSize=a,this.Goto(1))};this.Goto=function(a,b){EWA.F.CID=this._Id;this._PageCurrent=a;this._Ajax=this.CreateAjax();a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.RemoveParameter("EWA_AJAX");var c=this;this._Ajax.PostNew(a.GetUrl(),function(){c._CallBack(b)});this.REPLACE_HISTORY_STATE&&this.replaceHistoryState()};this.createReplaceHistoryStateUrl=function(){var a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.AddParameter(this._PageCurrentName,
this._PageCurrent);this._PageSize&&a.AddParameter(this._PageSizeName,this._PageSize);null!=this._Sort&&a.AddParameter(this._SortName,this._Sort);var b=this.SearchGetExpInit();b&&a.AddParameter("EWA_SEARCH",b);if(null!=this.GotoParas&&0<this.GotoParas.length)for(b=0;b<this.GotoParas.length;b+=1)a.AddParameter(this.GotoParas[b].Name,this.GotoParas[b].Value);a.RemoveParameter("EWA_AJAX");return a};this.replaceHistoryState=function(){var a=this.createReplaceHistoryStateUrl();window.history.replaceState("",
null,a.GetUrl())};this.CreateAjax=function(){var a=new EWA.C.Ajax;a.LoadingType="image";a.AddParameter(this._PageCurrentName,this._PageCurrent);this._PageSize&&a.AddParameter(this._PageSizeName,this._PageSize);null!=this._Sort&&a.AddParameter(this._SortName,this._Sort);null!=this._SearchExp&&""!=this._SearchExp&&a.AddParameter("EWA_LF_SEARCH",this._SearchExp);a.AddParameter("EWA_AJAX","LF_RELOAD");if(null!=this.GotoParas&&0<this.GotoParas.length)for(var b=0;b<this.GotoParas.length;b+=1)a.AddParameter(this.GotoParas[b].Name,
this.GotoParas[b].Value);return a};this.DownlodData=function(a,b){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";null!=this._Sort&&this._Ajax.AddParameter(this._SortName,this._Sort);null!=this._SearchExp&&""!=this._SearchExp&&this._Ajax.AddParameter("EWA_LF_SEARCH",this._SearchExp);this._Ajax.AddParameter("EWA_AJAX","DOWN_DATA");this._Ajax.AddParameter("EWA_AJAX_DOWN_TYPE",a);b&&this._Ajax.AddParameter("EWA_ACTION",b);if(null!=this.GotoParas&&0<this.GotoParas.length)for(a=
0;a<this.GotoParas.length;a+=1)this._Ajax.AddParameter(this.GotoParas[a].Name,this.GotoParas[a].Value);this._AjaxType="DOWN_DATA";a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);var c=this;this._Ajax.PostNew(a.GetUrl(),function(){c._CallBack()})};this.Get=function(a){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";var b=this;this._Ajax.Get(a,function(){b._CallBack()})};this.Post=function(a,b){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType=
"image";var c=this;this._Ajax.Post(a,b,function(){c._CallBackJs()})};this._CallBack=function(a){var b=this._Ajax;if(4==b._Http.readyState){b.HiddenWaitting();if(top.EWA&&top.EWA.MQE){var c=new EWA_MqeClass;c.Data=b.GetRst();c.FromId=EWA.F.CID;c.Type="POST";top.EWA.MQE.AddMqe(c)}200==b._Http.status?(b=b._Http.responseText,EWA.F.CheckCallBack(b)&&("DOWN_DATA"==this._AjaxType?(this._AjaxType=null,"DENY"==b.trim()?alert(_EWA_INFO_MSG["EWA.LF.DOWN_DATA.DENY"]):window.location.href=b.trim()):(c=$X("EWA_LF_"+
this._Id).parentNode,$(c).replaceWith(b),this.SearchMark(),this.IsReShow&&this.ReShowWithNoButtons(),this._ReShowSearchQuick(),null!=this._IsDblClick&&this.DblClick(this._IsDblClick),this._IsAddPreRow&&this.AddPreRow(),this.SubBottomsArray&&this._SubBottoms(),this.ReloadAfter&&this.ReloadAfter(a),this.ReloadAfterApp&&this.ReloadAfterApp(a)))):alert("ERROR:\r\n"+b._Http.statusText);this.RewriteInfo()}};this._CallBackJs=function(){var a=this._Ajax;if(4==a._Http.readyState){if(top.EWA&&top.EWA.MQE){var b=
new EWA_MqeClass;b.Data=a.GetRst();b.FromId=EWA.F.CID;b.Type="POST";top.EWA.MQE.AddMqe(b)}a.HiddenWaitting();200==a._Http.status?(a=a._Http.responseText,EWA.F.CheckCallBack(a)&&eval(a)):alert("ERROR:\r\n"+a._Http.statusText);this.EditAfterEvent&&this.EditAfterEvent()}};this.EditAfterEvent=function(){this.getUrlClass().GetParameter("EWA_ROW_SIGN")&&this.refreshPage()};this._GetItem=function(a){for(var b=this.ItemList,c=0;c<b.length;c+=1){var d=b[c],e=this._GetSubItem("Name",d);if(this.Xml.GetElementAttribute(e,
"Name")==a)return d}};this._GetSubItem=function(a,b){b=this.Xml.GetElements(a+"/Set",b);if(null==b||0==b.length)return null;if("DescriptionSet"==a)for(a=0;a<b.length;a+=1){var c=b[a].getAttribute("Lang");if(null!=c&&c.trim().toUpperCase()==EWA.LANG.trim().toUpperCase())return b[a]}return b[0]};this._GetSubValue=function(a,b,c){a=this._GetSubItem(a,c);return null==a?null:this.Xml.GetElementAttribute(a,b)};this.AddColumns=function(a,b,c,d,e,g,h,k){var l=$X("EWA_LF_"+this._Id);null==k&&(k=l.rows[0].cells.length);
for(var m=0;m<a.length;m++)for(var n=a[m],p=k+m,r=0;r<l.rows.length;r++){var q=l.rows[r].insertCell(p);q.title=n[d];if(0==r)q.className="EWA_TD_H ewa-add-column ewa-col-"+n[b],q.innerHTML='<nobr cellIdx="'+p+'" id="'+n[b]+'">'+n[c]+"</nobr>",q.title=n[d],q.width=100;else{var t=l.rows[r].getAttribute("EWA_KEY");q.className="EWA_TD_M ewa-add-column ewa-col-"+n[b];t=t+"_"+n[b];var v=this._GetAddControl(n[g],n[c],n[d]);null==v&&(v=e);var u=h.replace("[ID]",n[b]);v=0<=v.indexOf("<select")?v.replace("!!",
u.replace("onblur=","onchange=")):v.replace("!!",u);q.innerHTML=v;q.childNodes[0].id=t}}};this._GetAddControl=function(a,b,c){if(null==a)return null;a=a.toUpperCase().trim();b=b?b.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/"/ig,"&quot;"):"";c=c?c.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/"/ig,"&quot;"):"";return"SELECT"==a?'<select des="'+b+'"  title="'+c+'" !!></select>':"DATE"==a?'<input type=text des="'+b+'" title="'+c+'" class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,false);" readonly !!>':
"TIME"==a?'<input type=text des="'+b+'" title="'+c+'"  class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,true);" readonly !!>':"STRING"==a||"NUMBER"==a?'<input type=text des="'+b+'"  title="'+c+'" class=EWA_INPUT !!>':null};this.AddedValues=function(a,b,c,d,e){for(var g=0;g<a.length;g++){var h=a[g],k=$X(h[b]+"_"+h[c]);if(!k)break;var l=k.tagName.toUpperCase();"INPUT"==l||"SELECT"==l||"TEXTAREA"==l?k.value=h[d]:k.innerHTML=h[d];e&&(this.GetRow(k).getElementsByTagName("input")[0].checked=!0)}};this.AddRow=
function(a){for(var b=$X("EWA_LF_"+this._Id),c=b.insertRow(-1),d=0;d<b.rows[0].cells.length;d++){var e=c.insertCell(-1),g=b.rows[0].cells[d];e.className="EWA_TD_M";null!=a[d]&&(e.innerHTML=a[d]);e.style.display=g.style.display;e.id="ADD_ROW_"+g.childNodes[0].id}return c};this.Calc=function(a,b,c,d){for(var e=$X("EWA_LF_"+this._Id),g={},h=0;h<a.length;h++)g[a[h]]=0;for(h=b;h<c;h++)for(a=e.rows[h],b=0;b<a.cells.length;b++)if(null!=g[b]){var k=a.cells[b],l=k.getElementsByTagName("input");0<l.length?
g[b]+=1*l[0].value:(k=GetInnerText(k),""==k&&(k=0),g[b]+=1*k)}c=e.rows[d];for(h=0;h<c.cells.length;h++)null!=g[h]&&(k=Math.round(100*g[h])/100,d=GetInnerText(c.cells[h]),k!=1*d&&(this.IsCalcChanged=!0),c.cells[h].innerHTML=k.fm())};this.mergeHeaders=function(a,b,c){var d=$($X("EWA_LF_"+this._Id)),e=d.find('tr[ewa_tag="HEADER"]');if(0!=e.length&&(a=e.find('nobr[id="'+a+'"]').parent(),0!=a.length)){var g=d.find("tr[ewa_mearge]");0==g.length&&(g=$(d[0].insertRow(1)),g.attr("ewa_mearge","gdx"));d=-1;
for(var h=0;h<e[0].cells.length;h++){var k=e[0].cells[h];k==a[0]&&(d=h,k.colSpan=c);if(-1==d)"1"!=$(k).attr("ewa_tdmearged")&&(k.rowSpan=2);else if(d+c==h)d=-1,k.rowSpan=2;else{k.rowSpan=1;var l=g[0].insertCell(-1);l.innerHTML=k.innerHTML;l.className=k.className;l.style.cssText=k.style.cssText;k.style.display="none";$(k).attr("ewa_tdmearged",1)}k==a[0]&&(k.innerHTML=b,k.style.display="",k.style.width="")}}};this.MeargeHeader=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 mergeHeaders");
this.mergeHeaders(a,b,c)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}
...
this._ShowCover=function(b){this._Cover.style.display=b?"block":"none"};this._EventX=function(b){return b.x?b.x:b.pageX};this._OnMouseDown=function(b,c){this._ShowCover(!0);b.childNodes[0].style.borderLeft="1px solid black";b.setAttribute("D",1);c=c?c:event;var d=this._EventX(c);b.setAttribute("X",d);b.setAttribute("SX",d);"undefined"!=typeof c.preventDefault&&c.preventDefault();"undefined"!=typeof c.stopPropagation?c.stopPropagation():c.cancelBubble=!0};this._OnMouseUp=function(b,c){b.childNodes[0].style.borderLeft=
"1px";b.setAttribute("D",0);c=c?c:event;var d=this._EventX(c)-1*b.getAttribute("SX");b=b.getAttribute("TDINDEX");b=this._Table.rows[0].cells[b];d=b.clientWidth+d;b.style.width=4>d?4:d+"px";this._SetLocation();"undefined"!=typeof c.preventDefault&&c.preventDefault();"undefined"!=typeof c.stopPropagation?c.stopPropagation():c.cancelBubble=!0};this._OnMouseOut=function(b,c){"1"==b.getAttribute("D")&&(b.style.left=b.getAttribute("SX")+"px",b.setAttribute("D",0),this._SetLocation(),b.childNodes[0].style.borderLeft=
"1px");this._ShowCover(!1)};this._OnMouseMove=function(b,c){this._ShowCover(!0);if("1"==b.getAttribute("D")){c=c?c:event;var d=this._EventX(c),e=1*b.getAttribute("X");e=d-e;b.style.left=1*b.style.left.replace("px","")+e+"px";b.setAttribute("X",d);"undefined"!=typeof c.preventDefault&&c.preventDefault();"undefined"!=typeof c.stopPropagation?c.stopPropagation():c.cancelBubble=!0}};this._CreateMarker=function(b){var c=this._CreateElement("div","width:40px; height:"+this._Table.clientHeight+"px; position:absolute;cursor:e-resize",
...
2+"px";this._CellResize[b].style.top=d[1]+"px"}};this._CreateElement=function(b,c,d){b=document.createElement(b);null!=c&&(b.style.cssText=c,b.setAttribute("style",c));null!=d&&d.appendChild(b);return b};this._Location=function(b){var c;var d=c=0;do d+=b.offsetLeft,c+=b.offsetTop,b=b.offsetParent;while("BODY"!=b.tagName);return[d,c]}}
...
function(){e.togglePanel()});c.find("li input[type=checkbox]").on("click",function(){e.setCol(this.value)});if(0<d.length)for(g=0;g<d.length;g++)0<$(this.wrap+" .custom-cols-panel-box input[value='"+d[g]+"']").length?$(this.wrap+" .custom-cols-panel-box input[value='"+d[g]+"']")[0].checked=!1:this.setCol(d[g]);if(0<this.notHideColsArr.length)for(g=0;g<this.notHideColsArr.length;g++)b=this.notHideColsArr[g],c=$(this.wrap+" .custom-cols-panel-box input[value='"+b+"']"),0<c.length&&(c.parent().addClass("not-hide-col"),
...
this.frameUnid+" #INS_ROW_"+b).hide()};this.setCol=function(b){this.frameUnid||$Tip("not init");if(!(0<$("#EWA_LF_"+this.frameUnid+" .ewa-col-"+b+" a[href*='CheckedAll']").length)){var c=window.localStorage[this.storageId];if(c){c=c.split(",");for(var d=[],e=0;e<c.length;e++)b==c[e]?this.show(b):d.push(c[e]);c.length==d.length&&(d.push(b),this.hide(b));window.localStorage[this.storageId]=d.join(",")}else window.localStorage[this.storageId]=b,this.hide(b)}};this.setDefault=function(){this.togglePanel();
window.localStorage[this.storageId]=this.defHideCols;for(var b=$(this.wrap+" .custom-cols-panel-box input"),c=0;c<b.length;c++)b[c].checked=!0;if(this.defHideCols)for(b=this.defHideCols.split(","),c=0;c<b.length;c++)0<$(this.wrap+" .custom-cols-panel-box input[value='"+b[c]+"']").length?$(this.wrap+" .custom-cols-panel-box input[value='"+b[c]+"']")[0].checked=!1:this.setCol(b[c]);EWA.F.FOS[this.frameUnid].Reload()}}
function EWA_MultiGridClass(a,b){this.ClassName=a;this.Url=b;this._Id=this.TransParent=null;this.Resources={};this.Init=function(c){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(c);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml)};this.CollapseCol=function(c,d){var e="",g=d.parentNode;null==g.getAttribute("expand")||1==g.getAttribute("expand")?(g.setAttribute("expand",0),d.innerHTML="+",e="none",g.setAttribute("col_span",g.colSpan),g.colSpan=1,g.style.fontStyle="italic",g.style.color=
"blue"):(g.setAttribute("expand",1),d.innerHTML="-",g.colSpan=g.getAttribute("col_span"),g.style.fontStyle="",g.style.color="#000");var h=document.getElementsByTagName(c);c=[];var k=[];for(d=0;d<h.length;d++){var l=h[d],m=l.parentNode.parentNode.rowIndex;null==c[m]&&(c[m]=[]);l=l.parentNode;c[m].push(l);"none"==e&&"none"==l.style.display&&k.push(l.id)}if("none"==e)g.setAttribute("ids","["+k.join("][")+"]");else{var n=g.getAttribute("ids");n=null==n?"":n}for(d=0;d<c.length;d++)if(null!=c[d]){for(h=
g=0;h<c[d].length;h++)k=c[d][h],g+=1*k.getAttribute("val"),m="["+k.id+"]",0<h&&(""==e?0>n.indexOf(m)&&(k.style.display=e):k.style.display=e);k=c[d][0];""==e?(m="["+k.id+"]",0>n.indexOf(m)&&(k.childNodes[0].innerHTML=k.getAttribute("val"),k.style.fontStyle="",k.style.color="#000")):(k.childNodes[0].innerHTML="EWA_GRID_H"==k.className?k.childNodes[0].innerHTML+"...":g,k.style.fontStyle="italic",k.style.color="blue")}};this.Trans=function(){var c=new EWA_UrlClass;c.SetUrl(this.Url);0<this.Url.indexOf("&EWA_GRID_TRANS=")?
c.RemoveParameter("EWA_GRID_TRANS"):c.AddParameter("EWA_GRID_TRANS","1");this.TransParent=$X("EWA_MG_"+this._Id).parentNode;this.Url=c.GetUrl();this._DoTrans(c.GetUrl())};this._DoTrans=function(c){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.PostNew(c,EWA.F.FOS[EWA.F.CID]._CallBackJs)};this.Reload=function(){var c=new EWA_UrlClass;c.SetUrl(this.Url);this.TransParent=$X("EWA_MG_"+
this._Id).parentNode;this.Url=c.GetUrl();this._DoTrans(c.GetUrl())};this.ReloadAfter=function(){};this.getUrlClass=function(){var c=new EWA_UrlClass;c.SetUrl(this.Url);return c};this._CallBackJs=function(){var c=EWA.F.FOS[EWA.F.CID]._Ajax;4==c._Http.readyState&&(c.HiddenWaitting(),200==c._Http.status?(c=c._Http.responseText,EWA.F.CheckCallBack(c)&&(EWA.F.FOS[EWA.F.CID].TransParent.innerHTML=c,EWA.F.FOS[EWA.F.CID].ReloadAfter&&EWA.F.FOS[EWA.F.CID].ReloadAfter())):alert("ERROR:\r\n"+c._Http.statusText))}}
EWA.UI.MultiGrid={COLOR_BG:"rgba(173, 216, 230, 0.25)",COLOR_FOCUS:"gold",MTbId:null,MTbs:{},MOut:function(a){a=a||event;var b=a.srcElement||a.target;if(null!=b){a.stopPropagation?a.stopPropagation():a.cancelBubble();a=0;try{for(;!(b&&b.tagName&&"TD"==b.tagName.toUpperCase()&&0<b.id.indexOf("$MGC_"));)if(b=b.parentNode,a++,5<a)return}catch(m){return}var c=b.id;if(c!=EWA.UI.MultiGrid.MTbId){EWA.UI.MultiGrid.MTbId=c;var d=c.split("_"),e=d[2];a=d[1];var g=b.parentNode.parentNode.parentNode;null==this.MTbs[g.id]&&
(this.MTbs[g.id]=[]);b=this.MTbs[g.id];for(var h=0;h<b.length;h++)this._restoreBg(b[h]);for(h=b.length=0;1E3>h;h++){var k=d[0]+"_"+h+"_"+d[2],l=$X(k);if(!l)break;k==c?this._setBg(l,this.COLOR_FOCUS):this._setBg(l,this.COLOR_BG);b.push(l)}for(h=0;1E3>h;h++){k=d[0]+"_"+d[1]+"_"+h;l=$X(k);if(!l)break;k!=c&&(b.push(l),this._setBg(l,this.COLOR_BG))}c=$(g).find("#MGA_"+e+"_0");0<c.length&&(l=c[0],this._setBg(l,this.COLOR_BG),b.push(l));a=$(g).find("#MGB_"+a+"_0");0<a.length&&(l=a[0],this._setBg(l,this.COLOR_BG),
b.push(l))}}},_setBg:function(a,b){a.setAttribute("oldbg",a.style.backgroundColor);a.style.backgroundColor=b},_restoreBg:function(a){var b=a.getAttribute("oldbg");a.style.backgroundColor=b}};EWA.F.M={CUR:null,C:EWA_MultiGridClass};
...
this.AddBackground=function(a){this.GetObject().rows[1].cells[0].background=a};this.SetBookIcon=function(a){this.GetObject().rows[0].cells[1].className=a};this.IsNodeOpen=function(){var a=this.GetObject().rows[0].cells[0];tag=this._GetTag(a);return"B"==tag};this.NodeShow=function(a){if("EWA_TREE_ROOT"!=this.Key){var b=this.GetObject(),c=b.rows[0].cells[0];if(null==a){var d=this._GetTag(c);if("C"==d||"D"==d)return;d="A"==d?"B":"A"}else d=a?"B":"A";for(var e=c.className.split(" "),g=[this._GetClassNameNoTag(c)+
d],h=1;h<e.length;h++)g.push(e[h]);c.className=g.join(" ");2==b.rows.length&&0<b.rows[1].cells[1].childNodes.length&&(b.rows[1].style.display="B"==d?"table-row":"none");this.BookShow(a);this.IsMoreChildren&&(this.Object.setAttribute("EWA_TREE_MORE","0"),a=new EWA.F.Cmd,a.EWA_ACTION="OnTreeNodeMore",a.EWA_TREE_KEY=this.Key,EWA.CurUI._PostChange(a));if(this.ewa&&this.ewa.OnBookShowAfter)try{this.ewa.OnBookShowAfter("B"==d,this)}catch(k){console.log(k)}}};this.BookShow=function(a){if("EWA_TREE_ROOT"!=
...
this._OpenOrClose=function(d){var e=this;$("#EWA_TREE_"+this._Id).find(d).each(function(){e.Click({srcElement:this})})};this.DoAction=function(d,e,g,h,k,l){EWA.F.CID=this._Id;if(null==e||""==e.trim())alert("action not value");else{if(null!=g&&0<g.trim().length)if(d=_EWA_INFO_MSG[g],null!=d&&""!=d){if(!window.confirm(d))return}else if(!window.confirm(g))return;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",e);this._Ajax.AddParameter("EWA_ID",
this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.AddParameter("EWA_ACTION_TIP",h);null!=l&&0<l.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",l),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=!1;if(null!=k&&0<k.length)for(e=0;e<k.length;e+=1)this._Ajax.AddParameter(k[e].Name,k[e].Value);k=new EWA.C.Url;k.SetUrl(this.Url);k=k.RemoveParameter("EWA_ACTION");this._Ajax.PostNew(k,EWA.F.FOS[EWA.F.CID]._PostChangeCallback)}};
this.OnMouseDown=function(d){};this.OnMouseUp=function(d){};this.OnMouseMove=function(d){};this.OnMouseOut=function(d){};this.MoveNode=function(d){};this.GetParentNode=function(d){if(null==d||"EWA_TREE_ROOT"==d.Key)return null;d=d.GetObject().parentNode;d=this.GetNode(d);return null==d?null:"EWA_TREE_ROOT"==d.Key?null:d};this.CreateByXml=function(d){for(var e=d.GetElements("FrameData/Row"),g={},h,k=0;k<e.length;k+=1){var l=this._CreateNodeFromXml(e[k],d);g[l.Key]=l;if(0==k)h=l;else{var m=g[""==l.ParentKey?
"EWA_TREE_ROOT":l.ParentKey];null!=m&&m.AddChild(l)}}treeFirstNode=h;this.Create(h)};this.OnSelect=function(d){return"INPUT"!=d.srcElement.tagName?!1:!0};this.InitMenu=function(d){null!=d&&(this.Menu=new EWA_UI_MenuClass(b+".Menu"),this.Menu.Create(d))};this._PostChange=function(d){this.PostChangeType=d.EWA_ACTION;this.PostChangeKey=d.EWA_TREE_KEY;EWA.CurUI=this;this._Ajax=new EWA.C.Ajax;"OnTreeNodeMore"==this.PostChangeType&&(d.EWA_AJAX="XML",d.EWA_TREE_MORE="1");for(var e in d)this._Ajax.AddParameter(e,
d[e]);this._Ajax.PostNew(this._Url,EWA.CurUI._PostChangeCallback);this.IsPostChange=!0};this._PostChangeCallback=function(){var d=EWA.CurUI._Ajax;4==d._Http.readyState&&(d.HiddenWaitting(),200==d._Http.status?(d=d._Http.responseText,EWA.F.CheckCallBack(d)&&("OnTreeNodeMore"==EWA.CurUI.PostChangeType?EWA.CurUI.LoadChildrenAfter(d):"OnTreeNodeStatus"==EWA.CurUI.PostChangeType?EWA.CurUI.LoadChildrenStatus(d):"OnTreeNodeDelete"==EWA.CurUI.PostChangeType?EWA.CurUI.DeleteAfter():eval(d))):alert("ERROR:\r\n"+
d._Http.statusText),EWA.CurUI.IsPostChange=!1,EWA.SHOW_ERROR=!0)};this.LoadChildrenStatus=function(d){var e=new EWA.C.Xml;e.LoadXml(d);var g=e.GetElements("FrameData/Row");if(null!=g){d=[];for(var h={},k=0;k<g.length;k=1+k){var l=this._CreateNodeFromXml(g[k],e);""==l.Key||$[l.ParentKey]||(d.push(l),h[l.Key]=l)}if(0!=d.length&&(e=this.GetNodeById(d[0].ParentKey),null!=e)){h[e.Key]=e;for(k=0;k<d.length;k+=1)h[d[k].ParentKey].AddChild(d[k]);e.GetObject().setAttribute("EWA_TREE_MORE","0");e.IsMoreChildren=
!1;for(k=0;k<e.Children.length;k+=1)this.Create(e.Children[k]);e.NodeShow(!0);this.ShowNode(this.PostChangeKey)}}};this.LoadChildrenAfter=function(d){var e=new EWA.C.Xml;e.LoadXml(d);d=e.GetElements("FrameData/Row");if(null!=d&&0!=d.length){var g=this.GetNodeById(this.PostChangeKey),h={};h[g.Key]=g;for(var k=0;k<d.length;k=1+k){var l=this._CreateNodeFromXml(d[k],e);if("EWA_TREE_ROOT"!=l.Key){if(null==l.ParentKey||""==l.ParentKey)l.ParentKey=g.Key;h[l.Key]=l;var m=l.ParentKey;null!=h[m]&&h[m].AddChild(l)}}if(0<
g.Children.length)for(k=0;k<g.Children.length;k=1+k)this.Create(g.Children[k]);g.NodeShow(!0)}};this._CreateNodeFromXml=function(d,e){var g=new EWA_TreeNodeClass;g.ewa=this;g.Key=e.GetElementAttribute(d,"Key");g.ParentKey=e.GetElementAttribute(d,"ParentKey");g.Text=e.GetElementAttribute(d,"Text");g.IsMoreChildren="1"==e.GetElementAttribute(d,"IsMoreChildren")?!0:!1;g.MenuGroup=e.GetElementAttribute(d,"MenuGroup");for(var h=0;3>h;h+=1)g.AddParas[g.AddParas.length]=e.GetElementAttribute(d,"AddPara"+
h);return g};this.Rename=function(d,e,g,h){null==d&&(d=this._LastFocus);null!=d&&(this._RenameActionCmd=e,this._RenameRegex=g,this._RenameInfo=h,this._RenameNode="TREE_NODE"==d.tagName?d:this.GetNode(d),"EWA_TREE_ROOT"==this._RenameNode.Key?this._RenameNode=null:(d=this._RenameNode.GetObject(),d=d.rows[0].cells[d.rows[0].cells.length-1].childNodes[0],e=GetInnerText(d),d.style.display="none",g=this._GetInput(),d.parentNode.appendChild(g),g.value=e,g.setAttribute("EWA_OLD_VAL",e),g.style.width="300px",
g.focus()))};this._GetInput=function(){for(var d=this.ParentObject.getElementsByTagName("INPUT"),e=d.length-1;0<=e;e--){var g=d[e];if(g.getAttribute("onblur")&&0<g.getAttribute("onblur").indexOf("RenameBlur("))return this._InputDiv=g.parentNode,g}};this.RenameBlur=function(d){var e=this._RenameBlurT0||0,g=(new Date).getTime();if(!(100>g-e)){this._RenameBlurT0=g;g=d.getAttribute("EWA_OLD_VAL");e=this._RenameNode;for(var h=this.GetNode(e.GetObject().parentNode),k=0;k<h.Children.length;k+=1){var l=h.Children[k];
if(l.Key!=e.Key&&l.Text.trim()==d.value.trim()){alert(_EWA_EVENT_MSG.OnTreeNodeNameRepeat);d.focus();return}}h=d.parentNode.childNodes[0];this._InputDiv.appendChild(d);h.style.display="";if("NEW"==e.RenameType||g!=d.value){h.innerHTML=d.value;g=this._RenameActionCmd;null==g&&(g=new EWA.F.Cmd);if(null==g.EWA_ACTION||""==g.EWA_ACTION.trim())g.EWA_ACTION="NEW"==e.RenameType?"OnTreeNodeNew":"OnTreeNodeRename";"NEW"==e.RenameType&&(""==g.EWA_AFTER_EVENT&&(g.EWA_AFTER_EVENT='EWA.F.FOS["'+this._Id+'"].NewNodeAfter;'),
h=this.GetNode(e.GetObject().parentNode),g.EWA_TREE_PARENT_KEY=h.Key);g.EWA_TREE_TEXT=d.value;g.EWA_TREE_KEY=e.Key;this._PostChange(g);this._RenameActionCmd=null}}};this.RenameKeyDown=function(d,e){d=d.keyCode?d.keyCode:d.which;13==d&&this.RenameBlur(e);27==d&&(d=e.getAttribute("EWA_OLD_VAL"),e.value=d,this.RenameBlur(e))};this.Delete=function(d,e){var g=this.GetNode(this._LastFocus);null!=g&&"EWA_TREE_ROOT"!=g.Key&&window.confirm(_EWA_EVENT_MSG.OnTreeNodeDelete)&&(!d&&(0<g.Children.length||g.IsMoreChildren)?
(g.NodeShow(!0),alert(_EWA_EVENT_MSG.OnTreeNodeDeleteHaveChildren)):(d=e,null==d&&(d=new EWA.F.Cmd,d.EWA_ACTION="OnTreeNodeDelete"),""==d.EWA_AFTER_EVENT&&(d.EWA_AFTER_EVENT='EWA.F.FOS["'+this._Id+'"].DeleteAfter();'),d.EWA_TREE_KEY=g.Key,this._PostChange(d)))};this.DeleteAfter=function(){var d=this.GetNode(this._LastFocus).GetObject(),e=d.parentNode;e.removeChild(d);d=this.GetNode(e);0==d.Children.length?this.GetNode(d.GetObject().parentNode).ChildLast.Key==d.Key?d.NodeCrossEnd(!0):d.NodeCross(!0):
d.ChildLast.NodeCrossEnd();this._LastFocus=null};this.NewNode=function(d,e,g,h){null!=this._LastFocus&&(this._NewNodeTemp={TEXT:d,CMD:e,REGEX:g,INFO:h},this.GetNode(this._LastFocus).NodeShow(!0),this.IsPostChange?this._NewNodeTimer=window.setInterval(function(){EWA.CurUI.IsPostChange||(window.clearInterval(EWA.CurUI._NewNodeTimer),EWA.CurUI._NewNode())},100):this._NewNode())};this._NewNode=function(){var d=this._NewNodeTemp.TEXT,e=this._NewNodeTemp.CMD,g=this._NewNodeTemp.REGEX,h=this._NewNodeTemp.INFO;
this._NewNodeTemp=null;var k=new EWA_TreeNodeClass;k.ewa=this;this._CurNewNode+=1;k.Key="NEW_NODE_"+this._Id+"__"+this._CurNewNode;k.RenameType="NEW";var l=_EWA_EVENT_MSG.OnTreeNodeNew+this._CurNewNode;null!=d&&0<d.trim().length&&(l=d.trim());k.Text=l;d=this.GetNode(this._LastFocus);0<d.Children.length&&d.Children[d.Children.length-1].NodeCross();d.AddChild(k);this.Create(k);d.NodeShow(!0);this.Rename(k,e,g,h)};this.NewNodeAfter=function(d,e,g){var h=this.GetNodeById("NEW_NODE_"+this._Id+"__"+this._CurNewNode);
h.SetKey(d);h.SetAddParameters(null==e?"":e);h.SetMenuGroup(null==g?"":g);d=this.TestIcon(h);h.SetBookIcon(d)};this.GetNodeById=function(d){d=$("#EWA_TREE_"+this._Id+' .ewa-tree-node[id="'+d+'"]');return 0==d.length?null:this.GetNode(d[0])};this.GetFocusNode=function(){return this.GetNode(this._LastFocus)};this.GetNode=function(d){if(null==d||null==d.tagName)return null;var e=d;for(d=0;("TABLE"!=e.tagName||"1"!=e.getAttribute("EWA_T"))&&"EWA_TREE_ROOT"!=e.id;)if(e=e.parentNode,d++,33<d||"BODY"==e.tagName)return null;
d=new EWA_TreeNodeClass;d.ewa=this;d.Key=e.id;d.MenuGroup=e.getAttribute("EWA_MG");d.Object=e;var g=e.rows[0].cells[2];d.Text=GetInnerText(g);for(var h=0;3>h;h+=1)d.AddParas[h]=g.childNodes[0].getAttribute("EWA_P"+h);h=e.getAttribute("EWA_TREE_MORE");d.IsMoreChildren="1"==h?!0:!1;if(1<e.rows.length){e=e.rows[1].cells[e.rows[1].cells.length-1];for(h=0;h<e.childNodes.length;h=1+h)g=e.childNodes[h],3!=g.nodeType&&"TABLE"==g.tagName&&"1"==g.getAttribute("EWA_T")&&d.Children.push(this.GetNode(g));0<d.Children.length&&
(d.ChildLast=d.Children[d.Children.length-1])}return d};this.Click=function(d,e){if(!this.IsPostChange&&(EWA.CurUI=this,d=d.srcElement?d.srcElement:d.target,"INPUT"!=d.tagName))if("DIV"==d.tagName&&(d=d.parentNode),"TD"==d.tagName&&0==d.className.indexOf("TD00")){var g=this.GetNode(d);g.NodeShow()}else{for(;("SPAN"!=d.tagName||null==d.getAttribute("EWA_CMD"))&&"1"!=d.getAttribute("EWA_TREE_TOP");)if(d=d.parentNode,"BODY"==d.tagName)return;g=this.GetNode(d);if("SPAN"==d.tagName&&(null!=d.getAttribute("EWA_CMD")||
"1"==d.getAttribute("EWA_TREE_TOP"))){null!=this._LastFocus&&(this.GetNode(this._LastFocus).Mark(!1),this._LastFocus=null);"1"!=d.getAttribute("EWA_TREE_TOP")&&g.Mark(!0);this._LastFocus=d;if(e)return d;0>this.Url.toUpperCase().indexOf("EWA_TREE_SKIP_GET_STATUS")&&EWA.F.ST.SaveStatus(g.Key,"TREE");this._RunCmd(g);this.MoveNode(g.GetObject())}}};this._RunCmd=function(d){var e=this.GetNode(d.GetObject().parentNode);if(this.link)this.link(d.Key,d);else{console.warn('\u5efa\u8bae\u91c7\u7528\u5b9a\u4e49 EWA.F.FOS["xx"].link = function(nodeKey, node){}');
e='link("'+d.Key+'","'+e.Key+'","'+d.Text.replace(/\n/mig,"\\n").replace(/\r/mig,"\\r").replace(/"/mig,"&quot;")+'"';for(var g=0;g<d.AddParas.length;g+=1)e=null==d.AddParas[g]?e+",null":e+(',"'+d.AddParas[g]+'"');EWA.C.Utils.RunCmd(e+");")}};this.ShowMenu=function(d){EWA.CurUI=this;var e=this.Click(d,!0);null!=this.Menu&&null!=e&&(e=this.GetNode(e),this.Menu.ShowByMouse(d,e.MenuGroup))};this.TestIcon=function(d){if(null==this.Icons)return"TD01A";for(var e in this.Icons){var g=this.Icons[e],h=null;
switch(g.TEST.toUpperCase()){case "KEY":h=d.Key;break;case "PARENTKEY":h=d.Parent.Key;break;case "TEXT":h=d.Text;break;case "P0":h=d.AddParas[0];break;case "P1":h=d.AddParas[1];break;case "P2":h=d.AddParas[2];break;case "MG":h=d.MenuGroup}if(null!=h&&eval("/"+g.FILTER+"/ig").test(h))return g.NAME+"A"}return"TD01A"};this.Create=function(d,e){if(null!=d)if(null==d.Parent)this._CreateFirst(d);else{var g=this._HtmlTemplate.replace("[ID]",'id="'+d.Key+'"');g=g.replace("[TEMP_NODE_ADD_FIELDS]",this.AddCols||
"");for(var h="",k=0;k<d.AddParas.length;k+=1)null!=d.AddParas[k]&&void 0!=d.AddParas[k]&&(h+="EWA_P"+k+'="'+d.AddParas[k]+'" ');g=g.replace("[TMP_ADD_PARAS]",h);g=g.replace("[EWA_MENU_GROUP]",d.MenuGroup);h=this.TestIcon(d);g=g.replace("[B]",h);g=g.replace("[C]",d.Text);g=d.IsMoreChildren?g.replace("[EWA_MORE_CHILDREN]","EWA_TREE_MORE='1'"):g.replace("[EWA_MORE_CHILDREN]","");0<d.Children.length||d.IsMoreChildren?(g=g.replace("[A]","TD00A"),g=d!=d.Parent.ChildLast?g.replace("[A1]","TD10B"):g.replace("[A1]",
"TD10A")):g=d==d.Parent.ChildLast?g.replace("[A]","TD00D"):g.replace("[A]","TD00C");h=d.Parent.GetObject();1==h.rows.length&&(k=h.insertRow(-1),k.insertCell(-1),k.insertCell(-1),k.cells[1].colSpan=2);k=this.GetNodeLvl(d.Parent);g=g.replace("[LVL]",k+1);this._TempNode.innerHTML=g;g=this._TempNode.childNodes[0];h.rows[1].cells[h.rows[1].cells.length-1].appendChild(g);h.parentNode.childNodes[h.parentNode.childNodes.length-1]!=h&&(h.rows[1].cells[0].className="TD10B");d.Parent.NodeShow(!0);e&&e(g,this);
for(k=0;k<d.Children.length;k+=1)this.Create(d.Children[k],e)}};this.GetNodeLvl=function(d){var e=d;if(d.Object.getAttribute("tree_lvl"))return 1*d.Object.getAttribute("tree_lvl");for(var g=0;100>g;g++)if(e=this.GetParentNode(e),null==e)return d.Object.setAttribute("tree_lvl",g+1),g+1};this._CreateFirst=function(d,e){var g=this._HtmlTemplate1.replace("[ID]","id='"+d.Key+"'");g=g.replace("[B]",d.Text);this.ParentObject.innerHTML=g;for(g=0;g<d.Children.length;g+=1)this.Create(d.Children[g],e)};this.Init=
function(d){var e=new EWA.C.Xml;e.LoadXml(d);this.Resources=new EWA_FrameResoures;this.Resources.Init(e);-1!=this.Url.toUpperCase().indexOf("EWA_TREE_INIT_KEY")||0<this.Url.toUpperCase().indexOf("EWA_TREE_SKIP_GET_STATUS")||EWA.F.ST.GetStatus("TREE",this)};this.LoadStatus=function(){EWA.SHOW_ERROR=!1;this.ShowNode(_EWA_STATUS_VALUE)};this.ShowNode=function(d){if(null!=d&&""!=d&&"EWA_TREE_ROOT"!=d){var e=this.GetNodeById(d);null==e?(e=new EWA.F.Cmd,e.EWA_ACTION="OnTreeNodeStatus",e.EWA_AJAX="XML",
e.EWA_TREE_KEY=d,e.EWA_TREE_STATUS="1",this._PostChange(e)):(this._StatusNode=e,this.ShowNodeA())}};this.ShowNodeA=function(){var d=this._StatusNode;this._StatusNode=null;for(var e=d.GetObject().parentNode,g=this.GetNode(e);"EWA_TREE_ROOT"!=g.Key;)g.NodeShow(!0),g=this.GetNode(g.GetObject().parentNode);d.Mark(!0);this._LastFocus=d.GetObject();this._RunCmd(d);window.setTimeout(function(){e.focus()},0)};this.getUrlClass=function(){var d=new EWA_UrlClass;d.SetUrl(this.Url);return d};this.Reload=function(){}}
function EWA_Treelink(a,b,c,d,e,g){alert("key="+a+"\r\nparentKey="+b+"\r\ntext="+c+"\r\naddPara1="+d+"\r\naddPara2="+e+"\r\naddPara3="+g+"\r\n\r\n\u60a8\u9700\u8981\u8986\u76d6\u8fd9\u4e2a\u65b9\u6cd5\r\nlink(key, parentKey, text, addPara1, addPara2, addPara3)")}"undefined"==typeof link&&(link=EWA_Treelink);EWA.F.T={CUR:null,C:EWA_TreeClass,Node:EWA_TreeNodeClass};
function EWA_Html5UploadClass(){this.uploadIframes=[];this.files=[];this.UPLOAD_STATUS=this.POST_REF=this.POST_NAME=this.POST_ITEMNAME=this.POST_XMLNAME="";this.WAIT_ID=EWA_Utils.tempId("ht5upload_wait_");this.loadFiles=function(a,b,c,d,e){var g=this;$J(a,function(h){for(var k in h)g.loadFile(h[k],b,c,d,e)})};this.loadFile=function(a,b,c,d,e){c=this.showPreviewUrl(a[c]);if(d){var g=$("<a class='ewa_app_upload_remove'></a>").attr(a);g.on("click",function(){d(this)});$(c).css("position","relative").append(g)}if(e)$(c).find("img").css("cursor",
...
this.uploadIframes[b];if("string"==typeof c){c=JSON.parse(c);for(var d in c)a.push(c[d])}}return JSON.stringify(a)};this.fileIco=function(a,b){a=EWA.UI.Ext.FileExt(a.name);$X(b).onerror=function(){};$X(b).src=EWA.UI.Ext.FileIco(a)};this.showPreview=function(a,b){if(10<a.files.length)"enus"==EWA.LANG?EWA.UI.Msg.ShowError("Upload up to 10 files at a time","limts"):EWA.UI.Msg.ShowError("\u4e00\u6b21\u6700\u591a\u4e0a\u4f2010\u4e2a\u6587\u4ef6","\u6587\u4ef6\u6570\u91cf\u9650\u5236"),a.value="";else{this.UpLimit||
(this.UpLimit="10M");b=(this.UpLimit+"").toLocaleLowerCase().replace(/,/ig,"").replace(/ /ig,"");if(b.endsWith("m")){b=b.substring(0,b.length-1);if(isNaN(b)){alert("Invalid sizeLimit parameter:"+this.sizeLimit);return}var c=1048576*b}else if(b.endsWith("k")){b=b.substring(0,b.length-1);if(isNaN(b)){alert("Invalid sizeLimit parameter:"+this.sizeLimit);return}c=1024*b}else{if(isNaN(b)){alert("Invalid sizeLimit parameter:"+this.sizeLimit);return}c=1*b}var d=[];if(0<c)for(b=0;b<a.files.length;b++){var e=
a.files[b];if(e.size>c){var g=EWA.UI.Ext.getFileLen(e.size,2);d.push(e.name.replace(/</ig,"%lt;").replace(/>/ig,"%gt;")+" ["+g+"]")}}if(0<d.length)a.value="","enus"==EWA.LANG?(d.push("Exceed "+this.UpLimit+" limit"),EWA.UI.Msg.ShowError(d.join("<br>"),"Exceed "+this.UpLimit+" limit")):(d.push("\u8d85\u8fc7"+this.UpLimit+"\u5927\u5c0f\u9650\u5236"),EWA.UI.Msg.ShowError(d.join("<br>"),"\u8d85\u8fc7"+this.UpLimit+"\u5927\u5c0f\u9650\u5236"));else{c=a.parentNode;d=c.outerHTML;c.style.display="none";a.setAttribute("ok",
1);gFileReaders={};for(b=0;b<a.files.length;b++)e=a.files[b],this.showPreview1(c,e),this.files.push(e);"yes"==this.UpMulti&&$(c).before(d)}}};this.addOther=function(a){for(var b=$X(this.POST_NAME).parentNode.getElementsByTagName("input")[1].parentNode,c=0;c<a.length;c++)this.showPreview1(b,a[c]);this.uploadIframes.push(JSON.stringify(a))};this.createPreviewBox=function(a){var b=a||$("#EWA_FRAME_"+this.SYS_FRAME_UNID+" input#"+this.POST_NAME).parent().find(".ewa_app_upload_form")[0],c="_upload_"+Math.random();
...
if(b.POST_NAME==c)for(c=0;c<this.files.length;c++){var d=this.files[c];d.isDeleted?console.log(d):b.uploadIframes.push({file:d})}})}catch(c){alert(c)}0<this.uploadIframes.length?($("#f_"+this.SYS_FRAME_UNID).find(".ewa-app-upload-process,.ewa-app-upload-process1").show(),b.UPLOAD_STATUS="checking",this.asyncUpload()):this.UPLOAD_STATUS="nofile"}else this.submitUploads_old(a)};this.asyncUpload=function(){var a=this,b=null,c;for(c in this.uploadIframes){var d=this.uploadIframes[c];if("string"!=typeof d){b=
d;break}}null!=b?(b.submitting||(b.submitting=!0,this.submitUpload(b)),setTimeout(function(){a.asyncUpload()},111)):this.uploadsCompleted&&this.uploadsCompleted(this.uploadIframes)};this.createFormData=function(){var a=new FormData,b=new EWA_UrlClass;b.SetUrl(EWA.F.FOS[this.SYS_FRAME_UNID].Url);for(var c in b._Paras)0!=c.toUpperCase().indexOf("EWA")&&a.append(c,b._Paras[c]);if(b=$X("f_"+this.SYS_FRAME_UNID))for(c=0;c<b.length;c++){var d=b[c],e=d.name||d.id;"file"!=d.type&&"button"!=d.type&&"submit"!=
d.type&&("radio"!=d.type&&"checkbox"!=d.type||d.checked)&&"ht5upload"!=$(d).attr("ewa_tag")&&a.append(e,d.value)}return a};this.submitUpload=function(a){var b=a.file,c=this.createFormData();c.append(this.POST_NAME,b,b.name);var d=$('img[id="'+b.ref+'"]');this.createNewSizes(d[0],c);var e=this,g=$('div[id="'+b.ref+'_process"]');g.show().html("0%");var h=$('div[id="'+b.ref+'_process1"]');h.css("width",0).show();b=new XMLHttpRequest;b.upload.addEventListener("progress",function(k){k.lengthComputable?
(k=Math.round(100*k.loaded/k.total-10),0>k&&(k=0),g.html(k.toString()+"%"),h.css("width",k.toString()+"%")):g.html("unable to compute")},!1);b.addEventListener("load",function(k){g.html("100%");h.css("width","100%");for(var l in e.uploadIframes)if(e.uploadIframes[l].xhr==k.target){e.uploadIframes[l]=k.target.responseText;break}e.chkAllXhrComplete()},!1);b.addEventListener("error",function(k){console.log(k);g.html(k);e.UPLOAD_STATUS="error"},!1);b.addEventListener("abort",function(k){g.html("The upload has been canceled by the user or the browser dropped the connection.");
console.log(k);e.UPLOAD_STATUS="abort"},!1);b.open("POST",this.action,!0);b.send(c);a.xhr=b;delete a.file};this.createNewSizes=function(a,b){if("client"===this.NewSizesIn){if(!this.siezs){var c=this.UpNewSizes.split(",");this.siezs=[];for(var d in c){var e=c[d],g=e.split("x");2==g.length&&(e=g[0],g=g[1],isNaN(e)||isNaN(g)||this.siezs.push({w:1*e,h:1*g}))}}if(0!=this.siezs.length)for(d in this.siezs)e=this.siezs[d],c=EWA_ImageCalss.resizeAsBlob(a,e.w,e.h),b.append(this.POST_NAME,c,"resized$"+e.w+"x"+
e.h+".jpg")}};this.chkAllXhrComplete=function(){for(var a=0,b=0;b<this.uploadIframes.length;b++)"string"==typeof this.uploadIframes[b]&&a++;if(!(a<this.uploadIframes.length)){a=[];for(b=0;b<this.uploadIframes.length;b++){var c=JSON.parse(this.uploadIframes[b]);c.ERR&&a.push(c.ERR)}if(0===a.length)this.UPLOAD_STATUS="ok";else{b=[];var d=this;b[0]={Text:_EWA_INFO_MSG["BUT.OK"],Event:function(){d.UPLOAD_STATUS="error"},Default:!0};EWA.UI.Msg.Show(a.join("<br>"),b,"","ERR_ICON");this.removeWaitBox()}}};
...
this.POST_REF;var g=b.id.split("_")[1].split("$")[0],h=EWA.F.FOS[g].Url,k=new EWA_UrlClass;k.SetUrl(h);for(var l in k._Paras)0!=l.toUpperCase().indexOf("EWA")&&(d+="&"+l+"="+k._Paras[l]);if(l=$X("f_"+g))for(g=0;g<l.length;g++)h=l[g],"file"!=h.type&&"button"!=h.type&&"submit"!=h.type&&("radio"!=h.type&&"checkbox"!=h.type||h.checked)&&(d+="&"+(h.name||h.id)+"="+h.value.toURL());e.attr("action",d);e.append(b);e.attr("target",a);this.uploadIframes.push(c[0]);setTimeout(function(){e.submit()},400)};this.chkframeSubmt=
function(){for(var a=0,b=0;b<this.uploadIframes.length;b++){var c=this.uploadIframes[b];if("string"==typeof c)a++;else if(c.contentDocument&&c.contentDocument.body){var d=GetInnerText(c.contentDocument.body);if(0<=d.indexOf("]")&&0<=d.indexOf("["))$("form[target="+c.id+"]").remove(),$(c).remove(),this.uploadIframes[b]=d;else if(""!=d.trim()){alert("\u7cfb\u7edf\u6267\u884c\u9519\u8bef\uff1a"+d);return}}}if(a==this.uploadIframes.length)this.UPLOAD_STATUS="ok";else{var e=this;window.setTimeout(function(){e.chkframeSubmt()},
100)}}}
...
function(k){k.lengthComputable?(k=Math.round(100*k.loaded/k.total-10),0>k&&(k=0),d.find("span").html(k.toString()+"%"),e.css("width",k.toString()+"%")):d.html("unable to compute")},!1);g.addEventListener("load",function(k){d.find("span").html("100%");e.css("width","100%");$("#EWA_FRAME_"+c.H5_UPLOAD.SYS_FRAME_UNID+" #"+c.objName).val(k.target.responseText);c.responseText=k.target.responseText;c.UPLOAD_STATUS="ok"},!1);g.addEventListener("error",function(k){console.log(k);d.html(k);c.UPLOAD_STATUS=
...
g[h]+"' "+e+"></i>");d.push("&nbsp;&nbsp;");g=["fa-fast-backward aa","fa-backward aa","fa-forward aa","fa-fast-forward aa"];for(h=0;h<g.length;h++)d.push("<i class='fa "+g[h]+"' "+e+"></i>"),1==h&&(d.push("<span class='aa' id='"+this._ClassName+"_records'></span>"),d.push("<select class='aa' id='"+this._ClassName+"_page' onchange='"+this._ClassName+".do_page(this)'><option value=5>5</option><option value=10>10</option><option value=20>20</option><option value=50>50</option><option value=100>100</option><option value=150>150</option><option value=200>200</option><option value=300>300</option><option value=500>500</option></select>"));
h=this.create_filter(a);e=h[0];h=h[1];d.push("<div class='sort_items' id='"+this._ClassName+"_search'>");d.push(e.join(""));d.push(h.join(""));d.push("</div>");a=this.create_sort(a);d.push("<div class='sort_items' id='"+this._ClassName+"_sort'>");d.push(a);d.push("</div>");d.push('</div><div id="'+b.new_parent_id+'"></div>');c.html(d.join(""));$X(this._ClassName+"_page").value=this._Cfg.EWA_PAGESIZE};this.setPageInfo=function(a){var b=1*a.RECORDS/this._Cfg.EWA_PAGESIZE,c=Math.round(b);c<b&&c++;this._Cfg._TOTALPAGE=
...
this._Cfg._Fix?"style='width:"+this._Cfg._Fix.box_des1+"px'":"",g=[],h=0;h<c.txt.length;h++){var k=c.txt[h],l=k.t;k=k.n;if(0==k.indexOf("<hr"))d.push("<tr><td class='box_subject' colspan=2>"),d.push(k),d.push("</td></tr>");else{if((l=this.replace_parameter(b,l))&&0<=l.indexOf("(")&&0<l.indexOf(")"))try{l=eval(l)}catch(n){}var m=a[k]?a[k].DES:k;d.push("<tr class='ewa-box-"+k+"'><td class='box_subject'><div class='box_subject1'><nobr>");d.push(m);d.push("</nobr><i class='fa fa-caret-right' style='color:#ccc'></i></div></td>");
...
c._load_datas_post_time&&(c.total_records=e.RECORDS,c.show_pages(),c.show_data(e.DATA,[!0]),c.is_load_data=!1)})};this.show_sort=function(a,b){b=b||event;1==(b.srcElement||b.target).getAttribute("openbox")&&(a=$(a).next(),null==a.attr("show")||""==a.attr("show")?(a.show(),a.css({top:20,right:4}),a.attr("show",1)):(a.hide(),a.attr("show","")))};this.load_data=function(){if(EWA&&EWA.F&&EWA.F.FOS)for(var a in EWA.F.FOS){var b=EWA.F.FOS[a];if(b.LEFT_CLASS==this){var c=b;break}}b={};if(c){c=c.Url;var d=
...
b?b():window["__timer_"+a]=setInterval(function(){b&&(window.clearInterval(window["__timer_"+a]),b())},111);this.focusObject($(c))}};this.changeEdit=function(a,b){a=$X(a);b&&$(a).hasClass("disabled-true")||($(a).find(".EWA_TD_B").hide(),$(a).find("select").attr("disabled",b),$(a).find("input").attr("disabled",b),$(a).find("textarea").each(function(){var c=$(this).parent();c.hasClass("ewa_redraw_info")&&0==c.find(".textarea-tip").length&&(c.css("position","relative").append("<span class='textarea-tip'>"+
$(this).attr("placeholder")+"</span>"),c.hover(function(){c.find(".textarea-tip").show()},function(){c.find(".textarea-tip").hide()}));if(0==c.find(".hide-textarea-content").length){var d="<div class='hide-textarea-content' style='display:none;overflow:auto;height:"+$(this).height()+"'>"+$(this).val()+"</div>";$(this).after(d)}c.find(".hide-textarea-content").hover(function(){$(this).parent().find(".textarea-tip").show()},function(){$(this).parent().find(".textarea-tip").hide()})}),$(a).find(".EWA_DHTML").each(function(){var c=
$(this).parent();if(c.hasClass("ewa_redraw_info")&&0==c.find(".textarea-tip").length){var d=$("#cpx_tab1 .EWA_TABLE").prop("id").replace("EWA_FRAME_",""),e=EWA.LANG?EWA.LANG.toLowerCase():"zhcn";d=$(EWA.F.FOS[d].ItemList.Items[this.id]).find("DescriptionSet Set[Lang='"+e+"']").attr("Info");c.css("position","relative").append("<span class='textarea-tip'>"+d+"</span>");c.hover(function(){c.find(".textarea-tip").show()},function(){c.find(".textarea-tip").hide()})}0==c.find(".hide-textarea-content").length&&
...
(d.childNodes[0].setAttribute("cmd",a.Cmd),d.childNodes[0].onclick=function(){var e=this.getAttribute("cmd");eval("("+e+")")(this)}):d.childNodes[0].setAttribute("onclick",a.Cmd);d.className="tdbut"}b=$("#controls").width();$("#dock").css("width",b).css("left","50%").css("margin-left",-1*b/2)}else $("#dock").hide()};this.init_lazy_frames_top=function(){this.lazy_frames=this.lazy_frames||{};var a=this;$("div[x]").each(function(){var b=$(this).offset().top;a.lazy_frames[this.id]?a.lazy_frames[this.id].top=
...
this.lazy_load_do=function(a){if(!this.lazy_frames[a].ok){this.lazy_frames[a].ok=!0;var b=$("#"+a),c=b.attr("x"),d=this._getParas();d&&(d="&"+d);if(null!=c&&0<c.length){var e=b.attr("i"),g=b.attr("p"),h=b.attr("js");null==h||""==h.trim()?EWA.F.Install(a,c,e,g+d):EWA.F.Install(a,c,e,g+d,function(){if(0<h.indexOf("("))eval(h);else window[h](b,this)})}else{c=b.attr("u")+d+"&NO_NAV=1";var k=("iframe_lazy_"+Math.random()).replace(".","A");d="<iframe id='"+k+"' name='"+k+"' width=100% height=100% frameborder=0 src='"+
c+"'></iframe>";$X(a).innerHTML=d;var l=-1,m=0<c.indexOf("combine.jsp")?!0:!1;setInterval(function(){var n=window.frames[k];if(n&&n.document&&"complete"==n.document.readyState&&n.$){var p=m?$("[id=crm_main_box]:visible").height():n.document.body.offsetHeight;100>Math.abs(l-p)||(l=p,$("#"+k).css("height",p+10),n.document.body.style.overflow="hidden")}},777)}}};this.mark_loc=function(){for(var a=$(".fcaption"),b=$("#nav_left .top"),c=$("#nav_left .bottom"),d=$("#nav_left"),e=this._getBodyHeight(),g=
0;g<a.length;g++){var h=a[g],k=this.mark_loc_ref(h,g);h=$(h);h=h.offset().top-("CSS1Compat"==document.compatMode?document.documentElement.scrollTop:document.body.scrollTop);h>e-c.height()?c.append(k):h<b.height()?b.append(k):(k.css({bottom:"",top:h}),d.append(k))}};this.mark_loc_ref=function(a,b){if(null==a.id||""==a.id)a.id=Math.random();var c=a.id;a=$(a);var d=$X("zzz"+c),e='EWA.F.FOS["'+this._Id+'"].';if(!d){d="c"+b%5;a.attr("class",a.attr("class")+" "+d);a.html("<b onclick='"+e+"max_frame(this)' class='fa fa-thumb-tack '>&nbsp;</b>"+
a.html());var g=a.css("background-color");a.parent().css("border-bottom-color",g);d=document.createElement("div");d.style.backgroundColor=g;d.id="zzz"+c;$("#nav_left").append(d);d.onclick=function(){var h=this.id.replace("zzz","");h=$($X(h)).offset().top;"CSS1Compat"==document.compatMode?$(document.documentElement).animate({scrollTop:h},300):$("body").animate({scrollTop:h},300)};d.title=a.text();d.innerHTML=b+1;d.onmouseover=function(){$(".pop_title_left div").html(this.title);var h=$(this).offset();
...
this.getAttribute("instancename"));window.clearTimeout(g.Timer);g._GotoIndex=1*this.innerHTML-1;g.Change()};d=document.createElement("div");d.style.cssText="background-image:url('"+c.ImgUrl+"');  "+this._CssSize+";background-repeat: no-repeat; background-size: cover;-moz-background-size: cover;-webkit-background-size: cover;background-position: center center;";d.title=c.AdText;var e=document.createElement("a");e.style.cssText=this._CssSize;e.style.position="absolute";e.style.top="0em";e.style.left=
...
b.animate(q,"fast","swing",function(){b[0].style.cssText="";var t=1*b.attr("st");document.body.scrollTop=t;1==$("#crm_left_box").attr("show")&&$("#crm_left_box").show();b.css("display",b.attr("dsp"));0<d.length&&"DES_plugin"!=a?d[0].click():(t=$X(a.replace("DES_","")),t.style.width=t.parentNode.clientWidth-10+"px",t.style.height=q.height-30+"px",c.find('div[id="EWA_FRAME_MAIN"]').css("height",q.height-150))});else{b.attr("full","1");b.attr("st",document.body.scrollTop);b.attr("dsp",b.css("display"));
...
k);c.css("height",l);b.find("iframe").css("height",l);b.find('div[id="EWA_FRAME_MAIN"]').css("height",l-30);0<d.length&&"DES_plugin"!=a&&d[0].click()});document.body.scrollTop=0;"none"!=$("#crm_left_box").css("display")&&($("#crm_left_box").hide(),$("#crm_left_box").attr("show",1));$(document.body).css("overflow","hidden")}};this.meargeItems=function(a){a=a.split(",");for(var b,c,d,e=0;e<a.length;e++){var g=a[e].trim();if($X(g)){var h=$X(g.replace("DES_",""));$("#"+g);var k=[];if(0==e){b=$X(g);d=
document.createElement("div");d.id="KK_"+g;d.style.cssText="clear:both;height:25px;border-top:1px solid #cdcdcd";d.setAttribute("but","1");c=h;for(var l=1;l<$X(g).childNodes.length;l++)if(h=$X(g).childNodes[l],1<l)h.id="M"+Math.random(),k.push(h.id);else{var m=h;m.className="ewa_lf_func_caption show";if(null==m.id||""==m.id)m.id="MAx"+Math.random();m.parentNode.setAttribute("lid",m.id)}for(;2<$X(g).childNodes.length;)h=$X(g).childNodes[2],d.appendChild(h)}else for(h.parentNode.style.display="none",
c.parentNode.appendChild(h),h.style.display="none",l=0;1<$X(g).childNodes.length;)h=$X(g).childNodes[1],0<l?(h.style.display="none",h.id="M"+Math.random(),k.push(h.id),d.appendChild(h)):(m=h,b.appendChild(h)),l++;m.setAttribute("ids",k.join(","));m.setAttribute("lst",g);m.setAttribute("menu_id",d.id);var n=this;addEvent(m,"click",function(){n.meargeItems_ck(this)})}else if(0==e)return}0<d.childNodes.length&&(b.appendChild(d),b.style.height="50px")};this.meargeItems_ck=function(a){var b=a.getAttribute("menu_id"),
...
"");a=a.getAttribute("lst");a=$X(a.replace("DES_",""));a.style.display="";a.style.width=a.parentNode.clientWidth-20+"px"};this.actIframe=function(a){var b=$("#"+a).find("iframe");if(0==b.length)alert(a+" not iframe");else{var c=b[0].contentWindow,d=c.document.body.scrollHeight,e=c.document.body.scrollWidth;if(c.$){var g=0;0<c.document.body.innerHTML.indexOf("EWA.F.F.C")?(g=c.$("#Test1").height(),e=c.$("#Test1").width()):(c.$(".ewa_table").parent().parent().children().each(function(){g+=$(this).height()}),
e=c.$(".ewa_table").width());d=g}e>$("#"+a).width()&&(d+=40);300>d&&(d=330);$("#"+a).css("height",d);var h=this;"0"!=b.attr("_src")?(b.attr("src",b.attr("_src")),b.attr("_src","0"),setTimeout(function(){h.chkFrameLazyLoaded(a)},199)):(h.setFrameCss(a,c),h.afterFrameLazyLoaded(a))}};this.setFrameCss=function(a,b){if(1!=$("#"+a).attr("lnk")){var c=b.document.createElement("link");c.type="text/css";c.rel="stylesheet";c.rev="stylesheet";c.href="../../css/main.css";b.document.getElementsByTagName("head")[0].appendChild(c);
b.document.body.style.backgroundColor="#fff";$("#"+a).attr("lnk",1)}};this.afterFrameLazyLoaded=function(a){};this.chkFrameLazyLoaded=function(a){var b=$("#"+a).find("iframe")[0].contentWindow;if(b&&b.document&&b.document.body&&b.$&&"complete"==b.document.readyState){var c=[],d=$("#"+a).parent().find("div[but=1]");0<d.length&&(b.$(".ewa_lf_func_dact").each(function(g){var h=document.createElement("div");h.className="ewa_lf_func_dact";h.style.cursor="pointer";h.innerHTML=this.innerHTML;""==this.id&&
(this.id=a+"|"+Math.random());h.id=this.id;d[0].appendChild(h);h.onclick=function(){this.id.split("|");$("#"+a).find("iframe")[0].contentWindow.$X(this.id).click()};c.push(h.id);0==g&&(this.parentNode.parentNode.style.display="none")}),d.parent().find(".show").attr("ids",c.join(",")));this.actIframe(a)}else{var e=this;setTimeout(function(){e.chkFrameLazyLoaded(a)},101)}};this.showInPlugin=function(a,b){if(0<a.indexOf(".jsp"))a='<iframe width=100% height=100% frameborder=0 src="'+a+'"></iframe>',$("#plugin").html(a),
...
(function(a,b){"object"===typeof module&&"object"===typeof module.exports?module.exports=b():b(a)})("undefined"!==typeof window?window:this,function(a){function b(l){for(var m=[{number:0,scale:1,items:[]}],n=null,p=0;p<l.length;p++){var r=l[p],q=e[r],t=d[r];m[m.length-1].items.push([r,q,t]);if(q)0==p&&q.first?m[m.length-1].number=10:q.stop?(m[m.length-1].scale=q.value||1,m.push({number:0,scale:1,items:[]}),scale=1,n=null):(p==l.length-1&&(console.log(q),m[m.length-1].number.scale=q.value),n=q);else{if(null==
t)throw"\u975e\u6570\u5b57\u6216\u5355\u4f4d\uff1a"+r;r=p==l.length-1?null:l[p+1];var v=p==l.length-1?null:e[r];v&&v.stop&&(v=null);r=m[m.length-1].number;var u=m[m.length-1].items;q=u[u.length-2];u=u[u.length-3];null==v?null==n?(n=!1,q&&0===q[2]?u&&null!=u[1]&&(n=!0):q&&q[1]&&10===q[1].value&&(n=!0),t=n?r+t:10*r+t):t=q&&q[1]&&10===q[1].value&&(null==u||0===u[2]||null!=u[1])?r+t+10:r+t:t=r+t*v.value;m[m.length-1].number=t;n=null}}return m}function c(l){if(!l)return l;if(!isNaN(l.toString()))return 1*
l.toString();var m=l.replace(/\uff0c|,| |\u5143|\u5706/ig,"").replace(/\u70b9|\u3002/ig,".").split(".");if(2<m.length)throw"\u975e\u6570\u5b57\u8868\u8fbe\u5f0f\uff1a"+l;var n=m[0].split("");l=(2==m.length?m[1]:"").split("");m=!1;var p=n[0];g[p]?(m=!0,n=n.splice(1)):h[p]&&(m=!1,n=n.splice(1));p=n[n.length-1];k[p]?n=n.splice(0,n.length-1):1<l.length&&(p=l[l.length-1],k[p]&&(l=l.splice(0,l.length-1)));p=n;for(var r=n=0,q=p.length-1;0<=q;q-=2){var t=p[q];var v=d[p[q-1]];t=v?"\u89d2"==t?1*("0."+v):"\u5206"==
t?1*("0.0"+v):"\u5398"==t?1*("0.00"+v):"\u6beb"==t?1*("0.000"+v):-1:-1;if(-1===t)break;else n+=t,r++}p=p.splice(0,p.length-2*r);p=b(p);r=0;q=1;for(t=p.length-1;0<=t;t--){v=p[t];var u=v.number;q*=v.scale;r+=u*q}n=r+n;if(0<l.length){p=1;r=0;for(q=l.length-1;0<=q;q--){t=e[l[q]];if(!t)break;p*=t.value;r++}l=1==p?l:l.splice(0,l.length-r);r=b(l);q=0;t=1;for(v=r.length-1;0<=v;v--){u=r[v];var x=u.number;t*=u.scale;q+=x*t}l=[1*("0."+q),p,l.length]}else l=0;return 0==l?n*(m?-1:1):((n+l[0])*l[1]).toFixed(0>
l[2]?0:l[2])*(m?-1:1)}var d={"\u96f6":0,0:0,"\uff10":0,o:0,O:0,"\u4e00":1,"\u58f9":1,1:1,"\uff11":1,"\u4e8c":2,"\u8d30":2,2:2,"\uff12":2,"\u4e24":2,"\u4fe9":2,"\u4e09":3,"\u53c1":3,3:3,"\uff13":3,"\u56db":4,"\u8086":4,4:4,"\uff14":4,"\u4e94":5,"\u4f0d":5,5:5,"\uff15":5,"\u516d":6,"\u9646":6,6:6,"\uff16":6,"\u4e03":7,"\u67d2":7,7:7,"\uff17":7,"\u516b":8,"\u634c":8,8:8,"\uff18":8,"\u4e5d":9,"\u7396":9,9:9,"\uff19":9},e={"\u5341":{value:10,first:!0},"\u62fe":{value:10,first:!0},"\u4ec0":{value:10,first:!0},
"\u767e":{value:100},"\u4f70":{value:100},"\u964c":{value:100},"\u5343":{value:1E3},"\u9621":{value:1E3},"\u4edf":{value:1E3},k:{value:1E3,stop:!0},K:{value:1E3,stop:!0},"\u4e07":{value:1E4,stop:!0},"\u842c":{value:1E4,stop:!0},w:{value:1E4,stop:!0},W:{value:1E4,stop:!0},M:{value:1E6,stop:!0},m:{value:1E6,stop:!0},"\u4ebf":{value:1E8,stop:!0},b:{value:1E9,stop:!0},B:{value:1E9,stop:!0}},g={"-":!0,"\u8d1f":!0,"\uff0d":!0},h={"+":!0,"\u6b63":!0},k={"\u6574":!0};if("undefined"!=typeof window&&window.EWA&&
window.EWA_Utils)window.EWA_Utils.chineseToNumber=c;else if(a)a.chineseToNumber=c;else return c});
var EWAC_WfOrg=function(){this.Depts={};this.Posts={};this.Users={};this.GetMaster=function(a){var b=this.Users[a];if(null==b)console.log(("enus"==EWA.LANG?"NONE of ":"\u6ca1\u6709\u554a")+a);else{a=b.Dept;for(var c in a.Users){b=a.Users[c];for(var d in b.Posts)if(b.Posts[d].IsMaster)return b}console.log("enus"==EWA.LANG?"\tNo manager":"\u6ca1\u6709\u7ba1\u7406\u8005")}};this.IsMaster=function(a){var b=this.GetMaster(a);return null==b?!1:b.Id==a};this.InitDepts=function(a,b,c,d,e,g){for(var h=0;h<
a.length;h++){var k=a[h];if(null==this.Depts[k[b]]){var l={};l.Id=k[b];l.Name=k[c];l.Lvl=k[d];l.Ord=k[e];l.Pid=k[g];l.Posts={};l.Users={};l.Children={};this.Depts[l.Id]=l}}for(var m in this.Depts)k=this.Depts[m],this.Depts[k.Pid]?(a=this.Depts[k.Pid],k.Parent=a,a.Children[k.Id]=k):null==this.DeptRoot&&(this.DeptRoot=k)};this.InitPosts=function(a,b,c,d,e){for(var g=0;g<a.length;g++){var h=a[g],k=h[b];if(null==this.Posts[k]){var l={};l.Id=k;l.Name=h[c];l.DeptId=h[e];h=h[d];h=null==h?"":h.trim().toLowerCase();
l.IsMaster="y"==h||"yes"==h||"true"==h||"1"==h?!0:!1;this.Depts[l.DeptId]&&(l.Dept=this.Depts[l.DeptId],null==l.Dept.Posts[l.Id]&&(l.Dept.Posts[l.Id]=l));this.Posts[k]=l}}};this.InitUsers=function(a,b,c,d,e){for(var g=0;g<a.length;g++){var h=a[g],k=h[b];if(null!=this.Users[k])var l=this.Users[k];else l={},l.Id=k,l.Name=h[c],l.DeptId=h[d],l.Posts={},this.Depts[l.DeptId]&&(l.Dept=this.Depts[l.DeptId],null==l.Dept.Users[l.Id]&&(l.Dept.Users[l.Id]=l)),this.Users[k]=l;h=h[e];this.Posts[h]&&(l.Posts[h]=
...
function EWAC_WfUnit(a){this.Id=a;this.Type="normal";this.IsSelected=!1;this.tagName="wfunit";this.CnnsFrom={};this.CnnsFromLength=0;this.CnnsTo={};this.CnnsToLength=0;this.IsDelete=!1;this.ChangeType=function(b){var c=$X(this.Id),d="ewa_wf_unit_img";"control"==b?d="ewa_wf_unit_img1":"end"==b&&(d="ewa_wf_unit_img2");c.getElementsByTagName("img")[0].className=d};this.ChangeDes=function(b){var c=$X(this.Id);SetInnerText(c.getElementsByTagName("td")[1].childNodes[0],b)};this.GetDes=function(){return GetInnerText($X(this.Id).getElementsByTagName("span")[0]).trimEx()};
this.Delete=function(){if(!this.IsDelete){for(var b in this.CnnsFrom)this.CnnsFrom[b].Delete();for(b in this.CnnsTo)this.CnnsTo[b].Delete();b=$X(this.Id);b.parentNode.removeChild(b)}this.IsDelete=!0};this.Log=function(b,c,d){var e=null==EWA.RV_STATIC_PATH?EWA.CP:EWA.RV_STATIC_PATH;e+="/EWA_STYLE/";var g=$X(this.Id),h=g.getElementsByTagName("img")[0];h.src=e+"images/workflow/wf_ok.png?a=1";h.style.width="38px";h.style.height="38px";h.className="";e=h.nextSibling;null!=d&&0<d.trim().length&&(g.title=
...
k=EWAC_WfUtil.WF.Units[k.To],k.LogTo(),g&&(g.options[g.options.length]=new Option(k.GetDes(),k.Id)))}d.style.width="38px";d.style.height="38px";d.className="";h=null==EWA.RV_STATIC_PATH?EWA.CP:EWA.RV_STATIC_PATH;h+="/EWA_STYLE/";b?(e.innerHTML="enus"==EWA.LANG?e.innerHTML+"<i><b>Finished</b></i>":e.innerHTML+"<i><b>\u6267\u884c\u7ed3\u675f</b></i>",d.src=h+"images/workflow/wf_no.png?A=1"):(e.innerHTML="enus"==EWA.LANG?e.innerHTML+"<i><b>Current</b></i>":e.innerHTML+"<i><b>\u5f53\u524d\u8282\u70b9</b></i>",
g&&2==g.options.length&&(g.selectedIndex=1),c.style.backgroundColor="lightblue",c.style.color="white",d.src=h+"images/workflow/wf_cur.png?A=1")};this.LogTo=function(){var b=null==EWA.RV_STATIC_PATH?EWA.CP:EWA.RV_STATIC_PATH;b+="/EWA_STYLE/";var c=$X(this.Id);c.style.backgroundColor="lightyellow";c=c.getElementsByTagName("img")[0];c.src=b+"images/workflow/wf_next.png?A=2";c.style.width="38px";c.style.height="38px";c.className=""};this.Create=function(b){var c=EWAC_WfUtil.CUR_OBJ,d=document.createElement("TABLE");
d.id=this.Id;d.className="ewa_wf_box";var e=d.insertRow(-1);e=e.insertCell(-1);e.innerHTML='<img style="cursor:pointer" class="ewa_wf_unit_img" src="'+((null==EWA.RV_STATIC_PATH?EWA.CP:EWA.RV_STATIC_PATH)+'/EWA_STYLE//images/transparent.png" id="Atom_Img_')+a+'"><div a=1></div>';e.align="center";e=d.insertRow(-1);e=e.insertCell(-1);e.align="center";e.innerHTML='<span onselectstart="return true" onkeypress="EWAC_WfUtil.AtomNameKeyPress(this)" onblur="EWAC_WfUtil.AtomChangedName(this)" ondblclick="EWAC_WfUtil.AtomChangeName(this)">\u4e1a\u52a1\u5143'+
b+"</span>";document.body.appendChild(d);d.style.position="absolute";d.style.left=c?c.style.left:120*b+"px";d.style.top=c?c.style.top:"90px";c&&(c.style.position="static")};this.MoveTo=function(b,c){var d=this.GetObj();d.style.left=1*d.style.left.replace("px","")+b+"px";d.style.top=1*d.style.top.replace("px","")+c+"px";for(var e in this.CnnsFrom)this.CnnsFrom[e].IsDelete||(this.CnnsFrom[e].Show(),this.CnnsFrom[e].Disp());for(e in this.CnnsTo)this.CnnsTo[e].IsDelete||(this.CnnsTo[e].Show(),this.CnnsTo[e].Disp())};
...
(e>m?(c=m,g=e-m):(c=l,g-=l),e="2B,3L,1LTA"),e+="\u7b2c\u4e00"):k<c?(b=k,d=c-k,g<l?(c=g,g=l-g,e="1T,0R,2RBA"):g>l&&g<m?(c=e,g=m-e,e="2BA,3L,1LT"):e>m?(c=m,g=e-m,e="0TA,1L,3LB(\u4e09)"):(c=l,g-=l,e="0TA,1L,3LB(\u56db)"),e+="\u7b2c\u4e8c"):c>h&&c<k?(b=k,d=d-k+20,g<l?(c=g,g=l-g,a=20,e="1TR,3RB,2BA(\u5927)"):(c=m,g=e-m,a=20,e="0TA,1TR,3RB(##)")):(b=d,d=k-d+20,g<l?(c=g,g=l-g,a=20,e="0T,1TR,3RBA(\u58eb)"):(c=m,g=e-m,a=20,e="1TRA,3RB,2B(#)"));null==e&&(e="\u672a\u53d1\u73b0");document.title=e;this.Drawline(e,
b,c,d,g,a);this.Disp(1)};this.Drawline=function(a,b,c,d,e,g){var h=$X(this.Id);0>d||0>e||(h.setAttribute("type",a),h.style.left=b+"px",h.style.top=c+"px",h.style.height=e+"px",h.style.width=d+"px",0==d||0>d-g||(a=h.childNodes[0].rows[0].cells[0],h=h.childNodes[0].rows[0].cells[1],0<g?(h.style.width=g+"px",a.style.width=d-g+"px"):(h.style.width="50%",a.style.width="50%")))};this.Disp=function(a,b){var c=$X(this.Id),d=null==a?1:a;a=c.getAttribute("type");var e=c.getAttribute("w");c.childNodes[0].setAttribute("type",
a);c.childNodes[0].setAttribute("w",e);for(e=c.getElementsByTagName("img");0<e.length;)e[0].parentNode.removeChild(e[0]),e=c.getElementsByTagName("img");for(var g=0;g<e.length;g++)e[g].style.display="none";e=c.getElementsByTagName("td");for(g=0;g<e.length;g++)e[g].style.border="0px";b=(null==b?"#000":b)+" "+d+"px solid";for(g=0;g<a.length;g++)if(c=a.substring(g,g+1),""!=c.trim())if(isNaN(c))"T"==c?h.style.borderTop=b:"L"==c?h.style.borderLeft=b:"R"==c?h.style.borderRight=b:"B"==c?h.style.borderBottom=
b:"A"==c&&(3==k?"0px"!=h.style.borderLeftWidth?(c="arraw_t00.gif",h.style.textAlign="right"):(c="arraw_t01.gif",h.style.textAlign="left"):2==k?(c="arraw_t01.gif",h.style.textAlign="left"):1==k?"0px"!=h.style.borderLeftWidth?(c="arraw_t10.gif",h.style.textAlign="right"):(c="arraw_t11.gif",h.style.textAlign="left"):(c="arraw_t11.gif",h.style.textAlign="left"),d=null==EWA.RV_STATIC_PATH?EWA.CP:EWA.RV_STATIC_PATH,d+="/EWA_STYLE/",h.innerHTML='<img src="'+d+"images/workflow/"+c+'" />');else{var h=e[1*
c];var k=c}};this.UnSelect=function(){this.Disp(1);this.IsSelected=!1;EWAC_WfUtil.SELECTED=null};this.Selected=function(){this.Disp(3);this.IsSelected=!0;EWAC_WfUtil.SELECTED=this}}
...
b=a.id:-1<a.id.indexOf("Atom_Img_")&&(b=a.id.replace("Atom_Img_",""));return b?this.Units[b]:null};this.CreateUnit=function(a){a||(a=this.GetUnid());var b=new EWAC_WfUnit(a);b.Create(this._CurIdx);return this.Units[a]=b};this.CreateCnn=function(){var a=EWAC_WfUtil.TWO[0],b=EWAC_WfUtil.TWO[1];if(null==a||null==b)alert("\u9700\u8981\u4e24\u4e2a\u4e1a\u52a1\u5143");else{var c=new EWAC_WfCnn;c.Create(a,b);this.Cnns[c.Id]=c}};this.GetCnn=function(a){return this.Cnns[a.parentNode.id]}}
var EWAC_WfUtil={CUR_OBJ:null,TWO:[null,null],SELECTED:null,MouseDown:function(a){a=a?a:event;var b=EWA.B.IE?a.srcElement:a.target,c=b.tagName.toUpperCase();if("TD"==c&&"Test1"==b.parentNode.parentNode.parentNode.id)EWAC_WfUtil.WF.ClearSelects();else{var d=EWA.UI.Utils.GetMousePosition(a);EWAC_WfUtil.M_X=d.X;EWAC_WfUtil.M_Y=d.Y;if("IMG"==c)if("TEMP"==b.id)EWAC_WfUtil.CUR_OBJ=b;else{if(b=EWAC_WfUtil.WF.GetUnit(b),EWAC_WfUtil.CUR_OBJ=b)EWA.UI.Utils.GetMousePosition(a),EWAC_WfUtil.objSelectedDown(b),
EWAC_WfUtil.ShowUnitPara(b)}else"TD"==c&&(a=b.parentNode.parentNode.parentNode,"LINE"==a.getAttribute("gdx")&&(a=EWAC_WfUtil.WF.GetCnn(a),a.IsSelected?a.UnSelect():a.Selected()))}},MouseUp:function(a){a=EWAC_WfUtil.CUR_OBJ;null!=a&&("TEMP"==a.id&&EWAC_WfUtil.WF.CreateUnit(),EWAC_WfUtil.CUR_OBJ=null)},MouseMove:function(a){var b=EWAC_WfUtil.CUR_OBJ;if(null!=b){a=EWA.UI.Utils.GetMousePosition(a?a:event);var c=a.X-EWAC_WfUtil.M_X,d=a.Y-EWAC_WfUtil.M_Y;EWAC_WfUtil.M_X=a.X;EWAC_WfUtil.M_Y=a.Y;"IMG"==b.tagName?
(b.style.position="absolute",b.style.left=a.X+"px",b.style.top=a.Y+"px"):"wfunit"==b.tagName&&b.MoveTo(c,d)}},Delete:function(){var a=EWAC_WfUtil.SELECTED;null!=a&&(0==a.tagName.indexOf("wf")&&(a.Delete(),EWAC_WfUtil.TWO=[null,null],EWAC_WfUtil.SELECTED=null),EWAC_WfUtil.CUR_OBJ=null)},objSelectedDown:function(a){a.IsSelected?(a.UnSelect(),EWAC_WfUtil.TWO[0]==a&&(EWAC_WfUtil.TWO[0]=EWAC_WfUtil.TWO[1]),EWAC_WfUtil.TWO[1]=null):null==EWAC_WfUtil.TWO[1]&&(a.Selected(),null==EWAC_WfUtil.TWO[0]?EWAC_WfUtil.TWO[0]=
...
function loadWfShow(a,b,c,d,e,g,h,k,l,m){_EWA_WF&&_EWA_WF.EN&&(_EWA_WF.EN1=$J2MAP(_EWA_WF.EN,"WF_UNIT_ID"));d=document.createElement("div");d.style.position="absolute";d.style.zIndex=123;d.innerHTML="ver: "+_EWA_WF.WF_DLV_VER;document.body.appendChild(d);var n=EWAC_WfUtil.WF,p=1000012,r=1000011;for(d=0;d<a.length;d++){var q=a[d],t=q.WF_UNIT_X,v=q.WF_UNIT_Y;null!=t&&1*t<p&&(p=1*t);null!=v&&1*v<r&&(r=1*v)}1000012==p&&(p=0);1000011==r&&(r=0);p-=10;r-=10;m={};var u;for(d=0;d<a.length;d++)q=a[d],n.Ids[d]=
q.WF_UNIT_ID,t=n.CreateUnit(),m[q.WF_UNIT_ID]=t,v=q.WF_UNIT_NAME,"enus"==EWA.LANG&&_EWA_WF.EN1&&_EWA_WF.EN1[q.WF_UNIT_ID]&&_EWA_WF.EN1[q.WF_UNIT_ID].WF_UNIT_NAME_EN&&(v=_EWA_WF.EN1[q.WF_UNIT_ID].WF_UNIT_NAME_EN),t.ChangeDes(v),t.ChangeType(q.WF_UNIT_TYPE),t.WF_UNIT_ADM=q.WF_UNIT_ADM,t.WF_UNIT_ADM_LST=q.WF_UNIT_ADM_LST,t=q.WF_UNIT_X,v=q.WF_UNIT_Y,q=$X(q.WF_UNIT_ID),null!=t&&(q.style.left=t-p+"px"),null!=v&&(q.style.top=v-r+"px");a={};for(d=0;d<b.length;d++)q=b[d],t=q.WF_UNIT_FROM,a[t]||(a[t]=[]),a[t].push(q);
for(d=0;d<b.length;d++)q=b[d],a=q.WF_UNIT_TO,t=q.WF_UNIT_FROM,t=n.Units[t],a=n.Units[a],p=new EWAC_WfCnn,p.Create(t,a),n.Cnns[p.Id]=p,q.IsHaveLogic&&!q.IsLogicOk&&(p.IsStop=!0);for(var x in n.Units)d=n.Units[x],null==u&&0==d.CnnsToLength&&(u=d);if(null==u)d="enus"==EWA.LANG?"No startup node was found, process definition error":"\u672a\u53d1\u73b0\u542f\u52a8\u8282\u70b9,\u6d41\u7a0b\u5b9a\u4e49\u9519\u8bef",alert(d);else{0==c.length&&(n.CurUnit=u);var w=[];x={};for(d=0;d<c.length;d++)b=c[d],n=b.SYS_STA_TAG,
t=m[n],null!=t&&(q=b.ADM_NAME,"enus"==EWA.LANG&&b.ADM_NAME_EN&&(q=b.ADM_NAME_EN),t.Log(q,b.SYS_STA_CDATE,b.SYS_STA_MEMO),x[n]||(x[n]=1,w.push({ID:n,DES:t.GetDes()})),n=b.SYS_STA_TAG+"G"+b.SYS_STA_VAL,EWAC_WfUtil.WF.Cnns[n]&&(EWAC_WfUtil.WF.Cnns[n].Disp(3,"blue"),t==u&&(t.ADM_ID=b.ADM_ID),d==c.length-1&&(t=m[b.SYS_STA_VAL],t.WF_UNIT_ADM_LST=b.ROLE_IDS,t.WF_UNIT_ADM=b.ROLE_TYPE,EWAC_WfUtil.WF.CurUnit=t)));null!=l&&0<l.length&&m[l]&&(EWAC_WfUtil.WF.CurUnit=m[l]);EWAC_WfUtil.WF.CurUnit.LogCur(e);l=!1;
t=EWAC_WfUtil.WF.CurUnit;c=[];if(u==t)l=!0;else if("WF_ADM_ADM"==t.WF_UNIT_ADM)if(u=","+t.WF_UNIT_ADM_LST+",",0<=u.indexOf(","+g+","))l=!0;else for(d in g=$J2MAP1(top.org,"ADM_ID"),h=t.WF_UNIT_ADM_LST.split(","),h){k=g[h[d]];for(var y in k)c.push(k[y].ADM_NAME)}else if("WF_ADM_DEPT"==t.WF_UNIT_ADM)if(u=","+t.WF_UNIT_ADM_LST+",",0<=u.indexOf(","+h+","))l=!0;else for(d in g=$J2MAP1(top.org,"DEP_ID"),h=t.WF_UNIT_ADM_LST.split(","),h)for(y in k=g[h[d]],k)c.push(k[y].ADM_NAME);else if("WF_ADM_POST"==t.WF_UNIT_ADM){u=
","+t.WF_UNIT_ADM_LST+",";g=k.split(",");for(h=0;h<g.length;h++)if(0<=u.indexOf(","+g[h]+",")){l=!0;break}if(!l)for(d in g=$J2MAP1(top.org,"DEP_POS_ID"),h=t.WF_UNIT_ADM_LST.split(","),u={},h)for(y in k=g[h[d]],k)m=k[y],u[m]||(u[m]=!0,c.push(k[y].ADM_NAME))}else if("WF_ADM_START"==t.WF_UNIT_ADM){if(u==t||g==u.ADM_ID)l=!0}else"WF_ADM_MANAGER"==t.WF_UNIT_ADM&&(y=u.ADM_ID,top||top.ORG||(d="enus"==EWA.LANG?"No organization":"\u6ca1\u6709\u7ec4\u7ec7\u673a\u6784",alert(d),l=!1),l=top.ORG.GetMaster(y).Id==
g?!0:!1);e&&window.parent&&window.parent.$X(e)&&(y=window.parent.$X(e).parentNode.parentNode.parentNode,l?0<w.length&&(d=y.rows[y.rows.length-1].cells[0],g=window.parent.document.createElement("input"),g.type="button",g.value="enus"==EWA.LANG?"Back":"\u6253\u56de",g.onclick=function(){var z=window.parent.$X(e);z.options.length=1;for(var A=0;A<w.length;A++){var C=w[A];z.options[z.length]=new Option(C.DES,C.ID);this.style.display="none"}z.parentNode.parentNode.cells[0].innerHTML="enus"==EWA.LANG?'<div style="color:red">Back steps</div>':
'<div style="color:red">\u8fd4\u56de\u6b65\u9aa4</div>'},d.insertBefore(g,d.getElementsByTagName("input")[1])):(0==c.length?(d="enus"==EWA.LANG?"Only view":"\u60a8\u53ea\u80fd\u67e5\u770b",window.parent.$X(e).parentNode.innerHTML="<b>"+d+"</b>"):(d="enus"==EWA.LANG?"Waitting":"\u7b49\u5f85",g="enus"==EWA.LANG?"or":"\u6216",window.parent.$X(e).parentNode.innerHTML="<b>"+d+':<span style="color:blue">'+c.join("</span> "+g+' <span style="color:blue">')+"</span></b>"),window.parent.$X("butOk").style.display=
"none"),(d=_EWA_WF.WF_SHOW)&&showControls(y,d))}}function showControls(a,b){for(var c=a.rows.length-5;0<=c;c--)0!=a.rows[c].id.indexOf("_ewa_tr$EWA_WF_")&&(a.rows[c].style.display="none");var d={},e=!1;for(c=0;c<b.length;c++)for(var g=b[c].XITEMS.split(","),h=0;h<g.length;h++){var k=g[h].trim();""==k||d[k]||(d[k]=1,e=!0)}if(e)for(var l in d)if(b=a.ownerDocument.getElementById("_ewa_tr$"+l))b.style.display=""}
function loadWf(a,b){for(var c=EWAC_WfUtil.WF,d=1000012,e=1000011,g=0;g<a.length;g++){var h=a[g],k=h.WF_UNIT_X,l=h.WF_UNIT_Y;k<d&&(d=k);l<e&&(e=l)}for(g=0;g<a.length;g++)h=a[g],c.Ids[g]=h.WF_UNIT_ID,k=c.CreateUnit(),k.ChangeDes(h.WF_UNIT_NAME),k.ChangeType(h.WF_UNIT_TYPE),k=h.WF_UNIT_X,l=h.WF_UNIT_Y,h=$X(h.WF_UNIT_ID),null!=k&&(h.style.left=k+"px"),null!=l&&(h.style.top=l+"px");for(g=0;g<b.length;g++){h=b[g];a=c.Units[h.WF_UNIT_FROM];h=c.Units[h.WF_UNIT_TO];k=new EWAC_WfCnn;try{k.Create(a,h),c.Cnns[k.Id]=
k}catch(m){alert(m)}}}
function loadByDefined(){for(var a=window.parent._EWAC_User.WorkflowTableSet,b=EWAC_WfUtil.WF,c=0;c<a.Count();c++){var d=a.GetItem(c);b.Ids[c]=d.Name;var e=b.CreateUnit(),g=d.Tables.GetItem("descriptionset").SearchValue("lang=zhcn","info");e.ChangeDes(g);d=d.Tables.GetItem("WfType").GetSingleValue();e.ChangeType(d)}for(c=0;c<a.Count();c++)e=a.GetItem(c),d=e.Tables.GetItem("WfType").GetSingleValue(),"end"!=d&&(EWAC_WfUtil.TWO[0]=b.Units[e.Name],e=e.Tables.GetItem("WfAction"),d=e.GetValue("WFANextYes"),
null==d||""==d?(d=a.GetItem(c+1),EWAC_WfUtil.TWO[1]=b.Units[d.Name]):(alert(d),EWAC_WfUtil.TWO[1]=b.Units[d]),b.CreateCnn(),d=e.GetValue("WFANextNo"),null!=d&&""!=d&&(alert(d),EWAC_WfUtil.TWO[1]=b.Units[d]),b.CreateCnn());EWAC_WfUtil.TWO[0]=EWAC_WfUtil.TWO[1]=null}
function CreateExp(){var a=new EWA_XmlClass;a.LoadXml("<EwaWf><Units /><Cnns /><Draw /></EwaWf>");for(var b=a.GetElement("Units"),c=a.GetElement("Cnns"),d=document.getElementsByTagName("TABLE"),e=[],g=0;g<d.length;g++){var h=d[g];if(0==h.id.indexOf("Atom_Table_")||"none"==h.style.display){var k=a.NewChild("Unit",b);k.setAttribute("Unid",h.getAttribute("sid"));k.setAttribute("Type",h.getAttribute("type"));k.setAttribute("Des",GetInnerText(h).trim());e.push(GetOuterHTML(h))}}b=document.getElementsByTagName("DIV");
for(g=0;g<b.length;g++)if(d=b[g],0==d.id.indexOf("Atom_Table_")){k=d.id.split("G");h=k[0].replace("Atom_Table_","");var l=k[1].replace("Atom_Table_","");k=a.NewChild("Cnn",c);k.setAttribute("Unid",d.id);k.setAttribute("From",h);k.setAttribute("To",l);k.setAttribute("Logic","");e.push(GetOuterHTML(d))}c=a.GetElement("Draw");a.SetCData(e.join("\r\n"),c);alert(a.GetXml())}
function SetAtomName(a){""!=CurSelectedID&&(window.arrayAtoms[CurSelectedID][2]=a,$X("Atom_Table_"+CurSelectedID).rows[1].cells[0].innerText=a)}function SetAtomType(a){if(""!=CurSelectedID){var b=null==EWA.RV_STATIC_PATH?EWA.CP:EWA.RV_STATIC_PATH;b+="/EWA_STYLE/";window.arrayAtoms[CurSelectedID][1]=a;var c=$X("Atom_Table_"+CurSelectedID);c.type=a;c.rows[0].cells[0].childNodes[0].src=0==a?b+"images/workflow/nulla.gif":b+"images/workflow/nullaico.gif"}}
...
function loadParentInfo(){EWA.OW.Load();if(EWA.OW.PWin){for(var a,b=document.getElementsByTagName("table"),c=0;c<b.length;c++){var d=b[c];if(0==d.id.indexOf("EWA_FRAME_")){a=d;break}}if(null!=a)if(c=a.parentNode.parentNode.offsetHeight,b=a.offsetHeight,d=document.createElement("div"),d.style.height=c-b+"px",d.style.overflow="auto",d.innerHTML="<table broder=0 cellpadding=1 cellspacing=1 class=EWA_TABLE></table>",a.parentNode.insertBefore(d,a),a=d.childNodes[0],c=EWA.OW.PWin,b=new EWA_UrlClass,b.SetUrl(window.location.href),
d=b.GetParameter("fjson"),null!=d)loadParentInfoJson(c,d,a);else{b._Paras.COMBINE_ID&&c.$("#"+b._Paras.COMBINE_ID).find("li").each(function(m){0==m%2&&(h=a.insertRow(0),k=h.insertCell(-1),k.className="EWA_TD_L",k.innerHTML='<span style="color:111"><i>'+$(this).text()+"</i></span>");1==m%2&&(m=h.insertCell(-1),m.className="EWA_TD_M",m.innerHTML=$(this).text())});for(g in c.EWA.F.FOS)if(g==b.GetParameter("EWA_PARENT_FRAME")){var e=c.EWA.F.FOS[g];break}if(e&&(e=e.SelectCheckedRows(),0!=e.length)){e=
e[0];var g=e.parentNode.rows[0];for(c=e.cells.length-1;0<=c;c--)if(!(0<e.cells[c].getElementsByTagName("input"))&&(b=GetInnerText(g.cells[c]),d=GetInnerText(e.cells[c]),null!=b&&""!=b.trim()&&null!=d&&""!=d.trim()&&(b=b.replace("?","").trim(),b.trim()!=d.trim()))){var h=a.insertRow(0),k=h.insertCell(-1);k.className="EWA_TD_L";var l=h.insertCell(-1);l.className="EWA_TD_M";k.innerHTML='<span style="color:111"><i>'+b+"</i></span>";l.innerHTML=d}}}}else window.setTimeout(loadParentInfo,300)}
function getSpJson(){for(var a=null,b=document.getElementsByTagName("table"),c=0;c<b.length;c++)if(0==b[c].id.indexOf("EWA_FRAME_")){a=b[c];break}c="EWA_ITEMS_XML_"+a.id.replace("EWA_FRAME_","");a=[];a.push("[");b=new EWA_XmlClass;b.LoadXml(window[c]);b=b.XmlDoc.getElementsByTagName("XItem");for(c=0;c<b.length;c++){0<c&&a.push(",");var d=getSpItem(b[c]);eval("o="+d);if("select"==(void 0).TAG){for(var e=$X((void 0).NAME),g=[],h=0;h<e.options.length;h++){var k=e.options[h];g.push(k.text+"gdx|z"+k.value.replace(/"/ig,
...
function EWA_DocWordClass(){this.docks=[];this.pics=[];this.liNum=0;this.defaultFontEnglish="Century Gothic";this.defaultFontChinese="Microsoft YaHei";this.walker=function(a,b){3==a.nodeType?this.walkerTxt(a):1==a.nodeType&&this.walkerEle(a)};this.walkerEle=function(a){if("none"!=a.style.display){var b=a.tagName,c=!1;if("LI"==b){var d=this.createP(a);var e=this.getDockTable();e.appendChild(d);this.docks.push(d);c=!0;this.createLi(a)}else if("BR"==b){d=this.createBr(a);e=this.getDock();if("w:p"!=e.tagName){var g=
this.createP(a.parentNode),h=this.createSpan(a.parentNode);g.appendChild(h);g.appendChild(d);e.appendChild(g);this.docks.push(g)}else e.appendChild(d);this.lastWR=null}else if("IMG"==b)e=this.getDock(),d=this.createPic(a),"w:p"!=e.tagName?(g=this.createP(a.parentNode),h=this.createSpan(a.parentNode),g.appendChild(h),g.appendChild(d),e.appendChild(g),this.docks.push(g),c=!0,d=g):e.appendChild(d),this.lastWR=null;else if("TABLE"==b)h=this.getDockTable(),d=a.previousElementSibling,null!=d&&"TABLE"==
d.tagName&&(e=this.createPVanish(),h.appendChild(e[0])),d=this.createTable(a),null!=d&&(c=!0,h.appendChild(d),this.docks.push(d));else if("TBODY"==b)d=this.createTbody(a),this.getDock().appendChild(d);else if("TR"==b)d=this.createTr(a),this.getDock().appendChild(d),this.docks.push(d),c=!0;else if("TD"==b)d=this.createTd(a),this.getDock().appendChild(d),this.docks.push(d),c=!0;else if("HR"==b)e=this.getDockTable(),d=this.createP(a),h=this.createSpan(a),d.appendChild(h),g=this.createHr(),h.appendChild(g),
this.lastWR=null,e.appendChild(d);else if("LI"==a.parentNode.tagName||"H1"!=b&&"H2"!=b&&"H3"!=b&&"P"!=b&&"CENTER"!=b&&"DIV"!=b){if("SCRIPT"==b)return;"BODY"!=b&&"OL"!=b&&"UL"!=b&&(e=this.getDock(),d=this.createSpan(a),"w:p"!=e.tagName?(g=this.createP(a.parentNode),g.appendChild(d),e.appendChild(g),this.docks.push(g)):e.appendChild(d))}else e=this.getDockTable(),d=this.createP(a),e.appendChild(d),this.docks.push(d),c=!0;for(e=0;e<a.childNodes.length;e++)this.walker(a.childNodes[e]);c&&(this.docksPop(d),
this.lastWR=null);"TD"==b&&1==d.childNodes.length?(g=this.createEle("w:p"),d.appendChild(g)):"TABLE"==b&&null==d.nextSibling&&"w:tc"==d.parentNode.tagName&&(g=this.createEle("w:p"),d.parentNode.appendChild(g))}};this.walkerTxt=function(a){if(""!=a.nodeValue.trimEx()||-1!=a.nodeValue.indexOf("\u3000")){var b=this.createText(a),c=this.getDock();if("w:p"!=c.tagName){var d=this.createP(a.parentNode);a=this.createSpan(a.parentNode);d.appendChild(a);a.appendChild(b);c.appendChild(d);this.docks.push(d)}else this.lastWR||
(a=this.createSpan(a.parentNode),c.appendChild(a)),this.lastWR.parentNode.appendChild(b)}this.lastWR=null};this.createEle=function(a){return this.doc.XmlDoc.createElement(a)};this.createEles=function(a){a=a.split(",");for(var b=[],c=0;c<a.length;c++){var d=this.createEle(a[c].trim());b.push(d);0<c&&b[0].appendChild(d)}return b};this.createElesLvl=function(a){a=a.split(",");for(var b=[],c=0;c<a.length;c++){var d=this.createEle(a[c].trim());b.push(d);0<c&&b[c-1].appendChild(d)}return b};this.createElesSameLvl=
function(a,b){a=a.split(",");for(var c=[],d=0;d<a.length;d++){var e=this.createEle(a[d].trim());c.push(e);b.appendChild(e)}return c};this.createText=function(a){if(""!=a.nodeValue.trim()||-1!=a.nodeValue.indexOf("\u3000")){var b=a.nodeValue;if(a=0<=a.nodeValue.indexOf("\u3000")){var c=eval("/\u3000/g");b=b.replace(c,"\u3010zwer\u4e2d\uff0cwer,\u6587_\u5168`\u89d2=\u7a7a\u683cwerwe\u3011")}b=b.trim();a&&(a=eval("/\u3010zwer\u4e2d\uff0cwer,\u6587_\u5168`\u89d2=\u7a7a\u683cwerwe\u3011/g"),b=b.replace(a,
"\u3000"));a=this.createEle("w:t");EWA.B.IE?a.text=b:a.textContent=b;return a}};this.createHr=function(){var a=this.createElesLvl("w:pict,v:rect");a[0].setAttribute("w14:anchorId",this.getParaId());this.setAtts(a[1],{style:"width:.05pt;height:1pt","o:hralign":"center","o:hrstd":"t","o:hrnoshade":"t","o:hr":"t",fillcolor:"black [3213]",stroked:"f"});return a[0]};this.createLi=function(a){var b=this.createEles("w:numPr,w:ilvl,w:numId");"OL"==a.parentNode.tagName?(a==a.parentNode.getElementsByTagName("li")[0]&&
this.liNum++,b[1].setAttribute("w:val",0),b[2].setAttribute("w:val",this.liNum)):(b[1].setAttribute("w:val",0),b[2].setAttribute("w:val",22));a=this.createEle("w:spacing");a.setAttribute("w:line",270);a.setAttribute("w:lineRule","atLeast");var c=this.getDock();c.getElementsByTagName("w:pPr")[0].appendChild(b[0]);c.getElementsByTagName("w:pPr")[0].appendChild(a)};this.createSpan=function(a){var b=this.createEle("w:r");a=$(a);var c=this.createEle("w:rPr");this.lastWR=c;b.appendChild(c);if(""!=a.css("color")){var d=
this.createEle("w:color"),e=this.rgb1(a.css("color"));d.setAttribute("w:val",e);c.appendChild(d)}if(""!=a.css("font-family")){a.css("font-family").replace(/'/ig,"").split(",");d=this.createEle("w:rFonts");var g=/[\u4E00-\u9FA5]|[\uFE30-\uFFA0]/gi.test(a.text())?this.defaultFontChinese:this.defaultFontEnglish;this.setAtts(d,{"w:ascii":g,"w:eastAsia":g,"w:hAnsi":g,"w:hint":"eastAsia","w:cs":this.defaultFontEnglish});c.appendChild(d)}""!=a.css("font-size")&&(d=a.css("font-size"),g=this.fontSize(d),null!=
g&&(d=this.createEle("w:sz"),d.setAttribute("w:val",2*g),c.appendChild(d),e=this.createEle("w:szCs"),e.setAttribute("w:val",2*g),c.appendChild(e)));d=a.css("font-weight");if("B"==a.tagName||""!=d&&"normal"!=d&&"400"!=d)d=this.createEle("w:b"),c.appendChild(d);"I"==a.tagName&&(d=this.createEle("w:i"),c.appendChild(d));return b};this.createBr=function(a){a=this.createEle("w:r");var b=this.createEle("w:br");a.appendChild(b);return a};this.createTable=function(a){var b=this.createEle("w:tbl"),c=this.createEle("w:tblPr"),
d=this.createEle("w:tblStyle");d.setAttribute("w:val","a4");c.appendChild(d);d=this.createWidth(a,"tblW");c.appendChild(d);a.setAttribute("ww",d.getAttribute("w:w"));b.appendChild(c);return b};this.createTbody=function(){return this.createEle("w:tblGrid")};this.createTr=function(a){var b=this.createElesLvl("w:tr,w:trPr");this.setAtts(b[0],{"w:rsidR":"003D2D54","w14:textId":"77777777","w14:paraId":this.getParaId()});a=this.createHeight(a,"trHeight");b[1].appendChild(a);return b[0]};this.paraId=0;this.getParaId=
function(){var a="0000"+this.paraId;a=a.substring(a.length-4);this.paraId++;return"F0C0"+a};this.createTd=function(a){thisTr=a.parentNode;var b=thisTr.parentNode.parentNode,c=a.getAttribute("vmerge"),d=0;if(null!=c&&""!=c){var e=this.createEle("w:tc"),g=this.createEle("w:tcPr"),h=this.createEle("w:vMerge");g.appendChild(h);e.appendChild(g);this.getDock().appendChild(e);d=this.createEle("w:p");e.appendChild(d);e=c.split(",");e=b.rows[e[0]].cells[e[1]];g.appendChild(this.createTdBorders(e));d=1*e.getAttribute("wwtd")}e=
this.createEle("w:tc");g=this.createEle("w:tcPr");e.appendChild(g);if(1<a.rowSpan)for(h=this.createEle("w:vMerge"),h.setAttribute("w:val","restart"),g.appendChild(h),h=0;h<a.rowSpan-1;h++)(c=b.rows[h+1+thisTr.rowIndex])&&(c=c.cells[a.cellIndex])&&c.setAttribute("vmerge",thisTr.rowIndex+","+a.cellIndex);1<a.colSpan&&(b=this.createEle("w:gridSpan"),b.setAttribute("w:val",a.colSpan),g.appendChild(b));g.appendChild(this.createTdBorders(a));h=this.createWidth(a,"tcW");c=a.parentNode;b=c.getAttribute("wwtr");
if(null==b||""==b)b=c.parentNode.parentNode,b=b.getAttribute("ww");var k=h.getAttribute("w:w");a!=a.parentNode.cells[a.parentNode.cells.length-1]?(a.setAttribute("wwtd",k),c.setAttribute("wwtr",1*b-1*k-d)):(h.setAttribute("w:w",0),h.setAttribute("w:type","auto"));g.appendChild(h);a=$(a).css("vertical-align");"middle"==a?(a=this.createEle("w:vAlign"),a.setAttribute("w:val","center"),g.appendChild(a)):"bottom"==a&&(a=this.createEle("w:vAlign"),a.setAttribute("w:val","bottom"),g.appendChild(a));return e};
this.createWidth=function(a,b){b=this.createEle("w:"+b);a=15*$(a).width();b.setAttribute("w:w",a);b.setAttribute("w:type","dxa");return b};this.createHeight=function(a,b){b=this.createEle("w:"+b);a=15*$(a).height();b.setAttribute("w:val",a);return b};this.createTdBorders=function(a){for(var b=this.createEle("w:tcBorders"),c=0;c<this.EWA_DocTmp.borders.length;c++){var d=this.createBorder(a,this.EWA_DocTmp.borders[c]);b.appendChild(d)}return b};this.createBorder=function(a,b){var c=$(a).css("border-"+
b+"-width"),d=this.createEle("w:"+b);"0px"==c?d.setAttribute("w:val","nil"):(d.setAttribute("w:val","single"),a=$(a).css("border-"+b+"-color"),a=this.rgb1(a),d.setAttribute("w:color",a),d.setAttribute("w:sz",6));return d};this.createPVanish=function(){return this.createElesLvl("w:p,w:pPr,w:rPr,w:vanish")};this.createP=function(a){var b=this.createEle("w:p"),c=this.createEle("w:pPr");b.appendChild(c);c=this.createElesSameLvl("w:pStyle,w:jc",c);var d=c[1],e=$(a).css("text-align");e=null==e?"":e;0<=
e.indexOf("center")?d.setAttribute("w:val","center"):0<=e.indexOf("right")?d.setAttribute("w:val","right"):d.setAttribute("w:val","left");d=c[0];d.setAttribute("w:val","a");0==a.tagName.indexOf("H")&&d.setAttribute("w:val",a.tagName.replace("H",""));this.createElesLvl("w:rFonts",c[2])[0].setAttribute("w:hint","eastAsia");this.lastWR=null;this.setAtts(b,{"w:rsidR":"003D2D54","w14:textId":"77777777","w14:paraId":this.getParaId(),"w:rsidRDefault":"0057281A"});return b};this.createPic=function(a){var b=
$(a),c=a.src;this.pics.push(a.src);a=c.lastIndexOf("/");c=c.substring(a+1);a=this.px2emu(b.width());b=this.px2emu(b.height());var d=this.createElesLvl("w:r,w:rPr,w:noProof")[0],e=this.createElesLvl("w:drawing,wp:inline,wp:extent");d.appendChild(e[0]);wExtent=e[2];this.setAtts(wExtent,{cx:a,cy:b});e=e[1];this.setAtts(e,{distT:"0",distB:"0",distL:"0",distR:"0"});var g=this.createElesSameLvl("wp:effectExtent,wp:docPr,wp:cNvGraphicFramePr",e);this.setAtts(g[0],{l:"0",t:"0",r:"0",b:"0"});this.setAtts(g[1],
{id:"0",name:c});var h=this.createEleNs("a:graphicFrameLocks","http://schemas.openxmlformats.org/drawingml/2006/main");g[2].appendChild(h);this.setAtts(h,{noChangeAspect:1});g=this.createEleNs("a:graphic","http://schemas.openxmlformats.org/drawingml/2006/main");h=this.createEle("a:graphicData");h.setAttribute("uri","http://schemas.openxmlformats.org/drawingml/2006/picture");var k=this.createEleNs("pic:pic","http://schemas.openxmlformats.org/drawingml/2006/picture");g.appendChild(h);h.appendChild(k);
e.appendChild(g);e=this.createElesSameLvl("pic:nvPicPr,pic:blipFill,pic:spPr",k);this.setAtts(e[1],{rotWithShape:"1"});this.setAtts(e[2],{bwMode:"auto"});g=this.createElesSameLvl("pic:cNvPr,pic:cNvPicPr",e[0]);this.setAtts(g[0],{id:"0",name:c});g=this.createElesSameLvl("a:blip,a:srcRect,a:stretch",e[1]);this.setAtts(g[0],{"r:embed":"pic"+(this.pics.length-1)});this.setAtts(g[1],{l:"0",t:"0",r:"0",b:"0"});c=this.createEles("a:extLst,a:ext");g[0].appendChild(c[0]);c[1].setAttribute("uri","{28A0092B-C50C-407E-A947-70E740481C1C}");
g=this.createEleNs("a14:useLocalDpi","http://schemas.microsoft.com/office/drawing/2010/main");g.setAttribute("val",0);c[1].appendChild(g);c=this.createElesSameLvl("a:xfrm,a:prstGeom,a:ln,a:extLst",e[2]);this.setAtts(c[1],{prst:"rect"});e=this.createElesSameLvl("a:off,a:ext",c[0]);this.setAtts(e[0],{x:0,y:0});this.setAtts(e[1],{cx:a,cy:b});this.createElesSameLvl("a:avLst",c[1]);this.createElesSameLvl("a:noFill",c[2]);return d};this.createEleNs=function(a,b){return this.doc.XmlDoc.createElementNS(b,
a)};this.setAtts=function(a,b){for(var c in b)a.setAttribute(c,b[c])};this.fontSize=function(a){0<a.indexOf("px")&&(a=this.EWA_DocTmp.f[a],a=null==a?"9pt":a);return a.replace("pt","")};this.rgb1=function(a){a=a.replace("rgb(","").replace(")","").split(",");return this.rgb(1*a[0],1*a[1],1*a[2]).toUpperCase()};this.rgb=function(a,b,c){a=a.toString(16);b=b.toString(16);c=c.toString(16);return(2>a.length?"0":"")+a+(2>b.length?"0":"")+b+(2>c.length?"0":"")+c};this.init=function(){this.doc=new EWA_XmlClass;
this.doc.LoadXml(this.EWA_DocTmp.document);EWA.B.IE?this.docks.push(this.doc.XmlDoc.getElementsByTagName("w:body")[0]):this.docks.push(this.doc.XmlDoc.childNodes[0].childNodes[0])};this.getDock=function(){return this.docks[this.docks.length-1]};this.idx=0;this.docksPop=function(a){for(;1!=this.docks.length&&this.docks.pop()!=a;);};this.getDockTable=function(){for(var a=this.docks.length-1;0<=a;a--){var b=this.docks[a];if("w:body"==b.tagName||"w:tc"==b.tagName)return b}};this.px2emu=function(a){return parseInt(a/
...
function EWA_OdtDocWordClass(){this.docks=[];this.pics=[];this.liNum=0;this.start=!1;this.defaultFontEnglish="Century Gothic";this.defaultFontChinese="Microsoft YaHei";this.walker=function(a){this.fixTable();this.walker1(a);this.unFixTable()};this.walker1=function(a){3==a.nodeType?this.walkerTxt(a):1==a.nodeType&&this.walkerEle(a)};this.walkerEle=function(a){if("none"!=a.style.display)if("pp"==a.id&&"CENTER"==a.tagName)console.log("skip->",a.outerHTML);else{var b=a.tagName,c=!1;if("DIV"==b&&(0<=a.className.indexOf("page-next-before")||
0<=a.className.indexOf("page-next-after"))){var d=this.createBreak();b=this.docks[0];console.log("break",d);b.appendChild(d);c=!0}else if("UL"==b||"OL"==b)d=this.createUl(a),b=this.getDockTable(),b.appendChild(d),this.docks.push(d),c=!0;else if("LI"==b)d=this.createLi(a),b=this.getDock(),b.appendChild(d),this.docks.push(d),c=!0;else if("BR"==b){d=this.createBr(a);b=this.getDock();if("text:p"!=b.tagName){var e=this.createP(a.parentNode);this.docks.push(e);e.appendChild(d)}else b.appendChild(d);this.lastWR=
null}else if("IMG"==b)b=this.getDock(),console.log(b),d=this.createPic(a),"text:p"!=b.tagName?(e=this.createP(a.parentNode),e.appendChild(d),b.appendChild(e),this.docks.push(e),c=!0,d=e):b.appendChild(d),this.lastWR=null;else if("TABLE"==b)b=this.getDockTable(),d=this.createTable(a),c=!0,b.appendChild(d),this.docks.push(d);else if("TBODY"!=b)if("TR"==b)d=this.createTr(a),this.getDock().appendChild(d),this.docks.push(d),c=!0;else if("TD"==b){d=this.createTd(a);this.getDock().appendChild(d);if("table:covered-table-cell"==
d.tagName)return;this.docks.push(d);c=!0}else if("HR"==b){b=this.getDockTable();d=this.createP(a);e=this.createSpan(a);d.appendChild(e);var g=this.createHr();e.appendChild(g);this.lastWR=null;b.appendChild(d)}else if("H1"==b||"H2"==b||"H3"==b||"P"==b||"CENTER"==b||"DIV"==b)b=this.getDockTable(),d=this.createP(a),b.appendChild(d),this.docks.push(d),c=!0;else if("SCRIPT"==b)return;for(b=0;b<a.childNodes.length;b++)this.walker1(a.childNodes[b]);c&&(this.docksPop(d),this.lastWR=null)}};this.walkerTxt=
function(a){if(""==a.nodeValue.trimEx()&&-1==a.nodeValue.indexOf("\u3000"))this.lastWR=null;else{var b=this.createSpan(a.parentNode),c=a.nodeValue.replace(/\u00a0/ig," ");if("TD"==a.parentNode.tagName||"P"==a.parentNode.tagName){var d=0<=a.nodeValue.indexOf("\u3000");if(d){var e=eval("/\u3000/g");c=c.replace(e,"\u3010zwer\u4e2d\uff0cwer,\u6587_\u5168`\u89d2=\u7a7a\u683cwerwe\u3011")}c=c.trim();d&&(d=eval("/\u3010zwer\u4e2d\uff0cwer,\u6587_\u5168`\u89d2=\u7a7a\u683cwerwe\u3011/g"),c=c.replace(d,"\u3000"))}EWA.B.IE?
b.text=c:b.textContent=c;c=this.getDock();"text:p"!=c.tagName?(a=this.createP(a.parentNode),a.appendChild(b),c.appendChild(a),this.docks.push(a)):c.appendChild(b)}};this.fixTable=function(){for(var a=$("td[colspan]").toArray(),b=0;b<a.length;b++){var c=a[b],d=c.parentNode,e=c.colSpan;c.setAttribute("m_colspan",e);for(var g=0;g<e-1;g++){var h=d.insertCell(c.cellIndex+g+1);h.innerHTML=g;h.bgColor="blue";h.className="colspan";h.setAttribute("fixed","1");h.style.display="none"}}$("td[rowspan]").each(function(){for(var k=
this.rowSpan,l=this.parentNode,m=l.parentNode.parentNode,n=0;n<k-1;n++){var p=m.rows[l.rowIndex+n+1].insertCell(this.cellIndex);p.innerHTML=n;p.bgColor="green";p.className="rowspan";p.setAttribute("fixed","1")}$(this).attr("m_rowspan",k);this.rowSpan=""})};this.unFixTable=function(){$("td[fixed]").each(function(){this.parentNode.removeChild(this)});$("td[m_colspan]").each(function(){this.colSpan=this.getAttribute("m_colspan")});$("td[m_rowspan]").each(function(){this.rowSpan=this.getAttribute("m_rowspan")})};
this.createEle=function(a){return this.doc.XmlDoc.createElement(a)};this.createEles=function(a){a=a.split(",");for(var b=[],c=0;c<a.length;c++){var d=this.createEle(a[c].trim());b.push(d);0<c&&b[0].appendChild(d)}return b};this.createElesLvl=function(a){a=a.split(",");for(var b=[],c=0;c<a.length;c++){var d=this.createEle(a[c].trim());b.push(d);0<c&&b[c-1].appendChild(d)}return b};this.createElesSameLvl=function(a,b){a=a.split(",");for(var c=[],d=0;d<a.length;d++){var e=this.createEle(a[d].trim());
c.push(e);b.appendChild(e)}return c};this.createHr=function(){var a=this.createElesLvl("w:pict,v:rect");a[0].setAttribute("w14:anchorId",this.getParaId());this.setAtts(a[1],{style:"width:.05pt;height:1pt","o:hralign":"center","o:hrstd":"t","o:hrnoshade":"t","o:hr":"t",fillcolor:"black [3213]",stroked:"f"});return a[0]};this.createUl=function(a){var b=this.createEle("text:list");b.setAttribute("text:style-name","OL"==a.tagName?"L1":"L2");return b};this.createLi=function(a){return this.createEle("text:list-item")};
...
(this.pics.length-1)+"]}"});return a[0]};this.createEleNs=function(a,b){return this.doc.XmlDoc.createElementNS(b,a)};this.setAtts=function(a,b){for(var c in b)a.setAttribute(c,b[c])};this.fontSize=function(a){0<a.indexOf("px")&&(a=this.EWA_DocTmp.f[a],a=null==a?"9pt":a);return a.replace("pt","")};this.rgb1=function(a){a=a.replace("rgb(","").replace(")","").split(",");return this.rgb(1*a[0],1*a[1],1*a[2]).toUpperCase()};this.rgb=function(a,b,c){a=a.toString(16);b=b.toString(16);c=c.toString(16);return(2>
a.length?"0":"")+a+(2>b.length?"0":"")+b+(2>c.length?"0":"")+c};this.init=function(){this.doc=new EWA_XmlClass;this.doc.LoadXml(this.EWA_DocTmp.document);var a=this.doc.XmlDoc.getElementsByTagName("text");0==a.length&&(a=this.doc.XmlDoc.getElementsByTagName("office:text"));this.docks.push(a[0])};this.getDock=function(){return this.docks[this.docks.length-1]};this.idx=0;this.docksPop=function(a){for(;1!=this.docks.length&&this.docks.pop()!=a;);};this.getDockTable=function(){for(var a=this.docks.length-

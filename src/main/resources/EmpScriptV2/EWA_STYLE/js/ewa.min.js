...
$(this).text();"ALL"!=w&&$(this).attr("ids",k[w].join(","));$(this).on("click",function(){if("ALL"==$(this).text())$(a).find("nobr.ewa-filter-chk").show();else{var y=$(this).attr("ids").split(","),z={},A;for(A in y)z[y[A]]=1;$(a).find("input.ewa-filter-chkbox").each(function(){this.checked||z[this.id]?$(this).parent().show():$(this).parent().hide()})}})})}};this.hiddenNoContentRow=function(){this.getObj(".EWA_TD_M").each(function(){if(""==$(this).text()&&0==$(this).find("img,a,input[type=text],input[type=button],textarea").length){$(this).parent().hide();
var a=$(this).find("*:eq(0)").attr("id");a&&tb.find(".ewa-row-"+a).hide().attr("hiddennocontentrow",1)}})};this.itemReload=function(a,b,c){if(a){var d=new EWA_UrlClass(this.Url);d.AddParameter("EWA_AJAX","SELECT_RELOAD");d.AddParameter("EWA_RELOAD_ID",a);this.getObj("input,select").each(function(){this.name!=a&&100>this.value.length&&d.AddParameter(this.name,this.value)});for(var e=d.GetUrl(),g=this.getObj("#"+a)[0],h={},k=0;k<g.options.length;k++)h[g.options[k].value]=1;$J(e,function(l){if(l.RST){var m=

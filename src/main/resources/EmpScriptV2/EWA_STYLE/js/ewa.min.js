...
n=m+" 23:59:59";else if("fix"==l){var r=null;p.find("option").each(function(){this.text==m&&(r=this.value)});m=null===r?"":r}p.val()==m?("text"==l&&e&&0<q.length&&(q.attr("tag",e.Id),q.html("enus"==EWA.LANG?e.TxtEn:e.Txt)),p.val("")):("text"==l&&d&&0<q.length&&(q.attr("tag",d.Id),q.html("enus"==EWA.LANG?d.TxtEn:d.Txt)),p.val(m),"date"==l&&(p[1].value=n))}),b.each(function(){$(this).text()&&$(this).addClass("ewa-lf-search-text-click").attr("search_tag",k.T)}))}};this.ReShowWithNoButtons=function(){var a=
...
F=C.parentNode.parentNode.previousSibling.offsetHeight;C.style.top=F+"px";C.style.height=E.H-F+"px"},100),addEvent(window,"resize",function(){var C=$X(b),E=EWA.UI.Utils.GetDocSize(window),F=C.parentNode.parentNode.previousSibling.offsetHeight;C.style.top=F+"px";C.style.height=E.H-F+"px"}));for(;0<a.childNodes.length;)m.childNodes[0].appendChild(a.childNodes[0]);d=d.find(".ewa_lf_func_caption")[0];var p=!1;e=GetInnerText(m);e=e.trim();this._ReshowButs={};g=$(g.rows[0]);for(var q in this.ItemList.Items){var r=
this.ItemList.Items[q],t=this._GetSubValue("Tag","Tag",r);if(t&&("button"==t.toLowerCase()||"butflow"==t.toLowerCase())&&(t=this._GetSubValue("Name","Name",r),0!==g.find(".ewa-col-"+t).length)){p=!0;var u=this._GetSubValue("DescriptionSet","Info",r),w=this._GetSubValue("DescriptionSet","Memo",r),v=this._GetSubValue("EventSet","EventName",r),x="";null!=v&&"ewa_click"==v.toLowerCase().trim()&&(x=this._GetSubValue("EventSet","EventValue",r));e=e.replace(u,"");r=this._ReShowButton(u,w,null);this._ReshowButs[u]=
r;r.setAttribute("f_id",this._Id);r.setAttribute("t_id",t);m.childNodes[1].appendChild(r);""==x?r.setAttribute("onclick","EWA.F.FOS['"+this._Id+"'].reShowButtonClick(this)"):r.setAttribute("onclick",x)}}p&&this._ReShowSplit(m.childNodes[1]);t=m.getElementsByTagName("input");p={};for(g=0;g<t.length;g++){var y=t[g];y.style.display="none";if(null==y.id||""==y.id)y.id=("_tmp_"+Math.random()).replace(".","_");if("button"==y.type){if(r=this._ReShowButton(y.value,y.title,y.id),u=y.nextSibling){var z="";
3==u.nodeType&&(z=u.nodeValue.trimEx());"|"==z&&this._ReShowSplit(m.childNodes[1])}}else(u=y.nextSibling)&&(z=3==u.nodeType?u.nodeValue.replace("|",""):u.innerHTML),r=this._ReShowButton(z.trimEx(),y.title,y.id),r.id=("_tmp_"+Math.random()).replace(".","_"),p[y.name]||(p[y.name]=[]),p[y.name].push(r.id);m.childNodes[1].appendChild(r)}e=e.replace(/ /ig,"").replace(/\|/ig,"").trimEx();""!=e?0<=e.indexOf("if")?k.style.display="none":l.innerHTML=e.replace(/ /,""):k.style.display="none";a.appendChild(h);
for(q in p)for(z=p[q],g=0;g<z.length;g++)y=$X(z[g]),y.setAttribute("_r_ids",z.join(",")),y.onclick=function(){var C=this.getAttribute("_ewa_event_id");$X(C).click();C=this.getAttribute("_r_ids").split(",");for(var E=0;E<C.length;E++)y.id!=C[E]&&($X(C[E]).style.fontWeight="",$X(C[E]).style.color="");this.style.fontWeight="bold";this.style.color="blue"};d.innerHTML='<b><i class="fa fa-star-o">&nbsp;</i>'+this.Description+"</b>";if(0<this.Url.toUpperCase().indexOf("EWA_BTNS_IN_TITLE"))var A=this,B=0,
...
$J2MAP(this.RESOURCES.search_text_items,"Id");g=this._GetInitSearchMap();var n=!1,p=!1;for(h in this.ItemList.Items)if(null!=this._SearchJson[h]){var q=[],r=this._SearchJson[h],t=r.T,u=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[h]);q.push("<table class='ewa-lf-search-item ewa-ref-"+h+" ewa-lf-search-type-"+t+" "+("fix"==t?"ewa-lf-search-fix-m"+(r.M||"0"):"")+"' cellspacing=0 cellpadding=0>");q.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");
q.push(u);var w=u="",v="lk";g[h.toUpperCase()]&&(w=g[h.toUpperCase()],v=w.tag,u=w.para1,w=w.para2);var x="";"text"==t?(p=m[v]||m.lk,x="enus"==EWA.LANG?p.TxtEn:p.Txt,q.push("<a class='ewa-lf-search-type' tag='"+v+"' href='javascript:void(0)' onclick='"+k+"'>"),q.push(x),q.push("</a>"),p=!0):"date"==t&&(q.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+l+"'></a>"),n=!0);q.push("</b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==t?"blk"==v||"nblk"==v?(r=this._SearchSingle(h,
x),r=r.replace("<input","<input disabled "),q.push(r)):q.push(this._SearchSingle(h,u)):"date"==t?q.push(this._SearchDate(h,u,w)):"number"==t?q.push(this._SearchNumber(h,u,w)):"fix"==t&&(r="<div >"+this._SearchFix(h,r,"span",u)+"</div>",q.push(r));q.push("</td></tr></table>");"fix"==t&&this._IsSearchGroup?d.push(q.join("")):e.push(q.join(""))}if(0!=e.length+d.length){b.push('<table class="ewa-lf-search-main" id="'+a+'" cellspacing="0" cellpadding="0">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");
0<e.length&&b.push(" "+e.join("")+" ");for(e=0;e<d.length;e++)b.push(" "+d[e]+" ");b.push("</td></tr></table>");var y=document.createElement("div");this._SEARCH_BOX=y;y.className="ewa-lf-search";y.innerHTML=b.join("");b=$X("EWA_LF_"+this.Id).parentNode;b.parentNode.insertBefore(y,b);a="EWA_SEARCH_ITEM_"+this.Id;var z=this;n&&this._SearchCreateDateRange();p&&this._SearchCreateTextType();z._SEARCH_ITEM_EXP=this.SearchGetExp(y);"{}"!=JSON.stringify(g)&&(z._SearchExp=z._SEARCH_ITEM_EXP);$(y).find("input[type=text]").on("compositionstart",
function(){z._is_search_composition=!0}).on("compositionend",function(){z._is_search_composition=!1});this._TIMER_SEARCH=window.setInterval(function(){if(!z._is_search_composition){try{if(!$X(a)){window.clearInterval(z._TIMER_SEARCH);return}}catch(B){window.clearInterval(z._TIMER_SEARCH);return}var A=z.SearchGetExp(y);A!=z._SEARCH_ITEM_EXP&&(z._SEARCH_ITEM_EXP=A,z.DoSearch($X(a)))}},700)}};this._SearchSingle=function(a,b){var d=[];d.push('<input t="text" type="text" autocomplete="off" class="EWA_INPUT" maxlength="40" name="');

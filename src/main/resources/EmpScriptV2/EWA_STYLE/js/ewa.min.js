...
c.parentNode,e=c.parentNode.parentNode.childNodes[1];if(null==e)return;0==e.childNodes.length?(this._LastCkObj&&(this._LastCkObj.style.backgroundColor=""),d.style.backgroundColor="#ccc",this._LastCkObj=d):(e.style.display="none"==e.style.display?"":"none",window.event?b.cancelBubble=!0:b.stopPropagation())}else if(""==c.getAttribute("EWA_MF_PID")&&(this._HiddenDialogs(),0>=this.Dialogs.length&&this.Dialogs.push(this._CreateDialog()),0<this._ShowPullDownMenu(c,this.Dialogs[0]))){this.ShowByObject(c,
this.Dialogs[0],0);return}this.Click(b,c)};this._CalcLevel=function(b){for(var c=0;""!=b.getAttribute("EWA_MF_PID");)if(c+=1,b=document.getElementById(b.getAttribute("EWA_MF_PID")),null==b)return null;return c};this._ShowPullDownMenu=function(b,c){for(var d=$X(c.FrameContent).childNodes[0].rows[0].cells[0];0<d.childNodes.length;)this._ItemsDiv.appendChild(d.childNodes[0]);for(var e=[],g=0;g<this._ItemsDiv.childNodes.length;g++){var h=this._ItemsDiv.childNodes[g];0<h.innerHTML.toUpperCase().indexOf("<HR")||
(h.style.paddingRight="10px");h.getAttribute("EWA_MF_PID")==b.id&&e.push(h)}b=e.length;for(g=0;g<e.length;g++){d.appendChild(e[g]);if(this._CheckChildren(e[g].id)){h=e[g].childNodes[0].rows[0].cells[2];if(null==h.getAttribute("gdx")||""==h.getAttribute("gdx"))h.innerHTML+=" +",h.setAttribute("gdx","gdx");e[g].setAttribute("EWA_MF_CHILD","1")}else e[g].setAttribute("EWA_MF_CHILD","0");e[g]=null}e.length=0;$X(c.FrameContent).childNodes[0].style.height="auto";return b};this._CheckChildren=function(b){for(var c=
0;c<this._ItemsDiv.childNodes.length;c++)if(this._ItemsDiv.childNodes[c].getAttribute("EWA_MF_PID")==b)return!0;return!1};this.InstallMenus=function(b,c,d){if("METRO"==d){var e=[],g={};$(".ewa_menu_m").each(function(){var m=$(this),n={};n.id=m.attr("id");n.pid=m.attr("EWA_MF_PID");n.url=m.attr("EWA_CMD");n.icon=m.find(".ewa_menu_m0").attr("class");n.title=m.text().trim();n.icon&&(n.icon=n.icon.replace("ewa_menu_m0","").trim());""==n.pid?(n.pid="0",n.subs=[],g[n.id]=n,e.push(n)):g[n.pid].subs.push(n)});
EWA_UI_Metro.menus=e;EWA_UI_Metro.add_menus(e,"EWA_FRAME_MAIN","item",null,null,!0)}else{this.MenuShowType=d;d=$X(b);var h=$X(c);if(null==h)alert("MenuShow defined error ("+c+")");else{this._ItemsDiv=d;c=[];h.innerHTML="<table onselectstart='return false' style='cursor:pointer;-moz-user-select:none;' border=0 cellspacing=0 cellpadding=0></table>";h=h.childNodes[0];for(var k=0;k<d.childNodes.length;k++){var l=d.childNodes[k];"DIV"==l.tagName&&""==l.getAttribute("EWA_MF_PID")&&c.push(l)}if(""==this.MenuShowType||
"TOP"==this.MenuShowType)for(h.insertRow(-1),k=0;k<c.length;k++)h.rows[0].insertCell(-1).appendChild(c[k]);else h.style.width="100%",this._InstallMenusLeft(h,d,c,b);c.length=0;c=null}}};this._InstallMenusLeft=function(b,c,d,e){for(var g=0;g<d.length;g++){var h=b.insertRow(-1).insertCell(-1);e=document.createElement("div");e.innerHTML='<div class="ewa_lmenu_bar" des="rq1"></div><div  des="rq2"></div>';e.childNodes[1].style.paddingLeft="5px";h.appendChild(e);d[g].style.height="100%";e.childNodes[0].appendChild(d[g]);
0<g&&(e.childNodes[1].style.display="none")}for(b=c.childNodes;0<c.childNodes.length;)d=b[0],g=d.getAttribute("EWA_MF_PID"),e=document.createElement("div"),e.innerHTML='<div class="ewa_lmenu_bar1"></div><div style="padding-left:4px;display:none"></div>',$X(g).parentNode.parentNode.childNodes[1].appendChild(e),e.childNodes[0].appendChild(d)};this._CreateDialog=function(){var b=new EWA_UI_DialogClass;b.Create();b.SetHtml("<table class='ewa_menu_down' border=0 width=100 cellspacing=0 cellpadding=0 onmousemove='window."+
...
this.ClassName+".IsOut=false;' onmouseout='window."+this.ClassName+".IsOut=true; var t1=new Date().getTime(); if(t1-$(this).attr(&quot;open_time&quot;)>1000){ window.setTimeout(function(){var a=window."+this.ClassName+";a.AutoHidden(this);},1410);}'  onselectstart='return false' style='width:120px;cursor:pointer;-moz-user-select:none;'>");for(var d=0;d<b.length;d+=1){var e=b[d];c.push("<div class='ewa_menu_m' EWA_MG=\""+e.Group+"\" style='cursor:pointer' EWA_CMD=\""+e.Cmd+"\" onclick='"+this.ClassName+
".Click(event,this);' onmouseover='"+this.ClassName+".MouseOver(this);'><table boder=0 width=100% cellpadding=0 cellspacing=0>");0<=e.Txt.toUpperCase().indexOf("<HR")?c.push("<tr><td colspan=2 style='white-space:nowrap'>"+e.Txt+"</td></tr></table></div>"):(c.push("<tr><td class='ewa_menu_m0'>"),e=b[d].Img,null!=e&&0>e.indexOf("index=0,size=0")&&0<e.trim().length&&(0<=e.indexOf("fa")?c.push('<i class="'+e+'"></i>'):c.push('<img src="'+b[d].Img+'">')),c.push("</td><td class='ewa_menu_m1' style='white-space:nowrap'>"+
b[d].Txt+"</td></tr></table></div>"))}c.push("</div>");this.Dialog.SetHtml(c.join(""))}};this.HiddenMemu=function(){this.Dialog.Show(!1);EWA.UI.CurMenu=null};this.ShowByObject=function(b,c,d){var e=EWA.UI.Utils.GetPosition(b);this.SHOW_BY_OBJECT=b;c=c||this.Dialog;null==d||0==d?c.Move(e.X,e.Y):c.Move(e.X+b.offsetWidth-5,e.Y-b.offsetHeight+4);c.Show(!0);$(c.GetFrame()).find(".ewa_menu_box").attr("open_time",(new Date).getTime());c.ResizeByContent()};this.ShowByMouse=function(b,c){if(this.Dialog){var d=
0,e=$X(this.Dialog.FrameContent).childNodes[0];if(null==c)d=e.childNodes.length;else for(var g=0;g<e.childNodes.length;g++)e.childNodes[g].getAttribute("EWA_MG")==c||null==c||""==c?(e.childNodes[g].style.display="",d++):e.childNodes[g].style.display="none";0<d?(c=b.x?b.x:b.pageX,b=b.y?b.y:b.pageY,b+=document.body.scrollTop,c+=document.body.scrollLeft,this.Dialog.Move(c,b),this.Dialog.Show(!0),this.Dialog.ResizeByContent()):this.Dialog.Show(!1)}};this.MouseOver=function(b){null!=this._LastObj&&("LEFT"==
this.MenuShowType?this._LastObj.parentNode.className=this._LastObj.parentNode.className.replace("_mv",""):this._LastObj.className=this._LastObj.className.replace("_mv1",""));if("LEFT"==this.MenuShowType)this._LastObj=b,this._LastObj.parentNode.className+="_mv";else{this._LastObj=b;this.IsOut=!1;this._LastObj.className+="_mv1";null==EWA.UI.CurMenu&&(EWA.UI.CurMenu=this);var c=this._CalcLevel(b);"1"==b.getAttribute("EWA_MF_CHILD")&&(this.Dialogs.length<=c&&this.Dialogs.push(this._CreateDialog()),this._ShowPullDownMenu(b,
this.Dialogs[c]),this.ShowByObject(b,this.Dialogs[c],c))}};this._HiddenDialogs=function(){null!=this.Dialog&&this.Dialog.Show(!1);for(var b=0;b<this.Dialogs.length;b++){this.Dialogs[b].Show(!1);for(var c=$X(this.Dialogs[b].FrameContent).childNodes[0].rows[0].cells[0];0<c.childNodes.length;)this._ItemsDiv.appendChild(c.childNodes[0])}};this._InitEvent=function(){"LEFT"!=this.MenuShowType&&(EWA.B.IE?document.body.attachEvent("onclick",function(){"undefined"!=typeof EWA.UI.CurMenu&&EWA.UI.CurMenu._HiddenDialogs()}):

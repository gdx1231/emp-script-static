...
function _$J_SELECT(a,b,d,e,g,h,k,l){function m(w,v){var y=w[d],x=b.options[b.options.length]=new Option(y,w[e]);if(v){for(var z=[],A=0;A<v;A++)z.push("");z.push(y);z.join("\u3000")}for(var C in w)w[C]&&x.setAttribute("para_"+C.toLowerCase(),w[C]);x.setAttribute("json",JSON.stringify(w));return x}b.options.length=0;g&&(b.options[0]=new Option("",""),g instanceof Array&&(b.options[0].text=g[0],b.options[0].value=g[1]));if(l){var n=function(w,v){if((w=p[w])&&w._children&&0!=w._children.length)for(var y,
x=0;x<w._children.length;x++)y=w._children[x],m(y,v),n(y[e],v+1)},p={___ROOT___:[]};g={___ROOT___:{}};for(var q,u,r,t=0;t<a.length;t++){r=a[t];q=r[l];u=r[e];if(null===q||""===q||"0"===q)q="___ROOT___";p[q]||(p[q]=[]);p[q].push(r);g[u]=r;g[q]&&(g[q]._children||(g[q]._children=[]),g[q]._children.push(r))}n("___ROOT___",0)}else for(t=0;t<a.length;t++)r=a[t],m(r);h&&(b.value=h);$(b).trigger("change");k&&k(b)}
$Install=function(a,b,d,e){var g=new EWA_UrlClass;g.SetUrl(a);g.GetParameter("EWA_AJAX")||(a=g.AddParameter("EWA_AJAX","INSTALL"));(new EWA_AjaxClass).Install(a,"",b,d,e)};
...
g+=h;var q=[];if("number"===typeof n.length&&!n.propertyIsEnumerable("length")){var u=n.length;for(m=0;m<u;m+=1)q[m]=d(m,n)||"null";var r=0===q.length?"[]":g?"[\n"+g+q.join(",\n"+g)+"\n"+p+"]":"["+q.join(",")+"]";g=p;return r}if("object"===typeof l)for(u=l.length,m=0;m<u;m+=1){var t=l[m];"string"===typeof t&&(r=d(t,n,l))&&q.push(b(t)+(g?": ":":")+r)}else for(t in n)(r=d(t,n,l))&&q.push(b(t)+(g?": ":":")+r);r=0===q.length?"{}":g?"{\n"+g+q.join(",\n"+g)+"\n"+p+"}":"{"+q.join(",")+"}";g=p;return r}}
...
"number"===typeof n.length)l=n;else throw Error("JSON.stringify");else l=function(u,r){if(Object.hasOwnProperty.call(this,u))return r};return d("",{"":m})},parse:function(m,n){function p(q,u){var r,t=q[u];if(t&&"object"===typeof t)for(r in t)if(Object.hasOwnProperty.call(t,r)){var w=p(t,r);void 0!==w?t[r]=w:delete t[r]}return n.call(q,u,t)}if(/^[\],:{}\s]*$/.test(m.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,
...
a.childNodes.length;b+=1)EWA$UI$COMMON.Dispose(a.childNodes[b])}},Drop:function(a){EWA$UI$COMMON.Dispose(a);a.parentNode.removeChild(a)},AniExpand:function(a,b,d,e,g){if(null==e||0>=e)e=10;var h=0,k=b/(1*e),l=d/(1*e),m=a.clientWidth+b,n=a.clientHeight+d,p=window.setInterval(function(){var q=EWA$UI$COMMON.GetObjSize(a);if(h<e-1){var u=q.H+l,r=q.W+k;u>n&&(u=n);r>m&&(r=m);EWA$UI$COMMON.SetSize(a,r,u)}else EWA$UI$COMMON.SetSize(a,m,n);r=EWA$UI$COMMON.GetObjSize(a);u=r.W-q.W;r=r.H-q.H;q=EWA$UI$COMMON.GetPosition(a);
q.Y=q.Y-a.clientHeight-1*a.style.borderTopWidth.replace("px","")-1*a.style.borderBottomWidth.replace("px","");"LEFT_TOP"!=g&&("LEFT_BOTTOM"==g?(r=q.Y-r,u=q.X,EWA$UI$COMMON.MoveTo(a,u,r)):"RIGHT_TOP"==g?(r=q.Y,u=q.X-u,EWA$UI$COMMON.MoveTo(a,u,r)):"RIGHT_BOTTOM"==g?(r=q.Y-r,u=q.X-u,EWA$UI$COMMON.MoveTo(a,u,r)):(r=1*q.Y-r/2,u=1*q.X-u/2,EWA$UI$COMMON.MoveTo(a,u,r),EWA._TmpAniObj=a));h++;h>=e&&(window.clearInterval(p),EWA.UI.Utils.AniExpandCompleateFunction&&(EWA.UI.Utils.AniExpandCompleateFunction(),
...
g.innerHTML='<div class="ewa_lmenu_bar" des="rq1"></div><div  des="rq2"></div>';g.childNodes[1].style.paddingLeft="5px";k.appendChild(g);e[h].style.height="100%";g.childNodes[0].appendChild(e[h]);0==h?$(g).addClass("ewa-lmenu-show"):g.childNodes[1].style.display="none"}for(b=d.childNodes;0<d.childNodes.length;)e=b[0],h=e.getAttribute("EWA_MF_PID"),g=document.createElement("div"),g.innerHTML='<div class="ewa_lmenu_bar1"></div><div style="padding-left:4px;display:none"></div>',h=$X(h).parentNode.parentNode,
$(h).addClass("ewa-lmenu-children"),h.childNodes[1].appendChild(g),g.childNodes[0].appendChild(e)};this._CreateDialog=function(){var b=new EWA_UI_DialogClass;b.Create();b.SetHtml("<table class='ewa_menu_down' border=0 width=100 cellspacing=0 cellpadding=0 onmousemove='window."+this.ClassName+".IsOut=false;' onmouseout='window."+this.ClassName+".IsOut=true; window.setTimeout(function(){var a=window."+this.ClassName+";a.AutoHidden();},1410);' onselectstart='return false' style='cursor:pointer;-moz-user-select:none;' ><tr><td></td></tr></table>");
...
$DialogInstall=function(a,b,d,e,g,h){var k=EWA_Utils.tempId("dialogInstall"),l=$DialogHtml("<div id='"+k+"'></div>","",d,e,g);$Install(a,k,function(){var m=!(d&&e);if(g||b)m&&l.AutoSize(),h&&h(l,q);else{var n=l.getContent(),p=$(n).find(".EWA_TABLE");if(0!=p.length&&p[0].id){var q=p[0].id;p=q.replace("EWA_FRAME_","").replace("EWA_LF_","");if(EWA&&EWA.F&&EWA.F.FOS&&EWA.F.FOS[p])if(p=EWA.F.FOS[p].Title,q.startsWith("EWA_LF_"))var u=0,r=setInterval(function(){u++;if(90<u)window.clearInterval(r),m&&l.AutoSize(),
h&&h(l,q);else{var t=$(n).find(".ewa_lf_func");if(0!=t.length){window.clearInterval(r);var w=l.getTitleContainer();if(w){t.css({"background-color":"transparent",display:"block","float":"left","font-size":"14px"});var v=t.find(".ewa_lf_func_caption");v.css("color","#08c");v.text(v.text().replace("[","").replace("]","").trim());$(w).find("span:eq(0)").remove();$(w).append(t).css("border-bottom","1px solid #eee")}m&&l.AutoSize();h&&h(l,q)}}},10);else p&&l.SetTitle(p),m&&l.AutoSize(),h&&h(l,q);else m&&
...
4," ",80);a.setAttribute("tag","txt");d.editor?d.editor.setValue(b):(__VAL__=b,__TYPE__="html",d.aa())};this.execute=function(a){var b=$("#"+this.BoxId+" iframe:eq(0)")[0].contentWindow,d=$("#"+this.BoxId+" iframe:eq(1)")[0].contentWindow,e=b.document,g=a.getAttribute("cmd");if(0==a.id.indexOf("st_"))"CreateLink"==g?e.execCommand(g,!0,null):e.execCommand(g,!1,null);else if(0==a.id.indexOf("fn_"))this[g](a);else if("eraser"==g)this.executeEraser();else if("CODE_TXT"==g){var h=a.getAttribute("tag"),
k=$("#"+this.BoxId+" iframe:eq(0)");e=$("#"+this.BoxId+" iframe:eq(1)");if(h)k.show(),e.hide(),a.setAttribute("tag",""),b.document.body.innerHTML=d.getText();else if(k.hide(),e.show(),e.attr("src0")){b=e.attr("src0");e.attr("src",b);e.removeAttr("src0");var l=this;this._WAIT_CODE_LOAD_COMPLETE=setInterval(function(){"complete"==d.document.readyState&&(window.clearInterval(l._WAIT_CODE_LOAD_COMPLETE),l._WAIT_CODE_LOAD_COMPLETE=null,l.showCode(a))},100)}else this.showCode(a)}else"IMG"==a.id?insertImg(window):
...
a.innerHTML.replace(/\x3c!--[\w\W\r\n]*?--\x3e/gim,"")};this.executeAfterEvent=function(a,b){var d=$("#"+this.BoxId+" iframe:eq(0)")[0].contentWindow.document.body;if("init"!=a||"ok"!=b)this.OBJ_REPLACE.value=d.innerHTML;this.userAfterEvent&&this.userAfterEvent(a,b,d)};this.userAfterEvent=function(a,b,d){}}
...
EWA.UI.Ext.IdCard2=function(a){var b=[1,31,28,31,30,31,30,31,31,30,31,30,31],d=$(a).attr("sfz_id");d=$($X(d)).show();var e=a.value,g=d.find("div");g.html("");for(var h=!0,k=[],l=[],m=[],n=[],p=0;p<e.length;p++){var q=e.substring(p,p+1),u="";6>p?k.push(q):6<=p&&10>p?l.push(q):10<=p&&12>p?m.push(q):12<=p&&14>p&&n.push(q);17>p?isNaN(q)&&(u="red",h=!1):"x"!=q&&"X"!=q&&isNaN(q)&&(u="red",h=!1);g[p]&&(g[p].innerHTML="<span style='font-size:16px;color:"+u+"'>"+q+"</span>")}k=l.join("");l=[];if(isNaN(k))h=
...
function EWA_FrameCommonItems(){this._ClassXml=null;this.Items={};this._EWA_JS_ALERT_DEFAULT={MaxMinLength:"\u957f\u5ea6\u5e94\u5728{MinLength}-{MaxLength}\u4e4b\u95f4 ",MaxMinValue:"\u503c\u5e94\u5728({MinValue} - {MaxValue})\u4e4b\u95f4",IsMustInput:"*"};this.Init=function(a){this._ClassXml=a;a=a.GetElements("root/XItem");var b=!1;if(this.F){var d=new EWA_UrlClass;d.SetUrl(this.F.Url);"M"==d.GetParameter("EWA_MTYPE")&&(b=!0)}for(d=0;d<a.length;d++){var e=this.GetItemValue(a[d],"Name","Name").toUpperCase(),
g=a[d];this.Items[e]=g;var h=this.GetItemValue(g,"DataItem","Valid");h&&"MOBILE"==h.toUpperCase()?EWA.UI.Ext.Mobile($X(e)):h&&"IDCARD"==h.toUpperCase()&&EWA.UI.Ext.IdCard($X(e));b&&this.disableOnModify(g)}};this.disableOnModify=function(a){(a=this.GetItemValue(a,"DataItem","DisableOnModify"))&&"YES"==a.toUpperCase()&&(a=$X(name1))&&(a.setAttribute("disabled","disabled"),a.getAttribute("DlsShow")&&$(a).prev().attr("disabled","disabled"))};this.GetItem=function(a){a=a.toUpperCase().trim();return this.Items[a]};
this.GetItemValue=function(a,b,d){if(null==a)return null;a=this._ClassXml.GetElement(b+"/Set",a);return null==a?null:a.getAttribute(d)};this.GetDescription=function(a){a=$(this.GetItem(a)).find("DescriptionSet Set[Lang="+EWA.LANG+"]");return{Info:a.attr("Info"),Memo:a.attr("Memo")}};this.GetValue=function(a,b,d){a=this.GetItem(a);return this.GetItemValue(a,b,d)};this.CheckValid=function(a,b){if("SPAN"==a.tagName||"IMG"==a.tagName)return!0;var d=this.GetItem(a.id),e=[];if(null==b)return!0;var g=this._CheckMustInput(a,
b,d);g&&e.push(g);(g=this._CheckMaxMinLength(a,b,d))&&e.push(g);(g=this._CheckDataValid(a,b,d))&&e.push(g);(g=this._CheckDataType(a,b,d))&&e.push(g);(g=this._CheckMaxMinValue(a,b,d))&&e.push(g);(g=this._CheckPassword(a,b,d))&&e.push(g);(g=this._CheckExtent(a,b,d))&&e.push(g);if(0==e.length)return EWA_FrameRemoveAlert(a),!0;EWA_FrameShowAlert(a,e.join(", "));return!1};this._CheckExtent=function(a,b,d){b=null;a=a.getAttribute("EWA_VALID_EX");a=null==a?"":a;0<a.length&&(b=a);return b};this._CheckDataType=
function(a,b,d){if(""==b.trim())return null;d=null;this.isNumber(a)&&(/^[0-9.-]{0,120}$/.test(b)||(d=_EWA_INFO_MSG["EWA.SYS.INVALID_NUMBER_FORMAT"]));return d};this._CheckPassword=function(a,b,d){if("input"!=a.tagName.toLowerCase()||"password"!=a.type.toLowerCase())return null;d=$("#USR_PWD").parentsUntil("form").last().find("input[type=password]");b=null;for(var e=a.id,g=0;g<d.length;g+=1)if("password"==d[g].type&&d[g]!=a&&d[g].id==e+"1"){b=d[g];break}d=null;null!=b&&(b.value!=a.value?(isok=!1,d=
_EWA_INFO_MSG["EWA.F.PASSWORD"]):EWA_FrameRemoveAlert(b));return d};this._CheckMustInput=function(a,b,d){var e=null;"1"==this.GetItemValue(d,"IsMustInput","IsMustInput")&&0==b.length&&(e=(e=_EWA_JS_ALERT.IsMustInput)?e.replace("{Name}",a.id):"*");return e};this._CheckMaxMinLength=function(a,b,d){if(!b)return null;var e=this.GetItemValue(d,"MaxMinLength","MaxLength");d=this.GetItemValue(d,"MaxMinLength","MinLength");e=null==e?-1:parseInt(e);d=null==d?-1:parseInt(d);var g=!0;!isNaN(e)&&0<e&&b.length>
e&&(g=!1);g&&!isNaN(d)&&0<d&&b.length<d&&(g=!1);b=null;g||(b=_EWA_JS_ALERT.MaxMinLength||this._EWA_JS_ALERT_DEFAULT.MaxMinLength,b=b.replace("{Name}",a.id),b=b.replace("{MaxLength}",e),b=b.replace("{MinLength}",d));return b};this._CheckDataValid=function(a,b,d){a=this.GetItemValue(d,"DataItem","Valid");if(null==a||""==a.trim())return"";if(0<b.length)return a=_EWA_VALIDS[a.toUpperCase().trim()],null==a?"":a.REGEX.test(b)?"":a.MSG};this._CheckMaxMinValue=function(a,b,d){a=this.GetItemValue(d,"MaxMinValue",
"MaxValue");d=this.GetItemValue(d,"MaxMinValue","MinValue");var e=null==a||""==a.trim()?null:1*a,g=null==d||""==d.trim()?null:1*d,h=!0;null!=e&&(h=1*b<=e?!0:!1);null!=g&&(h=1*b>=g?h&1:!1);if(h)return"";errorInfo=_EWA_JS_ALERT.MaxMinValue||this._EWA_JS_ALERT_DEFAULT.MaxMinValue;errorInfo=errorInfo.replace("{MaxValue}",a);return errorInfo=errorInfo.replace("{MinValue}",d)};this.isNumber=function(a){if(!a)return null;a=(a=this.GetItem(a.id))?this.GetItemValue(a,"DataItem","DataType"):"";a=null==a?"":
a.toUpperCase();return"NUMBER"==a||"INT"==a||"BIGINT"==a};this.isTrim=function(a){if(!a)return null;a=(a=(a=this.GetItem(a.id))?this.GetItemValue(a,"DataItem","Trim"):"")?a.toUpperCase():"YES";return"YES"==a};this.getFormat=function(a){return a?(a=this.GetItem(a.id))?this.GetItemValue(a,"DataItem","Format"):"":""};this.GetObjectValue=function(a){var b=a.tagName.toUpperCase(),d=a,e="";if("DIV"==b&&"REPT"==a.getAttribute("TAG")){a=a.getElementsByTagName("input");for(d=0;d<a.length;d+=1)a[d].checked&&
(0<e.length&&(e+=","),e+=a[d].value);return e}if("DIV"==b&&"1"==a.getAttribute("EWA_DHTML")){e=a.getElementsByTagName("iframe")[0].contentWindow;d=e.document.getElementsByTagName("textarea");e=0<d.length&&"none"!=d[0].style.display?d[0].value:e.frames[0].document.body.innerHTML;if(null!=location.search&&0>location.search.toUpperCase().indexOf("EWA_DHTML_HOST"))var g="http:\\/\\/"+eval("document.location.host");d=eval("/"+g+"/ig");e=e.replace(d,"");a=a.getElementsByTagName("input")[0];a.value=e;return a.value}if("SELECT"==
b)return e="",0<=d.options.selectedIndex&&(e=d.options[d.options.selectedIndex].value),e;if("TEXTAREA"==b&&"none"==d.style.display)return a.value;if("INPUT"==b&&"IMG_UPLOAD"==d.getAttribute("ewa_tag"))return e="/"!=EWA.CP?d.value.replace(EWA.CP,""):d.value,e=e.replace("//","/");if("INPUT"==b&&d.getAttribute("val_ref")){a=d.getAttribute("val_ref");try{e=eval("(function(){var a="+a+";return a;})()")}catch(h){console.log(a),console.log(h),e=""}return e}if("INPUT"==b&&("checkbox"==d.type||"radio"==d.type))return e=
d.checked?d.value:"";(e=d.value)&&this.isTrim(a)&&(g=e.trim(),g!==e&&(e=g,d.value=e));if("INPUT"!==b||!this.isNumber(a))return e;if(""!==e){if(isNaN(e)&&(e=e.replace(/,/ig,""),isNaN(e)))try{e=EWA_Utils.chineseToNumber(e)+"",a.value=e}catch(h){}d=this.getFormat(a);"LeastMoney"==d?(d=e.split("."),a.value=1==d.length?(1*e).fm(0):(1*e).fm(d[1].length)):"Money"==d&&(a.value=(1*e).fm(2));return e}}}function EWA_FrameResourceDescription(){this.Memo=this.Info=this.Lang=null}
...
function EWA_FrameClass(){this._Ajax=this.Xml=null;this.ItemList=new EWA_FrameCommonItems;this.Resources={};this.ReloadAfter=this._Id=this._ValidExObj=this._ValidExFail=this._ValidExOk=this.Url=null;this.isShowPostWaitting=!0;this.getObj=function(a){var b=$("#EWA_FRAME_"+this._Id);return a?b.find(a):b};this.switchButtonAction=function(a,b){if(b){var d=this.getUrlClass(),e={};e.ewa_switch_name=a.name;e.ewa_action=b;e.ewa_ajax="json";e.ewa_switch=a.checked?"on":"off";b=a.parentNode;var g=b.getAttributeNames(),
h;for(h in g){var k=g[h],l=b.getAttribute(k);0!=k.indexOf("on")&&"name"!=k&&"id"!=k&&"class"!=k&&(e[k]=l)}var m=this;d=d.GetUrl();$JP(d,e,function(n){m.extSwitchCallBack&&m.extSwitchCallBack(a,n)})}};this.setDisable=function(){var a=this.getObj();a.find("input,textarea,select,label").each(function(){this.disabled||"hidden"==this.type||(this.disabled=!0,this.setAttribute("ewadisabled",1))});a.find(".EWA_DHTML").each(function(){if("DIV"==this.tagName)var b=$(this).find("iframe")[0].contentWindow,d=
setInterval(function(){if("complete"==b.document.readyState){window.clearInterval(d);b.frames[0].document.body.contentEditable=!1;b.frames[0].document.body.style.backgroundColor="#eee";var g=b.document.getElementsByClassName("but")[0];g.style.pointerEvents="none";g.style.filter="grayscale(1) opacity(0.8)"}},300);else if("TEXTAREA"==this.tagName){var e=$(this).parent();d=setInterval(function(){var g=e.find("iframe");0<g.length&&(g=g[0].contentWindow)&&"complete"==g.document.readyState&&(window.clearInterval(d),
g.document.body.contentEditable=!1,g.document.body.style.backgroundColor="#eee",e.find(".ewa-editor").attr("ewadisabled",1))},300)}})};this.setEnable=function(){var a=this.getObj();a.find("input,textarea,select,label").each(function(){this.disabled&&this.getAttribute("ewadisabled")&&(this.disabled=!1,this.removeAttribute("ewadisabled"))});a.find(".EWA_DHTML").each(function(){if("DIV"==this.tagName){var b=$(this).find("iframe")[0].contentWindow;b.frames[0].document.body.contentEditable=!0;b.frames[0].document.body.style.backgroundColor=
"";b=b.document.getElementsByClassName("but")[0];b.style.pointerEvents="";b.style.filter=""}else if("TEXTAREA"==this.tagName){var d=$(this).parent();b=d.find("iframe")[0].contentWindow;b.document.body.contentEditable=!0;b.document.body.style.backgroundColor="";d.find(".ewa-editor").removeAttr("ewadisabled")}})};this.convertFilterCheckbox=function(a,b,d,e,g,h){function k(v){var y=$("<nobr></nobr>");q.append(y);q.append(" ");var x=$(v).parent();v=$(v).attr("id")+"_"+u;x.attr("id",v);y.append(x.children());
y.attr("ref_id",v)}function l(v){v=$(v).parent();var y=v.attr("ref_id");y&&($("#"+y).append(v.children()),v.remove())}var m={},n=this.getObj(".ewa-row-"+a),p=this.getObj(".ewa-row-"+b),q=$("<div class='ewa-filter-checked'></div>");n.find("#"+a).prepend(q).addClass("ewa-filter-chks");var u=this._Id;d||(d="PY");n.find("input[type=checkbox]").each(function(){var v=JSON.parse($(this).attr("json"))[d];v&&(v=v.toUpperCase().trim().substring(0,1),m[v]||(m[v]=[]),m[v].push(this.id),this.checked&&k(this),
$(this).on("change",function(){this.checked?k(this):l(this)}))});a="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");b=["<a class='ewa-filter-char ewa-filter-char-all' code=''>ALL</a>"];for(var r in a){var t=a[r],w=m[t];w&&b.push("<a class='ewa-filter-char' code='"+t+"'>"+t+"<span class='ewa-filter-char-num'>("+w.length+")</span></a>")}p.find(".EWA_TD_M").html(b.join(" "));e&&(n.find(".EWA_TD_L").hide(),n.find(".EWA_TD_M").attr("colspan",2));p.find("a.ewa-filter-char").on("click",function(){var v=$(this).attr("code");
n.find("input[type=checkbox]").each(function(){v?this.checked?q.append($(this).parent()):($(this).parent().attr("ref_id")&&l(this),$(this).parent().hide()):$(this).parent().show()});if(v){for(var y=m[v],x=0;x<y.length;x++)n.find("#"+y[x]).parent().show();h&&h(this,n,p)}});g&&g(n,p)};this.createFilterCheckbox=function(a,b,d,e,g,h,k){var l=this;$J(e,function(m){l.createFilterCheckboxByData(a,b,d,m,g,h,k)})};this.createFilterCheckboxByData=function(a,b,d,e,g,h,k){var l={},m=m?"[]":d.split(",");d={};
for(var n in m)d[m[n]]=1;m=[];var p=[],q=a.id;for(n in e){var u=e[n],r=u[g];r&&(r=r.replace(/</ig,"&lt;"));var t=u[h];t&&(t=t.replace(/</ig,"&lt;"));var w=u[k],v=d[r],y=[];y.push("<nobr class='ewa-filter-chk' style='float:left;margin-right:4px'>");y.push('<input class="ewa-filter-chkbox" type="checkbox" ');v&&y.push(" checked ");u=q+"_"+n;y.push(' value="'+r+'" id="'+u+'" name="'+q+'"><label ');y.push(' for="'+u+'">'+t+"</label></nobr>");v?p.push(y.join("")):m.push(y.join(""));b&&(r=w?w.substring(0,
1).toUpperCase():"",l[r]||(l[r]=[]),l[r].push(u))}a.innerHTML=p.join(" ")+" "+m.join(" ");if(b){e=['<a href="javascript:void(0)">ALL</a>'];for(n="A".charCodeAt();n<="Z".charCodeAt();n++)g=String.fromCharCode(n),l[g]&&e.push('<a href="javascript:void(0)">'+g+"</a>");b.innerHTML=e.join(" ");$(b).find("a").each(function(){var x=$(this).text();"ALL"!=x&&$(this).attr("ids",l[x].join(","));$(this).on("click",function(){if("ALL"==$(this).text())$(a).find("nobr.ewa-filter-chk").show();else{var z=$(this).attr("ids").split(","),
A={},C;for(C in z)A[z[C]]=1;$(a).find("input.ewa-filter-chkbox").each(function(){this.checked||A[this.id]?$(this).parent().show():$(this).parent().hide()})}})})}};this.hiddenNoContentRow=function(){var a=$("#EWA_FRAME_"+this._Id);a.find(".EWA_TD_M").each(function(){if(""==$(this).text()&&0==$(this).find("img,a,input[type=text],input[type=button],textarea").length){$(this).parent().hide();var b=$(this).find("*:eq(0)").attr("id");b&&a.find(".ewa-row-"+b).hide().attr("hiddennocontentrow",1)}})};this.itemReload=
function(a,b,d){if(a){var e=new EWA_UrlClass(this.Url);e.AddParameter("EWA_AJAX","SELECT_RELOAD");e.AddParameter("EWA_RELOAD_ID",a);e=e.GetUrl();$J(e,function(g){if(g.RST){var h=g.ITEM.LST,k=$X(a);k.options.length=0;for(var l in h){var m=h[l];m=new Option(m.T,m.V);k.options[k.options.length]=m}b&&(k.value=b);if(d)try{d(g,k)}catch(n){console.log(n)}}else $Tip(g.ERR)})}};this._checkSelectOptionsChange=function(){if(this._SelectFilters){var a=this;this.isSelectFilter&&setTimeout(function(){a._checkSelectOptionsChange()},
311);for(var b in this._SelectFilters){var d=this._SelectFilters[b];this.getObj("#"+d.id).html()!=d.html&&a._selectOptionsChangeed(d)}setTimeout(function(){a._checkSelectOptionsChange()},311)}};this._selectOptionsChangeed=function(a){console.log("changed");var b=this.getObj("select#"+a.id),d="initSelectFilter"+this._Id+"-"+a.id+"-filter",e="initSelectFilter"+this._Id+"-"+a.id+"-filter2",g=this._initSelectFilterCreateCode(a.codeJsonFrom,b);this.getObj("#"+d).html(g);this.getObj("#"+e).html("");a.html=
b.html()};this._initSelectFilterCreateCode=function(a,b){var d=["<option value=''>ALL</option>"];if(a){var e={},g=[];b.find("option").each(function(){if(""!=this.value){var l;this.hasAttribute("para_"+a)?l=this.getAttribute("para_"+a):this.getAttribute("json")&&(l=JSON.parse(this.getAttribute("json"))[a]);l&&!e[l]&&(e[l]=!0,g.push(l))}});var h=g.sort(),k;for(k in h)b=h[k],b=b.replace(/>/ig,"&lt;").replace(/"/,"&quot;"),d.push('<option value="'+b+'">'+b+"</option>")}else for(k="A".charCodeAt();k<=
"Z".charCodeAt();k++)b=String.fromCharCode(k),d.push('<option value="'+b+'">'+b+"</option>");return d.join("")};this.initSelectFilter=function(a,b,d,e){if(!this["INIT_SELECT_FILTER"+a]){this["INIT_SELECT_FILTER"+a]=!0;var g=$("#EWA_FRAME_"+this._Id+" select#"+a),h=g.parent(),k="initSelectFilter"+this._Id+"-"+a+"-filter",l="initSelectFilter"+this._Id+"-"+a+"-filter2",m="initSelectFilter"+this._Id+"-"+a+"-filter-table";$X(m)&&(h.append(g),$($X(m)).remove());h.addClass("ewa-select-filter");k=["<table id='"+
m+"' cellpadding=0 cellspacing=0 width=100%><tr><td class='ewa-select-filter-char'><select class='EWA_SELECT' style='margin-right:4px' id='"+k+"' onchange='EWA.F.FOS[\""+this._Id+'"]._chCode(this,"'+b+'","'+d+"\")'>"];m=this._initSelectFilterCreateCode(e,g);k.push(m);k.push("</select><select id='"+l+"' style='display:none'></select></td><td class='ewa-select-filter-target'></td></tr></table>");h.prepend(k.join(""));h.find(".ewa-select-filter-target").append(g);this._SelectFilters||(this._SelectFilters=
{});h={};h.html=g.html();h.id=a;h.filterType=b;h.filterFrom=d;h.codeJsonFrom=e;this._SelectFilters[h.id]=h}};this._chCode=function(a,b,d){this.isSelectFilter=!0;var e=$(a).next(),g=$(a).parent().parent().find(".ewa-select-filter-target select");0==e[0].options.length&&e.html(g.html());if(""==a.value)g.html(e.html());else{for(var h=["<option></option>"],k=1;k<e[0].options.length;k++){var l=e[0].options[k];this._chCodeFilter(l,b,d,a.value)&&h.push(GetOuterHTML(l))}g.html(h.join(""));this._SelectFilters[g[0].id].html=
g.html();this.isSelectFilter=!1}};this._chCodeFilter=function(a,b,d,e){"json"==b?(a=JSON.parse(a.getAttribute("json"))[d],"ADM_LID"==d&&(d=a.split("."),a=d[d.length-1])):a="text"==b?a.text:a.value;return a?a.substring(0,e.length).toUpperCase()==e.toUpperCase()?!0:!1:!1};this.setUnMust=function(a){(a=this.ItemList.Items[a])&&a.getElementsByTagName("IsMustInput")[0].getElementsByTagName("Set")[0].setAttribute("IsMustInput",0)};this.setMust=function(a){(a=this.ItemList.Items[a])&&a.getElementsByTagName("IsMustInput")[0].getElementsByTagName("Set")[0].setAttribute("IsMustInput",
1)};this.RedrawCreateSpans=function(){for(var a=$("#EWA_FRAME_"+this._Id+" tr"),b=0;b<a.length;b++){var d=a[b];if("none"!=d.style.display)for(var e=0,g=!1,h=d.cells.length-1;0<=h;h--){var k=d.cells[h];"none"==k.style.display?g?e++:(e=1,g=!0):g&&(k.colSpan=e+1,g=!1)}}EWA_FrameShowAlert=EWA_FrameShowAlert1;EWA_FrameRemoveAlert=EWA_FrameRemoveAlert1;$("#EWA_FRAME_"+this._Id+" .ewa_d1").each(function(){this.title=this.innerHTML});for(var l in this.ItemList.Items)a=this.GetItemDescription(l).Memo,null!=
a&&0<a.trim().length&&($("#"+l).attr("placeHolder",a),$("#"+l).attr("title",a));this.RedrawChangWidth()};this.GetItemDescription=function(a){return this.ItemList.GetDescription(a)};this.ShowPlaceHolder=function(a){$("#EWA_FRAME_"+this._Id).addClass("ewa-frame-cols-"+a);for(var b in this.ItemList.Items){var d=this.ItemList.GetValue(b,"Name","Name");if(d=this.GetObject(d)){d=$(d);var e=this.GetItemDescription(b),g=e.Memo,h=e.Info;e=null;1==a?(e=h,null!=g&&0<g.trim().length&&g!=e&&("smsValid"==d.attr("ewa_tag")?
e=g:(g="<div class='ewa-item-memo'>"+g+"</div>",d.parentsUntil("tr").last().append(g))),d.hasClass("ewa-switch")&&d.prepend("<div class='ewa-switch-info'>"+e+"</div>")):2==a&&null!=g&&0<g.trim().length&&(e=g);e&&("hidden"==d[0].type?d.prev().attr("placeholder",e):"SELECT"==d[0].tagName?0<d[0].options.length&&""==d[0].options[0].value&&(d[0].options[0].text="-- "+e+" --",d[0].options[0].value=""):(d.attr("placeHolder",e),d.attr("title",e)))}}};this.RedrawChangWidth=function(){var a=$("#EWA_FRAME_"+
this._Id),b=a.width(),d=a.find(".ewa_msg_box")[0].colSpan/2;$("#EWA_FRAME_"+this._Id+">tbody>tr[class*='ewa-row-']:not('.ewa-row-msg-box')").each(function(){var g=$(this).find("td.ewa_redraw_info:visible").length,h=(b-90*g)/d;$(this).find("td.ewa_redraw_ctl:visible").each(function(){var k=this.colSpan||1;$(this).css("width",h*k)})});var e=this;addEvent(window,"size",function(){e.RedrawChangWidth()})};this.Mearge=function(a,b,d){console.log("\u62fc\u5199\u9519\u8bef\uff1a\u8bf7\u7528 Merge");this.Merge(a,
b,d)};this.Merge=function(a,b,d){if(a||b){var e=$("#EWA_FRAME_"+this._Id),g=e.find("#"+a),h=e.find("#"+b);if(0==g.length)console.log("Mearge:"+a+"\u4e0d\u5b58\u5728");else if(0==h.length)console.log("Mearge:"+b+"\u4e0d\u5b58\u5728");else{var k=!1,l=e.find(".ewa-row-"+b+" .EWA_TD_M"),m=null;0==l.length&&(k=!0,l=e.find(".ewa-row-"+b+" .EWA_TD_1"),m=e.find(".ewa-row-"+b+" .EWA_TD"),1==m.length&&(k=!0),b=m.html(),m.html("<table cellpadding=0 cellspacing=0 width=100%><tr><td style='width:50%'></td><td style='display:none'></td><td style='width:50%'></td></tr></table>"),
m.find("td:eq(0)").html(b));if(0==l.length)alert("target parent not exists");else{var n="border-box"==g.css("box-sizing")?0:1*g.css("padding-left").replace("px","")+1*g.css("padding-right").replace("px",""),p="border-box"==g.css("box-sizing")?0:1*h.css("padding-left").replace("px","")+1*h.css("padding-right").replace("px","");e.find(".ewa-row-"+a).hide();null==d&&(d=" - ");var q=l.width(),u=g[0].tagName,r=h[0].tagName;g.parent().hasClass("ewa-select-filter-target")&&(g=e.find(".ewa-row-"+a+" .EWA_TD_M table:eq(0)"),
u="SELECT_WITH_FILTER");var t=0;b=null;d&&(l.append('<span class="mearge-span">'+d+"</span>"),k&&m.find("table:eq(0) td:eq(1)").html('<span class="mearge-span">'+d+"</span>").show(),b=l.find(".mearge-span"),t=b.width()+1+1*b.css("padding-left").replace("px","")+1*b.css("padding-right").replace("px","")+1*b.css("margin-left").replace("px","")+1*b.css("margin-right").replace("px",""));u==r?(d=(q-t)/2-n-2,g.css("width",d),h.css("width",d),k&&m.find("table:eq(0) td:eq(2), table:eq(0) td:eq(0)").css("width",
d)):"SELECT"==u?(g.css("width",100),h.css("width",q-t-n-p-2-2-g.width())):"SELECT_WITH_FILTER"==u?(g.css("width",200),h.css("width",q-t-n-p-2-2-g.width())):"SELECT"==r&&(h.css("width",100),g.css("width",q-t-n-p-2-2-g.width()));h.css("float","left");b&&b.css("float","left");g.css("float","right");l.append(g);l.addClass("ewa-frame-merge");k&&(a=e.find(".ewa-row-"+a+" .EWA_TD").html(),m.find("table:eq(0) td:eq(2)").html(a))}}}};this.MergeExp=function(a,b,d,e){if(b){var g=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),
h=[],k=b;b={};for(var l=$("#EWA_FRAME_"+this._Id),m=0;m<g.length;m++){var n=g[m];h.push(n);var p=n.replace("@@","");k=k.replace(n,"<span class='ewa-row-merge ewa-row-merge-"+p+"' mid=\""+n+'"></span>');p!=a&&l.find(".ewa-row-"+p).hide();b[p]=this.GetItemDescription(p).Info}g=document.createElement("div");g.style.display="none";g.innerHTML=k;document.body.appendChild(g);n=l.find('[id="'+a+'"]');if(0==n.length)console.log("not find "+a);else{a=n.parent();for(var q in h)m=h[q],n=m.replace("@@",""),k=
l.find('[id="'+n+'"]'),0==k.length?console.log("not found [id="+n+"]"):(m=$(g).find('span[mid="'+m+'"]'),"placeholder"==d?k.attr("placeholder",b[n]):d&&(m.append("<span class='ewa-row-merge-memo'></span>"),m.find(".ewa-row-merge-memo").text(b[n])),m.append(k));for(;0<g.childNodes.length;)a.append(g.childNodes[0]);$(g).remove();e&&e(a)}}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MergeItems=function(){for(var a in this.MeargeMap){var b=this.MeargeMap[a],d=$X("_ewa_tr$"+a);if(d){for(var e=
d.cells.length,g=$(d.cells[0]);1<d.cells.length;)g.append(d.cells[1].innerHTML),d.removeChild(d.cells[1]);d.cells[0].colSpan=e;d=[];for(e=0;e<b.length;e++){for(var h=$X("_ewa_tr$"+b[e]),k=["<nobr>"],l=0;l<h.cells.length;l++)k.push(h.cells[l].innerHTML);k.push("</nobr>");d.push(k.join(" "));h.parentNode.removeChild(h)}g.append(d.join(" "))}}};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.DoAction=function(a,b,d,e,g,h){EWA.F.CID=this._Id;if(null!=b&&""!=
b.trim()){if(null!=d&&0<d.trim().length)if(a=_EWA_INFO_MSG[d],null!=a&&""!=a){if(!window.confirm(a))return}else if(!window.confirm(d))return;this.DoPostBefore();this._Ajax=this.CreateAjax(null,!0);this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.AddParameter("EWA_ACTION_TIP",e);null!=h&&0<h.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",
h),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=!1;if(null!=g&&0<g.length)for(b=0;b<g.length;b+=1)this._Ajax.AddParameter(g[b].Name,g[b].Value);g=new EWA.C.Url;g.SetUrl(this.Url);g=g.RemoveParameter("EWA_ACTION");this._Ajax.PostNew(g,EWA.F.FOS[EWA.F.CID]._CallBackJs)}};this.GuideShowCreate=function(a){this._GroupInfos=a;var b=$X("EWA_FRAME_"+this._Id);a=a.length-1;b.setAttribute("EWA_GUIDE_IDX","0");b.setAttribute("EWA_GUIDE_IDX_MAX",a);b.rows[b.rows.length-
1].style.display="none";100<b.clientHeight&&(b.parentNode.style.height=b.clientHeight+"px");a=document.createElement("input");a.id="ewa_but_"+Math.random();a.type="button";a.value="enus"==EWA.LANG?"Back":"\u4e0a\u4e00\u6b65";a.style.display="none";a.onclick=function(){var k=b.getAttribute("EWA_GUIDE_IDX");if(0==1*k)$Tip("\u5230\u5934\u4e86");else{var l=b.id.replace("EWA_FRAME_","");EWA.F.FOS[l].GuidePrevBefore&&EWA.F.FOS[l].GuidePrevBefore(k,this,b);EWA.F.FOS[l].GuideShow(1*k-1);EWA.F.FOS[l].GuidePrevAfter&&
EWA.F.FOS[l].GuidePrevAfter(k,this,b)}};var d=document.createElement("input");d.id="ewa_but_"+Math.random();d.type="submit";d.value="enus"==EWA.LANG?"Next":"\u4e0b\u4e00\u6b65";d.onclick=function(){var k=b.getAttribute("EWA_GUIDE_IDX"),l=b.id.replace("EWA_FRAME_","");EWA.F.FOS[l].GuideShowCheck(k)&&(EWA.F.FOS[l].GuideNextBefore&&EWA.F.FOS[l].GuideNextBefore(k,this,b),"ok"==this.getAttribute("ewa_guide_method")?$F(b,"input","type","submit")[0].click():EWA.F.FOS[l].GuideShow(1*k+1),EWA.F.FOS[l].GuideNextAfter&&
EWA.F.FOS[l].GuideNextAfter(k,this,b))};var e=b.parentNode.parentNode.parentNode.parentNode.insertRow(-1).insertCell(-1);e.appendChild(a);e.appendChild(d);e.className="EWA_FRAME_GROUP_BUTTONS";tdTitle=b.parentNode.parentNode.parentNode.parentNode.insertRow(0).insertCell(-1);e="ewa_title_"+Math.random();for(var g=[],h=0;h<this._GroupInfos.length;h++)g.push('<div style="float:left" id="ewa_'+this._Id+"_"+h+'">'+(h+1)+". "+this._GroupInfos[h].DES+"</div>");tdTitle.innerHTML="<div style='text-align:left'>"+
g.join(" <div style='float:left;color:#aaa'>&nbsp;&gt;&nbsp;</div> ")+"</div><div id='"+e+"'></div>";tdTitle.className="EWA_FRAME_GROUP_TITLE";b.setAttribute("EWA_GUIDE_ID_PREV",a.id);b.setAttribute("EWA_GUIDE_ID_NEXT",d.id);b.setAttribute("EWA_GUIDE_ID_TITLE",e);this.GuideShowTitle(0);a=document.createElement("div");100<b.clientHeight&&(a.style.width=b.clientWidth+"px",a.style.height=b.clientHeight+20+"px",a.style.overflow="auto");b.parentNode.appendChild(a);a.appendChild(b);b.parentNode.className=
"EWA_GROUP_GUIDE"};this.GuideShowTitle=function(a){for(var b=$X("EWA_FRAME_"+this._Id).getAttribute("EWA_GUIDE_IDX_MAX"),d=0;d<=b;d++){var e="ewa_"+this._Id+"_"+d;d==a?($X(e).style.color="blue",$X(e).style.borderBottom="2px solid green"):($X(e).style.color="green",$X(e).style.borderBottom="2px")}};this.GuideShowCheck=function(a){var b=!0,d=null,e;for(e in this.ItemList.Items){var g=this.ItemList.GetItemValue(this.ItemList.Items[e],"Name","Name"),h=$X(g);null==h?alert(g+" not exists"):(g=this._GetTr(h),
null!=g&&g.getAttribute("groupindex")==a&&((b&=this.CheckValid(h))||null!=d||(d=h)))}null!=d&&d.focus();return b};this._GetTr=function(a){for(var b=0;100>b;){b++;a=a.parentNode;try{if("TR"==a.tagName.toUpperCase()&&null!=a.getAttribute("id")&&0==a.getAttribute("id").indexOf("_ewa_tr$"))return a}catch(d){break}}return null};this.GuideShow=function(a){this.GuideShowTitle(a);var b=$X("EWA_FRAME_"+this._Id);if(b.getAttribute("EWA_GUIDE_IDX")!=a){var d=b.getAttribute("EWA_GUIDE_IDX_MAX"),e=b.getAttribute("EWA_GUIDE_ID_PREV"),
g=b.getAttribute("EWA_GUIDE_ID_NEXT");a==d?($X(g).value="enus"==EWA.LANG?"Confirm":"\u786e\u5b9a",$X(g).setAttribute("ewa_guide_method","ok")):($X(g).value="enus"==EWA.LANG?"Next":"\u4e0b\u4e00\u6b65",$X(g).setAttribute("ewa_guide_method",""));0==a?$X(e).style.display="none":$X(e).style.display="";b.setAttribute("EWA_GUIDE_IDX",a);this._ShowHidenGroup(b,a)}};this._ShowHidenGroup=function(a,b){for(var d=0;d<a.rows.length-1;d++){var e=a.rows[d];if(null!=e.getAttribute("groupIndex")&&""!=e.getAttribute("groupIndex")){var g=
1*e.getAttribute("groupIndex");e.style.display=b==g?"":"none"}}};this.GroupShow=function(a,b){if(!(0<a.className.indexOf("1"))){this.GroupShowBefore&&this.GroupShowBefore(a,b);for(var d=$X("EWA_FRAME_"+this._Id),e=a.parentNode.parentNode,g=0;g<d.rows.length;g++){var h=d.rows[g];if(h!=e&&!(1==h.cells.length&&h.cells[0].className&&0<=h.cells[0].className.indexOf("EWA_TD_B"))&&"1"!=h.getAttribute("hiddennocontentrow")){var k=0;null!=h.getAttribute("groupIndex")&&""!=h.getAttribute("groupIndex")&&(k=
1*h.getAttribute("groupIndex"));h.style.display=b==k?"":"none"}}d=e.getElementsByTagName("div");for(g=0;g<d.length;g++)e=d[g],e.className=e==a?e.className+"1":e.className.replace("1","");this.GroupShowAfter&&this.GroupShowAfter(a,b)}};this.DoActionJSON=function(a,b,d,e){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","JSON");this._Ajax.AddParameter("EWA_ACTION",a);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_JSON_NAME",
...
null);try{a.ReloadAfter&&a.ReloadAfter(b)}catch(d){alert(b)}}}else alert("ERROR:\r\n"+b._Http.statusText)};this.RewriteInfo=function(a,b,d,e){for(a=0;a<info.length;a++){var g=info[a],h=g[b];if($X(h)){var k="TD"==$X(h).parentNode.tagName?$X(h).parentNode:$X(h).parentNode.parentNode;"IMG_UPLOAD"==$X(h).getAttribute("ewa_tag")&&(k=$X(h).parentNode.parentNode.parentNode.parentNode.parentNode.parentNode);h=k.parentNode;null==g[d]||""==g[d].trim()?h.style.display="none":3==h.cells.length?(h.cells[2].innerHTML=
g[e],h.cells[0].innerHTML=g[d]):1==h.cells.length&&(h=h.previousSibling,3==h.nodeType&&(h=h.previousSibling),h.cells[1].innerHTML=g[e],h.cells[0].innerHTML=g[d])}}};this._HiddenMemo=function(a,b){var d=a.parentNode.parentNode;b=!1;"none"==d.style.display&&(b=!0);d.style.display="none";d.id="tr_"+a.id;d=d.previousSibling;3==d.nodeType&&(d=d.previousSibling);d.style.display="none";a="<span id=tab_"+a.id+' class="ewa_merge_tab" onclick="EWA.F.FOS[\''+this._Id+"'].ShowMemo(this.id);\">"+d.cells[0].innerHTML+
"</span>";return b?"":a};this.ShowMemo=function(a){for(var b=$X(this._Id+"__ewa_meger").getElementsByTagName("SPAN"),d=0;d<b.length;d++){var e=b[d].id.replace("tab_","tr_");"ewa_merge_tab1"==b[d].className&&(b[d].className="ewa_merge_tab",$X(e).style.display="none");b[d].id==a&&(b[d].className="ewa_merge_tab1",$X(e).style.display="")}};this.MergeMemo=function(){var a=$X("EWA_FRAME_"+this._Id).getElementsByTagName("textarea");if(0!=a.length&&"1"!=a[0].getAttribute("ewa_merge")){for(var b=[],d=0;d<
a.length;d++){var e=this._HiddenMemo(a[d]);e="<nobr>"+e.replace("\u2022 ","").trim()+"</nobr>";b.push(e)}a=a[0];d=a.parentNode.parentNode;e=d.previousSibling;3==e.nodeType&&(e=e.previousSibling);e.id=this._Id+"__ewa_meger";e.cells[0].colSpan=3;e.cells[0].innerHTML=b.join("");e.cells[0].style.width="100%";e.cells[0].style.height="25px";e.style.display="";d.style.display="";$X("tab_"+a.id).className="ewa_merge_tab1";null!=window._EWA_DialogWnd&&EWA.UI.Dialog._SetTitle(window._EWA_DialogWnd)}};this.DoValidEx=
function(a,b,d,e,g,h){""!=a.value&&(this._ValidExOk=this.Resources[g],this._ValidExFail=this.Resources[h],this._ValidExObj=a,"action"==b.toLowerCase().trim()?this._DoValidExAction(a,e,this.Resources[g].GetInfo(),this.Resources[h].GetInfo()):eval(d)?(EWA_FrameShowAlert(a,this._ValidExOk.GetInfo()),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,this._ValidExFail.GetInfo()),a.setAttribute("EWA_VALID_EX",this._ValidExFail.GetInfo())))};this._DoValidExAction=function(a,b,d,e){if(null!=a&&!$(a).is(":hidden"))if(null==
b||""==b.trim())alert("action not value");else{var g=a.id+","+a.value;if(this.DoValidExAction_RETS&&null!=this.DoValidExAction_RETS[g])0==this.DoValidExAction_RETS[g]?(EWA_FrameRemoveAlert(a,d),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,e),a.setAttribute("EWA_VALID_EX",e));else{var h=new EWA.C.Ajax;h.LoadingType="image";h.AddParameter("EWA_AJAX","HAVE_DATA");h.AddParameter("EWA_ACTION",b);h.AddParameter("EWA_ID",this._Id);h.AddParameter("EWA_NO_CONTENT","1");h.AddParameter(a.id,a.value);
this.DoValidExAction_RETS||(this.DoValidExAction_RETS={});var k=this;h.PostNew(this.Url,function(){if(4==h._Http.readyState){h.HiddenWaitting();if(200==h._Http.status){var l=h._Http.responseText;if(EWA.F.CheckCallBack(l))try{var m=parseInt(l.trim());k.DoValidExAction_RETS[g]=m;0==m?(EWA_FrameRemoveAlert(a,d),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,e),a.setAttribute("EWA_VALID_EX",e))}catch(n){alert(n+","+l)}}else alert("ERROR:\r\n"+h._Http.statusText);h=null}})}}};this.ValidCodeError=
...
this._InitMustInputs();this._InitEncyptions()};this._InitMustInputs=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name");0<$(d).find('IsMustInput Set[IsMustInput="1"]').length&&(d="#"+e,a.find(".ewa-row-"+e).addClass("ewa-row-must"),e=a.find(d),e.addClass("ewa-row-item-must"),0<e.length&&e.attr("type")&&"hidden"==e.attr("type").toLowerCase()&&e.prev().addClass("ewa-row-item-must"))}};this._InitEncyptions=
function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name");d=$(d).find("DispEnc Set");if(0!=d.length&&(e=a.find("#"+e),0!=e.length&&d.attr("EncType"))){if("INPUT"==e[0].tagName||"TEXTAREA"==e[0].tagName){if(!e.val())continue;e.prop("disabled",!0);e.attr("ewa_encyrption","yes")}var g=$("<div class='ewa-enc-cover' style='position:absolute;left:0;top:0;width:100%;height:100%;'><div></div></div>");e.parent().append(g);
e.parent().css("position","relative");if(d=d.attr("EncShowUrl")){g.find("div").html("\u70b9\u51fb\u67e5\u770b").css({position:"absolute",height:30,"line-height":"30px",top:"50%","margin-top":"-15px",right:10,"text-align":"right"});d=new EWA_UrlClass(d);g=new EWA_UrlClass(this.Url);for(var h in g._Paras)if(!d.GetParameter(h)){var k=g._Paras[h];null!=k&&(k=k.unURL());d.AddParameter(h,k)}d.AddParameter("EWA_ENCY_FROM_ID",e.attr("id"));d=d.GetUrl();e.parent().attr("enc_url",d).attr("fid",e.attr("id"));
e.parent().on("click",function(){if(!$(this).attr("enc_ok")){var l=$(this).attr("t")||100,m=(new Date).getTime();if(!(400>m-l)){$(this).attr("t",m);l=$(this).attr("enc_url");var n=$(this).find("#"+$(this).attr("fid"));$J(l,function(p){p.RST?(n.prop("disabled",!1),n.removeAttr("ewa_encyrption"),n.val(p.VALUE),$(n).parent().find(".ewa-enc-cover").remove(),$(n).parent().attr("enc_ok","1")):(p.ERR||p.MSG)&&$Tip(p.ERR||p.MSG)})}}})}}}};this._InitTranslations=function(){var a="EWA.F.FOS[&quot;"+this._Id+
"&quot;]._Trans(this)",b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name"),g=$(d).find("DataItem Set[Translation]");if(d=g.attr("Translation")){g=g.attr("TransTarget");var h="en2zh"==d?" \u82f1\u8bd1\u4e2d":" \u4e2d\u8bd1\u82f1";"enus"==EWA.LANG&&(h="en2zh"==d?" En-Zh":" Zh-En");d=$('<a class="ewa-but-trans" href="javascript:void(0)" onclick="'+a+'" _transf="'+e+'" _transp="'+d+'" _transt="'+g+'">'+h+"</a>");g=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+
e+" .EWA_TD_L");0==g.length&&(g=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+e+" .EWA_TD"));0==g.length&&(g=$("#EWA_FRAME_"+this._Id+" #"+e).parent().prev().find(".ewa_d1"));0==g.length&&(g=$("#EWA_FRAME_"+this._Id+" #"+e).parent(),g.css("position","relative"),d.addClass("ewa-but-trans-float"));g.append(d)}}};this._Trans=function(a){if(a){var b=$(a).attr("_transf"),d=$(a).attr("_transp");a=$(a).attr("_transt");b=$("#EWA_FRAME_"+this._Id+" #"+b);a=$("#EWA_FRAME_"+this._Id+" #"+a);if(0==b.length||0==a.length)console.log("trans ex:",
b,a);else{var e=b[0].tagName.toLowerCase();if(b="input"==e||"textarea"==e||"hidden"==e?b.val():b.text()){var g=new EWA_TransClass;"en2zh"==d?g.transToCn(b,a[0]):g.transToEn(b,a[0]);$Tip("enus"==EWA.LANG?"Translating...":"\u7ffb\u8bd1\u4e2d...",function(){return!g.IsRun})}}}};this._bindCompostion=function(a,b){if(!EWA.B.IE){var d=this;d._droplist_||(d._droplist_={});d._droplist_[b.id]={_is_composition:!1};$(a).on("compositionstart",function(){d._droplist_[b.id]._is_composition=!0}).on("compositionend",
function(){d._droplist_[b.id]._is_composition=!1;EWA.F.I.DropList(this)}).removeAttr("oninput").removeAttr("onkeyup").on("input",function(){d._droplist_[b.id]._is_composition||EWA.F.I.DropList(this)})}};this._GetDropListValue=function(){var a=this.getObj();if(0!=a.length){a=a[0];var b=a.getElementsByTagName("input");this._droplist_={};for(var d=0;d<b.length;d++){var e=b[d];if("droplist"==e.getAttribute("ewa_class")){var g=e.nextSibling;"INPUT"==g.tagName.toUpperCase()&&"HIDDEN"==g.type.toUpperCase()&&
(this._GetDropListValue1(e,g),this._bindCompostion(e,g))}}a=a.getElementsByTagName("select");for(d=0;d<a.length;d++)if(e=a[d],b=e.getAttribute("_ListFilterType"))g=e.getAttribute("_ListFilterField"),this.initSelectFilter(e.id,b,g);this._SelectFilters&&this._checkSelectOptionsChange()}};this._GetDropListValue1=function(a,b){if(""==b.value)b.setAttribute("setvalue",1);else{var d=b.getAttribute("DlsShow");if(null==d||""==d)b.setAttribute("canopen",0),a.value=b.value,b.setAttribute("canopen",1);else{var e=
new EWA_AjaxClass,g=b.getAttribute("xmlName"),h=b.getAttribute("itemName"),k=b.getAttribute("paraName"),l=b.getAttribute("DlsAction");e=new EWA.C.Ajax;var m=b.value;var n=this.EWA_CGI?this.EWA_CGI:window.EWA_CGI?window.EWA_CGI:EWA.CP+"/EWA_STYLE/cgi-bin/";var p=-1==n.indexOf("?")?"?":"&";n=(n+(p+"XMLNAME="+g+"&ITEMNAME="+h+"&EWA_AJAX=JSON")).replace("//","/");n=n.replace("//","/");n=n.replace("//","/");e.AddParameter(k,m);null!=l&&0<l.trim().length&&(e.AddParameter("EWA_ACTION",l),e.AddParameter(b.id,
b.value));e.PostNew(n,function(){if(e.IsRunEnd()){var q=e.GetRst(),u="__json"+Math.random();try{eval('window["'+u+'"]='+q)}catch(v){b.setAttribute("canopen",0);a.value=v;b.setAttribute("canopen",1);return}q=window[u];if(0!=q.length){u=q[0];var r=[];q={};for(var t in u)r.push(u[t]),q["@"+t.toUpperCase()]=u[t],u[t]&&b.setAttribute("para_"+t.toLowerCase(),u[t]);if(null==d||""==d)q=r.join("/");else{t=d.match(/@[a-zA-Z0-9\-\._:]*\b/ig);for(u=0;u<t.length;u++){r=t[u];var w=q[r.toUpperCase()];d=d.replace(r,
w)}q=d}b.setAttribute("canopen",0);a.value=q;b.id=null==b.id||""==b.id?Math.random():b.id;"yes"==b.getAttribute("isdlseventload")&&(EWA.F.FOS[b.id]=new EWA_FrameItemClass,EWA.F.FOS[b.id].DropList(a),EWA.F.FOS[b.id].CallAfterEvent());b.setAttribute("canopen",1);b.setAttribute("setvalue",1)}}})}}};this.DoPostEx=function(){EWA.F.F.CUR=this;if(this.CheckValidAll(document.forms[0])){this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST",
"1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");for(var a=document.getElementsByTagName("input"),b=0;b<a.length;b+=1){var d=a[b],e=""==d.name?d.id:d.name;null!=e&&""!=e&&this._Ajax.AddParameter(e,d.value)}a=document.getElementsByTagName("select");for(b=0;b<a.length;b+=1)d=a[b],e=""==d.name?d.id:d.name,null!=e&&""!=e&&this._Ajax.AddParameter(e,d.value);a=document.getElementsByTagName("textarea");for(b=0;b<a.length;b+=1)d=a[b],e=""==d.name?d.id:d.name,null!=e&&""!=e&&this._Ajax.AddParameter(e,d.value);
this._Ajax.PostNew(this.Url,EWA.F.F.CUR._CallBack)}};this.CreateAjax=function(a,b){EWA.F.F.CUR=this;null==a&&(a=$("#f_"+this._Id)[0]);if(!b&&!this.CheckValidAll(a))return null;b=new EWA.C.Ajax;for(var d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],"Name","Name"),g=this.GetObject(e,a);if(null!=g&&!$(g).attr("ewa_encyrption")){var h=g.getAttribute("ewa_tag");if("signature"==h){var k="N";var l=this.tablets[d];for(var m=0;m<l.lines.length;m++)if(l.lines[m]){k="Y";break}l=
"Y"==k?this._GetObjectValue(g):"";b.AddParameter(e+"_CHANGED",k)}else l=this._GetObjectValue(g);null!=l&&b.AddParameter(e,l);"DIV"==g.tagName.toUpperCase()&&"1"==g.getAttribute("EWA_DHTML")&&(k=$X("UP_IMG_"+e).value,b.AddParameter(e+"_imgs_split",k));if("swffile"==h||"IMG_UPLOAD"==h)if(e=g.getAttribute("UP_PARAS"),null!=e&&0<e.length)for(e=e.split(","),h=0;h<e.length;h++){var n=e[h];b.AddParameter(n,g.getAttribute(n))}else b.AddParameter("UP_URL",g.value);else"markdown"==h&&(g=g.parentNode.getElementsByTagName("textarea"),
1<g.length&&b.AddParameter(g[1].id,g[1].value))}}if(this.PostAddData)for(n in this.PostAddData)b.AddParameter(n,this.PostAddData[n]);return b};this.CreatePostData=function(){var a=$("#f_"+this._Id)[0],b={},d;for(d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],"Name","Name"),g=this.GetObject(e,a);if(null!=g){var h=this._GetObjectValue(g);null!=h&&(b[e]=h);"DIV"==g.tagName.toUpperCase()&&"1"==g.getAttribute("EWA_DHTML")&&(h=$X("UP_IMG_"+e).value,b[e+"_imgs_split"]=
h);e=g.getAttribute("ewa_tag");if("swffile"==e||"IMG_UPLOAD"==e)if(h=g.getAttribute("UP_PARAS"),null!=h&&0<h.length){h=h.split(",");for(var k=0;k<h.length;k++){var l=h[k];b[l]=g.getAttribute(l)}}else b.UP_URL=g.value;"markdown"==e&&(g=g.parentNode.getElementsByTagName("textarea"),1<g.length&&(b[g[1].id]=g[1].value))}}return b};this.DoPostBefore=function(){return!0};this.isDoPostBeforeTimer=function(){return null!=this._checkStatusFristResult};this._uploadingFileCheck=function(a){a=window["h5u_"+this._Id+
...
if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;$X(a.WAIT_ID)||a.createWaitBox();return this.uploadProcess=!0};this.DoPost=function(a,b,d){if(!d){d=this.DoPostBefore();if(d instanceof Array){var e=this;this._checkStatusInc=0;this._checkStatusFristResult=d;this._checkStatusTimer=window.setInterval(function(){var m=0==e._checkStatusInc?e._checkStatusFristResult:e.DoPostBefore();e._checkStatusInc++;null!=m[0]&&(window.clearInterval(e._checkStatusTimer),e._checkStatusTimer=
null,e._checkStatusInc=null,e._checkStatusFristResult=null,0==m[0]?m[2]?$Confirm(m[1],m[1],function(){m[0]=m[1]=null;e.DoPost(a,b,!0)},function(){}):$Tip(m[1]):(m[0]=m[1]=null,e.DoPost(a,b,!0)))},232);return}if(!d)return}var g=$(a).find("input[ewa_tag=ht5upload]");if(!(0<g.length)||this.uploadProcess||this.CheckValidAll(a)){var h=0;e=this;for(d=0;d<g.length>0;d++){var k=g[d];this._uploadingFileCheck(k)&&h++}if(0<h)setTimeout(function(){e.DoPost(a,b)},700);else if(g=$(a).find("input[ewa_tag=ht5takephoto]"),
!(0<g.length)||this.uploadProcess||this.CheckValidAll(a)){for(d=0;d<g.length>0;d++){k=g[d];h=!1;k=window["h5takephoto_"+this._Id+"$"+k.id];if("ok"!=k.UPLOAD_STATUS){if(!$X(k.H5_UPLOAD.WAIT_ID)){try{k.submitUpload()}catch(m){console.log("ht5takephotos - ht5.submitUpload: "+m);$Tip("\u60a8\u6ca1\u6709\u83b7\u53d6\u7167\u7247");return}k.H5_UPLOAD.createWaitBox();this.uploadProcess=!0}h||(e=this,setTimeout(function(){e.DoPost(a,b)},700),h=!0);return}k.H5_UPLOAD.removeWaitBox()}if(this._stopPostError)EWA.UI.Msg.ShowError(this._stopPostError,
"");else if(d=this.CreateAjax(a),null!=d){null==b&&(b=this.Url);if(""==b||null==b)b=window.location.href;this._Ajax=d;this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.LoadingType="image";this.DoPostStart&&this.DoPostStart(this._Ajax);d=new EWA_UrlClass(b);for(var l in this._Ajax._Parameters)d.RemoveParameter(l);b=d.GetUrl();this._Ajax.PostNew(b,EWA.F.F.CUR._CallBack);this.isShowPostWaitting||this._Ajax.HiddenWaitting();
...
a._Http.statusText)};this.Reload=function(){};this.Reload1=function(){console.log("Reload1 \u8fd9\u4e2a\u5e72\u561b\u7528\uff1f\u8c01\u5728\u8c03\u7528\uff1f")};this.ReloadFrame=function(a){var b=$("#EWA_FRAME_"+this._Id);if(0!=b.length){var d=b.parentsUntil("#EWA_FRAME_MAIN").last().parent();if(0!=d.length){b=EWA_Utils.tempId("ewa_frame_relaod");d.attr("id",b);var e=new EWA_UrlClass(this.Url);e.AddParameter("ewa_ajax","install");e=e.GetUrl();$Install(e,b,function(){a&&a(d,this)})}}};this.CheckValidAll=
function(a){var b=!0,d=null,e;for(e in this.ItemList.Items){var g=this.ItemList.GetItemValue(this.ItemList.Items[e],"Name","Name");g=this.GetObject(g,a);null!=g&&((b&=this.CheckValid(g))||null!=d||(d=g))}null!=d&&d.focus();return b};this.H5Type=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name");e=a.find('[id="'+e+'"]');if(0!=e.length){var g=this.ItemList.GetItemValue(d,"Tag","Tag"),h=this.ItemList.GetItemValue(d,
"DataItem","Valid");this.ItemList.GetItemValue(d,"DataItem","Format");d=this.ItemList.GetItemValue(d,"IsMustInput","IsMustInput");"Email"==h&&e.attr("type","email");"valid"==g&&e.attr("type","tel");1==d&&e.attr("required","required")}}};this.GetObject=function(a,b){b||(b=$("FORM#f_"+this._Id));a=$(b).find('[id="'+a+'"]');return 0<a.length?a[0]:null};this.CheckValid=function(a,b){if("SPAN"==a.tagName||"IMG"==a.tagName)return!0;if(a&&b&&"DIV"==a.tagName&&"REPT"==a.getAttribute("tag")){b=b.target.tagName;
if("LABEL"==b||"INPUT"==b){var d=this;setTimeout(function(){d._GetObjectValue(a);d.ItemList.CheckValid(a,e)},10)}return!0}var e=this._GetObjectValue(a);return this.ItemList.CheckValid(a,e)};this._GetObjectValue=function(a){return this.ItemList.GetObjectValue(a)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}var __EWA_ALTER_MSG=null;
...
window[p].GetHtml();window.onmousedown=null;p=e.attr("oldv");q==p?($(e).attr("style",""),m.hide()):(p={key:$(a).attr("ref"),val:q},$JP(n.POST_URL||window.location.href,p,function(u){$(e).attr("style","");m.hide();u.RST?(""==q&&(q="............."),b.html(q),$TipTL("\u4fdd\u5b58\u5b8c\u6bd5"),b.append('<i style="margin-left:5px" class="fa fa-edit"></i>')):$Tip(u.ERR)}))}}};this.checkInHtmlEditor=function(a){a=$(event.target).parents();for(var b=0;b<a.length;b++){var d=$(a[b]);if(d.hasClass("ewa-editor")||
...
1).addClass("ewa-lf-func-recycle-yes"));this.Url=b;this.Goto(1)};this.BindButton=function(a,b){$("#EWA_LF_"+this._Id+' tr[ewa_key] [id="'+a+'"]').each(function(){$(this).attr("onclick","$(this).parent().parent().find('[id=\""+b+"\"]')[0].click()");$(this).addClass("ewa-map-button")})};this.Merge=function(a,b,d,e,g){var h=$("#EWA_LF_"+this._Id);h.find("tr[ewa_key]").each(function(){var k=$(this).find('[id="'+b+'"]').parentsUntil("tr").last();if("yes"!=k.attr("ewa-merged")){k.attr("ewa-merged","yes");
var l=$(this).find('[id="'+a+'"]');l.parentsUntil("tr").last().hide();null==d?d="<br>":0<=d.indexOf("<")?k.append(d):k.append("<span class='ewa-merge-str ewa-mearge-str'>"+d+"</span>");k.append(l);e&&e(k,this)}});g&&(g="<span class='ewa-lf-merge-header-split'></span>"+h.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(),h.find('tr[ewa_tag="HEADER"] [id="'+b+'"]').append(g));h.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').parent().hide();h.find("td#ADD_ROW_"+a).hide()};this.Mearge=function(a,b,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 Merge");
this.Merge(a,b,d)};this.MergeExp=function(a,b,d,e,g){if(b){var h=$("#EWA_LF_"+this._Id),k=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),l=[],m=b,n={};b=[];for(var p=0;p<k.length;p++){var q=k[p];l.push(q);var u=q.replace("@@","");m=m.replace(q,"<span class='ewa-lf-merge ewa-lf-merge-"+u+" ewa-lf-mearge ewa-lf-mearge-"+u+"' mid=\""+u+'"></span>');u!=a&&(h.find('tr[ewa_tag="HEADER"] [id="'+u+'"]').parent().hide(),h.find("td#ADD_ROW_"+u).hide());q=h.find('tr[ewa_tag="HEADER"] [id="'+u+'"]').html();n[u]=q;b.push(q)}g&&
(g=b.join("<span class='ewa-lf-merge-header-split'></span>"),h.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(g));h.find("tr[ewa_key]").each(function(){if(0==$(this).find('[id="'+a+'"]').length)console.log("not find "+a);else{var r=$(this).find('[id="'+a+'"]').parent();if("yes"!=r.attr("ewa-merged")){r.attr("ewa-merged","yes");var t=$('<div style="display:none"></div>');t.html(m);for(var w in l){var v=l[w].replace("@@",""),y=$(this).find('[id="'+v+'"]');if(0!=y.length){v!=a&&y.parent().hide();var x=
t.find('span[mid="'+v+'"]');d&&(x.append("<span class='ewa-lf-mearge-memo'></span>"),x.find(".ewa-lf-mearge-memo").html(n[v]));x.append(y)}}for(;0<t[0].childNodes.length;)r.append(t[0].childNodes[0]);$(t).remove();e&&e(r,this)}}})}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MeargeExp=function(a,b,d,e){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 MereExp");this.MergeExp(a,b,d,e)};this.SubBottoms=function(a){this.SubBottomsArray=a.split(",");this._SubBottoms()};this.reCalcBottoms=
function(){this._SubBottoms()};this._SubBottoms=function(){var a=$("#EWA_LF_"+this._Id).find(".ewa-lf-sub-tr");0==a.length?(a=$(this.AddRow([])),a.addClass("ewa-lf-sub-tr"),a.find("td").addClass("ewa-lf-sub-td")):a.find("td").text("");var b=0,d;for(d in this.SubBottomsArray){var e=this.SubBottomsArray[d],g=0;$("#EWA_LF_"+this._Id+' .ewa-lf-data-row [name="'+e+'"]').each(function(){var h=null!=this.value?this.value.replace(/,/ig,""):GetInnerText(this).replace(/,/ig,"");isNaN(h)||(g+=1*h,0<h.indexOf(".")&&
(b=2))});a.find("td[id=ADD_ROW_"+e+"]").html("<nobr class='ewa-lf-sub'>"+g.fm(b)+"</nobr>")}};this.ChangeRowStyle=function(a,b,d){for(var e=$X("EWA_LF_"+this._Id),g=1;g<e.rows.length;g++){var h=e.rows[g];if(!(0==h.cells.length||h.cells.length<=a)){var k=h.cells[a].childNodes[0].getAttribute(b);if(null!=k&&d[k])for(var l=0;l<h.cells.length;l++)h.cells[l].style.cssText=h.cells[l].style.cssText+";"+d[k]}}if(null==this.ReloadAfter){var m=this;this.ReloadAfter=function(){m.ChangeRowStyle(a,b,d)}}};this.MDownEvent=
function(a,b){};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.Workflow=function(a,b,d,e,g,h){EWA.F.CID=this._Id;this._Ajax=this.CreateAjax();this._Ajax.AddParameter("EWA_AJAX","WORKFLOW");this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_WF_NAME",b);null!=d?(a=this.GetRowKey(d),this._Ajax.AddParameter("EWA_ACTION_KEY",a),"true"==d.getAttribute("ewa_wf_control")?this._Ajax.AddParameter("EWA_WF_CTRL",1):this._Ajax.AddParameter("EWA_WF_CTRL",
0)):this._Ajax.AddParameter("EWA_WF_CTRL",1);null!=e&&this._Ajax.AddParameter("EWA_ACTION_KEY",e);g&&this._Ajax.AddParameter("EWA_WF_UOK",g);h&&this._Ajax.AddParameter("EWA_WF_UMSG",h);var k=this;this._Ajax.PostNew(this.Url,function(){k._CallBackJs()})};this.GetRowKey=function(a){a=this.GetRow(a);return null!=a?a.getAttribute("EWA_KEY"):null};this.GetRow=function(a){if(null==a||null==a.tagName||""==a.tagName)return null;var b=0;for(a=a.parentNode;"TR"!=a.tagName||null==a.getAttribute("EWA_KEY");){a=
a.parentNode;if("BODY"==a.tagName){a=null;break}b++;if(100<b){alert("\u5faa\u73af100\u6b21\uff0c\u672a\u53d1\u73b0TR");break}}return a};this.RecordModify=function(a,b,d){var e=this.SelectChecked();if(0==e.length)EWA.UI.Msg.Alter("\u8bf7\u5148\u9009\u62e9","\u4fee\u6539");else{var g="EWA_MTYPE=M";null!=d&&0<d.trim().length&&(g+="&"+d);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,g+e)}};this.RecordNew=function(a,b,d){var e="EWA_MTYPE=N";null!=d&&0<d.trim().length&&(e+="&"+d);EWA.UI.Dialog.OpenReloadClose(this._Id,
a,b,!1,e)};this.SelectSingle=function(){this.IsTrSelect=!0;this._TrSelectMulti=!1};this.SelectMulti=function(){this._TrSelectMulti=this.IsTrSelect=!0};this.MOver=function(a,b){if(this.IsTrSelect&&this._CurTr!=a&&(null!=this._CurTr&&("1"!=this._CurTr.getAttribute("__ewa_lf_mdown")?this._MSetBg(this._CurTr,""):this._MSetBg(this._CurTr,"down")),"1"!=a.getAttribute("__ewa_lf_mdown")?this._MSetBg(a,"over"):this._MSetBg(a,"down"),this._CurTr=a,this.MOverEvent))try{this.MOverEvent(a,b)}catch(d){console.log(d,
...
b.tagName||"SELECT"==b.tagName||"BUTTON"==b.tagName||"TEXTAREA"==b.tagName||0<=b.className.indexOf("EWA_LF_EDIT")||0<=b.className.indexOf("ewa-lf-edit")||0<=b.className.indexOf("ewa-lf-search-text-click")||0<=b.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=b.parentNode.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=b.className.indexOf("ewa-mdown-stop")?!1:!0};this.mDownAutoCheck=function(a,b,d){for(var e,g=0;g<b.length&&!(0<=b[g].parentNode.className.indexOf("ewa-switch"));g++){if("RADIO"==
b[g].type.toUpperCase())return e=b[g],e.click(),e;if("CHECKBOX"==b[g].type.toUpperCase()){e=b[g];e.click();if(!this._TrSelectMulti){var h=$(b[g]).attr("id")||$(b[g]).attr("name");0==$(d).find(b[g]).length&&$(a).siblings(".ewa-lf-data-row").find("input[name='"+h+"']:checked").prop("checked",!1);e.checked=!0}return e}}return null};this.MDown=function(a,b){if(this.IsTrSelect){var d=(new Date).getTime(),e=$(a).attr("mdown_time_last");if(!(null!=e&&500>d-e)&&($(a).attr("mdown_time_last",d),b=null==b?window.event:
b,this.MDownEnableCheck(a)&&this.checkMDownEnable(a,b))){e=b.srcElement?b.srcElement:b.target;var g=null;d=a.getElementsByTagName("input");this.IsNotMDownAutoChecked||(g=this.mDownAutoCheck(a,d,e));if("1"==a.getAttribute("__ewa_lf_mdown"))this._TrSelectMulti&&(g&&"CHECKBOX"==g.type.toUpperCase()&&(g.checked=!1),this._MSetBg(a,""),a.removeAttribute("__ewa_lf_mdown"),$(a).removeClass("ewa-lf-mdown"));else{g&&(g.checked=!0);this._MSetBg(a,"down");a.setAttribute("__ewa_lf_mdown",1);$(a).addClass("ewa-lf-mdown");
if(!this._TrSelectMulti&&(g=a.parentNode)&&g.rows)for(e=0;e<g.rows.length;e++){var h=g.rows[e];"1"==h.getAttribute("__ewa_lf_mdown")&&h!=a&&(h.removeAttribute("__ewa_lf_mdown"),$(h).removeClass("ewa-lf-mdown"),this._MSetBg(h,""))}if(this.IsReShow)for(e=0;e<d.length;e++)"BUTTON"==d[e].type.toUpperCase()&&(g=d[e],"true"==g.getAttribute("disabled")||1==g.getAttribute("disabled")||"true"==g.parentNode.getAttribute("disabled")||1==g.parentNode.getAttribute("disabled")?(this._ReshowButs[g.value].disabled=
!0,this._ReshowButs[g.value].style.display="none"):(this._ReshowButs[g.value].disabled=!1,this._ReshowButs[g.value].style.display=""))}if(this._IsAddPreRow){if(d=a.getAttribute("ewa_key"),this.AddPreRowCheck(a,d,b)){g=a.parentNode.rows[a.rowIndex+1];if(null==g||1!=g.getAttribute("add_pre_row"))g=a.parentNode.parentNode,e=g.rows[0].cells.length,g=g.insertRow(a.rowIndex+1),g.setAttribute("add_pre_row",1),h=g.insertCell(-1),h.colSpan=e,h.className="ewa-lf-add-pre-cell",g.style.display="none",h.id=EWA_Utils.tempId("EWA_LF_NR_"+
this._Id),$(g).addClass("ewa-lf-add-pre-row");this.prevTr&&(this.AddPreRowCloseBeforeEvent&&this.AddPreRowCloseBeforeEvent(this._Id,a,d,this.prevTr,b),this.prevTr.style.display="none",this.prevTr.cells[0].innerHTML="",this.AddPreRowCloseEvent&&this.AddPreRowCloseEvent(this._Id,a,d,this.prevTr,b));this.prevTr==g?this.prevTr=null:(this.prevTr=g,this.prevTr.style.display="",this.MDownEvent(this._Id,a,d,this.prevTr,b))}}else this.MDownEvent(a,b)}}};this.AddPreRow=function(a){this._IsAddPreRow||(this.MDownEvent=
a);this._IsAddPreRow=!0};this.AddPreRowCheck=function(a,b,d){return!0};this.AddPreRowCloseBeforeEvent=function(a,b,d,e,g){};this.AddPreRowCloseEvent=function(a,b,d,e,g){};this._MSetBg=function(a,b){var d="EWA_TD_M";"down"==b?d="ewa_grid_down":"over"==b&&(d="ewa_grid_mover");for(b=0;b<a.cells.length;b++)$(a.cells[b]).removeClass("ewa_grid_mover ewa_grid_down EWA_TD_M").addClass(d)};this._ReShowSearchQuick=function(){var a=this,b=EWA_ListFrameClass.prototype.RESOURCES.search_text_items,d,e,g;for(g in b){var h=
b[g];"eq"==h.Id&&(d=h);"lk"==h.Id&&(e=h)}for(g in this._SearchJson){var k=this._SearchJson[g];k.isSearchQuick&&(b=$("#EWA_LF_"+this.Id+' .ewa-lf-data-row [id="'+g+'"]'),b.bind("click",function(l){l.stopPropagation();l=$(this).attr("search_tag");var m=$(this).text(),n=m,p=$("#EWA_SEARCH_ITEM_"+a.Id+' .ewa-lf-search-item-ctl [name="'+this.id.toUpperCase()+'"]');if("number"==l||"date"==l)p=p.parentsUntil(".ewa-lf-search-item").last().find("input");var q=p.parentsUntil(".ewa-lf-search-item").last().find("a");
if("date"==l)m=m.split(" ")[0],n=m+" 23:59:59";else if("fix"==l){var u=null;p.find("option").each(function(){this.text==m&&(u=this.value)});m=null===u?"":u}p.val()==m?("text"==l&&e&&0<q.length&&(q.attr("tag",e.Id),q.html("enus"==EWA.LANG?e.TxtEn:e.Txt)),p.val("")):("text"==l&&d&&0<q.length&&(q.attr("tag",d.Id),q.html("enus"==EWA.LANG?d.TxtEn:d.Txt)),p.val(m),"date"==l&&(p[1].value=n))}),b.each(function(){$(this).text()&&$(this).addClass("ewa-lf-search-text-click").attr("search_tag",k.T)}))}};this.ReShowWithNoButtons=
function(){var a=$X("EWA_LF_"+this._Id),b=[],d;for(d in this.ItemList.Items){var e=this.ItemList.Items[d],g=this._GetSubValue("Tag","Tag",e);if(null!=g&&"button"==g.trim().toLowerCase())for(g=0;g<a.rows[0].cells.length;g++)if(a.rows[0].cells[g].childNodes[0].id.toUpperCase()==d){b.push(g);e.setAttribute("but_show","1");break}}this.ShowHiddenColumns(b,!1)};this.ReShowButtonsInDailogTitle=function(){EWA.OW.Load();if(EWA.OW.Dia){var a=$(EWA.OW.Dia._Dialog.GetFrameTitle()),b=$($X("EWA_RESHOW_"+this._Id)).find("td.ewa_lf_func:eq(0)"),
d=this;b.find(".ewa_lf_func_dact").each(function(){this.id=EWA_Utils.tempId("gDx_"+d._Id+"_")});a.html(b.html());a.find(".ewa_lf_func_dact").each(function(){this.onclick=function(){b.find('div[id="'+this.id+'"]').click()}});b.parent().hide();$(EWA.OW.Dia._Dialog.GetFrame()).addClass("ewa-lf-btns-in-title")}};this.ReShow=function(a){this.IsReShow=!0;var b="_G_"+this._Id;this.NewDivId=b;a=[];a.push("<table class='ewa-lf-reshow' id='EWA_RESHOW_"+this._Id+"'>");a.push("<tr style='display:none'><td style='padding:0'></td></tr>");
a.push("<tr><td class='ewa_lf_func' style='padding:0'>");a.push("<div style='display:none'></div>");a.push("<div><div style='cursor:pointer' class='ewa_lf_func_caption'></div></div>");a.push("</td></tr>");a.push("<tr><td style='width:100%;padding:0;vertical-align:top'>");a.push("<div id='"+b+"' style=''></div>");a.push("</td></tr>");a.push("</table>");var d=$(a.join("")),e=!(0<this.Url.toUpperCase().indexOf("EWA_AJAX=INSTALL")||0<this.Url.toUpperCase().indexOf("EWA_CALL_METHOD=INNER_CALL")||0<this.Url.toUpperCase().indexOf(".JSP"));
e?EWA.UI.Utils.SetStyle(d[0],"width:100%;height:100%;border-spacing:0"):EWA.UI.Utils.SetStyle(d[0],"width:100%;border-spacing:0");css="";var g=$X("EWA_LF_"+this._Id);a=g.parentNode.parentNode;var h=g.parentNode;d.find("td:eq(2)>div").append(h);h=d[0];var k=d.find("tr:eq(0)")[0],l=d.find("td:eq(0)")[0],m=d.find("td:eq(1)")[0],n=d.find("td:eq(2)")[0];e&&(window.setTimeout(function(){$X("__EWA_DEBUG")&&n.childNodes[0].appendChild($X("__EWA_DEBUG"));var B=$X(b);B.getElementsByTagName("table");var D=EWA.UI.Utils.GetDocSize(window),
E=B.parentNode.parentNode.previousSibling.offsetHeight;B.style.top=E+"px";B.style.height=D.H-E+"px"},100),addEvent(window,"resize",function(){var B=$X(b),D=EWA.UI.Utils.GetDocSize(window),E=B.parentNode.parentNode.previousSibling.offsetHeight;B.style.top=E+"px";B.style.height=D.H-E+"px"}));for(;0<a.childNodes.length;)m.childNodes[0].appendChild(a.childNodes[0]);d=d.find(".ewa_lf_func_caption")[0];var p=!1;e=GetInnerText(m);e=e.trim();this._ReshowButs={};g=$(g.rows[0]);for(var q in this.ItemList.Items){var u=
this.ItemList.Items[q],r=this._GetSubValue("Tag","Tag",u);if(r&&("button"==r.toLowerCase()||"butflow"==r.toLowerCase())&&(r=this._GetSubValue("Name","Name",u),0!==g.find(".ewa-col-"+r).length)){p=!0;var t=this._GetSubValue("DescriptionSet","Info",u),w=this._GetSubValue("DescriptionSet","Memo",u),v=this._GetSubValue("EventSet","EventName",u),y="";null!=v&&"ewa_click"==v.toLowerCase().trim()&&(y=this._GetSubValue("EventSet","EventValue",u));e=e.replace(t,"");u=this._ReShowButton(t,w,null);this._ReshowButs[t]=
u;u.setAttribute("f_id",this._Id);u.setAttribute("t_id",r);m.childNodes[1].appendChild(u);""==y?u.setAttribute("onclick","EWA.F.FOS['"+this._Id+"'].reShowButtonClick(this)"):u.setAttribute("onclick",y)}}p&&this._ReShowSplit(m.childNodes[1]);r=m.getElementsByTagName("input");p={};for(g=0;g<r.length;g++){var x=r[g];x.style.display="none";if(null==x.id||""==x.id)x.id=("_tmp_"+Math.random()).replace(".","_");if("button"==x.type){if(u=this._ReShowButton(x.value,x.title,x.id),t=x.nextSibling){var z="";
3==t.nodeType&&(z=t.nodeValue.trimEx());"|"==z&&this._ReShowSplit(m.childNodes[1])}}else(t=x.nextSibling)&&(z=3==t.nodeType?t.nodeValue.replace("|",""):t.innerHTML),u=this._ReShowButton(z.trimEx(),x.title,x.id),u.id=("_tmp_"+Math.random()).replace(".","_"),p[x.name]||(p[x.name]=[]),p[x.name].push(u.id);m.childNodes[1].appendChild(u)}e=e.replace(/ /ig,"").replace(/\|/ig,"").trimEx();""!=e?0<=e.indexOf("if")?k.style.display="none":l.innerHTML=e.replace(/ /,""):k.style.display="none";a.appendChild(h);
for(q in p)for(z=p[q],g=0;g<z.length;g++)x=$X(z[g]),x.setAttribute("_r_ids",z.join(",")),x.onclick=function(){var B=this.getAttribute("_ewa_event_id");$X(B).click();B=this.getAttribute("_r_ids").split(",");for(var D=0;D<B.length;D++)x.id!=B[D]&&($X(B[D]).style.fontWeight="",$X(B[D]).style.color="");this.style.fontWeight="bold";this.style.color="blue"};d.innerHTML='<b><i class="fa fa-star-o">&nbsp;</i>'+this.Description+"</b>";if(0<this.Url.toUpperCase().indexOf("EWA_BTNS_IN_TITLE"))var A=this,C=0,
F=setInterval(function(){C++;1E3<C&&window.clearInterval(F);EWA.OW.Load();EWA.OW.Dia&&(window.clearInterval(F),A.ReShowButtonsInDailogTitle())},10)};this.reShowButtonClick=function(a){a=a.getAttribute("t_id");var b=this.SelectCheckedRows();if(null==b||0==b.length)EWA.UI.Msg.Alert(_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM"],_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM_TITLE"]);else{b=b[0].getElementsByTagName("input");for(var d=0;d<b.length;d++){var e=b[d];if(e.name===a){e.click();break}}}};this._ReShowSplit=function(a){EWA.UI.Utils.CreateObject(window,
"div","",a).className="ewa_lf_func_split"};this._ReShowButton=function(a,b,d){var e=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",document.body);e.innerHTML="<nobr>"+a+"</nobr>";null!=d&&(e.setAttribute("_ewa_event_id",d),e.onclick=function(){var g=this.getAttribute("_ewa_event_id");$X(g).click()});EWA.B.IE&&(e.onselectstart=function(){return!1});e.className="ewa_lf_func_dact";e.title=b;return e};this.CheckValid=function(a){var b=a.tagName.toLowerCase();if("span"==b||"img"==b||"div"==b)return!0;
b=this.ItemList.GetObjectValue(a);return this.ItemList.CheckValid(a,b)};this.ShowEdit=function(a){a.parentNode.style.width=a.clientWidth+"px";a.style.display="none";__show_obj__=a.nextSibling;__show_obj__.style.display="";var b=__show_obj__.childNodes[0];3==b.nodeType&&(b=__show_obj__.childNodes[1]);b.setAttribute("old",b.value);"SELECT"!=b.tagName||b.getAttribute("func")||(b.setAttribute("func",1),b.onchange=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)});null==b.getAttribute("__ewa_fid__")&&
(b.setAttribute("__ewa_fid__",this._Id),b.onblur=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)},b.onkeydown=function(d){d=null==d?window.event:d;var e=d.target?d.target:d.srcElement;13==d.keyCode&&"INPUT"==e.tagName&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this);27==d.keyCode&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditReset(this)});setTimeout(function(){b.focus()},10)};this.EditReset=function(a){a.parentNode.style.display="none";var b=a.parentNode.previousSibling;
b.style.display="";b.innerHTML=a.getAttribute("old");"select"==a.tagName.toLowerCase()?b.innerHTML=a.options[a.selectedIndex].text:a.value=a.getAttribute("old").replace(/</ig,"&lt;").replace(/>/ig,"&gt;")};this.EditAfter=function(a){if(this.CheckValid(a))if(a.getAttribute("old")==a.value)this.EditReset(a);else{a.parentNode.style.display="none";var b=a.parentNode.previousSibling;b.style.display="";if("droplist"==a.getAttribute("ewa_class")){var d=$(a.parentNode.getElementsByTagName("input")[1]).attr("name");
var e=a.parentNode.getElementsByTagName("input")[1].value;b.innerHTML=a.parentNode.getElementsByTagName("input")[0].value}else"select"==a.tagName.toLowerCase()?(d=$(a).attr("name"),b.innerHTML=a.options[a.selectedIndex].text):(d=a.value.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/\n/ig,"<br>"),b.innerHTML=d,d=$(a).attr("name")),e=a.value;b=a.getAttribute("action_name");if(""==b||null==b)b="OnListFrameUpdateCell";var g=a.getAttribute("action_confirm");g=null==g?"":g;var h=a.getAttribute("action_tip");
null==h&&(h="");var k=a.getAttribute("action_js"),l=this.ItemList.GetValue(d,"DataItem","DataType");d=[{Name:"EWA_FIELD_ID",Value:d},{Name:"EWA_FIELD_VAL",Value:e},{Name:"EWA_ACTION_RELOAD",Value:"0"},{Name:d,Value:e},{Name:"EWA_DATA_TYPE",Value:l},{Name:"EWA_FIELD_VAL_OLD",Value:a.getAttribute("old")}];this.EditEvent={FROM:a,OLD_VAL:a.getAttribute("old"),NEW_VAL:a.value};this.DoAction(a,b,g,h,d,k)}else a.focus()};this.RewriteInfo=function(a,b,d,e){var g=$("#EWA_LF_"+this._Id);if(a)this._INFO={},
this._INFO.INFO=a,this._INFO.ID_NAME=b||"id",this._INFO.INFO_NAME=d||"info",this._INFO.MEMO_NAME=e||"memo";else if(!this._INFO||!this._INFO.INFO)return;for(a=0;a<this._INFO.INFO.length;a++){var h=this._INFO.INFO[a];d=g.find('[id="'+h[this._INFO.ID_NAME]+'"]:eq(0)');if(0!==d.length)if(b=d.parentsUntil("tr").last(),e=h[this._INFO.INFO_NAME],h=h[this._INFO.MEMO_NAME],null==e||""==e.trim())for(d=b.parent()[0],e=0;e<d.cells.length;e++){if(d.cells[e]==b[0]){this.ShowHiddenColumn(e,!1);break}}else 0==d.children().length?
d.text(e):d.children()[0].innerText=e,h&&d.attr("title",h)}};this.ShowHiddenColumn=function(a,b){var d=$X("EWA_LF_"+this._Id),e="";if(null==b||0==b||"none"==b)e="none";for(b=0;b<d.rows.length;b++)d.rows[b].cells.length==d.rows[0].cells.length&&(d.rows[b].cells[a].style.display=e)};this.ShowHiddenColumns=function(a,b){var d=$X("EWA_LF_"+this._Id),e="";if(null==b||0==b||"none"==b)e="none";b=d.rows[0].cells.length;for(var g=0;g<d.rows.length;g++){var h=d.rows[g];if(h.cells.length==b)for(var k=0;k<a.length;k++)h.cells[a[k]].style.display=
e}};this.GroupShowHidden=function(a){var b=$(a).attr("t"),d=(new Date).getTime();if(!(b&&333>d-b)){$(a).attr("t",d);b=a.parentNode.parentNode;d=b.getAttribute("ewa_group");""==d?(d="none",a.childNodes[0].innerHTML=" + "):(d="",a.childNodes[0].innerHTML=" - ");b.setAttribute("ewa_group",d);for(var e=b.parentNode.parentNode,g=0,h=b.rowIndex+1;h<e.rows.length;h++){b=e.rows[h];if("group"==b.getAttribute("ewa_tag"))break;b.getAttribute("add_pre_row")?"none"==d?("none"!=b.style.display&&b.setAttribute("ewa_group_show_old",
b.style.display),b.style.display="none"):b.hasAttribute("ewa_group_show_old")&&(b.style.display=b.getAttribute("ewa_group_show_old"),b.removeAttribute("ewa_group_show_old")):(b.style.display=d,g++)}a.childNodes[a.childNodes.length-1].innerHTML=" ("+g+")"}};this.Sort=function(a){var b=this._last_sort_timer||0,d=this._Sort||"",e=(new Date).getTime();d==a&&500>e-b||(this._last_sort_timer=e,this._Sort=a,this.Goto(1))};this.SearchClear=function(a){a=a.parentNode.parentNode.parentNode.parentNode;for(var b=
0;b<a.rows.length;b+=1)for(var d=a.rows[b].getElementsByTagName("input"),e=0;e<d.length;e++){var g=d[e];if("text"==g.type)g.value="";else if("radio"==g.type||"checkbox"==g.type)g.checked=!1}};this.SearchGetExpInit=function(){var a=$("#_G_"+this._Id),b=[];$(a).find(".ewa-lf-search-item").each(function(){var d=$(this).find("input");if(0==d.length&&(d=$(this).find("select"),0==d.length))return;var e=d[0],g=$(e).attr("t");if(1==d.length){var h=e.value;if(""!=e.value.trim())for("text"==g&&(d=$(e.parentNode.parentNode).find("a").attr("tag"))&&
(g=d),e=e.name.split(","),d=0;d<e.length;d++)b.push(e[d]+"["+g+"]"+h)}else if(("date"==g||"number"==g)&&2==d.length){if(h=e.value,g=d[1].value,""!=g||""!=h)b.push(e.name+"[gte]"+h),g&&b.push(e.name+"[lte]"+g)}else if("fix"==g&&"INPUT"==e.tagName){var k=[""];$(this).find("input").each(function(){this.checked&&k.push(this.value)});1!=k.length&&b.push(e.name+"[or]"+k.join(";"))}});return b.join(",")};this.SearchGetExp=function(a){var b=[];$(a).find(".ewa-lf-search-item").each(function(){var d=$(this).find("input");
if(0==d.length&&(d=$(this).find("select"),0==d.length))return;var e=d[0],g=$(e).attr("t");if(1==d.length){var h=e.value;""!=e.value.trim()&&("text"==g&&(d=$(e.parentNode.parentNode).find("a").attr("tag"))&&(g=d),b.push("@!@"+e.name+"~!~"+g+"~!~"+h))}else if(("date"==g||"number"==g)&&2==d.length)h=e.value,d=d[1].value,""==d&&""==h||b.push("@!@"+e.name+"~!~"+g+"~!~"+h+"~!~"+d);else if("fix"==g&&"INPUT"==e.tagName){var k=[""];$(this).find("input").each(function(){this.checked&&k.push(this.value)});1!=
k.length&&b.push("@!@"+e.name+"~!~"+g+k.join("~!~"))}});return b.join("")};this.DoSearch=function(a){var b=!1;a.id=="EWA_SEARCH_ITEM_"+this.Id?a=$X("EWA_SEARCH_ITEM_"+this.Id).childNodes[0]:(a=a.parentNode.parentNode.parentNode.parentNode,b=!0);this._SearchExp=this.SearchGetExp(a);b&&(this._SearchHtml=a.parentNode.innerHTML,this._SearchDialog.Show(!1));this.Goto(1)};this.Search=function(a){null==this._SearchHtml?(this._SearchCreate(),this._SearchDialog=new EWA.UI.Dialog.OpenWindow("about:blank","aa",
400,100,!0,null,null,!1),this._SearchDialog.SetCaption(_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.TITLE"]),this._SearchDialog._Dialog.AutoSize=!0,this._SearchDialog._Dialog.SetHtml(this._SearchHtml),this._SearchDialog._Dialog.Show(!0),this._SearchDialog._Dialog.GetFrame().focus(),this._SearchDialog.MoveCenter()):(this._SearchDialog._Dialog.AutoSize=!1,this._SearchDialog.Show(!0))};this.ShowSearch=function(a){$X("EWA_SEARCH_ITEM_"+this.Id)||(this._SearchCreateItm(),a&&this.composeSearchTexts(),this._ReShowSearchQuick())};
this.ChangeSearchTextType=function(a){this._MENU_DATE_RANGE&&this._MENU_DATE_RANGE.HiddenMemu();this._MENU_TEXT_TYPE.ShowByObject(a,null,0);var b=$(this._MENU_TEXT_TYPE.Dialog.GetFrame());b.find(".search-text-tag").remove();b.find('div[ewa_mg="'+$(a).attr("tag")+'"] td:eq(0)').html('<b class="fa fa-check search-text-tag"></b>')};this.ChangeSearchDateType=function(a){this._MENU_TEXT_TYPE&&this._MENU_TEXT_TYPE.HiddenMemu();this._MENU_DATE_RANGE.ShowByObject(a,null,0)};this.ChangeSearchTextTypeIt=function(a){var b=
$(this._MENU_TEXT_TYPE.SHOW_BY_OBJECT).parentsUntil(".ewa-lf-search-item").last(),d=$J2MAP(this.RESOURCES.search_text_items,"Id")[a];d="enus"==EWA.LANG?d.TxtEn:d.Txt;b.find("a").attr("tag",a).html(d);var e=b.find("input");"blk"==a||"nblk"==a?e.val(d).prop("disabled",!0):e.prop("disabled")&&b.find("input").val("").prop("disabled",!1)};this._GetInitSearchMap=function(){var a=new EWA_UrlClass(this.Url),b={},d=a.GetParameter("ewa_search");if(!d)return b;this.Url=a.RemoveParameter("ewa_search");d=d.unURL();
a=d.split(",");for(var e in a){var g=a[e],h=g.indexOf("["),k=g.indexOf("]");0>h||k<h||(d=g.substring(0,h).trim(),0!=d.length&&(h=g.substring(h+1,k).trim().toLowerCase(),0!=h.length&&(g=g.substring(k+1).trim(),""!=g&&(b[d.toUpperCase()]||(b[d.toUpperCase()]={name:d,tag:h}),d=b[d.toUpperCase()],"lt"==h||"lte"==h?d.para2=g.unURL():d.para1=g.unURL()))))}return b};this.SearchFilterDate=function(a){var b=$(this._MENU_DATE_RANGE.SHOW_BY_OBJECT).parentsUntil(".ewa-lf-search-item").last(),d=b.find("input")[0];
b=b.find("input")[1];if("Clear"==a)$(d).val(""),$(b).val("");else{var e=EWA_Utils.Date(),g="",h="";"Today"==a?h=g=e.GetDateString():"Week"==a?(a=e.GetBenWeek(),g=a[0],h=a[1]):"Today-Weekend"==a?(a=e.GetBenWeek(),g=a[e.GetDateString()],h=a[1]):"Month"==a?(a=e.GetBenMonth(),g=a[0],h=a[1]):"Today-EOM"==a?(a=e.GetBenMonth(),g=a[e.GetDateString()],h=a[1]):"Quarter"==a?(a=e.GetBenQ(),g=a[0],h=a[1]):"Today-EOQ"==a?(a=e.GetBenQ(),g=a[e.GetDateString()],h=a[1]):"Year"==a?(a=e.GetBenYear(),g=a[0],h=a[1]):"Today-EOY"==
a&&(a=e.GetBenYear(),g=a[e.GetDateString()],h=a[1]);a=EWA_Utils.Date(g).FormatDate();e=EWA_Utils.Date(h).FormatDate();e+=" 23:59:59";$(d).val(a);$(b).val(e)}};this._SearchCreateDateRange=function(){var a="_MENU_DATE_RANGE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",d=JSON.parse(JSON.stringify(this.RESOURCES.search_date_items)),e="EWA.F.FOS[&quot;"+this._Id+"&quot;].SearchFilterDate",g;for(g in d){var h=d[g];h.Txt=h[b];h.Cmd=e+"(&quot;"+h.Id+"&quot;)"}b="EWA.F.FOS[&quot;"+
this._Id+"&quot;]._MENU_DATE_RANGE";this._MENU_DATE_RANGE=new EWA_UI_MenuClass(b);this._MENU_DATE_RANGE.Create(d);$(this._MENU_DATE_RANGE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+a);return b};this._SearchCreateTextType=function(){var a="_MENU_TEXT_TYPE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",d=JSON.parse(JSON.stringify(this.RESOURCES.search_text_items)),e="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextTypeIt",g;for(g in d){var h=d[g];h.Txt=h[b];
h.Cmd=e+"(&quot;"+h.Id+"&quot;)";h.Group=h.Id}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_TEXT_TYPE";this._MENU_TEXT_TYPE=new EWA_UI_MenuClass(b);this._MENU_TEXT_TYPE.Create(d);$(this._MENU_TEXT_TYPE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+a);this._MENU_TEXT_TYPE.clickBeforeEvent=function(k,l){$(this.Dialog.GetFrame()).find(".search-text-tag").remove();$(l).find("td:eq(0)").html('<b class="fa fa-check search-text-tag"></b>')};return b};this._SearchCreateItm=function(){var a="EWA_SEARCH_ITEM_"+
this.Id,b=[],d=[],e=[],g={},h;for(h in this._SearchJson)this._SearchJson[h].ORI_NAME=h,g[h.toUpperCase()]=this._SearchJson[h];this._SearchJson=g;var k="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextType(this)",l="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchDateType(this)",m=$J2MAP(this.RESOURCES.search_text_items,"Id");g=this._GetInitSearchMap();var n=!1,p=!1;for(h in this.ItemList.Items)if(null!=this._SearchJson[h]){var q=[],u=this._SearchJson[h],r=u.T,t=this._GetSubValue("DescriptionSet",
"Info",this.ItemList.Items[h]);q.push("<table class='ewa-lf-search-item ewa-ref-"+h+" ewa-lf-search-type-"+r+" "+("fix"==r?"ewa-lf-search-fix-m"+(u.M||"0"):"")+"' cellspacing=0 cellpadding=0>");q.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");q.push(t);var w=t="",v="lk";g[h.toUpperCase()]&&(w=g[h.toUpperCase()],v=w.tag,t=w.para1,w=w.para2);var y="";"text"==r?(p=m[v]||m.lk,y="enus"==EWA.LANG?p.TxtEn:p.Txt,q.push("<a class='ewa-lf-search-type' tag='"+v+"' href='javascript:void(0)' onclick='"+
k+"'>"),q.push(y),q.push("</a>"),p=!0):"date"==r&&(q.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+l+"'></a>"),n=!0);q.push("</b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==r?"blk"==v||"nblk"==v?(u=this._SearchSingle(h,y),u=u.replace("<input","<input disabled "),q.push(u)):q.push(this._SearchSingle(h,t)):"date"==r?q.push(this._SearchDate(h,t,w)):"number"==r?q.push(this._SearchNumber(h,t,w)):"fix"==r&&(u="<div >"+this._SearchFix(h,u,"span",t)+"</div>",
q.push(u));q.push("</td></tr></table>");"fix"==r?d.push(q.join("")):e.push(q.join(""))}if(0!=e.length+d.length){b.push('<table class="ewa-lf-search-main" id="'+a+'" cellspacing="0" cellpadding="0" style="width:100%">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");0<e.length&&b.push(" "+e.join("")+" ");if(0<d.length)for(e=0;e<d.length;e++)b.push(" "+d[e]+" ");b.push("</td></tr></table>");var x=document.createElement("div");this._SEARCH_BOX=x;x.className="ewa-lf-search";x.innerHTML=b.join("");
b=$X("EWA_LF_"+this.Id).parentNode;b.parentNode.insertBefore(x,b);a="EWA_SEARCH_ITEM_"+this.Id;var z=this;n&&this._SearchCreateDateRange();p&&this._SearchCreateTextType();z._SEARCH_ITEM_EXP=this.SearchGetExp(x);"{}"!=JSON.stringify(g)&&(z._SearchExp=z._SEARCH_ITEM_EXP);$(x).find("input[type=text]").on("compositionstart",function(){z._is_search_composition=!0}).on("compositionend",function(){z._is_search_composition=!1});this._TIMER_SEARCH=window.setInterval(function(){if(!z._is_search_composition){try{if(!$X(a)){window.clearInterval(z._TIMER_SEARCH);
return}}catch(C){window.clearInterval(z._TIMER_SEARCH);return}var A=z.SearchGetExp(x);A!=z._SEARCH_ITEM_EXP&&(z._SEARCH_ITEM_EXP=A,z.DoSearch($X(a)))}},700)}};this._SearchSingle=function(a,b){var d=[];d.push('<input t="text" type="text" autocomplete="off" class="EWA_INPUT" maxlength="40" name="');d.push(a.toInputValue());d.push('"');null!=b&&(d.push(' value="'),a=b.toInputValue(),d.push(a),d.push('" '));d.push(" />");return d.join("")};this._SearchDate=function(a,b,d){var e=[];e.push("<table border=0 cellpadding=0 cellspacing=0>");
e.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');e.push(a);e.push('"');b&&(b=b.toInputValue(),e.push(' value="'),e.push(b),e.push('"'));e.push(' /></td><td><span class="ewa-lf-search-split"> - </span></td>');e.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');e.push(a);e.push('1"');d&&(b=d.toInputValue(),e.push(' value="'),
e.push(b),e.push('"'));e.push("/></td></tr></table>");return e.join("")};this._SearchNumber=function(a,b,d){var e=[];e.push('<input type="text" t="number" size="10" name="');e.push(a);e.push('"');b&&(b*=1,e.push(' value="'),e.push(b),e.push('"'));e.push(' /><span class="ewa-lf-search-split"> - </span>');e.push('<input type="text" t="number" size="10" name="');e.push(a);e.push('1"');d&&(b=1*d,e.push(' value="'),e.push(b),e.push('"'));e.push("/>");return e.join("")};this._SearchFix=function(a,b,d,e){var g=
[],h="radio";if("1"==b.M)h="checkbox";else if("2"==b.M)return this._SearchFix1(a,b,d,e);d="<"+d+"><nobr><input t='fix' [@CHK] id='@ID' value=\"@V\" type='"+h+"' name='"+a+"' /><label for='@ID'>@T</label></nobr></"+d+"> ";h={};if(e){e=e.split(";");for(var k in e)h[e[k].trim().toUpperCase()]=1}for(k=0;k<b.D.length;k++){var l=b.D[k];e=l[0];l=l[1];var m=this.Id+"_"+a+"_SearchFix_"+k,n=d.replace("@ID",m);n=n.replace("@ID",m);n=n.replace("@V",e);n=h[e.toUpperCase().trim()]?n.replace("[@CHK]","checked"):
n.replace("[@CHK]","");n=n.replace("@T",l);g.push(n)}return g.join("")};this._SearchFix1=function(a,b,d,e){d=[];d.push("<select t='fix' name='"+a+"'><option></option>");for(var g=0;g<b.D.length;g++){var h=b.D[g],k="<option @CKD t='fix' id='@ID' value=\"@V\">@T</option> ".replace("@ID",this.Id+"_"+a+"_SearchFix_"+g);k=k.replace("@V",h[0]);k=k.replace("@T",h[1]);k=e&&h[0]==e?k.replace("@CKD","selected"):k.replace("@CKD","");d.push(k)}d.push("</select>");return d.join("")};this._SearchCreate=function(){var a=
[];a.push("<div><table border=0 style='margin:0px;' class=EWA_TABLE cellspacing=1>");for(var b in this.ItemList.Items)if(null!=this._SearchJson[b]){var d=this._SearchJson[b],e=d.T,g=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[b]);a.push("<tr><td class=EWA_TD_L width=140><nobr>"+g+"<nobr></td><td width=350 class=EWA_TD_M>");"text"==e?a.push(this._SearchSingle(b)):"date"==e?a.push(this._SearchDate(b)):"number"==e?a.push(this._SearchNumber(b)):"fix"==e&&a.push(this._SearchFix(b,d,"div"));
...
this._SearchHtml=a.join("")};this.SearchMark=function(){for(var a=this._SearchExp.split("@!@"),b=$X("EWA_LF_"+this._Id),d=0;d<a.length;d+=1){var e=a[d].split("~!~");if(!(3>e.length))for(var g=2;g<e.length;g++){var h=e[g];if(""!=h){if("fix"==e[1]){var k=e[2];$("table#EWA_SEARCH_ITEM_"+this.Id+' [name="'+e[0]+'"]').find("option").each(function(){this.value==k&&(h=this.text)})}for(var l=[],m=0;m<h.length;m++){var n=h[m];"a"<=n&&"z">=n||"A"<=n&&"Z">=n||"0"<=n&&"9">=n?l.push(n):l.push("\\"+n)}h=l.join("");
h=eval("/("+h+")/ig");l=e[0].split(",");for(var p in l){m=l[p];this._SearchJson[m]&&(m=this._SearchJson[m].ORI_NAME);m=$(b).find(".ewa-lf-data-row .ewa-col-"+m).not("[ewa-search-marked=yes]");m.attr("ewa-search-marked","yes");try{m.find("*").each(function(){0==this.children.length&&(this.innerHTML=this.innerHTML.replace(h,"<font color=red><b>$1</b></font>"))})}catch(q){console.log(q)}}}}}};this.DblClick=function(a){this._IsDblClick=a;for(var b=$X("EWA_LF_"+this._Id),d=1;d<b.rows.length;d++)b.rows[d].ondblclick=
function(){var e=this.getElementsByTagName("input");e.length>a&&0==e[a].disabled&&e[a].click()}};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);if((a=$X("EWA_LF_"+this._Id))&&"table"==a.tagName&&!(1>=a.rows.length)){a=a.rows[1].getElementsByTagName("input");for(var b=0;b<a.length;b++)if("RADIO"==a[b].type.toUpperCase()){this._TrSelectMulti=!1;break}}};this.SetPageParameters=function(a,
b,d,e,g){this._PageCurrent=a;this._PageSize=d;this._PageCount=b;this._RecordCount=e;this._Sort=g};this.SetPageParametersName=function(a,b,d,e,g){this._PageCurrentName=a;this._PageSizeName=d;this._PageCountName=b;this._RecordCountName=e;this._SortName=g};this.CheckedAll=function(){var a=document.getElementById("EWA_LF_"+this._Id);if(!(1>=a.rows.length)){for(var b=0;b<a.rows.length;b+=1){var d=a.rows[b].getElementsByTagName("input");0!=d.length&&(d[0].checked=this._IsCheckedAll)}this._IsCheckedAll=
this._IsCheckedAll?!1:!0;this.CheckedAllAfter&&this.CheckedAllAfter(a)}};this.SelectChecked=function(){var a=$X("EWA_LF_"+this._Id);if(!a||1>a.rows.length)return"";var b=[],d=$F(a,"input","type","radio,checkbox");if(0<d.length)for(var e=0;e<d.length;e++)d[e].checked&&b.push(d[e].value);else for(e=0;e<a.rows.length;e++)d=a.rows[e],1==d.getAttribute("__ewa_lf_mdown")&&b.push(d.getAttribute("EWA_KEY"));return b.join(",")};this.SelectCheckedInputs=function(){var a=[],b=$X("EWA_LF_"+this._Id);if(1>b.rows.length)return a;
b=b.getElementsByTagName("input");a=[];for(var d=0;d<b.length;d++)("CHECKBOX"==b[d].type.toUpperCase()||"RADIO"==b[d].type.toUpperCase())&&b[d].checked&&a.push(b[d]);return a};this.SelectCheckedRows=function(){for(var a=[],b=$X("EWA_LF_"+this._Id),d=0;d<b.rows.length;d++){var e=b.rows[d],g=e.getElementsByTagName("input");0!=g.length&&g[0].checked&&-1==g[0].parentNode.className.indexOf("ewa-switch")&&a.push(e)}if(0==a.length)for(d=0;d<b.rows.length;d++)e=b.rows[d],1==e.getAttribute("__ewa_lf_mdown")&&
a.push(e);return a};this.Reload=function(a){this.StopAjaxAfterReload?this.StopAjaxAfterReload=!1:this.Goto(this._PageCurrent,a)};this.refreshPage=function(a,b){this.replaceRowsData(null,null,a,b)};this.replaceRowsData=function(a,b,d,e){var g=this.getUrlClass();g.AddParameter("EWA_AJAX","LF_RELOAD");g.AddParameter("EWA_IS_SPLIT_PAGE","no");g.AddParameter("EWA_IS_HIDDEN_CAPTION","yes");g=g.GetUrl();a&&(g+="&"+a);var h=a?new EWA_AjaxClass:this.CreateAjax(),k=this;h.PostNew(g,function(){if(4==h._Http.readyState){h.HiddenWaitting();
var l=h._Http.responseText;200!=h._Http.status?(console.error(l),alert("ERROR:\r\n"+h._Http.statusText)):EWA.F.CheckCallBack(l)?k.replaceRowsWithDataHtml(l,b,d,e):console.error(l)}})};this.replaceRowsWithDataHtml=function(a,b,d,e){var g=$("<div></div>");g.html(a);var h=[],k=$("#EWA_LF_"+this._Id);g.find(".ewa-lf-data-row").each(function(){var l='tr[ewa_key="'+$(this).attr("ewa_key")+'"]',m=k.find(l);if(0==m.length)console.warn(l+" not found");else{l=$(this).attr("ewa_row_sign");var n=m.attr("ewa_row_sign"),
p=!0;(l||n)&&n===l&&(p=!1);if(p){m.attr("ewa_row_sign",l);l=m.clone()[0];for(n=0;n<this.cells.length;n++){p=m[0].cells[n];var q=this.cells[n];p.removeAttribute("ewa-merged");p.removeAttribute("ewa-search-marked");b?b(q,p):p.innerHTML=q.innerHTML}h.push({before:l,current:m[0]})}}});g.remove();this.SearchMark();this.IsReShow&&this.ReShowWithNoButtons();this._ReShowSearchQuick();null!=this._IsDblClick&&this.DblClick(c._IsDblClick);this.SubBottomsArray&&this._SubBottoms();this.ReloadAfter&&this.ReloadAfter(d);
this.ReloadAfterApp&&this.ReloadAfterApp(d);e&&e(h)};this.DoAction=function(a,b,d,e,g,h){EWA.F.CID=this._Id;if(b){if(a&&$(a).parent().hasClass("scroll-delete")){var k=$(a).attr("do-action-time")||0,l=(new Date).getTime();if(1E3>l-k)return;$(a).attr("do-action-time",l)}this.lastAction=b;this._Ajax=new EWA_AjaxClass;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT",
"1");this._Ajax.AddParameter("EWA_ACTION_TIP",e);null!=h&&0<h.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",h),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=!1;if(a&&a.getAttribute&&"yes"==a.getAttribute("box_menu_item")){if(this._Ajax.AddParameter("___CALL__FROM__","box"),a=a.parentNode)a=a.getAttribute("json_ref"),a=JSON.parse(a),a.EWA_KEY&&this._Ajax.AddParameter("EWA_ACTION_KEY",a.EWA_KEY)}else(a=this.GetRowKey(a))&&this._Ajax.AddParameter("EWA_ACTION_KEY",
a);a=this.SelectChecked();this._Ajax.AddParameter("IDS_SPLIT",a);if(null!=g&&0<g.length)for(a=0;a<g.length;a+=1)this._Ajax.AddParameter(g[a].Name,g[a].Value);g=new EWA.C.Url;g.SetUrl(this.Url);var m=g.RemoveParameter("EWA_ACTION"),n=this;d?((g=_EWA_INFO_MSG[d])||(g=d),$Confirm(g,"Confirm",function(){n._Ajax.PostNew(m,function(){n._CallBackJs()})})):this._Ajax.PostNew(m,function(){n._CallBackJs()})}};this.NewPageSize=function(a){this._PageSize!=a&&(this._PageSize=a,this.Goto(1))};this.Goto=function(a,
b){EWA.F.CID=this._Id;this._PageCurrent=a;this._Ajax=this.CreateAjax();a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.RemoveParameter("EWA_AJAX");var d=this;this._Ajax.PostNew(a.GetUrl(),function(){d._CallBack(b)});this.REPLACE_HISTORY_STATE&&this.replaceHistoryState()};this.createReplaceHistoryStateUrl=function(){var a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.AddParameter(this._PageCurrentName,this._PageCurrent);this._PageSize&&a.AddParameter(this._PageSizeName,
...
this.GotoParas[a].Value);this._AjaxType="DOWN_DATA";a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);var d=this;this._Ajax.PostNew(a.GetUrl(),function(){d._CallBack()})};this.Get=function(a){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";var b=this;this._Ajax.Get(a,function(){b._CallBack()})};this.Post=function(a,b){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";var d=this;this._Ajax.Post(a,b,function(){d._CallBackJs()})};
this._CallBack=function(a){var b=this._Ajax;if(4==b._Http.readyState){b.HiddenWaitting();if(top.EWA&&top.EWA.MQE){var d=new EWA_MqeClass;d.Data=b.GetRst();d.FromId=EWA.F.CID;d.Type="POST";top.EWA.MQE.AddMqe(d)}200==b._Http.status?(b=b._Http.responseText,EWA.F.CheckCallBack(b)&&("DOWN_DATA"==this._AjaxType?(this._AjaxType=null,"DENY"==b.trim()?alert(_EWA_INFO_MSG["EWA.LF.DOWN_DATA.DENY"]):window.location.href=b.trim()):(d=$X("EWA_LF_"+this._Id).parentNode,$(d).replaceWith(b),this.SearchMark(),this.IsReShow&&
...
top.EWA.MQE.AddMqe(b)}a.HiddenWaitting();200==a._Http.status?(a=a._Http.responseText,EWA.F.CheckCallBack(a)&&eval(a)):alert("ERROR:\r\n"+a._Http.statusText);this.EditAfterEvent&&this.EditAfterEvent()}};this.EditAfterEvent=function(){};this._GetItem=function(a){for(var b=this.ItemList,d=0;d<b.length;d+=1){var e=b[d],g=this._GetSubItem("Name",e);if(this.Xml.GetElementAttribute(g,"Name")==a)return e}};this._GetSubItem=function(a,b){b=this.Xml.GetElements(a+"/Set",b);if(null==b||0==b.length)return null;
if("DescriptionSet"==a)for(a=0;a<b.length;a+=1){var d=b[a].getAttribute("Lang");if(null!=d&&d.trim().toUpperCase()==EWA.LANG.trim().toUpperCase())return b[a]}return b[0]};this._GetSubValue=function(a,b,d){a=this._GetSubItem(a,d);return null==a?null:this.Xml.GetElementAttribute(a,b)};this.AddColumns=function(a,b,d,e,g,h,k,l){var m=$X("EWA_LF_"+this._Id);null==l&&(l=m.rows[0].cells.length);for(var n=0;n<a.length;n++)for(var p=a[n],q=l+n,u=0;u<m.rows.length;u++){var r=m.rows[u].insertCell(q);if(0==u)r.className=
"EWA_TD_H",r.innerHTML='<nobr cellIdx="'+q+'" id="'+p[b]+'">'+p[d]+"</nobr>",r.title=p[e],r.width=100;else{var t=m.rows[u].getAttribute("EWA_KEY");r.className="EWA_TD_M";t=t+"_"+p[b];var w=this._GetAddControl(p[h]);null==w&&(w=g);var v=k.replace("[ID]",p[b]);w=0<=w.indexOf("<select")?w.replace("!!",v.replace("onblur=","onchange=")):w.replace("!!",v);r.innerHTML=w;r.childNodes[0].id=t}}};this._GetAddControl=function(a){if(null==a)return null;a=a.toUpperCase().trim();return"SELECT"==a?"<select !!></select>":
"DATE"==a?'<input type=text class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,false);" readonly !!>':"TIME"==a?'<input type=text class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,true);" readonly !!>':"STRING"==a||"NUMBER"==a?"<input type=text class=EWA_INPUT !!>":null};this.AddedValues=function(a,b,d,e,g){for(var h=0;h<a.length;h++){var k=a[h],l=$X(k[b]+"_"+k[d]);if(!l)break;var m=l.tagName.toUpperCase();"INPUT"==m||"SELECT"==m||"TEXTAREA"==m?l.value=k[e]:l.innerHTML=k[e];g&&(this.GetRow(l).getElementsByTagName("input")[0].checked=
!0)}};this.AddRow=function(a){for(var b=$X("EWA_LF_"+this._Id),d=b.insertRow(-1),e=0;e<b.rows[0].cells.length;e++){var g=d.insertCell(-1),h=b.rows[0].cells[e];g.className="EWA_TD_M";null!=a[e]&&(g.innerHTML=a[e]);g.style.display=h.style.display;g.id="ADD_ROW_"+h.childNodes[0].id}return d};this.Calc=function(a,b,d,e){for(var g=$X("EWA_LF_"+this._Id),h={},k=0;k<a.length;k++)h[a[k]]=0;for(k=b;k<d;k++)for(a=g.rows[k],b=0;b<a.cells.length;b++)if(null!=h[b]){var l=a.cells[b],m=l.getElementsByTagName("input");
0<m.length?h[b]+=1*m[0].value:(l=GetInnerText(l),""==l&&(l=0),h[b]+=1*l)}d=g.rows[e];for(k=0;k<d.cells.length;k++)null!=h[k]&&(l=Math.round(100*h[k])/100,e=GetInnerText(d.cells[k]),l!=1*e&&(this.IsCalcChanged=!0),d.cells[k].innerHTML=l.fm())};this.mergeHeaders=function(a,b,d){var e=$($X("EWA_LF_"+this._Id)),g=e.find('tr[ewa_tag="HEADER"]');if(0!=g.length&&(a=g.find('nobr[id="'+a+'"]').parent(),0!=a.length)){var h=e.find("tr[ewa_mearge]");0==h.length&&(h=$(e[0].insertRow(1)),h.attr("ewa_mearge","gdx"));
e=-1;for(var k=0;k<g[0].cells.length;k++){var l=g[0].cells[k];l==a[0]&&(e=k,l.colSpan=d);if(-1==e)"1"!=$(l).attr("ewa_tdmearged")&&(l.rowSpan=2);else if(e+d==k)e=-1,l.rowSpan=2;else{l.rowSpan=1;var m=h[0].insertCell(-1);m.innerHTML=l.innerHTML;m.className=l.className;m.style.cssText=l.style.cssText;l.style.display="none";$(l).attr("ewa_tdmearged",1)}l==a[0]&&(l.innerHTML=b,l.style.display="",l.style.width="")}}};this.MeargeHeader=function(a,b,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 mergeHeaders");
this.mergeHeaders(a,b,d)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}
...
h.focus()))};this._GetInput=function(){for(var e=this.ParentObject.getElementsByTagName("INPUT"),g=e.length-1;0<=g;g--){var h=e[g];if(h.getAttribute("onblur")&&0<h.getAttribute("onblur").indexOf("RenameBlur("))return this._InputDiv=h.parentNode,h}};this.RenameBlur=function(e){for(var g=e.getAttribute("EWA_OLD_VAL"),h=this._RenameNode,k=this.GetNode(h.GetObject().parentNode),l=0;l<k.Children.length;l+=1){var m=k.Children[l];if(m.Key!=h.Key&&m.Text.trim()==e.value.trim()){alert(_EWA_EVENT_MSG.OnTreeNodeNameRepeat);
e.focus();return}}k=e.parentNode.childNodes[0];this._InputDiv.appendChild(e);k.style.display="";if("NEW"==h.RenameType||g!=e.value){k.innerHTML=e.value;g=this._RenameActionCmd;null==g&&(g=new EWA.F.Cmd);if(null==g.EWA_ACTION||""==g.EWA_ACTION.trim())g.EWA_ACTION="NEW"==h.RenameType?"OnTreeNodeNew":"OnTreeNodeRename";"NEW"==h.RenameType&&(""==g.EWA_AFTER_EVENT&&(g.EWA_AFTER_EVENT='EWA.F.FOS["'+this._Id+'"].NewNodeAfter;'),k=this.GetNode(h.GetObject().parentNode),g.EWA_TREE_PARENT_KEY=k.Key);g.EWA_TREE_TEXT=
e.value;g.EWA_TREE_KEY=h.Key;this._PostChange(g);this._RenameActionCmd=null}};this.RenameKeyDown=function(e,g){e=e.keyCode?e.keyCode:e.which;13==e&&this.RenameBlur(g);27==e&&(e=g.getAttribute("EWA_OLD_VAL"),g.value=e,this.RenameBlur(g))};this.Delete=function(e,g){var h=this.GetNode(this._LastFocus);null!=h&&"EWA_TREE_ROOT"!=h.Key&&window.confirm(_EWA_EVENT_MSG.OnTreeNodeDelete)&&(!e&&(0<h.Children.length||h.IsMoreChildren)?(h.NodeShow(!0),alert(_EWA_EVENT_MSG.OnTreeNodeDeleteHaveChildren)):(e=g,null==
e&&(e=new EWA.F.Cmd,e.EWA_ACTION="OnTreeNodeDelete"),""==e.EWA_AFTER_EVENT&&(e.EWA_AFTER_EVENT='EWA.F.FOS["'+this._Id+'"].DeleteAfter();'),e.EWA_TREE_KEY=h.Key,this._PostChange(e)))};this.DeleteAfter=function(){var e=this.GetNode(this._LastFocus).GetObject(),g=e.parentNode;g.removeChild(e);e=this.GetNode(g);0==e.Children.length?this.GetNode(e.GetObject().parentNode).ChildLast.Key==e.Key?e.NodeCrossEnd(!0):e.NodeCross(!0):e.ChildLast.NodeCrossEnd();this._LastFocus=null};this.NewNode=function(e,g,h,
k){null!=this._LastFocus&&(this._NewNodeTemp={TEXT:e,CMD:g,REGEX:h,INFO:k},this.GetNode(this._LastFocus).NodeShow(!0),this.IsPostChange?this._NewNodeTimer=window.setInterval(function(){EWA.CurUI.IsPostChange||(window.clearInterval(EWA.CurUI._NewNodeTimer),EWA.CurUI._NewNode())},100):this._NewNode())};this._NewNode=function(){var e=this._NewNodeTemp.TEXT,g=this._NewNodeTemp.CMD,h=this._NewNodeTemp.REGEX,k=this._NewNodeTemp.INFO;this._NewNodeTemp=null;var l=new EWA_TreeNodeClass;l.ewa=this;this._CurNewNode+=
1;l.Key="NEW_NODE_"+this._Id+"__"+this._CurNewNode;l.RenameType="NEW";var m=_EWA_EVENT_MSG.OnTreeNodeNew+this._CurNewNode;null!=e&&0<e.trim().length&&(m=e.trim());l.Text=m;e=this.GetNode(this._LastFocus);0<e.Children.length&&e.Children[e.Children.length-1].NodeCross();e.AddChild(l);this.Create(l);e.NodeShow(!0);this.Rename(l,g,h,k)};this.NewNodeAfter=function(e,g,h){var k=this.GetNodeById("NEW_NODE_"+this._Id+"__"+this._CurNewNode);k.SetKey(e);k.SetAddParameters(null==g?"":g);k.SetMenuGroup(null==
h?"":h);e=this.TestIcon(k);k.SetBookIcon(e)};this.GetNodeById=function(e){e=$("#EWA_TREE_"+this._Id+' .ewa-tree-node[id="'+e+'"]');return 0==e.length?null:this.GetNode(e[0])};this.GetFocusNode=function(){return this.GetNode(this._LastFocus)};this.GetNode=function(e){if(null==e||null==e.tagName)return null;var g=e;for(e=0;("TABLE"!=g.tagName||"1"!=g.getAttribute("EWA_T"))&&"EWA_TREE_ROOT"!=g.id;)if(g=g.parentNode,e++,33<e||"BODY"==g.tagName)return null;e=new EWA_TreeNodeClass;e.ewa=this;e.Key=g.id;
e.MenuGroup=g.getAttribute("EWA_MG");e.Object=g;var h=g.rows[0].cells[2];e.Text=GetInnerText(h);for(var k=0;3>k;k+=1)e.AddParas[k]=h.childNodes[0].getAttribute("EWA_P"+k);k=g.getAttribute("EWA_TREE_MORE");e.IsMoreChildren="1"==k?!0:!1;if(1<g.rows.length){g=g.rows[1].cells[g.rows[1].cells.length-1];for(k=0;k<g.childNodes.length;k=1+k)h=g.childNodes[k],3!=h.nodeType&&"TABLE"==h.tagName&&"1"==h.getAttribute("EWA_T")&&e.Children.push(this.GetNode(h));0<e.Children.length&&(e.ChildLast=e.Children[e.Children.length-
1])}return e};this.Click=function(e,g){if(!this.IsPostChange&&(EWA.CurUI=this,e=e.srcElement?e.srcElement:e.target,"INPUT"!=e.tagName))if("DIV"==e.tagName&&(e=e.parentNode),"TD"==e.tagName&&0==e.className.indexOf("TD00")){var h=this.GetNode(e);h.NodeShow()}else{for(;("SPAN"!=e.tagName||null==e.getAttribute("EWA_CMD"))&&"1"!=e.getAttribute("EWA_TREE_TOP");)if(e=e.parentNode,"BODY"==e.tagName)return;h=this.GetNode(e);if("SPAN"==e.tagName&&(null!=e.getAttribute("EWA_CMD")||"1"==e.getAttribute("EWA_TREE_TOP"))){null!=
this._LastFocus&&(this.GetNode(this._LastFocus).Mark(!1),this._LastFocus=null);"1"!=e.getAttribute("EWA_TREE_TOP")&&h.Mark(!0);this._LastFocus=e;if(g)return e;0>this.Url.toUpperCase().indexOf("EWA_TREE_SKIP_GET_STATUS")&&EWA.F.ST.SaveStatus(h.Key,"TREE");this._RunCmd(h);this.MoveNode(h.GetObject())}}};this._RunCmd=function(e){var g=this.GetNode(e.GetObject().parentNode);if(this.link)this.link(e.Key,e);else{console.warn('\u5efa\u8bae\u91c7\u7528\u5b9a\u4e49 EWA.F.FOS["xx"].link = function(nodeKey, node){}');
...
for(var a=[],b=0;b<this.uploadIframes.length;b++){var d=this.uploadIframes[b];if("string"==typeof d){d=JSON.parse(d);for(var e in d)a.push(d[e])}}return JSON.stringify(a)};this.fileIco=function(a,b){a=EWA.UI.Ext.FileExt(a.name);$X(b).onerror=function(){};$X(b).src=EWA.UI.Ext.FileIco(a)};this.showPreview=function(a,b){if(10<a.files.length)"enus"==EWA.LANG?EWA.UI.Msg.ShowError("Upload up to 10 files at a time","limts"):EWA.UI.Msg.ShowError("\u4e00\u6b21\u6700\u591a\u4e0a\u4f2010\u4e2a\u6587\u4ef6",
"\u6587\u4ef6\u6570\u91cf\u9650\u5236"),a.value="";else{this.UpLimit||(this.UpLimit="10M");b=(this.UpLimit+"").toLocaleLowerCase().replace(/,/ig,"").replace(/ /ig,"");if(b.endsWith("m")){b=b.substring(0,b.length-1);if(isNaN(b)){alert("Invalid sizeLimit parameter:"+this.sizeLimit);return}var d=1048576*b}else if(b.endsWith("k")){b=b.substring(0,b.length-1);if(isNaN(b)){alert("Invalid sizeLimit parameter:"+this.sizeLimit);return}d=1024*b}else{if(isNaN(b)){alert("Invalid sizeLimit parameter:"+this.sizeLimit);
return}d=1*b}var e=[];if(0<d)for(b=0;b<a.files.length;b++){var g=a.files[b];if(g.size>d){var h=EWA.UI.Ext.getFileLen(g.size,2);e.push(g.name.replace(/</ig,"%lt;").replace(/>/ig,"%gt;")+" ["+h+"]")}}if(0<e.length)a.value="","enus"==EWA.LANG?(e.push("Exceed "+this.UpLimit+" limit"),EWA.UI.Msg.ShowError(e.join("<br>"),"Exceed "+this.UpLimit+" limit")):(e.push("\u8d85\u8fc7"+this.UpLimit+"\u5927\u5c0f\u9650\u5236"),EWA.UI.Msg.ShowError(e.join("<br>"),"\u8d85\u8fc7"+this.UpLimit+"\u5927\u5c0f\u9650\u5236"));
else{d=a.parentNode;e=d.outerHTML;d.style.display="none";a.setAttribute("ok",1);gFileReaders={};for(b=0;b<a.files.length;b++)g=a.files[b],this.showPreview1(d,g),this.files.push(g);"yes"==this.UpMulti&&$(d).before(e)}}};this.addOther=function(a){for(var b=$X(this.POST_NAME).parentNode.getElementsByTagName("input")[1].parentNode,d=0;d<a.length;d++)this.showPreview1(b,a[d]);this.uploadIframes.push(JSON.stringify(a))};this.createPreviewBox=function(a){var b=a||$("#EWA_FRAME_"+this.SYS_FRAME_UNID+" input#"+
this.POST_NAME).parent().find(".ewa_app_upload_form")[0],d="_upload_"+Math.random();d=d.replace(".","G");a=document.createElement("img");a.id=d;d=document.createElement("table");d.cellPadding=0;d.cellSpacing=0;d.className="ewa_app_upload_form1";b.parentNode.appendChild(d);b=d.insertRow(-1).insertCell(-1);b.align="center";b.appendChild(a);b.className="img";b.vAlign="middle";d.insertRow(-1).insertCell(-1).className="name";var e=this;a.onerror=function(g){console.log(g);e.fileIco({name:this.src},this.id)};
return d};this.showPreviewExists=function(){var a=$("#EWA_FRAME_"+this.SYS_FRAME_UNID+" input#"+this.POST_NAME).val();if(""!=a){try{EWA.F.FOS[this.SYS_FRAME_UNID].setUnMust(this.POST_NAME)}catch(b){}this.showPreviewUrl(a)}};this.showPreviewUrl=function(a){var b=this.createPreviewBox(),d=$(b).find("td")[1],e=a.split("/");e=e[e.length-1];d.innerHTML="<div title='"+e+"'>"+e+"</div>";$(b).find("img")[0].src=a;return b};this.showPreview1=function(a,b){var d=this.createPreviewBox(a),e=$(d).find("td")[1],
g=$(d).find("img")[0];a=g.id;b.ref=a;e.innerHTML="<div>"+b.name+"</div><div id='"+a+"_process1' class='ewa-app-upload-process1'></div><div id='"+a+"_process' class='ewa-app-upload-process'>0%</div>";e.className="name";$(d).attr("file_name",b.name);$(d).attr("file_type",b.type);$(d).attr("file_size",b.size);if(b.type&&0==b.type.indexOf("image/")){g.src=(EWA.RV_STATIC_PATH||"/EmpScriptV2")+"/EWA_STYLE/images/loading2.gif";d=new FileReader;gFileReaders[a]=d;var h=this;d.onloadend=function(k){for(var l in gFileReaders)gFileReaders[l]==
k.target&&($X(l).src=k.target.result,h.showPreviewAfter&&h.showPreviewAfter($X(l),b))};d.readAsDataURL(b)}else this.fileIco(b,a),this.showPreviewAfter&&this.showPreviewAfter($X(a),b)};this.submitUploads=function(a){if(window.FormData){this.uploadIframes=[];var b=this;this.UPLOAD_STATUS="start";this.action=EWA.CP+"/EWA_STYLE/cgi-bin/_up_/?xmlname="+this.POST_XMLNAME+"&ITEMNAME="+this.POST_ITEMNAME+"&NAME="+this.POST_NAME+"&EWA_UP_TYPE=SWFUPLOAD&EWA_UP_REF="+this.POST_REF;try{$("input[type=file][ok=1]").each(function(){var d=
this.id.split("_1_2_3_4_5_")[1];if(b.POST_NAME==d)for(d=0;d<this.files.length;d++){var e=this.files[d];e.isDeleted?console.log(e):b.uploadIframes.push({file:e})}})}catch(d){alert(d)}0<this.uploadIframes.length?($("#f_"+this.SYS_FRAME_UNID).find(".ewa-app-upload-process,.ewa-app-upload-process1").show(),b.UPLOAD_STATUS="checking",this.asyncUpload()):this.UPLOAD_STATUS="nofile"}else this.submitUploads_old(a)};this.asyncUpload=function(){var a=this,b=null,d;for(d in this.uploadIframes){var e=this.uploadIframes[d];
if("string"!=typeof e){b=e;break}}null!=b?(b.submitting||(b.submitting=!0,this.submitUpload(b)),setTimeout(function(){a.asyncUpload()},111)):this.uploadsCompleted&&this.uploadsCompleted(this.uploadIframes)};this.createFormData=function(){var a=new FormData,b=new EWA_UrlClass;b.SetUrl(EWA.F.FOS[this.SYS_FRAME_UNID].Url);for(var d in b._Paras)0!=d.toUpperCase().indexOf("EWA")&&a.append(d,b._Paras[d]);if(b=$X("f_"+this.SYS_FRAME_UNID))for(d=0;d<b.length;d++){var e=b[d],g=e.name||e.id;"file"!=e.type&&
"button"!=e.type&&"submit"!=e.type&&("radio"!=e.type&&"checkbox"!=e.type||e.checked)&&"ht5upload"!=$(e).attr("ewa_tag")&&a.append(g,e.value)}return a};this.submitUpload=function(a){var b=a.file,d=this.createFormData();d.append(this.POST_NAME,b,b.name);var e=$('img[id="'+b.ref+'"]');this.createNewSizes(e[0],d);var g=this,h=$('div[id="'+b.ref+'_process"]');h.show().html("0%");var k=$('div[id="'+b.ref+'_process1"]');k.css("width",0).show();b=new XMLHttpRequest;b.upload.addEventListener("progress",function(l){l.lengthComputable?
...
b.animate(r,"fast","swing",function(){b[0].style.cssText="";var t=1*b.attr("st");document.body.scrollTop=t;1==$("#crm_left_box").attr("show")&&$("#crm_left_box").show();b.css("display",b.attr("dsp"));0<e.length&&"DES_plugin"!=a?e[0].click():(t=$X(a.replace("DES_","")),t.style.width=t.parentNode.clientWidth-10+"px",t.style.height=r.height-30+"px",d.find('div[id="EWA_FRAME_MAIN"]').css("height",r.height-150))});else{b.attr("full","1");b.attr("st",document.body.scrollTop);b.attr("dsp",b.css("display"));
var h=document.documentElement.clientHeight;g=document.documentElement.clientWidth-10;var k=h-20,l=document.documentElement.clientWidth-30,m=h-20-20-15;h=b.offset();var n=b.position(),p=h.left-n.left,q=b.width(),u=b.height();var r={width:q,height:u,"margin-left":p,left:n.left,top:n.top};b.attr("ori",JSON.stringify(r));b.css({"margin-left":"0px",top:h.top,left:h.left,position:"absolute",display:"",overflow:"auto"});b.animate({width:g,height:k,left:10,top:0},"fast","swing",function(){d.css("width",
...
(function(a,b){"object"===typeof module&&"object"===typeof module.exports?module.exports=b():b(a)})("undefined"!==typeof window?window:this,function(a){function b(h){if(!h)return 0;var k=h.replace(/\uff0c|,| /ig,"").replace(/\u70b9|\u3002/ig,".").split(".");if(2<k.length)throw"\u975e\u6570\u5b57\u8868\u8fbe\u5f0f\uff1a"+h;h=k[0].split("");k=(2==k.length?k[1]:"").split("");for(var l=0,m=1,n=null,p=h.length-1;0<=p;p--){var q=h[p];if(0==p&&g[q])l*=-1;else{var u=d[q],r=e[q];if(null!=u)l+=u*m,m*=10,n=
null;else if(r)m=(n?m:1)*r.value,n=r;else throw"\u975e\u6570\u5b57\u6216\u5355\u4f4d\uff1a"+q;}}h=[l,1,0];l="0.";m=1;n=null;for(p=0;p<k.length;p++)if(q=k[p],u=d[q],r=e[q],null!=u){if(l+=u.toString(),n)throw"\u975e\u8fde\u7eed\u5c0f\u6570\u70b9\u540e\u5355\u4f4d\uff1a"+k.join("");}else if(r)m=(n?m:1)*r.value,n=r;else throw"\u975e\u6570\u5b57\u6216\u5355\u4f4d\uff1a"+q;k=1*l;n=l.startsWith("0")?("1"+l.substring(1))*m:k*m;k=[k,m,1==m?l.toString().length-2:n>m?l.length-m.toString().length+1:0];return 0==
k?h:1*((h[0]+k[0])*k[1]).toFixed(0>k[2]?0:k[2])}var d={"\u96f6":0,0:0,"\uff10":0,o:0,O:0,"\u4e00":1,"\u58f9":1,1:1,"\uff11":1,"\u4e8c":2,"\u8d30":2,2:2,"\uff12":2,"\u4e09":3,"\u53c1":3,3:3,"\uff13":3,"\u56db":4,"\u8086":4,4:4,"\uff14":4,"\u4e94":5,"\u4f0d":5,5:5,"\uff15":5,"\u516d":6,"\u9646":6,6:6,"\uff16":6,"\u4e03":7,"\u67d2":7,7:7,"\uff17":7,"\u516b":8,"\u634c":8,8:8,"\uff18":8,"\u4e5d":9,"\u7396":9,9:9,"\uff19":9},e={"\u5341":{value:10},"\u62fe":{value:10},"\u4ec0":{value:10},"\u767e":{value:100},
"\u4f70":{value:100},"\u964c":{value:100},"\u5343":{value:1E3},"\u9621":{value:1E3},"\u4edf":{value:1E3},"\u4e07":{value:1E4},"\u842c":{value:1E4},"\u4ebf":{value:1E8}},g={"-":!0,"\u8d1f":!0,"\uff0d":!0};if(window&&window.EWA&&window.EWA_Utils)window.EWA_Utils.chineseToNumber=b;else if(a)a.chineseToNumber=b;else return b});
var EWAC_WfOrg=function(){this.Depts={};this.Posts={};this.Users={};this.GetMaster=function(a){var b=this.Users[a];if(null==b)alert(("enus"==EWA.LANG?"NONE of ":"\u6ca1\u6709\u554a")+a);else{a=b.Dept;for(var d in a.Users){b=a.Users[d];for(var e in b.Posts)if(b.Posts[e].IsMaster)return b}alert("enus"==EWA.LANG?"\tNo manager":"\u6ca1\u6709\u7ba1\u7406\u8005")}};this.IsMaster=function(a){var b=this.GetMaster(a);return null==b?!1:b.Id==a};this.InitDepts=function(a,b,d,e,g,h){for(var k=0;k<a.length;k++){var l=
a[k];if(null==this.Depts[l[b]]){var m={};m.Id=l[b];m.Name=l[d];m.Lvl=l[e];m.Ord=l[g];m.Pid=l[h];m.Posts={};m.Users={};m.Children={};this.Depts[m.Id]=m}}for(var n in this.Depts)l=this.Depts[n],this.Depts[l.Pid]?(a=this.Depts[l.Pid],l.Parent=a,a.Children[l.Id]=l):null==this.DeptRoot&&(this.DeptRoot=l)};this.InitPosts=function(a,b,d,e,g){for(var h=0;h<a.length;h++){var k=a[h],l=k[b];if(null==this.Posts[l]){var m={};m.Id=l;m.Name=k[d];m.DeptId=k[g];k=k[e];k=null==k?"":k.trim().toLowerCase();m.IsMaster=
"y"==k||"yes"==k||"true"==k||"1"==k?!0:!1;this.Depts[m.DeptId]&&(m.Dept=this.Depts[m.DeptId],null==m.Dept.Posts[m.Id]&&(m.Dept.Posts[m.Id]=m));this.Posts[l]=m}}};this.InitUsers=function(a,b,d,e,g){for(var h=0;h<a.length;h++){var k=a[h],l=k[b];if(null!=this.Users[l])var m=this.Users[l];else m={},m.Id=l,m.Name=k[d],m.DeptId=k[e],m.Posts={},this.Depts[m.DeptId]&&(m.Dept=this.Depts[m.DeptId],null==m.Dept.Users[m.Id]&&(m.Dept.Users[m.Id]=m)),this.Users[l]=m;k=k[g];this.Posts[k]&&(m.Posts[k]=this.Posts[k])}}};
...
function loadWfShow(a,b,d,e,g,h,k,l,m,n){_EWA_WF&&_EWA_WF.EN&&(_EWA_WF.EN1=$J2MAP(_EWA_WF.EN,"WF_UNIT_ID"));e=document.createElement("div");e.style.position="absolute";e.style.zIndex=123;e.innerHTML="ver: "+_EWA_WF.WF_DLV_VER;document.body.appendChild(e);var p=EWAC_WfUtil.WF,q=1000012,u=1000011;for(e=0;e<a.length;e++){var r=a[e],t=r.WF_UNIT_X,w=r.WF_UNIT_Y;null!=t&&1*t<q&&(q=1*t);null!=w&&1*w<u&&(u=1*w)}1000012==q&&(q=0);1000011==u&&(u=0);q-=10;u-=10;n={};var v;for(e=0;e<a.length;e++)r=a[e],p.Ids[e]=
r.WF_UNIT_ID,t=p.CreateUnit(),n[r.WF_UNIT_ID]=t,w=r.WF_UNIT_NAME,"enus"==EWA.LANG&&_EWA_WF.EN1&&_EWA_WF.EN1[r.WF_UNIT_ID]&&_EWA_WF.EN1[r.WF_UNIT_ID].WF_UNIT_NAME_EN&&(w=_EWA_WF.EN1[r.WF_UNIT_ID].WF_UNIT_NAME_EN),t.ChangeDes(w),t.ChangeType(r.WF_UNIT_TYPE),t.WF_UNIT_ADM=r.WF_UNIT_ADM,t.WF_UNIT_ADM_LST=r.WF_UNIT_ADM_LST,t=r.WF_UNIT_X,w=r.WF_UNIT_Y,r=$X(r.WF_UNIT_ID),null!=t&&(r.style.left=t-q+"px"),null!=w&&(r.style.top=w-u+"px");a={};for(e=0;e<b.length;e++)r=b[e],t=r.WF_UNIT_FROM,a[t]||(a[t]=[]),a[t].push(r);
for(e=0;e<b.length;e++)r=b[e],a=r.WF_UNIT_TO,t=r.WF_UNIT_FROM,t=p.Units[t],a=p.Units[a],q=new EWAC_WfCnn,q.Create(t,a),p.Cnns[q.Id]=q,r.IsHaveLogic&&!r.IsLogicOk&&(q.IsStop=!0);for(var y in p.Units)e=p.Units[y],null==v&&0==e.CnnsToLength&&(v=e);if(null==v)k="enus"==EWA.LANG?"No startup node was found, process definition error":"\u672a\u53d1\u73b0\u542f\u52a8\u8282\u70b9,\u6d41\u7a0b\u5b9a\u4e49\u9519\u8bef",alert(k);else{0==d.length&&(p.CurUnit=v);var x=[];y={};for(e=0;e<d.length;e++)b=d[e],p=b.SYS_STA_TAG,
t=n[p],null!=t&&(r=b.ADM_NAME,"enus"==EWA.LANG&&b.ADM_NAME_EN&&(r=b.ADM_NAME_EN),t.Log(r,b.SYS_STA_CDATE,b.SYS_STA_MEMO),y[p]||(y[p]=1,x.push({ID:p,DES:t.GetDes()})),p=b.SYS_STA_TAG+"G"+b.SYS_STA_VAL,EWAC_WfUtil.WF.Cnns[p]&&(EWAC_WfUtil.WF.Cnns[p].Disp(3,"blue"),t==v&&(t.ADM_ID=b.ADM_ID),e==d.length-1&&(p=n[b.SYS_STA_VAL],p.WF_UNIT_ADM_LST=b.ROLE_IDS,p.WF_UNIT_ADM=b.ROLE_TYPE,EWAC_WfUtil.WF.CurUnit=p)));null!=m&&0<m.length&&n[m]&&(EWAC_WfUtil.WF.CurUnit=n[m]);EWAC_WfUtil.WF.CurUnit.LogCur(g);m=!1;
t=EWAC_WfUtil.WF.CurUnit;d=[];if(v==t)m=!0;else if("WF_ADM_ADM"==t.WF_UNIT_ADM)if(v=","+t.WF_UNIT_ADM_LST+",",0<=v.indexOf(","+h+","))m=!0;else for(e in h=$J2MAP1(top.org,"ADM_ID"),k=t.WF_UNIT_ADM_LST.split(","),k){l=h[k[e]];for(var z in l)d.push(l[z].ADM_NAME)}else if("WF_ADM_DEPT"==t.WF_UNIT_ADM)if(v=","+t.WF_UNIT_ADM_LST+",",0<=v.indexOf(","+k+","))m=!0;else for(e in h=$J2MAP1(top.org,"DEP_ID"),k=t.WF_UNIT_ADM_LST.split(","),k)for(z in l=h[k[e]],l)d.push(l[z].ADM_NAME);else if("WF_ADM_POST"==t.WF_UNIT_ADM)if(v=
","+t.WF_UNIT_ADM_LST+",",0<=v.indexOf(","+l+","))m=!0;else for(e in h=$J2MAP1(top.org,"POS_ID"),k=t.WF_UNIT_ADM_LST.split(","),k)for(z in l=h[k[e]],l)d.push(l[z].ADM_NAME);else if("WF_ADM_START"==t.WF_UNIT_ADM){if(v==t||h==v.ADM_ID)m=!0}else"WF_ADM_MANAGER"==t.WF_UNIT_ADM&&(z=v.ADM_ID,top||top.ORG||(k="enus"==EWA.LANG?"No organization":"\u6ca1\u6709\u7ec4\u7ec7\u673a\u6784",alert(k),m=!1),m=top.ORG.GetMaster(z).Id==h?!0:!1);g&&window.parent&&window.parent.$X(g)&&(z=window.parent.$X(g).parentNode.parentNode.parentNode,
m?0<x.length&&(h=z.rows[z.rows.length-1].cells[0],k=window.parent.document.createElement("input"),k.type="button",k.value="enus"==EWA.LANG?"Back":"\u6253\u56de",k.onclick=function(){var A=window.parent.$X(g);A.options.length=1;for(var C=0;C<x.length;C++){var F=x[C];A.options[A.length]=new Option(F.DES,F.ID);this.style.display="none"}A.parentNode.parentNode.cells[0].innerHTML="enus"==EWA.LANG?'<div style="color:red">Back steps</div>':'<div style="color:red">\u8fd4\u56de\u6b65\u9aa4</div>'},h.insertBefore(k,
h.getElementsByTagName("input")[1])):(0==d.length?(k="enus"==EWA.LANG?"Only view":"\u60a8\u53ea\u80fd\u67e5\u770b",window.parent.$X(g).parentNode.innerHTML="<b>"+k+"</b>"):(k="enus"==EWA.LANG?"Waitting":"\u7b49\u5f85",h="enus"==EWA.LANG?"or":"\u6216",window.parent.$X(g).parentNode.innerHTML="<b>"+k+':<span style="color:blue">'+d.join("</span> "+h+' <span style="color:blue">')+"</span></b>"),window.parent.$X("butOk").style.display="none"),showControls(z,_EWA_WF.WF_SHOW))}}
function showControls(a,b){for(var d=a.rows.length-5;0<=d;d--)0!=a.rows[d].id.indexOf("_ewa_tr$EWA_WF_")&&(a.rows[d].style.display="none");var e={},g=!1;for(d=0;d<b.length;d++)for(var h=b[d].XITEMS.split(","),k=0;k<h.length;k++){var l=h[k].trim();""==l||e[l]||(e[l]=1,g=!0)}if(g)for(var m in e)if(b=a.ownerDocument.getElementById("_ewa_tr$"+m))b.style.display=""}
...
g[0];var h=g.parentNode.rows[0];for(d=g.cells.length-1;1<=d;d--)if(!(0<g.cells[d].getElementsByTagName("input")||0<g.cells[d].getElementsByTagName("img")||0<g.cells[d].getElementsByTagName("a"))&&(b=GetInnerText(h.cells[d]),e=GetInnerText(g.cells[d]),null!=b&&""!=b.trim()&&null!=e&&""!=e.trim()&&(b=b.replace("?","").trim(),b.trim()!=e.trim()))){var k=a.insertRow(0),l=k.insertCell(-1);l.className="EWA_TD_L";var m=k.insertCell(-1);m.className="EWA_TD_M";l.innerHTML='<span style="color:111"><i>'+b+"</i></span>";
m.innerHTML=e}}}}else window.setTimeout(loadParentInfo,300)}

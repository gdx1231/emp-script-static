...
0<=b.parentNode.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=b.className.indexOf("ewa-mdown-stop")||"TD"==b.tagName&&b.parentNode==a&&0<$(b).children("a:visible").length?!1:!0:!0:!0};this.MDown=function(a,b){if(this.IsTrSelect){var c=(new Date).getTime(),d=$(a).attr("mdown_time_last");if(!(null!=d&&500>c-d)&&($(a).attr("mdown_time_last",c),b=null==b?window.event:b,this.MDownEnableCheck(a)&&this.checkMDownEnable(a,b))){c=b.srcElement?b.srcElement:b.target;d=null;if(!this.IsNotMDownAutoChecked){var e=
a.getElementsByTagName("input");if("INPUT"!=c.tagName&&0<e.length)for(c=0;c<e.length;c++){if("RADIO"==e[c].type.toUpperCase()){d=e[c];d.click();break}if("CHECKBOX"==e[c].type.toUpperCase()&&0>e[c].parentNode.className.indexOf("ewa-switch")){d=e[c];d.click();break}}}if("1"==a.getAttribute("__ewa_lf_mdown"))this._TrSelectMulti&&(d&&"CHECKBOX"==d.type.toUpperCase()&&(d.checked=!1),this._MSetBg(a,""),a.removeAttribute("__ewa_lf_mdown"),$(a).removeClass("ewa-lf-mdown"));else{d&&(d.checked=!0);this._MSetBg(a,
"down");a.setAttribute("__ewa_lf_mdown",1);$(a).addClass("ewa-lf-mdown");if(!this._TrSelectMulti&&(d=a.parentNode)&&d.rows)for(c=0;c<d.rows.length;c++){var g=d.rows[c];"1"==g.getAttribute("__ewa_lf_mdown")&&g!=a&&(g.removeAttribute("__ewa_lf_mdown"),$(g).removeClass("ewa-lf-mdown"),this._MSetBg(g,""))}if(this.IsReShow)for(c=0;c<e.length;c++)"BUTTON"==e[c].type.toUpperCase()&&(d=e[c],"true"==d.getAttribute("disabled")||1==d.getAttribute("disabled")||"true"==d.parentNode.getAttribute("disabled")||1==
d.parentNode.getAttribute("disabled")?(this._ReshowButs[d.value].disabled=!0,this._ReshowButs[d.value].style.display="none"):(this._ReshowButs[d.value].disabled=!1,this._ReshowButs[d.value].style.display=""))}if(this._IsAddPreRow){if(e=a.getAttribute("ewa_key"),this.AddPreRowCheck(a,e,b)){d=a.parentNode.rows[a.rowIndex+1];if(null==d||1!=d.getAttribute("add_pre_row"))d=a.parentNode.parentNode,c=d.rows[0].cells.length,d=d.insertRow(a.rowIndex+1),d.setAttribute("add_pre_row",1),g=d.insertCell(-1),g.innerHTML=
"",g.colSpan=c,g.className="",d.style.display="none",g.id=("EWA_LF_NR_"+this._Id+"_"+Math.random()).replace(".","G"),$(d).addClass("ewa-lf-add-pre-row");this.prevTr&&(this.AddPreRowCloseBeforeEvent&&this.AddPreRowCloseBeforeEvent(this._Id,a,e,this.prevTr,b),this.prevTr.style.display="none",this.prevTr.cells[0].innerHTML="",this.AddPreRowCloseEvent&&this.AddPreRowCloseEvent(this._Id,a,e,this.prevTr,b));this.prevTr==d?this.prevTr=null:(this.prevTr=d,this.prevTr.style.display="",this.MDownEvent(this._Id,
a,e,this.prevTr,b))}}else this.MDownEvent(a,b)}}};this.AddPreRow=function(a){this._IsAddPreRow||(this.MDownEvent=a);this._IsAddPreRow=!0};this.AddPreRowCheck=function(a,b,c){return!0};this.AddPreRowCloseBeforeEvent=function(a,b,c,d,e){};this.AddPreRowCloseEvent=function(a,b,c,d,e){};this._MSetBg=function(a,b){var c="EWA_TD_M";"down"==b?c="ewa_grid_down":"over"==b&&(c="ewa_grid_mover");for(b=0;b<a.cells.length;b++)$(a.cells[b]).removeClass("ewa_grid_mover ewa_grid_down EWA_TD_M").addClass(c)};this._ReShowSearchQuick=
...
b=$($X("EWA_RESHOW_"+this._Id)).find("td.ewa_lf_func:eq(0)"),c=this;b.find(".ewa_lf_func_dact").each(function(){this.id=EWA_Utils.tempId("gDx_"+c._Id+"_")});a.html(b.html());a.find(".ewa_lf_func_dact").each(function(){this.onclick=function(){b.find('div[id="'+this.id+'"]').click()}});b.parent().hide();$(EWA.OW.Dia._Dialog.GetFrame()).addClass("ewa-lf-btns-in-title")}};this.ReShow=function(a){this.IsReShow=!0;a=document.createElement("table");a.id="EWA_RESHOW_"+this._Id;a.cellSpacing="0";a.cellPadding=
"0";var b=!(0<this.Url.toUpperCase().indexOf("EWA_AJAX=INSTALL")||0<this.Url.toUpperCase().indexOf("EWA_CALL_METHOD=INNER_CALL")||0<this.Url.toUpperCase().indexOf(".JSP"));b?EWA.UI.Utils.SetStyle(a,"width:100%;height:100%;"):EWA.UI.Utils.SetStyle(a,"width:100%");var c=a.insertRow(-1),d=c.insertCell(-1),e=a.insertRow(-1).insertCell(-1);e.className="ewa_lf_func";e.innerHTML='<div style="display:none"></div><div></div>';var g=a.insertRow(-1).insertCell(-1);g.vAlign="top";EWA.UI.Utils.SetStyle(g,"width:100%;");
css="";g.innerHTML='<div id="_G_'+this._Id+'" style="'+css+'"></div>';var h=$X("EWA_LF_"+this._Id),k=h.parentNode.parentNode.parentNode;g.childNodes[0].appendChild(h.parentNode);var l="_G_"+this._Id;this.NewDivId=l;b&&(window.setTimeout(function(){$X("__EWA_DEBUG")&&g.childNodes[0].appendChild($X("__EWA_DEBUG"));var z=$X(l);z.getElementsByTagName("table");var C=EWA.UI.Utils.GetDocSize(window),D=z.parentNode.parentNode.previousSibling.offsetHeight;z.style.top=D+"px";z.style.height=C.H-D+"px"},100),
addEvent(window,"resize",function(){var z=$X(l),C=EWA.UI.Utils.GetDocSize(window),D=z.parentNode.parentNode.previousSibling.offsetHeight;z.style.top=D+"px";z.style.height=C.H-D+"px"}));for(;0<k.childNodes.length;)e.childNodes[0].appendChild(k.childNodes[0]);var m=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",e.childNodes[1]);m.className="ewa_lf_func_caption";b=m;var n=[],p=!1,t=GetInnerText(e);t=t.trim();this._ReshowButs={};for(var r in this.ItemList.Items){m=this.ItemList.Items[r];var q=
this._GetSubValue("Tag","Tag",m);if(null!=q&&("button"==q.trim().toLowerCase()||"butflow"==q.trim().toLowerCase()))for(q=0;q<h.rows[0].cells.length;q++)if(h.rows[0].cells[q].childNodes[0].id.toUpperCase()==r){n.push(q);p=!0;q=this._GetSubValue("DescriptionSet","Info",m);var v=this._GetSubValue("DescriptionSet","Memo",m),u=this._GetSubValue("EventSet","EventName",m),y="";null!=u&&"ewa_click"==u.toLowerCase().trim()&&(y=this._GetSubValue("EventSet","EventValue",m));t=t.replace(q,"");m=this._ReShowButton(q,
v,null);this._ReshowButs[q]=m;m.setAttribute("f_id",this._Id);e.childNodes[1].appendChild(m);""==y?m.onclick=function(){var z=this.getAttribute("f_id");z=EWA.F.FOS[z].SelectCheckedRows();if(null==z||0==z.length)EWA.UI.Msg.Alert(_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM"],_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM_TITLE"]);else{z=z[0].getElementsByTagName("input");for(var C=0;C<z.length;C++){var D=z[C];if("button"==D.type&&D.value==this.childNodes[0].innerHTML){D.click();break}}}}:(m.setAttribute("ewa_click",y),
m.onclick=function(){eval(this.getAttribute("ewa_click"))});break}}p&&this._ReShowSplit(e.childNodes[1]);n=e.getElementsByTagName("input");h={};for(q=0;q<n.length;q++){var w=n[q];w.style.display="none";if(null==w.id||""==w.id)w.id=("_tmp_"+Math.random()).replace(".","_");if("button"==w.type){if(m=this._ReShowButton(w.value,w.title,w.id),p=w.nextSibling){var x="";3==p.nodeType&&(x=p.nodeValue.trimEx());"|"==x&&this._ReShowSplit(e.childNodes[1])}}else(p=w.nextSibling)&&(x=3==p.nodeType?p.nodeValue.replace("|",
""):p.innerHTML),m=this._ReShowButton(x.trimEx(),w.title,w.id),m.id=("_tmp_"+Math.random()).replace(".","_"),h[w.name]||(h[w.name]=[]),h[w.name].push(m.id);e.childNodes[1].appendChild(m)}t=t.replace(/ /ig,"").replace(/\|/ig,"").trimEx();""!=t?0<=t.indexOf("if")?c.style.display="none":d.innerHTML=t.replace(/ /,""):c.style.display="none";k.appendChild(a);for(r in h)for(x=h[r],q=0;q<x.length;q++)w=$X(x[q]),w.setAttribute("_r_ids",x.join(",")),w.onclick=function(){var z=this.getAttribute("_ewa_event_id");
$X(z).click();z=this.getAttribute("_r_ids").split(",");for(var C=0;C<z.length;C++)w.id!=z[C]&&($X(z[C]).style.fontWeight="",$X(z[C]).style.color="");this.style.fontWeight="bold";this.style.color="blue"};b.innerHTML='<b>[<i class="fa fa-star-o"></i>&nbsp;'+this.Description+"]</b>";if(0<this.Url.toUpperCase().indexOf("EWA_BTNS_IN_TITLE"))var A=this,B=0,E=setInterval(function(){B++;1E3<B&&window.clearInterval(E);EWA.OW.Load();EWA.OW.Dia&&(window.clearInterval(E),A.ReShowButtonsInDailogTitle())},10)};
this._ReShowSplit=function(a){EWA.UI.Utils.CreateObject(window,"div","",a).className="ewa_lf_func_split"};this._ReShowButton=function(a,b,c){var d=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",document.body);d.innerHTML="<nobr>"+a+"</nobr>";null!=c&&(d.setAttribute("_ewa_event_id",c),d.onclick=function(){var e=this.getAttribute("_ewa_event_id");$X(e).click()});EWA.B.IE&&(d.onselectstart=function(){return!1});d.className="ewa_lf_func_dact";d.title=b;return d};this.CheckValid=function(a){var b=
...
r+" "+("fix"==r?"ewa-lf-search-fix-m"+(t.M||"0"):"")+"' cellspacing=0 cellpadding=0>");p.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");p.push(q);var v=q="",u="lk";e[g.toUpperCase()]&&(v=e[g.toUpperCase()],u=v.tag,q=v.para1,v=v.para2);var y="";"text"==r?(n=l[u]||l.lk,y="enus"==EWA.LANG?n.TxtEn:n.Txt,p.push("<a class='ewa-lf-search-type' tag='"+u+"' href='javascript:void(0)' onclick='"+h+"'>"),p.push(y),p.push("</a>"),n=!0):"date"==r&&(p.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+

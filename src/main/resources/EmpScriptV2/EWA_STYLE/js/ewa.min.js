...
!1;this.CheckedAllAfter=this.ReloadAfter=null;this.REPLACE_HISTORY_STATE=this.IsNotMDownAutoChecked=!1;this._IsSearchGroup=!0;this.changeTag=function(a){a=new EWA_UrlClass("fake?"+a);var b=new EWA_UrlClass(this.Url),c;for(c in a._Paras)b.AddParameter(c,a._Paras[c]);this.Url=b.GetUrl();this.Reload()};this._InitMneu=function(){var a=window["_EWA_MENU_"+this._Id];if(a&&0!=a.length){for(var b=[],c=0;c<a.length;c++){var d=a[c],e=(0==c?"ewa-lf-menu-marked":"")+(c==a.length-1?"ewa-lf-menu-last":""),g=d.Cmd.replace(/"/g,
"&quot;");b.push('<a class="ewa-lf-menu '+e+"\" onclick=\"$(this).parent().find('.ewa-lf-menu-marked').removeClass('ewa-lf-menu-marked');$(this).addClass('ewa-lf-menu-marked'); "+g+'">'+d.Txt+"</a>")}a=b.join('<b class="ewa-lf-menu-span"></b >');$("#EWA_RESHOW_"+this._Id).find(".ewa_lf_func_caption").after(a)}};this.stickyColumns=function(a){var b=$X("EWA_LF_"+this._Id);if(null==b)console.log("not found table[#EWA_LF_"+this._Id+"]");else if(0!=b.rows.length){var c=$(b).parent();c.addClass("ewa-lf-sticky-scroll");
c.on("scroll",function(){0==this.scrollLeft?c.addClass("ewa-lf-stick-last-hide"):c.hasClass("ewa-lf-stick-last-hide")&&c.removeClass("ewa-lf-stick-last-hide")});for(var d=0;d<a;d++)this.stickyColumn(d,d==a-1,b);c.trigger("scroll")}};this.stickyColumn=function(a,b,c){c=c||$X("EWA_LF_"+this._Id);if(null==c)console.log("not found table[#EWA_LF_"+this._Id+"]");else if(0!=c.rows.length){var d=c.rows[0].cells[a];if(d){var e=$(d).position().left;d=$(d).width();e={left:e,width:d};for(d=0;d<c.rows.length;d++){var g=
$(c.rows[d].cells[a]);g.css(e).addClass("ewa-lf-sticky");b&&g.addClass("ewa-lf-sticky-last").css("overflow","initial")}}}};this.composeSearchTexts=function(){var a=[],b=[],c=$("#EWA_RESHOW_"+this._Id+" .ewa-lf-search-type-text");if(0==c.length)return null;c.each(function(g){var h=$(this).find(".ewa-lf-search-item-title").text();h=h.replace(":","").replace("\uff1a","").replace("\u5305\u542b","").replace("Like","").trim();var k=$(this).find("input[type=text]").attr("name");a.push(h);b.push(k);0<g&&
$(this).hide()});var d=$(c[0]);d.addClass("ewa-app-lf-search-compose");d.find("input[type=text]").attr("name",b.join(",")).attr("placeholder",a.join(", "));var e=d.find("a").clone();d.find(".ewa-lf-search-item-title b").text("enus"==EWA.LANG?"Search":"\u7efc\u5408\u641c\u7d22").append(e);return c};this.switchButtonAction=function(a,b){if(b){var c=this.getUrlClass();c.AddParameter("ewa_switch_name",a.name);c.AddParameter("ewa_action",b);c.AddParameter("ewa_ajax","json");c.AddParameter("ewa_switch",
...
this._Id+"'>");a.push("<tr style='display:none'><td style='padding:0'></td></tr>");a.push("<tr><td class='ewa_lf_func' style='padding:0'>");a.push("<div style='display:none'></div>");a.push("<div><div class='ewa_lf_func_caption'></div></div>");a.push("</td></tr>");a.push("<tr><td style='width:100%;padding:0;vertical-align:top'>");a.push("<div id='"+b+"' style=''></div>");a.push("</td></tr>");a.push("</table>");var c=$(a.join("")),d=!(0<this.Url.toUpperCase().indexOf("EWA_AJAX=INSTALL")||0<this.Url.toUpperCase().indexOf("EWA_CALL_METHOD=INNER_CALL")||
0<this.Url.toUpperCase().indexOf(".JSP"));d?EWA.UI.Utils.SetStyle(c[0],"width:100%;height:100%;border-spacing:0"):EWA.UI.Utils.SetStyle(c[0],"width:100%;border-spacing:0");css="";var e=$X("EWA_LF_"+this._Id);a=e.parentNode.parentNode;var g=e.parentNode;c.find("td:eq(2)>div").append(g);g=c[0];var h=c.find("tr:eq(0)")[0],k=c.find("td:eq(0)")[0],l=c.find("td:eq(1)")[0],m=c.find("td:eq(2)")[0];d&&(window.setTimeout(function(){$X("__EWA_DEBUG")&&m.childNodes[0].appendChild($X("__EWA_DEBUG"));var B=$X(b);
B.getElementsByTagName("table");var D=EWA.UI.Utils.GetDocSize(window),E=B.parentNode.parentNode.previousSibling.offsetHeight;B.style.top=E+"px";B.style.height=D.H-E+"px"},100),addEvent(window,"resize",function(){var B=$X(b),D=EWA.UI.Utils.GetDocSize(window),E=B.parentNode.parentNode.previousSibling.offsetHeight;B.style.top=E+"px";B.style.height=D.H-E+"px"}));for(;0<a.childNodes.length;)l.childNodes[0].appendChild(a.childNodes[0]);c=c.find(".ewa_lf_func_caption")[0];var n=!1;d=GetInnerText(l);d=d.trim();
this._ReshowButs={};e=$(e.rows[0]);for(var p in this.ItemList.Items){var r=this.ItemList.Items[p],q=this._GetSubValue("Tag","Tag",r);if(q&&("button"==q.toLowerCase()||"butflow"==q.toLowerCase())&&(q=this._GetSubValue("Name","Name",r),0!==e.find(".ewa-col-"+q).length)){n=!0;var t=this._GetSubValue("DescriptionSet","Info",r),v=this._GetSubValue("DescriptionSet","Memo",r),u=this._GetSubValue("EventSet","EventName",r),x="";null!=u&&"ewa_click"==u.toLowerCase().trim()&&(x=this._GetSubValue("EventSet",
"EventValue",r));d=d.replace(t,"");r=this._ReShowButton(t,v,null);this._ReshowButs[t]=r;r.setAttribute("f_id",this._Id);r.setAttribute("t_id",q);l.childNodes[1].appendChild(r);""==x?r.setAttribute("onclick","EWA.F.FOS['"+this._Id+"'].reShowButtonClick(this)"):r.setAttribute("onclick",x)}}n&&this._ReShowSplit(l.childNodes[1]);q=l.getElementsByTagName("input");n={};for(e=0;e<q.length;e++){var w=q[e];w.style.display="none";if(null==w.id||""==w.id)w.id=("_tmp_"+Math.random()).replace(".","_");if("button"==
w.type){if(r=this._ReShowButton(w.value,w.title,w.id),t=w.nextSibling){var y="";3==t.nodeType&&(y=t.nodeValue.trimEx());"|"==y&&this._ReShowSplit(l.childNodes[1])}}else(t=w.nextSibling)&&(y=3==t.nodeType?t.nodeValue.replace("|",""):t.innerHTML),r=this._ReShowButton(y.trimEx(),w.title,w.id),r.id=("_tmp_"+Math.random()).replace(".","_"),n[w.name]||(n[w.name]=[]),n[w.name].push(r.id);l.childNodes[1].appendChild(r)}d=d.replace(/ /ig,"").replace(/\|/ig,"").trimEx();""!=d?0<=d.indexOf("if")?h.style.display=
"none":k.innerHTML=d.replace(/ /,""):h.style.display="none";a.appendChild(g);for(p in n)for(y=n[p],e=0;e<y.length;e++)w=$X(y[e]),w.setAttribute("_r_ids",y.join(",")),w.onclick=function(){var B=this.getAttribute("_ewa_event_id");$X(B).click();B=this.getAttribute("_r_ids").split(",");for(var D=0;D<B.length;D++)w.id!=B[D]&&($X(B[D]).style.fontWeight="",$X(B[D]).style.color="");this.style.fontWeight="bold";this.style.color="blue"};c.innerHTML='<b><i class="fa fa-star-o">&nbsp;</i>'+this.Description+"</b>";
if(0<this.Url.toUpperCase().indexOf("EWA_BTNS_IN_TITLE"))var z=this,A=0,C=setInterval(function(){A++;1E3<A&&window.clearInterval(C);EWA.OW.Load();EWA.OW.Dia&&(window.clearInterval(C),z.ReShowButtonsInDailogTitle())},10);this._InitMneu()};this.reShowButtonClick=function(a){a=a.getAttribute("t_id");var b=this.SelectCheckedRows();if(null==b||0==b.length)EWA.UI.Msg.Alert(_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM"],_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM_TITLE"]);else{b=b[0].getElementsByTagName("input");for(var c=
...
d.title=b;return d};this.CheckValid=function(a){var b=a.tagName.toLowerCase();if("input"!=b&&"textarea"!=b&&"select"!=b||"button"==a.type||"submit"==a.type||"image"==a.type)return!0;b=this.ItemList.GetObjectValue(a);return this.ItemList.CheckValid(a,b)};this.ShowEdit=function(a){a.parentNode.style.width=a.clientWidth+"px";a.style.display="none";__show_obj__=a.nextSibling;__show_obj__.style.display="";var b=__show_obj__.childNodes[0];3==b.nodeType&&(b=__show_obj__.childNodes[1]);b.setAttribute("old",
b.value);"SELECT"!=b.tagName||b.getAttribute("func")||(b.setAttribute("func",1),b.onchange=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)});null==b.getAttribute("__ewa_fid__")&&(b.setAttribute("__ewa_fid__",this._Id),b.onblur=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)},b.onkeydown=function(c){c=null==c?window.event:c;var d=c.target?c.target:c.srcElement;13==c.keyCode&&"INPUT"==d.tagName&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this);
27==c.keyCode&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditReset(this)});setTimeout(function(){b.focus();b.select()},10)};this.EditReset=function(a){a.parentNode.style.display="none";var b=a.parentNode.previousSibling;b.style.display="";b.innerHTML=a.getAttribute("old");"select"==a.tagName.toLowerCase()?b.innerHTML=a.options[a.selectedIndex].text:a.value=a.getAttribute("old").replace(/</ig,"&lt;").replace(/>/ig,"&gt;")};this.EditAfter=function(a){if(this.CheckValid(a))if(a.getAttribute("old")==
a.value)this.EditReset(a);else{a.parentNode.style.display="none";var b=a.parentNode.previousSibling;b.style.display="";if("droplist"==a.getAttribute("ewa_class")){var c=$(a.parentNode.getElementsByTagName("input")[1]).attr("name");var d=a.parentNode.getElementsByTagName("input")[1].value;b.innerHTML=a.parentNode.getElementsByTagName("input")[0].value}else"select"==a.tagName.toLowerCase()?(c=$(a).attr("name"),b.innerHTML=a.options[a.selectedIndex].text):(c=a.value.replace(/</ig,"&lt;").replace(/>/ig,
"&gt;").replace(/\n/ig,"<br>"),b.innerHTML=c,c=$(a).attr("name")),d=a.value;b=a.getAttribute("action_name");if(""==b||null==b)b="OnListFrameUpdateCell";var e=a.getAttribute("action_confirm");e=null==e?"":e;var g=a.getAttribute("action_tip");null==g&&(g="");var h=a.getAttribute("action_js"),k=this.ItemList.GetValue(c,"DataItem","DataType");c=[{Name:"EWA_FIELD_ID",Value:c},{Name:"EWA_FIELD_VAL",Value:d},{Name:"EWA_ACTION_RELOAD",Value:"0"},{Name:c,Value:d},{Name:"EWA_DATA_TYPE",Value:k},{Name:"EWA_FIELD_VAL_OLD",
Value:a.getAttribute("old")}];this.EditEvent={FROM:a,OLD_VAL:a.getAttribute("old"),NEW_VAL:a.value};this.DoAction(a,b,e,g,c,h)}else a.focus()};this.RewriteInfo=function(a,b,c,d,e){var g=$("#EWA_LF_"+this._Id),h=[];if(a)this._INFO={},this._INFO.INFO=a,this._INFO.ID_NAME=b||"id",this._INFO.INFO_NAME=c||"info",this._INFO.MEMO_NAME=d||"memo";else if(!this._INFO||!this._INFO.INFO)return;for(a=0;a<this._INFO.INFO.length;a++)if(b=this._INFO.INFO[a],c=g.find('[id="'+b[this._INFO.ID_NAME]+'"]:eq(0)'),0!==
c.length){d=c.parentsUntil("tr").last();var k=b[this._INFO.INFO_NAME],l=b[this._INFO.MEMO_NAME];if(null==k||""==k.trim())for(k=d.parent()[0],l=0;l<k.cells.length;l++){if(k.cells[l]==d[0]){this.ShowHiddenColumn(l,!1);break}}else 0==c.children().length?c.text(k):c.children()[0].innerText=k,l&&c.attr("title",l);h.push(c[0]);e&&e(c[0],b,a)}return h};this.ShowHiddenColumn=function(a,b){var c=$X("EWA_LF_"+this._Id),d="";if(null==b||0==b||"none"==b)d="none";for(b=0;b<c.rows.length;b++)c.rows[b].cells.length==
c.rows[0].cells.length&&(c.rows[b].cells[a].style.display=d)};this.ShowHiddenColumns=function(a,b){var c=$X("EWA_LF_"+this._Id),d="";if(null==b||0==b||"none"==b)d="none";b=c.rows[0].cells.length;for(var e=0;e<c.rows.length;e++){var g=c.rows[e];if(g.cells.length==b)for(var h=0;h<a.length;h++)g.cells[a[h]].style.display=d}};this.GroupShowHidden=function(a){var b=$(a).attr("t"),c=(new Date).getTime();if(!(b&&333>c-b)){$(a).attr("t",c);b=a.parentNode.parentNode;c=b.getAttribute("ewa_group");""==c?(c=
"none",a.childNodes[0].innerHTML=" + "):(c="",a.childNodes[0].innerHTML=" - ");b.setAttribute("ewa_group",c);for(var d=b.parentNode.parentNode,e=0,g=b.rowIndex+1;g<d.rows.length;g++){b=d.rows[g];if("group"==b.getAttribute("ewa_tag"))break;b.getAttribute("add_pre_row")?"none"==c?("none"!=b.style.display&&b.setAttribute("ewa_group_show_old",b.style.display),b.style.display="none"):b.hasAttribute("ewa_group_show_old")&&(b.style.display=b.getAttribute("ewa_group_show_old"),b.removeAttribute("ewa_group_show_old")):
(b.style.display=c,e++)}a.childNodes[a.childNodes.length-1].innerHTML=" ("+e+")"}};this.Sort=function(a){var b=this._last_sort_timer||0,c=this._Sort||"",d=(new Date).getTime();c==a&&500>d-b||(this._last_sort_timer=d,this._Sort=a,this.Goto(1))};this.SearchClear=function(a){a=a.parentNode.parentNode.parentNode.parentNode;for(var b=0;b<a.rows.length;b+=1)for(var c=a.rows[b].getElementsByTagName("input"),d=0;d<c.length;d++){var e=c[d];if("text"==e.type)e.value="";else if("radio"==e.type||"checkbox"==
e.type)e.checked=!1}};this.SearchGetExpInit=function(){var a=$("#_G_"+this._Id),b=[];$(a).find(".ewa-lf-search-item").each(function(){var c=$(this).find("input");if(0==c.length&&(c=$(this).find("select"),0==c.length))return;var d=c[0],e=$(d).attr("t");if(1==c.length){var g=d.value;if(""!=d.value.trim())for("text"==e&&(c=$(d.parentNode.parentNode).find("a").attr("tag"))&&(e=c),d=d.name.split(","),c=0;c<d.length;c++)b.push(d[c]+"["+e+"]"+g)}else if(("date"==e||"number"==e)&&2==c.length){if(g=d.value,
e=c[1].value,""!=e||""!=g)b.push(d.name+"[gte]"+g),e&&b.push(d.name+"[lte]"+e)}else if("fix"==e&&"INPUT"==d.tagName){var h=[""];$(this).find("input").each(function(){this.checked&&h.push(this.value)});1!=h.length&&b.push(d.name+"[or]"+h.join(";"))}});return b.join(",")};this.SearchGetExp=function(a){var b=[];$(a).find(".ewa-lf-search-item").each(function(){var c=$(this).find("input");if(0==c.length&&(c=$(this).find("select"),0==c.length))return;var d=c[0],e=$(d).attr("t");if(1==c.length){var g=d.value;
""!=d.value.trim()&&("text"==e&&(c=$(d.parentNode.parentNode).find("a").attr("tag"))&&(e=c),b.push("@!@"+d.name+"~!~"+e+"~!~"+g))}else if(("date"==e||"number"==e)&&2==c.length)g=d.value,c=c[1].value,""==c&&""==g||b.push("@!@"+d.name+"~!~"+e+"~!~"+g+"~!~"+c);else if("fix"==e&&"INPUT"==d.tagName){var h=[""];$(this).find("input").each(function(){this.checked&&h.push(this.value)});1!=h.length&&b.push("@!@"+d.name+"~!~"+e+h.join("~!~"))}});return b.join("")};this.DoSearch=function(a){var b=!1;a.id=="EWA_SEARCH_ITEM_"+
...
0>g||h<g||(c=e.substring(0,g).trim(),0!=c.length&&(g=e.substring(g+1,h).trim().toLowerCase(),0!=g.length&&(e=e.substring(h+1).trim(),""!=e&&(b[c.toUpperCase()]||(b[c.toUpperCase()]={name:c,tag:g}),c=b[c.toUpperCase()],"lt"==g||"lte"==g?c.para2=e.unURL().replace(/\+/ig," "):c.para1=e.unURL().replace(/\+/ig," ")))))}return b};this.SearchFilterDate=function(a){var b=$(this._MENU_DATE_RANGE.SHOW_BY_OBJECT).parentsUntil(".ewa-lf-search-item").last(),c=b.find("input")[0];b=b.find("input")[1];if("Clear"==
a)$(c).val(""),$(b).val("");else{var d=EWA_Utils.Date(),e="",g="";"Today"==a?g=e=d.GetDateString():"Week"==a?(a=d.GetBenWeek(),e=a[0],g=a[1]):"Today-Weekend"==a?(a=d.GetBenWeek(),e=a[d.GetDateString()],g=a[1]):"Month"==a?(a=d.GetBenMonth(),e=a[0],g=a[1]):"Today-EOM"==a?(a=d.GetBenMonth(),e=a[d.GetDateString()],g=a[1]):"Quarter"==a?(a=d.GetBenQ(),e=a[0],g=a[1]):"Today-EOQ"==a?(a=d.GetBenQ(),e=a[d.GetDateString()],g=a[1]):"Year"==a?(a=d.GetBenYear(),e=a[0],g=a[1]):"Today-EOY"==a&&(a=d.GetBenYear(),
e=a[d.GetDateString()],g=a[1]);a=EWA_Utils.Date(e).FormatDate();d=EWA_Utils.Date(g).FormatDate();d+=" 23:59:59";$(c).val(a);$(b).val(d)}};this._SearchCreateDateRange=function(){var a="_MENU_DATE_RANGE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",c=JSON.parse(JSON.stringify(this.RESOURCES.search_date_items)),d="EWA.F.FOS[&quot;"+this._Id+"&quot;].SearchFilterDate",e;for(e in c){var g=c[e];g.Txt=g[b];g.Cmd=d+"(&quot;"+g.Id+"&quot;)"}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_DATE_RANGE";
...
g,e[g.toUpperCase()]=this._SearchJson[g];this._SearchJson=e;var h="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextType(this)",k="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchDateType(this)",l=$J2MAP(this.RESOURCES.search_text_items,"Id");e=this._GetInitSearchMap();var m=!1,n=!1;for(g in this.ItemList.Items)if(null!=this._SearchJson[g]){var p=[],r=this._SearchJson[g],q=r.T,t=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[g]);p.push("<table class='ewa-lf-search-item ewa-ref-"+
g+" ewa-lf-search-type-"+q+" "+("fix"==q?"ewa-lf-search-fix-m"+(r.M||"0"):"")+"' cellspacing=0 cellpadding=0>");p.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");p.push(t);var v=t="",u="lk";e[g.toUpperCase()]&&(v=e[g.toUpperCase()],u=v.tag,t=v.para1,v=v.para2);var x="";"text"==q?(n=l[u]||l.lk,x="enus"==EWA.LANG?n.TxtEn:n.Txt,p.push("<a class='ewa-lf-search-type' tag='"+u+"' href='javascript:void(0)' onclick='"+h+"'>"),p.push(x),p.push("</a>"),n=!0):"date"==q&&
(p.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+k+"'></a>"),m=!0);p.push("</b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==q?"blk"==u||"nblk"==u?(r=this._SearchSingle(g,x),r=r.replace("<input","<input disabled "),p.push(r)):p.push(this._SearchSingle(g,t)):"date"==q?p.push(this._SearchDate(g,t,v)):"number"==q?p.push(this._SearchNumber(g,t,v)):"fix"==q&&(r="<div >"+this._SearchFix(g,r,"span",t)+"</div>",p.push(r));p.push("</td></tr></table>");"fix"==q&&
this._IsSearchGroup?c.push(p.join("")):d.push(p.join(""))}if(0!=d.length+c.length){b.push('<table class="ewa-lf-search-main" id="'+a+'" cellspacing="0" cellpadding="0">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");0<d.length&&b.push(" "+d.join("")+" ");for(d=0;d<c.length;d++)b.push(" "+c[d]+" ");b.push("</td></tr></table>");var w=document.createElement("div");this._SEARCH_BOX=w;w.className="ewa-lf-search";w.innerHTML=b.join("");b=$X("EWA_LF_"+this.Id).parentNode;b.parentNode.insertBefore(w,
b);a="EWA_SEARCH_ITEM_"+this.Id;var y=this;m&&this._SearchCreateDateRange();n&&this._SearchCreateTextType();y._SEARCH_ITEM_EXP=this.SearchGetExp(w);"{}"!=JSON.stringify(e)&&(y._SearchExp=y._SEARCH_ITEM_EXP);$(w).find("input[type=text]").on("compositionstart",function(){y._is_search_composition=!0}).on("compositionend",function(){y._is_search_composition=!1});this._TIMER_SEARCH=window.setInterval(function(){if(!y._is_search_composition){try{if(!$X(a)){window.clearInterval(y._TIMER_SEARCH);return}}catch(A){window.clearInterval(y._TIMER_SEARCH);
return}var z=y.SearchGetExp(w);z!=y._SEARCH_ITEM_EXP&&(y._SEARCH_ITEM_EXP=z,y.DoSearch($X(a)))}},700)}};this._SearchSingle=function(a,b){var c=[];c.push('<input t="text" type="text" autocomplete="off" class="EWA_INPUT" maxlength="40" name="');c.push(a.toInputValue());c.push('"');null!=b&&(c.push(' value="'),a=b.toInputValue(),c.push(a),c.push('" '));c.push(" />");return c.join("")};this._SearchDate=function(a,b,c){var d=[];d.push("<table border=0 cellpadding=0 cellspacing=0>");d.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');
...
for(var e=0;e<b.D.length;e++){var g=b.D[e],h="<option @CKD t='fix' id='@ID' value=\"@V\">@T</option> ".replace("@ID",this.Id+"_"+a+"_SearchFix_"+e);h=h.replace("@V",g[0]);h=h.replace("@T",g[1]);h=d&&g[0]==d?h.replace("@CKD","selected"):h.replace("@CKD","");c.push(h)}c.push("</select>");return c.join("")};this._SearchCreate=function(){var a=[];a.push("<div><table border=0 style='margin:0px;' class=EWA_TABLE cellspacing=1>");for(var b in this.ItemList.Items)if(null!=this._SearchJson[b]){var c=this._SearchJson[b],
d=c.T,e=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[b]);a.push("<tr><td class=EWA_TD_L width=140><nobr>"+e+"<nobr></td><td width=350 class=EWA_TD_M>");"text"==d?a.push(this._SearchSingle(b)):"date"==d?a.push(this._SearchDate(b)):"number"==d?a.push(this._SearchNumber(b)):"fix"==d&&a.push(this._SearchFix(b,c,"div"));a.push("</td></tr>")}a.push("<tr><td class=EWA_TD_B colspan=2 align=right><input onclick='EWA.F.FOS[\""+this._Id+"\"].SearchClear(this);' type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLEAR"]+
"'> <input type=submit value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.SEARCH"]+"' onclick='EWA.F.FOS[\""+this._Id+"\"].DoSearch(this);'> <input type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLOSE"]+"' onclick='EWA.F.FOS[\""+this.Id+"\"]._SearchDialog.Show(false);'></td></tr>");a.push("</table></div>");this._SearchHtml=a.join("")};this.createRegExp=function(a){if(!a)return null;a=String(a).trim();if(0===a.length)return null;for(var b=[],c=0;c<a.length;c++){var d=a[c];"a"<=d&&"z">=d||"A"<=d&&"Z">=
d||"0"<=d&&"9">=d?b.push(d):b.push("\\"+d)}try{return new RegExp("("+b.join("")+")")}catch(e){return console.warn("new RegExp",a,e),null}};this.SearchMark=function(){for(var a=this._SearchExp.split("@!@"),b=$X("EWA_LF_"+this._Id),c=0;c<a.length;c+=1){var d=a[c].split("~!~");if(!(3>d.length))for(var e=2,g={};e<d.length;g={regExp:void 0},e++){var h=d[e];if(""!=h){if("fix"==d[1]){var k=d[2];$("table#EWA_SEARCH_ITEM_"+this.Id+' [name="'+d[0]+'"]').find("option").each(function(){this.value==k&&(h=this.text)})}g.regExp=
this.createRegExp(h);var l=d[0].split(","),m;for(m in l){var n=l[m];this._SearchJson[n]&&(n=this._SearchJson[n].ORI_NAME);n=$(b).find(".ewa-lf-data-row .ewa-col-"+n).not("[ewa-search-marked=yes]");n.attr("ewa-search-marked","yes");try{n.find("*").each(function(p){return function(){0==this.children.length&&(this.innerHTML=this.innerHTML.replace(p.regExp,"<font color=red><b>$1</b></font>"))}}(g))}catch(p){console.log(p)}}}}}};this.DblClick=function(a){this._IsDblClick=a;for(var b=$X("EWA_LF_"+this._Id),
c=1;c<b.rows.length;c++)b.rows[c].ondblclick=function(){var d=this.getElementsByTagName("input");d.length>a&&0==d[a].disabled&&d[a].click()}};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);if((a=$X("EWA_LF_"+this._Id))&&"table"==a.tagName&&!(1>=a.rows.length)){a=a.rows[1].getElementsByTagName("input");for(var b=0;b<a.length;b++)if("RADIO"==a[b].type.toUpperCase()){this._TrSelectMulti=
!1;break}}};this.SetPageParameters=function(a,b,c,d,e){this._PageCurrent=a;this._PageSize=c;this._PageCount=b;this._RecordCount=d;this._Sort=e};this.SetPageParametersName=function(a,b,c,d,e){this._PageCurrentName=a;this._PageSizeName=c;this._PageCountName=b;this._RecordCountName=d;this._SortName=e};this.CheckedAll=function(){var a=document.getElementById("EWA_LF_"+this._Id);if(!(1>=a.rows.length)){for(var b=0;b<a.rows.length;b+=1){var c=a.rows[b].getElementsByTagName("input");0!=c.length&&(c[0].checked=
this._IsCheckedAll)}this._IsCheckedAll=this._IsCheckedAll?!1:!0;this.CheckedAllAfter&&this.CheckedAllAfter(a)}};this.SelectChecked=function(){var a=$X("EWA_LF_"+this._Id);if(!a||1>a.rows.length)return"";var b=[],c=[];$("#EWA_LF_"+this._Id+">tbody>tr").find("input[type='radio'],input[type='checkbox']").each(function(){-1==this.parentNode.className.indexOf("ewa-switch")&&c.push(this)});if(0<c.length)for(var d=0;d<c.length;d++)c[d].checked&&b.push(c[d].value);else for(d=0;d<a.rows.length;d++){var e=
a.rows[d];1==e.getAttribute("__ewa_lf_mdown")&&b.push(e.getAttribute("EWA_KEY"))}return b.join(",")};this.SelectCheckedInputs=function(){var a=[],b=$X("EWA_LF_"+this._Id);if(1>b.rows.length)return a;b=b.getElementsByTagName("input");a=[];for(var c=0;c<b.length;c++)("CHECKBOX"==b[c].type.toUpperCase()||"RADIO"==b[c].type.toUpperCase())&&b[c].checked&&a.push(b[c]);return a};this.SelectCheckedRows=function(){for(var a=[],b=$X("EWA_LF_"+this._Id),c=0;c<b.rows.length;c++){var d=b.rows[c],e=d.getElementsByTagName("input");
0!=e.length&&e[0].checked&&-1==e[0].parentNode.className.indexOf("ewa-switch")&&a.push(d)}if(0==a.length)for(c=0;c<b.rows.length;c++)d=b.rows[c],1==d.getAttribute("__ewa_lf_mdown")&&a.push(d);return a};this.Reload=function(a){this.StopAjaxAfterReload?this.StopAjaxAfterReload=!1:this.Goto(this._PageCurrent,a)};this.refreshPage=function(a,b){this.replaceRowsData(null,null,a,b)};this.replaceRowsData=function(a,b,c,d){var e=this.getUrlClass();e.AddParameter("EWA_AJAX","LF_RELOAD");e.AddParameter("EWA_IS_SPLIT_PAGE",
"no");e.AddParameter("EWA_IS_HIDDEN_CAPTION","yes");e=e.GetUrl();a&&(e+="&"+a);var g=a?new EWA_AjaxClass:this.CreateAjax(),h=this;g.PostNew(e,function(){if(4==g._Http.readyState){g.HiddenWaitting();var k=g._Http.responseText;200!=g._Http.status?(console.error(k),alert("ERROR:\r\n"+g._Http.statusText)):EWA.F.CheckCallBack(k)?h.replaceRowsWithDataHtml(k,b,c,d):console.error(k)}})};this.replaceRowsWithDataHtml=function(a,b,c,d){var e=$("<div></div>");e.html(a);var g=[],h=$("#EWA_LF_"+this._Id);e.find(".ewa-lf-data-row").each(function(){var k=
'tr[ewa_key="'+$(this).attr("ewa_key")+'"]',l=h.find(k);if(0==l.length)console.warn(k+" not found");else{k=$(this).attr("ewa_row_sign");var m=l.attr("ewa_row_sign"),n=!0;(k||m)&&m===k&&(n=!1);if(n){l.attr("ewa_row_sign",k);k=l.clone()[0];for(m=0;m<this.cells.length;m++){n=l[0].cells[m];var p=this.cells[m];n.removeAttribute("ewa-merged");n.removeAttribute("ewa-search-marked");b?b(p,n):n.innerHTML=p.innerHTML}g.push({before:k,current:l[0]})}}});e.remove();this.SearchMark();this.IsReShow&&this.ReShowWithNoButtons();
this._ReShowSearchQuick();null!=this._IsDblClick&&this.DblClick(this._IsDblClick);this.SubBottomsArray&&this._SubBottoms();this.ReloadAfter&&this.ReloadAfter(c);this.ReloadAfterApp&&this.ReloadAfterApp(c);d&&d(g)};this.DoAction=function(a,b,c,d,e,g){EWA.F.CID=this._Id;if(b){if(a&&$(a).parent().hasClass("scroll-delete")){var h=$(a).attr("do-action-time")||0,k=(new Date).getTime();if(1E3>k-h)return;$(a).attr("do-action-time",k)}this.lastAction=b;this._Ajax=new EWA_AjaxClass;this._Ajax.LoadingType="image";
this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.AddParameter("EWA_ACTION_TIP",d);null!=g&&0<g.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",g),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=!1;if(a&&a.getAttribute&&"yes"==a.getAttribute("box_menu_item")){if(this._Ajax.AddParameter("___CALL__FROM__","box"),
...
function(){m._CallBackJs()})})):this._Ajax.PostNew(l,function(){m._CallBackJs()})}};this.NewPageSize=function(a){this._PageSize!=a&&(this._PageSize=a,this.Goto(1))};this.Goto=function(a,b){EWA.F.CID=this._Id;this._PageCurrent=a;this._Ajax=this.CreateAjax();a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.RemoveParameter("EWA_AJAX");var c=this;this._Ajax.PostNew(a.GetUrl(),function(){c._CallBack(b)});this.REPLACE_HISTORY_STATE&&this.replaceHistoryState()};this.createReplaceHistoryStateUrl=
...
this._IsCheckedAll=!0))):alert("ERROR:\r\n"+b._Http.statusText);this.RewriteInfo()}};this._CallBackJs=function(){var a=this._Ajax;if(4==a._Http.readyState){if(top.EWA&&top.EWA.MQE){var b=new EWA_MqeClass;b.Data=a.GetRst();b.FromId=EWA.F.CID;b.Type="POST";top.EWA.MQE.AddMqe(b)}a.HiddenWaitting();200==a._Http.status?(a=a._Http.responseText,EWA.F.CheckCallBack(a)&&eval(a)):alert("ERROR:\r\n"+a._Http.statusText);this.EditAfterEvent&&this.EditAfterEvent()}};this.EditAfterEvent=function(){this.getUrlClass().GetParameter("EWA_ROW_SIGN")&&
this.refreshPage()};this._GetItem=function(a){for(var b=this.ItemList,c=0;c<b.length;c+=1){var d=b[c],e=this._GetSubItem("Name",d);if(this.Xml.GetElementAttribute(e,"Name")==a)return d}};this._GetSubItem=function(a,b){b=this.Xml.GetElements(a+"/Set",b);if(null==b||0==b.length)return null;if("DescriptionSet"==a)for(a=0;a<b.length;a+=1){var c=b[a].getAttribute("Lang");if(null!=c&&c.trim().toUpperCase()==EWA.LANG.trim().toUpperCase())return b[a]}return b[0]};this._GetSubValue=function(a,b,c){a=this._GetSubItem(a,
c);return null==a?null:this.Xml.GetElementAttribute(a,b)};this.AddColumns=function(a,b,c,d,e,g,h,k){var l=$X("EWA_LF_"+this._Id);null==k&&(k=l.rows[0].cells.length);for(var m=0;m<a.length;m++)for(var n=a[m],p=k+m,r=0;r<l.rows.length;r++){var q=l.rows[r].insertCell(p);q.title=n[d];if(0==r)q.className="EWA_TD_H ewa-add-column ewa-col-"+n[b],q.innerHTML='<nobr cellIdx="'+p+'" id="'+n[b]+'">'+n[c]+"</nobr>",q.title=n[d],q.width=100;else{var t=l.rows[r].getAttribute("EWA_KEY");q.className="EWA_TD_M ewa-add-column ewa-col-"+
n[b];t=t+"_"+n[b];var v=this._GetAddControl(n[g],n[c],n[d]);null==v&&(v=e);var u=h.replace("[ID]",n[b]);v=0<=v.indexOf("<select")?v.replace("!!",u.replace("onblur=","onchange=")):v.replace("!!",u);q.innerHTML=v;q.childNodes[0].id=t}}};this._GetAddControl=function(a,b,c){if(null==a)return null;a=a.toUpperCase().trim();b=b?b.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/"/ig,"&quot;"):"";c=c?c.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/"/ig,"&quot;"):"";return"SELECT"==a?'<select des="'+
b+'"  title="'+c+'" !!></select>':"DATE"==a?'<input type=text des="'+b+'" title="'+c+'" class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,false);" readonly !!>':"TIME"==a?'<input type=text des="'+b+'" title="'+c+'"  class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,true);" readonly !!>':"STRING"==a||"NUMBER"==a?'<input type=text des="'+b+'"  title="'+c+'" class=EWA_INPUT !!>':null};this.AddedValues=function(a,b,c,d,e){for(var g=0;g<a.length;g++){var h=a[g],k=$X(h[b]+"_"+h[c]);if(!k)break;var l=k.tagName.toUpperCase();
"INPUT"==l||"SELECT"==l||"TEXTAREA"==l?k.value=h[d]:k.innerHTML=h[d];e&&(this.GetRow(k).getElementsByTagName("input")[0].checked=!0)}};this.AddRow=function(a){for(var b=$X("EWA_LF_"+this._Id),c=b.insertRow(-1),d=0;d<b.rows[0].cells.length;d++){var e=c.insertCell(-1),g=b.rows[0].cells[d];e.className="EWA_TD_M";null!=a[d]&&(e.innerHTML=a[d]);e.style.display=g.style.display;e.id="ADD_ROW_"+g.childNodes[0].id}return c};this.Calc=function(a,b,c,d){for(var e=$X("EWA_LF_"+this._Id),g={},h=0;h<a.length;h++)g[a[h]]=
0;for(h=b;h<c;h++)for(a=e.rows[h],b=0;b<a.cells.length;b++)if(null!=g[b]){var k=a.cells[b],l=k.getElementsByTagName("input");0<l.length?g[b]+=1*l[0].value:(k=GetInnerText(k),""==k&&(k=0),g[b]+=1*k)}c=e.rows[d];for(h=0;h<c.cells.length;h++)null!=g[h]&&(k=Math.round(100*g[h])/100,d=GetInnerText(c.cells[h]),k!=1*d&&(this.IsCalcChanged=!0),c.cells[h].innerHTML=k.fm())};this.mergeHeaders=function(a,b,c){var d=$($X("EWA_LF_"+this._Id)),e=d.find('tr[ewa_tag="HEADER"]');if(0!=e.length&&(a=e.find('nobr[id="'+
a+'"]').parent(),0!=a.length)){var g=d.find("tr[ewa_mearge]");0==g.length&&(g=$(d[0].insertRow(1)),g.attr("ewa_mearge","gdx"));d=-1;for(var h=0;h<e[0].cells.length;h++){var k=e[0].cells[h];k==a[0]&&(d=h,k.colSpan=c);if(-1==d)"1"!=$(k).attr("ewa_tdmearged")&&(k.rowSpan=2);else if(d+c==h)d=-1,k.rowSpan=2;else{k.rowSpan=1;var l=g[0].insertCell(-1);l.innerHTML=k.innerHTML;l.className=k.className;l.style.cssText=k.style.cssText;k.style.display="none";$(k).attr("ewa_tdmearged",1)}k==a[0]&&(k.innerHTML=
b,k.style.display="",k.style.width="")}}};this.MeargeHeader=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 mergeHeaders");this.mergeHeaders(a,b,c)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}

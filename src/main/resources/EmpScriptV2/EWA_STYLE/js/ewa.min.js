...
a.find("td").text("");var b={},d;for(d in this.SubBottomsArray){var e=this.SubBottomsArray[d];b.$jscomp$loop$prop$total$35=0;var g="#EWA_LF_"+this._Id+' .ewa-lf-data-row [name="'+e+'"]';b.$jscomp$loop$prop$fm_length$36=0;$(g).each(function(h){return function(){var k=this.hasAttribute("value")?this.value:this.hasAttribute("title")?this.title:this.innerText;null!=k&&0!==k.length&&(k=k.replace(/,/ig,""),isNaN(k)||(h.$jscomp$loop$prop$total$35+=1*k,0<k.indexOf(".")&&(h.$jscomp$loop$prop$fm_length$36=
2)))}}(b));g="<span id='"+e+"' name='"+e+"' class='ewa-lf-sub'>"+b.$jscomp$loop$prop$total$35.fm(b.$jscomp$loop$prop$fm_length$36)+"</span>";a.find("td[id=ADD_ROW_"+e+"]").html(g);b={$jscomp$loop$prop$total$35:b.$jscomp$loop$prop$total$35,$jscomp$loop$prop$fm_length$36:b.$jscomp$loop$prop$fm_length$36}}};this.ChangeRowStyle=function(a,b,d){for(var e=$X("EWA_LF_"+this._Id),g=1;g<e.rows.length;g++){var h=e.rows[g];if(!(0==h.cells.length||h.cells.length<=a)){var k=h.cells[a].childNodes[0].getAttribute(b);

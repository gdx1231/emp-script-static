...
l)}}else alert("ERROR:\r\n"+h._Http.statusText);h=null}})}}};this.ValidCodeError=function(a){$(".ewa-valid-code-img").each(function(){this.click()});a||($Tip(_EWA_EVENT_MSG.ValidCodeError),$(".ewa-valid-code-img").parent().parent().find("input").focus().select())};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.F=this;this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);"enus"==EWA.LANG&&$(".ewa-ipt-droplist").attr("placeholder",
"Input character selection");this._InitTranslations();this._GetDropListValue();this._InitMustInputs();this._InitEncyptions()};this._InitMustInputs=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name");0<$(d).find('IsMustInput Set[IsMustInput="1"]').length&&(d="#"+e,a.find(".ewa-row-"+e).addClass("ewa-row-must"),e=a.find(d),e.addClass("ewa-row-item-must"),0<e.length&&e.attr("type")&&"hidden"==e.attr("type").toLowerCase()&&
...
return b};this._SearchCreateItm=function(){var a="EWA_SEARCH_ITEM_"+this.Id,b=[],d=[],e=[],g={},h;for(h in this._SearchJson)this._SearchJson[h].ORI_NAME=h,g[h.toUpperCase()]=this._SearchJson[h];this._SearchJson=g;var k="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextType(this)",l="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchDateType(this)",m=$J2MAP(this.RESOURCES.search_text_items,"Id");g=this._GetInitSearchMap();var n=!1,p=!1;for(h in this.ItemList.Items)if(null!=this._SearchJson[h]){var q=
[],u=this._SearchJson[h],r=u.T,t=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[h]);q.push("<table class='ewa-lf-search-item ewa-ref-"+h+" ewa-lf-search-type-"+r+" "+("fix"==r?"ewa-lf-search-fix-m"+(u.M||"0"):"")+"' cellspacing=0 cellpadding=0>");q.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");q.push(t);var w=t="",v="lk";g[h.toUpperCase()]&&(w=g[h.toUpperCase()],v=w.tag,t=w.para1,w=w.para2);var y="";"text"==r?(p=m[v]||m.lk,y="enus"==EWA.LANG?p.TxtEn:
p.Txt,q.push("<a class='ewa-lf-search-type' tag='"+v+"' href='javascript:void(0)' onclick='"+k+"'>"),q.push(y),q.push("</a>"),p=!0):"date"==r&&(q.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+l+"'></a>"),n=!0);q.push("</b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==r?"blk"==v||"nblk"==v?(u=this._SearchSingle(h,y),u=u.replace("<input","<input disabled "),q.push(u)):q.push(this._SearchSingle(h,t)):"date"==r?q.push(this._SearchDate(h,t,w)):"number"==r?q.push(this._SearchNumber(h,
t,w)):"fix"==r&&(u="<div >"+this._SearchFix(h,u,"span",t)+"</div>",q.push(u));q.push("</td></tr></table>");"fix"==r?d.push(q.join("")):e.push(q.join(""))}if(0!=e.length+d.length){b.push('<table class="ewa-lf-search-main" id="'+a+'" cellspacing="0" cellpadding="0" style="width:100%">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");0<e.length&&b.push(" "+e.join("")+" ");if(0<d.length)for(e=0;e<d.length;e++)b.push(" "+d[e]+" ");b.push("</td></tr></table>");var x=document.createElement("div");
this._SEARCH_BOX=x;x.className="ewa-lf-search";x.innerHTML=b.join("");b=$X("EWA_LF_"+this.Id).parentNode;b.parentNode.insertBefore(x,b);a="EWA_SEARCH_ITEM_"+this.Id;var z=this;n&&this._SearchCreateDateRange();p&&this._SearchCreateTextType();z._SEARCH_ITEM_EXP=this.SearchGetExp(x);"{}"!=JSON.stringify(g)&&(z._SearchExp=z._SEARCH_ITEM_EXP);$(x).find("input[type=text]").on("compositionstart",function(){z._is_search_composition=!0}).on("compositionend",function(){z._is_search_composition=!1});this._TIMER_SEARCH=
window.setInterval(function(){if(!z._is_search_composition){try{if(!$X(a)){window.clearInterval(z._TIMER_SEARCH);return}}catch(C){window.clearInterval(z._TIMER_SEARCH);return}var A=z.SearchGetExp(x);A!=z._SEARCH_ITEM_EXP&&(z._SEARCH_ITEM_EXP=A,z.DoSearch($X(a)))}},700)}};this._SearchSingle=function(a,b){var d=[];d.push('<input t="text" type="text" autocomplete="off" class="EWA_INPUT" maxlength="40" name="');d.push(a.toInputValue());d.push('"');null!=b&&(d.push(' value="'),a=b.toInputValue(),d.push(a),
d.push('" '));d.push(" />");return d.join("")};this._SearchDate=function(a,b,d){var e=[];e.push("<table border=0 cellpadding=0 cellspacing=0>");e.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');e.push(a);e.push('"');b&&(b=b.toInputValue(),e.push(' value="'),e.push(b),e.push('"'));e.push(' /></td><td><span class="ewa-lf-search-split"> - </span></td>');e.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');
e.push(a);e.push('1"');d&&(b=d.toInputValue(),e.push(' value="'),e.push(b),e.push('"'));e.push("/></td></tr></table>");return e.join("")};this._SearchNumber=function(a,b,d){var e=[];e.push('<input type="text" t="number" size="10" name="');e.push(a);e.push('"');b&&(b*=1,e.push(' value="'),e.push(b),e.push('"'));e.push(' /><span class="ewa-lf-search-split"> - </span>');e.push('<input type="text" t="number" size="10" name="');e.push(a);e.push('1"');d&&(b=1*d,e.push(' value="'),e.push(b),e.push('"'));
e.push("/>");return e.join("")};this._SearchFix=function(a,b,d,e){var g=[],h="radio";if("1"==b.M)h="checkbox";else if("2"==b.M)return this._SearchFix1(a,b,d,e);d="<"+d+"><nobr><input t='fix' [@CHK] id='@ID' value=\"@V\" type='"+h+"' name='"+a+"' /><label for='@ID'>@T</label></nobr></"+d+"> ";h={};if(e){e=e.split(";");for(var k in e)h[e[k].trim().toUpperCase()]=1}for(k=0;k<b.D.length;k++){var l=b.D[k];e=l[0];l=l[1];var m=this.Id+"_"+a+"_SearchFix_"+k,n=d.replace("@ID",m);n=n.replace("@ID",m);n=n.replace("@V",
e);n=h[e.toUpperCase().trim()]?n.replace("[@CHK]","checked"):n.replace("[@CHK]","");n=n.replace("@T",l);g.push(n)}return g.join("")};this._SearchFix1=function(a,b,d,e){d=[];d.push("<select t='fix' name='"+a+"'><option></option>");for(var g=0;g<b.D.length;g++){var h=b.D[g],k="<option @CKD t='fix' id='@ID' value=\"@V\">@T</option> ".replace("@ID",this.Id+"_"+a+"_SearchFix_"+g);k=k.replace("@V",h[0]);k=k.replace("@T",h[1]);k=e&&h[0]==e?k.replace("@CKD","selected"):k.replace("@CKD","");d.push(k)}d.push("</select>");
return d.join("")};this._SearchCreate=function(){var a=[];a.push("<div><table border=0 style='margin:0px;' class=EWA_TABLE cellspacing=1>");for(var b in this.ItemList.Items)if(null!=this._SearchJson[b]){var d=this._SearchJson[b],e=d.T,g=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[b]);a.push("<tr><td class=EWA_TD_L width=140><nobr>"+g+"<nobr></td><td width=350 class=EWA_TD_M>");"text"==e?a.push(this._SearchSingle(b)):"date"==e?a.push(this._SearchDate(b)):"number"==e?a.push(this._SearchNumber(b)):
"fix"==e&&a.push(this._SearchFix(b,d,"div"));a.push("</td></tr>")}a.push("<tr><td class=EWA_TD_B colspan=2 align=right><input onclick='EWA.F.FOS[\""+this._Id+"\"].SearchClear(this);' type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLEAR"]+"'> <input type=submit value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.SEARCH"]+"' onclick='EWA.F.FOS[\""+this._Id+"\"].DoSearch(this);'> <input type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLOSE"]+"' onclick='EWA.F.FOS[\""+this.Id+"\"]._SearchDialog.Show(false);'></td></tr>");
a.push("</table></div>");this._SearchHtml=a.join("")};this.SearchMark=function(){for(var a=this._SearchExp.split("@!@"),b=$X("EWA_LF_"+this._Id),d=0;d<a.length;d+=1){var e=a[d].split("~!~");if(!(3>e.length))for(var g=2;g<e.length;g++){var h=e[g];if(""!=h){if("fix"==e[1]){var k=e[2];$("table#EWA_SEARCH_ITEM_"+this.Id+' [name="'+e[0]+'"]').find("option").each(function(){this.value==k&&(h=this.text)})}for(var l=[],m=0;m<h.length;m++){var n=h[m];"a"<=n&&"z">=n||"A"<=n&&"Z">=n||"0"<=n&&"9">=n?l.push(n):
l.push("\\"+n)}h=l.join("");h=eval("/("+h+")/ig");l=e[0].split(",");for(var p in l){m=l[p];this._SearchJson[m]&&(m=this._SearchJson[m].ORI_NAME);m=$(b).find(".ewa-lf-data-row .ewa-col-"+m).not("[ewa-search-marked=yes]");m.attr("ewa-search-marked","yes");try{m.find("*").each(function(){0==this.children.length&&(this.innerHTML=this.innerHTML.replace(h,"<font color=red><b>$1</b></font>"))})}catch(q){console.log(q)}}}}}};this.DblClick=function(a){this._IsDblClick=a;for(var b=$X("EWA_LF_"+this._Id),d=
1;d<b.rows.length;d++)b.rows[d].ondblclick=function(){var e=this.getElementsByTagName("input");e.length>a&&0==e[a].disabled&&e[a].click()}};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);if((a=$X("EWA_LF_"+this._Id))&&"table"==a.tagName&&!(1>=a.rows.length)){a=a.rows[1].getElementsByTagName("input");for(var b=0;b<a.length;b++)if("RADIO"==a[b].type.toUpperCase()){this._TrSelectMulti=!1;
break}}};this.SetPageParameters=function(a,b,d,e,g){this._PageCurrent=a;this._PageSize=d;this._PageCount=b;this._RecordCount=e;this._Sort=g};this.SetPageParametersName=function(a,b,d,e,g){this._PageCurrentName=a;this._PageSizeName=d;this._PageCountName=b;this._RecordCountName=e;this._SortName=g};this.CheckedAll=function(){var a=document.getElementById("EWA_LF_"+this._Id);if(!(1>=a.rows.length)){for(var b=0;b<a.rows.length;b+=1){var d=a.rows[b].getElementsByTagName("input");0!=d.length&&(d[0].checked=
this._IsCheckedAll)}this._IsCheckedAll=this._IsCheckedAll?!1:!0;this.CheckedAllAfter&&this.CheckedAllAfter(a)}};this.SelectChecked=function(){var a=$X("EWA_LF_"+this._Id);if(!a||1>a.rows.length)return"";var b=[],d=$F(a,"input","type","radio,checkbox");if(0<d.length)for(var e=0;e<d.length;e++)d[e].checked&&b.push(d[e].value);else for(e=0;e<a.rows.length;e++)d=a.rows[e],1==d.getAttribute("__ewa_lf_mdown")&&b.push(d.getAttribute("EWA_KEY"));return b.join(",")};this.SelectCheckedInputs=function(){var a=
...
q=l+n,u=0;u<m.rows.length;u++){var r=m.rows[u].insertCell(q);if(0==u)r.className="EWA_TD_H",r.innerHTML='<nobr cellIdx="'+q+'" id="'+p[b]+'">'+p[d]+"</nobr>",r.title=p[e],r.width=100;else{var t=m.rows[u].getAttribute("EWA_KEY");r.className="EWA_TD_M";t=t+"_"+p[b];var w=this._GetAddControl(p[h]);null==w&&(w=g);var v=k.replace("[ID]",p[b]);w=0<=w.indexOf("<select")?w.replace("!!",v.replace("onblur=","onchange=")):w.replace("!!",v);r.innerHTML=w;r.childNodes[0].id=t}}};this._GetAddControl=function(a){if(null==
a)return null;a=a.toUpperCase().trim();return"SELECT"==a?"<select !!></select>":"DATE"==a?'<input type=text class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,false);" readonly !!>':"TIME"==a?'<input type=text class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,true);" readonly !!>':"STRING"==a||"NUMBER"==a?"<input type=text class=EWA_INPUT !!>":null};this.AddedValues=function(a,b,d,e,g){for(var h=0;h<a.length;h++){var k=a[h],l=$X(k[b]+"_"+k[d]);if(!l)break;var m=l.tagName.toUpperCase();"INPUT"==m||
"SELECT"==m||"TEXTAREA"==m?l.value=k[e]:l.innerHTML=k[e];g&&(this.GetRow(l).getElementsByTagName("input")[0].checked=!0)}};this.AddRow=function(a){for(var b=$X("EWA_LF_"+this._Id),d=b.insertRow(-1),e=0;e<b.rows[0].cells.length;e++){var g=d.insertCell(-1),h=b.rows[0].cells[e];g.className="EWA_TD_M";null!=a[e]&&(g.innerHTML=a[e]);g.style.display=h.style.display;g.id="ADD_ROW_"+h.childNodes[0].id}return d};this.Calc=function(a,b,d,e){for(var g=$X("EWA_LF_"+this._Id),h={},k=0;k<a.length;k++)h[a[k]]=0;
for(k=b;k<d;k++)for(a=g.rows[k],b=0;b<a.cells.length;b++)if(null!=h[b]){var l=a.cells[b],m=l.getElementsByTagName("input");0<m.length?h[b]+=1*m[0].value:(l=GetInnerText(l),""==l&&(l=0),h[b]+=1*l)}d=g.rows[e];for(k=0;k<d.cells.length;k++)null!=h[k]&&(l=Math.round(100*h[k])/100,e=GetInnerText(d.cells[k]),l!=1*e&&(this.IsCalcChanged=!0),d.cells[k].innerHTML=l.fm())};this.mergeHeaders=function(a,b,d){var e=$($X("EWA_LF_"+this._Id)),g=e.find('tr[ewa_tag="HEADER"]');if(0!=g.length&&(a=g.find('nobr[id="'+
a+'"]').parent(),0!=a.length)){var h=e.find("tr[ewa_mearge]");0==h.length&&(h=$(e[0].insertRow(1)),h.attr("ewa_mearge","gdx"));e=-1;for(var k=0;k<g[0].cells.length;k++){var l=g[0].cells[k];l==a[0]&&(e=k,l.colSpan=d);if(-1==e)"1"!=$(l).attr("ewa_tdmearged")&&(l.rowSpan=2);else if(e+d==k)e=-1,l.rowSpan=2;else{l.rowSpan=1;var m=h[0].insertCell(-1);m.innerHTML=l.innerHTML;m.className=l.className;m.style.cssText=l.style.cssText;l.style.display="none";$(l).attr("ewa_tdmearged",1)}l==a[0]&&(l.innerHTML=
b,l.style.display="",l.style.width="")}}};this.MeargeHeader=function(a,b,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 mergeHeaders");this.mergeHeaders(a,b,d)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}

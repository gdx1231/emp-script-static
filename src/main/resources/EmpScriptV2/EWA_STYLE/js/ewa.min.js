/*
 ...
 https://gdxsoft.com/
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.createTemplateTagFirstArg=function(a){return a.raw=a};$jscomp.createTemplateTagFirstArgWithRaw=function(a,b){a.raw=b;return a};$jscomp.checkStringArgs=function(a,b,d){if(null==a)throw new TypeError("The 'this' value for String.prototype."+d+" must not be null or undefined");if(b instanceof RegExp)throw new TypeError("First argument to String.prototype."+d+" must not be a regular expression");return a+""};$jscomp.ASSUME_ES5=!1;
$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,d){if(a==Array.prototype||a==Object.prototype)return a;a[b]=d.value;return a};
...
"Format"):"":""};this.GetObjectValue=function(a){var b=a.tagName.toUpperCase(),d=a,e="";if("DIV"==b&&"REPT"==a.getAttribute("TAG")){a=a.getElementsByTagName("input");for(var g=0;g<a.length;g+=1)a[g].checked&&(0<e.length&&(e+=","),e+=a[g].value);return e}if("DIV"==b&&"1"==a.getAttribute("EWA_DHTML"))return e=a.getElementsByTagName("iframe")[0].contentWindow,b=e.document.getElementsByTagName("textarea"),e=0<b.length&&"none"!=b[0].style.display?b[0].value:e.frames[0].document.body.innerHTML,null!=location.search&&
0>location.search.toUpperCase().indexOf("EWA_DHTML_HOST")&&(g="http:\\/\\/"+eval("document.location.host")),g=eval("/"+g+"/ig"),e=e.replace(g,""),a=a.getElementsByTagName("input")[0],a.value=e,a.value;if("SELECT"==b)return e="",0<=d.options.selectedIndex&&(e=d.options[d.options.selectedIndex].value),e;if("TEXTAREA"==b&&"none"==d.style.display)return a.value;if("INPUT"==b&&"IMG_UPLOAD"==d.getAttribute("ewa_tag"))return e="/"!=EWA.CP?d.value.replace(EWA.CP,""):d.value,e=e.replace("//","/");if("INPUT"==
b&&d.getAttribute("val_ref")){a=d.getAttribute("val_ref");try{e=eval("(function(){var a="+a+";return a;})()")}catch(h){console.log(a),console.log(h),e=""}return e}if("INPUT"==b&&("checkbox"==d.type||"radio"==d.type))return e=d.checked?d.value:"";(e=d.value)&&this.isTrim(a)&&(g=e.trim(),g!==e&&(e=g));if("INPUT"!==b||!this.isNumber(a))return e;if(""!==e){if(isNaN(e)&&(e=e.replace(/,/ig,""),isNaN(e)))try{e=EWA_Utils.chineseToNumber(e)+"",a.value=e}catch(h){return e}g=this.getFormat(a);if("LeastMoney"==
g||"Money"==g)g=e.split("."),a.value=1==g.length?(1*e).fm(0):(1*e).fm(g[1].length)+(0==g[1].length?".":"");return e}}}function EWA_FrameResourceDescription(){this.Memo=this.Info=this.Lang=null}
...
(function(a,b){"object"===typeof module&&"object"===typeof module.exports?module.exports=b():b(a)})("undefined"!==typeof window?window:this,function(a){function b(m){for(var n=[{number:0,scale:1}],p=null,q=0;q<m.length;q++){var u=m[q],r=g[u];if(r)0==q&&r.first?n[n.length-1].number=10:r.stop?(n[n.length-1].scale=r.value,n.push({number:0,scale:1}),scale=1,p=null):(q==m.length-1&&(console.log(r),n[n.length-1].number.scale=r.value),p=r);else{r=e[u];if(null==r)throw"\u975e\u6570\u5b57\u6216\u5355\u4f4d\uff1a"+
u;(u=q==m.length-1?null:g[m[q+1]])&&u.stop&&(u=null);var t=n[n.length-1].number;u=null==u?null==p?10*t+r:t+r:t+r*u.value;n[n.length-1].number=u;p=null;console.log("num="+r+",  number="+u)}}console.log(n);return n}function d(m){if(!m)return m;if(!isNaN(m.toString()))return m.toString();var n=m.replace(/\uff0c|,| /ig,"").replace(/\u70b9|\u3002/ig,".").split(".");if(2<n.length)throw"\u975e\u6570\u5b57\u8868\u8fbe\u5f0f\uff1a"+m;var p=n[0].split("");m=(2==n.length?n[1]:"").split("");n=!1;var q=p[0];h[q]?
(n=!0,p=p.splice(1)):k[q]&&(n=!1,p=p.splice(1));q=p[p.length-1];l[q]?p=p.splice(0,p.length-1):(q=m[m.length-1],l[q]&&(m=m.splice(0,m.length-1)));p=b(p);q=0;for(var u=1,r=p.length-1;0<=r;r--){var t=p[r],w=t.number;u*=t.scale;q+=w*u}p=q;q=1;u=0;for(r=m.length-1;0<=r;r--){t=g[m[r]];if(!t)break;q*=t.value;u++}m=1==q?m:m.splice(0,m.length-u);u=b(m);r=0;t=1;for(w=u.length-1;0<=w;w--){var v=u[w],y=v.number;t*=v.scale;r+=y*t}m=[1*("0."+r),q,m.length];return 0==m?p*(n?-1:1):((p+m[0])*m[1]).toFixed(0>m[2]?
0:m[2])*(n?-1:1)}var e={"\u96f6":0,0:0,"\uff10":0,o:0,O:0,"\u4e00":1,"\u58f9":1,1:1,"\uff11":1,"\u4e8c":2,"\u8d30":2,2:2,"\uff12":2,"\u4e24":2,"\u4fe9":2,"\u4e09":3,"\u53c1":3,3:3,"\uff13":3,"\u56db":4,"\u8086":4,4:4,"\uff14":4,"\u4e94":5,"\u4f0d":5,5:5,"\uff15":5,"\u516d":6,"\u9646":6,6:6,"\uff16":6,"\u4e03":7,"\u67d2":7,7:7,"\uff17":7,"\u516b":8,"\u634c":8,8:8,"\uff18":8,"\u4e5d":9,"\u7396":9,9:9,"\uff19":9},g={"\u5341":{value:10,first:!0},"\u62fe":{value:10,first:!0},"\u4ec0":{value:10,first:!0},
"\u767e":{value:100},"\u4f70":{value:100},"\u964c":{value:100},"\u5343":{value:1E3},"\u9621":{value:1E3},"\u4edf":{value:1E3},k:{value:1E3,stop:!0},K:{value:1E3,stop:!0},"\u4e07":{value:1E4,stop:!0},"\u842c":{value:1E4,stop:!0},M:{value:1E6,stop:!0},m:{value:1E6,stop:!0},"\u4ebf":{value:1E8,stop:!0},b:{value:1E9,stop:!0},B:{value:1E9,stop:!0}},h={"-":!0,"\u8d1f":!0,"\uff0d":!0},k={"+":!0,"\u6b63":!0},l={"\u6574":!0};if(window&&window.EWA&&window.EWA_Utils)window.EWA_Utils.chineseToNumber=d;else if(a)a.chineseToNumber=
d;else return d});

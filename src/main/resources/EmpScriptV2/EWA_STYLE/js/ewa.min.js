...
var b=$(this).find("*:eq(0)").attr("id");b&&a.find(".ewa-row-"+b).hide().attr("hiddennocontentrow",1)}})};this.itemReload=function(a,b,d){if(a){var e=new EWA_UrlClass(this.Url);e.AddParameter("EWA_AJAX","SELECT_RELOAD");e.AddParameter("EWA_RELOAD_ID",a);e=e.GetUrl();$J(e,function(g){if(g.RST){var h=g.ITEM.LST,k=$X(a);k.options.length=0;for(var l in h){var m=h[l];m=new Option(m.T,m.V);k.options[k.options.length]=m}b&&(k.value=b);if(d)try{d(g,k)}catch(n){console.log(n)}}else $Tip(g.ERR)})}};this._checkSelectOptionsChange=
function(){if(this._SelectFilters){var a=this;this.isSelectFilter&&setTimeout(function(){a._checkSelectOptionsChange()},311);for(var b in this._SelectFilters){var d=this._SelectFilters[b];this.getObj("#"+d.id).html()!=d.html&&a._selectOptionsChangeed(d)}setTimeout(function(){a._checkSelectOptionsChange()},311)}};this._selectOptionsChangeed=function(a){console.log("changed");var b=this.getObj("select#"+a.id),d="initSelectFilter"+this._Id+"-"+a.id+"-filter",e="initSelectFilter"+this._Id+"-"+a.id+"-filter2",
g=this._initSelectFilterCreateCode(a.codeJsonFrom,b);this.getObj("#"+d).html(g);this.getObj("#"+e).html("");a.html=b.html()};this._initSelectFilterCreateCode=function(a,b){var d=["<option value=''>ALL</option>"];if(a){var e={},g=[];b.find("option").each(function(){if(""!=this.value){var l;this.hasAttribute("para_"+a)?l=this.getAttribute("para_"+a):this.getAttribute("json")&&(l=JSON.parse(this.getAttribute("json"))[a]);l&&!e[l]&&(e[l]=!0,g.push(l))}});var h=g.sort(),k;for(k in h)b=h[k],b=b.replace(/>/ig,
"&lt;").replace(/"/,"&quot;"),d.push('<option value="'+b+'">'+b+"</option>")}else for(k="A".charCodeAt();k<="Z".charCodeAt();k++)b=String.fromCharCode(k),d.push('<option value="'+b+'">'+b+"</option>");return d.join("")};this.initSelectFilter=function(a,b,d,e){if(!this["INIT_SELECT_FILTER"+a]){this["INIT_SELECT_FILTER"+a]=!0;var g=$("#EWA_FRAME_"+this._Id+" select#"+a),h=g.parent(),k="initSelectFilter"+this._Id+"-"+a+"-filter",l="initSelectFilter"+this._Id+"-"+a+"-filter2",m="initSelectFilter"+this._Id+
"-"+a+"-filter-table";$X(m)&&(h.append(g),$($X(m)).remove());h.addClass("ewa-select-filter");k=["<table id='"+m+"' cellpadding=0 cellspacing=0 width=100%><tr><td class='ewa-select-filter-char'><select class='EWA_SELECT' style='margin-right:4px' id='"+k+"' onchange='EWA.F.FOS[\""+this._Id+'"]._chCode(this,"'+b+'","'+d+"\")'>"];m=this._initSelectFilterCreateCode(e,g);k.push(m);k.push("</select><select id='"+l+"' style='display:none'></select></td><td class='ewa-select-filter-target'></td></tr></table>");
h.prepend(k.join(""));h.find(".ewa-select-filter-target").append(g);this._SelectFilters||(this._SelectFilters={});h={};h.html=g.html();h.id=a;h.filterType=b;h.filterFrom=d;h.codeJsonFrom=e;this._SelectFilters[h.id]=h}};this._chCode=function(a,b,d){this.isSelectFilter=!0;var e=$(a).next(),g=$(a).parent().parent().find(".ewa-select-filter-target select");0==e[0].options.length&&e.html(g.html());if(""==a.value)g.html(e.html());else{for(var h=["<option></option>"],k=1;k<e[0].options.length;k++){var l=
e[0].options[k];this._chCodeFilter(l,b,d,a.value)&&h.push(GetOuterHTML(l))}g.html(h.join(""));this._SelectFilters[g[0].id].html=g.html();this.isSelectFilter=!1}};this._chCodeFilter=function(a,b,d,e){"json"==b?(a=JSON.parse(a.getAttribute("json"))[d],"ADM_LID"==d&&(d=a.split("."),a=d[d.length-1])):a="text"==b?a.text:a.value;return a?a.substring(0,e.length).toUpperCase()==e.toUpperCase()?!0:!1:!1};this.setUnMust=function(a){(a=this.ItemList.Items[a])&&a.getElementsByTagName("IsMustInput")[0].getElementsByTagName("Set")[0].setAttribute("IsMustInput",
0)};this.setMust=function(a){(a=this.ItemList.Items[a])&&a.getElementsByTagName("IsMustInput")[0].getElementsByTagName("Set")[0].setAttribute("IsMustInput",1)};this.RedrawCreateSpans=function(){for(var a=$("#EWA_FRAME_"+this._Id+" tr"),b=0;b<a.length;b++){var d=a[b];if("none"!=d.style.display)for(var e=0,g=!1,h=d.cells.length-1;0<=h;h--){var k=d.cells[h];"none"==k.style.display?g?e++:(e=1,g=!0):g&&(k.colSpan=e+1,g=!1)}}EWA_FrameShowAlert=EWA_FrameShowAlert1;EWA_FrameRemoveAlert=EWA_FrameRemoveAlert1;
...
"")+1*h.css("padding-right").replace("px","");e.find(".ewa-row-"+a).hide();null==d&&(d=" - ");var q=l.width(),u=g[0].tagName,r=h[0].tagName;g.parent().hasClass("ewa-select-filter-target")&&(g=e.find(".ewa-row-"+a+" .EWA_TD_M table:eq(0)"),u="SELECT_WITH_FILTER");var t=0;b=null;d&&(l.append('<span class="mearge-span">'+d+"</span>"),k&&m.find("table:eq(0) td:eq(1)").html('<span class="mearge-span">'+d+"</span>").show(),b=l.find(".mearge-span"),t=b.width()+1+1*b.css("padding-left").replace("px","")+
1*b.css("padding-right").replace("px","")+1*b.css("margin-left").replace("px","")+1*b.css("margin-right").replace("px",""));u==r?(d=(q-t)/2-n-2,g.css("width",d),h.css("width",d),k&&m.find("table:eq(0) td:eq(2), table:eq(0) td:eq(0)").css("width",d)):"SELECT"==u?(g.css("width",100),h.css("width",q-t-n-p-2-2-g.width())):"SELECT_WITH_FILTER"==u?(g.css("width",200),h.css("width",q-t-n-p-2-2-g.width())):"SELECT"==r&&(h.css("width",100),g.css("width",q-t-n-p-2-2-g.width()));h.css("float","left");b&&b.css("float",
...
k.DoValidExAction_RETS[g]=m;0==m?(EWA_FrameRemoveAlert(a,d),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,e),a.setAttribute("EWA_VALID_EX",e))}catch(n){alert(n+","+l)}}else alert("ERROR:\r\n"+h._Http.statusText);h=null}})}}};this.ValidCodeError=function(a){$(".ewa-valid-code-img").each(function(){this.click()});a||($Tip(_EWA_EVENT_MSG.ValidCodeError),$(".ewa-valid-code-img").parent().parent().find("input").focus().select())};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);
this.ItemList.F=this;this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);"enus"==EWA.LANG&&$(".ewa-ipt-droplist").attr("placeholder","Input character selection");this._InitTranslations();this._GetDropListValue();this._InitMustInputs();this._InitEncyptions()};this._InitMustInputs=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name");0<$(d).find('IsMustInput Set[IsMustInput="1"]').length&&
(d="#"+e,a.find(".ewa-row-"+e).addClass("ewa-row-must"),e=a.find(d),e.addClass("ewa-row-item-must"),0<e.length&&e.attr("type")&&"hidden"==e.attr("type").toLowerCase()&&e.prev().addClass("ewa-row-item-must"))}};this._InitEncyptions=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name");d=$(d).find("DispEnc Set");if(0!=d.length&&(e=a.find("#"+e),0!=e.length&&d.attr("EncType"))){if("INPUT"==e[0].tagName||"TEXTAREA"==
e[0].tagName){if(!e.val())continue;e.prop("disabled",!0);e.attr("ewa_encyrption","yes")}var g=$("<div class='ewa-enc-cover' style='position:absolute;left:0;top:0;width:100%;height:100%;'><div></div></div>");e.parent().append(g);e.parent().css("position","relative");if(d=d.attr("EncShowUrl")){g.find("div").html("\u70b9\u51fb\u67e5\u770b").css({position:"absolute",height:30,"line-height":"30px",top:"50%","margin-top":"-15px",right:10,"text-align":"right"});d=new EWA_UrlClass(d);g=new EWA_UrlClass(this.Url);
for(var h in g._Paras)if(!d.GetParameter(h)){var k=g._Paras[h];null!=k&&(k=k.unURL());d.AddParameter(h,k)}d.AddParameter("EWA_ENCY_FROM_ID",e.attr("id"));d=d.GetUrl();e.parent().attr("enc_url",d).attr("fid",e.attr("id"));e.parent().on("click",function(){if(!$(this).attr("enc_ok")){var l=$(this).attr("t")||100,m=(new Date).getTime();if(!(400>m-l)){$(this).attr("t",m);l=$(this).attr("enc_url");var n=$(this).find("#"+$(this).attr("fid"));$J(l,function(p){p.RST?(n.prop("disabled",!1),n.removeAttr("ewa_encyrption"),
n.val(p.VALUE),$(n).parent().find(".ewa-enc-cover").remove(),$(n).parent().attr("enc_ok","1")):(p.ERR||p.MSG)&&$Tip(p.ERR||p.MSG)})}}})}}}};this._InitTranslations=function(){var a="EWA.F.FOS[&quot;"+this._Id+"&quot;]._Trans(this)",b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name"),g=$(d).find("DataItem Set[Translation]");if(d=g.attr("Translation")){g=g.attr("TransTarget");var h="en2zh"==d?" \u82f1\u8bd1\u4e2d":" \u4e2d\u8bd1\u82f1";"enus"==EWA.LANG&&
(h="en2zh"==d?" En-Zh":" Zh-En");d=$('<a class="ewa-but-trans" href="javascript:void(0)" onclick="'+a+'" _transf="'+e+'" _transp="'+d+'" _transt="'+g+'">'+h+"</a>");g=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+e+" .EWA_TD_L");0==g.length&&(g=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+e+" .EWA_TD"));0==g.length&&(g=$("#EWA_FRAME_"+this._Id+" #"+e).parent().prev().find(".ewa_d1"));0==g.length&&(g=$("#EWA_FRAME_"+this._Id+" #"+e).parent(),g.css("position","relative"),d.addClass("ewa-but-trans-float"));g.append(d)}}};
this._Trans=function(a){if(a){var b=$(a).attr("_transf"),d=$(a).attr("_transp");a=$(a).attr("_transt");b=$("#EWA_FRAME_"+this._Id+" #"+b);a=$("#EWA_FRAME_"+this._Id+" #"+a);if(0==b.length||0==a.length)console.log("trans ex:",b,a);else{var e=b[0].tagName.toLowerCase();if(b="input"==e||"textarea"==e||"hidden"==e?b.val():b.text()){var g=new EWA_TransClass;"en2zh"==d?g.transToCn(b,a[0]):g.transToEn(b,a[0]);$Tip("enus"==EWA.LANG?"Translating...":"\u7ffb\u8bd1\u4e2d...",function(){return!g.IsRun})}}}};
this._bindCompostion=function(a,b){if(!EWA.B.IE){var d=this;d._droplist_||(d._droplist_={});d._droplist_[b.id]={_is_composition:!1};$(a).on("compositionstart",function(){d._droplist_[b.id]._is_composition=!0}).on("compositionend",function(){d._droplist_[b.id]._is_composition=!1;EWA.F.I.DropList(this)}).removeAttr("oninput").removeAttr("onkeyup").on("input",function(){d._droplist_[b.id]._is_composition||EWA.F.I.DropList(this)})}};this._GetDropListValue=function(){var a=this.getObj();if(0!=a.length){a=
a[0];var b=a.getElementsByTagName("input");this._droplist_={};for(var d=0;d<b.length;d++){var e=b[d];if("droplist"==e.getAttribute("ewa_class")){var g=e.nextSibling;"INPUT"==g.tagName.toUpperCase()&&"HIDDEN"==g.type.toUpperCase()&&(this._GetDropListValue1(e,g),this._bindCompostion(e,g))}}a=a.getElementsByTagName("select");for(d=0;d<a.length;d++)if(e=a[d],b=e.getAttribute("_ListFilterType"))g=e.getAttribute("_ListFilterField"),this.initSelectFilter(e.id,b,g);this._SelectFilters&&this._checkSelectOptionsChange()}};
this._GetDropListValue1=function(a,b){if(""==b.value)b.setAttribute("setvalue",1);else{var d=b.getAttribute("DlsShow");if(null==d||""==d)b.setAttribute("canopen",0),a.value=b.value,b.setAttribute("canopen",1);else{var e=new EWA_AjaxClass,g=b.getAttribute("xmlName"),h=b.getAttribute("itemName"),k=b.getAttribute("paraName"),l=b.getAttribute("DlsAction");e=new EWA.C.Ajax;var m=b.value;var n=this.EWA_CGI?this.EWA_CGI:window.EWA_CGI?window.EWA_CGI:EWA.CP+"/EWA_STYLE/cgi-bin/";var p=-1==n.indexOf("?")?
"?":"&";n=(n+(p+"XMLNAME="+g+"&ITEMNAME="+h+"&EWA_AJAX=JSON")).replace("//","/");n=n.replace("//","/");n=n.replace("//","/");e.AddParameter(k,m);null!=l&&0<l.trim().length&&(e.AddParameter("EWA_ACTION",l),e.AddParameter(b.id,b.value));e.PostNew(n,function(){if(e.IsRunEnd()){var q=e.GetRst(),u="__json"+Math.random();try{eval('window["'+u+'"]='+q)}catch(v){b.setAttribute("canopen",0);a.value=v;b.setAttribute("canopen",1);return}q=window[u];if(0!=q.length){u=q[0];var r=[];q={};for(var t in u)r.push(u[t]),
q["@"+t.toUpperCase()]=u[t],u[t]&&b.setAttribute("para_"+t.toLowerCase(),u[t]);if(null==d||""==d)q=r.join("/");else{t=d.match(/@[a-zA-Z0-9\-\._:]*\b/ig);for(u=0;u<t.length;u++){r=t[u];var w=q[r.toUpperCase()];d=d.replace(r,w)}q=d}b.setAttribute("canopen",0);a.value=q;b.id=null==b.id||""==b.id?Math.random():b.id;"yes"==b.getAttribute("isdlseventload")&&(EWA.F.FOS[b.id]=new EWA_FrameItemClass,EWA.F.FOS[b.id].DropList(a),EWA.F.FOS[b.id].CallAfterEvent());b.setAttribute("canopen",1);b.setAttribute("setvalue",
1)}}})}}};this.DoPostEx=function(){EWA.F.F.CUR=this;if(this.CheckValidAll(document.forms[0])){this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");for(var a=document.getElementsByTagName("input"),b=0;b<a.length;b+=1){var d=a[b],e=""==d.name?d.id:d.name;null!=e&&""!=e&&this._Ajax.AddParameter(e,d.value)}a=document.getElementsByTagName("select");for(b=0;b<a.length;b+=1)d=
a[b],e=""==d.name?d.id:d.name,null!=e&&""!=e&&this._Ajax.AddParameter(e,d.value);a=document.getElementsByTagName("textarea");for(b=0;b<a.length;b+=1)d=a[b],e=""==d.name?d.id:d.name,null!=e&&""!=e&&this._Ajax.AddParameter(e,d.value);this._Ajax.PostNew(this.Url,EWA.F.F.CUR._CallBack)}};this.CreateAjax=function(a,b){EWA.F.F.CUR=this;null==a&&(a=$("#f_"+this._Id)[0]);if(!b&&!this.CheckValidAll(a))return null;b=new EWA.C.Ajax;for(var d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],
"Name","Name"),g=this.GetObject(e,a);if(null!=g&&!$(g).attr("ewa_encyrption")){var h=g.getAttribute("ewa_tag");if("signature"==h){var k="N";var l=this.tablets[d];for(var m=0;m<l.lines.length;m++)if(l.lines[m]){k="Y";break}l="Y"==k?this._GetObjectValue(g):"";b.AddParameter(e+"_CHANGED",k)}else l=this._GetObjectValue(g);null!=l&&b.AddParameter(e,l);"DIV"==g.tagName.toUpperCase()&&"1"==g.getAttribute("EWA_DHTML")&&(k=$X("UP_IMG_"+e).value,b.AddParameter(e+"_imgs_split",k));if("swffile"==h||"IMG_UPLOAD"==
h)if(e=g.getAttribute("UP_PARAS"),null!=e&&0<e.length)for(e=e.split(","),h=0;h<e.length;h++){var n=e[h];b.AddParameter(n,g.getAttribute(n))}else b.AddParameter("UP_URL",g.value);else"markdown"==h&&(g=g.parentNode.getElementsByTagName("textarea"),1<g.length&&b.AddParameter(g[1].id,g[1].value))}}if(this.PostAddData)for(n in this.PostAddData)b.AddParameter(n,this.PostAddData[n]);return b};this.CreatePostData=function(){var a=$("#f_"+this._Id)[0],b={},d;for(d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],
"Name","Name"),g=this.GetObject(e,a);if(null!=g){var h=this._GetObjectValue(g);null!=h&&(b[e]=h);"DIV"==g.tagName.toUpperCase()&&"1"==g.getAttribute("EWA_DHTML")&&(h=$X("UP_IMG_"+e).value,b[e+"_imgs_split"]=h);e=g.getAttribute("ewa_tag");if("swffile"==e||"IMG_UPLOAD"==e)if(h=g.getAttribute("UP_PARAS"),null!=h&&0<h.length){h=h.split(",");for(var k=0;k<h.length;k++){var l=h[k];b[l]=g.getAttribute(l)}}else b.UP_URL=g.value;"markdown"==e&&(g=g.parentNode.getElementsByTagName("textarea"),1<g.length&&(b[g[1].id]=
g[1].value))}}return b};this.DoPostBefore=function(){return!0};this.isDoPostBeforeTimer=function(){return null!=this._checkStatusFristResult};this._uploadingFileCheck=function(a){a=window["h5u_"+this._Id+"$"+a.id];if(!a.haveFile())return!1;if("ok"==a.UPLOAD_STATUS)return a.removeWaitBox(),this.uploadProcess=!1;if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;if("error"==a.UPLOAD_STATUS||"abort"==a.UPLOAD_STATUS)return this._stopPost=!0,this._stopPostError="enus"==EWA.LANG?
"Upload file error or aborted":"\u4e0a\u4f20\u6587\u4ef6\u9519\u8bef\u6216\u88ab\u4e2d\u6b62",console.log(this._stopPostError),!1;if("start"==a.UPLOAD_STATUS||"checking"==a.UPLOAD_STATUS)return!0;a.submitUploads();if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;$X(a.WAIT_ID)||a.createWaitBox();return this.uploadProcess=!0};this.DoPost=function(a,b,d){if(!d){d=this.DoPostBefore();if(d instanceof Array){var e=this;this._checkStatusInc=0;this._checkStatusFristResult=d;
this._checkStatusTimer=window.setInterval(function(){var m=0==e._checkStatusInc?e._checkStatusFristResult:e.DoPostBefore();e._checkStatusInc++;null!=m[0]&&(window.clearInterval(e._checkStatusTimer),e._checkStatusTimer=null,e._checkStatusInc=null,e._checkStatusFristResult=null,0==m[0]?m[2]?$Confirm(m[1],m[1],function(){m[0]=m[1]=null;e.DoPost(a,b,!0)},function(){}):$Tip(m[1]):(m[0]=m[1]=null,e.DoPost(a,b,!0)))},232);return}if(!d)return}var g=$(a).find("input[ewa_tag=ht5upload]");if(!(0<g.length)||
this.uploadProcess||this.CheckValidAll(a)){var h=0;e=this;for(d=0;d<g.length>0;d++){var k=g[d];this._uploadingFileCheck(k)&&h++}if(0<h)setTimeout(function(){e.DoPost(a,b)},700);else if(g=$(a).find("input[ewa_tag=ht5takephoto]"),!(0<g.length)||this.uploadProcess||this.CheckValidAll(a)){for(d=0;d<g.length>0;d++){k=g[d];h=!1;k=window["h5takephoto_"+this._Id+"$"+k.id];if("ok"!=k.UPLOAD_STATUS){if(!$X(k.H5_UPLOAD.WAIT_ID)){try{k.submitUpload()}catch(m){console.log("ht5takephotos - ht5.submitUpload: "+

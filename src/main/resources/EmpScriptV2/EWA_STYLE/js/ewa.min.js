...
c=this;b.find(".ewa_lf_func_dact").each(function(){this.id=EWA_Utils.tempId("gDx_"+c._Id+"_")});a.html(b.html());a.find(".ewa_lf_func_dact").each(function(){this.onclick=function(){b.find('div[id="'+this.id+'"]').click()}});b.parent().hide();$(EWA.OW.Dia._Dialog.GetFrame()).addClass("ewa-lf-btns-in-title")}};this.ReShow=function(a){this.IsReShow=!0;this.NewDivId=a="_G_"+this._Id;var b=[];b.push("<table class='ewa-lf-reshow' id='EWA_RESHOW_"+this._Id+"'>");b.push("<tr style='display:none'><td style='padding:0'></td></tr>");
b.push("<tr><td class='ewa_lf_func' style='padding:0'>");b.push("<div style='display:none'></div>");b.push("<div><div class='ewa_lf_func_caption'></div></div>");b.push("</td></tr>");b.push("<tr><td style='width:100%;padding:0;vertical-align:top'>");b.push("<div id='"+a+"' style=''></div>");b.push("</td></tr>");b.push("</table>");var c=$(b.join("")),d=!(this.Url.toUpperCase().indexOf("EWA_AJAX=INSTALL")>0||this.Url.toUpperCase().indexOf("EWA_CALL_METHOD=INNER_CALL")>0||this.Url.toUpperCase().indexOf(".JSP")>

...
a.toUpperCase();return"NUMBER"==a||"INT"==a||"BIGINT"==a};this.isTrim=function(a){if(!a)return null;if($(a).attr("ewa_trim"))return!0;var b=this.GetItem(a.id);b=(b=b?this.GetItemValue(b,"DataItem","Trim"):"")?b.toUpperCase():"YES";if(b="YES"==b)$(a).attr("ewa_trim","yes").on("blur",function(){this.value=this.value.trim()});return b};this.getFormat=function(a){return a?(a=this.GetItem(a.id))?this.GetItemValue(a,"DataItem","Format"):"":""};this.GetObjectValue=function(a){var b=a.tagName.toUpperCase(),
d=a,e="";if("DIV"==b&&"REPT"==a.getAttribute("TAG")){a=a.getElementsByTagName("input");for(var g=0;g<a.length;g+=1)a[g].checked&&(0<e.length&&(e+=","),e+=a[g].value);return e}if("DIV"==b&&"1"==a.getAttribute("EWA_DHTML"))return e=a.getElementsByTagName("iframe")[0].contentWindow,b=e.document.getElementsByTagName("textarea"),e=0<b.length&&"none"!=b[0].style.display?b[0].value:e.frames[0].document.body.innerHTML,null!=location.search&&0>location.search.toUpperCase().indexOf("EWA_DHTML_HOST")&&(g="http:\\/\\/"+
eval("document.location.host")),g=eval("/"+g+"/ig"),e=e.replace(g,""),a=a.getElementsByTagName("input")[0],a.value=e,a.value;if("SELECT"==b)return e="",0<=d.options.selectedIndex&&(e=d.options[d.options.selectedIndex].value),e;if("TEXTAREA"==b&&"none"==d.style.display)return a.value;if("INPUT"==b&&"IMG_UPLOAD"==d.getAttribute("ewa_tag"))return e="/"!=EWA.CP?d.value.replace(EWA.CP,""):d.value,e=e.replace("//","/");if("INPUT"==b&&d.getAttribute("val_ref")){a=d.getAttribute("val_ref");try{e=eval("(function(){var a="+
a+";return a;})()")}catch(h){console.log(a),console.log(h),e=""}return e}if("INPUT"==b&&("checkbox"==d.type||"radio"==d.type))return e=d.checked?d.value:"";(e=d.value)&&this.isTrim(a)&&(g=e.trim(),g!==e&&(e=g));if("INPUT"!==b||!this.isNumber(a))return e;if(""!==e){if(isNaN(e)&&(e=e.replace(/,/ig,""),isNaN(e)))try{e=EWA_Utils.chineseToNumber(e)+"",a.value=e}catch(h){}g=this.getFormat(a);"LeastMoney"==g?(g=e.split("."),a.value=1==g.length?(1*e).fm(0):(1*e).fm(g[1].length)):"Money"==g&&(a.value=(1*e).fm(2));
return e}}}function EWA_FrameResourceDescription(){this.Memo=this.Info=this.Lang=null}function EWA_FrameResoure(){this.Name=null;this.Descriptions={};this.GetDescription=function(){var a=this.Descriptions[EWA.LANG];if(null==a)for(var b in this.Description)return this.Description[b];return a};this.GetInfo=function(){var a=this.GetDescription();return null==a?null:a.Info};this.GetMemo=function(){var a=this.GetDescription();return null==a?null:a.Memo}}

...
this._Id),b=a.find(".ewa_msg_box")[0].colSpan/2,c=(a.width()-90*b)/b;$(a).find(".ewa_redraw_ctl").each(function(){var e=this.colSpan||1;$(this).css("width",c*e)});var d=this;addEvent(window,"size",function(){d.RedrawChangWidth()})};this.Mearge=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff1a\u8bf7\u7528 Merge");this.Merge(a,b,c)};this.Merge=function(a,b,c){if(a||b){var d=$("#EWA_FRAME_"+this._Id),e=d.find("#"+a),g=d.find("#"+b);if(0==e.length)console.log("Mearge:"+a+"\u4e0d\u5b58\u5728");
else if(0==g.length)console.log("Mearge:"+b+"\u4e0d\u5b58\u5728");else{var h=!1,k=d.find(".ewa-row-"+b+" .EWA_TD_M"),l=null;0==k.length&&(h=!0,k=d.find(".ewa-row-"+b+" .EWA_TD_1"),l=d.find(".ewa-row-"+b+" .EWA_TD"),1==l.length&&(h=!0),b=l.html(),l.html("<table cellpadding=0 cellspacing=0 width=100%><tr><td style='width:50%'></td><td style='display:none'></td><td style='width:50%'></td></tr></table>"),l.find("td:eq(0)").html(b));if(0==k.length)alert("target parent not exists");else{var m="border-box"==
e.css("box-sizing")?0:1*e.css("padding-left").replace("px","")+1*e.css("padding-right").replace("px",""),n="border-box"==e.css("box-sizing")?0:1*g.css("padding-left").replace("px","")+1*g.css("padding-right").replace("px","");d.find(".ewa-row-"+a).hide();null==c&&(c=" - ");var p=k.width(),t=e[0].tagName,r=g[0].tagName;e.parent().hasClass("ewa-select-filter-target")&&(e=d.find(".ewa-row-"+a+" .EWA_TD_M table:eq(0)"),t="SELECT_WITH_FILTER");var q=0;b=null;c&&(k.append('<span class="mearge-span">'+c+
"</span>"),h&&l.find("table:eq(0) td:eq(1)").html('<span class="mearge-span">'+c+"</span>").show(),b=k.find(".mearge-span"),q=b.width()+1+1*b.css("padding-left").replace("px","")+1*b.css("padding-right").replace("px","")+1*b.css("margin-left").replace("px","")+1*b.css("margin-right").replace("px",""));t==r?(c=(p-q)/2-m-2,e.css("width",c),g.css("width",c),h&&l.find("table:eq(0) td:eq(2), table:eq(0) td:eq(0)").css("width",c)):"SELECT"==t?(e.css("width",100),g.css("width",p-q-m-n-2-2-e.width())):"SELECT_WITH_FILTER"==
t?(e.css("width",200),g.css("width",p-q-m-n-2-2-e.width())):"SELECT"==r&&(g.css("width",100),e.css("width",p-q-m-n-2-2-e.width()));g.css("float","left");b&&b.css("float","left");e.css("float","right");k.append(e);k.addClass("ewa-frame-merge");h&&(a=d.find(".ewa-row-"+a+" .EWA_TD").html(),l.find("table:eq(0) td:eq(2)").html(a))}}}};this.MergeExp=function(a,b,c,d){if(b){var e=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),g=[],h=b;b={};for(var k=$("#EWA_FRAME_"+this._Id),l=0;l<e.length;l++){var m=e[l];g.push(m);
var n=m.replace("@@","");h=h.replace(m,"<span class='ewa-row-merge ewa-row-merge-"+n+"' mid=\""+m+'"></span>');n!=a&&k.find(".ewa-row-"+n).hide();b[n]=this.GetItemDescription(n).Info}e=document.createElement("div");e.style.display="none";e.innerHTML=h;document.body.appendChild(e);m=k.find('[id="'+a+'"]');if(0==m.length)console.log("not find "+a);else{a=m.parent();for(var p in g)l=g[p],m=l.replace("@@",""),h=k.find('[id="'+m+'"]'),0==h.length?console.log("not found [id="+m+"]"):(l=$(e).find('span[mid="'+
l+'"]'),"placeholder"==c?h.attr("placeholder",b[m]):c&&(l.append("<span class='ewa-row-merge-memo'></span>"),l.find(".ewa-row-merge-memo").text(b[m])),l.append(h));for(;0<e.childNodes.length;)a.append(e.childNodes[0]);$(e).remove();d&&d(a)}}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MergeItems=function(){for(var a in this.MeargeMap){var b=this.MeargeMap[a],c=$X("_ewa_tr$"+a);if(c){for(var d=c.cells.length,e=$(c.cells[0]);1<c.cells.length;)e.append(c.cells[1].innerHTML),c.removeChild(c.cells[1]);
c.cells[0].colSpan=d;c=[];for(d=0;d<b.length;d++){for(var g=$X("_ewa_tr$"+b[d]),h=["<nobr>"],k=0;k<g.cells.length;k++)h.push(g.cells[k].innerHTML);h.push("</nobr>");c.push(h.join(" "));g.parentNode.removeChild(g)}e.append(c.join(" "))}}};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.DoAction=function(a,b,c,d,e,g){EWA.F.CID=this._Id;if(null!=b&&""!=b.trim()){if(null!=c&&0<c.trim().length)if(a=_EWA_INFO_MSG[c],null!=a&&""!=a){if(!window.confirm(a))return}else if(!window.confirm(c))return;
this.DoPostBefore();this._Ajax=this.CreateAjax(null,!0);this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.AddParameter("EWA_ACTION_TIP",d);null!=g&&0<g.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",g),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=!1;if(null!=e&&0<e.length)for(b=
...
a.id="ewa_but_"+Math.random();a.type="button";a.value="enus"==EWA.LANG?"Back":"\u4e0a\u4e00\u6b65";a.style.display="none";a.onclick=function(){var h=b.getAttribute("EWA_GUIDE_IDX");if(0==1*h)$Tip("\u5230\u5934\u4e86");else{var k=b.id.replace("EWA_FRAME_","");EWA.F.FOS[k].GuidePrevBefore&&EWA.F.FOS[k].GuidePrevBefore(h,this,b);EWA.F.FOS[k].GuideShow(1*h-1);EWA.F.FOS[k].GuidePrevAfter&&EWA.F.FOS[k].GuidePrevAfter(h,this,b)}};var c=document.createElement("input");c.id="ewa_but_"+Math.random();c.type=
"submit";c.value="enus"==EWA.LANG?"Next":"\u4e0b\u4e00\u6b65";c.onclick=function(){var h=b.getAttribute("EWA_GUIDE_IDX"),k=b.id.replace("EWA_FRAME_","");EWA.F.FOS[k].GuideShowCheck(h)&&(EWA.F.FOS[k].GuideNextBefore&&EWA.F.FOS[k].GuideNextBefore(h,this,b),"ok"==this.getAttribute("ewa_guide_method")?$F(b,"input","type","submit")[0].click():EWA.F.FOS[k].GuideShow(1*h+1),EWA.F.FOS[k].GuideNextAfter&&EWA.F.FOS[k].GuideNextAfter(h,this,b))};var d=b.parentNode.parentNode.parentNode.parentNode.insertRow(-1).insertCell(-1);
d.appendChild(a);d.appendChild(c);d.className="EWA_FRAME_GROUP_BUTTONS";tdTitle=b.parentNode.parentNode.parentNode.parentNode.insertRow(0).insertCell(-1);d="ewa_title_"+Math.random();for(var e=[],g=0;g<this._GroupInfos.length;g++)e.push('<div style="float:left" id="ewa_'+this._Id+"_"+g+'">'+(g+1)+". "+this._GroupInfos[g].DES+"</div>");tdTitle.innerHTML="<div style='text-align:left'>"+e.join(" <div style='float:left;color:#aaa'>&nbsp;&gt;&nbsp;</div> ")+"</div><div id='"+d+"'></div>";tdTitle.className=
"EWA_FRAME_GROUP_TITLE";b.setAttribute("EWA_GUIDE_ID_PREV",a.id);b.setAttribute("EWA_GUIDE_ID_NEXT",c.id);b.setAttribute("EWA_GUIDE_ID_TITLE",d);this.GuideShowTitle(0);a=document.createElement("div");100<b.clientHeight&&(a.style.width=b.clientWidth+"px",a.style.height=b.clientHeight+20+"px",a.style.overflow="auto");b.parentNode.appendChild(a);a.appendChild(b);b.parentNode.className="EWA_GROUP_GUIDE"};this.GuideShowTitle=function(a){for(var b=$X("EWA_FRAME_"+this._Id).getAttribute("EWA_GUIDE_IDX_MAX"),
c=0;c<=b;c++){var d="ewa_"+this._Id+"_"+c;c==a?($X(d).style.color="blue",$X(d).style.borderBottom="2px solid green"):($X(d).style.color="green",$X(d).style.borderBottom="2px")}};this.GuideShowCheck=function(a){var b=!0,c=null,d;for(d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],"Name","Name"),g=$X(e);null==g?alert(e+" not exists"):(e=this._GetTr(g),null!=e&&e.getAttribute("groupindex")==a&&((b&=this.CheckValid(g))||null!=c||(c=g)))}null!=c&&c.focus();return b};this._GetTr=
function(a){for(var b=0;100>b;){b++;a=a.parentNode;try{if("TR"==a.tagName.toUpperCase()&&null!=a.getAttribute("id")&&0==a.getAttribute("id").indexOf("_ewa_tr$"))return a}catch(c){break}}return null};this.GuideShow=function(a){this.GuideShowTitle(a);var b=$X("EWA_FRAME_"+this._Id);if(b.getAttribute("EWA_GUIDE_IDX")!=a){var c=b.getAttribute("EWA_GUIDE_IDX_MAX"),d=b.getAttribute("EWA_GUIDE_ID_PREV"),e=b.getAttribute("EWA_GUIDE_ID_NEXT");a==c?($X(e).value="enus"==EWA.LANG?"Confirm":"\u786e\u5b9a",$X(e).setAttribute("ewa_guide_method",
"ok")):($X(e).value="enus"==EWA.LANG?"Next":"\u4e0b\u4e00\u6b65",$X(e).setAttribute("ewa_guide_method",""));0==a?$X(d).style.display="none":$X(d).style.display="";b.setAttribute("EWA_GUIDE_IDX",a);this._ShowHidenGroup(b,a)}};this._ShowHidenGroup=function(a,b){for(var c=0;c<a.rows.length-1;c++){var d=a.rows[c];if(null!=d.getAttribute("groupIndex")&&""!=d.getAttribute("groupIndex")){var e=1*d.getAttribute("groupIndex");d.style.display=b==e?"":"none"}}};this.GroupShow=function(a,b){if(!(0<a.className.indexOf("1"))){this.GroupShowBefore&&
this.GroupShowBefore(a,b);for(var c=$X("EWA_FRAME_"+this._Id),d=a.parentNode.parentNode,e=0;e<c.rows.length;e++){var g=c.rows[e];if(g!=d&&!(1==g.cells.length&&g.cells[0].className&&0<=g.cells[0].className.indexOf("EWA_TD_B"))&&"1"!=g.getAttribute("hiddennocontentrow")){var h=0;null!=g.getAttribute("groupIndex")&&""!=g.getAttribute("groupIndex")&&(h=1*g.getAttribute("groupIndex"));g.style.display=b==h?"":"none"}}c=d.getElementsByTagName("div");for(e=0;e<c.length;e++)d=c[e],d.className=d==a?d.className+
"1":d.className.replace("1","");this.GroupShowAfter&&this.GroupShowAfter(a,b)}};this.DoActionJSON=function(a,b,c,d){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","JSON");this._Ajax.AddParameter("EWA_ACTION",a);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_JSON_NAME",b);this._AjaxJsonAfter=null!=d?d:null;if(null!=c&&0<c.length)for(a=0;a<c.length;a+=1)this._Ajax.AddParameter(c[a].Name,c[a].Value);c=new EWA.C.Url;
c.SetUrl(this.Url);c=c.RemoveParameter("EWA_ACTION");this._Ajax.PostNew(c,EWA.F.FOS[EWA.F.CID]._CallBackJs)};this._CallBackJs=function(){var a=EWA.F.FOS[EWA.F.CID],b=a._Ajax;if(4==b._Http.readyState)if(b.HiddenWaitting(),200==b._Http.status){if(b=b._Http.responseText,EWA.F.CheckCallBack(b)){eval(b);a._AjaxJsonAfter&&(a._AjaxJsonAfter(),a._AjaxJsonAfter=null);try{a.ReloadAfter&&a.ReloadAfter(b)}catch(c){alert(b)}}}else alert("ERROR:\r\n"+b._Http.statusText)};this.RewriteInfo=function(a,b,c,d){for(a=
0;a<info.length;a++){var e=info[a],g=e[b];if($X(g)){var h="TD"==$X(g).parentNode.tagName?$X(g).parentNode:$X(g).parentNode.parentNode;"IMG_UPLOAD"==$X(g).getAttribute("ewa_tag")&&(h=$X(g).parentNode.parentNode.parentNode.parentNode.parentNode.parentNode);g=h.parentNode;null==e[c]||""==e[c].trim()?g.style.display="none":3==g.cells.length?(g.cells[2].innerHTML=e[d],g.cells[0].innerHTML=e[c]):1==g.cells.length&&(g=g.previousSibling,3==g.nodeType&&(g=g.previousSibling),g.cells[1].innerHTML=e[d],g.cells[0].innerHTML=
e[c])}}};this._HiddenMemo=function(a,b){var c=a.parentNode.parentNode;b=!1;"none"==c.style.display&&(b=!0);c.style.display="none";c.id="tr_"+a.id;c=c.previousSibling;3==c.nodeType&&(c=c.previousSibling);c.style.display="none";a="<span id=tab_"+a.id+' class="ewa_merge_tab" onclick="EWA.F.FOS[\''+this._Id+"'].ShowMemo(this.id);\">"+c.cells[0].innerHTML+"</span>";return b?"":a};this.ShowMemo=function(a){for(var b=$X(this._Id+"__ewa_meger").getElementsByTagName("SPAN"),c=0;c<b.length;c++){var d=b[c].id.replace("tab_",
"tr_");"ewa_merge_tab1"==b[c].className&&(b[c].className="ewa_merge_tab",$X(d).style.display="none");b[c].id==a&&(b[c].className="ewa_merge_tab1",$X(d).style.display="")}};this.MergeMemo=function(){var a=$X("EWA_FRAME_"+this._Id).getElementsByTagName("textarea");if(0!=a.length&&"1"!=a[0].getAttribute("ewa_merge")){for(var b=[],c=0;c<a.length;c++){var d=this._HiddenMemo(a[c]);d="<nobr>"+d.replace("\u2022 ","").trim()+"</nobr>";b.push(d)}a=a[0];c=a.parentNode.parentNode;d=c.previousSibling;3==d.nodeType&&
...
d,this.Resources[e].GetInfo(),this.Resources[g].GetInfo()):eval(c)?(EWA_FrameShowAlert(a,this._ValidExOk.GetInfo()),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,this._ValidExFail.GetInfo()),a.setAttribute("EWA_VALID_EX",this._ValidExFail.GetInfo())))};this._DoValidExAction=function(a,b,c,d){if(null!=a&&!$(a).is(":hidden"))if(null==b||""==b.trim())alert("action not value");else{var e=a.id+","+a.value;if(this.DoValidExAction_RETS&&null!=this.DoValidExAction_RETS[e])0==this.DoValidExAction_RETS[e]?
(EWA_FrameRemoveAlert(a,c),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,d),a.setAttribute("EWA_VALID_EX",d));else{var g=new EWA.C.Ajax;g.LoadingType="image";g.AddParameter("EWA_AJAX","HAVE_DATA");g.AddParameter("EWA_ACTION",b);g.AddParameter("EWA_ID",this._Id);g.AddParameter("EWA_NO_CONTENT","1");g.AddParameter(a.id,a.value);this.DoValidExAction_RETS||(this.DoValidExAction_RETS={});var h=this;g.PostNew(this.Url,function(){if(4==g._Http.readyState){g.HiddenWaitting();if(200==g._Http.status){var k=
g._Http.responseText;if(EWA.F.CheckCallBack(k))try{var l=parseInt(k.trim());h.DoValidExAction_RETS[e]=l;0==l?(EWA_FrameRemoveAlert(a,c),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,d),a.setAttribute("EWA_VALID_EX",d))}catch(m){alert(m+","+k)}}else alert("ERROR:\r\n"+g._Http.statusText);g=null}})}}};this.ValidCodeError=function(a){$(".ewa-valid-code-img").each(function(){this.click()});a||($Tip(_EWA_EVENT_MSG.ValidCodeError),$(".ewa-valid-code-img").parent().parent().find("input").focus().select())};
this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.F=this;this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);"enus"==EWA.LANG&&$(".ewa-ipt-droplist").attr("placeholder","Input character selection");this._InitTranslations();this._GetDropListValue();this._InitMustInputs();this._InitEncyptions()};this._InitMustInputs=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,
"Name","Name");0<$(c).find('IsMustInput Set[IsMustInput="1"]').length&&(c="#"+d,a.find(".ewa-row-"+d).addClass("ewa-row-must"),d=a.find(c),d.addClass("ewa-row-item-must"),0<d.length&&d.attr("type")&&"hidden"==d.attr("type").toLowerCase()&&d.prev().addClass("ewa-row-item-must"))}};this._InitEncyptions=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name");c=$(c).find("DispEnc Set");if(0!=c.length&&(d=a.find("#"+
d),0!=d.length&&c.attr("EncType"))){if("INPUT"==d[0].tagName||"TEXTAREA"==d[0].tagName){if(!d.val())continue;d.prop("disabled",!0);d.attr("ewa_encyrption","yes")}var e=$("<div class='ewa-enc-cover' style='position:absolute;left:0;top:0;width:100%;height:100%;'><div></div></div>");d.parent().append(e);d.parent().css("position","relative");if(c=c.attr("EncShowUrl")){e.find("div").html("\u70b9\u51fb\u67e5\u770b").css({position:"absolute",height:30,"line-height":"30px",top:"50%","margin-top":"-15px",
right:10,"text-align":"right"});c=new EWA_UrlClass(c);e=new EWA_UrlClass(this.Url);for(var g in e._Paras)if(!c.GetParameter(g)){var h=e._Paras[g];null!=h&&(h=h.unURL());c.AddParameter(g,h)}c.AddParameter("EWA_ENCY_FROM_ID",d.attr("id"));c=c.GetUrl();d.parent().attr("enc_url",c).attr("fid",d.attr("id"));d.parent().on("click",function(){if(!$(this).attr("enc_ok")){var k=$(this).attr("t")||100,l=(new Date).getTime();if(!(400>l-k)){$(this).attr("t",l);k=$(this).attr("enc_url");var m=$(this).find("#"+
$(this).attr("fid"));$J(k,function(n){n.RST?(m.prop("disabled",!1),m.removeAttr("ewa_encyrption"),m.val(n.VALUE),$(m).parent().find(".ewa-enc-cover").remove(),$(m).parent().attr("enc_ok","1")):(n.ERR||n.MSG)&&$Tip(n.ERR||n.MSG)})}}})}}}};this._InitTranslations=function(){var a="EWA.F.FOS[&quot;"+this._Id+"&quot;]._Trans(this)",b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name"),e=$(c).find("DataItem Set[Translation]");if(c=e.attr("Translation")){e=
e.attr("TransTarget");var g="en2zh"==c?" \u82f1\u8bd1\u4e2d":" \u4e2d\u8bd1\u82f1";"enus"==EWA.LANG&&(g="en2zh"==c?" En-Zh":" Zh-En");c=$('<a class="ewa-but-trans" href="javascript:void(0)" onclick="'+a+'" _transf="'+d+'" _transp="'+c+'" _transt="'+e+'">'+g+"</a>");e=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+d+" .EWA_TD_L");0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+d+" .EWA_TD"));0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" #"+d).parent().prev().find(".ewa_d1"));0==e.length&&(e=$("#EWA_FRAME_"+
this._Id+" #"+d).parent(),e.css("position","relative"),c.addClass("ewa-but-trans-float"));e.append(c)}}};this._Trans=function(a){if(a){var b=$(a).attr("_transf"),c=$(a).attr("_transp");a=$(a).attr("_transt");b=$("#EWA_FRAME_"+this._Id+" #"+b);a=$("#EWA_FRAME_"+this._Id+" #"+a);if(0==b.length||0==a.length)console.log("trans ex:",b,a);else{var d=b[0].tagName.toLowerCase();if(b="input"==d||"textarea"==d||"hidden"==d?b.val():b.text()){var e=new EWA_TransClass;"en2zh"==c?e.TransToCn(b,a[0]):e.TransToEn(b,
a[0]);$Tip("enus"==EWA.LANG?"Translating...":"\u7ffb\u8bd1\u4e2d...",function(){return!e.IsRun})}}}};this._bindCompostion=function(a,b){if(!EWA.B.IE){var c=this;c._droplist_||(c._droplist_={});c._droplist_[b.id]={_is_composition:!1};$(a).on("compositionstart",function(){c._droplist_[b.id]._is_composition=!0}).on("compositionend",function(){c._droplist_[b.id]._is_composition=!1;EWA.F.I.DropList(this)}).removeAttr("oninput").removeAttr("onkeyup").on("input",function(){c._droplist_[b.id]._is_composition||
EWA.F.I.DropList(this)})}};this._GetDropListValue=function(){var a=this.getObj();if(0!=a.length){a=a[0];var b=a.getElementsByTagName("input");this._droplist_={};for(var c=0;c<b.length;c++){var d=b[c];if("droplist"==d.getAttribute("ewa_class")){var e=d.nextSibling;"INPUT"==e.tagName.toUpperCase()&&"HIDDEN"==e.type.toUpperCase()&&(this._GetDropListValue1(d,e),this._bindCompostion(d,e))}}a=a.getElementsByTagName("select");for(c=0;c<a.length;c++)if(d=a[c],b=d.getAttribute("_ListFilterType"))e=d.getAttribute("_ListFilterField"),
this.initSelectFilter(d.id,b,e);this._SelectFilters&&this._checkSelectOptionsChange()}};this._GetDropListValue1=function(a,b){if(""==b.value)b.setAttribute("setvalue",1);else{var c=b.getAttribute("DlsShow");if(null==c||""==c)b.setAttribute("canopen",0),a.value=b.value,b.setAttribute("canopen",1);else{var d=new EWA_AjaxClass,e=b.getAttribute("xmlName"),g=b.getAttribute("itemName"),h=b.getAttribute("paraName"),k=b.getAttribute("DlsAction");d=new EWA.C.Ajax;var l=b.value;var m=this.EWA_CGI?this.EWA_CGI:
window.EWA_CGI?window.EWA_CGI:EWA.CP+"/EWA_STYLE/cgi-bin/";var n=-1==m.indexOf("?")?"?":"&";m=(m+(n+"XMLNAME="+e+"&ITEMNAME="+g+"&EWA_AJAX=JSON")).replace("//","/");m=m.replace("//","/");m=m.replace("//","/");d.AddParameter(h,l);null!=k&&0<k.trim().length&&(d.AddParameter("EWA_ACTION",k),d.AddParameter(b.id,b.value));d.PostNew(m,function(){if(d.IsRunEnd()){var p=d.GetRst(),t="__json"+Math.random();try{eval('window["'+t+'"]='+p)}catch(u){b.setAttribute("canopen",0);a.value=u;b.setAttribute("canopen",
1);return}p=window[t];if(0!=p.length){t=p[0];var r=[];p={};for(var q in t)r.push(t[q]),p["@"+q.toUpperCase()]=t[q],t[q]&&b.setAttribute("para_"+q.toLowerCase(),t[q]);if(null==c||""==c)p=r.join("/");else{q=c.match(/@[a-zA-Z0-9\-\._:]*\b/ig);for(t=0;t<q.length;t++){r=q[t];var v=p[r.toUpperCase()];c=c.replace(r,v)}p=c}b.setAttribute("canopen",0);a.value=p;b.id=null==b.id||""==b.id?Math.random():b.id;"yes"==b.getAttribute("isdlseventload")&&(EWA.F.FOS[b.id]=new EWA_FrameItemClass,EWA.F.FOS[b.id].DropList(a),
EWA.F.FOS[b.id].CallAfterEvent());b.setAttribute("canopen",1);b.setAttribute("setvalue",1)}}})}}};this.DoPostEx=function(){EWA.F.F.CUR=this;if(this.CheckValidAll(document.forms[0])){this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");for(var a=document.getElementsByTagName("input"),b=0;b<a.length;b+=1){var c=a[b],d=""==c.name?c.id:c.name;null!=d&&""!=d&&this._Ajax.AddParameter(d,
c.value)}a=document.getElementsByTagName("select");for(b=0;b<a.length;b+=1)c=a[b],d=""==c.name?c.id:c.name,null!=d&&""!=d&&this._Ajax.AddParameter(d,c.value);a=document.getElementsByTagName("textarea");for(b=0;b<a.length;b+=1)c=a[b],d=""==c.name?c.id:c.name,null!=d&&""!=d&&this._Ajax.AddParameter(d,c.value);this._Ajax.PostNew(this.Url,EWA.F.F.CUR._CallBack)}};this.CreateAjax=function(a,b){EWA.F.F.CUR=this;null==a&&(a=$("#f_"+this._Id)[0]);if(!b&&!this.CheckValidAll(a))return null;b=new EWA.C.Ajax;
for(var c in this.ItemList.Items){var d=this.ItemList.GetItemValue(this.ItemList.Items[c],"Name","Name"),e=this.GetObject(d,a);if(null!=e&&!$(e).attr("ewa_encyrption")){var g=this._GetObjectValue(e);null!=g&&b.AddParameter(d,g);"DIV"==e.tagName.toUpperCase()&&"1"==e.getAttribute("EWA_DHTML")&&(g=$X("UP_IMG_"+d).value,b.AddParameter(d+"_imgs_split",g));d=e.getAttribute("ewa_tag");if("swffile"==d||"IMG_UPLOAD"==d)if(g=e.getAttribute("UP_PARAS"),null!=g&&0<g.length){g=g.split(",");for(var h=0;h<g.length;h++){var k=
g[h];b.AddParameter(k,e.getAttribute(k))}}else b.AddParameter("UP_URL",e.value);"markdown"==d&&(e=e.parentNode.getElementsByTagName("textarea"),1<e.length&&b.AddParameter(e[1].id,e[1].value))}}if(this.PostAddData)for(k in this.PostAddData)b.AddParameter(k,this.PostAddData[k]);return b};this.CreatePostData=function(){var a=$("#f_"+this._Id)[0],b={},c;for(c in this.ItemList.Items){var d=this.ItemList.GetItemValue(this.ItemList.Items[c],"Name","Name"),e=this.GetObject(d,a);if(null!=e){var g=this._GetObjectValue(e);
null!=g&&(b[d]=g);"DIV"==e.tagName.toUpperCase()&&"1"==e.getAttribute("EWA_DHTML")&&(g=$X("UP_IMG_"+d).value,b[d+"_imgs_split"]=g);d=e.getAttribute("ewa_tag");if("swffile"==d||"IMG_UPLOAD"==d)if(g=e.getAttribute("UP_PARAS"),null!=g&&0<g.length){g=g.split(",");for(var h=0;h<g.length;h++){var k=g[h];b[k]=e.getAttribute(k)}}else b.UP_URL=e.value;"markdown"==d&&(e=e.parentNode.getElementsByTagName("textarea"),1<e.length&&(b[e[1].id]=e[1].value))}}return b};this.DoPostBefore=function(){return!0};this.isDoPostBeforeTimer=
function(){return null!=this._checkStatusFristResult};this._uploadingFileCheck=function(a){a=window["h5u_"+this._Id+"$"+a.id];if(!a.haveFile())return!1;if("ok"==a.UPLOAD_STATUS)return a.removeWaitBox(),this.uploadProcess=!1;if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;if("error"==a.UPLOAD_STATUS||"abort"==a.UPLOAD_STATUS)return alert("\u4e0a\u4f20\u6587\u4ef6\u9519\u8bef\u6216\u88ab\u4e2d\u6b62"),!1;if("start"==a.UPLOAD_STATUS||"checking"==a.UPLOAD_STATUS)return!0;
...
e.h+".jpg")}};this.chkAllXhrComplete=function(){for(var a=0,b=0;b<this.uploadIframes.length;b++)"string"==typeof this.uploadIframes[b]&&a++;a==this.uploadIframes.length&&(this.UPLOAD_STATUS="ok")};this.createWaitBox=function(){if(!$X(this.WAIT_ID)){var a=document.createElement("div");a.id=this.WAIT_ID;var b=$("body");$(a).css({width:300,height:100,"line-height":"100px","font-size":"16px",position:"fixed",top:.5*b.height()-35,left:.5*b.width()-150,"z-index":12838,"background-color":"f0f0f0",color:"#08c",
"border-radius":"10px",opacity:.9}).addClass("ewa-upload-wait-box");a.innerHTML="<table height=100% align=center><tr><td><img src='"+((EWA.RV_STATIC_PATH||"/EmpScriptV2")+"/EWA_STYLE/images/loading2.gif'></td><td>")+("enus"==EWA.LANG?"Please waitting ...":"\u8bf7\u7b49\u5f85\u6587\u4ef6\u4e0a\u4f20\u5b8c\u6bd5...")+"</td></table>";b.append(a);this.noWaitBox&&$(a).hide()}};this.removeWaitBox=function(){$("#"+this.WAIT_ID).remove()};this.submitUploads_old=function(a){this.uploadIframes=[];var b=this;
this.UPLOAD_STATUS="start";try{$("input[type=file][ok=1]").each(function(c){var d=this.id.split("$")[1];b.POST_NAME==d&&b.submitUpload_old(c,this)})}catch(c){alert(c)}0<this.uploadIframes.length?window.setTimeout(function(){b.UPLOAD_STATUS="checking";b.chkframeSubmt()},400):this.UPLOAD_STATUS="nofile"};this.submitUpload_old=function(a,b){a="GDX"+a;var c=document.createElement("iframe");c.id=a;c.name=a;document.body.appendChild(c);c=$(c);c.hide();var d=document.createElement("form");document.body.appendChild(d);
d.method="post";d.enctype="multipart/form-data";d.innerHTML="<input type=submit>";var e=$(d);e.hide();d=EWA.CP+"/EWA_STYLE/cgi-bin/_up_/?xmlname="+this.POST_XMLNAME+"&ITEMNAME="+this.POST_ITEMNAME+"&NAME="+this.POST_NAME+"&EWA_UP_TYPE=SWFUPLOAD&EWA_UP_REF="+this.POST_REF;var g=b.id.split("_")[1].split("$")[0],h=EWA.F.FOS[g].Url,k=new EWA_UrlClass;k.SetUrl(h);for(var l in k._Paras)0!=l.toUpperCase().indexOf("EWA")&&(d+="&"+l+"="+k._Paras[l]);if(l=$X("f_"+g))for(g=0;g<l.length;g++)h=l[g],"file"!=h.type&&
"button"!=h.type&&"submit"!=h.type&&("radio"!=h.type&&"checkbox"!=h.type||h.checked)&&(d+="&"+(h.name||h.id)+"="+h.value.toURL());e.attr("action",d);e.append(b);e.attr("target",a);this.uploadIframes.push(c[0]);setTimeout(function(){e.submit()},400)};this.chkframeSubmt=function(){for(var a=0,b=0;b<this.uploadIframes.length;b++){var c=this.uploadIframes[b];if("string"==typeof c)a++;else if(c.contentDocument&&c.contentDocument.body){var d=GetInnerText(c.contentDocument.body);if(0<=d.indexOf("]")&&0<=
d.indexOf("["))$("form[target="+c.id+"]").remove(),$(c).remove(),this.uploadIframes[b]=d;else if(""!=d.trim()){alert("\u7cfb\u7edf\u6267\u884c\u9519\u8bef\uff1a"+d);return}}}if(a==this.uploadIframes.length)this.UPLOAD_STATUS="ok";else{var e=this;window.setTimeout(function(){e.chkframeSubmt()},100)}}}

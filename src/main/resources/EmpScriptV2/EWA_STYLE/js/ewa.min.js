...
function EWA_FrameClass(){this._Ajax=this.Xml=null;this.ItemList=new EWA_FrameCommonItems;this.Resources={};this.ReloadAfter=this._Id=this._ValidExObj=this._ValidExFail=this._ValidExOk=this.Url=null;this.isShowPostWaitting=!0;this.textareaAutoSize=function(){window.autosize?autosize(this.getObj("textarea").addClass("ewa-textarea-auto-size")):console.log("autosize.js \u6ca1\u6709\u5f15\u5165\uff0c/third-party/autosize-master/dist/autosize.min.js")};this.getObj=function(a){var b=$("#EWA_FRAME_"+this._Id);

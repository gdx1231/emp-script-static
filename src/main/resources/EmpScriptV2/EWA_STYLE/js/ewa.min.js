...
EWA.UI.Dialog._SetTitle(window._EWA_DialogWnd)}};this.DoValidEx=function(a,b,d,e,g,h){""!=a.value&&(this._ValidExOk=this.Resources[g],this._ValidExFail=this.Resources[h],this._ValidExObj=a,"action"==b.toLowerCase().trim()?this._DoValidExAction(a,e,this.Resources[g].GetInfo(),this.Resources[h].GetInfo()):eval(d)?(EWA_FrameShowAlert(a,this._ValidExOk.GetInfo()),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,this._ValidExFail.GetInfo()),a.setAttribute("EWA_VALID_EX",this._ValidExFail.GetInfo())))};
this._DoValidExAction=function(a,b,d,e){if(null!=a&&!$(a).is(":hidden"))if(null==b||""==b.trim())alert("action not value");else{var g=a.id+","+a.value;if(this.DoValidExAction_RETS&&null!=this.DoValidExAction_RETS[g])0==this.DoValidExAction_RETS[g]?(EWA_FrameRemoveAlert(a,d),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,e),a.setAttribute("EWA_VALID_EX",e));else{var h=new EWA.C.Ajax;h.LoadingType="image";h.AddParameter("EWA_AJAX","HAVE_DATA");h.AddParameter("EWA_ACTION",b);h.AddParameter("EWA_ID",
this._Id);h.AddParameter("EWA_NO_CONTENT","1");h.AddParameter(a.id,a.value);this.DoValidExAction_RETS||(this.DoValidExAction_RETS={});var k=this;h.PostNew(this.Url,function(){if(4==h._Http.readyState){h.HiddenWaitting();if(200==h._Http.status){var l=h._Http.responseText;if(EWA.F.CheckCallBack(l))try{var m=parseInt(l.trim());k.DoValidExAction_RETS[g]=m;0==m?(EWA_FrameRemoveAlert(a,d),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,e),a.setAttribute("EWA_VALID_EX",e))}catch(n){alert(n+","+
...
this._InitTriggerValids()};this._InitTriggerValids=function(){var a=$("#EWA_FRAME_"+this._Id),b="EWA.F.FOS['"+this._Id+"'].callTriggerValid(this)";this.triggerValids={};for(var d in this.ItemList.Items){var e=this.ItemList.Items[d],g=this.ItemList.GetItemValue(e,"Name","Name"),h=$(e).find("DataItem Set[TriggerValid]").attr("TriggerValid");if(h){this.triggerValids[g]=null;var k=a.find("#"+g);0==k.length&&contine;k.attr("ewa_trigger_valid",h);e=$(e).find("Tag Set").attr("Tag");console.log(e);if("submit"==
e)break;if("smsValid"==e){k=a.find(".ewa-row-"+g+" .ewa-sms-valid-code-button");e=k.attr("id");e||(e=EWA_Utils.tempId(),k.attr("id",e));var l=$("<a style='position:absolute;left:0;top:0;right:0;bottom:0'></a>");l.attr("ewa_trigger_valid",h);l.attr("ewa_trigger_valid_rid",g);l.attr("ewa_trigger_valid_click_id",e);k.parent().css("position","relative").append(l);k=l}(g=k.attr("onclick"))&&k.attr("_onclick",g);k.attr("onclick",b)}}};this.callTriggerValidBefore=function(a){return!0};this.callTriggerValid=

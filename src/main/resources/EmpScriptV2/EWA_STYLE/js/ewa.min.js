...
function EWA_UI_MenuClass(a){this.ClassName=a;this.MenuShowType="";this.Dialog=null;this.Dialogs=[];this.clickedItem=this._ItemsDiv=this._LastObj=null;this.Click=function(b,c){"LEFT"!=this.MenuShowType&&(null!=this._LastObj&&(this._LastObj.className=this._LastObj.className.replace("_mv1","")),this._LastObj=null,"undefined"!=typeof b.stopPropagation?b.stopPropagation():b.cancelBubble=!0,this._HiddenDialogs());EWA.C.Utils.RunCmd(c)};this.OnClick=function(b,c){this.clickedItem=c;if("LEFT"==this.MenuShowType){var d=
c.parentNode.parentNode,e=c.parentNode,g=c.parentNode.parentNode.childNodes[1];if(null==g)return;0==g.childNodes.length?(this._LastCkObj&&(this._LastCkObj.style.backgroundColor=""),e.style.backgroundColor="#ccc",this._LastCkObj=e):("none"==g.style.display?(g.style.display="",$(d).addClass("ewa-lmenu-show")):($(d).removeClass("ewa-lmenu-show"),g.style.display="none"),window.event?b.cancelBubble=!0:b.stopPropagation())}else if(""==c.getAttribute("EWA_MF_PID")&&(this._HiddenDialogs(),0>=this.Dialogs.length&&
this.Dialogs.push(this._CreateDialog()),0<this._ShowPullDownMenu(c,this.Dialogs[0]))){this.ShowByObject(c,this.Dialogs[0],0);return}this.Click(b,c)};this._CalcLevel=function(b){for(var c=0;""!=b.getAttribute("EWA_MF_PID");)if(c+=1,b=document.getElementById(b.getAttribute("EWA_MF_PID")),null==b)return null;return c};this._ShowPullDownMenu=function(b,c){for(var d=$X(c.FrameContent).childNodes[0].rows[0].cells[0];0<d.childNodes.length;)this._ItemsDiv.appendChild(d.childNodes[0]);for(var e=[],g=0;g<this._ItemsDiv.childNodes.length;g++){var h=
this._ItemsDiv.childNodes[g];0<h.innerHTML.toUpperCase().indexOf("<HR")||(h.style.paddingRight="10px");h.getAttribute("EWA_MF_PID")==b.id&&e.push(h)}b=e.length;for(g=0;g<e.length;g++){d.appendChild(e[g]);if(this._CheckChildren(e[g].id)){h=e[g].childNodes[0].rows[0].cells[2];if(null==h.getAttribute("gdx")||""==h.getAttribute("gdx"))h.innerHTML+=" +",h.setAttribute("gdx","gdx");e[g].setAttribute("EWA_MF_CHILD","1")}else e[g].setAttribute("EWA_MF_CHILD","0");e[g]=null}e.length=0;$X(c.FrameContent).childNodes[0].style.height=
"auto";return b};this._CheckChildren=function(b){for(var c=0;c<this._ItemsDiv.childNodes.length;c++)if(this._ItemsDiv.childNodes[c].getAttribute("EWA_MF_PID")==b)return!0;return!1};this.InstallMenus=function(b,c,d){if("METRO"==d){var e=[],g={};$(".ewa_menu_m").each(function(){var m=$(this),n={};n.id=m.attr("id");n.pid=m.attr("EWA_MF_PID");n.url=m.attr("EWA_CMD");n.icon=m.find(".ewa_menu_m0").attr("class");n.title=m.text().trim();n.icon&&(n.icon=n.icon.replace("ewa_menu_m0","").trim());""==n.pid?(n.pid=
"0",n.subs=[],g[n.id]=n,e.push(n)):g[n.pid].subs.push(n)});EWA_UI_Metro.menus=e;EWA_UI_Metro.add_menus(e,"EWA_FRAME_MAIN","item",null,null,!0)}else{this.MenuShowType=d;d=$X(b);var h=$X(c);if(null==h)alert("MenuShow defined error ("+c+")");else{this._ItemsDiv=d;c=[];h.innerHTML="<table onselectstart='return false' style='cursor:pointer;-moz-user-select:none;' border=0 cellspacing=0 cellpadding=0></table>";h=h.childNodes[0];for(var k=0;k<d.childNodes.length;k++){var l=d.childNodes[k];"DIV"==l.tagName&&
""==l.getAttribute("EWA_MF_PID")&&c.push(l)}if(""==this.MenuShowType||"TOP"==this.MenuShowType)for(h.insertRow(-1),k=0;k<c.length;k++)h.rows[0].insertCell(-1).appendChild(c[k]);else h.style.width="100%",this._InstallMenusLeft(h,d,c,b);c.length=0;c=null}}};this._InstallMenusLeft=function(b,c,d,e){$(b).addClass("ewa-lmenu");for(var g=0;g<d.length;g++){var h=b.insertRow(-1).insertCell(-1);e=document.createElement("div");e.innerHTML='<div class="ewa_lmenu_bar" des="rq1"></div><div  des="rq2"></div>';
e.childNodes[1].style.paddingLeft="5px";h.appendChild(e);d[g].style.height="100%";e.childNodes[0].appendChild(d[g]);0==g?$(e).addClass("ewa-lmenu-show"):e.childNodes[1].style.display="none"}for(b=c.childNodes;0<c.childNodes.length;)d=b[0],g=d.getAttribute("EWA_MF_PID"),e=document.createElement("div"),e.innerHTML='<div class="ewa_lmenu_bar1"></div><div style="padding-left:4px;display:none"></div>',g=$X(g).parentNode.parentNode,$(g).addClass("ewa-lmenu-children"),g.childNodes[1].appendChild(e),e.childNodes[0].appendChild(d)};
this._CreateDialog=function(){var b=new EWA_UI_DialogClass;b.Create();b.SetHtml("<table class='ewa_menu_down' border=0 width=100 cellspacing=0 cellpadding=0 onmousemove='window."+this.ClassName+".IsOut=false;' onmouseout='window."+this.ClassName+".IsOut=true; window.setTimeout(function(){var a=window."+this.ClassName+";a.AutoHidden();},1410);' onselectstart='return false' style='cursor:pointer;-moz-user-select:none;' ><tr><td></td></tr></table>");return b};this.AutoHidden=function(){this.IsOut&&this._HiddenDialogs()};
this.Create=function(b){if(null!=b&&0!=b.length){this.Dialog=new EWA_UI_DialogClass;this.Dialog.Create();var c=[];c.push("<div class='ewa_menu_box' onmousemove='window."+this.ClassName+".IsOut=false;' onmouseout='window."+this.ClassName+".IsOut=true; var t1=new Date().getTime(); if(t1-$(this).attr(&quot;open_time&quot;)>1000){ window.setTimeout(function(){var a=window."+this.ClassName+";a.AutoHidden(this);},1410);}'  onselectstart='return false' style='width:120px;cursor:pointer;-moz-user-select:none;'>");
...
this._Ajax.PostNew(this.Url,EWA.F.F.CUR._CallBack)}};this.CreateAjax=function(a,b){EWA.F.F.CUR=this;null==a&&(a=$("#f_"+this._Id)[0]);if(!b&&!this.CheckValidAll(a))return null;b=new EWA.C.Ajax;for(var c in this.ItemList.Items){var d=this.ItemList.GetItemValue(this.ItemList.Items[c],"Name","Name"),e=this.GetObject(d,a);if(null!=e&&!$(e).attr("ewa_encyrption")){var g=this._GetObjectValue(e);null!=g&&b.AddParameter(d,g);"DIV"==e.tagName.toUpperCase()&&"1"==e.getAttribute("EWA_DHTML")&&(g=$X("UP_IMG_"+
d).value,b.AddParameter(d+"_imgs_split",g));d=e.getAttribute("ewa_tag");if("swffile"==d||"IMG_UPLOAD"==d)if(g=e.getAttribute("UP_PARAS"),null!=g&&0<g.length){g=g.split(",");for(var h=0;h<g.length;h++){var k=g[h];b.AddParameter(k,e.getAttribute(k))}}else b.AddParameter("UP_URL",e.value);"markdown"==d&&(e=e.parentNode.getElementsByTagName("textarea"),1<e.length&&b.AddParameter(e[1].id,e[1].value))}}if(this.PostAddData)for(k in this.PostAddData)b.AddParameter(k,this.PostAddData[k]);return b};this.CreatePostData=
function(){var a=$("#f_"+this._Id)[0],b={},c;for(c in this.ItemList.Items){var d=this.ItemList.GetItemValue(this.ItemList.Items[c],"Name","Name"),e=this.GetObject(d,a);if(null!=e){var g=this._GetObjectValue(e);null!=g&&(b[d]=g);"DIV"==e.tagName.toUpperCase()&&"1"==e.getAttribute("EWA_DHTML")&&(g=$X("UP_IMG_"+d).value,b[d+"_imgs_split"]=g);d=e.getAttribute("ewa_tag");if("swffile"==d||"IMG_UPLOAD"==d)if(g=e.getAttribute("UP_PARAS"),null!=g&&0<g.length){g=g.split(",");for(var h=0;h<g.length;h++){var k=
g[h];b[k]=e.getAttribute(k)}}else b.UP_URL=e.value;"markdown"==d&&(e=e.parentNode.getElementsByTagName("textarea"),1<e.length&&(b[e[1].id]=e[1].value))}}return b};this.DoPostBefore=function(){return!0};this.isDoPostBeforeTimer=function(){return null!=this._checkStatusFristResult};this._uploadingFileCheck=function(a){a=window["h5u_"+this._Id+"$"+a.id];if(!a.haveFile())return!1;if("ok"==a.UPLOAD_STATUS)return a.removeWaitBox(),this.uploadProcess=!1;if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=
!1,a.removeWaitBox(),!1;if("error"==a.UPLOAD_STATUS||"abort"==a.UPLOAD_STATUS)return this._stopPost=!0,this._stopPostError="enus"==EWA.LANG?"Upload file error or aborted":"\u4e0a\u4f20\u6587\u4ef6\u9519\u8bef\u6216\u88ab\u4e2d\u6b62",console.log(this._stopPostError),!1;if("start"==a.UPLOAD_STATUS||"checking"==a.UPLOAD_STATUS)return!0;a.submitUploads();if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;$X(a.WAIT_ID)||a.createWaitBox();return this.uploadProcess=!0};this.DoPost=
function(a,b,c){if(!c){c=this.DoPostBefore();if(c instanceof Array){var d=this;this._checkStatusInc=0;this._checkStatusFristResult=c;this._checkStatusTimer=window.setInterval(function(){var l=0==d._checkStatusInc?d._checkStatusFristResult:d.DoPostBefore();d._checkStatusInc++;null!=l[0]&&(window.clearInterval(d._checkStatusTimer),d._checkStatusTimer=null,d._checkStatusInc=null,d._checkStatusFristResult=null,0==l[0]?l[2]?$Confirm(l[1],l[1],function(){l[0]=l[1]=null;d.DoPost(a,b,!0)},function(){}):$Tip(l[1]):
(l[0]=l[1]=null,d.DoPost(a,b,!0)))},232);return}if(!c)return}var e=$(a).find("input[ewa_tag=ht5upload]");if(!(0<e.length)||this.uploadProcess||this.CheckValidAll(a)){var g=0;d=this;for(c=0;c<e.length>0;c++){var h=e[c];this._uploadingFileCheck(h)&&g++}if(0<g)setTimeout(function(){d.DoPost(a,b)},700);else if(e=$(a).find("input[ewa_tag=ht5takephoto]"),!(0<e.length)||this.uploadProcess||this.CheckValidAll(a)){for(c=0;c<e.length>0;c++){h=e[c];g=!1;h=window["h5takephoto_"+this._Id+"$"+h.id];if("ok"!=h.UPLOAD_STATUS){if(!$X(h.H5_UPLOAD.WAIT_ID)){try{h.submitUpload()}catch(l){console.log("ht5takephotos - ht5.submitUpload: "+
l);$Tip("\u60a8\u6ca1\u6709\u83b7\u53d6\u7167\u7247");return}h.H5_UPLOAD.createWaitBox();this.uploadProcess=!0}g||(d=this,setTimeout(function(){d.DoPost(a,b)},700),g=!0);return}h.H5_UPLOAD.removeWaitBox()}if(this._stopPostError)EWA.UI.Msg.ShowError(this._stopPostError,"");else if(c=this.CreateAjax(a),null!=c){null==b&&(b=this.Url);if(""==b||null==b)b=window.location.href;this._Ajax=c;this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT",
"1");this._Ajax.LoadingType="image";this.DoPostStart&&this.DoPostStart(this._Ajax);c=new EWA_UrlClass(b);for(var k in this._Ajax._Parameters)c.RemoveParameter(k);b=c.GetUrl();this._Ajax.PostNew(b,EWA.F.F.CUR._CallBack);this.isShowPostWaitting||this._Ajax.HiddenWaitting();$("#EWA_FRAME_"+this._Id+" input[type=submit]").attr("disabled","disabled")}}}};this._CallBack=function(){var a=EWA.F.F.CUR._Ajax;if(a.IsRunEnd())if($("#EWA_FRAME_"+EWA.F.F.CUR._Id+" input[type=submit]").attr("disabled",null),EWA.F.F.CUR.DoPostEnd&&
EWA.F.F.CUR.DoPostEnd(a,a._Http.status,a._Http.responseText,a._Http.statusText),200==a._Http.status){if(a=a._Http.responseText,EWA.F.CheckCallBack(a)){EWA.F.F.CUR.ValidCodeError(!0);try{EWA.F.F.CUR.ReloadAfter&&EWA.F.F.CUR.ReloadAfter(a),eval(a)}catch(b){alert(a)}}}else alert("ERROR:\r\n"+a._Http.statusText)};this.Reload=function(){};this.Reload1=function(){console.log("Reload1 \u8fd9\u4e2a\u5e72\u561b\u7528\uff1f\u8c01\u5728\u8c03\u7528\uff1f")};this.ReloadFrame=function(a){var b=$("#EWA_FRAME_"+
this._Id);if(0!=b.length){var c=b.parentsUntil("#EWA_FRAME_MAIN").last().parent();if(0!=c.length){b=EWA_Utils.tempId("ewa_frame_relaod");c.attr("id",b);var d=new EWA_UrlClass(this.Url);d.AddParameter("ewa_ajax","install");d=d.GetUrl();$Install(d,b,function(){a&&a(c,this)})}}};this.CheckValidAll=function(a){var b=!0,c=null,d;for(d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],"Name","Name");e=this.GetObject(e,a);null!=e&&((b&=this.CheckValid(e))||null!=c||(c=e))}null!=
c&&c.focus();return b};this.H5Type=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name");d=a.find('[id="'+d+'"]');if(0!=d.length){var e=this.ItemList.GetItemValue(c,"Tag","Tag"),g=this.ItemList.GetItemValue(c,"DataItem","Valid");this.ItemList.GetItemValue(c,"DataItem","Format");c=this.ItemList.GetItemValue(c,"IsMustInput","IsMustInput");"Email"==g&&d.attr("type","email");"valid"==e&&d.attr("type","tel");
1==c&&d.attr("required","required")}}};this.GetObject=function(a,b){b||(b=$("FORM#f_"+this._Id));a=$(b).find('[id="'+a+'"]');return 0<a.length?a[0]:null};this.CheckValid=function(a,b){if("SPAN"==a.tagName||"IMG"==a.tagName)return!0;if(a&&b&&"DIV"==a.tagName&&"REPT"==a.getAttribute("tag")){b=b.target.tagName;if("LABEL"==b||"INPUT"==b){var c=this;setTimeout(function(){c._GetObjectValue(a);c.ItemList.CheckValid(a,d)},10)}return!0}var d=this._GetObjectValue(a);return this.ItemList.CheckValid(a,d)};this._GetObjectValue=
function(a){return this.ItemList.GetObjectValue(a)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}var __EWA_ALTER_MSG=null;
...
!1;this.CheckedAllAfter=this.ReloadAfter=null;this.IsNotMDownAutoChecked=!1;this.replaceRowsData=function(a,b){var c=this.getUrlClass();c.AddParameter("EWA_AJAX","LF_RELOAD");c.AddParameter("EWA_IS_SPLIT_PAGE","no");c.AddParameter("EWA_IS_HIDDEN_CAPTION","yes");c=c.GetUrl();a&&(c+="&"+a);var d=$("#EWA_LF_"+this._Id);$J2(c,function(e){$(e).find("tr.ewa-lf-data-row").each(function(){var g=$(this).attr("ewa_key"),h=d.find('tr[ewa_key="'+g+'"]');$(this).find("td").each(function(){var k=$(this).children(0).attr("name");
k&&(k=h.find(".ewa-col-"+k),0!=k.length&&(b?b(this,k[0]):k.html($(this).html())))})})})};this.ShowRecycle=function(){var a=$X("EWA_LF_"+this._Id);if(null!=a&&(a=$(a).parentsUntil("table").last().find(".ewa_lf_func_caption"),0!=a.length)){var b="\u56de\u6536\u7ad9";window._EWA_INFO_MSG&&window._EWA_INFO_MSG.RECYCLE&&(b=window._EWA_INFO_MSG.RECYCLE);b="<div class='ewa_lf_func_dact ewa-lf-func-recycle' onclick='EWA.F.FOS[\""+this._Id+"\"].ShowRecycle1(this)' ><b class='fa fa-recycle'></b>"+b+"</div>";
a.parent().append(b)}};this.ShowRecycle1=function(a){var b=new EWA_UrlClass(this.Url);$(a).attr("recycle")?(b=b.RemoveParameter("ewa_recycle"),$(a).attr("recycle",null).removeClass("ewa-lf-func-recycle-yes")):(b=b.AddParameter("ewa_recycle","1"),$(a).attr("recycle",1).addClass("ewa-lf-func-recycle-yes"));this.Url=b;this.Goto(1)};this.BindButton=function(a,b){$("#EWA_LF_"+this._Id+' tr[ewa_key] [id="'+a+'"]').each(function(){$(this).attr("onclick","$(this).parent().parent().find('[id=\""+b+"\"]')[0].click()");
$(this).addClass("ewa-map-button")})};this.Merge=function(a,b,c,d){$("#EWA_LF_"+this._Id+" tr[ewa_key]").each(function(){var e=$(this).find('[id="'+a+'"]');e.parent().hide();var g=$(this).find('[id="'+b+'"]').parentsUntil("tr").last();c||(c="<br>");0<=c.indexOf("<")?g.append(c):g.append("<span class='ewa-mearge-str'>"+c+"</span>");g.append(e);d&&d(g,this)});$("#EWA_LF_"+this._Id+' tr[ewa_tag="HEADER"] [id="'+a+'"]').parent().hide()};this.Mearge=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 Merge");
this.Merge(a,b,c)};this.MergeExp=function(a,b,c,d){if(b){var e=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),g=[],h=b,k={};for(b=0;b<e.length;b++){var l=e[b];g.push(l);var m=l.replace("@@","");h=h.replace(l,"<span class='ewa-lf-mearge ewa-lf-mearge-"+m+"' mid=\""+m+'"></span>');m!=a&&$("#EWA_LF_"+this._Id+' tr[ewa_tag="HEADER"] [id="'+m+'"]').parent().hide();k[m]=$("#EWA_LF_"+this._Id+' tr[ewa_tag="HEADER"] [id="'+m+'"]').html()}$("#EWA_LF_"+this._Id+" tr[ewa_key]").each(function(){var n=document.createElement("div");
n.style.display="none";n.innerHTML=h;document.body.appendChild(n);if(0==$(this).find('[id="'+a+'"]').length)console.log("not find "+a);else{var p=$(this).find('[id="'+a+'"]').parent(),t;for(t in g){var r=g[t].replace("@@",""),q=$(this).find('[id="'+r+'"]');if(0!=q.length){r!=a&&q.parent().hide();var v=$(n).find('span[mid="'+r+'"]');c&&(v.append("<span class='ewa-lf-mearge-memo'></span>"),v.find(".ewa-lf-mearge-memo").html(k[r]));v.append(q)}}for(;0<n.childNodes.length;)p.append(n.childNodes[0]);$(n).remove();
d&&d(p,this)}})}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MeargeExp=function(a,b,c,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 MereExp");this.MergeExp(a,b,c,d)};this.SubBottoms=function(a){this.SubBottomsArray=a.split(",");this._SubBottoms()};this._SubBottoms=function(){var a=this.AddRow([]);$(a).find("td").addClass("ewa-lf-sub-td");var b=0,c;for(c in this.SubBottomsArray){var d=this.SubBottomsArray[c],e=0;$("#EWA_LF_"+this._Id+" .ewa-col-"+d).each(function(){var g=
GetInnerText(this).replace(/,/ig,"");isNaN(g)||(e+=1*g,0<g.indexOf(".")&&(b=2))});$(a).find("td[id=ADD_ROW_"+d+"]").html("<nobr class='ewa-lf-sub'>"+e.fm(b)+"</nobr>")}};this.ChangeRowStyle=function(a,b,c){for(var d=$X("EWA_LF_"+this._Id),e=1;e<d.rows.length;e++){var g=d.rows[e];if(!(0==g.cells.length||g.cells.length<=a)){var h=g.cells[a].childNodes[0].getAttribute(b);if(null!=h&&c[h])for(var k=0;k<g.cells.length;k++)g.cells[k].style.cssText=g.cells[k].style.cssText+";"+c[h]}}if(null==this.ReloadAfter){var l=
this;this.ReloadAfter=function(){l.ChangeRowStyle(a,b,c)}}};this.MDownEvent=function(a,b){};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.Workflow=function(a,b,c,d,e,g){EWA.F.CID=this._Id;this._Ajax=this.CreateAjax();this._Ajax.AddParameter("EWA_AJAX","WORKFLOW");this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_WF_NAME",b);null!=c?(a=this.GetRowKey(c),this._Ajax.AddParameter("EWA_ACTION_KEY",a),"true"==c.getAttribute("ewa_wf_control")?
this._Ajax.AddParameter("EWA_WF_CTRL",1):this._Ajax.AddParameter("EWA_WF_CTRL",0)):this._Ajax.AddParameter("EWA_WF_CTRL",1);null!=d&&this._Ajax.AddParameter("EWA_ACTION_KEY",d);e&&this._Ajax.AddParameter("EWA_WF_UOK",e);g&&this._Ajax.AddParameter("EWA_WF_UMSG",g);var h=this;this._Ajax.PostNew(this.Url,function(){h._CallBackJs()})};this.GetRowKey=function(a){a=this.GetRow(a);return null!=a?a.getAttribute("EWA_KEY"):null};this.GetRow=function(a){if(null==a||null==a.tagName||""==a.tagName)return null;
var b=0;for(a=a.parentNode;"TR"!=a.tagName||null==a.getAttribute("EWA_KEY");){a=a.parentNode;if("BODY"==a.tagName){a=null;break}b++;if(100<b){alert("\u5faa\u73af100\u6b21\uff0c\u672a\u53d1\u73b0TR");break}}return a};this.RecordModify=function(a,b,c){var d=this.SelectChecked();if(0==d.length)EWA.UI.Msg.Alter("\u8bf7\u5148\u9009\u62e9","\u4fee\u6539");else{var e="EWA_MTYPE=M";null!=c&&0<c.trim().length&&(e+="&"+c);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,e+d)}};this.RecordNew=function(a,b,c){var d=
"EWA_MTYPE=N";null!=c&&0<c.trim().length&&(d+="&"+c);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,d)};this.SelectSingle=function(){this.IsTrSelect=!0;this._TrSelectMulti=!1};this.SelectMulti=function(){this._TrSelectMulti=this.IsTrSelect=!0};this.MOver=function(a,b){if(this.IsTrSelect&&this._CurTr!=a&&(null!=this._CurTr&&("1"!=this._CurTr.getAttribute("__ewa_lf_mdown")?this._MSetBg(this._CurTr,""):this._MSetBg(this._CurTr,"down")),"1"!=a.getAttribute("__ewa_lf_mdown")?this._MSetBg(a,"over"):this._MSetBg(a,
"down"),this._CurTr=a,this.MOverEvent))try{this.MOverEvent(a,b)}catch(c){console.log(c,this.MOverEvent)}};this.MOut=function(a){if(this.IsTrSelect&&null!=this._CurTr&&"1"!=this._CurTr.getAttribute("__ewa_lf_mdown")){this._MSetBg(this._CurTr,"out");if(this.MOutEvent)try{this.MOutEvent(this._CurTr,a)}catch(b){console.log(b,this.MOutEvent)}this._CurTr=null}};this.MDownEnableCheck=function(a,b){return!0};this.MDown=function(a,b){if(this.IsTrSelect&&(b=null==b?event:b,this.MDownEnableCheck(a))){if(b){var c=
b.srcElement?b.srcElement:b.target;if(c&&("A"==c.tagName||"INPUT"==c.tagName||"SELECT"==c.tagName||"BUTTON"==c.tagName||"TEXTAREA"==c.tagName||0<=c.className.indexOf("EWA_LF_EDIT")||0<=c.className.indexOf("ewa-lf-edit")||0<=c.className.indexOf("ewa-lf-search-text-click")||0<=c.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=c.parentNode.parentNode.className.indexOf("ewa-lf-search-text-click")))return}var d=(new Date).getTime(),e=$(a).attr("mdown_time_last");if(!(null!=e&&500>d-e)){$(a).attr("mdown_time_last",
d);d=null;if(!this.IsNotMDownAutoChecked){var g=a.getElementsByTagName("input");if("INPUT"!=c.tagName&&0<g.length)for(c=0;c<g.length;c++){if("RADIO"==g[c].type.toUpperCase()){d=g[c];d.click();break}if("CHECKBOX"==g[c].type.toUpperCase()&&0>g[c].parentNode.className.indexOf("ewa-switch")){d=g[c];d.click();break}}}if("1"==a.getAttribute("__ewa_lf_mdown"))this._TrSelectMulti&&(d&&"CHECKBOX"==d.type.toUpperCase()&&(d.checked=!1),this._MSetBg(a,""),a.removeAttribute("__ewa_lf_mdown"),$(a).removeClass("ewa-lf-mdown"));
else{d&&(d.checked=!0);this._MSetBg(a,"down");a.setAttribute("__ewa_lf_mdown",1);$(a).addClass("ewa-lf-mdown");if(!this._TrSelectMulti&&(d=a.parentNode)&&d.rows)for(c=0;c<d.rows.length;c++)e=d.rows[c],"1"==e.getAttribute("__ewa_lf_mdown")&&e!=a&&(e.removeAttribute("__ewa_lf_mdown"),$(e).removeClass("ewa-lf-mdown"),this._MSetBg(e,""));if(this.IsReShow)for(c=0;c<g.length;c++)"BUTTON"==g[c].type.toUpperCase()&&(d=g[c],"true"==d.getAttribute("disabled")||1==d.getAttribute("disabled")||"true"==d.parentNode.getAttribute("disabled")||
1==d.parentNode.getAttribute("disabled")?(this._ReshowButs[d.value].disabled=!0,this._ReshowButs[d.value].style.display="none"):(this._ReshowButs[d.value].disabled=!1,this._ReshowButs[d.value].style.display=""))}if(this._IsAddPreRow){if(g=a.getAttribute("ewa_key"),this.AddPreRowCheck(a,g,b)){d=a.parentNode.rows[a.rowIndex+1];if(null==d||1!=d.getAttribute("add_pre_row"))d=a.parentNode.parentNode,c=d.rows[0].cells.length,d=d.insertRow(a.rowIndex+1),d.setAttribute("add_pre_row",1),e=d.insertCell(-1),
e.innerHTML="",e.colSpan=c,e.className="",d.style.display="none",e.id=("EWA_LF_NR_"+this._Id+"_"+Math.random()).replace(".","G"),$(d).addClass("ewa-lf-add-pre-row");this.prevTr&&(this.AddPreRowCloseBeforeEvent&&this.AddPreRowCloseBeforeEvent(this._Id,a,g,this.prevTr,b),this.prevTr.style.display="none",this.prevTr.cells[0].innerHTML="",this.AddPreRowCloseEvent&&this.AddPreRowCloseEvent(this._Id,a,g,this.prevTr,b));this.prevTr==d?this.prevTr=null:(this.prevTr=d,this.prevTr.style.display="",this.MDownEvent(this._Id,
a,g,this.prevTr,b))}}else this.MDownEvent(a,b)}}};this.AddPreRow=function(a){this._IsAddPreRow||(this.MDownEvent=a);this._IsAddPreRow=!0};this.AddPreRowCheck=function(a,b,c){return!0};this.AddPreRowCloseBeforeEvent=function(a,b,c,d,e){};this.AddPreRowCloseEvent=function(a,b,c,d,e){};this._MSetBg=function(a,b){var c="EWA_TD_M";"down"==b?c="ewa_grid_down":"over"==b&&(c="ewa_grid_mover");for(b=0;b<a.cells.length;b++)$(a.cells[b]).removeClass("ewa_grid_mover ewa_grid_down EWA_TD_M").addClass(c)};this._ReShowSearchQuick=
function(){var a=this,b=EWA_ListFrameClass.prototype.RESOURCES.search_text_items,c,d,e;for(e in b){var g=b[e];"eq"==g.Id&&(c=g);"lk"==g.Id&&(d=g)}for(e in this._SearchJson){var h=this._SearchJson[e];h.isSearchQuick&&(b=$("#EWA_LF_"+this.Id+' .ewa-lf-data-row [id="'+e+'"]'),b.bind("click",function(k){k.stopPropagation();var l=$(this).attr("search_tag"),m=$(this).text(),n=m,p=$("table#EWA_SEARCH_ITEM_"+a.Id+' .ewa-lf-search-item-ctl [name="'+this.id.toUpperCase()+'"]');if("number"==l||"date"==l)p=p.parentsUntil(".ewa-lf-search-item").last().find("input");
var t=p.parentsUntil(".ewa-lf-search-item").last().find("a");console.log(k);if("date"==l)m=m.split(" ")[0],n=m+" 23:59:59";else if("fix"==l){var r=null;p.find("option").each(function(){this.text==m&&(r=this.value)});m=null===r?"":r}console.log(m,n);p.val()==m?("text"==l&&d&&0<t.length&&(t.attr("tag",d.Id),t.html("enus"==EWA.LANG?d.TxtEn:d.Txt)),p.val("")):("text"==l&&c&&0<t.length&&(t.attr("tag",c.Id),t.html("enus"==EWA.LANG?c.TxtEn:c.Txt)),p.val(m),"date"==l&&(p[1].value=n))}),b.each(function(){$(this).text()&&
...
a.id="EWA_RESHOW_"+this._Id;a.cellSpacing="0";a.cellPadding="0";var b=!(0<this.Url.toUpperCase().indexOf("EWA_AJAX=INSTALL")||0<this.Url.toUpperCase().indexOf("EWA_CALL_METHOD=INNER_CALL")||0<this.Url.toUpperCase().indexOf(".JSP"));b?EWA.UI.Utils.SetStyle(a,"width:100%;height:100%;"):EWA.UI.Utils.SetStyle(a,"width:100%");var c=a.insertRow(-1),d=c.insertCell(-1),e=a.insertRow(-1).insertCell(-1);e.className="ewa_lf_func";e.innerHTML='<div style="display:none"></div><div></div>';var g=a.insertRow(-1).insertCell(-1);
g.vAlign="top";EWA.UI.Utils.SetStyle(g,"width:100%;");css="";g.innerHTML='<div id="_G_'+this._Id+'" style="'+css+'"></div>';var h=$X("EWA_LF_"+this._Id),k=h.parentNode.parentNode.parentNode;g.childNodes[0].appendChild(h.parentNode);var l="_G_"+this._Id;this.NewDivId=l;b&&(window.setTimeout(function(){$X("__EWA_DEBUG")&&g.childNodes[0].appendChild($X("__EWA_DEBUG"));var z=$X(l);z.getElementsByTagName("table");var C=EWA.UI.Utils.GetDocSize(window),D=z.parentNode.parentNode.previousSibling.offsetHeight;
z.style.top=D+"px";z.style.height=C.H-D+"px"},100),addEvent(window,"resize",function(){var z=$X(l),C=EWA.UI.Utils.GetDocSize(window),D=z.parentNode.parentNode.previousSibling.offsetHeight;z.style.top=D+"px";z.style.height=C.H-D+"px"}));for(;0<k.childNodes.length;)e.childNodes[0].appendChild(k.childNodes[0]);var m=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",e.childNodes[1]);m.className="ewa_lf_func_caption";b=m;var n=[],p=!1,t=GetInnerText(e);t=t.trim();this._ReshowButs={};for(var r in this.ItemList.Items){m=
this.ItemList.Items[r];var q=this._GetSubValue("Tag","Tag",m);if(null!=q&&("button"==q.trim().toLowerCase()||"butflow"==q.trim().toLowerCase()))for(q=0;q<h.rows[0].cells.length;q++)if(h.rows[0].cells[q].childNodes[0].id.toUpperCase()==r){n.push(q);p=!0;q=this._GetSubValue("DescriptionSet","Info",m);var v=this._GetSubValue("DescriptionSet","Memo",m),u=this._GetSubValue("EventSet","EventName",m),x="";null!=u&&"ewa_click"==u.toLowerCase().trim()&&(x=this._GetSubValue("EventSet","EventValue",m));t=t.replace(q,
"");m=this._ReShowButton(q,v,null);this._ReshowButs[q]=m;m.setAttribute("f_id",this._Id);e.childNodes[1].appendChild(m);""==x?m.onclick=function(){var z=this.getAttribute("f_id");z=EWA.F.FOS[z].SelectCheckedRows();if(null==z||0==z.length)EWA.UI.Msg.Alert(_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM"],_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM_TITLE"]);else{z=z[0].getElementsByTagName("input");for(var C=0;C<z.length;C++){var D=z[C];if("button"==D.type&&D.value==this.childNodes[0].innerHTML){D.click();break}}}}:(m.setAttribute("ewa_click",
x),m.onclick=function(){eval(this.getAttribute("ewa_click"))});break}}p&&this._ReShowSplit(e.childNodes[1]);n=e.getElementsByTagName("input");h={};for(q=0;q<n.length;q++){var w=n[q];w.style.display="none";if(null==w.id||""==w.id)w.id=("_tmp_"+Math.random()).replace(".","_");if("button"==w.type){if(m=this._ReShowButton(w.value,w.title,w.id),p=w.nextSibling){var y="";3==p.nodeType&&(y=p.nodeValue.trimEx());"|"==y&&this._ReShowSplit(e.childNodes[1])}}else(p=w.nextSibling)&&(y=3==p.nodeType?p.nodeValue.replace("|",
""):p.innerHTML),m=this._ReShowButton(y.trimEx(),w.title,w.id),m.id=("_tmp_"+Math.random()).replace(".","_"),h[w.name]||(h[w.name]=[]),h[w.name].push(m.id);e.childNodes[1].appendChild(m)}t=t.replace(/ /ig,"").replace(/\|/ig,"").trimEx();""!=t?0<=t.indexOf("if")?c.style.display="none":d.innerHTML=t.replace(/ /,""):c.style.display="none";k.appendChild(a);for(r in h)for(y=h[r],q=0;q<y.length;q++)w=$X(y[q]),w.setAttribute("_r_ids",y.join(",")),w.onclick=function(){var z=this.getAttribute("_ewa_event_id");
...
r+" "+("fix"==r?"ewa-lf-search-fix-m"+(t.M||"0"):"")+"' cellspacing=0 cellpadding=0>");p.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");p.push(q);var v=q="",u="lk";e[g.toUpperCase()]&&(v=e[g.toUpperCase()],u=v.tag,q=v.para1,v=v.para2);"text"==r?(n=l[u]||l.lk,n="enus"==EWA.LANG?n.TxtEn:n.Txt,p.push("<a class='ewa-lf-search-type' tag='"+u+"' href='javascript:void(0)' onclick='"+h+"'>"),p.push(n),p.push("</a>"),n=!0):"date"==r&&(p.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+
k+"'></a>"),m=!0);p.push(": </b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==r?p.push(this._SearchSingle(g,q)):"date"==r?p.push(this._SearchDate(g,q,v)):"number"==r?p.push(this._SearchNumber(g,q,v)):"fix"==r&&(t="<div >"+this._SearchFix(g,t,"span",q)+"</div>",p.push(t));p.push("</td></tr></table>");"fix"==r?c.push(p.join("")):d.push(p.join(""))}if(0!=d.length+c.length){b.push('<table class="ewa-lf-search-main" id="'+a+'" cellspacing="0" cellpadding="0" style="width:100%">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");
0<d.length&&b.push(" "+d.join("")+" ");if(0<c.length)for(d=0;d<c.length;d++)b.push(" "+c[d]+" ");b.push("</td></tr></table>");var x=document.createElement("div");this._SEARCH_BOX=x;x.className="ewa-lf-search";x.innerHTML=b.join("");b=$X("EWA_LF_"+this.Id).parentNode;b.parentNode.insertBefore(x,b);a="EWA_SEARCH_ITEM_"+this.Id;var w=this;m&&this._SearchCreateDateRange();n&&this._SearchCreateTextType();w._SEARCH_ITEM_EXP=this.SearchGetExp(x);"{}"!=JSON.stringify(e)&&(w._SearchExp=w._SEARCH_ITEM_EXP);
$(x).find("input[type=text]").on("compositionstart",function(){w._is_search_composition=!0}).on("compositionend",function(){w._is_search_composition=!1});this._TIMER_SEARCH=window.setInterval(function(){if(!w._is_search_composition){try{if(!$X(a)){window.clearInterval(w._TIMER_SEARCH);return}}catch(A){window.clearInterval(w._TIMER_SEARCH);return}var y=w.SearchGetExp(x);y!=w._SEARCH_ITEM_EXP&&(w._SEARCH_ITEM_EXP=y,w.DoSearch($X(a)))}},700)}};this._SearchSingle=function(a,b){var c=[];c.push('<input t="text" type="text" autocomplete="off" class="EWA_INPUT" maxlength="40" name="');
...
this._Id+"\"].DoSearch(this);'> <input type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLOSE"]+"' onclick='EWA.F.FOS[\""+this.Id+"\"]._SearchDialog.Show(false);'></td></tr>");a.push("</table></div>");this._SearchHtml=a.join("")};this.SearchMark=function(){for(var a=this._SearchExp.split("@!@"),b=$X("EWA_LF_"+this._Id),c=0;c<a.length;c+=1){var d=a[c].split("~!~");if(!(3>d.length))for(var e=2;e<d.length;e++){var g=d[e];if(""!=g){if("fix"==d[1]){var h=d[0],k=d[2];$("table#EWA_SEARCH_ITEM_"+this.Id+
' [name="'+h+'"]').find("option").each(function(){this.value==k&&(g=this.text)})}h=[];for(var l=0;l<g.length;l++){var m=g[l];"a"<=m&&"z">=m||"A"<=m&&"Z">=m||"0"<=m&&"9">=m?h.push(m):h.push("\\"+m)}g=h.join("");h=d[0];this._SearchJson[h]&&(h=this._SearchJson[h].ORI_NAME);try{g=eval("/("+g+")/ig"),$(b).find('.EWA_TD_M [id="'+h+'"]').each(function(){0==this.children.length&&(this.innerHTML=this.innerHTML.replace(g,"<font color=red><b>$1</b></font>"))})}catch(n){console.log(n)}}}}};this.DblClick=function(a){this._IsDblClick=
a;for(var b=$X("EWA_LF_"+this._Id),c=1;c<b.rows.length;c++)b.rows[c].ondblclick=function(){var d=this.getElementsByTagName("input");d.length>a&&0==d[a].disabled&&d[a].click()}};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);if((a=$X("EWA_LF_"+this._Id))&&"table"==a.tagName&&!(1>=a.rows.length)){a=a.rows[1].getElementsByTagName("input");for(var b=0;b<a.length;b++)if("RADIO"==a[b].type.toUpperCase()){this._TrSelectMulti=
...
this._IsCheckedAll)}this._IsCheckedAll=this._IsCheckedAll?!1:!0;this.CheckedAllAfter&&this.CheckedAllAfter(a)}};this.SelectChecked=function(){var a=$X("EWA_LF_"+this._Id);if(!a||1>a.rows.length)return"";var b=[],c=$F(a,"input","type","radio,checkbox");if(0<c.length)for(var d=0;d<c.length;d++)c[d].checked&&b.push(c[d].value);else for(d=0;d<a.rows.length;d++)c=a.rows[d],1==c.getAttribute("__ewa_lf_mdown")&&b.push(c.getAttribute("EWA_KEY"));return b.join(",")};this.SelectCheckedInputs=function(){var a=
...
a&&(this._PageSize=a,this.Goto(1))};this.Goto=function(a,b){EWA.F.CID=this._Id;this._PageCurrent=a;this._Ajax=this.CreateAjax();a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.RemoveParameter("EWA_AJAX");var c=this;this._Ajax.PostNew(a.GetUrl(),function(){c._CallBack(b)})};this.CreateAjax=function(){var a=new EWA.C.Ajax;a.LoadingType="image";a.AddParameter(this._PageCurrentName,this._PageCurrent);this._PageSize&&a.AddParameter(this._PageSizeName,this._PageSize);null!=
this._Sort&&a.AddParameter(this._SortName,this._Sort);null!=this._SearchExp&&""!=this._SearchExp&&a.AddParameter("EWA_LF_SEARCH",this._SearchExp);a.AddParameter("EWA_AJAX","LF_RELOAD");if(null!=this.GotoParas&&0<this.GotoParas.length)for(var b=0;b<this.GotoParas.length;b+=1)a.AddParameter(this.GotoParas[b].Name,this.GotoParas[b].Value);return a};this.DownlodData=function(a,b){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";null!=this._Sort&&this._Ajax.AddParameter(this._SortName,
this._Sort);null!=this._SearchExp&&""!=this._SearchExp&&this._Ajax.AddParameter("EWA_LF_SEARCH",this._SearchExp);this._Ajax.AddParameter("EWA_AJAX","DOWN_DATA");this._Ajax.AddParameter("EWA_AJAX_DOWN_TYPE",a);b&&this._Ajax.AddParameter("EWA_ACTION",b);if(null!=this.GotoParas&&0<this.GotoParas.length)for(a=0;a<this.GotoParas.length;a+=1)this._Ajax.AddParameter(this.GotoParas[a].Name,this.GotoParas[a].Value);this._AjaxType="DOWN_DATA";a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:
this.Url);var c=this;this._Ajax.PostNew(a.GetUrl(),function(){c._CallBack()})};this.Get=function(a){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";var b=this;this._Ajax.Get(a,function(){b._CallBack()})};this.Post=function(a,b){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";var c=this;this._Ajax.Post(a,b,function(){c._CallBackJs()})};this._CallBack=function(a){var b=this._Ajax;if(4==b._Http.readyState){b.HiddenWaitting();if(top.EWA&&top.EWA.MQE){var c=
new EWA_MqeClass;c.Data=b.GetRst();c.FromId=EWA.F.CID;c.Type="POST";top.EWA.MQE.AddMqe(c)}200==b._Http.status?(b=b._Http.responseText,EWA.F.CheckCallBack(b)&&("DOWN_DATA"==this._AjaxType?(this._AjaxType=null,"DENY"==b.trim()?alert(_EWA_INFO_MSG["EWA.LF.DOWN_DATA.DENY"]):window.location.href=b.trim()):(c=$X("EWA_LF_"+this._Id).parentNode,$(c).replaceWith(b),this.SearchMark(),this.IsReShow&&this.ReShowWithNoButtons(),this._ReShowSearchQuick(),null!=this._IsDblClick&&this.DblClick(this._IsDblClick),
this._IsAddPreRow&&this.AddPreRow(),this.SubBottomsArray&&this._SubBottoms(),this.ReloadAfter&&this.ReloadAfter(a),this.ReloadAfterApp&&this.ReloadAfterApp(a)))):alert("ERROR:\r\n"+b._Http.statusText);this.RewriteInfo()}};this._CallBackJs=function(){var a=this._Ajax;if(4==a._Http.readyState){if(top.EWA&&top.EWA.MQE){var b=new EWA_MqeClass;b.Data=a.GetRst();b.FromId=EWA.F.CID;b.Type="POST";top.EWA.MQE.AddMqe(b)}a.HiddenWaitting();200==a._Http.status?(a=a._Http.responseText,EWA.F.CheckCallBack(a)&&
eval(a)):alert("ERROR:\r\n"+a._Http.statusText);this.EditAfterEvent&&this.EditAfterEvent()}};this.EditAfterEvent=function(){};this._GetItem=function(a){for(var b=this.ItemList,c=0;c<b.length;c+=1){var d=b[c],e=this._GetSubItem("Name",d);if(this.Xml.GetElementAttribute(e,"Name")==a)return d}};this._GetSubItem=function(a,b){b=this.Xml.GetElements(a+"/Set",b);if(null==b||0==b.length)return null;if("DescriptionSet"==a)for(a=0;a<b.length;a+=1){var c=b[a].getAttribute("Lang");if(null!=c&&c.trim().toUpperCase()==
EWA.LANG.trim().toUpperCase())return b[a]}return b[0]};this._GetSubValue=function(a,b,c){a=this._GetSubItem(a,c);return null==a?null:this.Xml.GetElementAttribute(a,b)};this.AddColumns=function(a,b,c,d,e,g,h,k){var l=$X("EWA_LF_"+this._Id);null==k&&(k=l.rows[0].cells.length);for(var m=0;m<a.length;m++)for(var n=a[m],p=k+m,t=0;t<l.rows.length;t++){var r=l.rows[t].insertCell(p);if(0==t)r.className="EWA_TD_H",r.innerHTML='<nobr cellIdx="'+p+'" id="'+n[b]+'">'+n[c]+"</nobr>",r.title=n[d],r.width=100;else{var q=
l.rows[t].getAttribute("EWA_KEY");r.className="EWA_TD_M";q=q+"_"+n[b];var v=this._GetAddControl(n[g]);null==v&&(v=e);var u=h.replace("[ID]",n[b]);v=0<=v.indexOf("<select")?v.replace("!!",u.replace("onblur=","onchange=")):v.replace("!!",u);r.innerHTML=v;r.childNodes[0].id=q}}};this._GetAddControl=function(a){if(null==a)return null;a=a.toUpperCase().trim();return"SELECT"==a?"<select !!></select>":"DATE"==a?'<input type=text class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,false);" readonly !!>':"TIME"==
a?'<input type=text class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,true);" readonly !!>':"STRING"==a||"NUMBER"==a?"<input type=text class=EWA_INPUT !!>":null};this.AddedValues=function(a,b,c,d,e){for(var g=0;g<a.length;g++){var h=a[g],k=$X(h[b]+"_"+h[c]);if(!k)break;var l=k.tagName.toUpperCase();"INPUT"==l||"SELECT"==l||"TEXTAREA"==l?k.value=h[d]:k.innerHTML=h[d];e&&(this.GetRow(k).getElementsByTagName("input")[0].checked=!0)}};this.AddRow=function(a){for(var b=$X("EWA_LF_"+this._Id),c=b.insertRow(-1),
d=0;d<b.rows[0].cells.length;d++){var e=c.insertCell(-1),g=b.rows[0].cells[d];e.className="EWA_TD_M";null!=a[d]&&(e.innerHTML=a[d]);e.style.display=g.style.display;e.id="ADD_ROW_"+g.childNodes[0].id}return c};this.Calc=function(a,b,c,d){for(var e=$X("EWA_LF_"+this._Id),g={},h=0;h<a.length;h++)g[a[h]]=0;for(h=b;h<c;h++)for(a=e.rows[h],b=0;b<a.cells.length;b++)if(null!=g[b]){var k=a.cells[b],l=k.getElementsByTagName("input");0<l.length?g[b]+=1*l[0].value:(k=GetInnerText(k),""==k&&(k=0),g[b]+=1*k)}c=
e.rows[d];for(h=0;h<c.cells.length;h++)null!=g[h]&&(k=Math.round(100*g[h])/100,d=GetInnerText(c.cells[h]),k!=1*d&&(this.IsCalcChanged=!0),c.cells[h].innerHTML=k.fm())};this.mergeHeaders=function(a,b,c){var d=$($X("EWA_LF_"+this._Id)),e=d.find('tr[ewa_tag="HEADER"]');if(0!=e.length&&(a=e.find('nobr[id="'+a+'"]').parent(),0!=a.length)){var g=d.find("tr[ewa_mearge]");0==g.length&&(g=$(d[0].insertRow(1)),g.attr("ewa_mearge","gdx"));d=-1;for(var h=0;h<e[0].cells.length;h++){var k=e[0].cells[h];k==a[0]&&
(d=h,k.colSpan=c);if(-1==d)"1"!=$(k).attr("ewa_tdmearged")&&(k.rowSpan=2);else if(d+c==h)d=-1,k.rowSpan=2;else{k.rowSpan=1;var l=g[0].insertCell(-1);l.innerHTML=k.innerHTML;l.className=k.className;l.style.cssText=k.style.cssText;k.style.display="none";$(k).attr("ewa_tdmearged",1)}k==a[0]&&(k.innerHTML=b,k.style.display="",k.style.width="")}}};this.MeargeHeader=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 mergeHeaders");this.mergeHeaders(a,b,c)};this.getUrlClass=function(){var a=
new EWA_UrlClass;a.SetUrl(this.Url);return a}}
...
{Id:"Month",Txt:"\u672c\u6708",TxtEn:"This Month"},{Id:"Today-EOM",Txt:"\u4eca\u5929\u81f3\u6708\u5e95",TxtEn:"Today-EOM"},{Id:"Quarter",Txt:"\u672c\u5b63\u5ea6",TxtEn:"This Quarter"},{Id:"Today-EOQ",Txt:"\u4eca\u5929\u81f3\u5b63\u672b",TxtEn:"Today-EOQ"},{Id:"Year",Txt:"\u672c\u5e74\u5ea6",TxtEn:"This Year"},{Id:"Today-EOY",Txt:"\u4eca\u5929\u81f3\u5e74\u5e95",TxtEn:"Today-EOY"}]};EWA.F.L={CUR:null,C:EWA_ListFrameClass};
...
var EWA_UT_TansAll={tall:function(a,b){this.idx=0;this._objs_ch=a;this._objs_en=b;this.start_trans()},start_trans:function(){idx<=this._objs_ch.length-1?(this.trans_item(ipts[this.idx]),this.idx++,setTimeout(bb,123)):setTimeout(this.post_server,1231)},trans_item:function(a,b){null==this.trans&&(this.trans=new EWA_UT_TRANS);if("string"==typeof a)var c=a;else{var d=a.tagName;null==d&&(d="");d=d.toUpperCase();"SELECT"==d||"INPUT"==d||"TEXTAREA"==d?(c=a.value,a.setAttribute("ewa_trans_end","no")):""!=
d?(a.setAttribute("ewa_trans_end","no"),c=func.innerHTML):(console.log("trans_err"),console.log(a))}this.trans.TransToEn(c,b)},post_server:function(){for(var a=[],b=[],c=0;c<ipts.length;c++){var d=ipts[c].parentNode.parentNode,e=d.cells[4].getElementsByTagName("span")[0];"ok"==e.getAttribute("ewa_trans_end")&&(a.push(GetInnerText(d.cells[0])),b.push(GetInnerText(e)))}if(0!=a.length){var g=new EWA_AjaxClass;g.AddParameter("ids",a.join("`"));g.AddParameter("vals",b.join("`"));g.AddParameter("EWA_ACTION",
"EXTENDACTION2");g.AddParameter("EWA_AJAX","JSON");g.PostNew(window.location.href,function(){g.IsRunEnd()&&alert("ok")})}}};
function EWA_TransClass(){this.bingAppId="50F7C8D4BC00A6E047C046D012F334DEC61FA003";this.bingTrans="//api.microsofttranslator.com/V2/Ajax.svc/Translate?appid="+this.bingAppId;this.youdaoTrans="//fanyi.youdao.com/openapi.do?keyfrom=wwwoneworldcc&key=1597375709&type=data&doctype=jsonp&version=1.1";this._Id=("EWA_UT_TRANS"+Math.random()).replace(".","_");window[this._Id]=this;this._Trans="bing";this._IDX=0;this.IsRun=!1;this.TransToEn=function(a,b){null==a||""==a.trim()?b instanceof Function&&b(null):
(this.IsRun=!0,"bing"==this._Trans?this._trans_bing(a,b,!0):"youdao"==this._Trans?this._trans_youdao(a,b):console.log("\u6ca1\u6709\u6307\u5b9a\u7ffb\u8bd1\u5f15\u64ce"))};this.TransToCn=function(a,b){null==a||""==a.trim()?b instanceof Function&&b(null):(this.IsRun=!0,"bing"==this._Trans?this._trans_bing(a,b,!1):"youdao"==this._Trans?this._trans_youdao(a,b):console.log("\u6ca1\u6709\u6307\u5b9a\u7ffb\u8bd1\u5f15\u64ce"))};this._trans_youdao=function(a,b){var c=this._get_func_name(),d=c+"AAAAA",e=
this.transback_youdao_tmp.toString().replace("transback_youdao_tmp",""),g=this._get_user_func_str(c,d);e=e.replace("{","{"+g);eval("window."+c+"="+e);window[d]=b;b=document.createElement("script");a=a.replace(/\n/ig,"[GDX]").replace(/\r/ig,"");a=this.youdaoTrans+"&callback="+c+"&q="+a.toURL();b.src=a;document.getElementsByTagName("head")[0].appendChild(b)};this._trans_bing=function(a,b,c){var d=this._get_func_name(),e=d+"AAAAA",g=this.transback_bing_tmp.toString().replace("trans_en_back_bing_tmp",
""),h=this._get_user_func_str(d,e);g=g.replace("{","{"+h);eval("window."+d+"="+g);window[e]=b;b=document.createElement("script");d=this.bingTrans+"&oncomplete="+d;d=c?d+("&from=zh-CHS&to=en&text="+a.toURL()):d+("&from=en&to=zh-CHS&text="+a.toURL());b.src=d;document.getElementsByTagName("head")[0].appendChild(b)};this._get_user_func_str=function(a,b){return"var fromClass=window['"+this._Id+"'];\n var func=window['"+b+"']; \n var _fname='"+a+"'; \n var _fname1='"+b+"'; \n "};this._get_func_name=function(){this._IDX++;
return"___GDX_T_"+this._IDX};this.transback_bing_tmp=function(a){try{fromClass.transBackCallCommon(a,func)}catch(b){console.log(b)}delete window[_fname1];delete window[_fname]};this.transback_youdao_tmp=function(a){try{if(a&&a.errorCode){console.log(a);func instanceof Function&&func("\u7ffb\u8bd1\u5f15\u64ce\u9519\u8bef");return}if(a&&a.translation&&0<a.translation.length)a=a.translation[0];else{func instanceof Function&&func(a);console.log(a);return}fromClass.transBackCallCommon(a,func)}catch(b){console.log(b)}delete window[_fname1];
delete window[_fname]};this.transBackCallCommon=function(a,b){this.IsRun=!1;if(null==b)console.log(a);else if(b instanceof Function)b(a);else{"string"==typeof b&&(b=$X(b));var c=b.tagName;null==c&&(c="");c=c.toUpperCase();if("SELECT"==c||"INPUT"==c||"TEXTAREA"==c){if(b.value=a,b.setAttribute("ewa_trans_end","ok"),null!=b.onblur)b.onblur()}else"DIV"==c||"SPAN"==c?"DIV"==c&&$(b).attr("EWA_DHTML")?($(b).find("iframe")[0].contentWindow.frames[0].document.body.innerHTML=a,$(b).find("input[type=hidden]")[0].value=
a):(b.setAttribute("ewa_trans_end","ok"),b.innerHTML=a):console.log(a)}}}EWA_UT_TRANS=EWA_TransClass;

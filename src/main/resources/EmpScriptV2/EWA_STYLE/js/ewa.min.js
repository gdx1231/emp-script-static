...
h.ewa_trigger_valid_name);w.AddParameter("ewa_ajax",h.ewa_trigger_valid);$J(w.GetUrl(),function(v){console.log(v);v.RST?(l.addClass("ewa-slider-puzzle-successful"),e&&e(v)):(l.addClass("ewa-slider-puzzle-fail"),setTimeout(function(){l.removeClass("ewa-slider-puzzle-fail");m.css("left","0px");n.css("left","10px");p.css("opacity","1");g&&g(v)},500))})})})}function b(l){var m=$(".ewa-slider-puzzle-imgbox"),n=$(".ewa-slider-puzzle-imgbox img");m.css("width",l.imgBigWidth).css("height",l.imgBigHeight);
n.length?n.attr("src",l.imgBig):m.prepend("<img src='"+l.imgBig+"' />");$(".ewa-slider-puzzle-verify").css("background-image","url('"+l.imgSmall+"')").css("top",l.imgTop).css("width",l.imgSmallWidth).css("height",l.imgSmallHeight)}var d=[];d.push('<div class="ewa-slider-puzzle-box">');d.push('<div class="ewa-slider-puzzle-imgbox">');d.push('<div class="ewa-slider-puzzle-verify"></div>');d.push('<div class="ewa-slider-puzzle-refresh"></div>');d.push("</div>");d.push('<div class="ewa-slider-puzzle-handle">');
d.push('<span class="ewa-slider-puzzle-swiper"></span>');d.push('<span class="ewa-slider-puzzle-text"></span>');d.push("</div>");d.push("</div>");var e,g,h,k=/iphone|android|ipad/ig.test(navigator.userAgent)||window.EWA_App;EWA.UI.SlidePuzzle=function(l,m,n,p){h=l;e=n;g=p;$(m||"body").append(d.join(""));m=$(".ewa-slider-puzzle-refresh");$(".ewa-slider-puzzle-box").css("width",l.imgBigWidth);b(l);m.click(function(q){q.stopPropagation();q=new EWA_UrlClass;q.AddParameter("ewa_trigger_valid_mode","refresh");
q.AddParameter("ewa_trigger_valid_name",h.ewa_trigger_valid_name);q.AddParameter("ewa_ajax",h.ewa_trigger_valid);q.AddParameter("ewa_trigger_valid_width",document.documentElement.clientWidth);$J(q,function(r){r.RST?(r.ewa_trigger_valid_name=h.ewa_trigger_valid_name,r.ewa_trigger_valid=h.ewa_trigger_valid,h=r,b(h)):alert(r.ERR)})});a()}})();"undefined"==typeof EWA&&(EWA={});

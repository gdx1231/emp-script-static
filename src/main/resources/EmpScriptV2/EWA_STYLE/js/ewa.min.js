...
1;this.zIndex=b._EWA_UI_DIALOG_COVERINDEX;var d=EWA$UI$COMMON.CreateObject(b,"div","display:none; ; width:"+this.Width+"; height:"+this.Height+"; z-index:"+this.zIndex+"; left:"+this.Left+"; top:"+this.Top+";",b.document.body);d.setAttribute("EWA_NAME","DIV_FRAME");d.className="ewa-dialog";d.id=a+"divFrame";this.Frame=d.id;var e=EWA$UI$COMMON.CreateObject(b,"div","position: absolute; width: 100%; height: 100%; left: 0px; top: 0px;",d);e.setAttribute("EWA_NAME","DIV_BACK1");e.id=a+"divBack1";this._FrameBack1=
e.id;if(null!=this.ShadowColor&&""!=this.ShadowColor){var g=EWA$UI$COMMON.CreateObject(b,"div","position: absolute; background-color:"+this.ShadowColor+"; width:100%; height:100%; left:"+this.Offset+"px; top: "+(1*this.Offset+2)+"px;",d);g.style.filter="alpha(opacity=50)";g.style.opacity=.5;g.id=a+"divBack2";this._FrameBack2=g.id}EWA.B.IE&&(e.innerHTML="<iframe src='javascript:false' style=\"position:absolute;top:0px;left:0px;width:100%; height:100%; z-index:-1; filter='progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)';\"></iframe>",
...
this.DoPostBefore();if(d instanceof Array){var e=this;this._checkStatusInc=0;this._checkStatusFristResult=d;this._checkStatusTimer=window.setInterval(function(){var n=0==e._checkStatusInc?e._checkStatusFristResult:e.DoPostBefore();e._checkStatusInc++;null!=n[0]&&(window.clearInterval(e._checkStatusTimer),e._checkStatusTimer=null,e._checkStatusInc=null,e._checkStatusFristResult=null,0==n[0]?n[2]?$Confirm(n[1],n[1],function(){n[0]=n[1]=null;e.DoPost(a,b,!0)},function(){}):$Tip(n[1]):(n[0]=n[1]=null,
e.DoPost(a,b,!0)))},232);return}if(!d)return}var g=$(a).find("input[ewa_tag=ht5upload]");if(!(0<g.length)||this.uploadProcess||this.CheckValidAll(a)){var h=0;e=this;for(d=0;d<g.length>0;d++){var k=g[d];this._uploadingFileCheck(k)&&h++}if(0<h)setTimeout(function(){e.DoPost(a,b)},700);else{g=$(a).find("input[ewa_tag=ht5takephoto]");if(0<g.length&&!this.uploadProcess&&!this.CheckValidAll(a))return!1;for(d=0;d<g.length>0;d++){k=g[d];h=!1;k=window["h5takephoto_"+this._Id+"$"+k.id];if("ok"!=k.UPLOAD_STATUS){if(!$X(k.H5_UPLOAD.WAIT_ID)){try{k.submitUpload()}catch(n){console.log("ht5takephotos - ht5.submitUpload: "+

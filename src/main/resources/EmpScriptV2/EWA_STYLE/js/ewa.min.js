...
!1;if(b.tagName=="IFRAME"){c=!0;var d=b.contentWindow;d&&d.document&&d.document.body&&(d=d.document.getElementById("Test1"))&&(b=d)}d=this.GetFrameContent().parentNode.parentNode.parentNode;var e=$(d).css("border-left-width").replace("px","")*1+$(d).css("border-right-width").replace("px","")*1;var g=$(d).css("border-top-width").replace("px","")*1+$(d).css("border-bottom-width").replace("px","")*1;this._calc_frame_table=e;d=$(b).width();d+=e;b=$(b).height()+g;e=a.style.left.replace("px","")*1;a=a.style.top.replace("px",
"")*1;d+e>this.CreateWindow.document.body.clientWidth&&this.Move(this.CreateWindow.document.body.clientWidth-d-20,a);this._IsHeightCapped=!1;a=EWA.UI.Utils.GetDocSize(this.CreateWindow).H-10;this.IsShowTitle&&(a-=$(this.GetFrameTitle()).parent().height());b>a&&(b=a,this._IsHeightCapped=!0);c?this.GetFrameContent().style.overflow="hidden":this.GetFrameContent().style.overflow=this._IsHeightCapped?"auto":"";this.Resize(d,b,!0)};this.Resize=function(a,b,c){if(this.IsShowTitle){var d=this.GetFrameTitle();
b+=$(d).parent().height()}var e=d=0;c||(c=this.GetFrameContent().parentNode.parentNode.parentNode,this._calc_frame_table=d=$(c).css("border-left-width").replace("px","")*1+$(c).css("border-right-width").replace("px","")*1,e=$(c).css("border-top-width").replace("px","")*1+$(c).css("border-bottom-width").replace("px","")*1);a+=d;b+=e;c=this.GetFrame();c.style.width=a+"px";c.style.height=b+"px";for(d=0;d<c.childNodes.length;d+=1)e=c.childNodes[d],e.style.width=a+"px",e.style.height=b+"px",e.id.indexOf("divContent")>
0&&(e.style.overflow="hidden");this.GetFrameContent();a=this.GetObject(this._DivCover);$(a).css("background-image","none");$(a).attr("background-image","none")};this.Show=function(a){var b=this.GetFrame();a?(b.style.display="",this.IsShowTitle&&this.AutoSize&&(_EWA_DIALOG_ON_TIMER=this,this.TimerHandle=window.setInterval(function(){var c=_EWA_DIALOG_ON_TIMER;window.clearInterval(c.TimerHandle);var d=c.GetFrame(),e=c.GetFrameContent(),g=e.childNodes[0].offsetWidth,h=c.GetObject(c._FrameFore).offsetHeight;
d.style.width=g+"px";d.style.height=h+"px";c.GetObject(c._FrameBack1)&&(c.GetObject(c._FrameBack1).style.width=g+"px",c.GetObject(c._FrameBack1).style.height=h+"px");c.GetObject(c._FrameBack2)&&(c.GetObject(c._FrameBack2).style.width=g+"px",c.GetObject(c._FrameBack2).style.height=h+3+"px");if(c=e.childNodes[0])c.style.width=g-2+"px",c.style.height=h-2+"px";c=_EWA_DIALOG_ON_TIMER=null;g=c.GetObject(this._DivCover);$(g).css("background-image","none");$(g).attr("background-image","none")},32))):b.style.display=
"none";b=oCover=null};this.Dispose=function(){this.CreateWindow&&(this.CreateWindow._EWA_DIALOGS[this._CreateWindowIndex]=null,_EWA_DIALOGS[this._WindowIndex]=null,this._DivCover!=null&&(EWA$UI$COMMON.Drop(this.GetObject(this._DivCover)),this._DivCover=null),this.GetObject(this.Frame).innerHTML="",EWA$UI$COMMON.Drop(this.GetObject(this.Frame)),this.CreateWindow=null,EWA.B.IE&&CollectGarbage())};this.SetZIndex=function(a){this.CreateWindow._EWA_UI_DIALOG_COVERINDEX+=a;this.zIndex=this.CreateWindow._EWA_UI_DIALOG_COVERINDEX;
this.GetObject(this.Frame).style.zIndex=this.zIndex};this.CreateId=function(){var a=Math.random();return(new Date).getTime()+"_"+a};this.Create=function(){this.CreateWindow==null&&(this.CreateWindow=window);this.IsCover&&this._CreateCover();var a=this.CreateId(),b=this.CreateWindow;b._EWA_UI_DIALOG_COVERINDEX==null&&(b._EWA_UI_DIALOG_COVERINDEX=0);b._EWA_UI_DIALOG_COVERINDEX+=1;this.zIndex=b._EWA_UI_DIALOG_COVERINDEX;this._IsFixed=b.EWA_UI_DIALOG_FIXED||window.EWA_UI_DIALOG_FIXED?!0:!1;var c=EWA$UI$COMMON.CreateObject(b,
"div","display:none; "+(this._IsFixed?"position:fixed":"position:absolute")+"; width:"+this.Width+"; height:"+this.Height+"; z-index:"+this.zIndex+"; left:"+this.Left+"; top:"+this.Top+";",b.document.body);c.setAttribute("EWA_NAME","DIV_FRAME");c.className="ewa-dialog";c.id=a+"divFrame";this.Frame=c.id;var d=EWA$UI$COMMON.CreateObject(b,"div","position: absolute; width: 100%; height: 100%; left: 0px; top: 0px;",c);d.setAttribute("EWA_NAME","DIV_BACK1");d.id=a+"divBack1";this._FrameBack1=d.id;if(this.ShadowColor!=
null&&this.ShadowColor!=""){var e=EWA$UI$COMMON.CreateObject(b,"div","position: absolute; background-color:"+this.ShadowColor+"; width:100%; height:100%; left:"+this.Offset+"px; top: "+(this.Offset*1+2)+"px;",c);e.style.filter="alpha(opacity=50)";e.style.opacity=.5;e.id=a+"divBack2";this._FrameBack2=e.id}EWA.B.IE&&(d.innerHTML="<iframe src='javascript:false' style=\"position:absolute;top:0px;left:0px;width:100%; height:100%; z-index:-1; filter='progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)';\"></iframe>",
...
c||__Dialog._SetTextAreaFocus(b.document);c||b.document.body.focus();__Dialog._SetClose(b.document);b.document.body.style.margin="0px";b.document.body.style.overflow="hidden";a._Dialog.ResizeByContent();a._Dialog._IsHeightCapped&&!b.document.body.querySelector(".ewa-in-dialog")&&(b.document.body.style.overflow="auto");a.MoveCenter();a._CallBack!=null&&a._CallBack.Run();b=null}},_SetClose:function(a){for(var b=a.getElementsByTagName("INPUT"),c=0;c<b.length;c+=1){var d=b[c].type.toLowerCase();d!="button"&&
d!="submit"||__Dialog._SetCloseFunction(b[c])}b=a.getElementsByTagName("BUTTON");for(c=0;c<b.length;c++)__Dialog._SetCloseFunction(b[c])},_SetCloseFunction:function(a){var b=a.value.trim().toLowerCase();a.tagName.toLowerCase()=="button"&&(b=a.innerHTML);!(b.indexOf("\u5173\u95ed")>=0||b.indexOf("\u53d6\u6d88")>=0||b.indexOf("close")>=0||b.indexOf("cancel")>=0)||a.onclick!=null&&a.onclick.toString().indexOf("EWA")>=0||(a.onclick=function(){var c=this.ownerDocument;(c.parentWindow?c.parentWindow:c.defaultView)._EWA_DialogWnd.CloseWindow()})},
_SetInputFocus:function(a){a=a.getElementsByTagName("INPUT");for(var b=0;b<a.length;b+=1){var c=a[b],d=c.type.toLowerCase();if(d=="text"||d=="password")if(d=c.parentNode.innerHTML,!(d!=null&&d.toString().indexOf("EWA.F.I.Date")>=0))try{return c.focus(),a=null,!0}catch(e){}}return!1},_SetTextAreaFocus:function(a){a=a.getElementsByTagName("TEXTAREA");for(var b=0;b<a.length;b+=1)try{return a[b].focus(),a=null,!0}catch(c){}return!1},OpenReloadClose:function(a,b,c,d,e,g,h){EWA.UI.Dialog.OpenFrame(a,b,
c,d,e,"RELOAD_PARENT,CLOSE_SELF",g,h)},OpenReload:function(a,b,c,d,e,g,h){EWA.UI.Dialog.OpenFrame(a,b,c,d,e,"RELOAD_PARENT",g,h)},OpenReloadClear:function(a,b,c,d,e,g,h){EWA.UI.Dialog.OpenFrame(a,b,c,d,e,"RELOAD_PARENT,CLEAR_SELF",g,h)},OpenFrame:function(a,b,c,d,e,g,h,k){g==null&&(g="");__Dialog[a]||(__Dialog[a]={});__Dialog[a].AfterMsg=h==null?"":h;if(k=="yes"&&EWA.F&&EWA.F.FOS[a]&&EWA.F.FOS[a].Url){k=new EWA_UrlClass(EWA.F.FOS[a].Url);k.RemoveEwa();e=new EWA_UrlClass("a1?"+e);for(var l in e._Paras)h=
e.GetParameter(l),k.AddParameter(l,h);e=k.GetParas()}g="EWA_P_BEHAVIOR="+g+"&EWA_PARENT_FRAME="+a;a=EWA.UI.Dialog.GetUrl(b,c,e?e+"&"+g:g);EWA.UI.Dialog.OpenWindow(a,b+"-"+c,100,50,d)},OpenWindow:function(a,b,c,d,e,g,h,k){var l=k===void 0?!0:k;var m=e?window:EWA.UI.Dialog._GetTopWindow();e=a;e!=null&&e!="about:blank"&&(e=a.indexOf("?")>0?e+("&_r="+Math.random()):e+("?_r="+Math.random()));e=e.replace(/\|/ig,"%7c");a="_EWA_UI_DIALOG_"+b;EWA.UI.Dialog.WND[a]=null;EWA.UI.Dialog.WND[a]=new EWA.UI.Dialog.C(m,
l);l=EWA.UI.Dialog.WND[a];l.Id=a;l.DisposeOnClose=k;l.Create(c,d,b);e!=null&&l.SetUrl(e);g!=null&&l.SetCallBack(g);h!=null&&l.SetReturnBack(h);__Dialog.TimerInc=0;l._TimerHandle=window.setInterval(EWA.UI.Dialog._DialogMointer,155);l._IncNoIe=0;EWA.UI.Dialog.WNDCUR=l;return EWA.UI.Dialog.WND[a]},GetUrl:function(a,b,c){return EWA.CP+"/EWA_STYLE/cgi-bin/?XMLNAME="+a.toURL()+"&ITEMNAME="+b.toURL()+"&"+c}};

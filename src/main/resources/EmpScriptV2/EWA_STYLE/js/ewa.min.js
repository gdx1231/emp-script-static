...
c=410<c?400:300<c?c-10:300;var d=this._CreateHtml(c);this._Dialog=$DialogHtml(d,this._Caption,c);this._Dialog._ParentWindow=window;var e=this;$(this._Dialog.getContent()).find("button[_ewa_dialog_]").on("click",function(){$(this).attr("_ewa_dialog_",e._Dialog.Id);$(this).attr("evt")?e.fire($(this).attr("evt")):e.Hidden()});this._Dialog.AutoSize()};this._CreateHtml=function(c){var d=[];d.push("<table border=0 class='MSG_INFO' style='width: "+c+"px'>");d.push("<tr><td rowspan=2 style='width:130px;' align='center'>");
d.push("<div class='"+this._Icon+"'>&nbsp;</div></td>");d.push("<td class='MSG_TEXT'>");d.push(this._Msg);d.push("</td></tr>");d.push("<tr><td class='MSG_BUTS'>");if(0<this._Buttons.length){d.push("<hr><table><tr>");for(c=0;c<this._Buttons.length;c++){var e=this._Buttons[c];d.push("<td>");var g="<button _ewa_msg_default='"+(e.Default?1:0)+"'  type='button' _ewa_dialog_='[~ID~]' ";g=e.Event&&"function"==typeof e.Event?g+(" evt='"+c+"'>"+e.Text+"</button>"):g+(">"+e.Text+"</button>");d.push(g);d.push("</td>")}d.push("</tr></table>")}d.push("</td></tr></table>");
return d.join("")};this.fire=function(c){if((c=this._Buttons[c])&&c.Event)try{c.Event(this)}catch(d){console.log(d)}this.Hidden()};this.Show=function(c,d){null==this._Dialog&&this._Init();if(c)if(c=this._Dialog._ParentWindow.document.getElementsByTagName("button"),d){var e=[];for(d=0;d<c.length;d++){var g=$(c[d]);g.attr("_ewa_dialog_")==this._Dialog.Id&&(g.prop("disabled",!0),e.push(g))}setTimeout(function(){for(var h in e)e[h].prop("disabled",!1)},435)}else for(this._Dialog.AutoSize(),d=0;d<c.length;d++)if(1==
c[d].getAttribute("_ewa_msg_default")&&c[d].getAttribute("_ewa_dialog_")==this._Dialog.Id){c[d].focus();break}};this.Hidden=function(){this._Dialog.Close()}}
...
$Mark=function(a,b){var c=1E3*b||3E3,d="<div class='ewa-mark' style='transition-duration:"+(b||3)+"s;'></div>";$(a).each(function(){var e=$(d),g=$(this).offset();g={left:g.left+2,top:g.top-2,width:$(this).outerWidth(),height:$(this).outerHeight()};e.css(g);$("body").append(e);setTimeout(function(){e.css("opacity",0)},10);setTimeout(function(){e.remove()},c+10)})};$Confirm=EWA.UI.Msg.Confirm;$Tip=EWA.UI.Msg.Tip;$TipBR=EWA.UI.Msg.TipBR;$TipBL=EWA.UI.Msg.TipBL;$TipTR=EWA.UI.Msg.TipTR;$TipTL=EWA.UI.Msg.TipTL;
...
1;d++){var e=a[d];""!==e&&c.push(e)}c.push(b);return c.join("/")}};
...
$(this).text();"ALL"!=w&&$(this).attr("ids",k[w].join(","));$(this).on("click",function(){if("ALL"==$(this).text())$(a).find("nobr.ewa-filter-chk").show();else{var y=$(this).attr("ids").split(","),z={},A;for(A in y)z[y[A]]=1;$(a).find("input.ewa-filter-chkbox").each(function(){this.checked||z[this.id]?$(this).parent().show():$(this).parent().hide()})}})})}};this.hiddenNoContentRow=function(){var a=this.getObj();this.getObj(".EWA_TD_M").each(function(){if(""==$(this).text()&&0==$(this).find("img,a,input[type=text],input[type=button],textarea").length){$(this).parent().hide();
...
this.ItemList.Items[a.toUpperCase()])&&a.getElementsByTagName("IsMustInput")[0].getElementsByTagName("Set")[0].setAttribute("IsMustInput",1)};this.RedrawCreateSpans=function(){for(var a=this.getObj("tr"),b=0;b<a.length;b++){var c=a[b];if("none"!=c.style.display)for(var d=0,e=!1,g=c.cells.length-1;0<=g;g--){var h=c.cells[g];"none"==h.style.display?e?d++:(d=1,e=!0):e&&(h.colSpan=d+1,e=!1)}}EWA_FrameShowAlert=EWA_FrameShowAlert1;EWA_FrameRemoveAlert=EWA_FrameRemoveAlert1;this.getObj(".ewa_d1").each(function(){this.title=
this.innerHTML});for(var k in this.ItemList.Items)a=this.GetItemDescription(k).Memo,null!=a&&0<a.trim().length&&(this.getObj("#"+k).attr("placeHolder",a),this.getObj("#"+k).attr("title",a));this.RedrawChangWidth()};this.GetItemDescription=function(a){return this.ItemList.GetDescription(a)};this.ShowPlaceHolder=function(a){this.getObj().addClass("ewa-frame-cols-"+a);for(var b in this.ItemList.Items){var c=this.ItemList.GetValue(b,"Name","Name");if(c=this.GetObject(c)){c=$(c);var d=this.GetItemDescription(b),
e=d.Memo;d=d.Info;var g=null;1==a?(g=d,null!=e&&0<e.trim().length&&e!=g&&(g="smsValid"==c.attr("ewa_tag")?e:g+(", "+e)),c.hasClass("ewa-switch")&&c.prepend("<div class='ewa-switch-info'>"+g+"</div>")):2==a&&null!=e&&0<e.trim().length&&(g=e);g&&("hidden"==c[0].type?c.prev().attr("placeholder",g):"SELECT"==c[0].tagName?0<c[0].options.length&&""==c[0].options[0].value&&(c[0].options[0].text="-- "+g+" --",c[0].options[0].value=""):(c.attr("placeHolder",g),c.attr("title",g)))}}};this.RedrawChangWidth=
function(){var a=this.getObj(),b=a.width(),c=a.find(".ewa_msg_box")[0].colSpan/2;$("#EWA_FRAME_"+this._Id+">tbody>tr[class*='ewa-row-']:not('.ewa-row-msg-box')").each(function(){var e=$(this).find("td.ewa_redraw_info:visible").length,g=(b-90*e)/c;$(this).find("td.ewa_redraw_ctl:visible").each(function(){var h=this.colSpan||1;$(this).css("width",g*h)})});var d=this;addEvent(window,"size",function(){d.RedrawChangWidth()})};this.Mearge=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff1a\u8bf7\u7528 Merge");
this.Merge(a,b,c)};this.Merge=function(a,b,c){if(a||b){var d=this.getObj(),e=d.find("#"+a),g=d.find("#"+b);if(0==e.length)console.log("Mearge:"+a+"\u4e0d\u5b58\u5728");else if(0==g.length)console.log("Mearge:"+b+"\u4e0d\u5b58\u5728");else{var h=!1,k=d.find(".ewa-row-"+b+" .EWA_TD_M"),l=null;0==k.length&&(h=!0,k=d.find(".ewa-row-"+b+" .EWA_TD_1"),l=d.find(".ewa-row-"+b+" .EWA_TD"),1==l.length&&(h=!0),b=l.html(),l.html("<table cellpadding=0 cellspacing=0 width=100%><tr><td style='width:50%'></td><td style='display:none'></td><td style='width:50%'></td></tr></table>"),
...
g=[],h=b;b={};for(var k=this.getObj(),l=0;l<e.length;l++){var m=e[l];g.push(m);var n=m.replace("@@","");h=h.replace(m,"<span class='ewa-row-merge ewa-row-merge-"+n+"' mid=\""+m+'"></span>');n!=a&&k.find(".ewa-row-"+n).hide();b[n]=this.GetItemDescription(n).Info}e=document.createElement("div");e.style.display="none";e.innerHTML=h;document.body.appendChild(e);m=k.find('[id="'+a+'"]');if(0==m.length)console.log("not find "+a);else{a=m.parent();for(var p in g)l=g[p],m=l.replace("@@",""),h=k.find('[id="'+
m+'"]'),0==h.length?console.log("not found [id="+m+"]"):(l=$(e).find('span[mid="'+l+'"]'),"placeholder"==c?h.attr("placeholder",b[m]):c&&(l.append("<span class='ewa-row-merge-memo'></span>"),l.find(".ewa-row-merge-memo").text(b[m])),l.append(h));for(;0<e.childNodes.length;)a.append(e.childNodes[0]);$(e).remove();d&&d(a)}}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MergeItems=function(){for(var a in this.MeargeMap){var b=this.MeargeMap[a],c=$X("_ewa_tr$"+a);if(c){for(var d=c.cells.length,
e=$(c.cells[0]);1<c.cells.length;)e.append(c.cells[1].innerHTML),c.removeChild(c.cells[1]);c.cells[0].colSpan=d;c=[];for(d=0;d<b.length;d++){for(var g=$X("_ewa_tr$"+b[d]),h=["<nobr>"],k=0;k<g.cells.length;k++)h.push(g.cells[k].innerHTML);h.push("</nobr>");c.push(h.join(" "));g.parentNode.removeChild(g)}e.append(c.join(" "))}}};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.DoAction=function(a,b,c,d,e,g){EWA.F.CID=this._Id;if(null!=b&&""!=b.trim()){if(null!=
c&&0<c.trim().length)if(a=_EWA_INFO_MSG[c],null!=a&&""!=a){if(!window.confirm(a))return}else if(!window.confirm(c))return;this.DoPostBefore();this._Ajax=this.CreateAjax(null,!0);this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.AddParameter("EWA_ACTION_TIP",d);null!=g&&0<g.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",g),this.StopAjaxAfterReload=
!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=!1;if(null!=e&&0<e.length)for(b=0;b<e.length;b+=1)this._Ajax.AddParameter(e[b].Name,e[b].Value);e=new EWA.C.Url;e.SetUrl(this.Url);e=e.RemoveParameter("EWA_ACTION");this._Ajax.PostNew(e,EWA.F.FOS[EWA.F.CID]._CallBackJs)}};this.GuideShowCreate=function(a){this._GroupInfos=a;var b=$X("EWA_FRAME_"+this._Id);a=a.length-1;b.setAttribute("EWA_GUIDE_IDX","0");b.setAttribute("EWA_GUIDE_IDX_MAX",a);b.rows[b.rows.length-1].style.display=
...
this._InitTriggerValids()};this._InitTriggerValids=function(){var a=this.getObj(),b="EWA.F.FOS['"+this._Id+"'].callTriggerValid(this)";this.triggerValids={};for(var c in this.ItemList.Items){var d=this.ItemList.Items[c],e=this.ItemList.GetItemValue(d,"Name","Name"),g=$(d).find("DataItem Set[TriggerValid]").attr("TriggerValid");if(g){this.triggerValids[e]=null;var h=a.find("#"+e);0===h.length&&contine;h.attr("ewa_trigger_valid",g);d=$(d).find("Tag Set").attr("Tag");if("submit"==d)break;if("smsValid"==
d){h=a.find(".ewa-row-"+e+" .ewa-sms-valid-code-button");d=h.attr("id");d||(d=EWA_Utils.tempId(),h.attr("id",d));var k=$("<a style='position:absolute;left:0;top:0;right:0;bottom:0'></a>");k.attr("ewa_trigger_valid",g);k.attr("ewa_trigger_valid_rid",e);k.attr("ewa_trigger_valid_click_id",d);h.parent().css("position","relative").append(k);h=k}(e=h.attr("onclick"))&&h.attr("_onclick",e);h.attr("onclick",b)}}};this.callTriggerValidBefore=function(a){return!0};this.callTriggerValid=function(a){if(this.callTriggerValidBefore(a)){var b=
this.getObj(),c=$(a),d=c.attr("id");d||(d=c.attr("ewa_trigger_valid_rid"));var e=this.getUrlClass(),g=c.attr("ewa_trigger_valid");e.AddParameter("ewa_ajax",g);e.AddParameter("ewa_trigger_valid_name",d);e.AddParameter("ewa_trigger_valid_mode","create");e.AddParameter("ewa_trigger_valid_width",document.documentElement.clientWidth);var h=this,k=EWA_Utils.tempId();$J(e.GetUrl(),function(l){if(l.RST){c.attr("_trigger_valid_id",k);var m=top.$DialogHtml("<div id='"+k+"'></div>","enus"==EWA.LANG?"Silde puzzle":
"\u62fc\u56fe\u9a8c\u8bc1",l.bigImgWidth+20,200,!1);l.ewa_trigger_valid_name=d;l.ewa_trigger_valid=g;l.ewa_url=e.GetUrl();EWA.UI.SlidePuzzle(l,top.$("#"+k),function(n){console.log("2. puzzle cb true");var p=!1;c.attr("_onclick")&&(c.attr("onclick",$(a).attr("_onclick")),p=!0);setTimeout(function(){$(m.getMain()).animate({opacity:0},500)},500);setTimeout(function(){var r=c.attr("type");h.triggerValids[d]=n.VALID;var q=$(a).attr("ewa_trigger_valid_click_id");q?(c.remove(),console.log(q+".click"),b.find("#"+
q).click()):p?(console.log("3. puzzle click"),c.click()):"submit"==r&&console.log("3. puzzle submit");m.Close()},1E3)});setTimeout(function(){m.AutoSize()},100)}else alert(l.ERR)})}};this._InitMustInputs=function(){var a=this.getObj(),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name");0<$(c).find('IsMustInput Set[IsMustInput="1"]').length&&(c="#"+d,a.find(".ewa-row-"+d).addClass("ewa-row-must"),d=a.find(c),d.addClass("ewa-row-item-must"),0<d.length&&
d.attr("type")&&"hidden"==d.attr("type").toLowerCase()&&d.prev().addClass("ewa-row-item-must"))}};this._InitEncyptions=function(){var a=this.getObj(),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name");c=$(c).find("DispEnc Set");if(0!=c.length&&(d=a.find("#"+d),0!=d.length&&c.attr("EncType"))){if("INPUT"==d[0].tagName||"TEXTAREA"==d[0].tagName){if(!d.val())continue;d.prop("disabled",!0);d.attr("ewa_encyrption","yes")}var e=$("<div class='ewa-enc-cover' style='position:absolute;left:0;top:0;width:100%;height:100%;'><div></div></div>");
d.parent().append(e);d.parent().css("position","relative");if(c=c.attr("EncShowUrl")){e.find("div").html("\u70b9\u51fb\u67e5\u770b").css({position:"absolute",height:30,"line-height":"30px",top:"50%","margin-top":"-15px",right:10,"text-align":"right"});c=new EWA_UrlClass(c);e=new EWA_UrlClass(this.Url);for(var g in e._Paras)if(!c.GetParameter(g)){var h=e._Paras[g];null!=h&&(h=h.unURL());c.AddParameter(g,h)}c.AddParameter("EWA_ENCY_FROM_ID",d.attr("id"));c=c.GetUrl();d.parent().attr("enc_url",c).attr("fid",
d.attr("id"));d.parent().on("click",function(){if(!$(this).attr("enc_ok")){var k=$(this).attr("t")||100,l=(new Date).getTime();if(!(400>l-k)){$(this).attr("t",l);k=$(this).attr("enc_url");var m=$(this).find("#"+$(this).attr("fid"));$J(k,function(n){n.RST?(m.prop("disabled",!1),m.removeAttr("ewa_encyrption"),m.val(n.VALUE),$(m).parent().find(".ewa-enc-cover").remove(),$(m).parent().attr("enc_ok","1")):(n.ERR||n.MSG)&&$Tip(n.ERR||n.MSG)})}}})}}}};this._InitTranslations=function(){var a="EWA.F.FOS[&quot;"+
...
" .ewa-row-"+d+" .EWA_TD_L");0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+d+" .EWA_TD"));0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" #"+d).parent().prev().find(".ewa_d1"));0==e.length&&(e=$("#EWA_FRAME_"+this._Id+" #"+d).parent(),e.css("position","relative"),c.addClass("ewa-but-trans-float"));e.append(c)}}};this._Trans=function(a){if(a){var b=$(a).attr("_transf"),c=$(a).attr("_transp");a=$(a).attr("_transt");b=$("#EWA_FRAME_"+this._Id+" #"+b);a=$("#EWA_FRAME_"+this._Id+" #"+a);if(0==b.length||
...
!0}).on("compositionend",function(){c._droplist_[b.id]._is_composition=!1;EWA.F.I.DropList(this)}).removeAttr("oninput").removeAttr("onkeyup").on("input",function(){c._droplist_[b.id]._is_composition||EWA.F.I.DropList(this)})}};this._GetDropListValue=function(){var a=this.getObj();if(0!=a.length){a=a[0];var b=a.getElementsByTagName("input");this._droplist_={};for(var c=0;c<b.length;c++){var d=b[c];if("droplist"==d.getAttribute("ewa_class")){var e=d.nextSibling;"INPUT"==e.tagName.toUpperCase()&&"HIDDEN"==
e.type.toUpperCase()&&(this._GetDropListValue1(d,e),this._bindCompostion(d,e))}}a=a.getElementsByTagName("select");for(c=0;c<a.length;c++)if(d=a[c],b=d.getAttribute("_ListFilterType"))e=d.getAttribute("_ListFilterField"),this.initSelectFilter(d.id,b,e);this._SelectFilters&&this._checkSelectOptionsChange()}};this.refreshDropList=function(a,b){var c=this.getObj('input[id="'+a+'"]');if(0==c.length)console.warn("Can not found id="+a);else{var d=c.prev();0==d.length?console.warn("Can not found  id="+a+
" prev"):"droplist"==d.attr("ewa_class")?(c.val(b),this._GetDropListValue1(d[0],c[0])):console.warn("Not droplist id="+a+" prev")}};this._GetDropListValue1=function(a,b){if(""==b.value)b.setAttribute("setvalue",1);else{var c=b.getAttribute("DlsShow");if(null==c||""==c)b.setAttribute("canopen",0),a.value=obj1.value,b.setAttribute("canopen",1);else{var d=b.getAttribute("xmlName"),e=b.getAttribute("itemName"),g=b.getAttribute("paraName"),h=b.getAttribute("DlsAction"),k=b.value;var l=this.EWA_CGI?this.EWA_CGI:
window.EWA_CGI?window.EWA_CGI:EWA.CP+"/EWA_STYLE/cgi-bin/";var m=-1==l.indexOf("?")?"?":"&";l=(l+(m+"XMLNAME="+d+"&ITEMNAME="+e+"&EWA_AJAX=JSON")).replace("//","/");l=l.replace("//","/");l=l.replace("//","/");d={};d[g]=k;null!=h&&0<h.trim().length&&(d.EWA_ACTION=h,d[b.id]=b.value);$JP(l,d,function(n){if(0!=n.length){var p=n[0],r=[];n={};for(var q in p)r.push(p[q]),n["@"+q.toUpperCase()]=p[q],p[q]&&b.setAttribute("para_"+q.toLowerCase(),p[q]);if(null==c||""==c)n=r.join("/");else{q=c.match(/@[a-zA-Z0-9\-\._:]*\b/ig);
...
this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");for(var a=document.getElementsByTagName("input"),b=0;b<a.length;b+=1){var c=a[b],d=""==c.name?c.id:c.name;null!=d&&""!=d&&this._Ajax.AddParameter(d,c.value)}a=document.getElementsByTagName("select");for(b=0;b<a.length;b+=1)c=a[b],d=""==c.name?c.id:c.name,null!=d&&""!=d&&this._Ajax.AddParameter(d,c.value);a=document.getElementsByTagName("textarea");for(b=0;b<a.length;b+=1)c=
a[b],d=""==c.name?c.id:c.name,null!=d&&""!=d&&this._Ajax.AddParameter(d,c.value);this._Ajax.PostNew(this.Url,EWA.F.F.CUR._CallBack)}};this.createAjax=this.CreateAjax=function(a,b){EWA.F.F.CUR=this;null==a&&(a=$("#f_"+this._Id)[0]);if(!b&&!this.CheckValidAll(a))return null;a=new EWA.C.Ajax;b=this.CreatePostData();for(var c in b)a.AddParameter(c,b[c]);return a};this.createPostData=this.CreatePostData=function(a){a=a||$("#f_"+this._Id)[0];var b={},c;for(c in this.ItemList.Items){var d=this.ItemList.GetItemValue(this.ItemList.Items[c],
"Name","Name"),e=this.GetObject(d,a);if(null!=e&&!$(e).attr("ewa_encyrption")){var g=e.getAttribute("ewa_tag");if("signature"==g){var h="N";var k=this.tablets[c];for(var l=0;l<k.lines.length;l++)if(k.lines[l]){h="Y";break}k="Y"==h?this._GetObjectValue(e):"";b[d+"_CHANGED"]=h}else k=this._GetObjectValue(e);null!=k&&(b[d]=k);"DIV"==e.tagName.toUpperCase()&&"1"==e.getAttribute("EWA_DHTML")&&(h=$X("UP_IMG_"+d).value,b[d+"_imgs_split"]=h);if("swffile"==g||"IMG_UPLOAD"==g)if(d=e.getAttribute("UP_PARAS"),
null!=d&&0<d.length)for(d=d.split(","),g=0;g<d.length;g++){var m=d[g];b[m]=e.getAttribute(m)}else b.UP_URL=e.value;else"markdown"==g&&(e=e.parentNode.getElementsByTagName("textarea"),1<e.length&&(b[e[1].id]=e[1].value))}}if(this.PostAddData)for(m in this.PostAddData)b[m]=this.PostAddData[m];if(this.triggerValids)for(var n in this.triggerValids)b[n+"_TRIGGER_VALID_RESULT"]=this.triggerValids[n];return b};this.DoPostBefore=function(){return!0};this.isDoPostBeforeTimer=function(){return null!=this._checkStatusFristResult};
this._uploadingFileCheck=function(a){a=window["h5u_"+this._Id+"$"+a.id];if(!a.haveFile())return!1;if("ok"==a.UPLOAD_STATUS)return a.removeWaitBox(),this.uploadProcess=!1;if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;if("error"==a.UPLOAD_STATUS||"abort"==a.UPLOAD_STATUS)return this._stopPost=!0,this._stopPostError="enus"==EWA.LANG?"Upload file error or aborted":"\u4e0a\u4f20\u6587\u4ef6\u9519\u8bef\u6216\u88ab\u4e2d\u6b62",console.log(this._stopPostError),!1;if("start"==
a.UPLOAD_STATUS||"checking"==a.UPLOAD_STATUS)return!0;a.submitUploads();if("nofile"==a.UPLOAD_STATUS)return this.uploadProcess=!1,a.removeWaitBox(),!1;$X(a.WAIT_ID)||a.createWaitBox();return this.uploadProcess=!0};this._checkTriggerValids=function(){if(!this.triggerValids)return!0;var a=this.getObj();for(b in this.triggerValids)if(!this.triggerValids[b]){a=a.find("#"+b);if(0<a.length&&"submit"==a[0].type){var b=a.attr("_trigger_valid_inc")?1*a.attr("_trigger_valid_inc"):0;if(0==b)this.callTriggerValid(a);
else{var c=a.attr("_trigger_valid_id");if(!c)return!1;if(0==top.$("#"+c).length)return this._cancelPostWait=!0,a.removeAttr("_trigger_valid_inc"),a.removeAttr("_trigger_valid_id"),console.log("\u7a97\u53e3\u4e0d\u89c1\u4e86\uff0c\u53d6\u6d88\u63d0\u4ea4\u7b49\u5f85"),!1}b++;a.attr("_trigger_valid_inc",b)}return!1}return!0};this.DoPost=function(a,b,c){if(this.posting)return!1;if(this._cancelPostWait)return console.log("\u53d6\u6d88\u63d0\u4ea4"),this._cancelPostWait=null,!1;var d=this;if(!c){var e=
this.DoPostBefore();if(e instanceof Array){d=this;this._checkStatusInc=0;this._checkStatusFristResult=e;this._checkStatusTimer=window.setInterval(function(){var p=0==d._checkStatusInc?d._checkStatusFristResult:d.DoPostBefore();d._checkStatusInc++;var r=p[0];if(null!==r&&void 0!==r){window.clearInterval(d._checkStatusTimer);d._checkStatusTimer=null;d._checkStatusInc=null;d._checkStatusFristResult=null;var q=p[1];p=p[2];r&&!p?d.DoPost(a,b,!0):r&&p?$Confirm(q,q,function(){d.DoPost(a,b,!0)},function(){}):
q&&$Tip(q)}},232);return}if(!e)return}var g=$(a).find("input[ewa_tag=ht5upload]");if(!(0<g.length)||this.uploadProcess||this.CheckValidAll(a)){var h=0;for(e=0;e<g.length>0;e++){var k=g[e];this._uploadingFileCheck(k)&&h++}if(0<h)setTimeout(function(){d.DoPost(a,b)},700);else{g=$(a).find("input[ewa_tag=ht5takephoto]");if(0<g.length&&!this.uploadProcess&&!this.CheckValidAll(a))return!1;for(e=0;e<g.length>0;e++){k=g[e];h=!1;k=window["h5takephoto_"+this._Id+"$"+k.id];if("ok"!=k.UPLOAD_STATUS){if(!$X(k.H5_UPLOAD.WAIT_ID)){try{k.submitUpload()}catch(p){console.log("ht5takephotos - ht5.submitUpload: "+
p);$Tip("\u60a8\u6ca1\u6709\u83b7\u53d6\u7167\u7247");return}k.H5_UPLOAD.createWaitBox();this.uploadProcess=!0}h||(d=this,setTimeout(function(){d.DoPost(a,b)},700),h=!0);return}k.H5_UPLOAD.removeWaitBox()}if(this._stopPostError)return EWA.UI.Msg.ShowError(this._stopPostError,""),!1;e=this.CreateAjax(a);if(null==e)return!1;if(this._checkTriggerValids()){null==b&&(b=this.Url);if(""==b||null==b)b=window.location.href;this._Ajax=e;this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST",
"1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.LoadingType="image";this.DoPostStart&&this.DoPostStart(this._Ajax);e=new EWA_UrlClass(b);for(var l in this._Ajax._Parameters)e.RemoveParameter(l);b=e.GetUrl();this.posting=!0;var m=this;if(this.triggerValids)for(var n in this.triggerValids)this.triggerValids[n]=null,this.getObj("#"+n).removeAttr("_trigger_valid").removeAttr("_trigger_valid_inc");this._Ajax.PostNew(b,function(){m._CallBack()});this.isShowPostWaitting||this._Ajax.HiddenWaitting();
...
!1;this.CheckedAllAfter=this.ReloadAfter=null;this.REPLACE_HISTORY_STATE=this.IsNotMDownAutoChecked=!1;this._IsSearchGroup=!0;this.stickyColumns=function(a){var b=$X("EWA_LF_"+this._Id);if(null==b)console.log("not found table[#EWA_LF_"+this._Id+"]");else if(0!=b.rows.length){var c=$(b).parent();c.addClass("ewa-lf-sticky-scroll");c.on("scroll",function(){0==this.scrollLeft?c.addClass("ewa-lf-stick-last-hide"):c.hasClass("ewa-lf-stick-last-hide")&&c.removeClass("ewa-lf-stick-last-hide")});for(var d=
0;d<a;d++)this.stickyColumn(d,d==a-1,b);c.trigger("scroll")}};this.stickyColumn=function(a,b,c){c=c||$X("EWA_LF_"+this._Id);if(null==c)console.log("not found table[#EWA_LF_"+this._Id+"]");else if(0!=c.rows.length){var d=c.rows[0].cells[a];if(d){var e=$(d).position().left;d=$(d).width();e={left:e,width:d};for(d=0;d<c.rows.length;d++){var g=$(c.rows[d].cells[a]);g.css(e).addClass("ewa-lf-sticky");b&&g.addClass("ewa-lf-sticky-last").css("overflow","initial")}}}};this.composeSearchTexts=function(){var a=
[],b=[],c=$("#EWA_RESHOW_"+this._Id+" .ewa-lf-search-type-text");if(0==c.length)return null;c.each(function(g){var h=$(this).find(".ewa-lf-search-item-title").text();h=h.replace(":","").replace("\uff1a","").replace("\u5305\u542b","").replace("Like","").trim();var k=$(this).find("input[type=text]").attr("name");a.push(h);b.push(k);0<g&&$(this).hide()});var d=$(c[0]);d.addClass("ewa-app-lf-search-compose");d.find("input[type=text]").attr("name",b.join(",")).attr("placeholder",a.join(", "));var e=d.find("a").clone();
d.find(".ewa-lf-search-item-title b").text("enus"==EWA.LANG?"Search":"\u7efc\u5408\u641c\u7d22").append(e);return c};this.switchButtonAction=function(a,b){if(b){var c=this.getUrlClass();c.AddParameter("ewa_switch_name",a.name);c.AddParameter("ewa_action",b);c.AddParameter("ewa_ajax","json");c.AddParameter("ewa_switch",a.checked?"on":"off");c.AddParameter("ewa_action_key",$(a).parentsUntil("tbody").last().attr("ewa_key"));var d=a.parentNode,e=d.getAttributeNames();b={};for(var g in e){var h=e[g],k=
d.getAttribute(h);0!=h.indexOf("on")&&"name"!=h&&"id"!=h&&"class"!=h&&(b[h]=k)}var l=this;c=c.GetUrl();$JP(c,b,function(m){l.extSwitchCallBack&&l.extSwitchCallBack(a,m)})}};this.ShowRecycle=function(){var a=$X("EWA_LF_"+this._Id);if(null!=a&&(a=$(a).parentsUntil("table").last().find(".ewa_lf_func_caption"),0!=a.length)){var b="\u56de\u6536\u7ad9";window._EWA_INFO_MSG&&window._EWA_INFO_MSG.RECYCLE&&(b=window._EWA_INFO_MSG.RECYCLE);b="<div class='ewa_lf_func_dact ewa-lf-func-recycle' onclick='EWA.F.FOS[\""+
...
"$(this).parent().parent().find('[id=\""+b+"\"]')[0].click()");$(this).addClass("ewa-map-button")})};this.Merges=function(a){if(null==a||0==a.length)console.log("cfg.from, cfg.to, cfg.str, cfg.func, cfg.header");else for(var b=0;b<a.length;b++){var c=a[b];this.Merge(c.from,c.to,c.str,c.func,c.header)}};this.Merge=function(a,b,c,d,e){var g=$("#EWA_LF_"+this._Id);null==c?c="":-1==c.indexOf("<")&&(c="<span class='ewa-merge-str ewa-mearge-str'>"+c+"</span>");g.find("tr[ewa_key],tr.ewa-lf-sub-tr").each(function(){var h=
$(this).find('[id="'+b+'"]').parentsUntil("tr").last();if("yes"!=h.attr("ewa-merged")){h.attr("ewa-merged","yes");var k=$(this).find('[id="'+a+'"]');k.parentsUntil("tr").last().hide();h.append(c);h.append(k);d&&d(h,this)}});e&&(e="<span class='ewa-lf-merge-header-split'></span>"+g.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(),g.find('tr[ewa_tag="HEADER"] [id="'+b+'"]').append(e));g.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').parent().hide();g.find("td#ADD_ROW_"+a).hide()};this.Mearge=function(a,
b,c){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 Merge");this.Merge(a,b,c)};this.MergeExp=function(a,b,c,d,e){if(b){var g=$("#EWA_LF_"+this._Id),h=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),k=[],l=b,m={};b=[];for(var n=0;n<h.length;n++){var p=h[n];k.push(p);var r=p.replace("@@","");l=l.replace(p,"<span class='ewa-lf-merge ewa-lf-merge-"+r+" ewa-lf-mearge ewa-lf-mearge-"+r+"' mid=\""+r+'"></span>');r!=a&&(g.find('tr[ewa_tag="HEADER"] [id="'+r+'"]').parent().hide(),g.find("td#ADD_ROW_"+r).hide());
p=g.find('tr[ewa_tag="HEADER"] [id="'+r+'"]').html();m[r]=p;b.push(p)}e&&(e=b.join("<span class='ewa-lf-merge-header-split'></span>"),g.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(e));g.find("tr[ewa_key],tr.ewa-lf-sub-tr").each(function(){if(0==$(this).find('[id="'+a+'"]').length)console.log("not find "+a);else{var q=$(this).hasClass("ewa-lf-sub-tr")?$(this).find('[id="ADD_ROW_'+a+'"]'):$(this).find(".ewa-col-"+a);if("yes"!=q.attr("ewa-merged")){var t=$('<div style="display:none"></div>');t.html(l);
for(var v in k){var u=k[v].replace("@@",""),x=$(this).find('[id="'+u+'"]');if(0!=x.length){u!=a&&x.parent().hide();var w=t.find('span[mid="'+u+'"]');c&&(w.append("<span class='ewa-lf-mearge-memo'></span>"),w.find(".ewa-lf-mearge-memo").html(m[u]));w.append(x)}}for(;0<t[0].childNodes.length;)q.append(t[0].childNodes[0]);$(t).remove();d&&d(q,this);q.attr("ewa-merged","yes")}}})}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MeargeExp=function(a,b,c,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 MereExp");
this.MergeExp(a,b,c,d)};this.SubBottoms=function(a){this.SubBottomsArray=a.split(",");this._SubBottoms()};this.reCalcBottoms=function(){this._SubBottoms()};this._SubBottoms=function(){var a=$("#EWA_LF_"+this._Id).find(".ewa-lf-sub-tr");0==a.length?(a=$(this.AddRow([])),a.addClass("ewa-lf-sub-tr"),a.find("td").addClass("ewa-lf-sub-td")):a.find("td").text("");var b={},c;for(c in this.SubBottomsArray){b={total:void 0,fm_length:void 0};var d=this.SubBottomsArray[c];b.total=0;var e="#EWA_LF_"+this._Id+
' .ewa-lf-data-row [name="'+d+'"]';b.fm_length=0;$(e).each(function(g){return function(){var h=this.hasAttribute("value")?this.value:this.hasAttribute("title")?this.title:this.innerText;null!=h&&0!==h.length&&(h=h.replace(/,/ig,""),isNaN(h)||(g.total+=1*h,0<h.indexOf(".")&&(g.fm_length=2)))}}(b));b="<span id='"+d+"' name='"+d+"' class='ewa-lf-sub'>"+b.total.fm(b.fm_length)+"</span>";a.find("td[id=ADD_ROW_"+d+"]").html(b)}};this.ChangeRowStyle=function(a,b,c){for(var d=$X("EWA_LF_"+this._Id),e=1;e<
d.rows.length;e++){var g=d.rows[e];if(!(0==g.cells.length||g.cells.length<=a)){var h=g.cells[a].childNodes[0].getAttribute(b);if(null!=h&&c[h])for(var k=0;k<g.cells.length;k++)g.cells[k].style.cssText=g.cells[k].style.cssText+";"+c[h]}}if(null==this.ReloadAfter){var l=this;this.ReloadAfter=function(){l.ChangeRowStyle(a,b,c)}}};this.MDownEvent=function(a,b){};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.Workflow=function(a,b,c,d,e,g){EWA.F.CID=this._Id;
this._Ajax=this.CreateAjax();this._Ajax.AddParameter("EWA_AJAX","WORKFLOW");this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_WF_NAME",b);null!=c?(a=this.GetRowKey(c),this._Ajax.AddParameter("EWA_ACTION_KEY",a),"true"==c.getAttribute("ewa_wf_control")?this._Ajax.AddParameter("EWA_WF_CTRL",1):this._Ajax.AddParameter("EWA_WF_CTRL",0)):this._Ajax.AddParameter("EWA_WF_CTRL",1);null!=d&&this._Ajax.AddParameter("EWA_ACTION_KEY",d);e&&this._Ajax.AddParameter("EWA_WF_UOK",e);g&&this._Ajax.AddParameter("EWA_WF_UMSG",
g);var h=this;this._Ajax.PostNew(this.Url,function(){h._CallBackJs()})};this.GetRowKey=function(a){a=this.GetRow(a);return null!=a?a.getAttribute("EWA_KEY"):null};this.GetRow=function(a){if(null==a||null==a.tagName||""==a.tagName)return null;var b=0;for(a=a.parentNode;"TR"!=a.tagName||null==a.getAttribute("EWA_KEY");){a=a.parentNode;if("BODY"==a.tagName){a=null;break}b++;if(100<b){alert("\u5faa\u73af100\u6b21\uff0c\u672a\u53d1\u73b0TR");break}}return a};this.RecordModify=function(a,b,c){var d=this.SelectChecked();
if(0==d.length)EWA.UI.Msg.Alter("\u8bf7\u5148\u9009\u62e9","\u4fee\u6539");else{var e="EWA_MTYPE=M";null!=c&&0<c.trim().length&&(e+="&"+c);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,e+d)}};this.RecordNew=function(a,b,c){var d="EWA_MTYPE=N";null!=c&&0<c.trim().length&&(d+="&"+c);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,d)};this.SelectSingle=function(){this.IsTrSelect=!0;this._TrSelectMulti=!1};this.SelectMulti=function(){this._TrSelectMulti=this.IsTrSelect=!0};this.MOver=function(a,b){if(this.IsTrSelect&&
this._CurTr!=a&&(null!=this._CurTr&&("1"!=this._CurTr.getAttribute("__ewa_lf_mdown")?this._MSetBg(this._CurTr,""):this._MSetBg(this._CurTr,"down")),"1"!=a.getAttribute("__ewa_lf_mdown")?this._MSetBg(a,"over"):this._MSetBg(a,"down"),this._CurTr=a,this.MOverEvent))try{this.MOverEvent(a,b)}catch(c){console.log(c,this.MOverEvent)}};this.MOut=function(a){if(this.IsTrSelect&&null!=this._CurTr&&"1"!=this._CurTr.getAttribute("__ewa_lf_mdown")){this._MSetBg(this._CurTr,"out");if(this.MOutEvent)try{this.MOutEvent(this._CurTr,
a)}catch(b){console.log(b,this.MOutEvent)}this._CurTr=null}};this.MDownEnableCheck=function(a,b){return!0};this.checkMDownEnable=function(a,b){if(!b)return!0;b=b.srcElement?b.srcElement:b.target;return!b||"TD"==b.tagName&&b.parentNode==a?!0:"A"==b.tagName||"A"==b.parentNode.tagName||"INPUT"==b.tagName||"SELECT"==b.tagName||"BUTTON"==b.tagName||"TEXTAREA"==b.tagName||0<=b.className.indexOf("EWA_LF_EDIT")||0<=b.className.indexOf("ewa-lf-edit")||0<=b.className.indexOf("ewa-lf-search-text-click")||0<=
b.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=b.parentNode.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=b.className.indexOf("ewa-mdown-stop")?!1:!0};this.mDownAutoCheck=function(a,b,c){for(var d,e=0;e<b.length&&!(0<=b[e].parentNode.className.indexOf("ewa-switch"));e++){if("RADIO"==b[e].type.toUpperCase())return d=b[e],d.click(),d;if("CHECKBOX"==b[e].type.toUpperCase()){d=b[e];d.click();if(!this._TrSelectMulti){var g=$(b[e]).attr("id")||$(b[e]).attr("name");0==$(c).find(b[e]).length&&
$(a).siblings(".ewa-lf-data-row").find("input[name='"+g+"']:checked").prop("checked",!1);d.checked=!0}return d}}return null};this.newRowOneTd=function(a){if(null==a)return null;a=$(a)[0];var b=a.parentNode.rows[a.rowIndex+1];if(null!=b&&"1"==b.getAttribute("add_pre_row"))return b;b=a.parentNode.parentNode;var c=b.rows[0].cells.length;b=b.insertRow(a.rowIndex+1);b.setAttribute("add_pre_row",1);a=b.insertCell(-1);a.colSpan=c;a.className="ewa-lf-add-pre-cell";b.style.display="none";a.id=EWA_Utils.tempId("EWA_LF_NR_"+
this._Id);$(b).addClass("ewa-lf-add-pre-row");return b};this.MDown=function(a,b){if(this.IsTrSelect){var c=(new Date).getTime(),d=$(a).attr("mdown_time_last");if(!(null!=d&&500>c-d)&&($(a).attr("mdown_time_last",c),b=null==b?window.event:b,this.MDownEnableCheck(a)&&this.checkMDownEnable(a,b))){d=b.srcElement?b.srcElement:b.target;var e=null;c=a.getElementsByTagName("input");this.IsNotMDownAutoChecked||(e=this.mDownAutoCheck(a,c,d));if("1"==a.getAttribute("__ewa_lf_mdown"))this._TrSelectMulti&&(e&&
"CHECKBOX"==e.type.toUpperCase()&&(e.checked=!1),this._MSetBg(a,""),a.removeAttribute("__ewa_lf_mdown"),$(a).removeClass("ewa-lf-mdown"));else{e&&(e.checked=!0);this._MSetBg(a,"down");a.setAttribute("__ewa_lf_mdown",1);$(a).addClass("ewa-lf-mdown");if(!this._TrSelectMulti&&(e=a.parentNode)&&e.rows)for(d=0;d<e.rows.length;d++){var g=e.rows[d];"1"==g.getAttribute("__ewa_lf_mdown")&&g!=a&&(g.removeAttribute("__ewa_lf_mdown"),$(g).removeClass("ewa-lf-mdown"),this._MSetBg(g,""))}if(this.IsReShow)for(d=
0;d<c.length;d++)"BUTTON"==c[d].type.toUpperCase()&&(e=c[d],"true"==e.getAttribute("disabled")||1==e.getAttribute("disabled")||"true"==e.parentNode.getAttribute("disabled")||1==e.parentNode.getAttribute("disabled")?(this._ReshowButs[e.value].disabled=!0,this._ReshowButs[e.value].style.display="none"):(this._ReshowButs[e.value].disabled=!1,this._ReshowButs[e.value].style.display=""))}this._IsAddPreRow?(c=a.getAttribute("ewa_key"),this.AddPreRowCheck(a,c,b)&&(d=this.newRowOneTd(a),this.prevTr&&(this.AddPreRowCloseBeforeEvent&&
this.AddPreRowCloseBeforeEvent(this._Id,a,c,this.prevTr,b),this.prevTr.style.display="none",this.prevTr.cells[0].innerHTML="",this.AddPreRowCloseEvent&&this.AddPreRowCloseEvent(this._Id,a,c,this.prevTr,b)),this.prevTr==d?this.prevTr=null:(this.prevTr=d,this.prevTr.style.display="",this.MDownEvent(this._Id,a,c,this.prevTr,b)))):this.MDownEvent(a,b)}}};this.AddPreRow=function(a){this._IsAddPreRow||(this.MDownEvent=a);this._IsAddPreRow=!0};this.AddPreRowCheck=function(a,b,c){return!0};this.AddPreRowCloseBeforeEvent=
function(a,b,c,d,e){};this.AddPreRowCloseEvent=function(a,b,c,d,e){};this._MSetBg=function(a,b){var c="";"down"==b?c="ewa_grid_down":"over"==b&&(c="ewa_grid_mover");$(a).children("td").removeClass("ewa_grid_mover ewa_grid_down").addClass(c)};this._ReShowSearchQuick=function(){var a=this,b=EWA_ListFrameClass.prototype.RESOURCES.search_text_items,c,d,e;for(e in b){var g=b[e];"eq"==g.Id&&(c=g);"lk"==g.Id&&(d=g)}for(e in this._SearchJson){var h=this._SearchJson[e];h.isSearchQuick&&(b=$("#EWA_LF_"+this.Id+
' .ewa-lf-data-row [id="'+e+'"]'),b.bind("click",function(k){k.stopPropagation();k=$(this).attr("search_tag");var l=$(this).text(),m=l,n=$("#EWA_SEARCH_ITEM_"+a.Id+' .ewa-lf-search-item-ctl [name="'+this.id.toUpperCase()+'"]');if("number"==k||"date"==k)n=n.parentsUntil(".ewa-lf-search-item").last().find("input");var p=n.parentsUntil(".ewa-lf-search-item").last().find("a");if("date"==k)l=l.split(" ")[0],m=l+" 23:59:59";else if("fix"==k){var r=null;n.find("option").each(function(){this.text==l&&(r=
this.value)});l=null===r?"":r}n.val()==l?("text"==k&&d&&0<p.length&&(p.attr("tag",d.Id),p.html("enus"==EWA.LANG?d.TxtEn:d.Txt)),n.val("")):("text"==k&&c&&0<p.length&&(p.attr("tag",c.Id),p.html("enus"==EWA.LANG?c.TxtEn:c.Txt)),n.val(l),"date"==k&&(n[1].value=m))}),b.each(function(){$(this).text()&&$(this).addClass("ewa-lf-search-text-click").attr("search_tag",h.T)}))}};this.ReShowWithNoButtons=function(){var a=$X("EWA_LF_"+this._Id),b=[],c;for(c in this.ItemList.Items){var d=this.ItemList.Items[c],
e=this._GetSubValue("Tag","Tag",d);if(null!=e&&"button"==e.trim().toLowerCase())for(e=0;e<a.rows[0].cells.length;e++)if(a.rows[0].cells[e].childNodes[0].id.toUpperCase()==c){b.push(e);d.setAttribute("but_show","1");break}}this.ShowHiddenColumns(b,!1)};this.ReShowButtonsInDailogTitle=function(){EWA.OW.Load();if(EWA.OW.Dia){var a=$(EWA.OW.Dia._Dialog.GetFrameTitle()),b=$($X("EWA_RESHOW_"+this._Id)).find("td.ewa_lf_func:eq(0)"),c=this;b.find(".ewa_lf_func_dact").each(function(){this.id=EWA_Utils.tempId("gDx_"+
c._Id+"_")});a.html(b.html());a.find(".ewa_lf_func_dact").each(function(){this.onclick=function(){b.find('div[id="'+this.id+'"]').click()}});b.parent().hide();$(EWA.OW.Dia._Dialog.GetFrame()).addClass("ewa-lf-btns-in-title")}};this.ReShow=function(a){this.IsReShow=!0;var b="_G_"+this._Id;this.NewDivId=b;a=[];a.push("<table class='ewa-lf-reshow' id='EWA_RESHOW_"+this._Id+"'>");a.push("<tr style='display:none'><td style='padding:0'></td></tr>");a.push("<tr><td class='ewa_lf_func' style='padding:0'>");
a.push("<div style='display:none'></div>");a.push("<div><div style='cursor:pointer' class='ewa_lf_func_caption'></div></div>");a.push("</td></tr>");a.push("<tr><td style='width:100%;padding:0;vertical-align:top'>");a.push("<div id='"+b+"' style=''></div>");a.push("</td></tr>");a.push("</table>");var c=$(a.join("")),d=!(0<this.Url.toUpperCase().indexOf("EWA_AJAX=INSTALL")||0<this.Url.toUpperCase().indexOf("EWA_CALL_METHOD=INNER_CALL")||0<this.Url.toUpperCase().indexOf(".JSP"));d?EWA.UI.Utils.SetStyle(c[0],
"width:100%;height:100%;border-spacing:0"):EWA.UI.Utils.SetStyle(c[0],"width:100%;border-spacing:0");css="";var e=$X("EWA_LF_"+this._Id);a=e.parentNode.parentNode;var g=e.parentNode;c.find("td:eq(2)>div").append(g);g=c[0];var h=c.find("tr:eq(0)")[0],k=c.find("td:eq(0)")[0],l=c.find("td:eq(1)")[0],m=c.find("td:eq(2)")[0];d&&(window.setTimeout(function(){$X("__EWA_DEBUG")&&m.childNodes[0].appendChild($X("__EWA_DEBUG"));var B=$X(b);B.getElementsByTagName("table");var D=EWA.UI.Utils.GetDocSize(window),
E=B.parentNode.parentNode.previousSibling.offsetHeight;B.style.top=E+"px";B.style.height=D.H-E+"px"},100),addEvent(window,"resize",function(){var B=$X(b),D=EWA.UI.Utils.GetDocSize(window),E=B.parentNode.parentNode.previousSibling.offsetHeight;B.style.top=E+"px";B.style.height=D.H-E+"px"}));for(;0<a.childNodes.length;)l.childNodes[0].appendChild(a.childNodes[0]);c=c.find(".ewa_lf_func_caption")[0];var n=!1;d=GetInnerText(l);d=d.trim();this._ReshowButs={};e=$(e.rows[0]);for(var p in this.ItemList.Items){var r=
this.ItemList.Items[p],q=this._GetSubValue("Tag","Tag",r);if(q&&("button"==q.toLowerCase()||"butflow"==q.toLowerCase())&&(q=this._GetSubValue("Name","Name",r),0!==e.find(".ewa-col-"+q).length)){n=!0;var t=this._GetSubValue("DescriptionSet","Info",r),v=this._GetSubValue("DescriptionSet","Memo",r),u=this._GetSubValue("EventSet","EventName",r),x="";null!=u&&"ewa_click"==u.toLowerCase().trim()&&(x=this._GetSubValue("EventSet","EventValue",r));d=d.replace(t,"");r=this._ReShowButton(t,v,null);this._ReshowButs[t]=
r;r.setAttribute("f_id",this._Id);r.setAttribute("t_id",q);l.childNodes[1].appendChild(r);""==x?r.setAttribute("onclick","EWA.F.FOS['"+this._Id+"'].reShowButtonClick(this)"):r.setAttribute("onclick",x)}}n&&this._ReShowSplit(l.childNodes[1]);q=l.getElementsByTagName("input");n={};for(e=0;e<q.length;e++){var w=q[e];w.style.display="none";if(null==w.id||""==w.id)w.id=("_tmp_"+Math.random()).replace(".","_");if("button"==w.type){if(r=this._ReShowButton(w.value,w.title,w.id),t=w.nextSibling){var y="";
3==t.nodeType&&(y=t.nodeValue.trimEx());"|"==y&&this._ReShowSplit(l.childNodes[1])}}else(t=w.nextSibling)&&(y=3==t.nodeType?t.nodeValue.replace("|",""):t.innerHTML),r=this._ReShowButton(y.trimEx(),w.title,w.id),r.id=("_tmp_"+Math.random()).replace(".","_"),n[w.name]||(n[w.name]=[]),n[w.name].push(r.id);l.childNodes[1].appendChild(r)}d=d.replace(/ /ig,"").replace(/\|/ig,"").trimEx();""!=d?0<=d.indexOf("if")?h.style.display="none":k.innerHTML=d.replace(/ /,""):h.style.display="none";a.appendChild(g);
for(p in n)for(y=n[p],e=0;e<y.length;e++)w=$X(y[e]),w.setAttribute("_r_ids",y.join(",")),w.onclick=function(){var B=this.getAttribute("_ewa_event_id");$X(B).click();B=this.getAttribute("_r_ids").split(",");for(var D=0;D<B.length;D++)w.id!=B[D]&&($X(B[D]).style.fontWeight="",$X(B[D]).style.color="");this.style.fontWeight="bold";this.style.color="blue"};c.innerHTML='<b><i class="fa fa-star-o">&nbsp;</i>'+this.Description+"</b>";if(0<this.Url.toUpperCase().indexOf("EWA_BTNS_IN_TITLE"))var z=this,A=0,
C=setInterval(function(){A++;1E3<A&&window.clearInterval(C);EWA.OW.Load();EWA.OW.Dia&&(window.clearInterval(C),z.ReShowButtonsInDailogTitle())},10)};this.reShowButtonClick=function(a){a=a.getAttribute("t_id");var b=this.SelectCheckedRows();if(null==b||0==b.length)EWA.UI.Msg.Alert(_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM"],_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM_TITLE"]);else{b=b[0].getElementsByTagName("input");for(var c=0;c<b.length;c++){var d=b[c];if(d.name===a){d.click();break}}}};this._ReShowSplit=function(a){EWA.UI.Utils.CreateObject(window,
"div","",a).className="ewa_lf_func_split"};this._ReShowButton=function(a,b,c){var d=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",document.body);d.innerHTML="<nobr>"+a+"</nobr>";null!=c&&(d.setAttribute("_ewa_event_id",c),d.onclick=function(){var e=this.getAttribute("_ewa_event_id");$X(e).click()});EWA.B.IE&&(d.onselectstart=function(){return!1});d.className="ewa_lf_func_dact";d.title=b;return d};this.CheckValid=function(a){var b=a.tagName.toLowerCase();if("input"!=b&&"textarea"!=b&&"select"!=
b||"button"==a.type||"submit"==a.type||"image"==a.type)return!0;b=this.ItemList.GetObjectValue(a);return this.ItemList.CheckValid(a,b)};this.ShowEdit=function(a){a.parentNode.style.width=a.clientWidth+"px";a.style.display="none";__show_obj__=a.nextSibling;__show_obj__.style.display="";var b=__show_obj__.childNodes[0];3==b.nodeType&&(b=__show_obj__.childNodes[1]);b.setAttribute("old",b.value);"SELECT"!=b.tagName||b.getAttribute("func")||(b.setAttribute("func",1),b.onchange=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)});
null==b.getAttribute("__ewa_fid__")&&(b.setAttribute("__ewa_fid__",this._Id),b.onblur=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)},b.onkeydown=function(c){c=null==c?window.event:c;var d=c.target?c.target:c.srcElement;13==c.keyCode&&"INPUT"==d.tagName&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this);27==c.keyCode&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditReset(this)});setTimeout(function(){b.focus();b.select()},10)};this.EditReset=function(a){a.parentNode.style.display=
"none";var b=a.parentNode.previousSibling;b.style.display="";b.innerHTML=a.getAttribute("old");"select"==a.tagName.toLowerCase()?b.innerHTML=a.options[a.selectedIndex].text:a.value=a.getAttribute("old").replace(/</ig,"&lt;").replace(/>/ig,"&gt;")};this.EditAfter=function(a){if(this.CheckValid(a))if(a.getAttribute("old")==a.value)this.EditReset(a);else{a.parentNode.style.display="none";var b=a.parentNode.previousSibling;b.style.display="";if("droplist"==a.getAttribute("ewa_class")){var c=$(a.parentNode.getElementsByTagName("input")[1]).attr("name");
var d=a.parentNode.getElementsByTagName("input")[1].value;b.innerHTML=a.parentNode.getElementsByTagName("input")[0].value}else"select"==a.tagName.toLowerCase()?(c=$(a).attr("name"),b.innerHTML=a.options[a.selectedIndex].text):(c=a.value.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/\n/ig,"<br>"),b.innerHTML=c,c=$(a).attr("name")),d=a.value;b=a.getAttribute("action_name");if(""==b||null==b)b="OnListFrameUpdateCell";var e=a.getAttribute("action_confirm");e=null==e?"":e;var g=a.getAttribute("action_tip");
null==g&&(g="");var h=a.getAttribute("action_js"),k=this.ItemList.GetValue(c,"DataItem","DataType");c=[{Name:"EWA_FIELD_ID",Value:c},{Name:"EWA_FIELD_VAL",Value:d},{Name:"EWA_ACTION_RELOAD",Value:"0"},{Name:c,Value:d},{Name:"EWA_DATA_TYPE",Value:k},{Name:"EWA_FIELD_VAL_OLD",Value:a.getAttribute("old")}];this.EditEvent={FROM:a,OLD_VAL:a.getAttribute("old"),NEW_VAL:a.value};this.DoAction(a,b,e,g,c,h)}else a.focus()};this.RewriteInfo=function(a,b,c,d,e){var g=$("#EWA_LF_"+this._Id),h=[];if(a)this._INFO=
{},this._INFO.INFO=a,this._INFO.ID_NAME=b||"id",this._INFO.INFO_NAME=c||"info",this._INFO.MEMO_NAME=d||"memo";else if(!this._INFO||!this._INFO.INFO)return;for(a=0;a<this._INFO.INFO.length;a++)if(b=this._INFO.INFO[a],c=g.find('[id="'+b[this._INFO.ID_NAME]+'"]:eq(0)'),0!==c.length){d=c.parentsUntil("tr").last();var k=b[this._INFO.INFO_NAME],l=b[this._INFO.MEMO_NAME];if(null==k||""==k.trim())for(k=d.parent()[0],l=0;l<k.cells.length;l++){if(k.cells[l]==d[0]){this.ShowHiddenColumn(l,!1);break}}else 0==
c.children().length?c.text(k):c.children()[0].innerText=k,l&&c.attr("title",l);h.push(c[0]);e&&e(c[0],b,a)}return h};this.ShowHiddenColumn=function(a,b){var c=$X("EWA_LF_"+this._Id),d="";if(null==b||0==b||"none"==b)d="none";for(b=0;b<c.rows.length;b++)c.rows[b].cells.length==c.rows[0].cells.length&&(c.rows[b].cells[a].style.display=d)};this.ShowHiddenColumns=function(a,b){var c=$X("EWA_LF_"+this._Id),d="";if(null==b||0==b||"none"==b)d="none";b=c.rows[0].cells.length;for(var e=0;e<c.rows.length;e++){var g=
c.rows[e];if(g.cells.length==b)for(var h=0;h<a.length;h++)g.cells[a[h]].style.display=d}};this.GroupShowHidden=function(a){var b=$(a).attr("t"),c=(new Date).getTime();if(!(b&&333>c-b)){$(a).attr("t",c);b=a.parentNode.parentNode;c=b.getAttribute("ewa_group");""==c?(c="none",a.childNodes[0].innerHTML=" + "):(c="",a.childNodes[0].innerHTML=" - ");b.setAttribute("ewa_group",c);for(var d=b.parentNode.parentNode,e=0,g=b.rowIndex+1;g<d.rows.length;g++){b=d.rows[g];if("group"==b.getAttribute("ewa_tag"))break;
b.getAttribute("add_pre_row")?"none"==c?("none"!=b.style.display&&b.setAttribute("ewa_group_show_old",b.style.display),b.style.display="none"):b.hasAttribute("ewa_group_show_old")&&(b.style.display=b.getAttribute("ewa_group_show_old"),b.removeAttribute("ewa_group_show_old")):(b.style.display=c,e++)}a.childNodes[a.childNodes.length-1].innerHTML=" ("+e+")"}};this.Sort=function(a){var b=this._last_sort_timer||0,c=this._Sort||"",d=(new Date).getTime();c==a&&500>d-b||(this._last_sort_timer=d,this._Sort=
a,this.Goto(1))};this.SearchClear=function(a){a=a.parentNode.parentNode.parentNode.parentNode;for(var b=0;b<a.rows.length;b+=1)for(var c=a.rows[b].getElementsByTagName("input"),d=0;d<c.length;d++){var e=c[d];if("text"==e.type)e.value="";else if("radio"==e.type||"checkbox"==e.type)e.checked=!1}};this.SearchGetExpInit=function(){var a=$("#_G_"+this._Id),b=[];$(a).find(".ewa-lf-search-item").each(function(){var c=$(this).find("input");if(0==c.length&&(c=$(this).find("select"),0==c.length))return;var d=
c[0],e=$(d).attr("t");if(1==c.length){var g=d.value;if(""!=d.value.trim())for("text"==e&&(c=$(d.parentNode.parentNode).find("a").attr("tag"))&&(e=c),d=d.name.split(","),c=0;c<d.length;c++)b.push(d[c]+"["+e+"]"+g)}else if(("date"==e||"number"==e)&&2==c.length){if(g=d.value,e=c[1].value,""!=e||""!=g)b.push(d.name+"[gte]"+g),e&&b.push(d.name+"[lte]"+e)}else if("fix"==e&&"INPUT"==d.tagName){var h=[""];$(this).find("input").each(function(){this.checked&&h.push(this.value)});1!=h.length&&b.push(d.name+
"[or]"+h.join(";"))}});return b.join(",")};this.SearchGetExp=function(a){var b=[];$(a).find(".ewa-lf-search-item").each(function(){var c=$(this).find("input");if(0==c.length&&(c=$(this).find("select"),0==c.length))return;var d=c[0],e=$(d).attr("t");if(1==c.length){var g=d.value;""!=d.value.trim()&&("text"==e&&(c=$(d.parentNode.parentNode).find("a").attr("tag"))&&(e=c),b.push("@!@"+d.name+"~!~"+e+"~!~"+g))}else if(("date"==e||"number"==e)&&2==c.length)g=d.value,c=c[1].value,""==c&&""==g||b.push("@!@"+
d.name+"~!~"+e+"~!~"+g+"~!~"+c);else if("fix"==e&&"INPUT"==d.tagName){var h=[""];$(this).find("input").each(function(){this.checked&&h.push(this.value)});1!=h.length&&b.push("@!@"+d.name+"~!~"+e+h.join("~!~"))}});return b.join("")};this.DoSearch=function(a){var b=!1;a.id=="EWA_SEARCH_ITEM_"+this.Id?a=$X("EWA_SEARCH_ITEM_"+this.Id).childNodes[0]:(a=a.parentNode.parentNode.parentNode.parentNode,b=!0);this._SearchExp=this.SearchGetExp(a);b&&(this._SearchHtml=a.parentNode.innerHTML,this._SearchDialog.Show(!1));
this.Goto(1)};this.Search=function(a){null==this._SearchHtml?(this._SearchCreate(),this._SearchDialog=new EWA.UI.Dialog.OpenWindow("about:blank","aa",400,100,!0,null,null,!1),this._SearchDialog.SetCaption(_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.TITLE"]),this._SearchDialog._Dialog.AutoSize=!0,this._SearchDialog._Dialog.SetHtml(this._SearchHtml),this._SearchDialog._Dialog.Show(!0),this._SearchDialog._Dialog.GetFrame().focus(),this._SearchDialog.MoveCenter()):(this._SearchDialog._Dialog.AutoSize=!1,this._SearchDialog.Show(!0))};
this.ShowSearch=function(a,b){var c="EWA_SEARCH_ITEM_"+this.Id;b&&(this._IsSearchGroup=!1);$X(c)||(this._SearchCreateItm(),a&&this.composeSearchTexts(),this._ReShowSearchQuick())};this.ChangeSearchTextType=function(a){this._MENU_DATE_RANGE&&this._MENU_DATE_RANGE.HiddenMemu();this._MENU_TEXT_TYPE.ShowByObject(a,null,0);var b=$(this._MENU_TEXT_TYPE.Dialog.GetFrame());b.find(".search-text-tag").remove();b.find('div[ewa_mg="'+$(a).attr("tag")+'"] td:eq(0)').html('<b class="fa fa-check search-text-tag"></b>')};
this.ChangeSearchDateType=function(a){this._MENU_TEXT_TYPE&&this._MENU_TEXT_TYPE.HiddenMemu();this._MENU_DATE_RANGE.ShowByObject(a,null,0)};this.ChangeSearchTextTypeIt=function(a){var b=$(this._MENU_TEXT_TYPE.SHOW_BY_OBJECT).parentsUntil(".ewa-lf-search-item").last(),c=$J2MAP(this.RESOURCES.search_text_items,"Id")[a];c="enus"==EWA.LANG?c.TxtEn:c.Txt;b.find("a").attr("tag",a).html(c);var d=b.find("input");"blk"==a||"nblk"==a?d.val(c).prop("disabled",!0):d.prop("disabled")&&b.find("input").val("").prop("disabled",
!1)};this._GetInitSearchMap=function(){var a=new EWA_UrlClass(this.Url),b={},c=a.GetParameter("ewa_search");if(!c)return b;this.Url=a.RemoveParameter("ewa_search");c=c.unURL();a=c.split(",");for(var d in a){var e=a[d],g=e.indexOf("["),h=e.indexOf("]");0>g||h<g||(c=e.substring(0,g).trim(),0!=c.length&&(g=e.substring(g+1,h).trim().toLowerCase(),0!=g.length&&(e=e.substring(h+1).trim(),""!=e&&(b[c.toUpperCase()]||(b[c.toUpperCase()]={name:c,tag:g}),c=b[c.toUpperCase()],"lt"==g||"lte"==g?c.para2=e.unURL().replace(/\+/ig,
" "):c.para1=e.unURL().replace(/\+/ig," ")))))}return b};this.SearchFilterDate=function(a){var b=$(this._MENU_DATE_RANGE.SHOW_BY_OBJECT).parentsUntil(".ewa-lf-search-item").last(),c=b.find("input")[0];b=b.find("input")[1];if("Clear"==a)$(c).val(""),$(b).val("");else{var d=EWA_Utils.Date(),e="",g="";"Today"==a?g=e=d.GetDateString():"Week"==a?(a=d.GetBenWeek(),e=a[0],g=a[1]):"Today-Weekend"==a?(a=d.GetBenWeek(),e=a[d.GetDateString()],g=a[1]):"Month"==a?(a=d.GetBenMonth(),e=a[0],g=a[1]):"Today-EOM"==
a?(a=d.GetBenMonth(),e=a[d.GetDateString()],g=a[1]):"Quarter"==a?(a=d.GetBenQ(),e=a[0],g=a[1]):"Today-EOQ"==a?(a=d.GetBenQ(),e=a[d.GetDateString()],g=a[1]):"Year"==a?(a=d.GetBenYear(),e=a[0],g=a[1]):"Today-EOY"==a&&(a=d.GetBenYear(),e=a[d.GetDateString()],g=a[1]);a=EWA_Utils.Date(e).FormatDate();d=EWA_Utils.Date(g).FormatDate();d+=" 23:59:59";$(c).val(a);$(b).val(d)}};this._SearchCreateDateRange=function(){var a="_MENU_DATE_RANGE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":
"Txt",c=JSON.parse(JSON.stringify(this.RESOURCES.search_date_items)),d="EWA.F.FOS[&quot;"+this._Id+"&quot;].SearchFilterDate",e;for(e in c){var g=c[e];g.Txt=g[b];g.Cmd=d+"(&quot;"+g.Id+"&quot;)"}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_DATE_RANGE";this._MENU_DATE_RANGE=new EWA_UI_MenuClass(b);this._MENU_DATE_RANGE.Create(c);$(this._MENU_DATE_RANGE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+a);return b};this._SearchCreateTextType=function(){var a="_MENU_TEXT_TYPE"+this._Id;$("."+a).remove();
var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",c=JSON.parse(JSON.stringify(this.RESOURCES.search_text_items)),d="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextTypeIt",e;for(e in c){var g=c[e];g.Txt=g[b];g.Cmd=d+"(&quot;"+g.Id+"&quot;)";g.Group=g.Id}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_TEXT_TYPE";this._MENU_TEXT_TYPE=new EWA_UI_MenuClass(b);this._MENU_TEXT_TYPE.Create(c);$(this._MENU_TEXT_TYPE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+a);this._MENU_TEXT_TYPE.clickBeforeEvent=
function(h,k){$(this.Dialog.GetFrame()).find(".search-text-tag").remove();$(k).find("td:eq(0)").html('<b class="fa fa-check search-text-tag"></b>')};return b};this._SearchCreateItm=function(){var a="EWA_SEARCH_ITEM_"+this.Id,b=[],c=[],d=[],e={},g;for(g in this._SearchJson)this._SearchJson[g].ORI_NAME=g,e[g.toUpperCase()]=this._SearchJson[g];this._SearchJson=e;var h="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextType(this)",k="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchDateType(this)",l=
$J2MAP(this.RESOURCES.search_text_items,"Id");e=this._GetInitSearchMap();var m=!1,n=!1;for(g in this.ItemList.Items)if(null!=this._SearchJson[g]){var p=[],r=this._SearchJson[g],q=r.T,t=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[g]);p.push("<table class='ewa-lf-search-item ewa-ref-"+g+" ewa-lf-search-type-"+q+" "+("fix"==q?"ewa-lf-search-fix-m"+(r.M||"0"):"")+"' cellspacing=0 cellpadding=0>");p.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");
...
(g.NodeShow(!0),alert(_EWA_EVENT_MSG.OnTreeNodeDeleteHaveChildren)):(d=e,null==d&&(d=new EWA.F.Cmd,d.EWA_ACTION="OnTreeNodeDelete"),""==d.EWA_AFTER_EVENT&&(d.EWA_AFTER_EVENT='EWA.F.FOS["'+this._Id+'"].DeleteAfter();'),d.EWA_TREE_KEY=g.Key,this._PostChange(d)))};this.DeleteNoConfirmById=function(d,e){e&&(e.cancelBubble=!0,e.stopPropagation());d=this.GetNodeById(d);null!=d&&"EWA_TREE_ROOT"!=d.Key&&(this._LastFocus=d.GetObject(),this.DeleteAfter())};this.DeleteAfter=function(){var d=this.GetNode(this._LastFocus).GetObject(),
e=d.parentNode;e.removeChild(d);d=this.GetNode(e);0==d.Children.length?this.GetNode(d.GetObject().parentNode).ChildLast.Key==d.Key?d.NodeCrossEnd(!0):d.NodeCross(!0):d.ChildLast.NodeCrossEnd();this._LastFocus=null};this.NewNode=function(d,e,g,h){null!=this._LastFocus&&(this._NewNodeTemp={TEXT:d,CMD:e,REGEX:g,INFO:h},this.GetNode(this._LastFocus).NodeShow(!0),this.IsPostChange?this._NewNodeTimer=window.setInterval(function(){EWA.CurUI.IsPostChange||(window.clearInterval(EWA.CurUI._NewNodeTimer),EWA.CurUI._NewNode())},
100):this._NewNode())};this._NewNode=function(){var d=this._NewNodeTemp.TEXT,e=this._NewNodeTemp.CMD,g=this._NewNodeTemp.REGEX,h=this._NewNodeTemp.INFO;this._NewNodeTemp=null;var k=new EWA_TreeNodeClass;k.ewa=this;this._CurNewNode+=1;k.Key="NEW_NODE_"+this._Id+"__"+this._CurNewNode;k.RenameType="NEW";var l=_EWA_EVENT_MSG.OnTreeNodeNew+this._CurNewNode;null!=d&&0<d.trim().length&&(l=d.trim());k.Text=l;d=this.GetNode(this._LastFocus);0<d.Children.length&&d.Children[d.Children.length-1].NodeCross();
d.AddChild(k);this.Create(k);d.NodeShow(!0);this.Rename(k,e,g,h)};this.NewNodeAfter=function(d,e,g){var h=this.GetNodeById("NEW_NODE_"+this._Id+"__"+this._CurNewNode);h.SetKey(d);h.SetAddParameters(null==e?"":e);h.SetMenuGroup(null==g?"":g);d=this.TestIcon(h);h.SetBookIcon(d)};this.GetNodeById=function(d){d=$("#EWA_TREE_"+this._Id+' .ewa-tree-node[id="'+d+'"]');return 0==d.length?null:this.GetNode(d[0])};this.GetFocusNode=function(){return this.GetNode(this._LastFocus)};this.GetNode=function(d){if(null==
d||null==d.tagName)return null;var e=d;for(d=0;("TABLE"!=e.tagName||"1"!=e.getAttribute("EWA_T"))&&"EWA_TREE_ROOT"!=e.id;)if(e=e.parentNode,d++,33<d||"BODY"==e.tagName)return null;d=new EWA_TreeNodeClass;d.ewa=this;d.Key=e.id;d.MenuGroup=e.getAttribute("EWA_MG");d.Object=e;var g=e.rows[0].cells[2];d.Text=GetInnerText(g);for(var h=0;3>h;h+=1)d.AddParas[h]=g.childNodes[0].getAttribute("EWA_P"+h);h=e.getAttribute("EWA_TREE_MORE");d.IsMoreChildren="1"==h?!0:!1;if(1<e.rows.length){e=e.rows[1].cells[e.rows[1].cells.length-
1];for(h=0;h<e.childNodes.length;h=1+h)g=e.childNodes[h],3!=g.nodeType&&"TABLE"==g.tagName&&"1"==g.getAttribute("EWA_T")&&d.Children.push(this.GetNode(g));0<d.Children.length&&(d.ChildLast=d.Children[d.Children.length-1])}return d};this.Click=function(d,e){if(!this.IsPostChange&&(EWA.CurUI=this,d=d.srcElement?d.srcElement:d.target,"INPUT"!=d.tagName))if("DIV"==d.tagName&&(d=d.parentNode),"TD"==d.tagName&&0==d.className.indexOf("TD00")){var g=this.GetNode(d);g.NodeShow()}else{for(;("SPAN"!=d.tagName||
null==d.getAttribute("EWA_CMD"))&&"1"!=d.getAttribute("EWA_TREE_TOP");)if(d=d.parentNode,"BODY"==d.tagName)return;g=this.GetNode(d);if("SPAN"==d.tagName&&(null!=d.getAttribute("EWA_CMD")||"1"==d.getAttribute("EWA_TREE_TOP"))){null!=this._LastFocus&&(this.GetNode(this._LastFocus).Mark(!1),this._LastFocus=null);"1"!=d.getAttribute("EWA_TREE_TOP")&&g.Mark(!0);this._LastFocus=d;if(e)return d;0>this.Url.toUpperCase().indexOf("EWA_TREE_SKIP_GET_STATUS")&&EWA.F.ST.SaveStatus(g.Key,"TREE");this._RunCmd(g);
this.MoveNode(g.GetObject())}}};this._RunCmd=function(d){var e=this.GetNode(d.GetObject().parentNode);if(this.link)this.link(d.Key,d);else{console.warn('\u5efa\u8bae\u91c7\u7528\u5b9a\u4e49 EWA.F.FOS["xx"].link = function(nodeKey, node){}');e='link("'+d.Key+'","'+e.Key+'","'+d.Text.replace(/\n/mig,"\\n").replace(/\r/mig,"\\r").replace(/"/mig,"&quot;")+'"';for(var g=0;g<d.AddParas.length;g+=1)e=null==d.AddParas[g]?e+",null":e+(',"'+d.AddParas[g]+'"');EWA.C.Utils.RunCmd(e+");")}};this.ShowMenu=function(d){EWA.CurUI=
this;var e=this.Click(d,!0);null!=this.Menu&&null!=e&&(e=this.GetNode(e),this.Menu.ShowByMouse(d,e.MenuGroup))};this.TestIcon=function(d){if(null==this.Icons)return"TD01A";for(var e in this.Icons){var g=this.Icons[e],h=null;switch(g.TEST.toUpperCase()){case "KEY":h=d.Key;break;case "PARENTKEY":h=d.Parent.Key;break;case "TEXT":h=d.Text;break;case "P0":h=d.AddParas[0];break;case "P1":h=d.AddParas[1];break;case "P2":h=d.AddParas[2];break;case "MG":h=d.MenuGroup}if(null!=h&&eval("/"+g.FILTER+"/ig").test(h))return g.NAME+
"A"}return"TD01A"};this.Create=function(d,e){if(null!=d)if(null==d.Parent)this._CreateFirst(d);else{var g=this._HtmlTemplate.replace("[ID]",'id="'+d.Key+'"');g=g.replace("[TEMP_NODE_ADD_FIELDS]",this.AddCols||"");for(var h="",k=0;k<d.AddParas.length;k+=1)null!=d.AddParas[k]&&void 0!=d.AddParas[k]&&(h+="EWA_P"+k+'="'+d.AddParas[k].replace(/"/ig,"&quot;").replace(/</ig,"&lt;").replace(/</ig,"&gt;")+'" ');g=g.replace("[TMP_ADD_PARAS]",h);g=g.replace("[EWA_MENU_GROUP]",d.MenuGroup);h=this.TestIcon(d);
g=g.replace("[B]",h);g=g.replace("[C]",d.Text);g=d.IsMoreChildren?g.replace("[EWA_MORE_CHILDREN]","EWA_TREE_MORE='1'"):g.replace("[EWA_MORE_CHILDREN]","");0<d.Children.length||d.IsMoreChildren?(g=g.replace("[A]","TD00A"),g=d!=d.Parent.ChildLast?g.replace("[A1]","TD10B"):g.replace("[A1]","TD10A")):g=d==d.Parent.ChildLast?g.replace("[A]","TD00D"):g.replace("[A]","TD00C");h=d.Parent.GetObject();1==h.rows.length&&(k=h.insertRow(-1),k.insertCell(-1),k.insertCell(-1),k.cells[1].colSpan=2);k=this.GetNodeLvl(d.Parent);
g=g.replace("[LVL]",k+1);this._TempNode.innerHTML=g;g=this._TempNode.childNodes[0];h.rows[1].cells[h.rows[1].cells.length-1].appendChild(g);h.parentNode.childNodes[h.parentNode.childNodes.length-1]!=h&&(h.rows[1].cells[0].className="TD10B");d.Parent.NodeShow(!0);e&&e(g,this);for(k=0;k<d.Children.length;k+=1)this.Create(d.Children[k],e)}};this.GetNodeLvl=function(d){var e=d;if(d.Object.getAttribute("tree_lvl"))return 1*d.Object.getAttribute("tree_lvl");for(var g=0;100>g;g++)if(e=this.GetParentNode(e),
null==e)return d.Object.setAttribute("tree_lvl",g+1),g+1};this._CreateFirst=function(d,e){var g=this._HtmlTemplate1.replace("[ID]","id='"+d.Key+"'");g=g.replace("[B]",d.Text);this.ParentObject.innerHTML=g;for(g=0;g<d.Children.length;g+=1)this.Create(d.Children[g],e)};this.Init=function(d){var e=new EWA.C.Xml;e.LoadXml(d);this.Resources=new EWA_FrameResoures;this.Resources.Init(e);-1!=this.Url.toUpperCase().indexOf("EWA_TREE_INIT_KEY")||0<this.Url.toUpperCase().indexOf("EWA_TREE_SKIP_GET_STATUS")||
EWA.F.ST.GetStatus("TREE",this)};this.LoadStatus=function(){EWA.SHOW_ERROR=!1;this.ShowNode(_EWA_STATUS_VALUE)};this.ShowNode=function(d){if(null!=d&&""!=d&&"EWA_TREE_ROOT"!=d){var e=this.GetNodeById(d);null==e?(e=new EWA.F.Cmd,e.EWA_ACTION="OnTreeNodeStatus",e.EWA_AJAX="XML",e.EWA_TREE_KEY=d,e.EWA_TREE_STATUS="1",this._PostChange(e)):(this._StatusNode=e,this.ShowNodeA())}};this.ShowNodeA=function(){var d=this._StatusNode;this._StatusNode=null;for(var e=d.GetObject().parentNode,g=this.GetNode(e);"EWA_TREE_ROOT"!=
g.Key;)g.NodeShow(!0),g=this.GetNode(g.GetObject().parentNode);d.Mark(!0);this._LastFocus=d.GetObject();this._RunCmd(d);window.setTimeout(function(){e.focus()},0)};this.getUrlClass=function(){var d=new EWA_UrlClass;d.SetUrl(this.Url);return d};this.Reload=function(){}}
...
","+t.WF_UNIT_ADM_LST+",";g=k.split(",");for(h=0;h<g.length;h++)if(0<=u.indexOf(","+g[h]+",")){l=!0;break}if(!l)for(d in g=$J2MAP1(top.org,"DEP_POS_ID"),h=t.WF_UNIT_ADM_LST.split(","),u={},h)for(y in k=g[h[d]],k)m=k[y],u[m]||(u[m]=!0,c.push(k[y].ADM_NAME))}else if("WF_ADM_START"==t.WF_UNIT_ADM)if(u==t||g==u.ADM_ID)l=!0;else for(y in g=$J2MAP1(top.org,"ADM_ID"),k=g[u.ADM_ID],k)c.push(k[y].ADM_NAME);else"WF_ADM_MANAGER"==t.WF_UNIT_ADM&&(y=u.ADM_ID,top||top.ORG||(d="enus"==EWA.LANG?"No organization":
"\u6ca1\u6709\u7ec4\u7ec7\u673a\u6784",alert(d),l=!1),l=top.ORG.GetMaster(y).Id==g?!0:!1);e&&window.parent&&window.parent.$X(e)&&(y=window.parent.$X(e).parentNode.parentNode.parentNode,l?0<w.length&&(d=y.rows[y.rows.length-1].cells[0],g=window.parent.document.createElement("input"),g.type="button",g.value="enus"==EWA.LANG?"Back":"\u6253\u56de",g.onclick=function(){var z=window.parent.$X(e);z.options.length=1;for(var A=0;A<w.length;A++){var C=w[A];z.options[z.length]=new Option(C.DES,C.ID);this.style.display=
"none"}z.parentNode.parentNode.cells[0].innerHTML="enus"==EWA.LANG?'<div style="color:red">Back steps</div>':'<div style="color:red">\u8fd4\u56de\u6b65\u9aa4</div>'},d.insertBefore(g,d.getElementsByTagName("input")[1])):(0==c.length?(d="enus"==EWA.LANG?"Only view":"\u60a8\u53ea\u80fd\u67e5\u770b",window.parent.$X(e).parentNode.innerHTML="<b>"+d+"</b>"):(d="enus"==EWA.LANG?"Waitting":"\u7b49\u5f85",g="enus"==EWA.LANG?"or":"\u6216",window.parent.$X(e).parentNode.innerHTML="<b>"+d+':<span style="color:blue">'+
c.join("</span> "+g+' <span style="color:blue">')+"</span></b>"),window.parent.$X("butOk").style.display="none"),(d=_EWA_WF.WF_SHOW)&&showControls(y,d))}}
function showControls(a,b){for(var c=a.rows.length-5;0<=c;c--)0!=a.rows[c].id.indexOf("_ewa_tr$EWA_WF_")&&(a.rows[c].style.display="none");var d={},e=!1;for(c=0;c<b.length;c++)for(var g=b[c].XITEMS.split(","),h=0;h<g.length;h++){var k=g[h].trim();""==k||d[k]||(d[k]=1,e=!0)}if(e)for(var l in d)if(b=a.ownerDocument.getElementById("_ewa_tr$"+l))b.style.display=""}

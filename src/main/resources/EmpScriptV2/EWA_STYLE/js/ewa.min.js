...
!1;this.CheckedAllAfter=this.ReloadAfter=null;this.IsNotMDownAutoChecked=!1;this.switchButtonAction=function(a,b){if(b){var c=this.getUrlClass(),d={};d.ewa_switch_name=a.name;d.ewa_action=b;d.ewa_ajax="json";d.ewa_switch=a.checked?"on":"off";d.ewa_action_key=$(a).parentsUntil("tbody").last().attr("ewa_key");b=a.parentNode;var e=b.getAttributeNames(),g;for(g in e){var h=e[g],k=b.getAttribute(h);0!=h.indexOf("on")&&"name"!=h&&"id"!=h&&"class"!=h&&(d[h]=k)}var l=this;c=c.GetUrl();$JP(c,d,function(m){l.extSwitchCallBack&&
l.extSwitchCallBack(a,m)})}};this.replaceRowsData=function(a,b){var c=this.getUrlClass();c.AddParameter("EWA_AJAX","LF_RELOAD");c.AddParameter("EWA_IS_SPLIT_PAGE","no");c.AddParameter("EWA_IS_HIDDEN_CAPTION","yes");c=c.GetUrl();a&&(c+="&"+a);var d=$("#EWA_LF_"+this._Id);$J2(c,function(e){$(e).find("tr.ewa-lf-data-row").each(function(){var g=$(this).attr("ewa_key"),h=d.find('tr[ewa_key="'+g+'"]');$(this).find("td").each(function(){var k=$(this).children(0).attr("name");k&&(k=h.find(".ewa-col-"+k),
...
function(a){var b=new EWA_UrlClass(this.Url);$(a).attr("recycle")?(b=b.RemoveParameter("ewa_recycle"),$(a).attr("recycle",null).removeClass("ewa-lf-func-recycle-yes")):(b=b.AddParameter("ewa_recycle","1"),$(a).attr("recycle",1).addClass("ewa-lf-func-recycle-yes"));this.Url=b;this.Goto(1)};this.BindButton=function(a,b){$("#EWA_LF_"+this._Id+' tr[ewa_key] [id="'+a+'"]').each(function(){$(this).attr("onclick","$(this).parent().parent().find('[id=\""+b+"\"]')[0].click()");$(this).addClass("ewa-map-button")})};
this.Merge=function(a,b,c,d){$("#EWA_LF_"+this._Id+" tr[ewa_key]").each(function(){var e=$(this).find('[id="'+a+'"]');e.parent().hide();var g=$(this).find('[id="'+b+'"]').parentsUntil("tr").last();c||(c="<br>");0<=c.indexOf("<")?g.append(c):g.append("<span class='ewa-mearge-str'>"+c+"</span>");g.append(e);d&&d(g,this)});$("#EWA_LF_"+this._Id+' tr[ewa_tag="HEADER"] [id="'+a+'"]').parent().hide()};this.Mearge=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 Merge");this.Merge(a,
b,c)};this.MergeExp=function(a,b,c,d){if(b){var e=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),g=[],h=b,k={};for(b=0;b<e.length;b++){var l=e[b];g.push(l);var m=l.replace("@@","");h=h.replace(l,"<span class='ewa-lf-mearge ewa-lf-mearge-"+m+"' mid=\""+m+'"></span>');m!=a&&$("#EWA_LF_"+this._Id+' tr[ewa_tag="HEADER"] [id="'+m+'"]').parent().hide();k[m]=$("#EWA_LF_"+this._Id+' tr[ewa_tag="HEADER"] [id="'+m+'"]').html()}$("#EWA_LF_"+this._Id+" tr[ewa_key]").each(function(){var n=document.createElement("div");n.style.display=
"none";n.innerHTML=h;document.body.appendChild(n);if(0==$(this).find('[id="'+a+'"]').length)console.log("not find "+a);else{var p=$(this).find('[id="'+a+'"]').parent(),t;for(t in g){var r=g[t].replace("@@",""),q=$(this).find('[id="'+r+'"]');if(0!=q.length){r!=a&&q.parent().hide();var v=$(n).find('span[mid="'+r+'"]');c&&(v.append("<span class='ewa-lf-mearge-memo'></span>"),v.find(".ewa-lf-mearge-memo").html(k[r]));v.append(q)}}for(;0<n.childNodes.length;)p.append(n.childNodes[0]);$(n).remove();d&&
d(p,this)}})}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MeargeExp=function(a,b,c,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 MereExp");this.MergeExp(a,b,c,d)};this.SubBottoms=function(a){this.SubBottomsArray=a.split(",");this._SubBottoms()};this._SubBottoms=function(){var a=this.AddRow([]);$(a).find("td").addClass("ewa-lf-sub-td");var b=0,c;for(c in this.SubBottomsArray){var d=this.SubBottomsArray[c],e=0;$("#EWA_LF_"+this._Id+" .ewa-col-"+d).each(function(){var g=GetInnerText(this).replace(/,/ig,
"");isNaN(g)||(e+=1*g,0<g.indexOf(".")&&(b=2))});$(a).find("td[id=ADD_ROW_"+d+"]").html("<nobr class='ewa-lf-sub'>"+e.fm(b)+"</nobr>")}};this.ChangeRowStyle=function(a,b,c){for(var d=$X("EWA_LF_"+this._Id),e=1;e<d.rows.length;e++){var g=d.rows[e];if(!(0==g.cells.length||g.cells.length<=a)){var h=g.cells[a].childNodes[0].getAttribute(b);if(null!=h&&c[h])for(var k=0;k<g.cells.length;k++)g.cells[k].style.cssText=g.cells[k].style.cssText+";"+c[h]}}if(null==this.ReloadAfter){var l=this;this.ReloadAfter=
function(){l.ChangeRowStyle(a,b,c)}}};this.MDownEvent=function(a,b){};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.Workflow=function(a,b,c,d,e,g){EWA.F.CID=this._Id;this._Ajax=this.CreateAjax();this._Ajax.AddParameter("EWA_AJAX","WORKFLOW");this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_WF_NAME",b);null!=c?(a=this.GetRowKey(c),this._Ajax.AddParameter("EWA_ACTION_KEY",a),"true"==c.getAttribute("ewa_wf_control")?this._Ajax.AddParameter("EWA_WF_CTRL",
...
a.getElementsByTagName("input");if("INPUT"!=c.tagName&&0<g.length)for(c=0;c<g.length;c++){if("RADIO"==g[c].type.toUpperCase()){d=g[c];d.click();break}if("CHECKBOX"==g[c].type.toUpperCase()&&0>g[c].parentNode.className.indexOf("ewa-switch")){d=g[c];d.click();break}}}if("1"==a.getAttribute("__ewa_lf_mdown"))this._TrSelectMulti&&(d&&"CHECKBOX"==d.type.toUpperCase()&&(d.checked=!1),this._MSetBg(a,""),a.removeAttribute("__ewa_lf_mdown"),$(a).removeClass("ewa-lf-mdown"));else{d&&(d.checked=!0);this._MSetBg(a,
"down");a.setAttribute("__ewa_lf_mdown",1);$(a).addClass("ewa-lf-mdown");if(!this._TrSelectMulti&&(d=a.parentNode)&&d.rows)for(c=0;c<d.rows.length;c++)e=d.rows[c],"1"==e.getAttribute("__ewa_lf_mdown")&&e!=a&&(e.removeAttribute("__ewa_lf_mdown"),$(e).removeClass("ewa-lf-mdown"),this._MSetBg(e,""));if(this.IsReShow)for(c=0;c<g.length;c++)"BUTTON"==g[c].type.toUpperCase()&&(d=g[c],"true"==d.getAttribute("disabled")||1==d.getAttribute("disabled")||"true"==d.parentNode.getAttribute("disabled")||1==d.parentNode.getAttribute("disabled")?
...
d.style.display="none",e.id=("EWA_LF_NR_"+this._Id+"_"+Math.random()).replace(".","G"),$(d).addClass("ewa-lf-add-pre-row");this.prevTr&&(this.AddPreRowCloseBeforeEvent&&this.AddPreRowCloseBeforeEvent(this._Id,a,g,this.prevTr,b),this.prevTr.style.display="none",this.prevTr.cells[0].innerHTML="",this.AddPreRowCloseEvent&&this.AddPreRowCloseEvent(this._Id,a,g,this.prevTr,b));this.prevTr==d?this.prevTr=null:(this.prevTr=d,this.prevTr.style.display="",this.MDownEvent(this._Id,a,g,this.prevTr,b))}}else this.MDownEvent(a,

...
x=0;x<w._children.length;x++)y=w._children[x],m(y,v),n(y[e],v+1)},p={___ROOT___:[]};g={___ROOT___:{}};for(var q,u,t,r=0;r<a.length;r++){t=a[r];q=t[l];u=t[e];if(null===q||""===q||"0"===q)q="___ROOT___";p[q]||(p[q]=[]);p[q].push(t);g[u]=t;g[q]&&(g[q]._children||(g[q]._children=[]),g[q]._children.push(t))}n("___ROOT___",0)}else for(r=0;r<a.length;r++)t=a[r],m(t);h&&(b.value=h);$(b).trigger("change");k&&k(b)}
...
g+=h;var q=[];if("number"===typeof n.length&&!n.propertyIsEnumerable("length")){var u=n.length;for(m=0;m<u;m+=1)q[m]=d(m,n)||"null";var t=0===q.length?"[]":g?"[\n"+g+q.join(",\n"+g)+"\n"+p+"]":"["+q.join(",")+"]";g=p;return t}if("object"===typeof l)for(u=l.length,m=0;m<u;m+=1){var r=l[m];"string"===typeof r&&(t=d(r,n,l))&&q.push(b(r)+(g?": ":":")+t)}else for(r in n)(t=d(r,n,l))&&q.push(b(r)+(g?": ":":")+t);t=0===q.length?"{}":g?"{\n"+g+q.join(",\n"+g)+"\n"+p+"}":"{"+q.join(",")+"}";g=p;return t}}
...
"number"===typeof n.length)l=n;else throw Error("JSON.stringify");else l=function(u,t){if(Object.hasOwnProperty.call(this,u))return t};return d("",{"":m})},parse:function(m,n){function p(q,u){var t,r=q[u];if(r&&"object"===typeof r)for(t in r)if(Object.hasOwnProperty.call(r,t)){var w=p(r,t);void 0!==w?r[t]=w:delete r[t]}return n.call(q,u,r)}if(/^[\],:{}\s]*$/.test(m.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,
...
a.childNodes.length;b+=1)EWA$UI$COMMON.Dispose(a.childNodes[b])}},Drop:function(a){EWA$UI$COMMON.Dispose(a);a.parentNode.removeChild(a)},AniExpand:function(a,b,d,e,g){if(null==e||0>=e)e=10;var h=0,k=b/(1*e),l=d/(1*e),m=a.clientWidth+b,n=a.clientHeight+d,p=window.setInterval(function(){var q=EWA$UI$COMMON.GetObjSize(a);if(h<e-1){var u=q.H+l,t=q.W+k;u>n&&(u=n);t>m&&(t=m);EWA$UI$COMMON.SetSize(a,t,u)}else EWA$UI$COMMON.SetSize(a,m,n);t=EWA$UI$COMMON.GetObjSize(a);u=t.W-q.W;t=t.H-q.H;q=EWA$UI$COMMON.GetPosition(a);
q.Y=q.Y-a.clientHeight-1*a.style.borderTopWidth.replace("px","")-1*a.style.borderBottomWidth.replace("px","");"LEFT_TOP"!=g&&("LEFT_BOTTOM"==g?(t=q.Y-t,u=q.X,EWA$UI$COMMON.MoveTo(a,u,t)):"RIGHT_TOP"==g?(t=q.Y,u=q.X-u,EWA$UI$COMMON.MoveTo(a,u,t)):"RIGHT_BOTTOM"==g?(t=q.Y-t,u=q.X-u,EWA$UI$COMMON.MoveTo(a,u,t)):(t=1*q.Y-t/2,u=1*q.X-u/2,EWA$UI$COMMON.MoveTo(a,u,t),EWA._TmpAniObj=a));h++;h>=e&&(window.clearInterval(p),EWA.UI.Utils.AniExpandCompleateFunction&&(EWA.UI.Utils.AniExpandCompleateFunction(),
...
$X(b).innerHTML="";$X(b).className="ewa-metro-menu";$X(b).appendChild(m);$($X(b)).append('<div class="pop_title" style="display: none;"><div>-</div><p></p></div>');$($X(b)).css("background","transparent").css("border",0);m.align="center";var n=0,p=[];for(k=0;k<g;k++){var q=b+"_htr_"+k;l=m.insertRow(-1);l.id=q;var u=l.insertCell(-1);u.colSpan=e;l.style.display="none";u.id=q+"a";u=m.insertRow(-1);for(var t=0;t<e;t++){l=a[n];n++;var r=this.add_menu_item(u,l,h,n,d,q);l&&(r.id="M_"+l.id);r&&l&&(null==
...
e.toUpperCase(),h=a[d];this.Items[g]=h;var k=this.GetItemValue(h,"DataItem","Valid");k&&"MOBILE"==k.toUpperCase()?EWA.UI.Ext.Mobile($X(g)):k&&"IDCARD"==k.toUpperCase()&&EWA.UI.Ext.IdCard($X(g));b&&(g=this.GetItemValue(h,"DataItem","DisableOnModify"))&&"YES"==g.toUpperCase()&&(e=$X(e))&&(e.setAttribute("disabled","disabled"),e.getAttribute("DlsShow")&&$(e).prev().attr("disabled","disabled"))}};this.GetItem=function(a){a=a.toUpperCase().trim();return this.Items[a]};this.GetItemValue=function(a,b,d){if(null==
a)return null;a=this._ClassXml.GetElement(b+"/Set",a);return null==a?null:a.getAttribute(d)};this.GetDescription=function(a){a=$(this.GetItem(a)).find("DescriptionSet Set[Lang="+EWA.LANG+"]");return{Info:a.attr("Info"),Memo:a.attr("Memo")}};this.GetValue=function(a,b,d){a=this.GetItem(a);return this.GetItemValue(a,b,d)};this.CheckValid=function(a,b){if("SPAN"==a.tagName||"IMG"==a.tagName)return!0;var d=this.GetItem(a.id),e=[];if(null==b)return!0;var g=this._CheckMustInput(a,b,d);g?e.push(g):EWA_FrameRemoveAlert(a);
(g=this._CheckMaxMinLength(a,b,d))?e.push(g):EWA_FrameRemoveAlert(a);(g=this._CheckDataValid(a,b,d))?e.push(g):EWA_FrameRemoveAlert(a);(g=this._CheckDataType(a,b,d))?e.push(g):EWA_FrameRemoveAlert(a);(g=this._CheckMaxMinValue(a,b,d))?e.push(g):EWA_FrameRemoveAlert(a);(g=this._CheckPassword(a,b,d))?e.push(g):EWA_FrameRemoveAlert(a);(g=this._CheckExtent(a,b,d))?e.push(g):EWA_FrameRemoveAlert(a);if(0==e.length)return EWA_FrameRemoveAlert(a),!0;EWA_FrameShowAlert(a,e.join(", "));return!1};this._CheckExtent=
function(a,b,d){b=null;a=a.getAttribute("EWA_VALID_EX");a=null==a?"":a;0<a.length&&(b=a);return b};this._CheckDataType=function(a,b,d){if(""==b.trim())return null;var e=null;d=this.GetItemValue(d,"DataItem","DataType");null==d||"NUMBER"!=d.toUpperCase()&&"INT"!=d.toUpperCase()||(0<=b.indexOf(",")&&(b=b.replace(/,/ig,""),a.value=b),/^[0-9.-]{0,120}$/.test(b)||(e=_EWA_INFO_MSG["EWA.SYS.INVALID_NUMBER_FORMAT"]));return e};this._CheckPassword=function(a,b,d){if("input"!=a.tagName.toLowerCase()||"password"!=
a.type.toLowerCase())return null;d=$("#USR_PWD").parentsUntil("form").last().find("input[type=password]");b=null;for(var e=a.id,g=0;g<d.length;g+=1)if("password"==d[g].type&&d[g]!=a&&d[g].id==e+"1"){b=d[g];break}d=null;null!=b&&(b.value!=a.value?(isok=!1,d=_EWA_INFO_MSG["EWA.F.PASSWORD"]):EWA_FrameRemoveAlert(b));return d};this._CheckMustInput=function(a,b,d){var e=null;"1"==this.GetItemValue(d,"IsMustInput","IsMustInput")&&0==b.length&&(e=(e=_EWA_JS_ALERT.IsMustInput)?e.replace("{Name}",a.id):"*");
return e};this._CheckMaxMinLength=function(a,b,d){if(!b)return null;var e=this.GetItemValue(d,"MaxMinLength","MaxLength");d=this.GetItemValue(d,"MaxMinLength","MinLength");e=null==e?-1:parseInt(e);d=null==d?-1:parseInt(d);var g=!0;!isNaN(e)&&0<e&&b.length>e&&(g=!1);g&&!isNaN(d)&&0<d&&b.length<d&&(g=!1);b=null;g||(b=_EWA_JS_ALERT.MaxMinLength||this._EWA_JS_ALERT_DEFAULT.MaxMinLength,b=b.replace("{Name}",a.id),b=b.replace("{MaxLength}",e),b=b.replace("{MinLength}",d));return b};this._CheckDataValid=
function(a,b,d){a=this.GetItemValue(d,"DataItem","Valid");if(null==a||""==a.trim())return"";if(0<b.length)return a=_EWA_VALIDS[a.toUpperCase().trim()],null==a?"":a.REGEX.test(b)?"":a.MSG};this._CheckMaxMinValue=function(a,b,d){a=this.GetItemValue(d,"MaxMinValue","MaxValue");d=this.GetItemValue(d,"MaxMinValue","MinValue");var e=null==a||""==a.trim()?null:1*a,g=null==d||""==d.trim()?null:1*d,h=!0;null!=e&&(h=1*b<=e?!0:!1);null!=g&&(h=1*b>=g?h&1:!1);if(h)return"";errorInfo=_EWA_JS_ALERT.MaxMinValue||
this._EWA_JS_ALERT_DEFAULT.MaxMinValue;errorInfo=errorInfo.replace("{MaxValue}",a);return errorInfo=errorInfo.replace("{MinValue}",d)};this.GetObjectValue=function(a){var b=a.tagName.toUpperCase(),d=a,e="";if("DIV"==b&&"REPT"==a.getAttribute("TAG")){a=a.getElementsByTagName("input");for(var g=0;g<a.length;g+=1)a[g].checked&&(0<e.length&&(e+=","),e+=a[g].value);return e}if("DIV"==b&&"1"==a.getAttribute("EWA_DHTML"))return e=a.getElementsByTagName("iframe")[0].contentWindow,d=e.document.getElementsByTagName("textarea"),
e=0<d.length&&"none"!=d[0].style.display?d[0].value:e.frames[0].document.body.innerHTML,null!=location.search&&0>location.search.toUpperCase().indexOf("EWA_DHTML_HOST")&&(g="http:\\/\\/"+eval("document.location.host")),g=eval("/"+g+"/ig"),e=e.replace(g,""),a=a.getElementsByTagName("input")[0],a.value=e,a.value;if("SELECT"==b)return e="",0<=d.options.selectedIndex&&(e=d.options[d.options.selectedIndex].value),e;if("TEXTAREA"==b&&"none"==d.style.display)e=a.value;else if("INPUT"==b&&"IMG_UPLOAD"==d.getAttribute("ewa_tag"))e=
"/"!=EWA.CP?d.value.replace(EWA.CP,""):d.value,e=e.replace("//","/");else if("INPUT"==b&&d.getAttribute("val_ref")){a=d.getAttribute("val_ref");try{e=eval("(function(){var a="+a+";return a;})()")}catch(h){console.log(a),console.log(h),e=""}}else e="INPUT"!=b||"checkbox"!=d.type&&"radio"!=d.type?d.value:d.checked?d.value:"";return e}}function EWA_FrameResourceDescription(){this.Memo=this.Info=this.Lang=null}
...
$(this).on("change",function(){this.checked?k(this):l(this)}))});a="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");b=["<a class='ewa-filter-char ewa-filter-char-all' code=''>ALL</a>"];for(var t in a){var r=a[t],w=m[r];w&&b.push("<a class='ewa-filter-char' code='"+r+"'>"+r+"<span class='ewa-filter-char-num'>("+w.length+")</span></a>")}p.find(".EWA_TD_M").html(b.join(" "));e&&(n.find(".EWA_TD_L").hide(),n.find(".EWA_TD_M").attr("colspan",2));p.find("a.ewa-filter-char").on("click",function(){var v=$(this).attr("code");
...
for(var n in m)d[m[n]]=1;m=[];var p=[],q=a.id;for(n in e){var u=e[n],t=u[g];t&&(t=t.replace(/</ig,"&lt;"));var r=u[h];r&&(r=r.replace(/</ig,"&lt;"));var w=u[k],v=d[t],y=[];y.push("<nobr class='ewa-filter-chk' style='float:left;margin-right:4px'>");y.push('<input class="ewa-filter-chkbox" type="checkbox" ');v&&y.push(" checked ");u=q+"_"+n;y.push(' value="'+t+'" id="'+u+'" name="'+q+'"><label ');y.push(' for="'+u+'">'+r+"</label></nobr>");v?p.push(y.join("")):m.push(y.join(""));b&&(t=w?w.substring(0,
1).toUpperCase():"",l[t]||(l[t]=[]),l[t].push(u))}a.innerHTML=p.join(" ")+" "+m.join(" ");if(b){e=['<a href="javascript:void(0)">ALL</a>'];for(n="A".charCodeAt();n<="Z".charCodeAt();n++)g=String.fromCharCode(n),l[g]&&e.push('<a href="javascript:void(0)">'+g+"</a>");b.innerHTML=e.join(" ");$(b).find("a").each(function(){var x=$(this).text();"ALL"!=x&&$(this).attr("ids",l[x].join(","));$(this).on("click",function(){if("ALL"==$(this).text())$(a).find("nobr.ewa-filter-chk").show();else{var z=$(this).attr("ids").split(","),
...
m.find("td:eq(0)").html(b));if(0==l.length)alert("target parent not exists");else{var n="border-box"==g.css("box-sizing")?0:1*g.css("padding-left").replace("px","")+1*g.css("padding-right").replace("px",""),p="border-box"==g.css("box-sizing")?0:1*h.css("padding-left").replace("px","")+1*h.css("padding-right").replace("px","");e.find(".ewa-row-"+a).hide();null==d&&(d=" - ");var q=l.width(),u=g[0].tagName,t=h[0].tagName;g.parent().hasClass("ewa-select-filter-target")&&(g=e.find(".ewa-row-"+a+" .EWA_TD_M table:eq(0)"),
u="SELECT_WITH_FILTER");var r=0;b=null;d&&(l.append('<span class="mearge-span">'+d+"</span>"),k&&m.find("table:eq(0) td:eq(1)").html('<span class="mearge-span">'+d+"</span>").show(),b=l.find(".mearge-span"),r=b.width()+1+1*b.css("padding-left").replace("px","")+1*b.css("padding-right").replace("px","")+1*b.css("margin-left").replace("px","")+1*b.css("margin-right").replace("px",""));u==t?(d=(q-r)/2-n-2,g.css("width",d),h.css("width",d),k&&m.find("table:eq(0) td:eq(2), table:eq(0) td:eq(0)").css("width",
d)):"SELECT"==u?(g.css("width",100),h.css("width",q-r-n-p-2-2-g.width())):"SELECT_WITH_FILTER"==u?(g.css("width",200),h.css("width",q-r-n-p-2-2-g.width())):"SELECT"==t&&(h.css("width",100),g.css("width",q-r-n-p-2-2-g.width()));h.css("float","left");b&&b.css("float","left");g.css("float","right");l.append(g);l.addClass("ewa-frame-merge");k&&(a=e.find(".ewa-row-"+a+" .EWA_TD").html(),m.find("table:eq(0) td:eq(2)").html(a))}}}};this.MergeExp=function(a,b,d,e){if(b){var g=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),
...
b.value));e.PostNew(n,function(){if(e.IsRunEnd()){var q=e.GetRst(),u="__json"+Math.random();try{eval('window["'+u+'"]='+q)}catch(v){b.setAttribute("canopen",0);a.value=v;b.setAttribute("canopen",1);return}q=window[u];if(0!=q.length){u=q[0];var t=[];q={};for(var r in u)t.push(u[r]),q["@"+r.toUpperCase()]=u[r],u[r]&&b.setAttribute("para_"+r.toLowerCase(),u[r]);if(null==d||""==d)q=t.join("/");else{r=d.match(/@[a-zA-Z0-9\-\._:]*\b/ig);for(u=0;u<r.length;u++){t=r[u];var w=q[t.toUpperCase()];d=d.replace(t,
...
"");else{this.focus();$(this).css("background","pink");return}}q=this.id;u=this.value;"droplist"==$(this).attr("ewa_class")&&(u=$(this).next().val(),q=$(this).next().attr("id"));q={key:q,val:u};if("rgb(255, 255, 224)"==p)$Tip(n.html()),l.hide(),this.focus();else if(this.value==$(this).attr("oldv"))$(this).attr("style",""),l.hide();else{var t=this;$JP(m.POST_URL||window.location.href,q,function(r){$(t).attr("style","");l.hide();r.RST?(r="SELECT"==t.tagName?t.options[t.selectedIndex].text:t.value,"TEXTAREA"==
t.tagName?""==r?b.html("............."):(r=r.replace(/</ig,"&lt;").replace(/>/ig,"&gt;"),r="<div>"+r.split("\n").join("</div><div>")+"</div>",b.html(r)):(""==r&&(r="............."),b.text(r)),b.append('<i style="margin-left:5px" class="fa fa-edit"></i>'),$TipTL("\u4fdd\u5b58\u5b8c\u6bd5")):$Tip(r.ERR)})}})}}}
...
(g=b.join("<span class='ewa-lf-merge-header-split'></span>"),h.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(g));h.find("tr[ewa_key]").each(function(){if(0==$(this).find('[id="'+a+'"]').length)console.log("not find "+a);else{var t=$(this).find('[id="'+a+'"]').parent();if("yes"!=t.attr("ewa-merged")){t.attr("ewa-merged","yes");var r=$('<div style="display:none"></div>');r.html(m);for(var w in l){var v=l[w].replace("@@",""),y=$(this).find('[id="'+v+'"]');if(0!=y.length){v!=a&&y.parent().hide();var x=
r.find('span[mid="'+v+'"]');d&&(x.append("<span class='ewa-lf-mearge-memo'></span>"),x.find(".ewa-lf-mearge-memo").html(n[v]));x.append(y)}}for(;0<r[0].childNodes.length;)t.append(r[0].childNodes[0]);$(r).remove();e&&e(t,this)}}})}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MeargeExp=function(a,b,d,e){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 MereExp");this.MergeExp(a,b,d,e)};this.SubBottoms=function(a){this.SubBottomsArray=a.split(",");this._SubBottoms()};this._SubBottoms=
function(){var a=$("#EWA_LF_"+this._Id).find(".ewa-lf-sub-tr");0==a.length?(a=$(this.AddRow([])),a.addClass("ewa-lf-sub-tr"),a.find("td").addClass("ewa-lf-sub-td")):a.find("td").text("");var b=0,d;for(d in this.SubBottomsArray){var e=this.SubBottomsArray[d],g=0;$("#EWA_LF_"+this._Id+" .ewa-col-"+e).each(function(){var h=GetInnerText(this).replace(/,/ig,"");isNaN(h)||(g+=1*h,0<h.indexOf(".")&&(b=2))});a.find("td[id=ADD_ROW_"+e+"]").html("<nobr class='ewa-lf-sub'>"+g.fm(b)+"</nobr>")}};this.ChangeRowStyle=
function(a,b,d){for(var e=$X("EWA_LF_"+this._Id),g=1;g<e.rows.length;g++){var h=e.rows[g];if(!(0==h.cells.length||h.cells.length<=a)){var k=h.cells[a].childNodes[0].getAttribute(b);if(null!=k&&d[k])for(var l=0;l<h.cells.length;l++)h.cells[l].style.cssText=h.cells[l].style.cssText+";"+d[k]}}if(null==this.ReloadAfter){var m=this;this.ReloadAfter=function(){m.ChangeRowStyle(a,b,d)}}};this.MDownEvent=function(a,b){};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};
this.Workflow=function(a,b,d,e,g,h){EWA.F.CID=this._Id;this._Ajax=this.CreateAjax();this._Ajax.AddParameter("EWA_AJAX","WORKFLOW");this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_WF_NAME",b);null!=d?(a=this.GetRowKey(d),this._Ajax.AddParameter("EWA_ACTION_KEY",a),"true"==d.getAttribute("ewa_wf_control")?this._Ajax.AddParameter("EWA_WF_CTRL",1):this._Ajax.AddParameter("EWA_WF_CTRL",0)):this._Ajax.AddParameter("EWA_WF_CTRL",1);null!=e&&this._Ajax.AddParameter("EWA_ACTION_KEY",
e);g&&this._Ajax.AddParameter("EWA_WF_UOK",g);h&&this._Ajax.AddParameter("EWA_WF_UMSG",h);var k=this;this._Ajax.PostNew(this.Url,function(){k._CallBackJs()})};this.GetRowKey=function(a){a=this.GetRow(a);return null!=a?a.getAttribute("EWA_KEY"):null};this.GetRow=function(a){if(null==a||null==a.tagName||""==a.tagName)return null;var b=0;for(a=a.parentNode;"TR"!=a.tagName||null==a.getAttribute("EWA_KEY");){a=a.parentNode;if("BODY"==a.tagName){a=null;break}b++;if(100<b){alert("\u5faa\u73af100\u6b21\uff0c\u672a\u53d1\u73b0TR");
break}}return a};this.RecordModify=function(a,b,d){var e=this.SelectChecked();if(0==e.length)EWA.UI.Msg.Alter("\u8bf7\u5148\u9009\u62e9","\u4fee\u6539");else{var g="EWA_MTYPE=M";null!=d&&0<d.trim().length&&(g+="&"+d);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,g+e)}};this.RecordNew=function(a,b,d){var e="EWA_MTYPE=N";null!=d&&0<d.trim().length&&(e+="&"+d);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,e)};this.SelectSingle=function(){this.IsTrSelect=!0;this._TrSelectMulti=!1};this.SelectMulti=function(){this._TrSelectMulti=
this.IsTrSelect=!0};this.MOver=function(a,b){if(this.IsTrSelect&&this._CurTr!=a&&(null!=this._CurTr&&("1"!=this._CurTr.getAttribute("__ewa_lf_mdown")?this._MSetBg(this._CurTr,""):this._MSetBg(this._CurTr,"down")),"1"!=a.getAttribute("__ewa_lf_mdown")?this._MSetBg(a,"over"):this._MSetBg(a,"down"),this._CurTr=a,this.MOverEvent))try{this.MOverEvent(a,b)}catch(d){console.log(d,this.MOverEvent)}};this.MOut=function(a){if(this.IsTrSelect&&null!=this._CurTr&&"1"!=this._CurTr.getAttribute("__ewa_lf_mdown")){this._MSetBg(this._CurTr,
"out");if(this.MOutEvent)try{this.MOutEvent(this._CurTr,a)}catch(b){console.log(b,this.MOutEvent)}this._CurTr=null}};this.MDownEnableCheck=function(a,b){return!0};this.checkMDownEnable=function(a,b){if(!b)return!0;b=b.srcElement?b.srcElement:b.target;return!b||"TD"==b.tagName&&b.parentNode==a?!0:"A"==b.tagName||"A"==b.parentNode.tagName||"INPUT"==b.tagName||"SELECT"==b.tagName||"BUTTON"==b.tagName||"TEXTAREA"==b.tagName||0<=b.className.indexOf("EWA_LF_EDIT")||0<=b.className.indexOf("ewa-lf-edit")||
0<=b.className.indexOf("ewa-lf-search-text-click")||0<=b.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=b.parentNode.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=b.className.indexOf("ewa-mdown-stop")?!1:!0};this.mDownAutoCheck=function(a,b,d){for(var e,g=0;g<b.length&&!(0<=b[g].parentNode.className.indexOf("ewa-switch"));g++){if("RADIO"==b[g].type.toUpperCase())return e=b[g],e.click(),e;if("CHECKBOX"==b[g].type.toUpperCase()){e=b[g];e.click();if(!this._TrSelectMulti){var h=
$(b[g]).attr("id")||$(b[g]).attr("name");0==$(d).find(b[g]).length&&$(a).siblings(".ewa-lf-data-row").find("input[name='"+h+"']:checked").prop("checked",!1);e.checked=!0}return e}}return null};this.MDown=function(a,b){if(this.IsTrSelect){var d=(new Date).getTime(),e=$(a).attr("mdown_time_last");if(!(null!=e&&500>d-e)&&($(a).attr("mdown_time_last",d),b=null==b?window.event:b,this.MDownEnableCheck(a)&&this.checkMDownEnable(a,b))){e=b.srcElement?b.srcElement:b.target;var g=null;d=a.getElementsByTagName("input");
this.IsNotMDownAutoChecked||(g=this.mDownAutoCheck(a,d,e));if("1"==a.getAttribute("__ewa_lf_mdown"))this._TrSelectMulti&&(g&&"CHECKBOX"==g.type.toUpperCase()&&(g.checked=!1),this._MSetBg(a,""),a.removeAttribute("__ewa_lf_mdown"),$(a).removeClass("ewa-lf-mdown"));else{g&&(g.checked=!0);this._MSetBg(a,"down");a.setAttribute("__ewa_lf_mdown",1);$(a).addClass("ewa-lf-mdown");if(!this._TrSelectMulti&&(g=a.parentNode)&&g.rows)for(e=0;e<g.rows.length;e++){var h=g.rows[e];"1"==h.getAttribute("__ewa_lf_mdown")&&
h!=a&&(h.removeAttribute("__ewa_lf_mdown"),$(h).removeClass("ewa-lf-mdown"),this._MSetBg(h,""))}if(this.IsReShow)for(e=0;e<d.length;e++)"BUTTON"==d[e].type.toUpperCase()&&(g=d[e],"true"==g.getAttribute("disabled")||1==g.getAttribute("disabled")||"true"==g.parentNode.getAttribute("disabled")||1==g.parentNode.getAttribute("disabled")?(this._ReshowButs[g.value].disabled=!0,this._ReshowButs[g.value].style.display="none"):(this._ReshowButs[g.value].disabled=!1,this._ReshowButs[g.value].style.display=""))}if(this._IsAddPreRow){if(d=
a.getAttribute("ewa_key"),this.AddPreRowCheck(a,d,b)){g=a.parentNode.rows[a.rowIndex+1];if(null==g||1!=g.getAttribute("add_pre_row"))g=a.parentNode.parentNode,e=g.rows[0].cells.length,g=g.insertRow(a.rowIndex+1),g.setAttribute("add_pre_row",1),h=g.insertCell(-1),h.colSpan=e,h.className="ewa-lf-add-pre-cell",g.style.display="none",h.id=EWA_Utils.tempId("EWA_LF_NR_"+this._Id),$(g).addClass("ewa-lf-add-pre-row");this.prevTr&&(this.AddPreRowCloseBeforeEvent&&this.AddPreRowCloseBeforeEvent(this._Id,a,
d,this.prevTr,b),this.prevTr.style.display="none",this.prevTr.cells[0].innerHTML="",this.AddPreRowCloseEvent&&this.AddPreRowCloseEvent(this._Id,a,d,this.prevTr,b));this.prevTr==g?this.prevTr=null:(this.prevTr=g,this.prevTr.style.display="",this.MDownEvent(this._Id,a,d,this.prevTr,b))}}else this.MDownEvent(a,b)}}};this.AddPreRow=function(a){this._IsAddPreRow||(this.MDownEvent=a);this._IsAddPreRow=!0};this.AddPreRowCheck=function(a,b,d){return!0};this.AddPreRowCloseBeforeEvent=function(a,b,d,e,g){};
this.AddPreRowCloseEvent=function(a,b,d,e,g){};this._MSetBg=function(a,b){var d="EWA_TD_M";"down"==b?d="ewa_grid_down":"over"==b&&(d="ewa_grid_mover");for(b=0;b<a.cells.length;b++)$(a.cells[b]).removeClass("ewa_grid_mover ewa_grid_down EWA_TD_M").addClass(d)};this._ReShowSearchQuick=function(){var a=this,b=EWA_ListFrameClass.prototype.RESOURCES.search_text_items,d,e,g;for(g in b){var h=b[g];"eq"==h.Id&&(d=h);"lk"==h.Id&&(e=h)}for(g in this._SearchJson){var k=this._SearchJson[g];k.isSearchQuick&&(b=
$("#EWA_LF_"+this.Id+' .ewa-lf-data-row [id="'+g+'"]'),b.bind("click",function(l){l.stopPropagation();l=$(this).attr("search_tag");var m=$(this).text(),n=m,p=$("#EWA_SEARCH_ITEM_"+a.Id+' .ewa-lf-search-item-ctl [name="'+this.id.toUpperCase()+'"]');if("number"==l||"date"==l)p=p.parentsUntil(".ewa-lf-search-item").last().find("input");var q=p.parentsUntil(".ewa-lf-search-item").last().find("a");if("date"==l)m=m.split(" ")[0],n=m+" 23:59:59";else if("fix"==l){var u=null;p.find("option").each(function(){this.text==
m&&(u=this.value)});m=null===u?"":u}p.val()==m?("text"==l&&e&&0<q.length&&(q.attr("tag",e.Id),q.html("enus"==EWA.LANG?e.TxtEn:e.Txt)),p.val("")):("text"==l&&d&&0<q.length&&(q.attr("tag",d.Id),q.html("enus"==EWA.LANG?d.TxtEn:d.Txt)),p.val(m),"date"==l&&(p[1].value=n))}),b.each(function(){$(this).text()&&$(this).addClass("ewa-lf-search-text-click").attr("search_tag",k.T)}))}};this.ReShowWithNoButtons=function(){var a=$X("EWA_LF_"+this._Id),b=[],d;for(d in this.ItemList.Items){var e=this.ItemList.Items[d],
g=this._GetSubValue("Tag","Tag",e);if(null!=g&&"button"==g.trim().toLowerCase())for(g=0;g<a.rows[0].cells.length;g++)if(a.rows[0].cells[g].childNodes[0].id.toUpperCase()==d){b.push(g);e.setAttribute("but_show","1");break}}this.ShowHiddenColumns(b,!1)};this.ReShowButtonsInDailogTitle=function(){EWA.OW.Load();if(EWA.OW.Dia){var a=$(EWA.OW.Dia._Dialog.GetFrameTitle()),b=$($X("EWA_RESHOW_"+this._Id)).find("td.ewa_lf_func:eq(0)"),d=this;b.find(".ewa_lf_func_dact").each(function(){this.id=EWA_Utils.tempId("gDx_"+
d._Id+"_")});a.html(b.html());a.find(".ewa_lf_func_dact").each(function(){this.onclick=function(){b.find('div[id="'+this.id+'"]').click()}});b.parent().hide();$(EWA.OW.Dia._Dialog.GetFrame()).addClass("ewa-lf-btns-in-title")}};this.ReShow=function(a){this.IsReShow=!0;var b="_G_"+this._Id;this.NewDivId=b;a=[];a.push("<table class='ewa-lf-reshow' id='EWA_RESHOW_"+this._Id+"'>");a.push("<tr style='display:none'><td style='padding:0'></td></tr>");a.push("<tr><td class='ewa_lf_func' style='padding:0'>");
a.push("<div style='display:none'></div>");a.push("<div><div style='cursor:pointer' class='ewa_lf_func_caption'></div></div>");a.push("</td></tr>");a.push("<tr><td style='width:100%;padding:0;vertical-align:top'>");a.push("<div id='"+b+"' style=''></div>");a.push("</td></tr>");a.push("</table>");var d=$(a.join("")),e=!(0<this.Url.toUpperCase().indexOf("EWA_AJAX=INSTALL")||0<this.Url.toUpperCase().indexOf("EWA_CALL_METHOD=INNER_CALL")||0<this.Url.toUpperCase().indexOf(".JSP"));e?EWA.UI.Utils.SetStyle(d[0],
"width:100%;height:100%;border-spacing:0"):EWA.UI.Utils.SetStyle(d[0],"width:100%;border-spacing:0");css="";var g=$X("EWA_LF_"+this._Id);a=g.parentNode.parentNode;var h=g.parentNode;d.find("td:eq(2)>div").append(h);h=d[0];var k=d.find("tr:eq(0)")[0],l=d.find("td:eq(0)")[0],m=d.find("td:eq(1)")[0],n=d.find("td:eq(2)")[0];e&&(window.setTimeout(function(){$X("__EWA_DEBUG")&&n.childNodes[0].appendChild($X("__EWA_DEBUG"));var B=$X(b);B.getElementsByTagName("table");var D=EWA.UI.Utils.GetDocSize(window),
...
this.ItemList.Items[q],t=this._GetSubValue("Tag","Tag",u);if(t&&("button"==t.toLowerCase()||"butflow"==t.toLowerCase())&&(t=this._GetSubValue("Name","Name",u),0!==g.find(".ewa-col-"+t).length)){p=!0;var r=this._GetSubValue("DescriptionSet","Info",u),w=this._GetSubValue("DescriptionSet","Memo",u),v=this._GetSubValue("EventSet","EventName",u),y="";null!=v&&"ewa_click"==v.toLowerCase().trim()&&(y=this._GetSubValue("EventSet","EventValue",u));e=e.replace(r,"");u=this._ReShowButton(r,w,null);this._ReshowButs[r]=
u;u.setAttribute("f_id",this._Id);u.setAttribute("t_id",t);m.childNodes[1].appendChild(u);""==y?u.setAttribute("onclick","EWA.F.FOS['"+this._Id+"'].reShowButtonClick(this)"):u.setAttribute("onclick",y)}}p&&this._ReShowSplit(m.childNodes[1]);t=m.getElementsByTagName("input");p={};for(g=0;g<t.length;g++){var x=t[g];x.style.display="none";if(null==x.id||""==x.id)x.id=("_tmp_"+Math.random()).replace(".","_");if("button"==x.type){if(u=this._ReShowButton(x.value,x.title,x.id),r=x.nextSibling){var z="";
3==r.nodeType&&(z=r.nodeValue.trimEx());"|"==z&&this._ReShowSplit(m.childNodes[1])}}else(r=x.nextSibling)&&(z=3==r.nodeType?r.nodeValue.replace("|",""):r.innerHTML),u=this._ReShowButton(z.trimEx(),x.title,x.id),u.id=("_tmp_"+Math.random()).replace(".","_"),p[x.name]||(p[x.name]=[]),p[x.name].push(u.id);m.childNodes[1].appendChild(u)}e=e.replace(/ /ig,"").replace(/\|/ig,"").trimEx();""!=e?0<=e.indexOf("if")?k.style.display="none":l.innerHTML=e.replace(/ /,""):k.style.display="none";a.appendChild(h);
...
this.Id,b=[],d=[],e=[],g={},h;for(h in this._SearchJson)this._SearchJson[h].ORI_NAME=h,g[h.toUpperCase()]=this._SearchJson[h];this._SearchJson=g;var k="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextType(this)",l="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchDateType(this)",m=$J2MAP(this.RESOURCES.search_text_items,"Id");g=this._GetInitSearchMap();var n=!1,p=!1;for(h in this.ItemList.Items)if(null!=this._SearchJson[h]){var q=[],u=this._SearchJson[h],t=u.T,r=this._GetSubValue("DescriptionSet",
"Info",this.ItemList.Items[h]);q.push("<table class='ewa-lf-search-item ewa-ref-"+h+" ewa-lf-search-type-"+t+" "+("fix"==t?"ewa-lf-search-fix-m"+(u.M||"0"):"")+"' cellspacing=0 cellpadding=0>");q.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");q.push(r);var w=r="",v="lk";g[h.toUpperCase()]&&(w=g[h.toUpperCase()],v=w.tag,r=w.para1,w=w.para2);var y="";"text"==t?(p=m[v]||m.lk,y="enus"==EWA.LANG?p.TxtEn:p.Txt,q.push("<a class='ewa-lf-search-type' tag='"+v+"' href='javascript:void(0)' onclick='"+
k+"'>"),q.push(y),q.push("</a>"),p=!0):"date"==t&&(q.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+l+"'></a>"),n=!0);q.push("</b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==t?"blk"==v||"nblk"==v?(u=this._SearchSingle(h,y),u=u.replace("<input","<input disabled "),q.push(u)):q.push(this._SearchSingle(h,r)):"date"==t?q.push(this._SearchDate(h,r,w)):"number"==t?q.push(this._SearchNumber(h,r,w)):"fix"==t&&(u="<div >"+this._SearchFix(h,u,"span",r)+"</div>",
q.push(u));q.push("</td></tr></table>");"fix"==t?d.push(q.join("")):e.push(q.join(""))}if(0!=e.length+d.length){b.push('<table class="ewa-lf-search-main" id="'+a+'" cellspacing="0" cellpadding="0" style="width:100%">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");0<e.length&&b.push(" "+e.join("")+" ");if(0<d.length)for(e=0;e<d.length;e++)b.push(" "+d[e]+" ");b.push("</td></tr></table>");var x=document.createElement("div");this._SEARCH_BOX=x;x.className="ewa-lf-search";x.innerHTML=b.join("");
...
b.animate(t,"fast","swing",function(){b[0].style.cssText="";var r=1*b.attr("st");document.body.scrollTop=r;1==$("#crm_left_box").attr("show")&&$("#crm_left_box").show();b.css("display",b.attr("dsp"));0<e.length&&"DES_plugin"!=a?e[0].click():(r=$X(a.replace("DES_","")),r.style.width=r.parentNode.clientWidth-10+"px",r.style.height=t.height-30+"px",d.find('div[id="EWA_FRAME_MAIN"]').css("height",t.height-150))});else{b.attr("full","1");b.attr("st",document.body.scrollTop);b.attr("dsp",b.css("display"));
var h=document.documentElement.clientHeight;g=document.documentElement.clientWidth-10;var k=h-20,l=document.documentElement.clientWidth-30,m=h-20-20-15;h=b.offset();var n=b.position(),p=h.left-n.left,q=b.width(),u=b.height();var t={width:q,height:u,"margin-left":p,left:n.left,top:n.top};b.attr("ori",JSON.stringify(t));b.css({"margin-left":"0px",top:h.top,left:h.left,position:"absolute",display:"",overflow:"auto"});b.animate({width:g,height:k,left:10,top:0},"fast","swing",function(){d.css("width",
...
function loadWfShow(a,b,d,e,g,h,k,l,m,n){_EWA_WF&&_EWA_WF.EN&&(_EWA_WF.EN1=$J2MAP(_EWA_WF.EN,"WF_UNIT_ID"));e=document.createElement("div");e.style.position="absolute";e.style.zIndex=123;e.innerHTML="ver: "+_EWA_WF.WF_DLV_VER;document.body.appendChild(e);var p=EWAC_WfUtil.WF,q=1000012,u=1000011;for(e=0;e<a.length;e++){var t=a[e],r=t.WF_UNIT_X,w=t.WF_UNIT_Y;null!=r&&1*r<q&&(q=1*r);null!=w&&1*w<u&&(u=1*w)}1000012==q&&(q=0);1000011==u&&(u=0);q-=10;u-=10;n={};var v;for(e=0;e<a.length;e++)t=a[e],p.Ids[e]=
t.WF_UNIT_ID,r=p.CreateUnit(),n[t.WF_UNIT_ID]=r,w=t.WF_UNIT_NAME,"enus"==EWA.LANG&&_EWA_WF.EN1&&_EWA_WF.EN1[t.WF_UNIT_ID]&&_EWA_WF.EN1[t.WF_UNIT_ID].WF_UNIT_NAME_EN&&(w=_EWA_WF.EN1[t.WF_UNIT_ID].WF_UNIT_NAME_EN),r.ChangeDes(w),r.ChangeType(t.WF_UNIT_TYPE),r.WF_UNIT_ADM=t.WF_UNIT_ADM,r.WF_UNIT_ADM_LST=t.WF_UNIT_ADM_LST,r=t.WF_UNIT_X,w=t.WF_UNIT_Y,t=$X(t.WF_UNIT_ID),null!=r&&(t.style.left=r-q+"px"),null!=w&&(t.style.top=w-u+"px");a={};for(e=0;e<b.length;e++)t=b[e],r=t.WF_UNIT_FROM,a[r]||(a[r]=[]),a[r].push(t);
for(e=0;e<b.length;e++)t=b[e],a=t.WF_UNIT_TO,r=t.WF_UNIT_FROM,r=p.Units[r],a=p.Units[a],q=new EWAC_WfCnn,q.Create(r,a),p.Cnns[q.Id]=q,t.IsHaveLogic&&!t.IsLogicOk&&(q.IsStop=!0);for(var y in p.Units)e=p.Units[y],null==v&&0==e.CnnsToLength&&(v=e);if(null==v)k="enus"==EWA.LANG?"No startup node was found, process definition error":"\u672a\u53d1\u73b0\u542f\u52a8\u8282\u70b9,\u6d41\u7a0b\u5b9a\u4e49\u9519\u8bef",alert(k);else{0==d.length&&(p.CurUnit=v);var x=[];y={};for(e=0;e<d.length;e++)b=d[e],p=b.SYS_STA_TAG,
r=n[p],null!=r&&(t=b.ADM_NAME,"enus"==EWA.LANG&&b.ADM_NAME_EN&&(t=b.ADM_NAME_EN),r.Log(t,b.SYS_STA_CDATE,b.SYS_STA_MEMO),y[p]||(y[p]=1,x.push({ID:p,DES:r.GetDes()})),p=b.SYS_STA_TAG+"G"+b.SYS_STA_VAL,EWAC_WfUtil.WF.Cnns[p]&&(EWAC_WfUtil.WF.Cnns[p].Disp(3,"blue"),r==v&&(r.ADM_ID=b.ADM_ID),e==d.length-1&&(p=n[b.SYS_STA_VAL],p.WF_UNIT_ADM_LST=b.ROLE_IDS,p.WF_UNIT_ADM=b.ROLE_TYPE,EWAC_WfUtil.WF.CurUnit=p)));null!=m&&0<m.length&&n[m]&&(EWAC_WfUtil.WF.CurUnit=n[m]);EWAC_WfUtil.WF.CurUnit.LogCur(g);m=!1;
r=EWAC_WfUtil.WF.CurUnit;d=[];if(v==r)m=!0;else if("WF_ADM_ADM"==r.WF_UNIT_ADM)if(v=","+r.WF_UNIT_ADM_LST+",",0<=v.indexOf(","+h+","))m=!0;else for(e in h=$J2MAP1(top.org,"ADM_ID"),k=r.WF_UNIT_ADM_LST.split(","),k){l=h[k[e]];for(var z in l)d.push(l[z].ADM_NAME)}else if("WF_ADM_DEPT"==r.WF_UNIT_ADM)if(v=","+r.WF_UNIT_ADM_LST+",",0<=v.indexOf(","+k+","))m=!0;else for(e in h=$J2MAP1(top.org,"DEP_ID"),k=r.WF_UNIT_ADM_LST.split(","),k)for(z in l=h[k[e]],l)d.push(l[z].ADM_NAME);else if("WF_ADM_POST"==r.WF_UNIT_ADM)if(v=
","+r.WF_UNIT_ADM_LST+",",0<=v.indexOf(","+l+","))m=!0;else for(e in h=$J2MAP1(top.org,"POS_ID"),k=r.WF_UNIT_ADM_LST.split(","),k)for(z in l=h[k[e]],l)d.push(l[z].ADM_NAME);else if("WF_ADM_START"==r.WF_UNIT_ADM){if(v==r||h==v.ADM_ID)m=!0}else"WF_ADM_MANAGER"==r.WF_UNIT_ADM&&(z=v.ADM_ID,top||top.ORG||(k="enus"==EWA.LANG?"No organization":"\u6ca1\u6709\u7ec4\u7ec7\u673a\u6784",alert(k),m=!1),m=top.ORG.GetMaster(z).Id==h?!0:!1);g&&window.parent&&window.parent.$X(g)&&(z=window.parent.$X(g).parentNode.parentNode.parentNode,

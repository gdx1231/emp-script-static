...
EWA_Utils.JsRegister=function(a){var b=document.getElementsByTagName("head")[0],d=document.createElement("script");d.type="text/javascript";d.language="javascript";try{d.text=a,b.appendChild(d)}catch(e){alert(e)}};EWA_Utils.LazyBackgroundLoad=function(a,b){var d=b||$(window).height()+$(window).scrollTop()+50;(a||$(".EWA_GRID_BG_IMG[is_lazy_load=true]")).each(function(){var e=$(this);if(e.offset().top<d){e.removeAttr("is_lazy_load");var g=e.attr("ori_src");e.css("background-image",'url("'+g+'")')}})};
...
b.endsWith(".TXT")||(b=0<b.indexOf("?")?b+"&___R="+Math.random():b+"?___R="+Math.random()),b=b.replace("&&","&"),b=b.replace("?&","?"),0==EWA.B.IE?(this._Http.open("GET",b,!this._IsAsync),this._Http.send(null)):(this._Http.open("GET",b,!this._IsAsync),this._Http.send()),this._IsAsync||this._ShowWaitting())};this.Post=function(b,d,e){null==b?console.log("ajax url not null"):(b.GetUrl?b=b.GetUrl():b.getUrl?b=b.getUrl():b.href&&(b=b.href),0<=b.indexOf("|")&&(b=b.replace(/\|/ig,"%7c")),this._ShowWaitting(),
null!=e&&(this._Http.onreadystatechange=e),b=b.replace("&&","&"),b=b.replace("?&","?"),this._Http.open("POST",b,!this._IsAsync),this._Http.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),this._Http.send(d),this._IsAsync||this._ShowWaitting())};this.PostNew=function(b,d){var e=[],g;for(g in this._Parameters){var h=this._Parameters[g];null!=h&&e.push(g+"="+h)}this.Post(b,e.join("&"),d)};this.GetReturnValue=function(){return this._Http.responseText};this.AddParameter=function(b,
d,e){this._Parameters[b]=e?d:encodeURIComponent(d)};this._InitHttp();this._getLoaddingImg=function(){return(EWA.RV_STATIC_PATH||"/EmpScriptV2")+"/EWA_STYLE/images/loading4.gif"};this.Install=function(b,d,e,g,h){var k=this,l="string"==typeof e?document.getElementById(e):e;if(null==l)alert("Object ["+e+"] not found");else{var m=$(l),n=null;h||(n=m.css("position"),"static"==n&&m.css("position","relative"),m.append("<div class='ewa-ajax-install-waitting'></div>"));this.Post(b,d,function(){if(k.IsRunEnd()){"static"==
n&&m.css("position",n);var p=k.GetRst();if(k.IsError())$(l)[0].innerHTML=p;else{$(l)[0].innerHTML=p;try{EWA.C.Utils.JsRegisters(p)}catch(q){console.log(q)}}null!=g&&g(b,d,e,p)}});this.HiddenWaitting()}};this.IsRunEnd=function(){if(4!=this._Http.readyState)return!1;this.HiddenWaitting();this._RunEndTime||(this._RunEndTime=(new Date).getTime());window.setTimeout(function(){for(var b=window._EWA_AJAX_LIST.length-1;0<=b;b--){var d=window._EWA_AJAX_LIST[b];if(null!=d&&1231<d.GetEndPastTime()){try{d.Dispose()}catch(e){}window._EWA_AJAX_LIST[b]=
...
function $J1(a,b){for(var d=[],e=2;e<arguments.length;e++)d.push(arguments[e]);return __$J(!1,a,b,d,!0,!0)}function $J2(a,b){for(var d=[],e=2;e<arguments.length;e++)d.push(arguments[e]);return __$J(!1,a,b,d,!1,!1)}function $J3(a,b){for(var d=[],e=2;e<arguments.length;e++)d.push(arguments[e]);return __$J(!1,a,b,d,!1,!0)}function $JP1(a,b,d,e,g,h,k,l,m){$JP(a,b,d,e,g,h,k,l,m).HiddenWaitting()}
...
function _$J_HandleRst(a,b,d,e){if(a.IsRunEnd())if(a.IsError())window.EWA_AjaxErr?window.EWA_AjaxErr(a.GetRst()):console.error(a.GetRst());else{a=a.GetRst();if(e)try{a=JSON.parse(a)}catch(m){console.error("_$J_HandleRst-JSON"+m);return}if(null==b)alert("\u5bf9\u8c61\u6ca1\u6709\u53d1\u73b0");else if(b instanceof Function||"function"==typeof b)b(a,d);else if("string"==typeof b)$X(b);else if("SELECT"==b.tagName)if(e)if(2>d.length)alert("\u53c2\u6570\u4e0d\u8db3\uff0c\u9700\u8981textName,valueName\u7684\u5b9a\u4e49");
...
z.setAttribute("json",JSON.stringify(v));return z}b.options.length=0;g&&(b.options[0]=new Option("",""),g instanceof Array&&(b.options[0].text=g[0],b.options[0].value=g[1]));if(l){var p=function(v,y){if((v=q[v])&&v._children&&0!=v._children.length)for(var x,z=0;z<v._children.length;z++)x=v._children[z],n(x,y),p(x[e],y+1)},q={___ROOT___:[]};g={___ROOT___:{}};for(var t,r,u,w=0;w<a.length;w++){u=a[w];t=u[l];r=u[e];if(null===t||""===t||"0"===t)t="___ROOT___";q[t]||(q[t]=[]);q[t].push(u);g[r]=u;g[t]&&
(g[t]._children||(g[t]._children=[]),g[t]._children.push(u))}p("___ROOT___",0)}else for(w=0;w<a.length;w++)u=a[w],n(u);h&&(b.value=h);$(b).trigger("change");k&&k(b)}$Install=function(a,b,d,e){a.GetUrl?a=a.GetUrl():a.getUrl?a=a.getUrl():a.href&&(a=a.href);var g=new EWA_UrlClass;g.SetUrl(a);g.GetParameter("EWA_AJAX")||g.AddParameter("EWA_AJAX","INSTALL");(new EWA_AjaxClass).Install(g.GetUrl(),"",b,d,e)};
...
g+=h;var q=[];if("number"===typeof n.length&&!n.propertyIsEnumerable("length")){var t=n.length;for(m=0;m<t;m+=1)q[m]=d(m,n)||"null";var r=0===q.length?"[]":g?"[\n"+g+q.join(",\n"+g)+"\n"+p+"]":"["+q.join(",")+"]";g=p;return r}if("object"===typeof l)for(t=l.length,m=0;m<t;m+=1){var u=l[m];"string"===typeof u&&(r=d(u,n,l))&&q.push(b(u)+(g?": ":":")+r)}else for(u in n)(r=d(u,n,l))&&q.push(b(u)+(g?": ":":")+r);r=0===q.length?"{}":g?"{\n"+g+q.join(",\n"+g)+"\n"+p+"}":"{"+q.join(",")+"}";g=p;return r}}
...
"number"===typeof n.length)l=n;else throw Error("JSON.stringify");else l=function(t,r){if(Object.hasOwnProperty.call(this,t))return r};return d("",{"":m})},parse:function(m,n){function p(q,t){var r,u=q[t];if(u&&"object"===typeof u)for(r in u)if(Object.hasOwnProperty.call(u,r)){var w=p(u,r);void 0!==w?u[r]=w:delete u[r]}return n.call(q,t,u)}if(/^[\],:{}\s]*$/.test(m.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,
...
a.childNodes.length;b+=1)EWA$UI$COMMON.Dispose(a.childNodes[b])}},Drop:function(a){EWA$UI$COMMON.Dispose(a);a.parentNode.removeChild(a)},AniExpand:function(a,b,d,e,g){if(null==e||0>=e)e=10;var h=0,k=b/(1*e),l=d/(1*e),m=a.clientWidth+b,n=a.clientHeight+d,p=window.setInterval(function(){var q=EWA$UI$COMMON.GetObjSize(a);if(h<e-1){var t=q.H+l,r=q.W+k;t>n&&(t=n);r>m&&(r=m);EWA$UI$COMMON.SetSize(a,r,t)}else EWA$UI$COMMON.SetSize(a,m,n);r=EWA$UI$COMMON.GetObjSize(a);t=r.W-q.W;r=r.H-q.H;q=EWA$UI$COMMON.GetPosition(a);
q.Y=q.Y-a.clientHeight-1*a.style.borderTopWidth.replace("px","")-1*a.style.borderBottomWidth.replace("px","");"LEFT_TOP"!=g&&("LEFT_BOTTOM"==g?(r=q.Y-r,t=q.X,EWA$UI$COMMON.MoveTo(a,t,r)):"RIGHT_TOP"==g?(r=q.Y,t=q.X-t,EWA$UI$COMMON.MoveTo(a,t,r)):"RIGHT_BOTTOM"==g?(r=q.Y-r,t=q.X-t,EWA$UI$COMMON.MoveTo(a,t,r)):(r=1*q.Y-r/2,t=1*q.X-t/2,EWA$UI$COMMON.MoveTo(a,t,r),EWA._TmpAniObj=a));h++;h>=e&&(window.clearInterval(p),EWA.UI.Utils.AniExpandCompleateFunction&&(EWA.UI.Utils.AniExpandCompleateFunction(),
...
function(){var a=$(window).width(),b=$(window).height(),d=$("#"+this.Id+"_box"),e=d.width();d=d.height();a=(a-e)/2;b=(b-d)/2;0>a&&(a=0);0>b&&(b=0);this.Move(a,b)};this.Move=function(a,b){var d=$("#"+this.Id+"_box");d.css("top",b);d.css("left",a)};this.Close=function(){this.IsCloseAsHidden?$("#"+this.Id).hide():this.Dispose()};this.Dispose=function(){$("#"+this.Id).remove();window["class_"+this.Id]=null;delete window["class_"+this.Id]};this.Show=function(){this.IsCloseAsHidden?$("#"+this.Id).show():
alert("\u8bf7\u8bbe\u7f6e\u53c2\u6570 IsCloseAsHidden=true")}}$Dialog=function(a,b,d,e,g,h){var k=!(d&&e),l=new EWA_UI_DiaNewClass;l.IS_AUTO_SIZE=k;l.Create(d,e,b,a,!0,g,h);l.MoveCenter();return l};$DialogHtml=function(a,b,d,e,g,h){var k=new EWA_UI_DiaNewClass;k.Create(d,e,b,a,!1,g);k.MoveCenter();h&&h(k,id);return k};
$DialogInstall=function(a,b,d,e,g,h){var k=EWA_Utils.tempId("dialogInstall"),l=$DialogHtml("<div id='"+k+"'></div>","",d,e,g);$Install(a,k,function(){var m=!(d&&e);if(g||b)m&&l.AutoSize(),h&&h(l,q);else{var n=l.getContent(),p=$(n).find(".EWA_TABLE");if(0!=p.length&&p[0].id){var q=p[0].id;p=q.replace("EWA_FRAME_","").replace("EWA_LF_","");if(EWA&&EWA.F&&EWA.F.FOS&&EWA.F.FOS[p])if(p=EWA.F.FOS[p].Title,q.startsWith("EWA_LF_"))var t=0,r=setInterval(function(){t++;if(90<t)window.clearInterval(r),m&&l.AutoSize(),
h&&h(l,q);else{var u=$(n).find(".ewa_lf_func");if(0!=u.length){window.clearInterval(r);var w=l.getTitleContainer();if(w){u.css({"background-color":"transparent",display:"block","float":"left","font-size":"14px"});var v=u.find(".ewa_lf_func_caption");v.css("color","#08c");v.text(v.text().replace("[","").replace("]","").trim());$(w).find("span:eq(0)").remove();$(w).append(u).css("border-bottom","1px solid #eee")}m&&l.AutoSize();h&&h(l,q)}}},10);else p&&l.SetTitle(p),m&&l.AutoSize(),h&&h(l,q);else m&&
...
EWA_UI_NavBarClass.prototype.getBox=function(a){a=$(this.parent).find(".ewa-tab-box:eq("+a+")");return 0==a.length?null:a[0]};EWA_UI_NavBarClass.prototype.setContent=function(a,b,d){var e=this.getBox(a);e.html(b);d&&d(e,a,b)};EWA_UI_NavBarClass.prototype.install=function(a,b,d){var e=this.getBox(a);$Install(b,e,function(g,h,k){d&&d(e,a,b,g,h,k)})};EWA_UI_NavBarClass.prototype.createInstallCfg=function(a,b,d,e){return{text:a,url:b,cb:d,show:e}};
EWA_UI_NavBarClass.prototype.createContentCfg=function(a,b,d,e){return{text:a,content:b,cb:d,show:e}};EWA_UI_NavBarClass.prototype.demo=function(){document.body.innerHTML="";this.init("demo",document.body,[{text:"\u6807\u7b7e\u4e00"},{text:"\u6807\u7b7e\u4e8c"},{text:"<b>\u6807\u7b7e\u4e09</b>",show:!0}])};
EWA_UI_NavBarClass.prototype.init=function(a,b,d){this.id=a;this.parent=b;this.tabsCfg=d;var e=[],g=[],h;for(h in d){var k='<div idx="'+h+'" class="ewa-tab-tab '+(0<h?"EWA_GROUP_CNT_TOP":"EWA_GROUP_CNT_TOP1")+'" id="tab_'+a+"_"+h+"\">\n<a style='display:block'>"+d[h].text+"</a></div>";g.push('<div idx="'+h+"\" class='ewa-tab-box' id=\"box_"+a+"_"+h+'" style="display: '+(0<h?"none":"block")+'"></div>');e.push(k)}e=e.join("");g=g.join("");a=$('<div class="ewa-tab" id="'+a+'">\n\t<div class="ewa-tab-headers" id="headers_'+
a+'">'+e+'<div style=\'clear:both\'></div></div>\n\t<div class="ewa-tab-boxes" id="boxes_'+a+'">'+g+"</div>\n</div>");var l=this;a.find("a").on("click",function(){var n=1*$(this).parent().attr("idx");l.show(n)});$(b).append(a);for(var m in d)b=d[m],b.url?l.install(m,b.url,b.cb):b.content&&l.setContent(m,b.content,b.cb),b.show&&(console.log(b),this.show(m))};
...
h?(d.find("i").html("<font color=green>\u6b63\u786e</font>"),b={YEAR:k,MONTH:m,DAY:n,SEX:1*$(g[16]).text()%2},$(a).attr("sfz_json",JSON.stringify(b))):d.find("i").html("<font color=red>"+l.join(", ")+"\u9519\u8bef</font>")};
(function(){function a(){var m=l.$(".ewa-slider-puzzle-box"),n=l.$(".ewa-slider-puzzle-swiper"),p=l.$(".ewa-slider-puzzle-verify"),q=l.$(".ewa-slider-puzzle-text"),t=k?"touchmove":"mousemove",r=k?"touchend":"mouseup";n.bind(k?"touchstart":"mousedown",function(u){u.stopPropagation();p.css({display:"block"});var w=(k?u.touches[0]:u).clientX-$(this).offset().left;$(this).offset();q.css("opacity","0");m.unbind(t);m.unbind(r);m.bind(t,function(v){var y=k?v.touches[0]:v,x=l.$(".ewa-slider-puzzle-handle");
v=l.$(".ewa-slider-puzzle-swiper");var z=l.$(".ewa-slider-puzzle-verify");y=y.clientX-w-$(x).offset().left;x=$(x).width()+29;0>y?y=0:y>x&&(y=x);v.css("left",y);z.css("left",y+10)});m.bind(r,function(v){m.unbind(t);m.unbind(r);v=new EWA_UrlClass(h.ewa_url);var y={};y.left=p.position().left;y.top=p.position().top;y.left1=p.offset().left;y.top1=p.offset().top;y.ewa_trigger_valid_mode="check";y.ewa_trigger_valid_name=h.ewa_trigger_valid_name;y.ewa_ajax=h.ewa_trigger_valid;console.log("0. Puzzle post check");
$JP(v.GetUrl(),y,function(x){x.RST?(console.log("1. puzzle valid ok"),m.addClass("ewa-slider-puzzle-successful"),e&&e(x)):(m.addClass("ewa-slider-puzzle-fail"),setTimeout(function(){m.removeClass("ewa-slider-puzzle-fail");n.css("left","0px");p.css("left","10px");q.css("opacity","1");g&&g(x);x.newConfig&&(x.newConfig.ewa_trigger_valid_name=h.ewa_trigger_valid_name,x.newConfig.ewa_trigger_valid=h.ewa_trigger_valid,x.newConfig.ewa_url=h.ewa_url,h=x.newConfig,b(h))},500))})})})}function b(m){var n=l.$(".ewa-slider-puzzle-imgbox"),
p=l.$(".ewa-slider-puzzle-imgbox img");n.css("width",m.imgBigWidth).css("height",m.imgBigHeight);p.length?p.attr("src",m.imgBig):n.prepend("<img src='"+m.imgBig+"' />");l.$(".ewa-slider-puzzle-verify").css("background-image","url('"+m.imgSmall+"')").css("top",m.imgTop).css("width",m.imgSmallWidth).css("height",m.imgSmallHeight)}var d=[];d.push('<div class="ewa-slider-puzzle-box">');d.push('<div class="ewa-slider-puzzle-imgbox">');d.push('<div class="ewa-slider-puzzle-verify"></div>');d.push('<div class="ewa-slider-puzzle-refresh"></div>');
d.push("</div>");d.push('<div class="ewa-slider-puzzle-handle">');d.push('<span class="ewa-slider-puzzle-swiper"></span>');d.push('<span class="ewa-slider-puzzle-text"></span>');d.push("</div>");d.push("</div>");var e,g,h,k=/iphone|android|ipad/ig.test(navigator.userAgent)||window.EWA_App,l;EWA.UI.SlidePuzzle=function(m,n,p,q){h=m;e=p;g=q;n=$(n||"body");n.append(d.join(""));l=n[0].ownerDocument.defaultView;n=l.$(".ewa-slider-puzzle-refresh");l.$(".ewa-slider-puzzle-box").css("width",m.imgBigWidth);
b(m);n.click(function(t){t.stopPropagation();t=new EWA_UrlClass(h.ewa_url);t.AddParameter("ewa_trigger_valid_mode","refresh");t.AddParameter("ewa_trigger_valid_name",h.ewa_trigger_valid_name);t.AddParameter("ewa_ajax",h.ewa_trigger_valid);t.AddParameter("ewa_trigger_valid_width",document.documentElement.clientWidth);$J(t,function(r){r.RST?(r.ewa_trigger_valid_name=h.ewa_trigger_valid_name,r.ewa_trigger_valid=h.ewa_trigger_valid,r.ewa_url=h.ewa_url,h=r,b(h)):alert(r.ERR)})});a()}})();
...
EWA.CP+"/EWA_STYLE/cgi-bin/")+"?xmlName="+b+"&itemName="+d+"&EWA_FRAMESET_NO=1&EWA_AJAX=INSTALL&"+e;(new EWA.C.Ajax).Install(b,"_r=1",a,g)},InstallHtml:function(a,b,d){var e=$X(a);if(null==e)alert("Object ["+a+"] not found");else{e.innerHTML=b;try{EWA.C.Utils.JsRegisters(rst)}catch(g){console.log(g)}if(null!=d)try{d(a)}catch(g){console.log(g)}}},replaceXmlName:function(a,b){a=a.unURL().replace(/\|/ig,"/").split("/");for(var d=[],e=0;e<a.length-1;e++){var g=a[e];""!==g&&d.push(g)}d.push(b);return d.join("/")}};
...
1)if("password"==d[g].type&&d[g]!=a&&d[g].id==e+"1"){b=d[g];break}d=null;null!=b&&(b.value!=a.value?(isok=!1,d=_EWA_INFO_MSG["EWA.F.PASSWORD"]):EWA_FrameRemoveAlert(b));return d};this._CheckMustInput=function(a,b,d){return"1"!=this.GetItemValue(d,"IsMustInput","IsMustInput")||null!=b&&0<b.length||"hidden"==a.type&&"ht5upload"==$(a).attr("ewa_tag")&&0<$(a).parent().find(".ewa_app_upload_form1:visible").length?null:b=(b=_EWA_JS_ALERT.IsMustInput)?b.replace("{Name}",a.id):"*"};this._CheckMaxMinLength=
function(a,b,d){if(!b)return null;var e=this.GetItemValue(d,"MaxMinLength","MaxLength");d=this.GetItemValue(d,"MaxMinLength","MinLength");e=null==e?-1:parseInt(e);d=null==d?-1:parseInt(d);var g=!0;!isNaN(e)&&0<e&&b.length>e&&(g=!1);g&&!isNaN(d)&&0<d&&b.length<d&&(g=!1);b=null;g||(b=_EWA_JS_ALERT.MaxMinLength||this._EWA_JS_ALERT_DEFAULT.MaxMinLength,b=b.replace("{Name}",a.id),b=b.replace("{MaxLength}",e),b=b.replace("{MinLength}",d));return b};this._CheckDataValid=function(a,b,d){a=this.GetItemValue(d,
"DataItem","Valid");if(null==a||""==a.trim())return"";if(0<b.length)return a=_EWA_VALIDS[a.toUpperCase().trim()],null==a?"":a.REGEX.test(b)?"":a.MSG};this._CheckMaxMinValue=function(a,b,d){a=this.GetItemValue(d,"MaxMinValue","MaxValue");d=this.GetItemValue(d,"MaxMinValue","MinValue");var e=null==a||""==a.trim()?null:1*a,g=null==d||""==d.trim()?null:1*d,h=!0;null!=e&&(h=1*b<=e?!0:!1);null!=g&&(h=1*b>=g?h&1:!1);if(h)return"";errorInfo=_EWA_JS_ALERT.MaxMinValue||this._EWA_JS_ALERT_DEFAULT.MaxMinValue;
errorInfo=errorInfo.replace("{MaxValue}",a);return errorInfo=errorInfo.replace("{MinValue}",d)};this.isNumber=function(a){if(!a)return null;a=(a=this.GetItem(a.id))?this.GetItemValue(a,"DataItem","DataType"):"";a=null==a?"":a.toUpperCase();return"NUMBER"==a||"INT"==a||"BIGINT"==a};this.isTrim=function(a){if(!a)return null;if($(a).attr("ewa_trim"))return!0;var b=this.GetItem(a.id);b=(b=b?this.GetItemValue(b,"DataItem","Trim"):"")?b.toUpperCase():"YES";if(b="YES"==b)$(a).attr("ewa_trim","yes").on("blur",
function(){this.value=this.value.trim()});return b};this.getFormat=function(a){return a?(a=this.GetItem(a.id))?this.GetItemValue(a,"DataItem","Format"):"":""};this.GetObjectValue=function(a){var b=a.tagName.toUpperCase(),d=a,e="";if("DIV"==b&&$(a).hasClass("ewa-switch"))return a.getElementsByTagName("input")[0].checked?"on":"off";if("DIV"==b&&"REPT"==a.getAttribute("TAG")){a=a.getElementsByTagName("input");for(var g=0;g<a.length;g+=1)a[g].checked&&(0<e.length&&(e+=","),e+=a[g].value);return e}if("DIV"==
b&&"1"==a.getAttribute("EWA_DHTML"))return e=a.getElementsByTagName("iframe")[0].contentWindow,b=e.document.getElementsByTagName("textarea"),e=0<b.length&&"none"!=b[0].style.display?b[0].value:e.frames[0].document.body.innerHTML,null!=location.search&&0>location.search.toUpperCase().indexOf("EWA_DHTML_HOST")&&(g="http:\\/\\/"+eval("document.location.host")),g=eval("/"+g+"/ig"),e=e.replace(g,""),a=a.getElementsByTagName("input")[0],a.value=e,a.value;if("SELECT"==b)return e="",0<=d.options.selectedIndex&&
(e=d.options[d.options.selectedIndex].value),e;if("TEXTAREA"==b&&"none"==d.style.display)return a.value;if("INPUT"==b&&"IMG_UPLOAD"==d.getAttribute("ewa_tag"))return e="/"!=EWA.CP?d.value.replace(EWA.CP,""):d.value,e=e.replace("//","/");if("INPUT"==b&&d.getAttribute("val_ref")){a=d.getAttribute("val_ref");try{e=eval("(function(){var a="+a+";return a;})()")}catch(h){console.log(a),console.log(h),e=""}return e}if("INPUT"==b&&("checkbox"==d.type||"radio"==d.type))return e=d.checked?d.value:"";(e=d.value)&&
this.isTrim(a)&&(g=e.trim(),g!==e&&(e=g));if("INPUT"!==b||!this.isNumber(a))return e;if(""!==e&&"-"!==e&&"."!==e){if(isNaN(e)&&(e=e.replace(/,/ig,""),isNaN(e)))try{e=EWA_Utils.chineseToNumber(e)+"",a.value=e}catch(h){return e}g=this.getFormat(a);if("LeastMoney"==g||"Money"==g)g=e.split("."),a.value=1==g.length?(1*e).fm(0):(1*e).fm(g[1].length)+(0==g[1].length?".":"");return e}}}function EWA_FrameResourceDescription(){this.Memo=this.Info=this.Lang=null}
...
function(a,b,d,e,g,h,k){var l=this;$J(e,function(m){l.createFilterCheckboxByData(a,b,d,m,g,h,k)})};this.createFilterCheckboxByData=function(a,b,d,e,g,h,k){var l={},m=m?"[]":d.split(",");d={};for(var n in m)d[m[n]]=1;m=[];var p=[],q=a.id;for(n in e){var t=e[n],r=t[g];r&&(r=r.replace(/</ig,"&lt;"));var u=t[h];u&&(u=u.replace(/</ig,"&lt;"));var w=t[k],v=d[r],y=[];y.push("<nobr class='ewa-filter-chk' style='float:left;margin-right:4px'>");y.push('<input class="ewa-filter-chkbox" type="checkbox" ');v&&
y.push(" checked ");t=q+"_"+n;y.push(' value="'+r+'" id="'+t+'" name="'+q+'"><label ');y.push(' for="'+t+'">'+u+"</label></nobr>");v?p.push(y.join("")):m.push(y.join(""));b&&(r=w?w.substring(0,1).toUpperCase():"",l[r]||(l[r]=[]),l[r].push(t))}a.innerHTML=p.join(" ")+" "+m.join(" ");if(b){e=['<a href="javascript:void(0)">ALL</a>'];for(n="A".charCodeAt();n<="Z".charCodeAt();n++)g=String.fromCharCode(n),l[g]&&e.push('<a href="javascript:void(0)">'+g+"</a>");b.innerHTML=e.join(" ");$(b).find("a").each(function(){var x=
...
m.ITEM.LST;h.options.length=0;var p=[],q;for(q in n){var t=n[q];if(!t.V||!k[t.V]){var r=new Option(t.T,t.V);t.json&&$(r).attr("json",t.json);h.options[h.options.length]=r;p.push(r);t._used=!0}}for(q in n)t=n[q],t._used||(r=new Option(t.T,t.V),t.json&&$(r).attr("json",t.json),h.options[h.options.length]=r);if(b)h.value=b;else for(var u in p)if(p[u].value){h.value=p[u].value;break}if(d)try{d(m,h)}catch(w){console.log(w)}}else $Tip(m.ERR)})}};this._checkSelectOptionsChange=function(){if(this._SelectFilters){var a=
this;this.isSelectFilter&&setTimeout(function(){a._checkSelectOptionsChange()},311);for(var b in this._SelectFilters){var d=this._SelectFilters[b];this.getObj("#"+d.id).html()!=d.html&&a._selectOptionsChangeed(d)}setTimeout(function(){a._checkSelectOptionsChange()},311)}};this._selectOptionsChangeed=function(a){var b=this.getObj("select#"+a.id),d="initSelectFilter"+this._Id+"-"+a.id+"-filter",e="initSelectFilter"+this._Id+"-"+a.id+"-filter2",g=this._initSelectFilterCreateCode(a.codeJsonFrom||a.filterFrom,
b);this.getObj("#"+d).html(g);this.getObj("#"+e).html("");a.html=b.html()};this._initSelectFilterCreateCode=function(a,b){var d=["<option value=''>-ALL-</option>"];if(a){var e={},g=[];b.find("option").each(function(){if(""!=this.value){var l;this.hasAttribute("para_"+a)?l=this.getAttribute("para_"+a):this.getAttribute("json")&&(l=JSON.parse(this.getAttribute("json"))[a]);l&&(e[l]?e[l]+=1:(e[l]=1,g.push(l)))}});var h=g.sort(),k;for(k in h)b=h[k],b=b.replace(/>/ig,"&lt;").replace(/"/,"&quot;"),d.push('<option value="'+
b+'">'+b+" ["+e[b]+"]</option>")}else for(k="A".charCodeAt();k<="Z".charCodeAt();k++)b=String.fromCharCode(k),d.push('<option value="'+b+'">'+b+"</option>");return d.join("")};this.initSelectFilter=function(a,b,d,e){if(!this["INIT_SELECT_FILTER"+a]){this["INIT_SELECT_FILTER"+a]=!0;var g=$("#EWA_FRAME_"+this._Id+" select#"+a),h=g.parent(),k="initSelectFilter"+this._Id+"-"+a+"-filter",l="initSelectFilter"+this._Id+"-"+a+"-filter2",m="initSelectFilter"+this._Id+"-"+a+"-filter-table";$X(m)&&(h.append(g),
$($X(m)).remove());h.addClass("ewa-select-filter");k=["<table id='"+m+"' cellpadding=0 cellspacing=0 width=100%><tr><td class='ewa-select-filter-char'><select class='EWA_SELECT' style='margin-right:4px' id='"+k+"' onchange='EWA.F.FOS[\""+this._Id+'"]._chCode(this,"'+b+'","'+d+"\")'>"];m=this._initSelectFilterCreateCode(e||d,g);k.push(m);k.push("</select><select id='"+l+"' style='display:none'></select></td><td class='ewa-select-filter-target'></td></tr></table>");h.prepend(k.join(""));h.find(".ewa-select-filter-target").append(g);
this._SelectFilters||(this._SelectFilters={});h={};h.html=g.html();h.id=a;h.filterType=b;h.filterFrom=d;h.codeJsonFrom=e;this._SelectFilters[h.id]=h}};this._chCode=function(a,b,d){this.isSelectFilter=!0;var e=$(a).next(),g=$(a).parent().parent().find(".ewa-select-filter-target select");0==e[0].options.length&&e.html(g.html());if(""==a.value)g.html(e.html());else{for(var h=["<option></option>"],k=1;k<e[0].options.length;k++){var l=e[0].options[k];this._chCodeFilter(l,b,d,a.value)&&h.push(GetOuterHTML(l))}g.html(h.join(""));
this._SelectFilters[g[0].id].html=g.html();this.isSelectFilter=!1}};this._chCodeFilter=function(a,b,d,e){"json"==b?(a=JSON.parse(a.getAttribute("json"))[d],"ADM_LID"==d&&(d=a.split("."),a=d[d.length-1])):a="text"==b?a.text:a.value;return a?a.substring(0,e.length).toUpperCase()==e.toUpperCase()?!0:!1:!1};this.setUnMust=function(a){(a=this.ItemList.Items[a.toUpperCase()])&&a.getElementsByTagName("IsMustInput")[0].getElementsByTagName("Set")[0].setAttribute("IsMustInput",0)};this.setMust=function(a){(a=
this.ItemList.Items[a.toUpperCase()])&&a.getElementsByTagName("IsMustInput")[0].getElementsByTagName("Set")[0].setAttribute("IsMustInput",1)};this.RedrawCreateSpans=function(){for(var a=$("#EWA_FRAME_"+this._Id+" tr"),b=0;b<a.length;b++){var d=a[b];if("none"!=d.style.display)for(var e=0,g=!1,h=d.cells.length-1;0<=h;h--){var k=d.cells[h];"none"==k.style.display?g?e++:(e=1,g=!0):g&&(k.colSpan=e+1,g=!1)}}EWA_FrameShowAlert=EWA_FrameShowAlert1;EWA_FrameRemoveAlert=EWA_FrameRemoveAlert1;$("#EWA_FRAME_"+
this._Id+" .ewa_d1").each(function(){this.title=this.innerHTML});for(var l in this.ItemList.Items)a=this.GetItemDescription(l).Memo,null!=a&&0<a.trim().length&&($("#"+l).attr("placeHolder",a),$("#"+l).attr("title",a));this.RedrawChangWidth()};this.GetItemDescription=function(a){return this.ItemList.GetDescription(a)};this.ShowPlaceHolder=function(a){$("#EWA_FRAME_"+this._Id).addClass("ewa-frame-cols-"+a);for(var b in this.ItemList.Items){var d=this.ItemList.GetValue(b,"Name","Name");if(d=this.GetObject(d)){d=
$(d);var e=this.GetItemDescription(b),g=e.Memo;e=e.Info;var h=null;1==a?(h=e,null!=g&&0<g.trim().length&&g!=h&&(h="smsValid"==d.attr("ewa_tag")?g:h+(", "+g)),d.hasClass("ewa-switch")&&d.prepend("<div class='ewa-switch-info'>"+h+"</div>")):2==a&&null!=g&&0<g.trim().length&&(h=g);h&&("hidden"==d[0].type?d.prev().attr("placeholder",h):"SELECT"==d[0].tagName?0<d[0].options.length&&""==d[0].options[0].value&&(d[0].options[0].text="-- "+h+" --",d[0].options[0].value=""):(d.attr("placeHolder",h),d.attr("title",
h)))}}};this.RedrawChangWidth=function(){var a=$("#EWA_FRAME_"+this._Id),b=a.width(),d=a.find(".ewa_msg_box")[0].colSpan/2;$("#EWA_FRAME_"+this._Id+">tbody>tr[class*='ewa-row-']:not('.ewa-row-msg-box')").each(function(){var g=$(this).find("td.ewa_redraw_info:visible").length,h=(b-90*g)/d;$(this).find("td.ewa_redraw_ctl:visible").each(function(){var k=this.colSpan||1;$(this).css("width",h*k)})});var e=this;addEvent(window,"size",function(){e.RedrawChangWidth()})};this.Mearge=function(a,b,d){console.log("\u62fc\u5199\u9519\u8bef\uff1a\u8bf7\u7528 Merge");
this.Merge(a,b,d)};this.Merge=function(a,b,d){if(a||b){var e=$("#EWA_FRAME_"+this._Id),g=e.find("#"+a),h=e.find("#"+b);if(0==g.length)console.log("Mearge:"+a+"\u4e0d\u5b58\u5728");else if(0==h.length)console.log("Mearge:"+b+"\u4e0d\u5b58\u5728");else{var k=!1,l=e.find(".ewa-row-"+b+" .EWA_TD_M"),m=null;0==l.length&&(k=!0,l=e.find(".ewa-row-"+b+" .EWA_TD_1"),m=e.find(".ewa-row-"+b+" .EWA_TD"),1==m.length&&(k=!0),b=m.html(),m.html("<table cellpadding=0 cellspacing=0 width=100%><tr><td style='width:50%'></td><td style='display:none'></td><td style='width:50%'></td></tr></table>"),
m.find("td:eq(0)").html(b));if(0==l.length)alert("target parent not exists");else{var n="border-box"==g.css("box-sizing")?0:1*g.css("padding-left").replace("px","")+1*g.css("padding-right").replace("px",""),p="border-box"==g.css("box-sizing")?0:1*h.css("padding-left").replace("px","")+1*h.css("padding-right").replace("px","");e.find(".ewa-row-"+a).hide();null==d&&(d=" - ");var q=l.width(),t=g[0].tagName,r=h[0].tagName;g.parent().hasClass("ewa-select-filter-target")&&(g=e.find(".ewa-row-"+a+" .EWA_TD_M table:eq(0)"),
t="SELECT_WITH_FILTER");var u=0;b=null;d&&(l.append('<span class="mearge-span">'+d+"</span>"),k&&m.find("table:eq(0) td:eq(1)").html('<span class="mearge-span">'+d+"</span>").show(),b=l.find(".mearge-span"),u=b.width()+1+1*b.css("padding-left").replace("px","")+1*b.css("padding-right").replace("px","")+1*b.css("margin-left").replace("px","")+1*b.css("margin-right").replace("px",""));t==r?(d=(q-u)/2-n-2,g.css("width",d),h.css("width",d),k&&m.find("table:eq(0) td:eq(2), table:eq(0) td:eq(0)").css("width",
d)):"SELECT"==t?(g.css("width",100),h.css("width",q-u-n-p-2-2-g.width())):"SELECT_WITH_FILTER"==t?(g.css("width",200),h.css("width",q-u-n-p-2-2-g.width())):"SELECT"==r&&(h.css("width",100),g.css("width",q-u-n-p-2-2-g.width()));h.css("float","left");b&&b.css("float","left");g.css("float","right");l.append(g);l.addClass("ewa-frame-merge");k&&(a=e.find(".ewa-row-"+a+" .EWA_TD").html(),m.find("table:eq(0) td:eq(2)").html(a))}}}};this.MergeExp=function(a,b,d,e){if(b){var g=b.match(/@@[a-zA-Z0-9\-\._:]*\b/ig),
...
null);try{a.ReloadAfter&&a.ReloadAfter(b)}catch(d){alert(b)}}}else alert("ERROR:\r\n"+b._Http.statusText)};this.RewriteInfo=function(a,b,d,e,g){var h=$("#EWA_FRAME_"+this._Id),k=[];b=b||"id";d=d||"info";e=e||"memo";for(var l=0;l<a.length;l++){var m=a[l],n=h.find("#"+m[b]);0!=n.length&&(n=n.parentsUntil("tr[show_msg]").last().parent(),null==m[d]||""==m[d].trim()?(n.hide(),g&&g(n[0],m,l)):3==n[0].cells.length?(k.push(n[0]),n[0].cells[2].innerHTML=m[e],n[0].cells[0].innerHTML=m[d],g&&g(n[0],m,l)):2==
n[0].cells.length?(k.push(n[0]),n[0].cells[0].innerHTML=m[d],g&&g(n[0],m,l)):1==n[0].cells.length&&(n=n.prev(),1<n[0].cells.length&&(n[0].cells[1].innerHTML=m[e]),k.push(n[0]),n[0].cells[0].innerHTML=m[d],g&&g(n[0],m,l)))}return k};this._HiddenMemo=function(a,b){var d=a.parentNode.parentNode;b=!1;"none"==d.style.display&&(b=!0);d.style.display="none";d.id="tr_"+a.id;d=d.previousSibling;3==d.nodeType&&(d=d.previousSibling);d.style.display="none";a="<span id=tab_"+a.id+' class="ewa_merge_tab" onclick="EWA.F.FOS[\''+
this._Id+"'].ShowMemo(this.id);\">"+d.cells[0].innerHTML+"</span>";return b?"":a};this.ShowMemo=function(a){for(var b=$X(this._Id+"__ewa_meger").getElementsByTagName("SPAN"),d=0;d<b.length;d++){var e=b[d].id.replace("tab_","tr_");"ewa_merge_tab1"==b[d].className&&(b[d].className="ewa_merge_tab",$X(e).style.display="none");b[d].id==a&&(b[d].className="ewa_merge_tab1",$X(e).style.display="")}};this.MergeMemo=function(){var a=$X("EWA_FRAME_"+this._Id).getElementsByTagName("textarea");if(0!=a.length&&
"1"!=a[0].getAttribute("ewa_merge")){for(var b=[],d=0;d<a.length;d++){var e=this._HiddenMemo(a[d]);e="<nobr>"+e.replace("\u2022 ","").trim()+"</nobr>";b.push(e)}a=a[0];d=a.parentNode.parentNode;e=d.previousSibling;3==e.nodeType&&(e=e.previousSibling);e.id=this._Id+"__ewa_meger";e.cells[0].colSpan=3;e.cells[0].innerHTML=b.join("");e.cells[0].style.width="100%";e.cells[0].style.height="25px";e.style.display="";d.style.display="";$X("tab_"+a.id).className="ewa_merge_tab1";null!=window._EWA_DialogWnd&&
EWA.UI.Dialog._SetTitle(window._EWA_DialogWnd)}};this.DoValidEx=function(a,b,d,e,g,h){""!=a.value&&(this._ValidExOk=this.Resources[g],this._ValidExFail=this.Resources[h],this._ValidExObj=a,"action"==b.toLowerCase().trim()?this._DoValidExAction(a,e,this.Resources[g].GetInfo(),this.Resources[h].GetInfo()):(0<=d.indexOf("&quot;")&&(d=d.replace(/&quot;/ig,'"')),eval(d)?(EWA_FrameShowAlert(a,this._ValidExOk.GetInfo()),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,this._ValidExFail.GetInfo()),
a.setAttribute("EWA_VALID_EX",this._ValidExFail.GetInfo()))))};this._DoValidExAction=function(a,b,d,e){if(null!=a&&!$(a).is(":hidden"))if(null==b||""==b.trim())alert("action not value");else{var g=a.id+","+a.value;if(this.DoValidExAction_RETS&&null!=this.DoValidExAction_RETS[g])0==this.DoValidExAction_RETS[g]?(EWA_FrameRemoveAlert(a,d),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,e),a.setAttribute("EWA_VALID_EX",e));else{var h=new EWA.C.Ajax;h.LoadingType="image";h.AddParameter("EWA_AJAX",
"HAVE_DATA");h.AddParameter("EWA_ACTION",b);h.AddParameter("EWA_ID",this._Id);h.AddParameter("EWA_NO_CONTENT","1");h.AddParameter(a.id,a.value);this.DoValidExAction_RETS||(this.DoValidExAction_RETS={});var k=this;h.PostNew(this.Url,function(){if(4==h._Http.readyState){h.HiddenWaitting();if(200==h._Http.status){var l=h._Http.responseText;if(EWA.F.CheckCallBack(l))try{var m=parseInt(l.trim());k.DoValidExAction_RETS[g]=m;0==m?(EWA_FrameRemoveAlert(a,d),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,
e),a.setAttribute("EWA_VALID_EX",e))}catch(n){alert(n+","+l)}}else alert("ERROR:\r\n"+h._Http.statusText);h=null}})}}};this.ValidCodeError=function(a){var b=this._t_ValidCodeError||0,d=(new Date).getTime();1E3>d-b?a||(a=_EWA_EVENT_MSG.ValidCodeError,$Tip(a),$(".ewa-valid-code-img").parent().parent().find("input").focus().select()):(this._t_ValidCodeError=d,$(".ewa-valid-code-img").each(function(){this.click()}),a||(a=_EWA_EVENT_MSG.ValidCodeError,$Tip(a),$(".ewa-valid-code-img").parent().parent().find("input").focus().select()))};
...
this._InitEncyptions();this._InitTriggerValids()};this._InitTriggerValids=function(){var a=$("#EWA_FRAME_"+this._Id),b="EWA.F.FOS['"+this._Id+"'].callTriggerValid(this)";this.triggerValids={};for(var d in this.ItemList.Items){var e=this.ItemList.Items[d],g=this.ItemList.GetItemValue(e,"Name","Name"),h=$(e).find("DataItem Set[TriggerValid]").attr("TriggerValid");if(h){this.triggerValids[g]=null;var k=a.find("#"+g);0===k.length&&contine;k.attr("ewa_trigger_valid",h);e=$(e).find("Tag Set").attr("Tag");
if("submit"==e)break;if("smsValid"==e){k=a.find(".ewa-row-"+g+" .ewa-sms-valid-code-button");e=k.attr("id");e||(e=EWA_Utils.tempId(),k.attr("id",e));var l=$("<a style='position:absolute;left:0;top:0;right:0;bottom:0'></a>");l.attr("ewa_trigger_valid",h);l.attr("ewa_trigger_valid_rid",g);l.attr("ewa_trigger_valid_click_id",e);k.parent().css("position","relative").append(l);k=l}(g=k.attr("onclick"))&&k.attr("_onclick",g);k.attr("onclick",b)}}};this.callTriggerValidBefore=function(a){return!0};this.callTriggerValid=
function(a){if(this.callTriggerValidBefore(a)){var b=$("#EWA_FRAME_"+this._Id),d=$(a),e=d.attr("id");e||(e=d.attr("ewa_trigger_valid_rid"));var g=this.getUrlClass(),h=d.attr("ewa_trigger_valid");g.AddParameter("ewa_ajax",h);g.AddParameter("ewa_trigger_valid_name",e);g.AddParameter("ewa_trigger_valid_mode","create");g.AddParameter("ewa_trigger_valid_width",document.documentElement.clientWidth);var k=this,l=EWA_Utils.tempId();$J(g.GetUrl(),function(m){if(m.RST){d.attr("_trigger_valid_id",l);var n=top.$DialogHtml("<div id='"+
l+"'></div>","enus"==EWA.LANG?"Silde puzzle":"\u62fc\u56fe\u9a8c\u8bc1",m.bigImgWidth+20,200,!1);m.ewa_trigger_valid_name=e;m.ewa_trigger_valid=h;m.ewa_url=g.GetUrl();EWA.UI.SlidePuzzle(m,top.$("#"+l),function(p){console.log("2. puzzle cb true");var q=!1;d.attr("_onclick")&&(d.attr("onclick",$(a).attr("_onclick")),q=!0);setTimeout(function(){$(n.getMain()).animate({opacity:0},500)},500);setTimeout(function(){var t=d.attr("type");k.triggerValids[e]=p.VALID;var r=$(a).attr("ewa_trigger_valid_click_id");
r?(d.remove(),console.log(r+".click"),b.find("#"+r).click()):q?(console.log("3. puzzle click"),d.click()):"submit"==t&&console.log("3. puzzle submit");n.Close()},1E3)});setTimeout(function(){n.AutoSize()},100)}else alert(m.ERR)})}};this._InitMustInputs=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name");0<$(d).find('IsMustInput Set[IsMustInput="1"]').length&&(d="#"+e,a.find(".ewa-row-"+e).addClass("ewa-row-must"),
e=a.find(d),e.addClass("ewa-row-item-must"),0<e.length&&e.attr("type")&&"hidden"==e.attr("type").toLowerCase()&&e.prev().addClass("ewa-row-item-must"))}};this._InitEncyptions=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name");d=$(d).find("DispEnc Set");if(0!=d.length&&(e=a.find("#"+e),0!=e.length&&d.attr("EncType"))){if("INPUT"==e[0].tagName||"TEXTAREA"==e[0].tagName){if(!e.val())continue;e.prop("disabled",
!0);e.attr("ewa_encyrption","yes")}var g=$("<div class='ewa-enc-cover' style='position:absolute;left:0;top:0;width:100%;height:100%;'><div></div></div>");e.parent().append(g);e.parent().css("position","relative");if(d=d.attr("EncShowUrl")){g.find("div").html("\u70b9\u51fb\u67e5\u770b").css({position:"absolute",height:30,"line-height":"30px",top:"50%","margin-top":"-15px",right:10,"text-align":"right"});d=new EWA_UrlClass(d);g=new EWA_UrlClass(this.Url);for(var h in g._Paras)if(!d.GetParameter(h)){var k=
g._Paras[h];null!=k&&(k=k.unURL());d.AddParameter(h,k)}d.AddParameter("EWA_ENCY_FROM_ID",e.attr("id"));d=d.GetUrl();e.parent().attr("enc_url",d).attr("fid",e.attr("id"));e.parent().on("click",function(){if(!$(this).attr("enc_ok")){var l=$(this).attr("t")||100,m=(new Date).getTime();if(!(400>m-l)){$(this).attr("t",m);l=$(this).attr("enc_url");var n=$(this).find("#"+$(this).attr("fid"));$J(l,function(p){p.RST?(n.prop("disabled",!1),n.removeAttr("ewa_encyrption"),n.val(p.VALUE),$(n).parent().find(".ewa-enc-cover").remove(),
$(n).parent().attr("enc_ok","1")):(p.ERR||p.MSG)&&$Tip(p.ERR||p.MSG)})}}})}}}};this._InitTranslations=function(){var a="EWA.F.FOS[&quot;"+this._Id+"&quot;]._Trans(this)",b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name"),g=$(d).find("DataItem Set[Translation]");if(d=g.attr("Translation")){g=g.attr("TransTarget");var h="en2zh"==d?" \u82f1\u8bd1\u4e2d":" \u4e2d\u8bd1\u82f1";"enus"==EWA.LANG&&(h="en2zh"==d?" En-Zh":" Zh-En");d=$('<a class="ewa-but-trans" href="javascript:void(0)" onclick="'+
a+'" _transf="'+e+'" _transp="'+d+'" _transt="'+g+'">'+h+"</a>");g=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+e+" .EWA_TD_L");0==g.length&&(g=$("#EWA_FRAME_"+this._Id+" .ewa-row-"+e+" .EWA_TD"));0==g.length&&(g=$("#EWA_FRAME_"+this._Id+" #"+e).parent().prev().find(".ewa_d1"));0==g.length&&(g=$("#EWA_FRAME_"+this._Id+" #"+e).parent(),g.css("position","relative"),d.addClass("ewa-but-trans-float"));g.append(d)}}};this._Trans=function(a){if(a){var b=$(a).attr("_transf"),d=$(a).attr("_transp");a=$(a).attr("_transt");
...
{_is_composition:!1};$(a).on("compositionstart",function(){d._droplist_[b.id]._is_composition=!0}).on("compositionend",function(){d._droplist_[b.id]._is_composition=!1;EWA.F.I.DropList(this)}).removeAttr("oninput").removeAttr("onkeyup").on("input",function(){d._droplist_[b.id]._is_composition||EWA.F.I.DropList(this)})}};this._GetDropListValue=function(){var a=this.getObj();if(0!=a.length){a=a[0];var b=a.getElementsByTagName("input");this._droplist_={};for(var d=0;d<b.length;d++){var e=b[d];if("droplist"==
e.getAttribute("ewa_class")){var g=e.nextSibling;"INPUT"==g.tagName.toUpperCase()&&"HIDDEN"==g.type.toUpperCase()&&(this._GetDropListValue1(e,g),this._bindCompostion(e,g))}}a=a.getElementsByTagName("select");for(d=0;d<a.length;d++)if(e=a[d],b=e.getAttribute("_ListFilterType"))g=e.getAttribute("_ListFilterField"),this.initSelectFilter(e.id,b,g);this._SelectFilters&&this._checkSelectOptionsChange()}};this.refreshDropList=function(a,b){var d=this.getObj('input[id="'+a+'"]');if(0==d.length)console.warn("Can not found id="+
a);else{var e=d.prev();0==e.length?console.warn("Can not found  id="+a+" prev"):"droplist"==e.attr("ewa_class")?(d.val(b),this._GetDropListValue1(e[0],d[0])):console.warn("Not droplist id="+a+" prev")}};this._GetDropListValue1=function(a,b){if(""==b.value)b.setAttribute("setvalue",1);else{var d=b.getAttribute("DlsShow");if(null==d||""==d)b.setAttribute("canopen",0),a.value=obj1.value,b.setAttribute("canopen",1);else{var e=b.getAttribute("xmlName"),g=b.getAttribute("itemName"),h=b.getAttribute("paraName"),
k=b.getAttribute("DlsAction"),l=b.value;var m=this.EWA_CGI?this.EWA_CGI:window.EWA_CGI?window.EWA_CGI:EWA.CP+"/EWA_STYLE/cgi-bin/";var n=-1==m.indexOf("?")?"?":"&";m=(m+(n+"XMLNAME="+e+"&ITEMNAME="+g+"&EWA_AJAX=JSON")).replace("//","/");m=m.replace("//","/");m=m.replace("//","/");e={};e[h]=l;null!=k&&0<k.trim().length&&(e.EWA_ACTION=k,e[b.id]=b.value);$JP(m,e,function(p){if(0!=p.length){var q=p[0],t=[];p={};for(var r in q)t.push(q[r]),p["@"+r.toUpperCase()]=q[r],q[r]&&b.setAttribute("para_"+r.toLowerCase(),
q[r]);if(null==d||""==d)p=t.join("/");else{r=d.match(/@[a-zA-Z0-9\-\._:]*\b/ig);for(q=0;q<r.length;q++){t=r[q];var u=p[t.toUpperCase()];d=d.replace(t,u)}p=d}b.setAttribute("canopen",0);a.value=p;b.id=null==b.id||""==b.id?Math.random():b.id;"yes"==b.getAttribute("isdlseventload")&&(EWA.F.FOS[b.id]=new EWA_FrameItemClass,EWA.F.FOS[b.id].DropList(a),EWA.F.FOS[b.id].CallAfterEvent());b.setAttribute("canopen",1);b.setAttribute("setvalue",1)}})}}};this.DoPostEx=function(){EWA.F.F.CUR=this;if(this.CheckValidAll(document.forms[0])){this._Ajax=
new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");for(var a=document.getElementsByTagName("input"),b=0;b<a.length;b+=1){var d=a[b],e=""==d.name?d.id:d.name;null!=e&&""!=e&&this._Ajax.AddParameter(e,d.value)}a=document.getElementsByTagName("select");for(b=0;b<a.length;b+=1)d=a[b],e=""==d.name?d.id:d.name,null!=e&&""!=e&&this._Ajax.AddParameter(e,d.value);a=document.getElementsByTagName("textarea");
for(b=0;b<a.length;b+=1)d=a[b],e=""==d.name?d.id:d.name,null!=e&&""!=e&&this._Ajax.AddParameter(e,d.value);this._Ajax.PostNew(this.Url,EWA.F.F.CUR._CallBack)}};this.createAjax=this.CreateAjax=function(a,b){EWA.F.F.CUR=this;null==a&&(a=$("#f_"+this._Id)[0]);if(!b&&!this.CheckValidAll(a))return null;a=new EWA.C.Ajax;b=this.CreatePostData();for(var d in b)a.AddParameter(d,b[d]);return a};this.createPostData=this.CreatePostData=function(a){a=a||$("#f_"+this._Id)[0];var b={},d;for(d in this.ItemList.Items){var e=
this.ItemList.GetItemValue(this.ItemList.Items[d],"Name","Name"),g=this.GetObject(e,a);if(null!=g&&!$(g).attr("ewa_encyrption")){var h=g.getAttribute("ewa_tag");if("signature"==h){var k="N";var l=this.tablets[d];for(var m=0;m<l.lines.length;m++)if(l.lines[m]){k="Y";break}l="Y"==k?this._GetObjectValue(g):"";b[e+"_CHANGED"]=k}else l=this._GetObjectValue(g);null!=l&&(b[e]=l);"DIV"==g.tagName.toUpperCase()&&"1"==g.getAttribute("EWA_DHTML")&&(k=$X("UP_IMG_"+e).value,b[e+"_imgs_split"]=k);if("swffile"==
h||"IMG_UPLOAD"==h)if(e=g.getAttribute("UP_PARAS"),null!=e&&0<e.length)for(e=e.split(","),h=0;h<e.length;h++){var n=e[h];b[n]=g.getAttribute(n)}else b.UP_URL=g.value;else"markdown"==h&&(g=g.parentNode.getElementsByTagName("textarea"),1<g.length&&(b[g[1].id]=g[1].value))}}if(this.PostAddData)for(n in this.PostAddData)b[n]=this.PostAddData[n];if(this.triggerValids)for(var p in this.triggerValids)b[p+"_TRIGGER_VALID_RESULT"]=this.triggerValids[p];return b};this.DoPostBefore=function(){return!0};this.isDoPostBeforeTimer=
...
1*a.attr("_trigger_valid_inc"):0;if(0==b)this.callTriggerValid(a);else{var d=a.attr("_trigger_valid_id");if(!d)return!1;if(0==top.$("#"+d).length)return this._cancelPostWait=!0,a.removeAttr("_trigger_valid_inc"),a.removeAttr("_trigger_valid_id"),console.log("\u7a97\u53e3\u4e0d\u89c1\u4e86\uff0c\u53d6\u6d88\u63d0\u4ea4\u7b49\u5f85"),!1}b++;a.attr("_trigger_valid_inc",b)}return!1}return!0};this.DoPost=function(a,b,d){if(this.posting)return!1;if(this._cancelPostWait)return console.log("\u53d6\u6d88\u63d0\u4ea4"),
this._cancelPostWait=null,!1;var e=this;if(!d){var g=this.DoPostBefore();if(g instanceof Array){e=this;this._checkStatusInc=0;this._checkStatusFristResult=g;this._checkStatusTimer=window.setInterval(function(){var p=0==e._checkStatusInc?e._checkStatusFristResult:e.DoPostBefore();e._checkStatusInc++;var q=p[0];if(null!==q&&void 0!==q){window.clearInterval(e._checkStatusTimer);e._checkStatusTimer=null;e._checkStatusInc=null;e._checkStatusFristResult=null;var t=p[1];p=p[2];q&&!p?e.DoPost(a,b,!0):q&&
p?$Confirm(t,t,function(){e.DoPost(a,b,!0)},function(){}):t&&$Tip(t)}},232);return}if(!g)return}var h=$(a).find("input[ewa_tag=ht5upload]");if(!(0<h.length)||this.uploadProcess||this.CheckValidAll(a)){var k=0;for(g=0;g<h.length>0;g++){var l=h[g];this._uploadingFileCheck(l)&&k++}if(0<k)setTimeout(function(){e.DoPost(a,b)},700);else{h=$(a).find("input[ewa_tag=ht5takephoto]");if(0<h.length&&!this.uploadProcess&&!this.CheckValidAll(a))return!1;for(g=0;g<h.length>0;g++){l=h[g];k=!1;l=window["h5takephoto_"+
this._Id+"$"+l.id];if("ok"!=l.UPLOAD_STATUS){if(!$X(l.H5_UPLOAD.WAIT_ID)){try{l.submitUpload()}catch(p){console.log("ht5takephotos - ht5.submitUpload: "+p);$Tip("\u60a8\u6ca1\u6709\u83b7\u53d6\u7167\u7247");return}l.H5_UPLOAD.createWaitBox();this.uploadProcess=!0}k||(e=this,setTimeout(function(){e.DoPost(a,b)},700),k=!0);return}l.H5_UPLOAD.removeWaitBox()}if(this._stopPostError)return EWA.UI.Msg.ShowError(this._stopPostError,""),!1;g=this.CreateAjax(a);if(null==g)return!1;if(this._checkTriggerValids()){null==
b&&(b=this.Url);if(""==b||null==b)b=window.location.href;this._Ajax=g;this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_POST","1");this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.LoadingType="image";this.DoPostStart&&this.DoPostStart(this._Ajax);g=new EWA_UrlClass(b);for(var m in this._Ajax._Parameters)g.RemoveParameter(m);b=g.GetUrl();this.posting=!0;var n=this;this._Ajax.PostNew(b,function(){n._CallBack()});this.isShowPostWaitting||this._Ajax.HiddenWaitting();$("#EWA_FRAME_"+
this._Id+" input[type=submit]").attr("disabled","disabled");return!0}setTimeout(function(){e.DoPost(a,b,d)},500)}}};this._CallBack=function(){var a=this._Ajax;if(a.IsRunEnd())if($("#EWA_FRAME_"+this._Id+" input[type=submit]").attr("disabled",null),this.posting=!1,this.DoPostEnd&&this.DoPostEnd(a,a._Http.status,a._Http.responseText,a._Http.statusText),200==a._Http.status){if(a=a._Http.responseText,EWA.F.CheckCallBack(a)){this.ValidCodeError(!0);var b=null;this.doPostAfter?b=this.doPostAfter:this.ReloadAfter&&
(console.warn("\u8bf7\u7528\uff1adoPostAfter"),b=this.ReloadAfter);try{b&&b(a)||eval(a)}catch(d){console.log(a),console.error(d),alert(a)}}}else alert("ERROR:\r\n"+a._Http.statusText)};this.Reload=function(){};this.Reload1=function(){console.log("Reload1 \u8fd9\u4e2a\u5e72\u561b\u7528\uff1f\u8c01\u5728\u8c03\u7528\uff1f")};this.ReloadFrame=function(a){var b=$("#f_"+this._Id);if(0!=b.length){var d=new EWA_UrlClass(this.Url),e=null,g=this._last_reload_frame_id;g?e=$("#"+this._last_reload_frame_id):
(g=EWA_Utils.tempId("ewa_frame_relaod"),e=b.parentsUntil("#EWA_FRAME_MAIN").last().parent(),"EWA_FRAME_MAIN"!=e[0].id&&(e=$("<div class='ewa-reload-frame'></div>"),e.insertBefore(b),e.append(b)),this._last_reload_frame_id=g,e.attr("id",g));d=new EWA_UrlClass(this.Url);d.AddParameter("ewa_ajax","install");b=d.GetUrl();$Install(b,g,function(){a&&a(e,this)})}};this.CheckValidAll=function(a){var b=!0,d=null,e;for(e in this.ItemList.Items){var g=this.ItemList.GetItemValue(this.ItemList.Items[e],"Name",
"Name");g=this.GetObject(g,a);null!=g&&((b&=this.CheckValid(g))||null!=d||(d=g))}null!=d&&d.focus();return b};this.H5Type=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,"Name","Name");e=a.find('[id="'+e+'"]');if(0!=e.length){var g=this.ItemList.GetItemValue(d,"Tag","Tag"),h=this.ItemList.GetItemValue(d,"DataItem","Valid");this.ItemList.GetItemValue(d,"DataItem","Format");d=this.ItemList.GetItemValue(d,"IsMustInput",
"IsMustInput");"Email"==h&&e.attr("type","email");"valid"==g&&e.attr("type","tel");1==d&&e.attr("required","required")}}};this.GetObject=function(a,b){b||(b=$("FORM#f_"+this._Id));a=$(b).find('[id="'+a+'"]');return 0<a.length?a[0]:null};this.CheckValid=function(a,b){if("SPAN"==a.tagName||"IMG"==a.tagName)return!0;if(a&&b&&"DIV"==a.tagName&&"REPT"==a.getAttribute("tag")){b=b.target.tagName;if("LABEL"==b||"INPUT"==b){var d=this;setTimeout(function(){d._GetObjectValue(a);d.ItemList.CheckValid(a,e)},
10)}return!0}var e=this._GetObjectValue(a);return this.ItemList.CheckValid(a,e)};this._GetObjectValue=function(a){return this.ItemList.GetObjectValue(a)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}var __EWA_ALTER_MSG=null;
function EWA_FrameShowAlert(a,b){if(1!=a.getAttribute("show_alert")){a.setAttribute("show_alert",1);var d=a;do if(d=d.parentNode,"BODY"==d.tagName){d=null;break}while("TR"!=d.tagName||1!=d.getAttribute("SHOW_MSG"));if(!d){var e=$(a);e.attr("ori_bc",e.css("background-color"));e.css("background-color","pink");"SELECT"!=a.tagName&&a.focus();e=$(a).parentsUntil("tbody").last();e.prev().hasClass("ewa-row-"+a.id)&&(d=e.prev()[0])}if(d)if(1==d.cells.length||"1"==d.parentNode.parentNode.getAttribute("error_show_type")){e=
$(d);var g=e.next();g.attr("error")||(g=d.parentNode.insertRow(d.rowIndex+1),g.setAttribute("error",1),g.setAttribute("rid",a.id),a=g.insertCell(-1),a.colSpan=d.cells.length,a.className="ewa-tip-error",g=$(g),a.innerHTML='<div class="ewa-tip-error-info"></div>');e.find("td").addClass("ewa-tip-error");g.find(".ewa-tip-error-info").html(b)}else 3==d.cells.length?(d.style.backgroundColor="lightyellow",null==a.getAttribute("ori_msg")&&(a.setAttribute("ori_msg",d.cells[2].innerHTML),a.setAttribute("ori_st",
d.cells[2].style.borderLeft)),d.cells[2].innerHTML=a.getAttribute("ORI_MSG")+"(<font color=red>"+b+"</font>)",d.cells[2].style.borderLeft="2px solid red"):($(d).find("td").css("background-color","lightyellow"),"SELECT"!=a.tagName&&a.focus(),1==d.cells.length?(d=$(d).prev(),d.attr("id")&&0<d.attr("id").indexOf(a.id)?(null==a.getAttribute("ori_msg")&&a.setAttribute("ori_msg",d[0].cells[0].innerHTML),d[0].cells[0].innerHTML=a.getAttribute("ori_msg")+"(<font color=red>"+b+"</font>)"):(alert("\u8bf7\u8f93\u5165\uff1a"+
b),a.focus())):(null==a.getAttribute("ori_msg")&&a.setAttribute("ori_msg",d.cells[0].innerHTML),d.cells[0].innerHTML=a.getAttribute("ori_msg")+"(<font color=red>"+b+"</font>)"))}}
function EWA_FrameRemoveAlert(a){__EWA_ALTER_MSG&&(__EWA_ALTER_MSG.style.display="none");if(1==a.getAttribute("show_alert")){a.setAttribute("show_alert",0);var b=a;do if(b=b.parentNode,"BODY"==b.tagName){b=null;break}while("TR"!=b.tagName||1!=b.getAttribute("SHOW_MSG"));if(!b){var d=$(a);d.css("background-color",d.attr("ori_bc"));d=$(a).parentsUntil("tbody").last();d.prev().prev().hasClass("ewa-row-"+a.id)&&(b=d.prev().prev()[0])}b&&(b.style.backgroundColor="",1==b.cells.length||"1"==b.parentNode.parentNode.getAttribute("error_show_type")?
...
"");else{this.focus();$(this).css("background","pink");return}}q=this.id;t=this.value;"droplist"==$(this).attr("ewa_class")&&(t=$(this).next().val(),q=$(this).next().attr("id"));q={key:q,val:t};if("rgb(255, 255, 224)"==p)$Tip(n.html()),l.hide(),this.focus();else if(this.value==$(this).attr("oldv"))$(this).attr("style",""),l.hide();else{var r=this;$JP(m.POST_URL||window.location.href,q,function(u){$(r).attr("style","");l.hide();u.RST?(u="SELECT"==r.tagName?r.options[r.selectedIndex].text:r.value,"TEXTAREA"==
r.tagName?""==u?b.html("............."):(u=u.replace(/</ig,"&lt;").replace(/>/ig,"&gt;"),u="<div>"+u.split("\n").join("</div><div>")+"</div>",b.html(u)):(""==u&&(u="............."),b.text(u)),b.append('<i style="margin-left:5px" class="fa fa-edit"></i>'),$TipTL("\u4fdd\u5b58\u5b8c\u6bd5")):$Tip(u.ERR)})}})}}}
...
!1;this.CheckedAllAfter=this.ReloadAfter=null;this.REPLACE_HISTORY_STATE=this.IsNotMDownAutoChecked=!1;this._IsSearchGroup=!0;this.composeSearchTexts=function(){var a=[],b=[],d=$("#EWA_RESHOW_"+this._Id+" .ewa-lf-search-type-text");if(0==d.length)return null;d.each(function(h){var k=$(this).find(".ewa-lf-search-item-title").text();k=k.replace(":","").replace("\uff1a","").replace("\u5305\u542b","").replace("Like","").trim();var l=$(this).find("input[type=text]").attr("name");a.push(k);b.push(l);0<
h&&$(this).hide()});var e=$(d[0]);e.addClass("ewa-app-lf-search-compose");e.find("input[type=text]").attr("name",b.join(",")).attr("placeholder",a.join(", "));var g=e.find("a").clone();e.find(".ewa-lf-search-item-title b").text("enus"==EWA.LANG?"Search":"\u7efc\u5408\u641c\u7d22").append(g);return d};this.switchButtonAction=function(a,b){if(b){var d=this.getUrlClass();d.AddParameter("ewa_switch_name",a.name);d.AddParameter("ewa_action",b);d.AddParameter("ewa_ajax","json");d.AddParameter("ewa_switch",
a.checked?"on":"off");d.AddParameter("ewa_action_key",$(a).parentsUntil("tbody").last().attr("ewa_key"));var e=a.parentNode,g=e.getAttributeNames();b={};for(var h in g){var k=g[h],l=e.getAttribute(k);0!=k.indexOf("on")&&"name"!=k&&"id"!=k&&"class"!=k&&(b[k]=l)}var m=this;d=d.GetUrl();$JP(d,b,function(n){m.extSwitchCallBack&&m.extSwitchCallBack(a,n)})}};this.ShowRecycle=function(){var a=$X("EWA_LF_"+this._Id);if(null!=a&&(a=$(a).parentsUntil("table").last().find(".ewa_lf_func_caption"),0!=a.length)){var b=
...
t+" ewa-lf-mearge ewa-lf-mearge-"+t+"' mid=\""+t+'"></span>');t!=a&&(h.find('tr[ewa_tag="HEADER"] [id="'+t+'"]').parent().hide(),h.find("td#ADD_ROW_"+t).hide());q=h.find('tr[ewa_tag="HEADER"] [id="'+t+'"]').html();n[t]=q;b.push(q)}g&&(g=b.join("<span class='ewa-lf-merge-header-split'></span>"),h.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(g));h.find("tr[ewa_key],tr.ewa-lf-sub-tr").each(function(){if(0==$(this).find('[id="'+a+'"]').length)console.log("not find "+a);else{var r=$(this).hasClass("ewa-lf-sub-tr")?
$(this).find('[id="ADD_ROW_'+a+'"]'):$(this).find(".ewa-col-"+a);if("yes"!=r.attr("ewa-merged")){var u=$('<div style="display:none"></div>');u.html(m);for(var w in l){var v=l[w].replace("@@",""),y=$(this).find('[id="'+v+'"]');if(0!=y.length){v!=a&&y.parent().hide();var x=u.find('span[mid="'+v+'"]');d&&(x.append("<span class='ewa-lf-mearge-memo'></span>"),x.find(".ewa-lf-mearge-memo").html(n[v]));x.append(y)}}for(;0<u[0].childNodes.length;)r.append(u[0].childNodes[0]);$(u).remove();e&&e(r,this);r.attr("ewa-merged",
"yes")}}})}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MeargeExp=function(a,b,d,e){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 MereExp");this.MergeExp(a,b,d,e)};this.SubBottoms=function(a){this.SubBottomsArray=a.split(",");this._SubBottoms()};this.reCalcBottoms=function(){this._SubBottoms()};this._SubBottoms=function(){var a=$("#EWA_LF_"+this._Id).find(".ewa-lf-sub-tr");0==a.length?(a=$(this.AddRow([])),a.addClass("ewa-lf-sub-tr"),a.find("td").addClass("ewa-lf-sub-td")):
a.find("td").text("");var b={},d;for(d in this.SubBottomsArray){b={total:void 0,fm_length:void 0};var e=this.SubBottomsArray[d];b.total=0;var g="#EWA_LF_"+this._Id+' .ewa-lf-data-row [name="'+e+'"]';b.fm_length=0;$(g).each(function(h){return function(){var k=this.hasAttribute("value")?this.value:this.hasAttribute("title")?this.title:this.innerText;null!=k&&0!==k.length&&(k=k.replace(/,/ig,""),isNaN(k)||(h.total+=1*k,0<k.indexOf(".")&&(h.fm_length=2)))}}(b));b="<span id='"+e+"' name='"+e+"' class='ewa-lf-sub'>"+
b.total.fm(b.fm_length)+"</span>";a.find("td[id=ADD_ROW_"+e+"]").html(b)}};this.ChangeRowStyle=function(a,b,d){for(var e=$X("EWA_LF_"+this._Id),g=1;g<e.rows.length;g++){var h=e.rows[g];if(!(0==h.cells.length||h.cells.length<=a)){var k=h.cells[a].childNodes[0].getAttribute(b);if(null!=k&&d[k])for(var l=0;l<h.cells.length;l++)h.cells[l].style.cssText=h.cells[l].style.cssText+";"+d[k]}}if(null==this.ReloadAfter){var m=this;this.ReloadAfter=function(){m.ChangeRowStyle(a,b,d)}}};this.MDownEvent=function(a,
b){};this.LoadJson=function(a,b){null!=a&&$J(this.Url+"&EWA_ACTION="+a+"&EWA_AJAX=JSON",b)};this.Workflow=function(a,b,d,e,g,h){EWA.F.CID=this._Id;this._Ajax=this.CreateAjax();this._Ajax.AddParameter("EWA_AJAX","WORKFLOW");this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_WF_NAME",b);null!=d?(a=this.GetRowKey(d),this._Ajax.AddParameter("EWA_ACTION_KEY",a),"true"==d.getAttribute("ewa_wf_control")?this._Ajax.AddParameter("EWA_WF_CTRL",1):this._Ajax.AddParameter("EWA_WF_CTRL",0)):
this._Ajax.AddParameter("EWA_WF_CTRL",1);null!=e&&this._Ajax.AddParameter("EWA_ACTION_KEY",e);g&&this._Ajax.AddParameter("EWA_WF_UOK",g);h&&this._Ajax.AddParameter("EWA_WF_UMSG",h);var k=this;this._Ajax.PostNew(this.Url,function(){k._CallBackJs()})};this.GetRowKey=function(a){a=this.GetRow(a);return null!=a?a.getAttribute("EWA_KEY"):null};this.GetRow=function(a){if(null==a||null==a.tagName||""==a.tagName)return null;var b=0;for(a=a.parentNode;"TR"!=a.tagName||null==a.getAttribute("EWA_KEY");){a=a.parentNode;
if("BODY"==a.tagName){a=null;break}b++;if(100<b){alert("\u5faa\u73af100\u6b21\uff0c\u672a\u53d1\u73b0TR");break}}return a};this.RecordModify=function(a,b,d){var e=this.SelectChecked();if(0==e.length)EWA.UI.Msg.Alter("\u8bf7\u5148\u9009\u62e9","\u4fee\u6539");else{var g="EWA_MTYPE=M";null!=d&&0<d.trim().length&&(g+="&"+d);EWA.UI.Dialog.OpenReloadClose(this._Id,a,b,!1,g+e)}};this.RecordNew=function(a,b,d){var e="EWA_MTYPE=N";null!=d&&0<d.trim().length&&(e+="&"+d);EWA.UI.Dialog.OpenReloadClose(this._Id,
...
b[g].type.toUpperCase())return e=b[g],e.click(),e;if("CHECKBOX"==b[g].type.toUpperCase()){e=b[g];e.click();if(!this._TrSelectMulti){var h=$(b[g]).attr("id")||$(b[g]).attr("name");0==$(d).find(b[g]).length&&$(a).siblings(".ewa-lf-data-row").find("input[name='"+h+"']:checked").prop("checked",!1);e.checked=!0}return e}}return null};this.newRowOneTd=function(a){if(null==a)return null;a=$(a)[0];var b=a.parentNode.rows[a.rowIndex+1];if(null!=b&&"1"==b.getAttribute("add_pre_row"))return b;b=a.parentNode.parentNode;
var d=b.rows[0].cells.length;b=b.insertRow(a.rowIndex+1);b.setAttribute("add_pre_row",1);a=b.insertCell(-1);a.colSpan=d;a.className="ewa-lf-add-pre-cell";b.style.display="none";a.id=EWA_Utils.tempId("EWA_LF_NR_"+this._Id);$(b).addClass("ewa-lf-add-pre-row");return b};this.MDown=function(a,b){if(this.IsTrSelect){var d=(new Date).getTime(),e=$(a).attr("mdown_time_last");if(!(null!=e&&500>d-e)&&($(a).attr("mdown_time_last",d),b=null==b?window.event:b,this.MDownEnableCheck(a)&&this.checkMDownEnable(a,
b))){e=b.srcElement?b.srcElement:b.target;var g=null;d=a.getElementsByTagName("input");this.IsNotMDownAutoChecked||(g=this.mDownAutoCheck(a,d,e));if("1"==a.getAttribute("__ewa_lf_mdown"))this._TrSelectMulti&&(g&&"CHECKBOX"==g.type.toUpperCase()&&(g.checked=!1),this._MSetBg(a,""),a.removeAttribute("__ewa_lf_mdown"),$(a).removeClass("ewa-lf-mdown"));else{g&&(g.checked=!0);this._MSetBg(a,"down");a.setAttribute("__ewa_lf_mdown",1);$(a).addClass("ewa-lf-mdown");if(!this._TrSelectMulti&&(g=a.parentNode)&&
g.rows)for(e=0;e<g.rows.length;e++){var h=g.rows[e];"1"==h.getAttribute("__ewa_lf_mdown")&&h!=a&&(h.removeAttribute("__ewa_lf_mdown"),$(h).removeClass("ewa-lf-mdown"),this._MSetBg(h,""))}if(this.IsReShow)for(e=0;e<d.length;e++)"BUTTON"==d[e].type.toUpperCase()&&(g=d[e],"true"==g.getAttribute("disabled")||1==g.getAttribute("disabled")||"true"==g.parentNode.getAttribute("disabled")||1==g.parentNode.getAttribute("disabled")?(this._ReshowButs[g.value].disabled=!0,this._ReshowButs[g.value].style.display=
"none"):(this._ReshowButs[g.value].disabled=!1,this._ReshowButs[g.value].style.display=""))}this._IsAddPreRow?(d=a.getAttribute("ewa_key"),this.AddPreRowCheck(a,d,b)&&(e=this.newRowOneTd(a),this.prevTr&&(this.AddPreRowCloseBeforeEvent&&this.AddPreRowCloseBeforeEvent(this._Id,a,d,this.prevTr,b),this.prevTr.style.display="none",this.prevTr.cells[0].innerHTML="",this.AddPreRowCloseEvent&&this.AddPreRowCloseEvent(this._Id,a,d,this.prevTr,b)),this.prevTr==e?this.prevTr=null:(this.prevTr=e,this.prevTr.style.display=
"",this.MDownEvent(this._Id,a,d,this.prevTr,b)))):this.MDownEvent(a,b)}}};this.AddPreRow=function(a){this._IsAddPreRow||(this.MDownEvent=a);this._IsAddPreRow=!0};this.AddPreRowCheck=function(a,b,d){return!0};this.AddPreRowCloseBeforeEvent=function(a,b,d,e,g){};this.AddPreRowCloseEvent=function(a,b,d,e,g){};this._MSetBg=function(a,b){var d="";"down"==b?d="ewa_grid_down":"over"==b&&(d="ewa_grid_mover");$(a).children("td").removeClass("ewa_grid_mover ewa_grid_down").addClass(d)};this._ReShowSearchQuick=
...
var p=!1;e=GetInnerText(m);e=e.trim();this._ReshowButs={};g=$(g.rows[0]);for(var q in this.ItemList.Items){var t=this.ItemList.Items[q],r=this._GetSubValue("Tag","Tag",t);if(r&&("button"==r.toLowerCase()||"butflow"==r.toLowerCase())&&(r=this._GetSubValue("Name","Name",t),0!==g.find(".ewa-col-"+r).length)){p=!0;var u=this._GetSubValue("DescriptionSet","Info",t),w=this._GetSubValue("DescriptionSet","Memo",t),v=this._GetSubValue("EventSet","EventName",t),y="";null!=v&&"ewa_click"==v.toLowerCase().trim()&&
(y=this._GetSubValue("EventSet","EventValue",t));e=e.replace(u,"");t=this._ReShowButton(u,w,null);this._ReshowButs[u]=t;t.setAttribute("f_id",this._Id);t.setAttribute("t_id",r);m.childNodes[1].appendChild(t);""==y?t.setAttribute("onclick","EWA.F.FOS['"+this._Id+"'].reShowButtonClick(this)"):t.setAttribute("onclick",y)}}p&&this._ReShowSplit(m.childNodes[1]);r=m.getElementsByTagName("input");p={};for(g=0;g<r.length;g++){var x=r[g];x.style.display="none";if(null==x.id||""==x.id)x.id=("_tmp_"+Math.random()).replace(".",
"_");if("button"==x.type){if(t=this._ReShowButton(x.value,x.title,x.id),u=x.nextSibling){var z="";3==u.nodeType&&(z=u.nodeValue.trimEx());"|"==z&&this._ReShowSplit(m.childNodes[1])}}else(u=x.nextSibling)&&(z=3==u.nodeType?u.nodeValue.replace("|",""):u.innerHTML),t=this._ReShowButton(z.trimEx(),x.title,x.id),t.id=("_tmp_"+Math.random()).replace(".","_"),p[x.name]||(p[x.name]=[]),p[x.name].push(t.id);m.childNodes[1].appendChild(t)}e=e.replace(/ /ig,"").replace(/\|/ig,"").trimEx();""!=e?0<=e.indexOf("if")?
...
this._SearchDialog.MoveCenter()):(this._SearchDialog._Dialog.AutoSize=!1,this._SearchDialog.Show(!0))};this.ShowSearch=function(a,b){var d="EWA_SEARCH_ITEM_"+this.Id;b&&(this._IsSearchGroup=!1);$X(d)||(this._SearchCreateItm(),a&&this.composeSearchTexts(),this._ReShowSearchQuick())};this.ChangeSearchTextType=function(a){this._MENU_DATE_RANGE&&this._MENU_DATE_RANGE.HiddenMemu();this._MENU_TEXT_TYPE.ShowByObject(a,null,0);var b=$(this._MENU_TEXT_TYPE.Dialog.GetFrame());b.find(".search-text-tag").remove();
b.find('div[ewa_mg="'+$(a).attr("tag")+'"] td:eq(0)').html('<b class="fa fa-check search-text-tag"></b>')};this.ChangeSearchDateType=function(a){this._MENU_TEXT_TYPE&&this._MENU_TEXT_TYPE.HiddenMemu();this._MENU_DATE_RANGE.ShowByObject(a,null,0)};this.ChangeSearchTextTypeIt=function(a){var b=$(this._MENU_TEXT_TYPE.SHOW_BY_OBJECT).parentsUntil(".ewa-lf-search-item").last(),d=$J2MAP(this.RESOURCES.search_text_items,"Id")[a];d="enus"==EWA.LANG?d.TxtEn:d.Txt;b.find("a").attr("tag",a).html(d);var e=b.find("input");
"blk"==a||"nblk"==a?e.val(d).prop("disabled",!0):e.prop("disabled")&&b.find("input").val("").prop("disabled",!1)};this._GetInitSearchMap=function(){var a=new EWA_UrlClass(this.Url),b={},d=a.GetParameter("ewa_search");if(!d)return b;this.Url=a.RemoveParameter("ewa_search");d=d.unURL();a=d.split(",");for(var e in a){var g=a[e],h=g.indexOf("["),k=g.indexOf("]");0>h||k<h||(d=g.substring(0,h).trim(),0!=d.length&&(h=g.substring(h+1,k).trim().toLowerCase(),0!=h.length&&(g=g.substring(k+1).trim(),""!=g&&
(b[d.toUpperCase()]||(b[d.toUpperCase()]={name:d,tag:h}),d=b[d.toUpperCase()],"lt"==h||"lte"==h?d.para2=g.unURL().replace(/\+/ig," "):d.para1=g.unURL().replace(/\+/ig," ")))))}return b};this.SearchFilterDate=function(a){var b=$(this._MENU_DATE_RANGE.SHOW_BY_OBJECT).parentsUntil(".ewa-lf-search-item").last(),d=b.find("input")[0];b=b.find("input")[1];if("Clear"==a)$(d).val(""),$(b).val("");else{var e=EWA_Utils.Date(),g="",h="";"Today"==a?h=g=e.GetDateString():"Week"==a?(a=e.GetBenWeek(),g=a[0],h=a[1]):
"Today-Weekend"==a?(a=e.GetBenWeek(),g=a[e.GetDateString()],h=a[1]):"Month"==a?(a=e.GetBenMonth(),g=a[0],h=a[1]):"Today-EOM"==a?(a=e.GetBenMonth(),g=a[e.GetDateString()],h=a[1]):"Quarter"==a?(a=e.GetBenQ(),g=a[0],h=a[1]):"Today-EOQ"==a?(a=e.GetBenQ(),g=a[e.GetDateString()],h=a[1]):"Year"==a?(a=e.GetBenYear(),g=a[0],h=a[1]):"Today-EOY"==a&&(a=e.GetBenYear(),g=a[e.GetDateString()],h=a[1]);a=EWA_Utils.Date(g).FormatDate();e=EWA_Utils.Date(h).FormatDate();e+=" 23:59:59";$(d).val(a);$(b).val(e)}};this._SearchCreateDateRange=
function(){var a="_MENU_DATE_RANGE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",d=JSON.parse(JSON.stringify(this.RESOURCES.search_date_items)),e="EWA.F.FOS[&quot;"+this._Id+"&quot;].SearchFilterDate",g;for(g in d){var h=d[g];h.Txt=h[b];h.Cmd=e+"(&quot;"+h.Id+"&quot;)"}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_DATE_RANGE";this._MENU_DATE_RANGE=new EWA_UI_MenuClass(b);this._MENU_DATE_RANGE.Create(d);$(this._MENU_DATE_RANGE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+
...
"&quot;].ChangeSearchDateType(this)",m=$J2MAP(this.RESOURCES.search_text_items,"Id");g=this._GetInitSearchMap();var n=!1,p=!1;for(h in this.ItemList.Items)if(null!=this._SearchJson[h]){var q=[],t=this._SearchJson[h],r=t.T,u=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[h]);q.push("<table class='ewa-lf-search-item ewa-ref-"+h+" ewa-lf-search-type-"+r+" "+("fix"==r?"ewa-lf-search-fix-m"+(t.M||"0"):"")+"' cellspacing=0 cellpadding=0>");q.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");
q.push(u);var w=u="",v="lk";g[h.toUpperCase()]&&(w=g[h.toUpperCase()],v=w.tag,u=w.para1,w=w.para2);var y="";"text"==r?(p=m[v]||m.lk,y="enus"==EWA.LANG?p.TxtEn:p.Txt,q.push("<a class='ewa-lf-search-type' tag='"+v+"' href='javascript:void(0)' onclick='"+k+"'>"),q.push(y),q.push("</a>"),p=!0):"date"==r&&(q.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+l+"'></a>"),n=!0);q.push("</b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==r?"blk"==v||"nblk"==v?(t=this._SearchSingle(h,
y),t=t.replace("<input","<input disabled "),q.push(t)):q.push(this._SearchSingle(h,u)):"date"==r?q.push(this._SearchDate(h,u,w)):"number"==r?q.push(this._SearchNumber(h,u,w)):"fix"==r&&(t="<div >"+this._SearchFix(h,t,"span",u)+"</div>",q.push(t));q.push("</td></tr></table>");"fix"==r&&this._IsSearchGroup?d.push(q.join("")):e.push(q.join(""))}if(0!=e.length+d.length){b.push('<table class="ewa-lf-search-main" id="'+a+'" cellspacing="0" cellpadding="0">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");
0<e.length&&b.push(" "+e.join("")+" ");for(e=0;e<d.length;e++)b.push(" "+d[e]+" ");b.push("</td></tr></table>");var x=document.createElement("div");this._SEARCH_BOX=x;x.className="ewa-lf-search";x.innerHTML=b.join("");b=$X("EWA_LF_"+this.Id).parentNode;b.parentNode.insertBefore(x,b);a="EWA_SEARCH_ITEM_"+this.Id;var z=this;n&&this._SearchCreateDateRange();p&&this._SearchCreateTextType();z._SEARCH_ITEM_EXP=this.SearchGetExp(x);"{}"!=JSON.stringify(g)&&(z._SearchExp=z._SEARCH_ITEM_EXP);$(x).find("input[type=text]").on("compositionstart",
function(){z._is_search_composition=!0}).on("compositionend",function(){z._is_search_composition=!1});this._TIMER_SEARCH=window.setInterval(function(){if(!z._is_search_composition){try{if(!$X(a)){window.clearInterval(z._TIMER_SEARCH);return}}catch(B){window.clearInterval(z._TIMER_SEARCH);return}var A=z.SearchGetExp(x);A!=z._SEARCH_ITEM_EXP&&(z._SEARCH_ITEM_EXP=A,z.DoSearch($X(a)))}},700)}};this._SearchSingle=function(a,b){var d=[];d.push('<input t="text" type="text" autocomplete="off" class="EWA_INPUT" maxlength="40" name="');
...
this._Id+"\"].DoSearch(this);'> <input type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLOSE"]+"' onclick='EWA.F.FOS[\""+this.Id+"\"]._SearchDialog.Show(false);'></td></tr>");a.push("</table></div>");this._SearchHtml=a.join("")};this.createRegExp=function(a){if(!a)return null;a=String(a).trim();if(0===a.length)return null;for(var b=[],d=0;d<a.length;d++){var e=a[d];"a"<=e&&"z">=e||"A"<=e&&"Z">=e||"0"<=e&&"9">=e?b.push(e):b.push("\\"+e)}try{return new RegExp("("+b.join("")+")")}catch(g){return console.warn("new RegExp",
a,g),null}};this.SearchMark=function(){for(var a=this._SearchExp.split("@!@"),b=$X("EWA_LF_"+this._Id),d=0;d<a.length;d+=1){var e=a[d].split("~!~");if(!(3>e.length))for(var g=2,h={};g<e.length;h={regExp:void 0},g++){var k=e[g];if(""!=k){if("fix"==e[1]){var l=e[2];$("table#EWA_SEARCH_ITEM_"+this.Id+' [name="'+e[0]+'"]').find("option").each(function(){this.value==l&&(k=this.text)})}h.regExp=this.createRegExp(k);var m=e[0].split(","),n;for(n in m){var p=m[n];this._SearchJson[p]&&(p=this._SearchJson[p].ORI_NAME);
p=$(b).find(".ewa-lf-data-row .ewa-col-"+p).not("[ewa-search-marked=yes]");p.attr("ewa-search-marked","yes");try{p.find("*").each(function(q){return function(){0==this.children.length&&(this.innerHTML=this.innerHTML.replace(q.regExp,"<font color=red><b>$1</b></font>"))}}(h))}catch(q){console.log(q)}}}}}};this.DblClick=function(a){this._IsDblClick=a;for(var b=$X("EWA_LF_"+this._Id),d=1;d<b.rows.length;d++)b.rows[d].ondblclick=function(){var e=this.getElementsByTagName("input");e.length>a&&0==e[a].disabled&&
e[a].click()}};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);if((a=$X("EWA_LF_"+this._Id))&&"table"==a.tagName&&!(1>=a.rows.length)){a=a.rows[1].getElementsByTagName("input");for(var b=0;b<a.length;b++)if("RADIO"==a[b].type.toUpperCase()){this._TrSelectMulti=!1;break}}};this.SetPageParameters=function(a,b,d,e,g){this._PageCurrent=a;this._PageSize=d;this._PageCount=b;this._RecordCount=
e;this._Sort=g};this.SetPageParametersName=function(a,b,d,e,g){this._PageCurrentName=a;this._PageSizeName=d;this._PageCountName=b;this._RecordCountName=e;this._SortName=g};this.CheckedAll=function(){var a=document.getElementById("EWA_LF_"+this._Id);if(!(1>=a.rows.length)){for(var b=0;b<a.rows.length;b+=1){var d=a.rows[b].getElementsByTagName("input");0!=d.length&&(d[0].checked=this._IsCheckedAll)}this._IsCheckedAll=this._IsCheckedAll?!1:!0;this.CheckedAllAfter&&this.CheckedAllAfter(a)}};this.SelectChecked=
function(){var a=$X("EWA_LF_"+this._Id);if(!a||1>a.rows.length)return"";var b=[],d=[];$("#EWA_LF_"+this._Id+">tbody>tr").find("input[type='radio'],input[type='checkbox']").each(function(){-1==this.parentNode.className.indexOf("ewa-switch")&&d.push(this)});if(0<d.length)for(var e=0;e<d.length;e++)d[e].checked&&b.push(d[e].value);else for(e=0;e<a.rows.length;e++){var g=a.rows[e];1==g.getAttribute("__ewa_lf_mdown")&&b.push(g.getAttribute("EWA_KEY"))}return b.join(",")};this.SelectCheckedInputs=function(){var a=
[],b=$X("EWA_LF_"+this._Id);if(1>b.rows.length)return a;b=b.getElementsByTagName("input");a=[];for(var d=0;d<b.length;d++)("CHECKBOX"==b[d].type.toUpperCase()||"RADIO"==b[d].type.toUpperCase())&&b[d].checked&&a.push(b[d]);return a};this.SelectCheckedRows=function(){for(var a=[],b=$X("EWA_LF_"+this._Id),d=0;d<b.rows.length;d++){var e=b.rows[d],g=e.getElementsByTagName("input");0!=g.length&&g[0].checked&&-1==g[0].parentNode.className.indexOf("ewa-switch")&&a.push(e)}if(0==a.length)for(d=0;d<b.rows.length;d++)e=
b.rows[d],1==e.getAttribute("__ewa_lf_mdown")&&a.push(e);return a};this.Reload=function(a){this.StopAjaxAfterReload?this.StopAjaxAfterReload=!1:this.Goto(this._PageCurrent,a)};this.refreshPage=function(a,b){this.replaceRowsData(null,null,a,b)};this.replaceRowsData=function(a,b,d,e){var g=this.getUrlClass();g.AddParameter("EWA_AJAX","LF_RELOAD");g.AddParameter("EWA_IS_SPLIT_PAGE","no");g.AddParameter("EWA_IS_HIDDEN_CAPTION","yes");g=g.GetUrl();a&&(g+="&"+a);var h=a?new EWA_AjaxClass:this.CreateAjax(),
k=this;h.PostNew(g,function(){if(4==h._Http.readyState){h.HiddenWaitting();var l=h._Http.responseText;200!=h._Http.status?(console.error(l),alert("ERROR:\r\n"+h._Http.statusText)):EWA.F.CheckCallBack(l)?k.replaceRowsWithDataHtml(l,b,d,e):console.error(l)}})};this.replaceRowsWithDataHtml=function(a,b,d,e){var g=$("<div></div>");g.html(a);var h=[],k=$("#EWA_LF_"+this._Id);g.find(".ewa-lf-data-row").each(function(){var l='tr[ewa_key="'+$(this).attr("ewa_key")+'"]',m=k.find(l);if(0==m.length)console.warn(l+
" not found");else{l=$(this).attr("ewa_row_sign");var n=m.attr("ewa_row_sign"),p=!0;(l||n)&&n===l&&(p=!1);if(p){m.attr("ewa_row_sign",l);l=m.clone()[0];for(n=0;n<this.cells.length;n++){p=m[0].cells[n];var q=this.cells[n];p.removeAttribute("ewa-merged");p.removeAttribute("ewa-search-marked");b?b(q,p):p.innerHTML=q.innerHTML}h.push({before:l,current:m[0]})}}});g.remove();this.SearchMark();this.IsReShow&&this.ReShowWithNoButtons();this._ReShowSearchQuick();null!=this._IsDblClick&&this.DblClick(c._IsDblClick);
...
b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.AddParameter("EWA_ACTION_TIP",e);null!=h&&0<h.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",h),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=!1;if(a&&a.getAttribute&&"yes"==a.getAttribute("box_menu_item")){if(this._Ajax.AddParameter("___CALL__FROM__","box"),a=a.parentNode)a=a.getAttribute("json_ref"),a=JSON.parse(a),a.EWA_KEY&&this._Ajax.AddParameter("EWA_ACTION_KEY",
a.EWA_KEY)}else(a=this.GetRowKey(a))&&this._Ajax.AddParameter("EWA_ACTION_KEY",a);a=this.SelectChecked();this._Ajax.AddParameter("IDS_SPLIT",a);if(null!=g&&0<g.length)for(a=0;a<g.length;a+=1)this._Ajax.AddParameter(g[a].Name,g[a].Value);g=new EWA.C.Url;g.SetUrl(this.Url);var m=g.RemoveParameter("EWA_ACTION"),n=this;d?((g=_EWA_INFO_MSG[d])||(g=d),$Confirm(g,"Confirm",function(){n._Ajax.PostNew(m,function(){n._CallBackJs()})})):this._Ajax.PostNew(m,function(){n._CallBackJs()})}};this.NewPageSize=function(a){this._PageSize!=
a&&(this._PageSize=a,this.Goto(1))};this.Goto=function(a,b){EWA.F.CID=this._Id;this._PageCurrent=a;this._Ajax=this.CreateAjax();a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.RemoveParameter("EWA_AJAX");var d=this;this._Ajax.PostNew(a.GetUrl(),function(){d._CallBack(b)});this.REPLACE_HISTORY_STATE&&this.replaceHistoryState()};this.createReplaceHistoryStateUrl=function(){var a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.AddParameter(this._PageCurrentName,
...
0;a<this.GotoParas.length;a+=1)this._Ajax.AddParameter(this.GotoParas[a].Name,this.GotoParas[a].Value);this._AjaxType="DOWN_DATA";a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);var d=this;this._Ajax.PostNew(a.GetUrl(),function(){d._CallBack()})};this.Get=function(a){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";var b=this;this._Ajax.Get(a,function(){b._CallBack()})};this.Post=function(a,b){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType=
"image";var d=this;this._Ajax.Post(a,b,function(){d._CallBackJs()})};this._CallBack=function(a){var b=this._Ajax;if(4==b._Http.readyState){b.HiddenWaitting();if(top.EWA&&top.EWA.MQE){var d=new EWA_MqeClass;d.Data=b.GetRst();d.FromId=EWA.F.CID;d.Type="POST";top.EWA.MQE.AddMqe(d)}200==b._Http.status?(b=b._Http.responseText,EWA.F.CheckCallBack(b)&&("DOWN_DATA"==this._AjaxType?(this._AjaxType=null,"DENY"==b.trim()?alert(_EWA_INFO_MSG["EWA.LF.DOWN_DATA.DENY"]):window.location.href=b.trim()):(d=$X("EWA_LF_"+
this._Id).parentNode,$(d).replaceWith(b),this.SearchMark(),this.IsReShow&&this.ReShowWithNoButtons(),this._ReShowSearchQuick(),null!=this._IsDblClick&&this.DblClick(this._IsDblClick),this._IsAddPreRow&&this.AddPreRow(),this.SubBottomsArray&&this._SubBottoms(),this.ReloadAfter&&this.ReloadAfter(a),this.ReloadAfterApp&&this.ReloadAfterApp(a)))):alert("ERROR:\r\n"+b._Http.statusText);this.RewriteInfo()}};this._CallBackJs=function(){var a=this._Ajax;if(4==a._Http.readyState){if(top.EWA&&top.EWA.MQE){var b=
new EWA_MqeClass;b.Data=a.GetRst();b.FromId=EWA.F.CID;b.Type="POST";top.EWA.MQE.AddMqe(b)}a.HiddenWaitting();200==a._Http.status?(a=a._Http.responseText,EWA.F.CheckCallBack(a)&&eval(a)):alert("ERROR:\r\n"+a._Http.statusText);this.EditAfterEvent&&this.EditAfterEvent()}};this.EditAfterEvent=function(){};this._GetItem=function(a){for(var b=this.ItemList,d=0;d<b.length;d+=1){var e=b[d],g=this._GetSubItem("Name",e);if(this.Xml.GetElementAttribute(g,"Name")==a)return e}};this._GetSubItem=function(a,b){b=
this.Xml.GetElements(a+"/Set",b);if(null==b||0==b.length)return null;if("DescriptionSet"==a)for(a=0;a<b.length;a+=1){var d=b[a].getAttribute("Lang");if(null!=d&&d.trim().toUpperCase()==EWA.LANG.trim().toUpperCase())return b[a]}return b[0]};this._GetSubValue=function(a,b,d){a=this._GetSubItem(a,d);return null==a?null:this.Xml.GetElementAttribute(a,b)};this.AddColumns=function(a,b,d,e,g,h,k,l){var m=$X("EWA_LF_"+this._Id);null==l&&(l=m.rows[0].cells.length);for(var n=0;n<a.length;n++)for(var p=a[n],
q=l+n,t=0;t<m.rows.length;t++){var r=m.rows[t].insertCell(q);r.title=p[e];if(0==t)r.className="EWA_TD_H ewa-add-column ewa-col-"+p[b],r.innerHTML='<nobr cellIdx="'+q+'" id="'+p[b]+'">'+p[d]+"</nobr>",r.title=p[e],r.width=100;else{var u=m.rows[t].getAttribute("EWA_KEY");r.className="EWA_TD_M ewa-add-column ewa-col-"+p[b];u=u+"_"+p[b];var w=this._GetAddControl(p[h],p[d],p[e]);null==w&&(w=g);var v=k.replace("[ID]",p[b]);w=0<=w.indexOf("<select")?w.replace("!!",v.replace("onblur=","onchange=")):w.replace("!!",
v);r.innerHTML=w;r.childNodes[0].id=u}}};this._GetAddControl=function(a,b,d){if(null==a)return null;a=a.toUpperCase().trim();b=b?b.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/"/ig,"&quot;"):"";d=d?d.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/"/ig,"&quot;"):"";return"SELECT"==a?'<select des="'+b+'"  title="'+d+'" !!></select>':"DATE"==a?'<input type=text des="'+b+'" title="'+d+'" class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,false);" readonly !!>':"TIME"==a?'<input type=text des="'+
b+'" title="'+d+'"  class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,true);" readonly !!>':"STRING"==a||"NUMBER"==a?'<input type=text des="'+b+'"  title="'+d+'" class=EWA_INPUT !!>':null};this.AddedValues=function(a,b,d,e,g){for(var h=0;h<a.length;h++){var k=a[h],l=$X(k[b]+"_"+k[d]);if(!l)break;var m=l.tagName.toUpperCase();"INPUT"==m||"SELECT"==m||"TEXTAREA"==m?l.value=k[e]:l.innerHTML=k[e];g&&(this.GetRow(l).getElementsByTagName("input")[0].checked=!0)}};this.AddRow=function(a){for(var b=$X("EWA_LF_"+
this._Id),d=b.insertRow(-1),e=0;e<b.rows[0].cells.length;e++){var g=d.insertCell(-1),h=b.rows[0].cells[e];g.className="EWA_TD_M";null!=a[e]&&(g.innerHTML=a[e]);g.style.display=h.style.display;g.id="ADD_ROW_"+h.childNodes[0].id}return d};this.Calc=function(a,b,d,e){for(var g=$X("EWA_LF_"+this._Id),h={},k=0;k<a.length;k++)h[a[k]]=0;for(k=b;k<d;k++)for(a=g.rows[k],b=0;b<a.cells.length;b++)if(null!=h[b]){var l=a.cells[b],m=l.getElementsByTagName("input");0<m.length?h[b]+=1*m[0].value:(l=GetInnerText(l),
""==l&&(l=0),h[b]+=1*l)}d=g.rows[e];for(k=0;k<d.cells.length;k++)null!=h[k]&&(l=Math.round(100*h[k])/100,e=GetInnerText(d.cells[k]),l!=1*e&&(this.IsCalcChanged=!0),d.cells[k].innerHTML=l.fm())};this.mergeHeaders=function(a,b,d){var e=$($X("EWA_LF_"+this._Id)),g=e.find('tr[ewa_tag="HEADER"]');if(0!=g.length&&(a=g.find('nobr[id="'+a+'"]').parent(),0!=a.length)){var h=e.find("tr[ewa_mearge]");0==h.length&&(h=$(e[0].insertRow(1)),h.attr("ewa_mearge","gdx"));e=-1;for(var k=0;k<g[0].cells.length;k++){var l=
g[0].cells[k];l==a[0]&&(e=k,l.colSpan=d);if(-1==e)"1"!=$(l).attr("ewa_tdmearged")&&(l.rowSpan=2);else if(e+d==k)e=-1,l.rowSpan=2;else{l.rowSpan=1;var m=h[0].insertCell(-1);m.innerHTML=l.innerHTML;m.className=l.className;m.style.cssText=l.style.cssText;l.style.display="none";$(l).attr("ewa_tdmearged",1)}l==a[0]&&(l.innerHTML=b,l.style.display="",l.style.width="")}}};this.MeargeHeader=function(a,b,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 mergeHeaders");this.mergeHeaders(a,b,d)};this.getUrlClass=
function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}
...
b.animate(r,"fast","swing",function(){b[0].style.cssText="";var u=1*b.attr("st");document.body.scrollTop=u;1==$("#crm_left_box").attr("show")&&$("#crm_left_box").show();b.css("display",b.attr("dsp"));0<e.length&&"DES_plugin"!=a?e[0].click():(u=$X(a.replace("DES_","")),u.style.width=u.parentNode.clientWidth-10+"px",u.style.height=r.height-30+"px",d.find('div[id="EWA_FRAME_MAIN"]').css("height",r.height-150))});else{b.attr("full","1");b.attr("st",document.body.scrollTop);b.attr("dsp",b.css("display"));
var h=document.documentElement.clientHeight;g=document.documentElement.clientWidth-10;var k=h-20,l=document.documentElement.clientWidth-30,m=h-20-20-15;h=b.offset();var n=b.position(),p=h.left-n.left,q=b.width(),t=b.height();var r={width:q,height:t,"margin-left":p,left:n.left,top:n.top};b.attr("ori",JSON.stringify(r));b.css({"margin-left":"0px",top:h.top,left:h.left,position:"absolute",display:"",overflow:"auto"});b.animate({width:g,height:k,left:10,top:0},"fast","swing",function(){d.css("width",
...
(function(a,b){"object"===typeof module&&"object"===typeof module.exports?module.exports=b():b(a)})("undefined"!==typeof window?window:this,function(a){function b(m){for(var n=[{number:0,scale:1,items:[]}],p=null,q=0;q<m.length;q++){var t=m[q],r=g[t],u=e[t];n[n.length-1].items.push([t,r,u]);if(r)0==q&&r.first?n[n.length-1].number=10:r.stop?(n[n.length-1].scale=r.value||1,n.push({number:0,scale:1,items:[]}),scale=1,p=null):(q==m.length-1&&(console.log(r),n[n.length-1].number.scale=r.value),p=r);else{if(null==
u)throw"\u975e\u6570\u5b57\u6216\u5355\u4f4d\uff1a"+t;t=q==m.length-1?null:m[q+1];var w=q==m.length-1?null:g[t];w&&w.stop&&(w=null);t=n[n.length-1].number;var v=n[n.length-1].items;r=v[v.length-2];v=v[v.length-3];null==w?null==p?(p=!1,r&&0===r[2]?v&&null!=v[1]&&(p=!0):r&&r[1]&&10===r[1].value&&(p=!0),u=p?t+u:10*t+u):u=r&&r[1]&&10===r[1].value&&(null==v||0===v[2]||null!=v[1])?t+u+10:t+u:u=t+u*w.value;n[n.length-1].number=u;p=null}}return n}function d(m){if(!m)return m;if(!isNaN(m.toString()))return 1*
m.toString();var n=m.replace(/\uff0c|,| |\u5143|\u5706/ig,"").replace(/\u70b9|\u3002/ig,".").split(".");if(2<n.length)throw"\u975e\u6570\u5b57\u8868\u8fbe\u5f0f\uff1a"+m;var p=n[0].split("");m=(2==n.length?n[1]:"").split("");n=!1;var q=p[0];h[q]?(n=!0,p=p.splice(1)):k[q]&&(n=!1,p=p.splice(1));q=p[p.length-1];l[q]?p=p.splice(0,p.length-1):1<m.length&&(q=m[m.length-1],l[q]&&(m=m.splice(0,m.length-1)));q=p;for(var t=p=0,r=q.length-1;0<=r;r-=2){var u=q[r];var w=e[q[r-1]];u=w?"\u89d2"==u?1*("0."+w):"\u5206"==
u?1*("0.0"+w):"\u5398"==u?1*("0.00"+w):"\u6beb"==u?1*("0.000"+w):-1:-1;if(-1===u)break;else p+=u,t++}q=q.splice(0,q.length-2*t);q=b(q);t=0;r=1;for(u=q.length-1;0<=u;u--){w=q[u];var v=w.number;r*=w.scale;t+=v*r}p=t+p;if(0<m.length){q=1;t=0;for(r=m.length-1;0<=r;r--){u=g[m[r]];if(!u)break;q*=u.value;t++}m=1==q?m:m.splice(0,m.length-t);t=b(m);r=0;u=1;for(w=t.length-1;0<=w;w--){v=t[w];var y=v.number;u*=v.scale;r+=y*u}m=[1*("0."+r),q,m.length]}else m=0;return 0==m?p*(n?-1:1):((p+m[0])*m[1]).toFixed(0>
...
function loadWfShow(a,b,d,e,g,h,k,l,m,n){_EWA_WF&&_EWA_WF.EN&&(_EWA_WF.EN1=$J2MAP(_EWA_WF.EN,"WF_UNIT_ID"));e=document.createElement("div");e.style.position="absolute";e.style.zIndex=123;e.innerHTML="ver: "+_EWA_WF.WF_DLV_VER;document.body.appendChild(e);var p=EWAC_WfUtil.WF,q=1000012,t=1000011;for(e=0;e<a.length;e++){var r=a[e],u=r.WF_UNIT_X,w=r.WF_UNIT_Y;null!=u&&1*u<q&&(q=1*u);null!=w&&1*w<t&&(t=1*w)}1000012==q&&(q=0);1000011==t&&(t=0);q-=10;t-=10;n={};var v;for(e=0;e<a.length;e++)r=a[e],p.Ids[e]=
r.WF_UNIT_ID,u=p.CreateUnit(),n[r.WF_UNIT_ID]=u,w=r.WF_UNIT_NAME,"enus"==EWA.LANG&&_EWA_WF.EN1&&_EWA_WF.EN1[r.WF_UNIT_ID]&&_EWA_WF.EN1[r.WF_UNIT_ID].WF_UNIT_NAME_EN&&(w=_EWA_WF.EN1[r.WF_UNIT_ID].WF_UNIT_NAME_EN),u.ChangeDes(w),u.ChangeType(r.WF_UNIT_TYPE),u.WF_UNIT_ADM=r.WF_UNIT_ADM,u.WF_UNIT_ADM_LST=r.WF_UNIT_ADM_LST,u=r.WF_UNIT_X,w=r.WF_UNIT_Y,r=$X(r.WF_UNIT_ID),null!=u&&(r.style.left=u-q+"px"),null!=w&&(r.style.top=w-t+"px");a={};for(e=0;e<b.length;e++)r=b[e],u=r.WF_UNIT_FROM,a[u]||(a[u]=[]),a[u].push(r);
for(e=0;e<b.length;e++)r=b[e],a=r.WF_UNIT_TO,u=r.WF_UNIT_FROM,u=p.Units[u],a=p.Units[a],q=new EWAC_WfCnn,q.Create(u,a),p.Cnns[q.Id]=q,r.IsHaveLogic&&!r.IsLogicOk&&(q.IsStop=!0);for(var y in p.Units)e=p.Units[y],null==v&&0==e.CnnsToLength&&(v=e);if(null==v)e="enus"==EWA.LANG?"No startup node was found, process definition error":"\u672a\u53d1\u73b0\u542f\u52a8\u8282\u70b9,\u6d41\u7a0b\u5b9a\u4e49\u9519\u8bef",alert(e);else{0==d.length&&(p.CurUnit=v);var x=[];y={};for(e=0;e<d.length;e++)b=d[e],p=b.SYS_STA_TAG,
u=n[p],null!=u&&(r=b.ADM_NAME,"enus"==EWA.LANG&&b.ADM_NAME_EN&&(r=b.ADM_NAME_EN),u.Log(r,b.SYS_STA_CDATE,b.SYS_STA_MEMO),y[p]||(y[p]=1,x.push({ID:p,DES:u.GetDes()})),p=b.SYS_STA_TAG+"G"+b.SYS_STA_VAL,EWAC_WfUtil.WF.Cnns[p]&&(EWAC_WfUtil.WF.Cnns[p].Disp(3,"blue"),u==v&&(u.ADM_ID=b.ADM_ID),e==d.length-1&&(u=n[b.SYS_STA_VAL],u.WF_UNIT_ADM_LST=b.ROLE_IDS,u.WF_UNIT_ADM=b.ROLE_TYPE,EWAC_WfUtil.WF.CurUnit=u)));null!=m&&0<m.length&&n[m]&&(EWAC_WfUtil.WF.CurUnit=n[m]);EWAC_WfUtil.WF.CurUnit.LogCur(g);m=!1;
u=EWAC_WfUtil.WF.CurUnit;d=[];if(v==u)m=!0;else if("WF_ADM_ADM"==u.WF_UNIT_ADM)if(v=","+u.WF_UNIT_ADM_LST+",",0<=v.indexOf(","+h+","))m=!0;else for(e in h=$J2MAP1(top.org,"ADM_ID"),k=u.WF_UNIT_ADM_LST.split(","),k){l=h[k[e]];for(var z in l)d.push(l[z].ADM_NAME)}else if("WF_ADM_DEPT"==u.WF_UNIT_ADM)if(v=","+u.WF_UNIT_ADM_LST+",",0<=v.indexOf(","+k+","))m=!0;else for(e in h=$J2MAP1(top.org,"DEP_ID"),k=u.WF_UNIT_ADM_LST.split(","),k)for(z in l=h[k[e]],l)d.push(l[z].ADM_NAME);else if("WF_ADM_POST"==u.WF_UNIT_ADM){v=
","+u.WF_UNIT_ADM_LST+",";h=l.split(",");for(k=0;k<h.length;k++)if(0<=v.indexOf(","+h[k]+",")){m=!0;break}if(!m)for(e in h=$J2MAP1(top.org,"DEP_POS_ID"),k=u.WF_UNIT_ADM_LST.split(","),v={},k)for(z in l=h[k[e]],l)n=l[z],v[n]||(v[n]=!0,d.push(l[z].ADM_NAME))}else if("WF_ADM_START"==u.WF_UNIT_ADM){if(v==u||h==v.ADM_ID)m=!0}else"WF_ADM_MANAGER"==u.WF_UNIT_ADM&&(z=v.ADM_ID,top||top.ORG||(e="enus"==EWA.LANG?"No organization":"\u6ca1\u6709\u7ec4\u7ec7\u673a\u6784",alert(e),m=!1),m=top.ORG.GetMaster(z).Id==
...
this.lastWR=null);"TD"==b&&1==e.childNodes.length?(h=this.createEle("w:p"),e.appendChild(h)):"TABLE"==b&&null==e.nextSibling&&"w:tc"==e.parentNode.tagName&&(h=this.createEle("w:p"),e.parentNode.appendChild(h))}};this.walkerTxt=function(a){if(""!=a.nodeValue.trimEx()||-1!=a.nodeValue.indexOf("\u3000")){var b=this.createText(a),d=this.getDock();if("w:p"!=d.tagName){var e=this.createP(a.parentNode);a=this.createSpan(a.parentNode);e.appendChild(a);a.appendChild(b);d.appendChild(e);this.docks.push(e)}else this.lastWR||
(a=this.createSpan(a.parentNode),d.appendChild(a)),this.lastWR.parentNode.appendChild(b)}this.lastWR=null};this.createEle=function(a){return this.doc.XmlDoc.createElement(a)};this.createEles=function(a){a=a.split(",");for(var b=[],d=0;d<a.length;d++){var e=this.createEle(a[d].trim());b.push(e);0<d&&b[0].appendChild(e)}return b};this.createElesLvl=function(a){a=a.split(",");for(var b=[],d=0;d<a.length;d++){var e=this.createEle(a[d].trim());b.push(e);0<d&&b[d-1].appendChild(e)}return b};this.createElesSameLvl=
function(a,b){a=a.split(",");for(var d=[],e=0;e<a.length;e++){var g=this.createEle(a[e].trim());d.push(g);b.appendChild(g)}return d};this.createText=function(a){if(""!=a.nodeValue.trim()||-1!=a.nodeValue.indexOf("\u3000")){var b=a.nodeValue;if(a=0<=a.nodeValue.indexOf("\u3000")){var d=eval("/\u3000/g");b=b.replace(d,"\u3010zwer\u4e2d\uff0cwer,\u6587_\u5168`\u89d2=\u7a7a\u683cwerwe\u3011")}b=b.trim();a&&(a=eval("/\u3010zwer\u4e2d\uff0cwer,\u6587_\u5168`\u89d2=\u7a7a\u683cwerwe\u3011/g"),b=b.replace(a,
...
this.liNum++,b[1].setAttribute("w:val",0),b[2].setAttribute("w:val",this.liNum)):(b[1].setAttribute("w:val",0),b[2].setAttribute("w:val",22));a=this.createEle("w:spacing");a.setAttribute("w:line",270);a.setAttribute("w:lineRule","atLeast");var d=this.getDock();d.getElementsByTagName("w:pPr")[0].appendChild(b[0]);d.getElementsByTagName("w:pPr")[0].appendChild(a)};this.createSpan=function(a){var b=this.createEle("w:r");a=$(a);var d=this.createEle("w:rPr");this.lastWR=d;b.appendChild(d);if(""!=a.css("color")){var e=
this.createEle("w:color"),g=this.rgb1(a.css("color"));e.setAttribute("w:val",g);d.appendChild(e)}if(""!=a.css("font-family")){a.css("font-family").replace(/'/ig,"").split(",");e=this.createEle("w:rFonts");var h=/[\u4E00-\u9FA5]|[\uFE30-\uFFA0]/gi.test(a.text())?this.defaultFontChinese:this.defaultFontEnglish;this.setAtts(e,{"w:ascii":h,"w:eastAsia":h,"w:hAnsi":h,"w:hint":"eastAsia","w:cs":this.defaultFontEnglish});d.appendChild(e)}""!=a.css("font-size")&&(e=a.css("font-size"),h=this.fontSize(e),null!=
h&&(e=this.createEle("w:sz"),e.setAttribute("w:val",2*h),d.appendChild(e),g=this.createEle("w:szCs"),g.setAttribute("w:val",2*h),d.appendChild(g)));e=a.css("font-weight");if("B"==a.tagName||""!=e&&"normal"!=e&&"400"!=e)e=this.createEle("w:b"),d.appendChild(e);"I"==a.tagName&&(e=this.createEle("w:i"),d.appendChild(e));return b};this.createBr=function(a){a=this.createEle("w:r");var b=this.createEle("w:br");a.appendChild(b);return a};this.createTable=function(a){var b=this.createEle("w:tbl"),d=this.createEle("w:tblPr"),
e=this.createEle("w:tblStyle");e.setAttribute("w:val","a4");d.appendChild(e);e=this.createWidth(a,"tblW");d.appendChild(e);a.setAttribute("ww",e.getAttribute("w:w"));b.appendChild(d);return b};this.createTbody=function(){return this.createEle("w:tblGrid")};this.createTr=function(a){var b=this.createElesLvl("w:tr,w:trPr");this.setAtts(b[0],{"w:rsidR":"003D2D54","w14:textId":"77777777","w14:paraId":this.getParaId()});a=this.createHeight(a,"trHeight");b[1].appendChild(a);return b[0]};this.paraId=0;this.getParaId=
function(){var a="0000"+this.paraId;a=a.substring(a.length-4);this.paraId++;return"F0C0"+a};this.createTd=function(a){thisTr=a.parentNode;var b=thisTr.parentNode.parentNode,d=a.getAttribute("vmerge"),e=0;if(null!=d&&""!=d){var g=this.createEle("w:tc"),h=this.createEle("w:tcPr"),k=this.createEle("w:vMerge");h.appendChild(k);g.appendChild(h);this.getDock().appendChild(g);e=this.createEle("w:p");g.appendChild(e);g=d.split(",");g=b.rows[g[0]].cells[g[1]];h.appendChild(this.createTdBorders(g));e=1*g.getAttribute("wwtd")}g=
this.createEle("w:tc");h=this.createEle("w:tcPr");g.appendChild(h);if(1<a.rowSpan)for(k=this.createEle("w:vMerge"),k.setAttribute("w:val","restart"),h.appendChild(k),k=0;k<a.rowSpan-1;k++)(d=b.rows[k+1+thisTr.rowIndex])&&(d=d.cells[a.cellIndex])&&d.setAttribute("vmerge",thisTr.rowIndex+","+a.cellIndex);1<a.colSpan&&(b=this.createEle("w:gridSpan"),b.setAttribute("w:val",a.colSpan),h.appendChild(b));h.appendChild(this.createTdBorders(a));k=this.createWidth(a,"tcW");d=a.parentNode;b=d.getAttribute("wwtr");
if(null==b||""==b)b=d.parentNode.parentNode,b=b.getAttribute("ww");var l=k.getAttribute("w:w");a!=a.parentNode.cells[a.parentNode.cells.length-1]?(a.setAttribute("wwtd",l),d.setAttribute("wwtr",1*b-1*l-e)):(k.setAttribute("w:w",0),k.setAttribute("w:type","auto"));h.appendChild(k);a=$(a).css("vertical-align");"middle"==a?(a=this.createEle("w:vAlign"),a.setAttribute("w:val","center"),h.appendChild(a)):"bottom"==a&&(a=this.createEle("w:vAlign"),a.setAttribute("w:val","bottom"),h.appendChild(a));return g};
this.createWidth=function(a,b){b=this.createEle("w:"+b);a=15*$(a).width();b.setAttribute("w:w",a);b.setAttribute("w:type","dxa");return b};this.createHeight=function(a,b){b=this.createEle("w:"+b);a=15*$(a).height();b.setAttribute("w:val",a);return b};this.createTdBorders=function(a){for(var b=this.createEle("w:tcBorders"),d=0;d<this.EWA_DocTmp.borders.length;d++){var e=this.createBorder(a,this.EWA_DocTmp.borders[d]);b.appendChild(e)}return b};this.createBorder=function(a,b){var d=$(a).css("border-"+
b+"-width"),e=this.createEle("w:"+b);"0px"==d?e.setAttribute("w:val","nil"):(e.setAttribute("w:val","single"),a=$(a).css("border-"+b+"-color"),a=this.rgb1(a),e.setAttribute("w:color",a),e.setAttribute("w:sz",6));return e};this.createPVanish=function(){return this.createElesLvl("w:p,w:pPr,w:rPr,w:vanish")};this.createP=function(a){var b=this.createEle("w:p"),d=this.createEle("w:pPr");b.appendChild(d);d=this.createElesSameLvl("w:pStyle,w:jc",d);var e=d[1],g=$(a).css("text-align");g=null==g?"":g;0<=
g.indexOf("center")?e.setAttribute("w:val","center"):0<=g.indexOf("right")?e.setAttribute("w:val","right"):e.setAttribute("w:val","left");e=d[0];e.setAttribute("w:val","a");0==a.tagName.indexOf("H")&&e.setAttribute("w:val",a.tagName.replace("H",""));this.createElesLvl("w:rFonts",d[2])[0].setAttribute("w:hint","eastAsia");this.lastWR=null;this.setAtts(b,{"w:rsidR":"003D2D54","w14:textId":"77777777","w14:paraId":this.getParaId(),"w:rsidRDefault":"0057281A"});return b};this.createPic=function(a){var b=
$(a),d=a.src;this.pics.push(a.src);a=d.lastIndexOf("/");d=d.substring(a+1);a=this.px2emu(b.width());b=this.px2emu(b.height());var e=this.createElesLvl("w:r,w:rPr,w:noProof")[0],g=this.createElesLvl("w:drawing,wp:inline,wp:extent");e.appendChild(g[0]);wExtent=g[2];this.setAtts(wExtent,{cx:a,cy:b});g=g[1];this.setAtts(g,{distT:"0",distB:"0",distL:"0",distR:"0"});var h=this.createElesSameLvl("wp:effectExtent,wp:docPr,wp:cNvGraphicFramePr",g);this.setAtts(h[0],{l:"0",t:"0",r:"0",b:"0"});this.setAtts(h[1],
{id:"0",name:d});var k=this.createEleNs("a:graphicFrameLocks","http://schemas.openxmlformats.org/drawingml/2006/main");h[2].appendChild(k);this.setAtts(k,{noChangeAspect:1});h=this.createEleNs("a:graphic","http://schemas.openxmlformats.org/drawingml/2006/main");k=this.createEle("a:graphicData");k.setAttribute("uri","http://schemas.openxmlformats.org/drawingml/2006/picture");var l=this.createEleNs("pic:pic","http://schemas.openxmlformats.org/drawingml/2006/picture");h.appendChild(k);k.appendChild(l);
g.appendChild(h);g=this.createElesSameLvl("pic:nvPicPr,pic:blipFill,pic:spPr",l);this.setAtts(g[1],{rotWithShape:"1"});this.setAtts(g[2],{bwMode:"auto"});h=this.createElesSameLvl("pic:cNvPr,pic:cNvPicPr",g[0]);this.setAtts(h[0],{id:"0",name:d});h=this.createElesSameLvl("a:blip,a:srcRect,a:stretch",g[1]);this.setAtts(h[0],{"r:embed":"pic"+(this.pics.length-1)});this.setAtts(h[1],{l:"0",t:"0",r:"0",b:"0"});d=this.createEles("a:extLst,a:ext");h[0].appendChild(d[0]);d[1].setAttribute("uri","{28A0092B-C50C-407E-A947-70E740481C1C}");
h=this.createEleNs("a14:useLocalDpi","http://schemas.microsoft.com/office/drawing/2010/main");h.setAttribute("val",0);d[1].appendChild(h);d=this.createElesSameLvl("a:xfrm,a:prstGeom,a:ln,a:extLst",g[2]);this.setAtts(d[1],{prst:"rect"});g=this.createElesSameLvl("a:off,a:ext",d[0]);this.setAtts(g[0],{x:0,y:0});this.setAtts(g[1],{cx:a,cy:b});this.createElesSameLvl("a:avLst",d[1]);this.createElesSameLvl("a:noFill",d[2]);return e};this.createEleNs=function(a,b){return this.doc.XmlDoc.createElementNS(b,
a)};this.setAtts=function(a,b){for(var d in b)a.setAttribute(d,b[d])};this.fontSize=function(a){0<a.indexOf("px")&&(a=this.EWA_DocTmp.f[a],a=null==a?"9pt":a);return a.replace("pt","")};this.rgb1=function(a){a=a.replace("rgb(","").replace(")","").split(",");return this.rgb(1*a[0],1*a[1],1*a[2]).toUpperCase()};this.rgb=function(a,b,d){a=a.toString(16);b=b.toString(16);d=d.toString(16);return(2>a.length?"0":"")+a+(2>b.length?"0":"")+b+(2>d.length?"0":"")+d};this.init=function(){this.doc=new EWA_XmlClass;

...
d;this._checkStatusTimer=window.setInterval(function(){var n=0==e._checkStatusInc?e._checkStatusFristResult:e.DoPostBefore();e._checkStatusInc++;null!=n[0]&&(window.clearInterval(e._checkStatusTimer),e._checkStatusTimer=null,e._checkStatusInc=null,e._checkStatusFristResult=null,0==n[0]?n[2]?$Confirm(n[1],n[1],function(){n[0]=n[1]=null;e.DoPost(a,b,!0)},function(){}):$Tip(n[1]):(n[0]=n[1]=null,e.DoPost(a,b,!0)))},232);return}if(!d)return}var g=$(a).find("input[ewa_tag=ht5upload]");if(!(0<g.length)||
...
null),this.posting=!1,this.DoPostEnd&&this.DoPostEnd(a,a._Http.status,a._Http.responseText,a._Http.statusText),200==a._Http.status){if(a=a._Http.responseText,EWA.F.CheckCallBack(a)){this.ValidCodeError(!0);try{this.ReloadAfter&&this.ReloadAfter(a),eval(a)}catch(b){alert(a)}}}else alert("ERROR:\r\n"+a._Http.statusText)};this.Reload=function(){};this.Reload1=function(){console.log("Reload1 \u8fd9\u4e2a\u5e72\u561b\u7528\uff1f\u8c01\u5728\u8c03\u7528\uff1f")};this.ReloadFrame=function(a){var b=$("#EWA_FRAME_"+

...
(console.log("\u8bf7\u7528\uff1adoPostAfter"),this.ReloadAfter(a)),eval(a)}catch(b){console.log(a),console.error(b),alert(a)}}}else alert("ERROR:\r\n"+a._Http.statusText)};this.Reload=function(){};this.Reload1=function(){console.log("Reload1 \u8fd9\u4e2a\u5e72\u561b\u7528\uff1f\u8c01\u5728\u8c03\u7528\uff1f")};this.ReloadFrame=function(a){var b=$("#EWA_FRAME_"+this._Id);if(0!=b.length){var d=b.parentsUntil("#EWA_FRAME_MAIN").last().parent();if(0!=d.length){b=EWA_Utils.tempId("ewa_frame_relaod");d.attr("id",
b);var e=new EWA_UrlClass(this.Url);e.AddParameter("ewa_ajax","install");e=e.GetUrl();$Install(e,b,function(){a&&a(d,this)})}}};this.CheckValidAll=function(a){var b=!0,d=null,e;for(e in this.ItemList.Items){var g=this.ItemList.GetItemValue(this.ItemList.Items[e],"Name","Name");g=this.GetObject(g,a);null!=g&&((b&=this.CheckValid(g))||null!=d||(d=g))}null!=d&&d.focus();return b};this.H5Type=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var d=this.ItemList.Items[b],e=this.ItemList.GetItemValue(d,
"Name","Name");e=a.find('[id="'+e+'"]');if(0!=e.length){var g=this.ItemList.GetItemValue(d,"Tag","Tag"),h=this.ItemList.GetItemValue(d,"DataItem","Valid");this.ItemList.GetItemValue(d,"DataItem","Format");d=this.ItemList.GetItemValue(d,"IsMustInput","IsMustInput");"Email"==h&&e.attr("type","email");"valid"==g&&e.attr("type","tel");1==d&&e.attr("required","required")}}};this.GetObject=function(a,b){b||(b=$("FORM#f_"+this._Id));a=$(b).find('[id="'+a+'"]');return 0<a.length?a[0]:null};this.CheckValid=
function(a,b){if("SPAN"==a.tagName||"IMG"==a.tagName)return!0;if(a&&b&&"DIV"==a.tagName&&"REPT"==a.getAttribute("tag")){b=b.target.tagName;if("LABEL"==b||"INPUT"==b){var d=this;setTimeout(function(){d._GetObjectValue(a);d.ItemList.CheckValid(a,e)},10)}return!0}var e=this._GetObjectValue(a);return this.ItemList.CheckValid(a,e)};this._GetObjectValue=function(a){return this.ItemList.GetObjectValue(a)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}
var __EWA_ALTER_MSG=null;
function EWA_FrameShowAlert(a,b){if(1!=a.getAttribute("show_alert")){a.setAttribute("show_alert",1);var d=a;do if(d=d.parentNode,"BODY"==d.tagName){d=null;break}while("TR"!=d.tagName||1!=d.getAttribute("SHOW_MSG"));if(!d){var e=$(a);e.attr("ori_bc",e.css("background-color"));e.css("background-color","pink");"SELECT"!=a.tagName&&a.focus();e=$(a).parentsUntil("tbody").last();e.prev().hasClass("ewa-row-"+a.id)&&(d=e.prev()[0])}if(d)if(1==d.cells.length||"1"==d.parentNode.parentNode.getAttribute("error_show_type")){e=$(d);
var g=e.next();g.attr("error")||(g=d.parentNode.insertRow(d.rowIndex+1),g.setAttribute("error",1),g.setAttribute("rid",a.id),a=g.insertCell(-1),a.colSpan=d.cells.length,a.className="ewa-tip-error",g=$(g),a.innerHTML='<div class="ewa-tip-error-info"></div>');e.find("td").addClass("ewa-tip-error");g.find(".ewa-tip-error-info").html(b)}else 3==d.cells.length?(d.style.backgroundColor="lightyellow",null==a.getAttribute("ori_msg")&&(a.setAttribute("ori_msg",d.cells[2].innerHTML),a.setAttribute("ori_st",
...
a);this._IsAddPreRow=!0};this.AddPreRowCheck=function(a,b,d){return!0};this.AddPreRowCloseBeforeEvent=function(a,b,d,e,g){};this.AddPreRowCloseEvent=function(a,b,d,e,g){};this._MSetBg=function(a,b){var d="";"down"==b?d="ewa_grid_down":"over"==b&&(d="ewa_grid_mover");$(a).children("td").removeClass("ewa_grid_mover ewa_grid_down").addClass(d)};this._ReShowSearchQuick=function(){var a=this,b=EWA_ListFrameClass.prototype.RESOURCES.search_text_items,d,e,g;for(g in b){var h=b[g];"eq"==h.Id&&(d=h);"lk"==
h.Id&&(e=h)}for(g in this._SearchJson){var k=this._SearchJson[g];k.isSearchQuick&&(b=$("#EWA_LF_"+this.Id+' .ewa-lf-data-row [id="'+g+'"]'),b.bind("click",function(l){l.stopPropagation();l=$(this).attr("search_tag");var m=$(this).text(),n=m,p=$("#EWA_SEARCH_ITEM_"+a.Id+' .ewa-lf-search-item-ctl [name="'+this.id.toUpperCase()+'"]');if("number"==l||"date"==l)p=p.parentsUntil(".ewa-lf-search-item").last().find("input");var q=p.parentsUntil(".ewa-lf-search-item").last().find("a");if("date"==l)m=m.split(" ")[0],
n=m+" 23:59:59";else if("fix"==l){var t=null;p.find("option").each(function(){this.text==m&&(t=this.value)});m=null===t?"":t}p.val()==m?("text"==l&&e&&0<q.length&&(q.attr("tag",e.Id),q.html("enus"==EWA.LANG?e.TxtEn:e.Txt)),p.val("")):("text"==l&&d&&0<q.length&&(q.attr("tag",d.Id),q.html("enus"==EWA.LANG?d.TxtEn:d.Txt)),p.val(m),"date"==l&&(p[1].value=n))}),b.each(function(){$(this).text()&&$(this).addClass("ewa-lf-search-text-click").attr("search_tag",k.T)}))}};this.ReShowWithNoButtons=function(){var a=
$X("EWA_LF_"+this._Id),b=[],d;for(d in this.ItemList.Items){var e=this.ItemList.Items[d],g=this._GetSubValue("Tag","Tag",e);if(null!=g&&"button"==g.trim().toLowerCase())for(g=0;g<a.rows[0].cells.length;g++)if(a.rows[0].cells[g].childNodes[0].id.toUpperCase()==d){b.push(g);e.setAttribute("but_show","1");break}}this.ShowHiddenColumns(b,!1)};this.ReShowButtonsInDailogTitle=function(){EWA.OW.Load();if(EWA.OW.Dia){var a=$(EWA.OW.Dia._Dialog.GetFrameTitle()),b=$($X("EWA_RESHOW_"+this._Id)).find("td.ewa_lf_func:eq(0)"),
...
null==h&&(h="");var k=a.getAttribute("action_js"),l=this.ItemList.GetValue(d,"DataItem","DataType");d=[{Name:"EWA_FIELD_ID",Value:d},{Name:"EWA_FIELD_VAL",Value:e},{Name:"EWA_ACTION_RELOAD",Value:"0"},{Name:d,Value:e},{Name:"EWA_DATA_TYPE",Value:l},{Name:"EWA_FIELD_VAL_OLD",Value:a.getAttribute("old")}];this.EditEvent={FROM:a,OLD_VAL:a.getAttribute("old"),NEW_VAL:a.value};this.DoAction(a,b,g,h,d,k)}else a.focus()};this.RewriteInfo=function(a,b,d,e,g){var h=$("#EWA_LF_"+this._Id),k=[];if(a)this._INFO=
{},this._INFO.INFO=a,this._INFO.ID_NAME=b||"id",this._INFO.INFO_NAME=d||"info",this._INFO.MEMO_NAME=e||"memo";else if(!this._INFO||!this._INFO.INFO)return;for(a=0;a<this._INFO.INFO.length;a++)if(b=this._INFO.INFO[a],d=h.find('[id="'+b[this._INFO.ID_NAME]+'"]:eq(0)'),0!==d.length){e=d.parentsUntil("tr").last();var l=b[this._INFO.INFO_NAME],m=b[this._INFO.MEMO_NAME];if(null==l||""==l.trim())for(l=e.parent()[0],m=0;m<l.cells.length;m++){if(l.cells[m]==e[0]){this.ShowHiddenColumn(m,!1);break}}else 0==
d.children().length?d.text(l):d.children()[0].innerText=l,m&&d.attr("title",m);k.push(d[0]);g&&g(d[0],b,a)}return k};this.ShowHiddenColumn=function(a,b){var d=$X("EWA_LF_"+this._Id),e="";if(null==b||0==b||"none"==b)e="none";for(b=0;b<d.rows.length;b++)d.rows[b].cells.length==d.rows[0].cells.length&&(d.rows[b].cells[a].style.display=e)};this.ShowHiddenColumns=function(a,b){var d=$X("EWA_LF_"+this._Id),e="";if(null==b||0==b||"none"==b)e="none";b=d.rows[0].cells.length;for(var g=0;g<d.rows.length;g++){var h=
d.rows[g];if(h.cells.length==b)for(var k=0;k<a.length;k++)h.cells[a[k]].style.display=e}};this.GroupShowHidden=function(a){var b=$(a).attr("t"),d=(new Date).getTime();if(!(b&&333>d-b)){$(a).attr("t",d);b=a.parentNode.parentNode;d=b.getAttribute("ewa_group");""==d?(d="none",a.childNodes[0].innerHTML=" + "):(d="",a.childNodes[0].innerHTML=" - ");b.setAttribute("ewa_group",d);for(var e=b.parentNode.parentNode,g=0,h=b.rowIndex+1;h<e.rows.length;h++){b=e.rows[h];if("group"==b.getAttribute("ewa_tag"))break;
b.getAttribute("add_pre_row")?"none"==d?("none"!=b.style.display&&b.setAttribute("ewa_group_show_old",b.style.display),b.style.display="none"):b.hasAttribute("ewa_group_show_old")&&(b.style.display=b.getAttribute("ewa_group_show_old"),b.removeAttribute("ewa_group_show_old")):(b.style.display=d,g++)}a.childNodes[a.childNodes.length-1].innerHTML=" ("+g+")"}};this.Sort=function(a){var b=this._last_sort_timer||0,d=this._Sort||"",e=(new Date).getTime();d==a&&500>e-b||(this._last_sort_timer=e,this._Sort=
a,this.Goto(1))};this.SearchClear=function(a){a=a.parentNode.parentNode.parentNode.parentNode;for(var b=0;b<a.rows.length;b+=1)for(var d=a.rows[b].getElementsByTagName("input"),e=0;e<d.length;e++){var g=d[e];if("text"==g.type)g.value="";else if("radio"==g.type||"checkbox"==g.type)g.checked=!1}};this.SearchGetExpInit=function(){var a=$("#_G_"+this._Id),b=[];$(a).find(".ewa-lf-search-item").each(function(){var d=$(this).find("input");if(0==d.length&&(d=$(this).find("select"),0==d.length))return;var e=
d[0],g=$(e).attr("t");if(1==d.length){var h=e.value;if(""!=e.value.trim())for("text"==g&&(d=$(e.parentNode.parentNode).find("a").attr("tag"))&&(g=d),e=e.name.split(","),d=0;d<e.length;d++)b.push(e[d]+"["+g+"]"+h)}else if(("date"==g||"number"==g)&&2==d.length){if(h=e.value,g=d[1].value,""!=g||""!=h)b.push(e.name+"[gte]"+h),g&&b.push(e.name+"[lte]"+g)}else if("fix"==g&&"INPUT"==e.tagName){var k=[""];$(this).find("input").each(function(){this.checked&&k.push(this.value)});1!=k.length&&b.push(e.name+
"[or]"+k.join(";"))}});return b.join(",")};this.SearchGetExp=function(a){var b=[];$(a).find(".ewa-lf-search-item").each(function(){var d=$(this).find("input");if(0==d.length&&(d=$(this).find("select"),0==d.length))return;var e=d[0],g=$(e).attr("t");if(1==d.length){var h=e.value;""!=e.value.trim()&&("text"==g&&(d=$(e.parentNode.parentNode).find("a").attr("tag"))&&(g=d),b.push("@!@"+e.name+"~!~"+g+"~!~"+h))}else if(("date"==g||"number"==g)&&2==d.length)h=e.value,d=d[1].value,""==d&&""==h||b.push("@!@"+
e.name+"~!~"+g+"~!~"+h+"~!~"+d);else if("fix"==g&&"INPUT"==e.tagName){var k=[""];$(this).find("input").each(function(){this.checked&&k.push(this.value)});1!=k.length&&b.push("@!@"+e.name+"~!~"+g+k.join("~!~"))}});return b.join("")};this.DoSearch=function(a){var b=!1;a.id=="EWA_SEARCH_ITEM_"+this.Id?a=$X("EWA_SEARCH_ITEM_"+this.Id).childNodes[0]:(a=a.parentNode.parentNode.parentNode.parentNode,b=!0);this._SearchExp=this.SearchGetExp(a);b&&(this._SearchHtml=a.parentNode.innerHTML,this._SearchDialog.Show(!1));
...
function(){var a=$X("EWA_LF_"+this._Id);if(!a||1>a.rows.length)return"";var b=[],d=$F(a,"input","type","radio,checkbox");if(0<d.length)for(var e=0;e<d.length;e++)d[e].checked&&b.push(d[e].value);else for(e=0;e<a.rows.length;e++)d=a.rows[e],1==d.getAttribute("__ewa_lf_mdown")&&b.push(d.getAttribute("EWA_KEY"));return b.join(",")};this.SelectCheckedInputs=function(){var a=[],b=$X("EWA_LF_"+this._Id);if(1>b.rows.length)return a;b=b.getElementsByTagName("input");a=[];for(var d=0;d<b.length;d++)("CHECKBOX"==
b[d].type.toUpperCase()||"RADIO"==b[d].type.toUpperCase())&&b[d].checked&&a.push(b[d]);return a};this.SelectCheckedRows=function(){for(var a=[],b=$X("EWA_LF_"+this._Id),d=0;d<b.rows.length;d++){var e=b.rows[d],g=e.getElementsByTagName("input");0!=g.length&&g[0].checked&&-1==g[0].parentNode.className.indexOf("ewa-switch")&&a.push(e)}if(0==a.length)for(d=0;d<b.rows.length;d++)e=b.rows[d],1==e.getAttribute("__ewa_lf_mdown")&&a.push(e);return a};this.Reload=function(a){this.StopAjaxAfterReload?this.StopAjaxAfterReload=
!1:this.Goto(this._PageCurrent,a)};this.refreshPage=function(a,b){this.replaceRowsData(null,null,a,b)};this.replaceRowsData=function(a,b,d,e){var g=this.getUrlClass();g.AddParameter("EWA_AJAX","LF_RELOAD");g.AddParameter("EWA_IS_SPLIT_PAGE","no");g.AddParameter("EWA_IS_HIDDEN_CAPTION","yes");g=g.GetUrl();a&&(g+="&"+a);var h=a?new EWA_AjaxClass:this.CreateAjax(),k=this;h.PostNew(g,function(){if(4==h._Http.readyState){h.HiddenWaitting();var l=h._Http.responseText;200!=h._Http.status?(console.error(l),
alert("ERROR:\r\n"+h._Http.statusText)):EWA.F.CheckCallBack(l)?k.replaceRowsWithDataHtml(l,b,d,e):console.error(l)}})};this.replaceRowsWithDataHtml=function(a,b,d,e){var g=$("<div></div>");g.html(a);var h=[],k=$("#EWA_LF_"+this._Id);g.find(".ewa-lf-data-row").each(function(){var l='tr[ewa_key="'+$(this).attr("ewa_key")+'"]',m=k.find(l);if(0==m.length)console.warn(l+" not found");else{l=$(this).attr("ewa_row_sign");var n=m.attr("ewa_row_sign"),p=!0;(l||n)&&n===l&&(p=!1);if(p){m.attr("ewa_row_sign",
l);l=m.clone()[0];for(n=0;n<this.cells.length;n++){p=m[0].cells[n];var q=this.cells[n];p.removeAttribute("ewa-merged");p.removeAttribute("ewa-search-marked");b?b(q,p):p.innerHTML=q.innerHTML}h.push({before:l,current:m[0]})}}});g.remove();this.SearchMark();this.IsReShow&&this.ReShowWithNoButtons();this._ReShowSearchQuick();null!=this._IsDblClick&&this.DblClick(c._IsDblClick);this.SubBottomsArray&&this._SubBottoms();this.ReloadAfter&&this.ReloadAfter(d);this.ReloadAfterApp&&this.ReloadAfterApp(d);e&&
e(h)};this.DoAction=function(a,b,d,e,g,h){EWA.F.CID=this._Id;if(b){if(a&&$(a).parent().hasClass("scroll-delete")){var k=$(a).attr("do-action-time")||0,l=(new Date).getTime();if(1E3>l-k)return;$(a).attr("do-action-time",l)}this.lastAction=b;this._Ajax=new EWA_AjaxClass;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.AddParameter("EWA_ACTION_TIP",
e);null!=h&&0<h.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",h),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=!1;if(a&&a.getAttribute&&"yes"==a.getAttribute("box_menu_item")){if(this._Ajax.AddParameter("___CALL__FROM__","box"),a=a.parentNode)a=a.getAttribute("json_ref"),a=JSON.parse(a),a.EWA_KEY&&this._Ajax.AddParameter("EWA_ACTION_KEY",a.EWA_KEY)}else(a=this.GetRowKey(a))&&this._Ajax.AddParameter("EWA_ACTION_KEY",a);a=this.SelectChecked();
this._Ajax.AddParameter("IDS_SPLIT",a);if(null!=g&&0<g.length)for(a=0;a<g.length;a+=1)this._Ajax.AddParameter(g[a].Name,g[a].Value);g=new EWA.C.Url;g.SetUrl(this.Url);var m=g.RemoveParameter("EWA_ACTION"),n=this;d?((g=_EWA_INFO_MSG[d])||(g=d),$Confirm(g,"Confirm",function(){n._Ajax.PostNew(m,function(){n._CallBackJs()})})):this._Ajax.PostNew(m,function(){n._CallBackJs()})}};this.NewPageSize=function(a){this._PageSize!=a&&(this._PageSize=a,this.Goto(1))};this.Goto=function(a,b){EWA.F.CID=this._Id;
this._PageCurrent=a;this._Ajax=this.CreateAjax();a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.RemoveParameter("EWA_AJAX");var d=this;this._Ajax.PostNew(a.GetUrl(),function(){d._CallBack(b)});this.REPLACE_HISTORY_STATE&&this.replaceHistoryState()};this.createReplaceHistoryStateUrl=function(){var a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.AddParameter(this._PageCurrentName,this._PageCurrent);this._PageSize&&a.AddParameter(this._PageSizeName,
...
if("DescriptionSet"==a)for(a=0;a<b.length;a+=1){var d=b[a].getAttribute("Lang");if(null!=d&&d.trim().toUpperCase()==EWA.LANG.trim().toUpperCase())return b[a]}return b[0]};this._GetSubValue=function(a,b,d){a=this._GetSubItem(a,d);return null==a?null:this.Xml.GetElementAttribute(a,b)};this.AddColumns=function(a,b,d,e,g,h,k,l){var m=$X("EWA_LF_"+this._Id);null==l&&(l=m.rows[0].cells.length);for(var n=0;n<a.length;n++)for(var p=a[n],q=l+n,t=0;t<m.rows.length;t++){var r=m.rows[t].insertCell(q);r.title=
p[e];if(0==t)r.className="EWA_TD_H ewa-add-column ewa-col-"+p[b],r.innerHTML='<nobr cellIdx="'+q+'" id="'+p[b]+'">'+p[d]+"</nobr>",r.title=p[e],r.width=100;else{var u=m.rows[t].getAttribute("EWA_KEY");r.className="EWA_TD_M ewa-add-column ewa-col-"+p[b];u=u+"_"+p[b];var w=this._GetAddControl(p[h],p[d],p[e]);null==w&&(w=g);var v=k.replace("[ID]",p[b]);w=0<=w.indexOf("<select")?w.replace("!!",v.replace("onblur=","onchange=")):w.replace("!!",v);r.innerHTML=w;r.childNodes[0].id=u}}};this._GetAddControl=
function(a,b,d){if(null==a)return null;a=a.toUpperCase().trim();b=b?b.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/"/ig,"&quot;"):"";d=d?d.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/"/ig,"&quot;"):"";return"SELECT"==a?'<select des="'+b+'"  title="'+d+'" !!></select>':"DATE"==a?'<input type=text des="'+b+'" title="'+d+'" class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,false);" readonly !!>':"TIME"==a?'<input type=text des="'+b+'" title="'+d+'"  class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,true);" readonly !!>':
"STRING"==a||"NUMBER"==a?'<input type=text des="'+b+'"  title="'+d+'" class=EWA_INPUT !!>':null};this.AddedValues=function(a,b,d,e,g){for(var h=0;h<a.length;h++){var k=a[h],l=$X(k[b]+"_"+k[d]);if(!l)break;var m=l.tagName.toUpperCase();"INPUT"==m||"SELECT"==m||"TEXTAREA"==m?l.value=k[e]:l.innerHTML=k[e];g&&(this.GetRow(l).getElementsByTagName("input")[0].checked=!0)}};this.AddRow=function(a){for(var b=$X("EWA_LF_"+this._Id),d=b.insertRow(-1),e=0;e<b.rows[0].cells.length;e++){var g=d.insertCell(-1),
h=b.rows[0].cells[e];g.className="EWA_TD_M";null!=a[e]&&(g.innerHTML=a[e]);g.style.display=h.style.display;g.id="ADD_ROW_"+h.childNodes[0].id}return d};this.Calc=function(a,b,d,e){for(var g=$X("EWA_LF_"+this._Id),h={},k=0;k<a.length;k++)h[a[k]]=0;for(k=b;k<d;k++)for(a=g.rows[k],b=0;b<a.cells.length;b++)if(null!=h[b]){var l=a.cells[b],m=l.getElementsByTagName("input");0<m.length?h[b]+=1*m[0].value:(l=GetInnerText(l),""==l&&(l=0),h[b]+=1*l)}d=g.rows[e];for(k=0;k<d.cells.length;k++)null!=h[k]&&(l=Math.round(100*
h[k])/100,e=GetInnerText(d.cells[k]),l!=1*e&&(this.IsCalcChanged=!0),d.cells[k].innerHTML=l.fm())};this.mergeHeaders=function(a,b,d){var e=$($X("EWA_LF_"+this._Id)),g=e.find('tr[ewa_tag="HEADER"]');if(0!=g.length&&(a=g.find('nobr[id="'+a+'"]').parent(),0!=a.length)){var h=e.find("tr[ewa_mearge]");0==h.length&&(h=$(e[0].insertRow(1)),h.attr("ewa_mearge","gdx"));e=-1;for(var k=0;k<g[0].cells.length;k++){var l=g[0].cells[k];l==a[0]&&(e=k,l.colSpan=d);if(-1==e)"1"!=$(l).attr("ewa_tdmearged")&&(l.rowSpan=
2);else if(e+d==k)e=-1,l.rowSpan=2;else{l.rowSpan=1;var m=h[0].insertCell(-1);m.innerHTML=l.innerHTML;m.className=l.className;m.style.cssText=l.style.cssText;l.style.display="none";$(l).attr("ewa_tdmearged",1)}l==a[0]&&(l.innerHTML=b,l.style.display="",l.style.width="")}}};this.MeargeHeader=function(a,b,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 mergeHeaders");this.mergeHeaders(a,b,d)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}

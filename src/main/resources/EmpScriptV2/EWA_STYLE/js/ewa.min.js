...
function _$J_SELECT(a,b,c,d,e,g,h,k){function l(v,u){var x=v[c],w=b.options[b.options.length]=new Option(x,v[d]);if(u){for(var y=[],A=0;A<u;A++)y.push("");y.push(x);y.join("\u3000")}for(var B in v)v[B]&&w.setAttribute("para_"+B.toLowerCase(),v[B]);w.setAttribute("json",JSON.stringify(v));return w}b.options.length=0;e&&(b.options[0]=new Option("",""),e instanceof Array&&(b.options[0].text=e[0],b.options[0].value=e[1]));if(k){var m=function(v,u){if((v=n[v])&&v._children&&0!=v._children.length)for(var x,
w=0;w<v._children.length;w++)x=v._children[w],l(x,u),m(x[d],u+1)},n={___ROOT___:[]};e={___ROOT___:{}};for(var p,t,r,q=0;q<a.length;q++){r=a[q];p=r[k];t=r[d];if(null===p||""===p||"0"===p)p="___ROOT___";n[p]||(n[p]=[]);n[p].push(r);e[t]=r;e[p]&&(e[p]._children||(e[p]._children=[]),e[p]._children.push(r))}m("___ROOT___",0)}else for(q=0;q<a.length;q++)r=a[q],l(r);g&&(b.value=g);$(b).trigger("change");h&&h(b)}
...
e+=g;var p=[];if("number"===typeof m.length&&!m.propertyIsEnumerable("length")){var t=m.length;for(l=0;l<t;l+=1)p[l]=c(l,m)||"null";var r=0===p.length?"[]":e?"[\n"+e+p.join(",\n"+e)+"\n"+n+"]":"["+p.join(",")+"]";e=n;return r}if("object"===typeof k)for(t=k.length,l=0;l<t;l+=1){var q=k[l];"string"===typeof q&&(r=c(q,m,k))&&p.push(b(q)+(e?": ":":")+r)}else for(q in m)(r=c(q,m,k))&&p.push(b(q)+(e?": ":":")+r);r=0===p.length?"{}":e?"{\n"+e+p.join(",\n"+e)+"\n"+n+"}":"{"+p.join(",")+"}";e=n;return r}}
...
"number"===typeof m.length)k=m;else throw Error("JSON.stringify");else k=function(t,r){if(Object.hasOwnProperty.call(this,t))return r};return c("",{"":l})},parse:function(l,m){function n(p,t){var r,q=p[t];if(q&&"object"===typeof q)for(r in q)if(Object.hasOwnProperty.call(q,r)){var v=n(q,r);void 0!==v?q[r]=v:delete q[r]}return m.call(p,t,q)}if(/^[\],:{}\s]*$/.test(l.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,
...
a.childNodes.length;b+=1)EWA$UI$COMMON.Dispose(a.childNodes[b])}},Drop:function(a){EWA$UI$COMMON.Dispose(a);a.parentNode.removeChild(a)},AniExpand:function(a,b,c,d,e){if(null==d||0>=d)d=10;var g=0,h=b/(1*d),k=c/(1*d),l=a.clientWidth+b,m=a.clientHeight+c,n=window.setInterval(function(){var p=EWA$UI$COMMON.GetObjSize(a);if(g<d-1){var t=p.H+k,r=p.W+h;t>m&&(t=m);r>l&&(r=l);EWA$UI$COMMON.SetSize(a,r,t)}else EWA$UI$COMMON.SetSize(a,l,m);r=EWA$UI$COMMON.GetObjSize(a);t=r.W-p.W;r=r.H-p.H;p=EWA$UI$COMMON.GetPosition(a);
p.Y=p.Y-a.clientHeight-1*a.style.borderTopWidth.replace("px","")-1*a.style.borderBottomWidth.replace("px","");"LEFT_TOP"!=e&&("LEFT_BOTTOM"==e?(r=p.Y-r,t=p.X,EWA$UI$COMMON.MoveTo(a,t,r)):"RIGHT_TOP"==e?(r=p.Y,t=p.X-t,EWA$UI$COMMON.MoveTo(a,t,r)):"RIGHT_BOTTOM"==e?(r=p.Y-r,t=p.X-t,EWA$UI$COMMON.MoveTo(a,t,r)):(r=1*p.Y-r/2,t=1*p.X-t/2,EWA$UI$COMMON.MoveTo(a,t,r),EWA._TmpAniObj=a));g++;g>=d&&(window.clearInterval(n),EWA.UI.Utils.AniExpandCompleateFunction&&(EWA.UI.Utils.AniExpandCompleateFunction(),
...
$DialogInstall=function(a,b,c,d,e,g){var h=EWA_Utils.tempId("dialogInstall"),k=$DialogHtml("<div id='"+h+"'></div>","",c,d,e);$Install(a,h,function(){var l=!(c&&d);if(e||b)l&&k.AutoSize(),g&&g(k,p);else{var m=k.getContent(),n=$(m).find(".EWA_TABLE");if(0!=n.length&&n[0].id){var p=n[0].id;n=p.replace("EWA_FRAME_","").replace("EWA_LF_","");if(EWA&&EWA.F&&EWA.F.FOS&&EWA.F.FOS[n])if(n=EWA.F.FOS[n].Title,p.startsWith("EWA_LF_"))var t=0,r=setInterval(function(){t++;if(90<t)window.clearInterval(r),l&&k.AutoSize(),
g&&g(k,p);else{var q=$(m).find(".ewa_lf_func");if(0!=q.length){window.clearInterval(r);var v=k.getTitleContainer();if(v){q.css({"background-color":"transparent",display:"block","float":"left","font-size":"14px"});var u=q.find(".ewa_lf_func_caption");u.css("color","#08c");u.text(u.text().replace("[","").replace("]","").trim());$(v).find("span:eq(0)").remove();$(v).append(q).css("border-bottom","1px solid #eee")}l&&k.AutoSize();g&&g(k,p)}}},10);else n&&k.SetTitle(n),l&&k.AutoSize(),g&&g(k,p);else l&&
...
"";b=b.document.getElementsByClassName("but")[0];b.style.pointerEvents="";b.style.filter=""}else if("TEXTAREA"==this.tagName){var c=$(this).parent();b=c.find("iframe")[0].contentWindow;b.document.body.contentEditable=!0;b.document.body.style.backgroundColor="";c.find(".ewa-editor").removeAttr("ewadisabled")}})};this.convertFilterCheckbox=function(a,b,c,d,e,g){function h(u){var x=$("<nobr></nobr>");p.append(x);p.append(" ");var w=$(u).parent();u=$(u).attr("id")+"_"+t;w.attr("id",u);x.append(w.children());
x.attr("ref_id",u)}function k(u){u=$(u).parent();var x=u.attr("ref_id");x&&($("#"+x).append(u.children()),u.remove())}var l={},m=this.getObj(".ewa-row-"+a),n=this.getObj(".ewa-row-"+b),p=$("<div class='ewa-filter-checked'></div>");m.find("#"+a).prepend(p).addClass("ewa-filter-chks");var t=this._Id;c||(c="PY");m.find("input[type=checkbox]").each(function(){var u=JSON.parse($(this).attr("json"))[c];u&&(u=u.toUpperCase().trim().substring(0,1),l[u]||(l[u]=[]),l[u].push(this.id),this.checked&&h(this),
$(this).on("change",function(){this.checked?h(this):k(this)}))});a="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");b=["<a class='ewa-filter-char ewa-filter-char-all' code=''>ALL</a>"];for(var r in a){var q=a[r],v=l[q];v&&b.push("<a class='ewa-filter-char' code='"+q+"'>"+q+"<span class='ewa-filter-char-num'>("+v.length+")</span></a>")}n.find(".EWA_TD_M").html(b.join(" "));d&&(m.find(".EWA_TD_L").hide(),m.find(".EWA_TD_M").attr("colspan",2));n.find("a.ewa-filter-char").on("click",function(){var u=$(this).attr("code");
m.find("input[type=checkbox]").each(function(){u?this.checked?p.append($(this).parent()):($(this).parent().attr("ref_id")&&k(this),$(this).parent().hide()):$(this).parent().show()});if(u){for(var x=l[u],w=0;w<x.length;w++)m.find("#"+x[w]).parent().show();g&&g(this,m,n)}});e&&e(m,n)};this.createFilterCheckbox=function(a,b,c,d,e,g,h){var k=this;$J(d,function(l){k.createFilterCheckboxByData(a,b,c,l,e,g,h)})};this.createFilterCheckboxByData=function(a,b,c,d,e,g,h){var k={},l=l?"[]":c.split(",");c={};
for(var m in l)c[l[m]]=1;l=[];var n=[],p=a.id;for(m in d){var t=d[m],r=t[e];r&&(r=r.replace(/</ig,"&lt;"));var q=t[g];q&&(q=q.replace(/</ig,"&lt;"));var v=t[h],u=c[r],x=[];x.push("<nobr class='ewa-filter-chk' style='float:left;margin-right:4px'>");x.push('<input class="ewa-filter-chkbox" type="checkbox" ');u&&x.push(" checked ");t=p+"_"+m;x.push(' value="'+r+'" id="'+t+'" name="'+p+'"><label ');x.push(' for="'+t+'">'+q+"</label></nobr>");u?n.push(x.join("")):l.push(x.join(""));b&&(r=v?v.substring(0,
1).toUpperCase():"",k[r]||(k[r]=[]),k[r].push(t))}a.innerHTML=n.join(" ")+" "+l.join(" ");if(b){d=['<a href="javascript:void(0)">ALL</a>'];for(m="A".charCodeAt();m<="Z".charCodeAt();m++)e=String.fromCharCode(m),k[e]&&d.push('<a href="javascript:void(0)">'+e+"</a>");b.innerHTML=d.join(" ");$(b).find("a").each(function(){var w=$(this).text();"ALL"!=w&&$(this).attr("ids",k[w].join(","));$(this).on("click",function(){if("ALL"==$(this).text())$(a).find("nobr.ewa-filter-chk").show();else{var y=$(this).attr("ids").split(","),
...
b.value));d.PostNew(m,function(){if(d.IsRunEnd()){var p=d.GetRst(),t="__json"+Math.random();try{eval('window["'+t+'"]='+p)}catch(u){b.setAttribute("canopen",0);a.value=u;b.setAttribute("canopen",1);return}p=window[t];if(0!=p.length){t=p[0];var r=[];p={};for(var q in t)r.push(t[q]),p["@"+q.toUpperCase()]=t[q],t[q]&&b.setAttribute("para_"+q.toLowerCase(),t[q]);if(null==c||""==c)p=r.join("/");else{q=c.match(/@[a-zA-Z0-9\-\._:]*\b/ig);for(t=0;t<q.length;t++){r=q[t];var v=p[r.toUpperCase()];c=c.replace(r,
...
"");else{this.focus();$(this).css("background","pink");return}}p=this.id;t=this.value;"droplist"==$(this).attr("ewa_class")&&(t=$(this).next().val(),p=$(this).next().attr("id"));p={key:p,val:t};if("rgb(255, 255, 224)"==n)$Tip(m.html()),k.hide(),this.focus();else if(this.value==$(this).attr("oldv"))$(this).attr("style",""),k.hide();else{var r=this;$JP(l.POST_URL||window.location.href,p,function(q){$(r).attr("style","");k.hide();q.RST?(q="SELECT"==r.tagName?r.options[r.selectedIndex].text:r.value,"TEXTAREA"==
r.tagName?""==q?b.html("............."):(q=q.replace(/</ig,"&lt;").replace(/>/ig,"&gt;"),q="<div>"+q.split("\n").join("</div><div>")+"</div>",b.html(q)):(""==q&&(q="............."),b.text(q)),b.append('<i style="margin-left:5px" class="fa fa-edit"></i>'),$TipTL("\u4fdd\u5b58\u5b8c\u6bd5")):$Tip(q.ERR)})}})}}}
...
g.find('tr[ewa_tag="HEADER"] [id="'+a+'"]').html(e));g.find("tr[ewa_key]").each(function(){var r=document.createElement("div");r.style.display="none";r.innerHTML=l;document.body.appendChild(r);if(0==$(this).find('[id="'+a+'"]').length)console.log("not find "+a);else{var q=$(this).find('[id="'+a+'"]').parent(),v;for(v in k){var u=k[v].replace("@@",""),x=$(this).find('[id="'+u+'"]');if(0!=x.length){u!=a&&x.parent().hide();var w=$(r).find('span[mid="'+u+'"]');c&&(w.append("<span class='ewa-lf-mearge-memo'></span>"),
w.find(".ewa-lf-mearge-memo").html(m[u]));w.append(x)}}for(;0<r.childNodes.length;)q.append(r.childNodes[0]);$(r).remove();d&&d(q,this)}})}else console.log("mergeExp \u6ca1\u6709\u8bbe\u7f6e")};this.MeargeExp=function(a,b,c,d){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 MereExp");this.MergeExp(a,b,c,d)};this.SubBottoms=function(a){this.SubBottomsArray=a.split(",");this._SubBottoms()};this._SubBottoms=function(){var a=this.AddRow([]);$(a).find("td").addClass("ewa-lf-sub-td");var b=0,c;
...
b){return!0};this.checkMDownEnable=function(a,b){return b?(b=b.srcElement?b.srcElement:b.target)?"A"==b.tagName||"A"==b.parentNode.tagName||"INPUT"==b.tagName||"SELECT"==b.tagName||"BUTTON"==b.tagName||"TEXTAREA"==b.tagName||0<=b.className.indexOf("EWA_LF_EDIT")||0<=b.className.indexOf("ewa-lf-edit")||0<=b.className.indexOf("ewa-lf-search-text-click")||0<=b.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=b.parentNode.parentNode.className.indexOf("ewa-lf-search-text-click")||0<=b.className.indexOf("ewa-mdown-stop")||
"TD"==b.tagName&&b.parentNode==a&&0<$(b).children("a:visible").length?!1:!0:!0:!0};this.MDown=function(a,b){if(this.IsTrSelect){var c=(new Date).getTime(),d=$(a).attr("mdown_time_last");if(!(null!=d&&500>c-d)&&($(a).attr("mdown_time_last",c),b=null==b?window.event:b,this.MDownEnableCheck(a)&&this.checkMDownEnable(a,b))){c=b.srcElement?b.srcElement:b.target;d=null;if(!this.IsNotMDownAutoChecked){var e=a.getElementsByTagName("input");if("INPUT"!=c.tagName&&0<e.length)for(c=0;c<e.length;c++){if("RADIO"==
e[c].type.toUpperCase()){d=e[c];d.click();break}if("CHECKBOX"==e[c].type.toUpperCase()&&0>e[c].parentNode.className.indexOf("ewa-switch")){d=e[c];d.click();break}}}if("1"==a.getAttribute("__ewa_lf_mdown"))this._TrSelectMulti&&(d&&"CHECKBOX"==d.type.toUpperCase()&&(d.checked=!1),this._MSetBg(a,""),a.removeAttribute("__ewa_lf_mdown"),$(a).removeClass("ewa-lf-mdown"));else{d&&(d.checked=!0);this._MSetBg(a,"down");a.setAttribute("__ewa_lf_mdown",1);$(a).addClass("ewa-lf-mdown");if(!this._TrSelectMulti&&
(d=a.parentNode)&&d.rows)for(c=0;c<d.rows.length;c++){var g=d.rows[c];"1"==g.getAttribute("__ewa_lf_mdown")&&g!=a&&(g.removeAttribute("__ewa_lf_mdown"),$(g).removeClass("ewa-lf-mdown"),this._MSetBg(g,""))}if(this.IsReShow)for(c=0;c<e.length;c++)"BUTTON"==e[c].type.toUpperCase()&&(d=e[c],"true"==d.getAttribute("disabled")||1==d.getAttribute("disabled")||"true"==d.parentNode.getAttribute("disabled")||1==d.parentNode.getAttribute("disabled")?(this._ReshowButs[d.value].disabled=!0,this._ReshowButs[d.value].style.display=
"none"):(this._ReshowButs[d.value].disabled=!1,this._ReshowButs[d.value].style.display=""))}if(this._IsAddPreRow){if(e=a.getAttribute("ewa_key"),this.AddPreRowCheck(a,e,b)){d=a.parentNode.rows[a.rowIndex+1];if(null==d||1!=d.getAttribute("add_pre_row"))d=a.parentNode.parentNode,c=d.rows[0].cells.length,d=d.insertRow(a.rowIndex+1),d.setAttribute("add_pre_row",1),g=d.insertCell(-1),g.innerHTML="",g.colSpan=c,g.className="",d.style.display="none",g.id=("EWA_LF_NR_"+this._Id+"_"+Math.random()).replace(".",
"G"),$(d).addClass("ewa-lf-add-pre-row");this.prevTr&&(this.AddPreRowCloseBeforeEvent&&this.AddPreRowCloseBeforeEvent(this._Id,a,e,this.prevTr,b),this.prevTr.style.display="none",this.prevTr.cells[0].innerHTML="",this.AddPreRowCloseEvent&&this.AddPreRowCloseEvent(this._Id,a,e,this.prevTr,b));this.prevTr==d?this.prevTr=null:(this.prevTr=d,this.prevTr.style.display="",this.MDownEvent(this._Id,a,e,this.prevTr,b))}}else this.MDownEvent(a,b)}}};this.AddPreRow=function(a){this._IsAddPreRow||(this.MDownEvent=
a);this._IsAddPreRow=!0};this.AddPreRowCheck=function(a,b,c){return!0};this.AddPreRowCloseBeforeEvent=function(a,b,c,d,e){};this.AddPreRowCloseEvent=function(a,b,c,d,e){};this._MSetBg=function(a,b){var c="EWA_TD_M";"down"==b?c="ewa_grid_down":"over"==b&&(c="ewa_grid_mover");for(b=0;b<a.cells.length;b++)$(a.cells[b]).removeClass("ewa_grid_mover ewa_grid_down EWA_TD_M").addClass(c)};this._ReShowSearchQuick=function(){var a=this,b=EWA_ListFrameClass.prototype.RESOURCES.search_text_items,c,d,e;for(e in b){var g=
b[e];"eq"==g.Id&&(c=g);"lk"==g.Id&&(d=g)}for(e in this._SearchJson){var h=this._SearchJson[e];h.isSearchQuick&&(b=$("#EWA_LF_"+this.Id+' .ewa-lf-data-row [id="'+e+'"]'),b.bind("click",function(k){k.stopPropagation();k=$(this).attr("search_tag");var l=$(this).text(),m=l,n=$("#EWA_SEARCH_ITEM_"+a.Id+' .ewa-lf-search-item-ctl [name="'+this.id.toUpperCase()+'"]');if("number"==k||"date"==k)n=n.parentsUntil(".ewa-lf-search-item").last().find("input");var p=n.parentsUntil(".ewa-lf-search-item").last().find("a");
if("date"==k)l=l.split(" ")[0],m=l+" 23:59:59";else if("fix"==k){var t=null;n.find("option").each(function(){this.text==l&&(t=this.value)});l=null===t?"":t}n.val()==l?("text"==k&&d&&0<p.length&&(p.attr("tag",d.Id),p.html("enus"==EWA.LANG?d.TxtEn:d.Txt)),n.val("")):("text"==k&&c&&0<p.length&&(p.attr("tag",c.Id),p.html("enus"==EWA.LANG?c.TxtEn:c.Txt)),n.val(l),"date"==k&&(n[1].value=m))}),b.each(function(){$(this).text()&&$(this).addClass("ewa-lf-search-text-click").attr("search_tag",h.T)}))}};this.ReShowWithNoButtons=
function(){var a=$X("EWA_LF_"+this._Id),b=[],c;for(c in this.ItemList.Items){var d=this.ItemList.Items[c],e=this._GetSubValue("Tag","Tag",d);if(null!=e&&"button"==e.trim().toLowerCase())for(e=0;e<a.rows[0].cells.length;e++)if(a.rows[0].cells[e].childNodes[0].id.toUpperCase()==c){b.push(e);d.setAttribute("but_show","1");break}}this.ShowHiddenColumns(b,!1)};this.ReShowButtonsInDailogTitle=function(){EWA.OW.Load();if(EWA.OW.Dia){var a=$(EWA.OW.Dia._Dialog.GetFrameTitle()),b=$($X("EWA_RESHOW_"+this._Id)).find("td.ewa_lf_func:eq(0)"),
c=this;b.find(".ewa_lf_func_dact").each(function(){this.id=EWA_Utils.tempId("gDx_"+c._Id+"_")});a.html(b.html());a.find(".ewa_lf_func_dact").each(function(){this.onclick=function(){b.find('div[id="'+this.id+'"]').click()}});b.parent().hide();$(EWA.OW.Dia._Dialog.GetFrame()).addClass("ewa-lf-btns-in-title")}};this.ReShow=function(a){this.IsReShow=!0;a=document.createElement("table");a.id="EWA_RESHOW_"+this._Id;a.cellSpacing="0";a.cellPadding="0";var b=!(0<this.Url.toUpperCase().indexOf("EWA_AJAX=INSTALL")||
0<this.Url.toUpperCase().indexOf("EWA_CALL_METHOD=INNER_CALL")||0<this.Url.toUpperCase().indexOf(".JSP"));b?EWA.UI.Utils.SetStyle(a,"width:100%;height:100%;"):EWA.UI.Utils.SetStyle(a,"width:100%");var c=a.insertRow(-1),d=c.insertCell(-1),e=a.insertRow(-1).insertCell(-1);e.className="ewa_lf_func";e.innerHTML='<div style="display:none"></div><div></div>';var g=a.insertRow(-1).insertCell(-1);g.vAlign="top";EWA.UI.Utils.SetStyle(g,"width:100%;");css="";g.innerHTML='<div id="_G_'+this._Id+'" style="'+
css+'"></div>';var h=$X("EWA_LF_"+this._Id),k=h.parentNode.parentNode.parentNode;g.childNodes[0].appendChild(h.parentNode);var l="_G_"+this._Id;this.NewDivId=l;b&&(window.setTimeout(function(){$X("__EWA_DEBUG")&&g.childNodes[0].appendChild($X("__EWA_DEBUG"));var z=$X(l);z.getElementsByTagName("table");var C=EWA.UI.Utils.GetDocSize(window),D=z.parentNode.parentNode.previousSibling.offsetHeight;z.style.top=D+"px";z.style.height=C.H-D+"px"},100),addEvent(window,"resize",function(){var z=$X(l),C=EWA.UI.Utils.GetDocSize(window),
D=z.parentNode.parentNode.previousSibling.offsetHeight;z.style.top=D+"px";z.style.height=C.H-D+"px"}));for(;0<k.childNodes.length;)e.childNodes[0].appendChild(k.childNodes[0]);var m=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",e.childNodes[1]);m.className="ewa_lf_func_caption";b=m;var n=[],p=!1,t=GetInnerText(e);t=t.trim();this._ReshowButs={};for(var r in this.ItemList.Items){m=this.ItemList.Items[r];var q=this._GetSubValue("Tag","Tag",m);if(null!=q&&("button"==q.trim().toLowerCase()||
"butflow"==q.trim().toLowerCase()))for(q=0;q<h.rows[0].cells.length;q++)if(h.rows[0].cells[q].childNodes[0].id.toUpperCase()==r){n.push(q);p=!0;q=this._GetSubValue("DescriptionSet","Info",m);var v=this._GetSubValue("DescriptionSet","Memo",m),u=this._GetSubValue("EventSet","EventName",m),x="";null!=u&&"ewa_click"==u.toLowerCase().trim()&&(x=this._GetSubValue("EventSet","EventValue",m));t=t.replace(q,"");m=this._ReShowButton(q,v,null);this._ReshowButs[q]=m;m.setAttribute("f_id",this._Id);e.childNodes[1].appendChild(m);
""==x?m.onclick=function(){var z=this.getAttribute("f_id");z=EWA.F.FOS[z].SelectCheckedRows();if(null==z||0==z.length)EWA.UI.Msg.Alert(_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM"],_EWA_INFO_MSG["EWA.SYS.CHOOSE_ITEM_TITLE"]);else{z=z[0].getElementsByTagName("input");for(var C=0;C<z.length;C++){var D=z[C];if("button"==D.type&&D.value==this.childNodes[0].innerHTML){D.click();break}}}}:(m.setAttribute("ewa_click",x),m.onclick=function(){eval(this.getAttribute("ewa_click"))});break}}p&&this._ReShowSplit(e.childNodes[1]);
n=e.getElementsByTagName("input");h={};for(q=0;q<n.length;q++){var w=n[q];w.style.display="none";if(null==w.id||""==w.id)w.id=("_tmp_"+Math.random()).replace(".","_");if("button"==w.type){if(m=this._ReShowButton(w.value,w.title,w.id),p=w.nextSibling){var y="";3==p.nodeType&&(y=p.nodeValue.trimEx());"|"==y&&this._ReShowSplit(e.childNodes[1])}}else(p=w.nextSibling)&&(y=3==p.nodeType?p.nodeValue.replace("|",""):p.innerHTML),m=this._ReShowButton(y.trimEx(),w.title,w.id),m.id=("_tmp_"+Math.random()).replace(".",
"_"),h[w.name]||(h[w.name]=[]),h[w.name].push(m.id);e.childNodes[1].appendChild(m)}t=t.replace(/ /ig,"").replace(/\|/ig,"").trimEx();""!=t?0<=t.indexOf("if")?c.style.display="none":d.innerHTML=t.replace(/ /,""):c.style.display="none";k.appendChild(a);for(r in h)for(y=h[r],q=0;q<y.length;q++)w=$X(y[q]),w.setAttribute("_r_ids",y.join(",")),w.onclick=function(){var z=this.getAttribute("_ewa_event_id");$X(z).click();z=this.getAttribute("_r_ids").split(",");for(var C=0;C<z.length;C++)w.id!=z[C]&&($X(z[C]).style.fontWeight=
"",$X(z[C]).style.color="");this.style.fontWeight="bold";this.style.color="blue"};b.innerHTML='<b>[<i class="fa fa-star-o"></i>&nbsp;'+this.Description+"]</b>";if(0<this.Url.toUpperCase().indexOf("EWA_BTNS_IN_TITLE"))var A=this,B=0,E=setInterval(function(){B++;1E3<B&&window.clearInterval(E);EWA.OW.Load();EWA.OW.Dia&&(window.clearInterval(E),A.ReShowButtonsInDailogTitle())},10)};this._ReShowSplit=function(a){EWA.UI.Utils.CreateObject(window,"div","",a).className="ewa_lf_func_split"};this._ReShowButton=
function(a,b,c){var d=EWA.UI.Utils.CreateObject(window,"div","cursor:pointer",document.body);d.innerHTML="<nobr>"+a+"</nobr>";null!=c&&(d.setAttribute("_ewa_event_id",c),d.onclick=function(){var e=this.getAttribute("_ewa_event_id");$X(e).click()});EWA.B.IE&&(d.onselectstart=function(){return!1});d.className="ewa_lf_func_dact";d.title=b;return d};this.CheckValid=function(a){var b=a.tagName.toLowerCase();if("span"==b||"img"==b||"div"==b)return!0;b=this.ItemList.GetObjectValue(a);return this.ItemList.CheckValid(a,
b)};this.ShowEdit=function(a){a.parentNode.style.width=a.clientWidth+"px";a.style.display="none";__show_obj__=a.nextSibling;__show_obj__.style.display="";var b=__show_obj__.childNodes[0];3==b.nodeType&&(b=__show_obj__.childNodes[1]);b.setAttribute("old",b.value);"SELECT"!=b.tagName||b.getAttribute("func")||(b.setAttribute("func",1),b.onchange=function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)});null==b.getAttribute("__ewa_fid__")&&(b.setAttribute("__ewa_fid__",this._Id),b.onblur=
function(){EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this)},b.onkeydown=function(c){c=null==c?window.event:c;var d=c.target?c.target:c.srcElement;13==c.keyCode&&"INPUT"==d.tagName&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditAfter(this);27==c.keyCode&&EWA.F.FOS[this.getAttribute("__ewa_fid__")].EditReset(this)});setTimeout(function(){b.focus()},10)};this.EditReset=function(a){a.parentNode.style.display="none";var b=a.parentNode.previousSibling;b.style.display="";b.innerHTML=a.getAttribute("old");
"select"==a.tagName.toLowerCase()?b.innerHTML=a.options[a.selectedIndex].text:a.value=a.getAttribute("old").replace(/</ig,"&lt;").replace(/>/ig,"&gt;")};this.EditAfter=function(a){if(this.CheckValid(a))if(a.getAttribute("old")==a.value)this.EditReset(a);else{a.parentNode.style.display="none";var b=a.parentNode.previousSibling;b.style.display="";if("droplist"==a.getAttribute("ewa_class")){var c=$(a.parentNode.getElementsByTagName("input")[1]).attr("name");var d=a.parentNode.getElementsByTagName("input")[1].value;
b.innerHTML=a.parentNode.getElementsByTagName("input")[0].value}else"select"==a.tagName.toLowerCase()?(c=$(a).attr("name"),b.innerHTML=a.options[a.selectedIndex].text):(c=a.value.replace(/</ig,"&lt;").replace(/>/ig,"&gt;").replace(/\n/ig,"<br>"),b.innerHTML=c,c=$(a).attr("name")),d=a.value;b=a.getAttribute("action_name");if(""==b||null==b)b="OnListFrameUpdateCell";var e=a.getAttribute("action_confirm");e=null==e?"":e;var g=a.getAttribute("action_tip");null==g&&(g="");var h=a.getAttribute("action_js"),
k=this.ItemList.GetValue(c,"DataItem","DataType");c=[{Name:"EWA_FIELD_ID",Value:c},{Name:"EWA_FIELD_VAL",Value:d},{Name:"EWA_ACTION_RELOAD",Value:"0"},{Name:c,Value:d},{Name:"EWA_DATA_TYPE",Value:k},{Name:"EWA_FIELD_VAL_OLD",Value:a.getAttribute("old")}];this.EditEvent={FROM:a,OLD_VAL:a.getAttribute("old"),NEW_VAL:a.value};this.DoAction(a,b,e,g,c,h)}else a.focus()};this.RewriteInfo=function(a,b,c,d){$X("EWA_LF_"+this._Id);null==this._INFO&&(this._INFO={},this._INFO.INFO=a,this._INFO.ID_NAME=b,this._INFO.INFO_NAME=
c,this._INFO.INFO_MEMO=d);if(null!=this._INFO.INFO)for(a=0;a<this._INFO.INFO.length;a++)if(b=this._INFO.INFO[a],c=b[this._INFO.ID_NAME],$X(c))if(null==b[this._INFO.INFO_NAME]||""==b[this._INFO.INFO_NAME].trim())for(b="TD"==$X(c).parentNode.tagName?$X(c).parentNode:$X(c).parentNode.parentNode,c=0;c<b.parentNode.cells.length;c++)b.parentNode.cells[c]==b&&this.ShowHiddenColumn(c,!1);else $X(c).innerHTML=b[this._INFO.INFO_NAME]};this.ShowHiddenColumn=function(a,b){var c=$X("EWA_LF_"+this._Id),d="";if(null==
b||0==b||"none"==b)d="none";for(b=0;b<c.rows.length;b++)c.rows[b].cells.length==c.rows[0].cells.length&&(c.rows[b].cells[a].style.display=d)};this.ShowHiddenColumns=function(a,b){var c=$X("EWA_LF_"+this._Id),d="";if(null==b||0==b||"none"==b)d="none";b=c.rows[0].cells.length;for(var e=0;e<c.rows.length;e++){var g=c.rows[e];if(g.cells.length==b)for(var h=0;h<a.length;h++)g.cells[a[h]].style.display=d}};this.GroupShowHidden=function(a){var b=$(a).attr("t"),c=(new Date).getTime();if(!(b&&333>c-b)){$(a).attr("t",
c);b=a.parentNode.parentNode;c=b.getAttribute("ewa_group");""==c?(c="none",a.childNodes[0].innerHTML=" + "):(c="",a.childNodes[0].innerHTML=" - ");b.setAttribute("ewa_group",c);for(var d=b.parentNode.parentNode,e=0,g=b.rowIndex+1;g<d.rows.length;g++){b=d.rows[g];if("group"==b.getAttribute("ewa_tag"))break;b.getAttribute("add_pre_row")?"none"==c?("none"!=b.style.display&&b.setAttribute("ewa_group_show_old",b.style.display),b.style.display="none"):b.hasAttribute("ewa_group_show_old")&&(b.style.display=
b.getAttribute("ewa_group_show_old"),b.removeAttribute("ewa_group_show_old")):(b.style.display=c,e++)}a.childNodes[a.childNodes.length-1].innerHTML=" ("+e+")"}};this.Sort=function(a){var b=this._last_sort_timer||0,c=this._Sort||"",d=(new Date).getTime();c==a&&500>d-b||(this._last_sort_timer=d,this._Sort=a,this.Goto(1))};this.SearchClear=function(a){a=a.parentNode.parentNode.parentNode.parentNode;for(var b=0;b<a.rows.length;b+=1)for(var c=a.rows[b].getElementsByTagName("input"),d=0;d<c.length;d++){var e=
c[d];if("text"==e.type)e.value="";else if("radio"==e.type||"checkbox"==e.type)e.checked=!1}};this.SearchGetExpInit=function(){var a=$("#_G_"+this._Id),b=[];$(a).find(".ewa-lf-search-item").each(function(){var c=$(this).find("input");if(0==c.length&&(c=$(this).find("select"),0==c.length))return;var d=c[0],e=$(d).attr("t");if(1==c.length){var g=d.value;if(""!=d.value.trim())for("text"==e&&(c=$(d.parentNode.parentNode).find("a").attr("tag"))&&(e=c),d=d.name.split(","),c=0;c<d.length;c++)b.push(d[c]+
"["+e+"]"+g)}else if(("date"==e||"number"==e)&&2==c.length){if(g=d.value,e=c[1].value,""!=e||""!=g)b.push(d.name+"[gte]"+g),e&&b.push(d.name+"[lte]"+e)}else if("fix"==e&&"INPUT"==d.tagName){var h=[""];$(this).find("input").each(function(){this.checked&&h.push(this.value)});1!=h.length&&b.push(d.name+"[or]"+h.join(";"))}});return b.join(",")};this.SearchGetExp=function(a){var b=[];$(a).find(".ewa-lf-search-item").each(function(){var c=$(this).find("input");if(0==c.length&&(c=$(this).find("select"),
0==c.length))return;var d=c[0],e=$(d).attr("t");if(1==c.length){var g=d.value;""!=d.value.trim()&&("text"==e&&(c=$(d.parentNode.parentNode).find("a").attr("tag"))&&(e=c),b.push("@!@"+d.name+"~!~"+e+"~!~"+g))}else if(("date"==e||"number"==e)&&2==c.length)g=d.value,c=c[1].value,""==c&&""==g||b.push("@!@"+d.name+"~!~"+e+"~!~"+g+"~!~"+c);else if("fix"==e&&"INPUT"==d.tagName){var h=[""];$(this).find("input").each(function(){this.checked&&h.push(this.value)});1!=h.length&&b.push("@!@"+d.name+"~!~"+e+h.join("~!~"))}});
return b.join("")};this.DoSearch=function(a){var b=!1;a.id=="EWA_SEARCH_ITEM_"+this.Id?a=$X("EWA_SEARCH_ITEM_"+this.Id).childNodes[0]:(a=a.parentNode.parentNode.parentNode.parentNode,b=!0);this._SearchExp=this.SearchGetExp(a);b&&(this._SearchHtml=a.parentNode.innerHTML,this._SearchDialog.Show(!1));this.Goto(1)};this.Search=function(a){null==this._SearchHtml?(this._SearchCreate(),this._SearchDialog=new EWA.UI.Dialog.OpenWindow("about:blank","aa",400,100,!0,null,null,!1),this._SearchDialog.SetCaption(_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.TITLE"]),
this._SearchDialog._Dialog.AutoSize=!0,this._SearchDialog._Dialog.SetHtml(this._SearchHtml),this._SearchDialog._Dialog.Show(!0),this._SearchDialog._Dialog.GetFrame().focus(),this._SearchDialog.MoveCenter()):(this._SearchDialog._Dialog.AutoSize=!1,this._SearchDialog.Show(!0))};this.ShowSearch=function(a){$X("EWA_SEARCH_ITEM_"+this.Id)||(this._SearchCreateItm(),a&&this.composeSearchTexts(),this._ReShowSearchQuick())};this.ChangeSearchTextType=function(a){this._MENU_DATE_RANGE&&this._MENU_DATE_RANGE.HiddenMemu();
...
0>g||h<g||(c=e.substring(0,g).trim(),0!=c.length&&(g=e.substring(g+1,h).trim().toLowerCase(),0!=g.length&&(e=e.substring(h+1).trim(),""!=e&&(b[c.toUpperCase()]||(b[c.toUpperCase()]={name:c,tag:g}),c=b[c.toUpperCase()],"lt"==g||"lte"==g?c.para2=e.unURL():c.para1=e.unURL()))))}return b};this.SearchFilterDate=function(a){var b=$(this._MENU_DATE_RANGE.SHOW_BY_OBJECT).parentsUntil(".ewa-lf-search-item").last(),c=b.find("input")[0];b=b.find("input")[1];if("Clear"==a)$(c).val(""),$(b).val("");else{var d=
EWA_Utils.Date(),e="",g="";"Today"==a?g=e=d.GetDateString():"Week"==a?(a=d.GetBenWeek(),e=a[0],g=a[1]):"Today-Weekend"==a?(a=d.GetBenWeek(),e=a[d.GetDateString()],g=a[1]):"Month"==a?(a=d.GetBenMonth(),e=a[0],g=a[1]):"Today-EOM"==a?(a=d.GetBenMonth(),e=a[d.GetDateString()],g=a[1]):"Quarter"==a?(a=d.GetBenQ(),e=a[0],g=a[1]):"Today-EOQ"==a?(a=d.GetBenQ(),e=a[d.GetDateString()],g=a[1]):"Year"==a?(a=d.GetBenYear(),e=a[0],g=a[1]):"Today-EOY"==a&&(a=d.GetBenYear(),e=a[d.GetDateString()],g=a[1]);a=EWA_Utils.Date(e).FormatDate();
d=EWA_Utils.Date(g).FormatDate();d+=" 23:59:59";$(c).val(a);$(b).val(d)}};this._SearchCreateDateRange=function(){var a="_MENU_DATE_RANGE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",c=JSON.parse(JSON.stringify(this.RESOURCES.search_date_items)),d="EWA.F.FOS[&quot;"+this._Id+"&quot;].SearchFilterDate",e;for(e in c){var g=c[e];g.Txt=g[b];g.Cmd=d+"(&quot;"+g.Id+"&quot;)"}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_DATE_RANGE";this._MENU_DATE_RANGE=new EWA_UI_MenuClass(b);
this._MENU_DATE_RANGE.Create(c);$(this._MENU_DATE_RANGE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+a);return b};this._SearchCreateTextType=function(){var a="_MENU_TEXT_TYPE"+this._Id;$("."+a).remove();var b="enus"==EWA.LANG.toLowerCase()?"TxtEn":"Txt",c=JSON.parse(JSON.stringify(this.RESOURCES.search_text_items)),d="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextTypeIt",e;for(e in c){var g=c[e];g.Txt=g[b];g.Cmd=d+"(&quot;"+g.Id+"&quot;)";g.Group=g.Id}b="EWA.F.FOS[&quot;"+this._Id+"&quot;]._MENU_TEXT_TYPE";
this._MENU_TEXT_TYPE=new EWA_UI_MenuClass(b);this._MENU_TEXT_TYPE.Create(c);$(this._MENU_TEXT_TYPE.Dialog.GetFrame()).addClass("ewa-lf-search-menu "+a);this._MENU_TEXT_TYPE.clickBeforeEvent=function(h,k){$(this.Dialog.GetFrame()).find(".search-text-tag").remove();$(k).find("td:eq(0)").html('<b class="fa fa-check search-text-tag"></b>')};return b};this._SearchCreateItm=function(){var a="EWA_SEARCH_ITEM_"+this.Id,b=[],c=[],d=[],e={},g;for(g in this._SearchJson)this._SearchJson[g].ORI_NAME=g,e[g.toUpperCase()]=
this._SearchJson[g];this._SearchJson=e;var h="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchTextType(this)",k="EWA.F.FOS[&quot;"+this._Id+"&quot;].ChangeSearchDateType(this)",l=$J2MAP(this.RESOURCES.search_text_items,"Id");e=this._GetInitSearchMap();var m=!1,n=!1;for(g in this.ItemList.Items)if(null!=this._SearchJson[g]){var p=[],t=this._SearchJson[g],r=t.T,q=this._GetSubValue("DescriptionSet","Info",this.ItemList.Items[g]);p.push("<table class='ewa-lf-search-item ewa-ref-"+g+" ewa-lf-search-type-"+
r+" "+("fix"==r?"ewa-lf-search-fix-m"+(t.M||"0"):"")+"' cellspacing=0 cellpadding=0>");p.push("<tr><td class='ewa-lf-search-item-title' style='position:relative'><nobr><b>");p.push(q);var v=q="",u="lk";e[g.toUpperCase()]&&(v=e[g.toUpperCase()],u=v.tag,q=v.para1,v=v.para2);var x="";"text"==r?(n=l[u]||l.lk,x="enus"==EWA.LANG?n.TxtEn:n.Txt,p.push("<a class='ewa-lf-search-type' tag='"+u+"' href='javascript:void(0)' onclick='"+h+"'>"),p.push(x),p.push("</a>"),n=!0):"date"==r&&(p.push("<a  href='javascript:void(0)' class='fa fa-calendar-check-o'  onclick='"+
k+"'></a>"),m=!0);p.push("</b></nobr></td><td class='ewa-lf-search-item-ctl'>");"text"==r?"blk"==u||"nblk"==u?(t=this._SearchSingle(g,x),t=t.replace("<input","<input disabled "),p.push(t)):p.push(this._SearchSingle(g,q)):"date"==r?p.push(this._SearchDate(g,q,v)):"number"==r?p.push(this._SearchNumber(g,q,v)):"fix"==r&&(t="<div >"+this._SearchFix(g,t,"span",q)+"</div>",p.push(t));p.push("</td></tr></table>");"fix"==r?c.push(p.join("")):d.push(p.join(""))}if(0!=d.length+c.length){b.push('<table class="ewa-lf-search-main" id="'+
a+'" cellspacing="0" cellpadding="0" style="width:100%">');b.push("<tr><td class='ewa-lf-search-des'></td><td>");0<d.length&&b.push(" "+d.join("")+" ");if(0<c.length)for(d=0;d<c.length;d++)b.push(" "+c[d]+" ");b.push("</td></tr></table>");var w=document.createElement("div");this._SEARCH_BOX=w;w.className="ewa-lf-search";w.innerHTML=b.join("");b=$X("EWA_LF_"+this.Id).parentNode;b.parentNode.insertBefore(w,b);a="EWA_SEARCH_ITEM_"+this.Id;var y=this;m&&this._SearchCreateDateRange();n&&this._SearchCreateTextType();
y._SEARCH_ITEM_EXP=this.SearchGetExp(w);"{}"!=JSON.stringify(e)&&(y._SearchExp=y._SEARCH_ITEM_EXP);$(w).find("input[type=text]").on("compositionstart",function(){y._is_search_composition=!0}).on("compositionend",function(){y._is_search_composition=!1});this._TIMER_SEARCH=window.setInterval(function(){if(!y._is_search_composition){try{if(!$X(a)){window.clearInterval(y._TIMER_SEARCH);return}}catch(B){window.clearInterval(y._TIMER_SEARCH);return}var A=y.SearchGetExp(w);A!=y._SEARCH_ITEM_EXP&&(y._SEARCH_ITEM_EXP=
A,y.DoSearch($X(a)))}},700)}};this._SearchSingle=function(a,b){var c=[];c.push('<input t="text" type="text" autocomplete="off" class="EWA_INPUT" maxlength="40" name="');c.push(a.toInputValue());c.push('"');null!=b&&(c.push(' value="'),a=b.toInputValue(),c.push(a),c.push('" '));c.push(" />");return c.join("")};this._SearchDate=function(a,b,c){var d=[];d.push("<table border=0 cellpadding=0 cellspacing=0>");d.push('<td  ><input type="text" autocomplete="off" class="EWA_INPUT" t="date" readonly maxlength="8" onclick="EWA.UI.Calendar.Pop(this)" name="');
...
"'> <input type=submit value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.SEARCH"]+"' onclick='EWA.F.FOS[\""+this._Id+"\"].DoSearch(this);'> <input type=button value='"+_EWA_INFO_MSG["EWA.LF.SEARCH.BUT.CLOSE"]+"' onclick='EWA.F.FOS[\""+this.Id+"\"]._SearchDialog.Show(false);'></td></tr>");a.push("</table></div>");this._SearchHtml=a.join("")};this.SearchMark=function(){for(var a=this._SearchExp.split("@!@"),b=$X("EWA_LF_"+this._Id),c=0;c<a.length;c+=1){var d=a[c].split("~!~");if(!(3>d.length))for(var e=2;e<
d.length;e++){var g=d[e];if(""!=g){if("fix"==d[1]){var h=d[2];$("table#EWA_SEARCH_ITEM_"+this.Id+' [name="'+d[0]+'"]').find("option").each(function(){this.value==h&&(g=this.text)})}for(var k=[],l=0;l<g.length;l++){var m=g[l];"a"<=m&&"z">=m||"A"<=m&&"Z">=m||"0"<=m&&"9">=m?k.push(m):k.push("\\"+m)}g=k.join("");g=eval("/("+g+")/ig");k=d[0].split(",");for(var n in k){l=k[n];this._SearchJson[l]&&(l=this._SearchJson[l].ORI_NAME);try{$(b).find(".ewa-lf-data-row .ewa-col-"+l+">*").each(function(){0==this.children.length&&
(this.innerHTML=this.innerHTML.replace(g,"<font color=red><b>$1</b></font>"))})}catch(p){console.log(p)}}}}}};this.DblClick=function(a){this._IsDblClick=a;for(var b=$X("EWA_LF_"+this._Id),c=1;c<b.rows.length;c++)b.rows[c].ondblclick=function(){var d=this.getElementsByTagName("input");d.length>a&&0==d[a].disabled&&d[a].click()}};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);if((a=$X("EWA_LF_"+
this._Id))&&"table"==a.tagName&&!(1>=a.rows.length)){a=a.rows[1].getElementsByTagName("input");for(var b=0;b<a.length;b++)if("RADIO"==a[b].type.toUpperCase()){this._TrSelectMulti=!1;break}}};this.SetPageParameters=function(a,b,c,d,e){this._PageCurrent=a;this._PageSize=c;this._PageCount=b;this._RecordCount=d;this._Sort=e};this.SetPageParametersName=function(a,b,c,d,e){this._PageCurrentName=a;this._PageSizeName=c;this._PageCountName=b;this._RecordCountName=d;this._SortName=e};this.CheckedAll=function(){var a=
document.getElementById("EWA_LF_"+this._Id);if(!(1>=a.rows.length)){for(var b=0;b<a.rows.length;b+=1){var c=a.rows[b].getElementsByTagName("input");0!=c.length&&(c[0].checked=this._IsCheckedAll)}this._IsCheckedAll=this._IsCheckedAll?!1:!0;this.CheckedAllAfter&&this.CheckedAllAfter(a)}};this.SelectChecked=function(){var a=$X("EWA_LF_"+this._Id);if(!a||1>a.rows.length)return"";var b=[],c=$F(a,"input","type","radio,checkbox");if(0<c.length)for(var d=0;d<c.length;d++)c[d].checked&&b.push(c[d].value);
else for(d=0;d<a.rows.length;d++)c=a.rows[d],1==c.getAttribute("__ewa_lf_mdown")&&b.push(c.getAttribute("EWA_KEY"));return b.join(",")};this.SelectCheckedInputs=function(){var a=[],b=$X("EWA_LF_"+this._Id);if(1>b.rows.length)return a;b=b.getElementsByTagName("input");a=[];for(var c=0;c<b.length;c++)("CHECKBOX"==b[c].type.toUpperCase()||"RADIO"==b[c].type.toUpperCase())&&b[c].checked&&a.push(b[c]);return a};this.SelectCheckedRows=function(){for(var a=[],b=$X("EWA_LF_"+this._Id),c=0;c<b.rows.length;c++){var d=
b.rows[c],e=d.getElementsByTagName("input");0!=e.length&&e[0].checked&&-1==e[0].parentNode.className.indexOf("ewa-switch")&&a.push(d)}if(0==a.length)for(c=0;c<b.rows.length;c++)d=b.rows[c],1==d.getAttribute("__ewa_lf_mdown")&&a.push(d);return a};this.Reload=function(a){this.StopAjaxAfterReload?this.StopAjaxAfterReload=!1:this.Goto(this._PageCurrent,a)};this.DoAction=function(a,b,c,d,e,g){EWA.F.CID=this._Id;if(b){if(a&&$(a).parent().hasClass("scroll-delete")){var h=$(a).attr("do-action-time")||0,k=
(new Date).getTime();if(1E3>k-h)return;$(a).attr("do-action-time",k)}this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","1");this._Ajax.AddParameter("EWA_ACTION",b);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_NO_CONTENT","1");this._Ajax.AddParameter("EWA_ACTION_TIP",d);null!=g&&0<g.trim().length?(this._Ajax.AddParameter("EWA_AFTER_EVENT",g),this.StopAjaxAfterReload=!0,this._Ajax.AddParameter("EWA_ACTION_RELOAD","0")):this.StopAjaxAfterReload=
!1;if(a&&a.getAttribute&&"yes"==a.getAttribute("box_menu_item")){if(this._Ajax.AddParameter("___CALL__FROM__","box"),a=a.parentNode)a=a.getAttribute("json_ref"),a=JSON.parse(a),a.EWA_KEY&&this._Ajax.AddParameter("EWA_ACTION_KEY",a.EWA_KEY)}else(a=this.GetRowKey(a))&&this._Ajax.AddParameter("EWA_ACTION_KEY",a);a=this.SelectChecked();this._Ajax.AddParameter("IDS_SPLIT",a);if(null!=e&&0<e.length)for(a=0;a<e.length;a+=1)this._Ajax.AddParameter(e[a].Name,e[a].Value);e=new EWA.C.Url;e.SetUrl(this.Url);
var l=e.RemoveParameter("EWA_ACTION"),m=this;c?((e=_EWA_INFO_MSG[c])||(e=c),$Confirm(e,"Confirm",function(){m._Ajax.PostNew(l,function(){m._CallBackJs()})})):this._Ajax.PostNew(l,function(){m._CallBackJs()})}};this.NewPageSize=function(a){this._PageSize!=a&&(this._PageSize=a,this.Goto(1))};this.Goto=function(a,b){EWA.F.CID=this._Id;this._PageCurrent=a;this._Ajax=this.CreateAjax();a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.RemoveParameter("EWA_AJAX");var c=this;this._Ajax.PostNew(a.GetUrl(),
function(){c._CallBack(b)});this.REPLACE_HISTORY_STATE&&this.replaceHistoryState()};this.createReplaceHistoryStateUrl=function(){var a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);a.AddParameter(this._PageCurrentName,this._PageCurrent);this._PageSize&&a.AddParameter(this._PageSizeName,this._PageSize);null!=this._Sort&&a.AddParameter(this._SortName,this._Sort);var b=this.SearchGetExpInit();b&&a.AddParameter("EWA_SEARCH",b);if(null!=this.GotoParas&&0<this.GotoParas.length)for(b=
0;b<this.GotoParas.length;b+=1)a.AddParameter(this.GotoParas[b].Name,this.GotoParas[b].Value);a.RemoveParameter("EWA_AJAX");return a};this.replaceHistoryState=function(){var a=this.createReplaceHistoryStateUrl();window.history.replaceState("",null,a.GetUrl())};this.CreateAjax=function(){var a=new EWA.C.Ajax;a.LoadingType="image";a.AddParameter(this._PageCurrentName,this._PageCurrent);this._PageSize&&a.AddParameter(this._PageSizeName,this._PageSize);null!=this._Sort&&a.AddParameter(this._SortName,
this._Sort);null!=this._SearchExp&&""!=this._SearchExp&&a.AddParameter("EWA_LF_SEARCH",this._SearchExp);a.AddParameter("EWA_AJAX","LF_RELOAD");if(null!=this.GotoParas&&0<this.GotoParas.length)for(var b=0;b<this.GotoParas.length;b+=1)a.AddParameter(this.GotoParas[b].Name,this.GotoParas[b].Value);return a};this.DownlodData=function(a,b){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";null!=this._Sort&&this._Ajax.AddParameter(this._SortName,this._Sort);null!=this._SearchExp&&
""!=this._SearchExp&&this._Ajax.AddParameter("EWA_LF_SEARCH",this._SearchExp);this._Ajax.AddParameter("EWA_AJAX","DOWN_DATA");this._Ajax.AddParameter("EWA_AJAX_DOWN_TYPE",a);b&&this._Ajax.AddParameter("EWA_ACTION",b);if(null!=this.GotoParas&&0<this.GotoParas.length)for(a=0;a<this.GotoParas.length;a+=1)this._Ajax.AddParameter(this.GotoParas[a].Name,this.GotoParas[a].Value);this._AjaxType="DOWN_DATA";a=new EWA_UrlClass;a.SetUrl(null==this.Url?document.location.href:this.Url);var c=this;this._Ajax.PostNew(a.GetUrl(),
function(){c._CallBack()})};this.Get=function(a){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";var b=this;this._Ajax.Get(a,function(){b._CallBack()})};this.Post=function(a,b){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";var c=this;this._Ajax.Post(a,b,function(){c._CallBackJs()})};this._CallBack=function(a){var b=this._Ajax;if(4==b._Http.readyState){b.HiddenWaitting();if(top.EWA&&top.EWA.MQE){var c=new EWA_MqeClass;c.Data=b.GetRst();c.FromId=
EWA.F.CID;c.Type="POST";top.EWA.MQE.AddMqe(c)}200==b._Http.status?(b=b._Http.responseText,EWA.F.CheckCallBack(b)&&("DOWN_DATA"==this._AjaxType?(this._AjaxType=null,"DENY"==b.trim()?alert(_EWA_INFO_MSG["EWA.LF.DOWN_DATA.DENY"]):window.location.href=b.trim()):(c=$X("EWA_LF_"+this._Id).parentNode,$(c).replaceWith(b),this.SearchMark(),this.IsReShow&&this.ReShowWithNoButtons(),this._ReShowSearchQuick(),null!=this._IsDblClick&&this.DblClick(this._IsDblClick),this._IsAddPreRow&&this.AddPreRow(),this.SubBottomsArray&&
this._SubBottoms(),this.ReloadAfter&&this.ReloadAfter(a),this.ReloadAfterApp&&this.ReloadAfterApp(a)))):alert("ERROR:\r\n"+b._Http.statusText);this.RewriteInfo()}};this._CallBackJs=function(){var a=this._Ajax;if(4==a._Http.readyState){if(top.EWA&&top.EWA.MQE){var b=new EWA_MqeClass;b.Data=a.GetRst();b.FromId=EWA.F.CID;b.Type="POST";top.EWA.MQE.AddMqe(b)}a.HiddenWaitting();200==a._Http.status?(a=a._Http.responseText,EWA.F.CheckCallBack(a)&&eval(a)):alert("ERROR:\r\n"+a._Http.statusText);this.EditAfterEvent&&
this.EditAfterEvent()}};this.EditAfterEvent=function(){};this._GetItem=function(a){for(var b=this.ItemList,c=0;c<b.length;c+=1){var d=b[c],e=this._GetSubItem("Name",d);if(this.Xml.GetElementAttribute(e,"Name")==a)return d}};this._GetSubItem=function(a,b){b=this.Xml.GetElements(a+"/Set",b);if(null==b||0==b.length)return null;if("DescriptionSet"==a)for(a=0;a<b.length;a+=1){var c=b[a].getAttribute("Lang");if(null!=c&&c.trim().toUpperCase()==EWA.LANG.trim().toUpperCase())return b[a]}return b[0]};this._GetSubValue=
function(a,b,c){a=this._GetSubItem(a,c);return null==a?null:this.Xml.GetElementAttribute(a,b)};this.AddColumns=function(a,b,c,d,e,g,h,k){var l=$X("EWA_LF_"+this._Id);null==k&&(k=l.rows[0].cells.length);for(var m=0;m<a.length;m++)for(var n=a[m],p=k+m,t=0;t<l.rows.length;t++){var r=l.rows[t].insertCell(p);if(0==t)r.className="EWA_TD_H",r.innerHTML='<nobr cellIdx="'+p+'" id="'+n[b]+'">'+n[c]+"</nobr>",r.title=n[d],r.width=100;else{var q=l.rows[t].getAttribute("EWA_KEY");r.className="EWA_TD_M";q=q+"_"+
n[b];var v=this._GetAddControl(n[g]);null==v&&(v=e);var u=h.replace("[ID]",n[b]);v=0<=v.indexOf("<select")?v.replace("!!",u.replace("onblur=","onchange=")):v.replace("!!",u);r.innerHTML=v;r.childNodes[0].id=q}}};this._GetAddControl=function(a){if(null==a)return null;a=a.toUpperCase().trim();return"SELECT"==a?"<select !!></select>":"DATE"==a?'<input type=text class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,false);" readonly !!>':"TIME"==a?'<input type=text class=EWA_INPUT onclick="EWA.UI.Calendar.Pop(this,true);" readonly !!>':
"STRING"==a||"NUMBER"==a?"<input type=text class=EWA_INPUT !!>":null};this.AddedValues=function(a,b,c,d,e){for(var g=0;g<a.length;g++){var h=a[g],k=$X(h[b]+"_"+h[c]);if(!k)break;var l=k.tagName.toUpperCase();"INPUT"==l||"SELECT"==l||"TEXTAREA"==l?k.value=h[d]:k.innerHTML=h[d];e&&(this.GetRow(k).getElementsByTagName("input")[0].checked=!0)}};this.AddRow=function(a){for(var b=$X("EWA_LF_"+this._Id),c=b.insertRow(-1),d=0;d<b.rows[0].cells.length;d++){var e=c.insertCell(-1),g=b.rows[0].cells[d];e.className=
"EWA_TD_M";null!=a[d]&&(e.innerHTML=a[d]);e.style.display=g.style.display;e.id="ADD_ROW_"+g.childNodes[0].id}return c};this.Calc=function(a,b,c,d){for(var e=$X("EWA_LF_"+this._Id),g={},h=0;h<a.length;h++)g[a[h]]=0;for(h=b;h<c;h++)for(a=e.rows[h],b=0;b<a.cells.length;b++)if(null!=g[b]){var k=a.cells[b],l=k.getElementsByTagName("input");0<l.length?g[b]+=1*l[0].value:(k=GetInnerText(k),""==k&&(k=0),g[b]+=1*k)}c=e.rows[d];for(h=0;h<c.cells.length;h++)null!=g[h]&&(k=Math.round(100*g[h])/100,d=GetInnerText(c.cells[h]),
k!=1*d&&(this.IsCalcChanged=!0),c.cells[h].innerHTML=k.fm())};this.mergeHeaders=function(a,b,c){var d=$($X("EWA_LF_"+this._Id)),e=d.find('tr[ewa_tag="HEADER"]');if(0!=e.length&&(a=e.find('nobr[id="'+a+'"]').parent(),0!=a.length)){var g=d.find("tr[ewa_mearge]");0==g.length&&(g=$(d[0].insertRow(1)),g.attr("ewa_mearge","gdx"));d=-1;for(var h=0;h<e[0].cells.length;h++){var k=e[0].cells[h];k==a[0]&&(d=h,k.colSpan=c);if(-1==d)"1"!=$(k).attr("ewa_tdmearged")&&(k.rowSpan=2);else if(d+c==h)d=-1,k.rowSpan=
2;else{k.rowSpan=1;var l=g[0].insertCell(-1);l.innerHTML=k.innerHTML;l.className=k.className;l.style.cssText=k.style.cssText;k.style.display="none";$(k).attr("ewa_tdmearged",1)}k==a[0]&&(k.innerHTML=b,k.style.display="",k.style.width="")}}};this.MeargeHeader=function(a,b,c){console.log("\u62fc\u5199\u9519\u8bef\uff0c\u8bf7\u7528 mergeHeaders");this.mergeHeaders(a,b,c)};this.getUrlClass=function(){var a=new EWA_UrlClass;a.SetUrl(this.Url);return a}}
...
b.animate(r,"fast","swing",function(){b[0].style.cssText="";var q=1*b.attr("st");document.body.scrollTop=q;1==$("#crm_left_box").attr("show")&&$("#crm_left_box").show();b.css("display",b.attr("dsp"));0<d.length&&"DES_plugin"!=a?d[0].click():(q=$X(a.replace("DES_","")),q.style.width=q.parentNode.clientWidth-10+"px",q.style.height=r.height-30+"px",c.find('div[id="EWA_FRAME_MAIN"]').css("height",r.height-150))});else{b.attr("full","1");b.attr("st",document.body.scrollTop);b.attr("dsp",b.css("display"));
var g=document.documentElement.clientHeight;e=document.documentElement.clientWidth-10;var h=g-20,k=document.documentElement.clientWidth-30,l=g-20-20-15;g=b.offset();var m=b.position(),n=g.left-m.left,p=b.width(),t=b.height();var r={width:p,height:t,"margin-left":n,left:m.left,top:m.top};b.attr("ori",JSON.stringify(r));b.css({"margin-left":"0px",top:g.top,left:g.left,position:"absolute",display:"",overflow:"auto"});b.animate({width:e,height:h,left:10,top:0},"fast","swing",function(){c.css("width",
...
function loadWfShow(a,b,c,d,e,g,h,k,l,m){_EWA_WF&&_EWA_WF.EN&&(_EWA_WF.EN1=$J2MAP(_EWA_WF.EN,"WF_UNIT_ID"));d=document.createElement("div");d.style.position="absolute";d.style.zIndex=123;d.innerHTML="ver: "+_EWA_WF.WF_DLV_VER;document.body.appendChild(d);var n=EWAC_WfUtil.WF,p=1000012,t=1000011;for(d=0;d<a.length;d++){var r=a[d],q=r.WF_UNIT_X,v=r.WF_UNIT_Y;null!=q&&1*q<p&&(p=1*q);null!=v&&1*v<t&&(t=1*v)}1000012==p&&(p=0);1000011==t&&(t=0);p-=10;t-=10;m={};var u;for(d=0;d<a.length;d++)r=a[d],n.Ids[d]=
r.WF_UNIT_ID,q=n.CreateUnit(),m[r.WF_UNIT_ID]=q,v=r.WF_UNIT_NAME,"enus"==EWA.LANG&&_EWA_WF.EN1&&_EWA_WF.EN1[r.WF_UNIT_ID]&&_EWA_WF.EN1[r.WF_UNIT_ID].WF_UNIT_NAME_EN&&(v=_EWA_WF.EN1[r.WF_UNIT_ID].WF_UNIT_NAME_EN),q.ChangeDes(v),q.ChangeType(r.WF_UNIT_TYPE),q.WF_UNIT_ADM=r.WF_UNIT_ADM,q.WF_UNIT_ADM_LST=r.WF_UNIT_ADM_LST,q=r.WF_UNIT_X,v=r.WF_UNIT_Y,r=$X(r.WF_UNIT_ID),null!=q&&(r.style.left=q-p+"px"),null!=v&&(r.style.top=v-t+"px");a={};for(d=0;d<b.length;d++)r=b[d],q=r.WF_UNIT_FROM,a[q]||(a[q]=[]),a[q].push(r);
for(d=0;d<b.length;d++)r=b[d],a=r.WF_UNIT_TO,q=r.WF_UNIT_FROM,q=n.Units[q],a=n.Units[a],p=new EWAC_WfCnn,p.Create(q,a),n.Cnns[p.Id]=p,r.IsHaveLogic&&!r.IsLogicOk&&(p.IsStop=!0);for(var x in n.Units)d=n.Units[x],null==u&&0==d.CnnsToLength&&(u=d);if(null==u)h="enus"==EWA.LANG?"No startup node was found, process definition error":"\u672a\u53d1\u73b0\u542f\u52a8\u8282\u70b9,\u6d41\u7a0b\u5b9a\u4e49\u9519\u8bef",alert(h);else{0==c.length&&(n.CurUnit=u);var w=[];x={};for(d=0;d<c.length;d++)b=c[d],n=b.SYS_STA_TAG,
q=m[n],null!=q&&(r=b.ADM_NAME,"enus"==EWA.LANG&&b.ADM_NAME_EN&&(r=b.ADM_NAME_EN),q.Log(r,b.SYS_STA_CDATE,b.SYS_STA_MEMO),x[n]||(x[n]=1,w.push({ID:n,DES:q.GetDes()})),n=b.SYS_STA_TAG+"G"+b.SYS_STA_VAL,EWAC_WfUtil.WF.Cnns[n]&&(EWAC_WfUtil.WF.Cnns[n].Disp(3,"blue"),q==u&&(q.ADM_ID=b.ADM_ID),d==c.length-1&&(n=m[b.SYS_STA_VAL],n.WF_UNIT_ADM_LST=b.ROLE_IDS,n.WF_UNIT_ADM=b.ROLE_TYPE,EWAC_WfUtil.WF.CurUnit=n)));null!=l&&0<l.length&&m[l]&&(EWAC_WfUtil.WF.CurUnit=m[l]);EWAC_WfUtil.WF.CurUnit.LogCur(e);l=!1;
q=EWAC_WfUtil.WF.CurUnit;c=[];if(u==q)l=!0;else if("WF_ADM_ADM"==q.WF_UNIT_ADM)if(u=","+q.WF_UNIT_ADM_LST+",",0<=u.indexOf(","+g+","))l=!0;else for(d in g=$J2MAP1(top.org,"ADM_ID"),h=q.WF_UNIT_ADM_LST.split(","),h){k=g[h[d]];for(var y in k)c.push(k[y].ADM_NAME)}else if("WF_ADM_DEPT"==q.WF_UNIT_ADM)if(u=","+q.WF_UNIT_ADM_LST+",",0<=u.indexOf(","+h+","))l=!0;else for(d in g=$J2MAP1(top.org,"DEP_ID"),h=q.WF_UNIT_ADM_LST.split(","),h)for(y in k=g[h[d]],k)c.push(k[y].ADM_NAME);else if("WF_ADM_POST"==q.WF_UNIT_ADM)if(u=
","+q.WF_UNIT_ADM_LST+",",0<=u.indexOf(","+k+","))l=!0;else for(d in g=$J2MAP1(top.org,"POS_ID"),h=q.WF_UNIT_ADM_LST.split(","),h)for(y in k=g[h[d]],k)c.push(k[y].ADM_NAME);else if("WF_ADM_START"==q.WF_UNIT_ADM){if(u==q||g==u.ADM_ID)l=!0}else"WF_ADM_MANAGER"==q.WF_UNIT_ADM&&(y=u.ADM_ID,top||top.ORG||(h="enus"==EWA.LANG?"No organization":"\u6ca1\u6709\u7ec4\u7ec7\u673a\u6784",alert(h),l=!1),l=top.ORG.GetMaster(y).Id==g?!0:!1);e&&window.parent&&window.parent.$X(e)&&(y=window.parent.$X(e).parentNode.parentNode.parentNode,
l?0<w.length&&(g=y.rows[y.rows.length-1].cells[0],h=window.parent.document.createElement("input"),h.type="button",h.value="enus"==EWA.LANG?"Back":"\u6253\u56de",h.onclick=function(){var A=window.parent.$X(e);A.options.length=1;for(var B=0;B<w.length;B++){var E=w[B];A.options[A.length]=new Option(E.DES,E.ID);this.style.display="none"}A.parentNode.parentNode.cells[0].innerHTML="enus"==EWA.LANG?'<div style="color:red">Back steps</div>':'<div style="color:red">\u8fd4\u56de\u6b65\u9aa4</div>'},g.insertBefore(h,

...
EWA.F.FOS[k].GuideNextAfter(h,this,b))};var d=b.parentNode.parentNode.parentNode.parentNode.insertRow(-1).insertCell(-1);d.appendChild(a);d.appendChild(c);d.className="EWA_FRAME_GROUP_BUTTONS";tdTitle=b.parentNode.parentNode.parentNode.parentNode.insertRow(0).insertCell(-1);d="ewa_title_"+Math.random();for(var e=[],g=0;g<this._GroupInfos.length;g++)e.push('<div style="float:left" id="ewa_'+this._Id+"_"+g+'">'+(g+1)+". "+this._GroupInfos[g].DES+"</div>");tdTitle.innerHTML="<div style='text-align:left'>"+
e.join(" <div style='float:left;color:#aaa'>&nbsp;&gt;&nbsp;</div> ")+"</div><div id='"+d+"'></div>";tdTitle.className="EWA_FRAME_GROUP_TITLE";b.setAttribute("EWA_GUIDE_ID_PREV",a.id);b.setAttribute("EWA_GUIDE_ID_NEXT",c.id);b.setAttribute("EWA_GUIDE_ID_TITLE",d);this.GuideShowTitle(0);a=document.createElement("div");100<b.clientHeight&&(a.style.width=b.clientWidth+"px",a.style.height=b.clientHeight+20+"px",a.style.overflow="auto");b.parentNode.appendChild(a);a.appendChild(b);b.parentNode.className=
"EWA_GROUP_GUIDE"};this.GuideShowTitle=function(a){for(var b=$X("EWA_FRAME_"+this._Id).getAttribute("EWA_GUIDE_IDX_MAX"),c=0;c<=b;c++){var d="ewa_"+this._Id+"_"+c;c==a?($X(d).style.color="blue",$X(d).style.borderBottom="2px solid green"):($X(d).style.color="green",$X(d).style.borderBottom="2px")}};this.GuideShowCheck=function(a){var b=!0,c=null,d;for(d in this.ItemList.Items){var e=this.ItemList.GetItemValue(this.ItemList.Items[d],"Name","Name"),g=$X(e);null==g?alert(e+" not exists"):(e=this._GetTr(g),
null!=e&&e.getAttribute("groupindex")==a&&((b&=this.CheckValid(g))||null!=c||(c=g)))}null!=c&&c.focus();return b};this._GetTr=function(a){for(var b=0;100>b;){b++;a=a.parentNode;try{if("TR"==a.tagName.toUpperCase()&&null!=a.getAttribute("id")&&0==a.getAttribute("id").indexOf("_ewa_tr$"))return a}catch(c){break}}return null};this.GuideShow=function(a){this.GuideShowTitle(a);var b=$X("EWA_FRAME_"+this._Id);if(b.getAttribute("EWA_GUIDE_IDX")!=a){var c=b.getAttribute("EWA_GUIDE_IDX_MAX"),d=b.getAttribute("EWA_GUIDE_ID_PREV"),
e=b.getAttribute("EWA_GUIDE_ID_NEXT");a==c?($X(e).value="enus"==EWA.LANG?"Confirm":"\u786e\u5b9a",$X(e).setAttribute("ewa_guide_method","ok")):($X(e).value="enus"==EWA.LANG?"Next":"\u4e0b\u4e00\u6b65",$X(e).setAttribute("ewa_guide_method",""));0==a?$X(d).style.display="none":$X(d).style.display="";b.setAttribute("EWA_GUIDE_IDX",a);this._ShowHidenGroup(b,a)}};this._ShowHidenGroup=function(a,b){for(var c=0;c<a.rows.length-1;c++){var d=a.rows[c];if(null!=d.getAttribute("groupIndex")&&""!=d.getAttribute("groupIndex")){var e=
1*d.getAttribute("groupIndex");d.style.display=b==e?"":"none"}}};this.GroupShow=function(a,b){if(!(0<a.className.indexOf("1"))){this.GroupShowBefore&&this.GroupShowBefore(a,b);for(var c=$X("EWA_FRAME_"+this._Id),d=a.parentNode.parentNode,e=0;e<c.rows.length;e++){var g=c.rows[e];if(g!=d&&!(1==g.cells.length&&g.cells[0].className&&0<=g.cells[0].className.indexOf("EWA_TD_B"))&&"1"!=g.getAttribute("hiddennocontentrow")){var h=0;null!=g.getAttribute("groupIndex")&&""!=g.getAttribute("groupIndex")&&(h=
1*g.getAttribute("groupIndex"));g.style.display=b==h?"":"none"}}c=d.getElementsByTagName("div");for(e=0;e<c.length;e++)d=c[e],d.className=d==a?d.className+"1":d.className.replace("1","");this.GroupShowAfter&&this.GroupShowAfter(a,b)}};this.DoActionJSON=function(a,b,c,d){EWA.F.CID=this._Id;this._Ajax=new EWA.C.Ajax;this._Ajax.LoadingType="image";this._Ajax.AddParameter("EWA_AJAX","JSON");this._Ajax.AddParameter("EWA_ACTION",a);this._Ajax.AddParameter("EWA_ID",this._Id);this._Ajax.AddParameter("EWA_JSON_NAME",
b);this._AjaxJsonAfter=null!=d?d:null;if(null!=c&&0<c.length)for(a=0;a<c.length;a+=1)this._Ajax.AddParameter(c[a].Name,c[a].Value);c=new EWA.C.Url;c.SetUrl(this.Url);c=c.RemoveParameter("EWA_ACTION");this._Ajax.PostNew(c,EWA.F.FOS[EWA.F.CID]._CallBackJs)};this._CallBackJs=function(){var a=EWA.F.FOS[EWA.F.CID],b=a._Ajax;if(4==b._Http.readyState)if(b.HiddenWaitting(),200==b._Http.status){if(b=b._Http.responseText,EWA.F.CheckCallBack(b)){eval(b);a._AjaxJsonAfter&&(a._AjaxJsonAfter(),a._AjaxJsonAfter=
null);try{a.ReloadAfter&&a.ReloadAfter(b)}catch(c){alert(b)}}}else alert("ERROR:\r\n"+b._Http.statusText)};this.RewriteInfo=function(a,b,c,d,e){var g=$("#EWA_FRAME_"+this._Id),h=[];b=b||"id";c=c||"info";d=d||"memo";for(var k=0;k<a.length;k++){var l=a[k],m=g.find("#"+l[b]);0!=m.length&&(m=m.parentsUntil("tr[show_msg]").last().parent(),null==l[c]||""==l[c].trim()?(m.hide(),e&&e(m[0],l,k)):3==m[0].cells.length?(h.push(m[0]),m[0].cells[2].innerHTML=l[d],m[0].cells[0].innerHTML=l[c],e&&e(m[0],l,k)):2==
m[0].cells.length?(h.push(m[0]),m[0].cells[0].innerHTML=l[c],e&&e(m[0],l,k)):1==m[0].cells.length&&(m=m.prev(),1<m[0].cells.length&&(m[0].cells[1].innerHTML=l[d]),h.push(m[0]),m[0].cells[0].innerHTML=l[c],e&&e(m[0],l,k)))}return h};this._HiddenMemo=function(a,b){var c=a.parentNode.parentNode;b=!1;"none"==c.style.display&&(b=!0);c.style.display="none";c.id="tr_"+a.id;c=c.previousSibling;3==c.nodeType&&(c=c.previousSibling);c.style.display="none";a="<span id=tab_"+a.id+' class="ewa_merge_tab" onclick="EWA.F.FOS[\''+
this._Id+"'].ShowMemo(this.id);\">"+c.cells[0].innerHTML+"</span>";return b?"":a};this.ShowMemo=function(a){for(var b=$X(this._Id+"__ewa_meger").getElementsByTagName("SPAN"),c=0;c<b.length;c++){var d=b[c].id.replace("tab_","tr_");"ewa_merge_tab1"==b[c].className&&(b[c].className="ewa_merge_tab",$X(d).style.display="none");b[c].id==a&&(b[c].className="ewa_merge_tab1",$X(d).style.display="")}};this.MergeMemo=function(){var a=$X("EWA_FRAME_"+this._Id).getElementsByTagName("textarea");if(0!=a.length&&
"1"!=a[0].getAttribute("ewa_merge")){for(var b=[],c=0;c<a.length;c++){var d=this._HiddenMemo(a[c]);d="<nobr>"+d.replace("\u2022 ","").trim()+"</nobr>";b.push(d)}a=a[0];c=a.parentNode.parentNode;d=c.previousSibling;3==d.nodeType&&(d=d.previousSibling);d.id=this._Id+"__ewa_meger";d.cells[0].colSpan=3;d.cells[0].innerHTML=b.join("");d.cells[0].style.width="100%";d.cells[0].style.height="25px";d.style.display="";c.style.display="";$X("tab_"+a.id).className="ewa_merge_tab1";null!=window._EWA_DialogWnd&&
EWA.UI.Dialog._SetTitle(window._EWA_DialogWnd)}};this.DoValidEx=function(a,b,c,d,e,g){""!=a.value&&(this._ValidExOk=this.Resources[e],this._ValidExFail=this.Resources[g],this._ValidExObj=a,"action"==b.toLowerCase().trim()?this._DoValidExAction(a,d,this.Resources[e].GetInfo(),this.Resources[g].GetInfo()):(0<=c.indexOf("&quot;")&&(c=c.replace(/&quot;/ig,'"')),eval(c)?(EWA_FrameShowAlert(a,this._ValidExOk.GetInfo()),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,this._ValidExFail.GetInfo()),
a.setAttribute("EWA_VALID_EX",this._ValidExFail.GetInfo()))))};this._DoValidExAction=function(a,b,c,d){if(null!=a&&!$(a).is(":hidden"))if(null==b||""==b.trim())alert("action not value");else{var e=a.id+","+a.value;if(this.DoValidExAction_RETS&&null!=this.DoValidExAction_RETS[e])0==this.DoValidExAction_RETS[e]?(EWA_FrameRemoveAlert(a,c),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,d),a.setAttribute("EWA_VALID_EX",d));else{var g=new EWA.C.Ajax;g.LoadingType="image";g.AddParameter("EWA_AJAX",
"HAVE_DATA");g.AddParameter("EWA_ACTION",b);g.AddParameter("EWA_ID",this._Id);g.AddParameter("EWA_NO_CONTENT","1");g.AddParameter(a.id,a.value);this.DoValidExAction_RETS||(this.DoValidExAction_RETS={});var h=this;g.PostNew(this.Url,function(){if(4==g._Http.readyState){g.HiddenWaitting();if(200==g._Http.status){var k=g._Http.responseText;if(EWA.F.CheckCallBack(k))try{var l=parseInt(k.trim());h.DoValidExAction_RETS[e]=l;0==l?(EWA_FrameRemoveAlert(a,c),a.setAttribute("EWA_VALID_EX","")):(EWA_FrameShowAlert(a,
d),a.setAttribute("EWA_VALID_EX",d))}catch(m){alert(m+","+k)}}else alert("ERROR:\r\n"+g._Http.statusText);g=null}})}}};this.ValidCodeError=function(a){var b=this._t_ValidCodeError||0,c=(new Date).getTime();1E3>c-b?a||(a=_EWA_EVENT_MSG.ValidCodeError,$Tip(a),$(".ewa-valid-code-img").parent().parent().find("input").focus().select()):(this._t_ValidCodeError=c,$(".ewa-valid-code-img").each(function(){this.click()}),a||(a=_EWA_EVENT_MSG.ValidCodeError,$Tip(a),$(".ewa-valid-code-img").parent().parent().find("input").focus().select()))};
this.checkIdempotenceError=function(){$Tip(_EWA_EVENT_MSG.IdempotanceError)};this.checkValidSildePuzzleError=function(){$Tip(_EWA_EVENT_MSG.ValidSildePuzzleError)};this.Init=function(a){this.Xml=new EWA.C.Xml;this.Xml.LoadXml(a);this.ItemList.F=this;this.ItemList.Init(this.Xml);this.Resources=new EWA_FrameResoures;this.Resources.Init(this.Xml);"enus"==EWA.LANG&&$(".ewa-ipt-droplist").attr("placeholder","Input character selection");this._InitTranslations();this._GetDropListValue();this._InitMustInputs();
this._InitEncyptions();this._InitTriggerValids()};this._InitTriggerValids=function(){var a=$("#EWA_FRAME_"+this._Id),b="EWA.F.FOS['"+this._Id+"'].callTriggerValid(this)";this.triggerValids={};for(var c in this.ItemList.Items){var d=this.ItemList.Items[c],e=this.ItemList.GetItemValue(d,"Name","Name"),g=$(d).find("DataItem Set[TriggerValid]").attr("TriggerValid");if(g){this.triggerValids[e]=null;var h=a.find("#"+e);0===h.length&&contine;h.attr("ewa_trigger_valid",g);d=$(d).find("Tag Set").attr("Tag");
if("submit"==d)break;if("smsValid"==d){h=a.find(".ewa-row-"+e+" .ewa-sms-valid-code-button");d=h.attr("id");d||(d=EWA_Utils.tempId(),h.attr("id",d));var k=$("<a style='position:absolute;left:0;top:0;right:0;bottom:0'></a>");k.attr("ewa_trigger_valid",g);k.attr("ewa_trigger_valid_rid",e);k.attr("ewa_trigger_valid_click_id",d);h.parent().css("position","relative").append(k);h=k}(e=h.attr("onclick"))&&h.attr("_onclick",e);h.attr("onclick",b)}}};this.callTriggerValidBefore=function(a){return!0};this.callTriggerValid=
function(a){if(this.callTriggerValidBefore(a)){var b=$("#EWA_FRAME_"+this._Id),c=$(a),d=c.attr("id");d||(d=c.attr("ewa_trigger_valid_rid"));var e=this.getUrlClass(),g=c.attr("ewa_trigger_valid");e.AddParameter("ewa_ajax",g);e.AddParameter("ewa_trigger_valid_name",d);e.AddParameter("ewa_trigger_valid_mode","create");e.AddParameter("ewa_trigger_valid_width",document.documentElement.clientWidth);var h=this,k=EWA_Utils.tempId();$J(e.GetUrl(),function(l){if(l.RST){c.attr("_trigger_valid_id",k);var m=top.$DialogHtml("<div id='"+
k+"'></div>","enus"==EWA.LANG?"Silde puzzle":"\u62fc\u56fe\u9a8c\u8bc1",l.bigImgWidth+20,200,!1);l.ewa_trigger_valid_name=d;l.ewa_trigger_valid=g;l.ewa_url=e.GetUrl();EWA.UI.SlidePuzzle(l,top.$("#"+k),function(n){console.log("2. puzzle cb true");var p=!1;c.attr("_onclick")&&(c.attr("onclick",$(a).attr("_onclick")),p=!0);setTimeout(function(){$(m.getMain()).animate({opacity:0},500)},500);setTimeout(function(){var r=c.attr("type");h.triggerValids[d]=n.VALID;var q=$(a).attr("ewa_trigger_valid_click_id");
q?(c.remove(),console.log(q+".click"),b.find("#"+q).click()):p?(console.log("3. puzzle click"),c.click()):"submit"==r&&console.log("3. puzzle submit");m.Close()},1E3)});setTimeout(function(){m.AutoSize()},100)}else alert(l.ERR)})}};this._InitMustInputs=function(){var a=$("#EWA_FRAME_"+this._Id),b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name");0<$(c).find('IsMustInput Set[IsMustInput="1"]').length&&(c="#"+d,a.find(".ewa-row-"+d).addClass("ewa-row-must"),
...
!0);d.attr("ewa_encyrption","yes")}var e=$("<div class='ewa-enc-cover' style='position:absolute;left:0;top:0;width:100%;height:100%;'><div></div></div>");d.parent().append(e);d.parent().css("position","relative");if(c=c.attr("EncShowUrl")){e.find("div").html("\u70b9\u51fb\u67e5\u770b").css({position:"absolute",height:30,"line-height":"30px",top:"50%","margin-top":"-15px",right:10,"text-align":"right"});c=new EWA_UrlClass(c);e=new EWA_UrlClass(this.Url);for(var g in e._Paras)if(!c.GetParameter(g)){var h=
e._Paras[g];null!=h&&(h=h.unURL());c.AddParameter(g,h)}c.AddParameter("EWA_ENCY_FROM_ID",d.attr("id"));c=c.GetUrl();d.parent().attr("enc_url",c).attr("fid",d.attr("id"));d.parent().on("click",function(){if(!$(this).attr("enc_ok")){var k=$(this).attr("t")||100,l=(new Date).getTime();if(!(400>l-k)){$(this).attr("t",l);k=$(this).attr("enc_url");var m=$(this).find("#"+$(this).attr("fid"));$J(k,function(n){n.RST?(m.prop("disabled",!1),m.removeAttr("ewa_encyrption"),m.val(n.VALUE),$(m).parent().find(".ewa-enc-cover").remove(),
$(m).parent().attr("enc_ok","1")):(n.ERR||n.MSG)&&$Tip(n.ERR||n.MSG)})}}})}}}};this._InitTranslations=function(){var a="EWA.F.FOS[&quot;"+this._Id+"&quot;]._Trans(this)",b;for(b in this.ItemList.Items){var c=this.ItemList.Items[b],d=this.ItemList.GetItemValue(c,"Name","Name"),e=$(c).find("DataItem Set[Translation]");if(c=e.attr("Translation")){e=e.attr("TransTarget");var g="en2zh"==c?" \u82f1\u8bd1\u4e2d":" \u4e2d\u8bd1\u82f1";"enus"==EWA.LANG&&(g="en2zh"==c?" En-Zh":" Zh-En");c=$('<a class="ewa-but-trans" href="javascript:void(0)" onclick="'+

...
function _$J_HandleRst(a,b,c,d){if(a.IsRunEnd())if(a.IsError())if(a.onError)a.onError(a.responseStatus);else window.EWA_AjaxErr?window.EWA_AjaxErr(a):(alert("ERROR: "+a.responseStatus),console.error(a._Http));else{a=a.GetRst();if(d)try{a=JSON.parse(a)}catch(l){console.error("_$J_HandleRst-JSON"+l);return}if(null==b)alert("\u5bf9\u8c61\u6ca1\u6709\u53d1\u73b0");else if(b instanceof Function||"function"==typeof b)b(a,c);else if("string"==typeof b)$X(b);else if("SELECT"==b.tagName)if(d)if(2>c.length)alert("\u53c2\u6570\u4e0d\u8db3\uff0c\u9700\u8981textName,valueName\u7684\u5b9a\u4e49");

...
"disabled"));e.append(k)})},footerButtonRelate:function(b){var a=$(b).attr("last_t")||0,c=(new Date).getTime();500>c-a||($(b).attr("last_t",c),a=$(b).attr("rid"),c=$X(a),null==c?console.log("\u4e0d\u80fd\u627e\u5230 ref_obj id="+a):(c.onclick(),$(b).parent().find("input").each(function(){var d=$(this).attr("rid"),e=$X(d);null==e?console.log("\u4e0d\u80fd\u627e\u5230 ref_obj id="+d):(this.value=e.value,"none"==e.style.display||e.disabled?this.setAttribute("disabled","disabled"):this.removeAttribute("disabled"))})))},
